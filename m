...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 12B2A656967
	for <lists+devicetree@lfdr.de>; Tue, 27 Dec 2022 11:24:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231334AbiL0KYI (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 27 Dec 2022 05:24:08 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41294 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231335AbiL0KYG (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 27 Dec 2022 05:24:06 -0500
Received: from smtpout1.mo528.mail-out.ovh.net (smtpout1.mo528.mail-out.ovh.net [46.105.34.251])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8B6199FE9;
        Tue, 27 Dec 2022 02:24:05 -0800 (PST)
Received: from pro2.mail.ovh.net (unknown [10.108.1.71])
        by mo528.mail-out.ovh.net (Postfix) with ESMTPS id 0A341147C1BF4;
...
Subject: [RESEND PATCH v6 3/6] leds: provide devm_of_led_get_optional()
Date:   Tue, 27 Dec 2022 11:06:56 +0100
Message-ID: <20221227100659.157071-4-jjhiblot@traphandler.com>
...
X-ClientProxiedBy: DAG3EX1.emp2.local (172.16.2.21) To DAG1EX1.emp2.local
 (172.16.2.1)
X-Ovh-Tracer-Id: 14108370259400866267
X-VR-SPAMSTATE: OK
X-VR-SPAMSCORE: 0
