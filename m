...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6E67720FC25
	for <lists+devicetree@lfdr.de>; Tue, 30 Jun 2020 20:47:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727823AbgF3SrQ (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 30 Jun 2020 14:47:16 -0400
Received: from m43-7.mailgun.net ([69.72.43.7]:61884 "EHLO m43-7.mailgun.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726685AbgF3SrB (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Tue, 30 Jun 2020 14:47:01 -0400
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1593542806; h=Content-Transfer-Encoding: MIME-Version:
 References: In-Reply-To: Message-Id: Date: Subject: Cc: To: From:
 Sender; bh=3jH00PYGxsgmthvgF7jvo5ZIKpt5WPwGkh7pueEZ770=; b=WQ/p1hPSeaRHPUHOPQ88WZmv7e7CEm17SiPuf+JjQdwpRS7JQDOj/SIWKFuKKQGOyS1IbMqp
 VjVL4+GVJBc0RSVvt/RxviuNOJtkUMk9KW4HN8J98Wtqb1HuEx9qjDmOf6kWZ6tNKgOIFtf4
 Vw844NNMHYcSsRwdtSCDScsYc2w=
X-Mailgun-Sending-Ip: 69.72.43.7
X-Mailgun-Sid: WyI1YmJiNiIsICJkZXZpY2V0cmVlQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org
 (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171]) by
 smtp-out-n13.prod.us-west-2.postgun.com with SMTP id
 5efb888afe1db4db890a2eea (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Tue, 30 Jun 2020 18:46:34
 GMT
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 8B4F4C433AF; Tue, 30 Jun 2020 18:46:34 +0000 (UTC)
...
Received: from linuxdisplay-lab-04.qualcomm.com (i-global254.qualcomm.com [199.106.103.254])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id BD8DDC433CA;
        Tue, 30 Jun 2020 18:46:24 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org BD8DDC433CA
...
Subject: [PATCH v8 3/6] drm/msm/dp: add displayPort driver support
Date:   Tue, 30 Jun 2020 11:45:04 -0700
Message-Id: <20200630184507.15589-4-tanmay@codeaurora.org>
...
---
 ...
 drivers/gpu/drm/msm/dp/dp_catalog.c           | 1034 ++++++++++
 ...
 27 files changed, 8088 insertions(+), 3 deletions(-)
...
index 926a113a7ff8..753cc2fcf916 100644
...
+	}
 ...
 out:
@@ -1169,6 +1183,13 @@ static void dpu_encoder_virt_disable(struct drm_encoder *drm_enc)
...
index 000000000000..696dc8741f1e
--- /dev/null
...
new file mode 100644
index 000000000000..c54312341e3c
--- /dev/null
...
new file mode 100644
index 000000000000..0a2504ee08e6
--- /dev/null
...
new file mode 100644
index 000000000000..cfe429d2e95f
--- /dev/null
...
new file mode 100644
index 000000000000..9c75a4d327bb
--- /dev/null
...
new file mode 100644
index 000000000000..809e99e78aba
--- /dev/null
...
new file mode 100644
index 000000000000..47fa478f9f0c
--- /dev/null
