...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1D0EE34400D
	for <lists+devicetree@lfdr.de>; Mon, 22 Mar 2021 12:44:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229979AbhCVLna (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 22 Mar 2021 07:43:30 -0400
Received: from www381.your-server.de ([78.46.137.84]:50360 "EHLO
        www381.your-server.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229673AbhCVLnR (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 22 Mar 2021 07:43:17 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=metafoo.de;
         s=default2002; h=Content-Transfer-Encoding:Content-Type:In-Reply-To:
        MIME-Version:Date:Message-ID:From:References:Cc:To:Subject:Sender:Reply-To:
        Content-ID:Content-Description:Resent-Date:Resent-From:Resent-Sender:
        Resent-To:Resent-Cc:Resent-Message-ID;
        bh=EdTpqCapsEky/DEdnGZcSSCaMYuNbl8EcUHZMKVszqA=; b=Ze1lmTBhjN28PLs+kKs/ReEl52
        ;
Received: from sslproxy03.your-server.de ([88.198.220.132])
        by www381.your-server.de with esmtpsa (TLSv1.3:TLS_AES_256_GCM_SHA384:256)
        (Exim 4.92.3)
        (envelope-from <lars@metafoo.de>)
        id 1lOIxj-000FbU-VT; Mon, 22 Mar 2021 12:43:12 +0100
Received: from [2001:a61:2aa9:e001:9e5c:8eff:fe01:8578]
        by sslproxy03.your-server.de with esmtpsa (TLSv1.3:TLS_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <lars@metafoo.de>)
        id 1lOIxj-0006Uj-Mq; Mon, 22 Mar 2021 12:43:11 +0100
...
Message-ID: <47ef00a0-dafb-df1e-969c-f41c3f7b156c@metafoo.de>
Date:   Mon, 22 Mar 2021 12:43:11 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.8.0
MIME-Version: 1.0
In-Reply-To: <20210322105056.30571-3-raviteja.narayanam@xilinx.com>
