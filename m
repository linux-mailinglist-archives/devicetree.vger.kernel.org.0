...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3749D4BD484
	for <lists+devicetree@lfdr.de>; Mon, 21 Feb 2022 05:01:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245228AbiBUDq1 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 20 Feb 2022 22:46:27 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:51006 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344389AbiBUDqW (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 20 Feb 2022 22:46:22 -0500
Received: from mx1.cqplus1.com (unknown [113.204.237.245])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 83A9C51E50
        for <devicetree@vger.kernel.org>; Sun, 20 Feb 2022 19:45:51 -0800 (PST)
...
Subject: [PATCH v9 06/10] clk: Add Sunplus SP7021 clock driver
Date:   Mon, 21 Feb 2022 11:29:17 +0800
Message-Id: <728ffa13a962b723ed32c2ba714390576ce3f2e9.1645413746.git.qinjian@cqplus1.com>
...
+#define DBG_CLK(clk)					\
+{							\
+	struct clk_hw *hw = clk;			\
+	char *name = clk_hw_get_name(hw);		\
...
+}
+
+#define PD_EXTCLK	(&sp_clk_parents[0])
+#define PD_PLLSYS	(&sp_clk_parents[1])
+#define PD_PLLE		(&sp_clk_parents[2])
+
...
+	};
+	static struct clk_parent_data sp_clk_parents[3];
...
+	PD_PLLSYS->hw = hws[PLL_SYS];
+
+	/* gates */
+	for (i = 0; i < ARRAY_SIZE(sp_clk_gates); i++) {
+		u32 f = sp_clk_gates[i];
+		int j = f & 0xffff;
+		struct clk_parent_data *pd = &sp_clk_parents[!(f & F_EXTCLK)];
+		char s[10];
+
