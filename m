...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DBE782C0F34
	for <lists+devicetree@lfdr.de>; Mon, 23 Nov 2020 16:47:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388010AbgKWPqZ (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 23 Nov 2020 10:46:25 -0500
Received: from mga18.intel.com ([134.134.136.126]:59722 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2388121AbgKWPqZ (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Mon, 23 Nov 2020 10:46:25 -0500
IronPort-SDR: SOF66ECvMZt3nE0ZIDUvtrLtaE3Af8WhZnejEAkxZ2GUrucBPEWxez2OfxQDqE+o3KQ/z14szI
 R7o4aKEhxC9w==
X-IronPort-AV: E=McAfee;i="6000,8403,9813"; a="159555168"
X-IronPort-AV: E=Sophos;i="5.78,363,1599548400"; 
   d="yaml'?scan'208";a="159555168"
X-Amp-Result: UNKNOWN
X-Amp-Original-Verdict: FILE UNKNOWN
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Nov 2020 07:46:15 -0800
IronPort-SDR: glD8skfc5R8iokHvB6fhWUah4VmnaP0ckX8pp056LvoCTq//BoQFagME2cW3AX93s1I0gJeW6G
 Du+QhruSNnzQ==
X-IronPort-AV: E=Sophos;i="5.78,363,1599548400"; 
   d="yaml'?scan'208";a="312246320"
Received: from xsang-optiplex-9020.sh.intel.com (HELO xsang-OptiPlex-9020) ([10.239.159.140])
  by fmsmga008-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Nov 2020 07:46:09 -0800
Date:   Tue, 24 Nov 2020 00:00:26 +0800
...
Cc:     "Rafael J. Wysocki" <rjw@rjwysocki.net>,
        ...
        devicetree@vger.kernel.org, 0day robot <lkp@intel.com>,
        lkp@lists.01.org, ying.huang@intel.com, feng.tang@intel.com,
        zhengjun.xing@intel.com
Subject: [driver core]  95f755a4ef:  will-it-scale.per_process_ops 2.2%
 improvement
Message-ID: <20201123160026.GB26172@xsang-OptiPlex-9020>
MIME-Version: 1.0
...
Content-Disposition: attachment; filename="config-5.10.0-rc4-00075-g95f755a4ef7b"
...
export_top_env()
{
	...
	export nr_task=96
	export job_origin='/lkp-src/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2ap2/will-it-scale-part1.yaml'
...
queue_at_least_once'
	...
	export submit_id='5fb9d43df9053d61a79b46c6'
	export job_file='/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-95f755a4ef7b9ccbed-20201122-24999-lin0f7-3.yaml'
	export id='bebd434ee680b83c6b6ade7139165e228b243f8d'
	...
	export commit='95f755a4ef7b9ccbedf6012b4112a990120b6a6c'
	export need_kconfig_hw='CONFIG_IGB=y
CONFIG_BLK_DEV_NVME'
	export ucode='0x5003003'
	export enqueue_time='2020-11-22 11:00:14 +0800'
	export _id='5fb9d444f9053d61a79b46c7'
	export _rt='/result/will-it-scale/performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c'
	export user='lkp'
	...
	export branch='linux-review/Saravana-Kannan/Refactor-fw_devlink-to-significantly-improve-boot-time/20201121-100850'
	export rootfs='debian-10.4-x86_64-20200603.cgz'
	export monitor_sha='6e02c248'
	export result_root='/result/will-it-scale/performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c/3'
...
user=lkp
job=/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-95f755a4ef7b9ccbed-20201122-24999-lin0f7-3.yaml
ARCH=x86_64
kconfig=x86_64-rhel-8.3
branch=linux-review/Saravana-Kannan/Refactor-fw_devlink-to-significantly-improve-boot-time/20201121-100850
commit=95f755a4ef7b9ccbedf6012b4112a990120b6a6c
BOOT_IMAGE=/pkg/linux/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c/vmlinuz-5.10.0-rc4-00075-g95f755a4ef7b
acpi_rsdp=0x67f44014
max_uptime=3600
RESULT_ROOT=/result/will-it-scale/performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c/3
...
vga=normal
rw'
	export modules_initrd='/pkg/linux/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c/modules.cgz'
	export bm_initrd='/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20200709.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/will-it-scale_20201111.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/will-it-scale-x86_64-b695a1b-1_20201111.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20200723.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-eccc87672492-1_20201111.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz'
	export ucode_initrd='/osimage/ucode/intel-ucode-20201117.cgz'
	export lkp_initrd='/osimage/user/lkp/lkp-x86_64.cgz'
	export site='inn'
	export LKP_CGI_PORT=80
	export LKP_CIFS_PORT=139
	export last_kernel='5.10.0-rc4-intel-next-02840-g76abee9845c5'
	export repeat_to=4
	export schedule_notify_address=
	export queue_at_least_once=1
	export kernel='/pkg/linux/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c/vmlinuz-5.10.0-rc4-00075-g95f755a4ef7b'
	export dequeue_time='2020-11-22 11:13:04 +0800'
	export job_initrd='/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-95f755a4ef7b9ccbed-20201122-24999-lin0f7-3.cgz'
...
run_job()
{
	...
	run_test mode='process' test='futex3' $LKP_SRC/tests/wrapper will-it-scale
}
...
will-it-scale:
  mode: process
  test: futex3
job_origin: "/lkp-src/allot/cyclic:p1:linux-devel:devel-hourly/lkp-csl-2ap2/will-it-scale-part1.yaml"
...
kconfig: x86_64-rhel-8.3
submit_id: 5fb9c9eff9053d5f9e9d5d84
job_file: "/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-95f755a4ef7b9ccbed-20201122-24478-awezff-1.yaml"
id: 7cf548233e3a1abb1a111fe27858ba3b57faab18
...
- CONFIG_BLK_DEV_NVME
ucode: '0x5003003'
enqueue_time: 2020-11-22 10:16:15.766323014 +08:00
_id: 5fb9cc14f9053d5f9e9d5d85
_rt: "/result/will-it-scale/performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c"
...
result_root: "/result/will-it-scale/performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248/lkp-csl-2ap2/debian-10.4-x86_64-20200603.cgz/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c/0"
...
- root=/dev/ram0
- user=lkp
- job=/lkp/jobs/scheduled/lkp-csl-2ap2/will-it-scale-performance-process-50%-futex3-ucode=0x5003003-monitor=6e02c248-debian-10.4-x86_64-20200603.cgz-95f755a4ef7b9ccbed-20201122-24478-awezff-1.yaml
- ARCH=x86_64
- kconfig=x86_64-rhel-8.3
- branch=linux-devel/devel-hourly-2020112115
- commit=95f755a4ef7b9ccbedf6012b4112a990120b6a6c
...
- vga=normal
- rw
modules_initrd: "/pkg/linux/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c/modules.cgz"
bm_initrd: "/osimage/deps/debian-10.4-x86_64-20200603.cgz/run-ipconfig_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/lkp_20200709.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/rsync-rootfs_20200608.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/will-it-scale_20201111.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/will-it-scale-x86_64-b695a1b-1_20201111.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/mpstat_20200714.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/perf_20200723.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/perf-x86_64-eccc87672492-1_20201111.cgz,/osimage/pkg/debian-10.4-x86_64-20200603.cgz/sar-x86_64-34c92ae-1_20200702.cgz,/osimage/deps/debian-10.4-x86_64-20200603.cgz/hw_20200715.cgz"
...
kernel: "/pkg/linux/x86_64-rhel-8.3/gcc-9/95f755a4ef7b9ccbedf6012b4112a990120b6a6c/vmlinuz-5.10.0-rc4-00075-g95f755a4ef7b"
dequeue_time: 2020-11-22 10:27:19.419482080 +08:00
job_state: finished
loadavg: 74.42 58.03 26.18 1/1283 13038
start_time: '1606012272'
end_time: '1606012573'
...
do
 ...
 "/lkp/benchmarks/python3/bin/python3" "./runtest.py" "futex3" "295" "process" "96"
