...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1C08A75D690
	for <lists+devicetree@lfdr.de>; Fri, 21 Jul 2023 23:33:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229992AbjGUVc6 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 21 Jul 2023 17:32:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46600 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230475AbjGUVc4 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 21 Jul 2023 17:32:56 -0400
Received: from pidgin.makrotopia.org (pidgin.makrotopia.org [185.142.180.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6816C35A7;
        Fri, 21 Jul 2023 14:32:49 -0700 (PDT)
Received: from local
        by pidgin.makrotopia.org with esmtpsa (TLS1.3:TLS_AES_256_GCM_SHA384:256)
         (Exim 4.96)
        (envelope-from <daniel@makrotopia.org>)
        id 1qMxjo-0004Zw-13;
        Fri, 21 Jul 2023 21:32:36 +0000
Date:   Fri, 21 Jul 2023 22:32:28 +0100
...
Subject: [PATCH net-next v4 3/9] net: ethernet: mtk_eth_soc: add version in
 mtk_soc_data
Message-ID: <89f944e6f8453883074fb71f7802218f66431be9.1689974536.git.daniel@makrotopia.org>
...
index 834c644b67db5..6f27c66c69cba 100644
...
@@ -4809,6 +4809,7 @@ static const struct mtk_soc_data mt7621_data = {
 	.hw_features = MTK_HW_FEATURES,
...
@@ -4829,6 +4830,7 @@ static const struct mtk_soc_data mt7622_data = {
 	.hw_features = MTK_HW_FEATURES,
...
+	.version = 1,
 	...
 	.hash_offset = 2,
 	.has_accounting = true,
@@ -4849,6 +4851,7 @@ static const struct mtk_soc_data mt7623_data = {
 	.hw_features = MTK_HW_FEATURES,
 	.required_clks = MT7623_CLKS_BITMAP,
 	.required_pctl = true,
+	.version = 1,
...
@@ -4908,6 +4913,7 @@ static const struct mtk_soc_data mt7986_data = {
 	.hw_features = MTK_HW_FEATURES,
