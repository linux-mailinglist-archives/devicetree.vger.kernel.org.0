...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D9772574D5D
	for <lists+devicetree@lfdr.de>; Thu, 14 Jul 2022 14:23:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239063AbiGNMXt (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 14 Jul 2022 08:23:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39198 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238955AbiGNMXt (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 14 Jul 2022 08:23:49 -0400
Received: from maillog.nuvoton.com (maillog.nuvoton.com [202.39.227.15])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 162E512C;
        Thu, 14 Jul 2022 05:23:45 -0700 (PDT)
Received: from NTHCCAS04.nuvoton.com (NTHCCAS04.nuvoton.com [10.1.8.29])
        by maillog.nuvoton.com (Postfix) with ESMTP id 55EC51C80FA1;
        Thu, 14 Jul 2022 20:23:44 +0800 (CST)
Received: from NTHCCAS01.nuvoton.com (10.1.8.28) by NTHCCAS04.nuvoton.com
 (10.1.8.29) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2176.2; Thu, 14
 Jul 2022 20:23:43 +0800
Received: from taln60.nuvoton.co.il (10.191.1.180) by NTHCCAS01.nuvoton.com
 (10.1.12.25) with Microsoft SMTP Server id 15.1.2375.7 via Frontend
 Transport; Thu, 14 Jul 2022 20:23:43 +0800
Received: by taln60.nuvoton.co.il (Postfix, from userid 10070)
        id 6978F63A20; Thu, 14 Jul 2022 15:23:42 +0300 (IDT)
...
Subject: [PATCH v2 2/2] pinctrl: nuvoton: add NPCM8XX pinctrl and GPIO driver
Date:   Thu, 14 Jul 2022 15:23:22 +0300
Message-ID: <20220714122322.63663-3-tmaimon77@gmail.com>
X-Mailer: git-send-email 2.33.0
In-Reply-To: <20220714122322.63663-1-tmaimon77@gmail.com>
...
index 852b0d0eb08e..b6a16a483145 100644
--- a/drivers/pinctrl/nuvoton/Kconfig
+++ b/drivers/pinctrl/nuvoton/Kconfig
@@ -31,3 +31,16 @@ config PINCTRL_NPCM7XX
 	help
...
index 000000000000..e560d7b4ec88
--- /dev/null
...
+#define NPCM8XX_GP_N_DIN	0x4
+#define NPCM8XX_GP_N_POL	0x8
+#define NPCM8XX_GP_N_DOUT	0xC
...
+		if (!ret)
+			return dev_err_probe(dev, -EINVAL, "No IRQ for GPIO bank %u\n", id);
+
+		sprintf(gpioirqname, "NPCM8XX-GPIO-IRQ Bank %d", id);
+		npcmgpio_irqchip.name = gpioirqname;
...
+	if (ret < 0)
+		return dev_err_probe(pctrl->dev, ret, "Failed to gpio dt-binding\n");
+
+	pctrl->pctldev = devm_pinctrl_register(&pdev->dev,
+					       &npcm8xx_pinctrl_desc, pctrl);
+	if (IS_ERR(pctrl->pctldev))
+		return dev_err_probe(pctrl->dev, PTR_ERR(pctrl->pctldev), "Failed to register pinctrl device\n");
+
+	ret = npcm8xx_gpio_register(pctrl);
+	if (ret < 0)
+		dev_err_probe(pctrl->dev, ret, "Failed to register gpio\n");
+
+	return 0;
+}
+
