...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 534C92855AB
	for <lists+devicetree@lfdr.de>; Wed,  7 Oct 2020 03:00:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726989AbgJGBAh (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 6 Oct 2020 21:00:37 -0400
Received: from mga14.intel.com ([192.55.52.115]:58198 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726860AbgJGBAh (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Tue, 6 Oct 2020 21:00:37 -0400
IronPort-SDR: AbD623zNLtDd7qOIyDgdNcOjh+93M2CWPZCCp/Y2as0oSitCsnM6joYmrk4EaAlnPIXUeeoFEv
 i8iujeYf+ozw==
X-IronPort-AV: E=McAfee;i="6000,8403,9766"; a="163998011"
X-IronPort-AV: E=Sophos;i="5.77,344,1596524400"; 
   d="scan'208";a="163998011"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 Oct 2020 18:00:36 -0700
IronPort-SDR: RFrvSRsTjEOkmWEYuys3nF/kFDeYN3CY02P3KLjw4RRe/fp08KNirHMT5O0ry6U35Nnh6zuDbc
 Ah7VLmlZJsOg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.77,344,1596524400"; 
   d="scan'208";a="388149542"
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:BY5PR11MB4182.namprd11.prod.outlook.com;PTR:;CAT:NONE;SFS:(4636009)(376002)(366004)(39860400002)(136003)(346002)(396003)(66556008)(64756008)(66946007)(8676002)(9686003)(66446008)(66476007)(966005)(76116006)(71200400001)(478600001)(52536014)(5660300002)(4326008)(54906003)(33656002)(7696005)(55016002)(8936002)(6916009)(6506007)(316002)(53546011)(86362001)(26005)(2906002)(186003)(83380400001)(83080400001);DIR:OUT;SFP:1102;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 07 Oct 2020 01:00:24.6720
 (UTC)
...
> Subject: Re: [PATCH v1] dt-bindings: display: Add support for Intel KeemB=
ay
> Display
>=20
...
>=20
> Don't use '_' either.
Please note that I cannot change the name at this point as there is a depen=
dency on the u-boot firmware which loads the device tree. I can change the =
...
And  bridge =3D of_drm_find_bridge(encoder_node); to locate the bridge driv=
er.
...
> > +    type: object
> > +    description: >
> > +          Port node with one endpoint connected to mipi to hdmi conver=
ter
> node.
> > +
> > +required:
...
> > +      reg =3D <0x20930000 0x3000>,
> > +            <0x20900000 0x4000>,
> > +            <0x20910000 0x30>;
> > +      reg-names =3D "lcd_regs", "mipi_regs", "msscam_regs";
> > +      interrupts =3D <GIC_SPI 33 IRQ_TYPE_LEVEL_HIGH>;
> > +      interrupt-names =3D "irq_lcd";
> > +      clocks =3D <&scmi_clk MOVISOC_KMB_MSS_AUX_LCD>,
...
> > +      clock-names =3D "clk_lcd", "clk_mipi", "clk_mipi_ecfg",
> > +                    "clk_mipi_cfg", "clk_pll0";
> > +
> > +      encoder-slave =3D <&adv7535>;
> > +
> > +      port {
> > +            dsi_output: endpoint {
> > +                remote-endpoint =3D <&adv7535_input>;
> > +            };
> > +      };
> > +    };
> > --
