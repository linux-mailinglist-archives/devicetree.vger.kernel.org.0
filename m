...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6E0B15F171E
	for <lists+devicetree@lfdr.de>; Sat,  1 Oct 2022 02:19:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232787AbiJAATW (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 30 Sep 2022 20:19:22 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35238 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232745AbiJAASy (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 30 Sep 2022 20:18:54 -0400
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 42F262871C;
        Fri, 30 Sep 2022 17:16:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1664583408; x=1696119408;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=HzcLI6QdMOhG36P9dVtnEIo/4Ku9z7i2wrrRwt3UMDg=;
  b=X7xqRjKg3E8eqet86STGxqkswEKNHQcEESiwoX9gNSLskcRiw5uALTRp
   bm1Kp+ZbY4tyHkTOZqZwanzI63JOEii5ODhDvX1Z3MtQwXp7vcnSSXnKT
   7VcpYbKR6+mPtZ+MIhLqp5FAZpSx4AFplxEu5oDDWQWz/+3EftaqGwACi
   MVvm2H+WcVJx+vt2HZlWTlpjK7ejMkysr7KM5nCzi6rig1ITgtnN8zx3m
   CNtp81SDDGq7RI6VMp2c4nOp6pobyi/6uMQxNuY7YjEt/YYdXTkjh39+c
   R+wKoOvAVYQ9enj0+xL4ZuY0wlW+G8SROC/Cvcirgxt/gkYRZCbcbyw6p
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10486"; a="299917246"
X-IronPort-AV: E=Sophos;i="5.93,359,1654585200"; 
   d="scan'208";a="299917246"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Sep 2022 17:16:12 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10486"; a="622949899"
X-IronPort-AV: E=Sophos;i="5.93,359,1654585200"; 
   d="scan'208";a="622949899"
Received: from lkp-server01.sh.intel.com (HELO 14cc182da2d0) ([10.239.97.150])
  by orsmga002.jf.intel.com with ESMTP; 30 Sep 2022 17:16:05 -0700
Received: from kbuild by 14cc182da2d0 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oeQAn-0001fr-0A;
        Sat, 01 Oct 2022 00:16:05 +0000
Date:   Sat, 1 Oct 2022 08:15:42 +0800
...
Message-ID: <202210010821.ixF0AX4s-lkp@intel.com>
References: <20220930153857.299396-10-sebastian.reichel@collabora.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="ApYpFLQOrcL1qPd9"
...
>> drivers/clk/rockchip/rst-rk3588.c:850:6: warning: no previous prototype for function 'rk3588_rst_init' [-Wmissing-prototypes]
   void rk3588_rst_init(struct device_node *np, void __iomem *reg_base)
        ^
   drivers/clk/rockchip/rst-rk3588.c:850:1: note: declare 'static' if the function is not intended to be used outside of this translation unit
   void rk3588_rst_init(struct device_node *np, void __iomem *reg_base)
   ^
   static 
   1 warning generated.
...
# CONFIG_EDAC_ALTERA_QSPI is not set
