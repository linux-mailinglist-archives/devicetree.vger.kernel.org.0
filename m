...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 57DB7124E92
	for <lists+devicetree@lfdr.de>; Wed, 18 Dec 2019 18:00:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727225AbfLRRAV (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 18 Dec 2019 12:00:21 -0500
Received: from hqnvemgate26.nvidia.com ([216.228.121.65]:15686 "EHLO
        hqnvemgate26.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727021AbfLRRAU (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 18 Dec 2019 12:00:20 -0500
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate26.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5dfa5b180001>; Wed, 18 Dec 2019 09:00:08 -0800
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Wed, 18 Dec 2019 09:00:17 -0800
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Wed, 18 Dec 2019 09:00:17 -0800
...
References: <1576613046-17159-1-git-send-email-skomatineni@nvidia.com>
 ...
 <87a6dc02-babf-4857-fb97-dc8149a06cfa@gmail.com>
From:   Sowjanya Komatineni <skomatineni@nvidia.com>
Message-ID: <1a1480ca-5667-bee0-b827-71e70581e613@nvidia.com>
Date:   Wed, 18 Dec 2019 09:00:15 -0800
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.7.2
MIME-Version: 1.0
In-Reply-To: <87a6dc02-babf-4857-fb97-dc8149a06cfa@gmail.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1576688408; bh=qn+2UKo5omSxpJsnusIVEoT9/6nndDKs/EJ+Fp42V2s=;
        h=X-PGP-Universal:Subject:To:CC:References:From:Message-ID:Date:
         User-Agent:MIME-Version:In-Reply-To:X-Originating-IP:
         X-ClientProxiedBy:Content-Type:Content-Transfer-Encoding:
         Content-Language;
        b=
...
> 18.12.2019 18:50, Sowjanya Komatineni =D0=BF=D0=B8=D1=88=D0=B5=D1=82:
...
>>>>>> Tegra PMC has clk_out_1, clk_out_2, and clk_out_3 clocks and current=
ly
...
=A0 BIT(2)
>>>>>>  =C2=A0 #define=C2=A0 PMC_SENSOR_CTRL_ENABLE_RST=C2=A0=C2=A0=C2=A0 B=
IT(1)
>>>>>> @@ -155,6 +160,64 @@
...
>>>>>> +=C2=A0=C2=A0=C2=A0 u32=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 mu=
x_mask;
>>>>>> +=C2=A0=C2=A0=C2=A0 u32=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 mu=
x_shift;
>>>>>> +=C2=A0=C2=A0=C2=A0 u32=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 ga=
te_shift;
>>>>>> +};
>>>>>> +
...
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 .clk_id =3D TEGRA_PMC_CL=
K_OUT_1,
...
>>>>>>  =C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 const struct tegra_wake_event *wake_=
events;
...
>>>>>> +=C2=A0=C2=A0=C2=A0 init.flags =3D CLK_SET_RATE_NO_REPARENT | CLK_SE=
T_RATE_PARENT |
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
...
>>>>> If mux_mask is a constant value, perhaps will be better to replace th=
e
...
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 clk_data->clks[i] =3D ER=
R_PTR(-ENOENT);
>>>>>> +
>>>>>> +=C2=A0=C2=A0=C2=A0 for (i =3D 0; i < pmc->soc->num_pmc_clks; i++) {
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 const struct pmc_clk_ini=
t_data *data;
>>>>>> +
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 data =3D pmc->soc->pmc_c=
lks_data + i;
>>>>>> +
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 clk =3D tegra_pmc_clk_ou=
t_register(data,
>>>>>> PMC_CLK_OUT_CNTRL);> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 if =
(IS_ERR(clk)) {
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 =
dev_err(pmc->dev,
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=
=C2=A0=C2=A0=C2=A0=C2=A0 "unable to register %s\n", data->name);
>>>>>> +=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0=C2=A0 =
err =3D PTR_ERR(clk);
...
Earlier I had WARN message at each of errors during clock registers=20
except during malloc/calloc.

When you suggested to add additional WARN message at the end of clock=20
register in earlier feedback, thought you were suggesting to warn about=20
kmalloc/kcalloc failures.

Probably I misunderstood your suggestion.

Anyways now with moving to devm malloc/calloc, will use dev_warn to show=20
