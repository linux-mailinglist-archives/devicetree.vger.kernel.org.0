...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8CEF317686F
	for <lists+devicetree@lfdr.de>; Tue,  3 Mar 2020 00:48:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726890AbgCBXsf (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 2 Mar 2020 18:48:35 -0500
Received: from mail27.static.mailgun.info ([104.130.122.27]:41909 "EHLO
        mail27.static.mailgun.info" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726728AbgCBXse (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 2 Mar 2020 18:48:34 -0500
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1583192898; h=Message-ID: References: In-Reply-To: Subject:
 Cc: To: From: Date: Content-Transfer-Encoding: Content-Type:
 MIME-Version: Sender; bh=SW/N8mWsQB/KpHD1/4pDjh9MDLOCESCpWfCaQfqV5HE=;
 b=ZVP5eGpSW5tDLseQCq/KxszmAwcowlOmHh8O+7zgIvOxiFut6ZG8wzvm6rikzGVXD4uOfWwI
 9y97bnIq2kJGONH0ILG3/vST9RTKeVWKH9o9QnvQnDEuXucKCjChZhdt1ZrZc1Pb2CardN/Y
 8Iriam2QtQUnCnvBhwRo5sLrVCw=
X-Mailgun-Sending-Ip: 104.130.122.27
X-Mailgun-Sid: WyI1YmJiNiIsICJkZXZpY2V0cmVlQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171])
 by mxa.mailgun.org with ESMTP id 5e5d9b3c.7f2d6c488960-smtp-out-n03;
 Mon, 02 Mar 2020 23:48:12 -0000 (UTC)
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 7EFEBC447A0; Mon,  2 Mar 2020 23:48:11 +0000 (UTC)
...
Received: from mail.codeaurora.org (localhost.localdomain [127.0.0.1])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id 676A1C433A2;
        Mon,  2 Mar 2020 23:47:53 +0000 (UTC)
MIME-Version: 1.0
Content-Type: text/plain; charset=US-ASCII;
 format=flowed
Content-Transfer-Encoding: 7bit
Date:   Mon, 02 Mar 2020 15:47:53 -0800
...
Subject: Re: FW: Re: [DPU PATCH v3 3/5] drm/msm/dp: add displayPort driver
 support
In-Reply-To: <BYAPR02MB5288D92EF7422BF5C86FC45BA9E70@BYAPR02MB5288.namprd02.prod.outlook.com>
...
Message-ID: <72a241e299bb81f0d5246f13814317a2@codeaurora.org>
...
The earlier patchsets of the same series were reviewed by Sean so we 
were spending our efforts addressing the comments based on the earlier 
versions. We think the delay in getting reviews and also posting newer 
versions was not specifically due to the size of the code but also due 
to business reasons around that time. This is the basic version of the 
DP driver where all the files are tightly coupled. We understand that 
this is a big series and we have tried to break it up 
functionality-wise. For example, we are going to post hot-plug related 
changes and some more functionality like audio in a later patch. Also, 
we shall be posting a newer version of this series within a day or two 
which shall address the comments posted so far along with the checkpatch 
fixes and changes needed to make DP work on Trogdor. Hence we request 
that the new version which shall be posted be reviewed first and if 
there is some split-up which can be done further, let us know and we 
shall try to address that in the next patchsets.
...
> been reviewed in almost 3 months is its size, 8k LOC. I would suggest 
> to
...
> 
> And please make sure to run scripts/checkpatch.pl before sending 
> patches
