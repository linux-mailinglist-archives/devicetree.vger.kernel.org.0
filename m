...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DE1D43433DA
	for <lists+devicetree@lfdr.de>; Sun, 21 Mar 2021 18:47:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230167AbhCURq6 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 21 Mar 2021 13:46:58 -0400
Received: from mx3.wp.pl ([212.77.101.10]:60806 "EHLO mx3.wp.pl"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230009AbhCURq0 (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Sun, 21 Mar 2021 13:46:26 -0400
X-Greylist: delayed 406 seconds by postgrey-1.27 at vger.kernel.org; Sun, 21 Mar 2021 13:46:26 EDT
Received: (wp-smtpd smtp.wp.pl 24900 invoked from network); 21 Mar 2021 18:39:39 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=wp.pl; s=1024a;
          t=1616348379; bh=XE51Lmua6or/WbeEagDiHeQ6M5ORLlAU0e6Xl7ffKqo=;
          h=From:To:Cc:Subject;
          b=DupqAPwn3ujAOJ0JFVB/GIXkd9hSmdigWk36LowsjOdkZpwJhZKXQafK6lOPKqwi+
           hV+c/h8rpayJ7RJSTXLjzJRA4IWl3WIeFWBz95PdjpGiGNz6/IX2puC9lFD+Zs1sxm
           xo4L3W6iMs+7ppWSRfptO4rL9CZdRN+I4rLvIK9o=
Received: from riviera.nat.ds.pw.edu.pl (HELO LAPTOP-OLEK.lan) (olek2@wp.pl@[194.29.137.1])
          (envelope-sender <olek2@wp.pl>)
          by smtp.wp.pl (WP-SMTPD) with ECDHE-RSA-AES256-GCM-SHA384 encrypted SMTP
          for <hauke@hauke-m.de>; 21 Mar 2021 18:39:39 +0100
...
Subject: [PATCH v3 1/3] net: dsa: lantiq: allow to use all GPHYs on xRX300 and xRX330
Date:   Sun, 21 Mar 2021 18:39:20 +0100
Message-Id: <20210321173922.2837-2-olek2@wp.pl>
...
X-WP-MailID: 04582acbe07fba8dbfe74a7c7e5ead6c
X-WP-AV: skaner antywirusowy Poczty Wirtualnej Polski
X-WP-SPAM: NO 0000001 [gSIm]                               
Precedence: bulk
...
@@ -1943,13 +2018,22 @@ static int gswip_remove(struct platform_device *pdev)
 	return 0;
 }
 
-static const struct gswip_hw_info gswip_xrx200 = {
+static struct gswip_hw_info gswip_xrx200 = {
+	.max_ports = 7,
+	.cpu_port = 6,
+	.ops = &gswip_xrx200_switch_ops,
+};
+
+static struct gswip_hw_info gswip_xrx300 = {
 	.max_ports = 7,
 	.cpu_port = 6,
