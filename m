...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E047D6084EF
	for <lists+devicetree@lfdr.de>; Sat, 22 Oct 2022 08:08:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229919AbiJVGIM (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 22 Oct 2022 02:08:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53730 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229920AbiJVGIL (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 22 Oct 2022 02:08:11 -0400
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5A04F2B4155;
        Fri, 21 Oct 2022 23:08:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666418887; x=1697954887;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=fgLUM/U2yjrodukfoWjL3wLfwVcnb9hBYptjMzxztSA=;
  b=eQJ//U+0F3o2DzRzzbP2cEPXF6W6E5y5MRqyjlsqopw515WY840KcKd3
   109Y3v61JtGw4Ln1BNfENgxXYD0OlXQ+edzLkXhzdgVgrk7aVi4VaNgOz
   7snuTR1EpjOHRhax275H2FHmHZdKYRf+J1Uzlrs0SwcbrEu3lTjilrvXB
   RFVfxhQ+exOltJxrHfOP7Lqi6/IuoYHilgAGZenJInkw/LewBy4hjOZDq
   aeBwDAcCiaaxPTXVMnGTR9I3eRLqixnVT8Staqxo5Yz+/q4w9AqHyql7N
   tAdhDRMxZNdQHqwnVgznaE0N2B1xJc2gactkhzF4YbQ6h1VykAToM2kX0
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10507"; a="371381879"
X-IronPort-AV: E=Sophos;i="5.95,204,1661842800"; 
   d="scan'208";a="371381879"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Oct 2022 23:08:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10507"; a="581843391"
X-IronPort-AV: E=Sophos;i="5.95,204,1661842800"; 
   d="scan'208";a="581843391"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by orsmga003.jf.intel.com with ESMTP; 21 Oct 2022 23:08:02 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1om7ft-0003ON-2Z;
        Sat, 22 Oct 2022 06:08:01 +0000
Date:   Sat, 22 Oct 2022 14:07:41 +0800
...
Message-ID: <202210221414.T4iHGbE4-lkp@intel.com>
References: <20221019133910.282-1-Ibrahim.Tilki@analog.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="BekvNSBAymL2Ix8h"
...
config: arm-randconfig-p002-20221022
...
All errors (new ones prefixed by >>):
   ...
   arm-linux-gnueabi-ld: arm-linux-gnueabi-ld: DWARF error: could not find abbrev number 454131909
   drivers/rtc/rtc-max313xx.o: in function `max313xx_probe':
>> rtc-max313xx.c:(.text+0x13ec): undefined reference to `devm_hwmon_device_register_with_info'
>> arm-linux-gnueabi-ld: rtc-max313xx.c:(.text+0x147a): undefined reference to `devm_watchdog_register_device'
