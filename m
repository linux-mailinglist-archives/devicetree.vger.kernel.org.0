...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8DB1312F868
	for <lists+devicetree@lfdr.de>; Fri,  3 Jan 2020 13:45:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727539AbgACMon (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Jan 2020 07:44:43 -0500
Received: from hqnvemgate26.nvidia.com ([216.228.121.65]:18159 "EHLO
        hqnvemgate26.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727494AbgACMom (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 3 Jan 2020 07:44:42 -0500
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate26.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5e0f37250000>; Fri, 03 Jan 2020 04:44:21 -0800
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Fri, 03 Jan 2020 04:44:37 -0800
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Fri, 03 Jan 2020 04:44:37 -0800
Received: from HQMAIL101.nvidia.com (172.20.187.10) by HQMAIL105.nvidia.com
 (172.20.187.12) with Microsoft SMTP Server (TLS) id 15.0.1473.3; Fri, 3 Jan
 2020 12:44:36 +0000
Received: from hqnvemgw03.nvidia.com (10.124.88.68) by HQMAIL101.nvidia.com
 (172.20.187.10) with Microsoft SMTP Server (TLS) id 15.0.1473.3 via Frontend
 Transport; Fri, 3 Jan 2020 12:44:36 +0000
Received: from vidyas-desktop.nvidia.com (Not Verified[10.24.37.48]) by hqnvemgw03.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5e0f37300000>; Fri, 03 Jan 2020 04:44:35 -0800
...
Subject: [PATCH V2 3/5] PCI: tegra: Add support for PCIe endpoint mode in Tegra194
Date:   Fri, 3 Jan 2020 18:14:02 +0530
Message-ID: <20200103124404.20662-4-vidyas@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1578055461; bh=xbD/0+YglJOi8Hm79EGyUu8gA94Zk4i9fVB7WpklkME=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:X-NVConfidentiality:MIME-Version:
         Content-Type;
        b=
...
@@ -884,8 +994,26 @@ static void tegra_pcie_set_msi_vec_num(struct pcie_port *pp)
...
@@ -935,6 +1063,7 @@ static int tegra_pcie_enable_phy(struct tegra_pcie_dw *pcie)
...
+
+	name = devm_kasprintf(pcie->dev, GFP_KERNEL,
+			      "tegra_pcie_%u_refclk_select_gpios", pcie->cid);
+	if (!name) {
+		dev_err(pcie->dev, "Failed to create REFCLK select GPIO string\n");
+		return -ENOMEM;
+	}
+	pcie->pex_refclk_sel_gpiod = devm_gpiod_get_from_of_node(pcie->dev, np,
...
@@ -1017,6 +1182,34 @@ static int tegra_pcie_bpmp_set_ctrl_state(struct tegra_pcie_dw *pcie,
