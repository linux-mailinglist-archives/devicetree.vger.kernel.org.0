...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 2163B11C45B
	for <lists+devicetree@lfdr.de>; Thu, 12 Dec 2019 04:50:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727467AbfLLDpg (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 11 Dec 2019 22:45:36 -0500
Received: from hqnvemgate25.nvidia.com ([216.228.121.64]:14482 "EHLO
        hqnvemgate25.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727407AbfLLDpg (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 11 Dec 2019 22:45:36 -0500
Received: from hqpgpgate102.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate25.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5df1b7d70001>; Wed, 11 Dec 2019 19:45:27 -0800
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate102.nvidia.com (PGP Universal service);
  Wed, 11 Dec 2019 19:45:34 -0800
X-PGP-Universal: processed;
        by hqpgpgate102.nvidia.com on Wed, 11 Dec 2019 19:45:34 -0800
...
Message-ID: <01bf40ae-393d-3cb1-9ba2-acdd10385cb8@nvidia.com>
Date:   Wed, 11 Dec 2019 19:45:31 -0800
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.7.2
MIME-Version: 1.0
In-Reply-To: <02109d70-2747-c246-5401-69a2d5c84771@gmail.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1576122327; bh=b3mpMik1+G+W/AUoZ42C8rOMX06OvOzuq5SW7MV23vw=;
        h=X-PGP-Universal:Subject:To:CC:References:From:Message-ID:Date:
         User-Agent:MIME-Version:In-Reply-To:X-Originating-IP:
         X-ClientProxiedBy:Content-Type:Content-Transfer-Encoding:
         Content-Language;
        b=
...
>>>>>>>>>>>>> it,
>>>>>>>>>>>>> correct?
>>>>>>>>> Was following existing clk-tegra-pmc as I am not sure of reason f=
or
...
>>>>>>>>>>
>>>>>> Reg clk_m_div2/3, they are dividers at OSC pad and not really intern=
al
>>>>>> to PMC block.
>>>>>>
>>>>>> current clock driver creates clk_m_div clocks which should actually =
be
...
>>>>>>>
>>>>>>> EXTPERIPH is from CAR and it has reset and enable controls along wi=
th
...
>>>>>>> Pinmux logic or driven as per CLKx_SRC_SEL bypassing pinmux based o=
n
>>>>>>> CLKx_ACCEPT_REQ bit.
>>>>>>>
>>>>>>>
>>>>>>> PMC Clock control register has bit CLKx_ACCEPT_REQ
>>>>>>> When CLKx_ACCEPT_REQ =3D 0, output clock driver is from by EXTPERIP=
H
>>>>>>> through the pinmux
>>>>>>> When CLKx_ACCEPT_REQ =3D 1, output clock is based on CLKx_SRC_SEL b=
its
...
configuration based on presence of assigned-clock-parents property is to=20
have old dt compatible with new kernel and also to have new dt=20
compatible with old kernel.

So the point I was mentioning is to have new DT to work with old kernel,=20
setting extern1 as parent to clk_out_1 (with single pmc clock) through=20
assigned-clock-parents in DT will fail as old kernel has mux and gate as=20
