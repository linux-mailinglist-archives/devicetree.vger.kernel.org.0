...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A9888279560
	for <lists+devicetree@lfdr.de>; Sat, 26 Sep 2020 02:07:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726119AbgIZAHa (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 25 Sep 2020 20:07:30 -0400
Received: from mail.v3.sk ([167.172.186.51]:38512 "EHLO shell.v3.sk"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1729505AbgIZAH3 (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Fri, 25 Sep 2020 20:07:29 -0400
Received: from localhost (localhost.localdomain [127.0.0.1])
        by zimbra.v3.sk (Postfix) with ESMTP id 87D03DFAA1;
        Sat, 26 Sep 2020 00:05:49 +0000 (UTC)
Received: from shell.v3.sk ([127.0.0.1])
        by localhost (zimbra.v3.sk [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id g3hiR75VxRn4; Sat, 26 Sep 2020 00:05:48 +0000 (UTC)
Received: from localhost (localhost.localdomain [127.0.0.1])
        by zimbra.v3.sk (Postfix) with ESMTP id 6679DDFA3C;
        Sat, 26 Sep 2020 00:05:48 +0000 (UTC)
X-Virus-Scanned: amavisd-new at zimbra.v3.sk
Received: from shell.v3.sk ([127.0.0.1])
        by localhost (zimbra.v3.sk [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id vLhaOq_ud8fM; Sat, 26 Sep 2020 00:05:47 +0000 (UTC)
Received: from localhost (unknown [109.183.109.54])
        by zimbra.v3.sk (Postfix) with ESMTPSA id C50A4DFAA2;
...
Subject: [RESEND PATCH v5 2/2] drm/bridge: hx8837: add a Himax HX8837 display controller driver
Date:   Sat, 26 Sep 2020 02:07:19 +0200
Message-Id: <20200926000719.229204-3-lkundrak@v3.sk>
