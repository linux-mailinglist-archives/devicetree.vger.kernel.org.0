...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0D2CA77894B
	for <lists+devicetree@lfdr.de>; Fri, 11 Aug 2023 10:54:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234571AbjHKIyL (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 11 Aug 2023 04:54:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35006 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234579AbjHKIyK (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 11 Aug 2023 04:54:10 -0400
Received: from mx1.tq-group.com (mx1.tq-group.com [93.104.207.81])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B3B55E73
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  ...
  bh=K9KXpH+DvS+xHsbIIkM8PFDCh1ZPggKSjFz5F1kR0rw=;
  b=Rj8uiK/Efms15Eqd7Et60HFJd3raDBxitcSJxn4gI9HAIErMdSbt44HT
   yAbf3wlZj4LZ7r5yEX29rnLBz1/LEIlyNcaEGYU2Spotnc0lr/t39oAF3
   sF2S1yZ5d8Z2/pDc3ZYa9leaGMh0/1M/AHBf+c29pIXNcQs3p3mG0E5l5
   vigy885a7obKDducIq+wjPTmY4ffUAWh5CfvSncwyeAlAF14XuGwPuBck
   HV/tkhQLtt1VbHyND5pne8GYxwQtVfsALC7+eV5zvONXNX+Tl+QQBUK+O
   h6x1S++TuY8lT4u7OgIVP1e8fBpVdY29xAECKqdhwLctW5H+xSXQRIo8o
   g==;
X-IronPort-AV: E=Sophos;i="6.01,165,1684792800"; 
   d="scan'208";a="32409002"
...
Received: from steina-w.tq-net.de (steina-w.tq-net.de [10.123.53.21])
        ...
        by vtuxmail01.tq-net.de (Postfix) with ESMTPSA id 879F728008C;
...
Subject: [PATCH 3/3] arm64: dts: freescale: add initial device tree for MBa93xxCA starter kit
Date:   Fri, 11 Aug 2023 10:54:01 +0200
Message-Id: <20230811085401.3856778-4-alexander.stein@ew.tq-group.com>
...
index 95f039d94435..f46c5b5e8178 100644
--- a/arch/arm64/boot/dts/freescale/Makefile
+++ b/arch/arm64/boot/dts/freescale/Makefile
@@ -145,6 +145,7 @@ dtb-$(CONFIG_ARCH_MXC) += imx8qxp-colibri-iris-v2.dtb
...
index 000000000000..a7ee95de93da
--- /dev/null
