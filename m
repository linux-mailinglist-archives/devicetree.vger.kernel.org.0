...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id CEA2623C1A
	for <lists+devicetree@lfdr.de>; Mon, 20 May 2019 17:28:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390963AbfETP2F (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 20 May 2019 11:28:05 -0400
Received: from mx07-00178001.pphosted.com ([62.209.51.94]:55284 "EHLO
        mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S2388226AbfETP1y (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Mon, 20 May 2019 11:27:54 -0400
Received: from pps.filterd (m0046668.ppops.net [127.0.0.1])
        by mx07-00178001.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id x4KFLUFE002106;
        Mon, 20 May 2019 17:27:19 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=st.com; h=from : to : cc : subject
 : date : message-id : references : in-reply-to : content-type :
 content-transfer-encoding : mime-version; s=STMicroelectronics;
 bh=Z9x1RsoFBv1VevDzyNrpT9CEsTNBt+qZC3x8CkrHJ1g=;
 b= Dw== 
Received: from beta.dmz-eu.st.com (beta.dmz-eu.st.com [164.129.1.35])
        by mx07-00178001.pphosted.com with ESMTP id 2sj7h0mb1x-1
        (version=TLSv1 cipher=ECDHE-RSA-AES256-SHA bits=256 verify=NOT);
        Mon, 20 May 2019 17:27:19 +0200
Received: from zeta.dmz-eu.st.com (zeta.dmz-eu.st.com [164.129.230.9])
        by beta.dmz-eu.st.com (STMicroelectronics) with ESMTP id 30CA73D;
        Mon, 20 May 2019 15:27:18 +0000 (GMT)
Received: from Webmail-eu.st.com (sfhdag3node3.st.com [10.75.127.9])
        by zeta.dmz-eu.st.com (STMicroelectronics) with ESMTP id F082C2BAC;
        Mon, 20 May 2019 15:27:17 +0000 (GMT)
Received: from SFHDAG5NODE1.st.com (10.75.127.13) by SFHDAG3NODE3.st.com
 (10.75.127.9) with Microsoft SMTP Server (TLS) id 15.0.1347.2; Mon, 20 May
 2019 17:27:17 +0200
...
Subject: [PATCH v2 3/5] perf: stm32: ddrperfm driver creation
Thread-Topic: [PATCH v2 3/5] perf: stm32: ddrperfm driver creation
Thread-Index: AQHVDyCCI5Cs89crU0SFN7k5vdHanA==
Date:   Mon, 20 May 2019 15:27:17 +0000
Message-ID: <1558366019-24214-4-git-send-email-gerald.baeza@st.com>
