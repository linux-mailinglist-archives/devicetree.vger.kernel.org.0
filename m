...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 602391AD0CE
	for <lists+devicetree@lfdr.de>; Thu, 16 Apr 2020 22:06:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731468AbgDPUFb (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 16 Apr 2020 16:05:31 -0400
Received: from mx0b-001b2d01.pphosted.com ([148.163.158.5]:2302 "EHLO
        mx0a-001b2d01.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1730782AbgDPUEA (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Thu, 16 Apr 2020 16:04:00 -0400
Received: from pps.filterd (m0098414.ppops.net [127.0.0.1])
        by mx0b-001b2d01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 03GK2ueH138702;
        Thu, 16 Apr 2020 16:03:52 -0400
Received: from ppma02dal.us.ibm.com (a.bd.3ea9.ip4.static.sl-reverse.com [169.62.189.10])
        by mx0b-001b2d01.pphosted.com with ESMTP id 30ewy4g58u-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 16 Apr 2020 16:03:51 -0400
Received: from pps.filterd (ppma02dal.us.ibm.com [127.0.0.1])
        by ppma02dal.us.ibm.com (8.16.0.27/8.16.0.27) with SMTP id 03GK0vTG023445;
        Thu, 16 Apr 2020 20:03:51 GMT
Received: from b01cxnp23032.gho.pok.ibm.com (b01cxnp23032.gho.pok.ibm.com [9.57.198.27])
        by ppma02dal.us.ibm.com with ESMTP id 30b5h7g0y5-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 16 Apr 2020 20:03:51 +0000
Received: from b01ledav006.gho.pok.ibm.com (b01ledav006.gho.pok.ibm.com [9.57.199.111])
        by b01cxnp23032.gho.pok.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 03GK3otX35127612
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Thu, 16 Apr 2020 20:03:50 GMT
Received: from b01ledav006.gho.pok.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 2BC82AC064;
        Thu, 16 Apr 2020 20:03:50 +0000 (GMT)
Received: from b01ledav006.gho.pok.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 1A64DAC062;
        Thu, 16 Apr 2020 20:03:48 +0000 (GMT)
Received: from talon7.ibm.com (unknown [9.163.81.122])
        by b01ledav006.gho.pok.ibm.com (Postfix) with ESMTP;
        Thu, 16 Apr 2020 20:03:47 +0000 (GMT)
From:   Eddie James <eajames@linux.ibm.com>
To:     linux-aspeed@lists.ozlabs.org
Cc:     linux-kernel@vger.kernel.org, devicetree@vger.kernel.org,
        robh+dt@kernel.org, joel@jms.id.au, andrew@aj.id.au,
        eajames@linux.ibm.com
Subject: [PATCH v9 3/5] soc: aspeed: xdma: Add user interface
Date:   Thu, 16 Apr 2020 15:03:37 -0500
Message-Id: <1587067419-5107-4-git-send-email-eajames@linux.ibm.com>
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 impostorscore=0
 ...
 suspectscore=4 lowpriorityscore=0 clxscore=1015 bulkscore=0 adultscore=0
...
---
 drivers/soc/aspeed/aspeed-xdma.c | 197 +++++++++++++++++++++++++++++++++++++++
 1 file changed, 197 insertions(+)

diff --git a/drivers/soc/aspeed/aspeed-xdma.c b/drivers/soc/aspeed/aspeed-xdma.c
index c1087f3..41506ed 100644
...
@@ -230,6 +231,8 @@ struct aspeed_xdma {
 	void *cmdq_virt;
...
@@ -555,6 +558,187 @@ static irqreturn_t aspeed_xdma_pcie_irq(int irq, void *arg)
 	return IRQ_HANDLED;
 }
...
@@ -754,6 +938,18 @@ static int aspeed_xdma_probe(struct platform_device *pdev)
...
@@ -784,6 +980,7 @@ static int aspeed_xdma_remove(struct platform_device *pdev)
 {
