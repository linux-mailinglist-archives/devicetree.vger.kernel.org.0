...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E52FA63882B
	for <lists+devicetree@lfdr.de>; Fri, 25 Nov 2022 12:03:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230351AbiKYLD1 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 25 Nov 2022 06:03:27 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58736 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230358AbiKYLD0 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 25 Nov 2022 06:03:26 -0500
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2E9264A5A7;
        Fri, 25 Nov 2022 03:03:23 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669374203; x=1700910203;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=aRDNwm41h45Pt8djqEYN1wyithS4BEq1CsCccmfCTPM=;
  b=TuK9F2f85Q4Ru2f7jt79WKeHo0WUcRbDNMvGEFNiRDGSDJGOtZtH96Q2
   6L0kIIzZBBrP5+LkEiJKB7ygB2Hw3u4afSwgg6SZsi94d4ZGtcfnze0rA
   ddl3W4u+j8Y809S5iauDngD7yCE0QHqjCLv37SgsfvHGQXRLa/8/1Q22t
   O1iQOC+usuWY+1zeG2jy0yAvESl5d2Sk/uQZx9S4YB+hggWH7d7FPEhcm
   9atoQdhCoTB/D1+JD+66+dpJYSN9EOxJ+yPWET8DZytuaZGNzuOw/qLek
   h0eYTV2lDPDocziYo2Q9Tj8VsDhq0Gr0yxRHPpmM0YkpZvfp6WODcNreH
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10541"; a="312097471"
X-IronPort-AV: E=Sophos;i="5.96,193,1665471600"; 
   d="scan'208";a="312097471"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Nov 2022 03:03:22 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10541"; a="711240271"
X-IronPort-AV: E=Sophos;i="5.96,193,1665471600"; 
   d="scan'208";a="711240271"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by fmsmga004.fm.intel.com with ESMTP; 25 Nov 2022 03:03:18 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oyWUH-00053l-2N;
        Fri, 25 Nov 2022 11:03:17 +0000
Date:   Fri, 25 Nov 2022 19:02:46 +0800
...
Subject: Re: [PATCH V3 4/5] i2c: ls2x: Add driver for Loongson-2K/LS7A I2C
 controller
Message-ID: <202211251857.UCYqr1oD-lkp@intel.com>
References: <822356908305580d601e5b3e424371ed7f220b85.1669359515.git.zhoubinbin@loongson.cn>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="PwetaU6UbHtfS8wS"
...
url:    https://github.com/intel-lab-lkp/linux/commits/Binbin-Zhou/i2c-ls2x-Add-support-for-the-Loongson-2K-LS7A-I2C-controller/20221125-170819
base:   https://git.kernel.org/pub/scm/linux/kernel/git/wsa/linux.git i2c/for-next
patch link:    https://lore.kernel.org/r/822356908305580d601e5b3e424371ed7f220b85.1669359515.git.zhoubinbin%40loongson.cn
patch subject: [PATCH V3 4/5] i2c: ls2x: Add driver for Loongson-2K/LS7A I2C controller
config: sparc-allyesconfig
compiler: sparc64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/9c4f16f40329e912c921092cb6f2b4725d969901
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Binbin-Zhou/i2c-ls2x-Add-support-for-the-Loongson-2K-LS7A-I2C-controller/20221125-170819
        git checkout 9c4f16f40329e912c921092cb6f2b4725d969901
...
All warnings (new ones prefixed by >>):
   ...
   drivers/i2c/busses/i2c-ls2x.c: In function 'ls2x_i2c_xfer_one':
>> drivers/i2c/busses/i2c-ls2x.c:164:18: warning: variable 'ret2' set but not used [-Wunused-but-set-variable]
     164 |         int ret, ret2;
         |                  ^~~~


vim +/ret2 +164 drivers/i2c/busses/i2c-ls2x.c

   160	
   161	static int ls2x_i2c_xfer_one(struct i2c_adapter *adap,
   162				struct i2c_msg *msg, bool stop)
   163	{
 > 164		int ret, ret2;
   165		bool is_read = msg->flags & I2C_M_RD;
   166	
   167		ret = ls2x_i2c_start(adap, msg);
   168		if (ret)
   169			return ret;
   170	
   171		if (is_read)
   172			ret = ls2x_i2c_rx(adap, msg->buf, msg->len);
   173		else
   174			ret = ls2x_i2c_tx(adap, msg->buf, msg->len);
   175	
   176		/* could not acquire bus. bail out without STOP */
   177		if (ret == -EAGAIN)
   178			return ret;
   179	
   180		if (stop)
   181			ret2 = ls2x_i2c_stop(adap);
   182	
   183		return ret;
   184	}
   185	
