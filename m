...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6357346C65C
	for <lists+devicetree@lfdr.de>; Tue,  7 Dec 2021 22:09:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241734AbhLGVMx (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 7 Dec 2021 16:12:53 -0500
Received: from mout.gmx.net ([212.227.17.20]:43023 "EHLO mout.gmx.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S241769AbhLGVMj (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Tue, 7 Dec 2021 16:12:39 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=gmx.net;
        s=badeba3b8450; t=1638911338;
        bh=TSUe7hr/WBrDf46jzIs5Gq+0tXOKFoFSvTk4PJ/4hEA=;
        h=X-UI-Sender-Class:From:To:Cc:Subject:Date:In-Reply-To:References;
        b=KpoACaau4T7hYg231CxFk8YPc10lnceDhT7KQlHdCQIwYuR2YgSJOglwCa3utXscU
         xtq4D685uMLDA3kIXO9GboOsuIwdrwhR+6VLY9bjSAqrGe4eyjR2N279EWtWTbviAw
         3Z4Zx9ZfRPf9HZjwzCcjQYRx/ahsOytnhWnFHghQ=
X-UI-Sender-Class: 01bb95c1-4bf8-414a-932a-4f6e2808ef9c
Received: from longitude ([5.146.194.160]) by mail.gmx.net (mrgmx104
 [212.227.17.168]) with ESMTPSA (Nemesis) id 1Mw9QC-1mbnLR32ii-00s3OO; Tue, 07
 Dec 2021 22:08:57 +0100
...
Subject: [PATCH v2 5/8] pinctrl: nuvoton: Add driver for WPCM450
Date:   Tue,  7 Dec 2021 22:08:20 +0100
...
X-Provags-ID: V03:K1:QeqsC329B5FrkOzDfZhQlayciMWw8h9zkeZu/LWtd259UA/hGk4
 6nr/l0ps3Er+CigtTLXNu/ja4tmYMF9MUtsPsNsL/va1uu5ChNt+ddsTFWeOq4KuDWJpCl8
 l/fGRRHa3X1h6XtZzlWA+JIoYXhT/eqy/NxTytO3LP2BZMshoE7ZlPHj3qVzOB3biDQnYqg
 1p6VuWOyIdEnvtUP63WaQ==
X-Spam-Flag: NO
X-UI-Out-Filterresults: notjunk:1;V03:K0:fH1w3fisNJk=:Vs2Xg8X/C8qD72ONFPUxry
 
 ...
 iEnkDUuVs6g1zILByDGBZEALthCW2cMkhv6UpSEusSyc54kphBlvQhpHygTXoGRniST1K6C2W
 BBq16ooC6nw3Cs=
Precedence: bulk
...
+		}
+
+		ret =3D fwnode_property_read_u32_array(np, "nuvoton,interrupt-map",
...
+		}
+
+		ret =3D gpiochip_add_pin_range(&gpio->gc, dev_name(pctrl->dev),
