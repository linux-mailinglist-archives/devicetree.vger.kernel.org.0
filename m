...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 960DAA549B
	for <lists+devicetree@lfdr.de>; Mon,  2 Sep 2019 13:02:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730013AbfIBLCB (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 2 Sep 2019 07:02:01 -0400
Received: from mo4-p02-ob.smtp.rzone.de ([85.215.255.81]:24513 "EHLO
        mo4-p02-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731144AbfIBLCA (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 2 Sep 2019 07:02:00 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1567422116;
        s=strato-dkim-0002; d=goldelico.com;
        h=References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=y6d8yUncj9yKT4vPDXI1EkBvhxcQKzs69RFC22lGlXA=;
        b=
X-RZG-AUTH: ":JGIXVUS7cutRB/49FwqZ7WcJeFKiMhflhwDubTJ9o1mfYzBGHXL8GTnvuHRT"
X-RZG-CLASS-ID: mo00
Received: from iMac.fritz.box
        by smtp.strato.de (RZmta 44.27.0 DYNA|AUTH)
        with ESMTPSA id u036f9v82AtqPvi
...
Subject: [RFC 1/5] cpufreq: ti-cpufreq: add support for omap34xx and omap36xx
Date:   Mon,  2 Sep 2019 12:55:47 +0200
Message-Id: <01a2f0db82bbed4cc8f7b04d8d4e1d7108c8f4bd.1567421750.git.hns@goldelico.com>
...
the register values using ioremap() if syscon access fails.
...
index 2ad1ae17932d..5c5ca4577093 100644
...
+	else if (ret) {
 		dev_err(dev,
 			...
 			ret);
@@ -190,6 +268,10 @@ static const struct of_device_id ti_cpufreq_of_match[] = {
