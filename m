...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 749906D2800
	for <lists+devicetree@lfdr.de>; Fri, 31 Mar 2023 20:45:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232710AbjCaSpr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 31 Mar 2023 14:45:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50230 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229529AbjCaSpq (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 31 Mar 2023 14:45:46 -0400
Received: from mail-qv1-xf34.google.com (mail-qv1-xf34.google.com [IPv6:2607:f8b0:4864:20::f34])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 14E561D876
        for <devicetree@vger.kernel.org>; Fri, 31 Mar 2023 11:45:42 -0700 (PDT)
Received: by mail-qv1-xf34.google.com with SMTP id m16so16936934qvi.12
        for <devicetree@vger.kernel.org>; Fri, 31 Mar 2023 11:45:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ndufresne-ca.20210112.gappssmtp.com; s=20210112; t=1680288341;
        h=mime-version:user-agent:content-transfer-encoding:references
         :in-reply-to:date:cc:to:from:subject:message-id:from:to:cc:subject
         :date:message-id:reply-to;
        bh=9jUgpkdsMyGbUEywR1LLgn50uWcjp64enTc/rgPHAlg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1680288341;
        h=mime-version:user-agent:content-transfer-encoding:references
         :in-reply-to:date:cc:to:from:subject:message-id:x-gm-message-state
         :from:to:cc:subject:date:message-id:reply-to;
        bh=9jUgpkdsMyGbUEywR1LLgn50uWcjp64enTc/rgPHAlg=;
        b=
X-Gm-Message-State: AAQBX9dwMxQqO0y/wue+KfDFhJZjyfHGTWozjbUDrVjqLnL8di47nEqK
        tJ0BD7i9r+2SqPutnoI8TWu8KQ==
X-Google-Smtp-Source: AKy350ZPyheKI//EbEFPmk/g5BQlsc3K7EFWjxFwdciuq7Uk6xY2jD/cQf673nCai+R/bL+YdZc0DA==
X-Received: by 2002:a05:6214:d83:b0:5b6:eef9:b8f7 with SMTP id e3-20020a0562140d8300b005b6eef9b8f7mr41252070qve.6.1680288340494;
        Fri, 31 Mar 2023 11:45:40 -0700 (PDT)
Received: from nicolas-tpx395.localdomain ([2606:6d00:15:a07e::580])
        by smtp.gmail.com with ESMTPSA id mb7-20020a056214550700b005dd8b934594sm791650qvb.44.2023.03.31.11.45.39
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 31 Mar 2023 11:45:40 -0700 (PDT)
Message-ID: <cad2f43d06fd65735aba23dbd2b152954fb1212a.camel@ndufresne.ca>
...
Date:   Fri, 31 Mar 2023 14:45:38 -0400
...
Le lundi 30 janvier 2023 =C3=A0 20:38 +0800, Xiaoyong Lu a =C3=A9crit=C2=A0=
:
> Add mediatek av1 decoder linux driver which use the stateless API in
> MT8195.
>=20

I think this no longer needs an RFC tag. While at it, it would be nice for =
the
maintainer to rebase on top if latest media stage (you still have to pull t=
he
uAPI of course).
...
Please, don't forget to include your fluster test result here too. Fluster =
has 3
test suites, you should provide the score for each of them, and perhaps exp=
lain
the failures if any (I think 10bit/422/444 is what remains, and is unsuppor=
ted
atm).

Also, don't forget to double check with checkpatch (with --strict) to make =
sure
you have no style issue.

>=20
> - change V4L2_CID_STATELESS_AV1_PROFILE to V4L2_CID_MPEG_VIDEO_AV1_PROFIL=
E,
> V4L2_CID_STATELESS_AV1_LEVEL to V4L2_CID_MPEG_VIDEO_AV1_LEVEL to match av=
1 uAPI V4.
> - remove vsi and ctx null check in vdec_av1_slice_init_cdf_table, vdec_av=
1_slice_init_iq_table for the never true condition.
> - add inline in function vdec_av1_slice_clear_fb, vdec_av1_slice_vsi_from=
_remote,
> vdec_av1_slice_vsi_to_remote, vdec_av1_slice_setup_state, vdec_av1_slice_=
setup_operating_mode and vdec_av1_slice_get_dpb_size.
> - remove fb_idx check in vdec_av1_slice_decrease_ref_count.
> - add define AV1_CDF_TABLE_BUFFER_SIZE for magic number 16384.
> - remove intermediate variable "size" at the end of vdec_av1_slice_alloc_=
working_buffer.
> - use define V4L2_AV1_WARP_MODEL_AFFINE to replace magic number 3 in vdec=
_av1_slice_setup_gm.
> - change api name vdec_av1_slice_get_relative_dist to vdec_av1_slice_get_=
sign_bias and return 0 or 1 for the caller directly use.
...
> - Add newline before return statememt in vdec_av1_slice_init and vdec_av1=
_slice_flush.
> - remove work_buffer assignment and merge 3 loops with one in vdec_av1_sl=
ice_alloc_working_buffer.
> - remove va null check in vdec_av1_slice_free_working_buffer.
> - swap order between vdec_av1_slice_clear_fb and vdec_msg_queue_wait_lat_=
buf_full in vdec_av1_slice_flush.
...
> - use ARRAY_SIZE to replace size for loop_filter_level and loop_filter_mo=
de_deltas
...
>      message-id: 20230103154832.6982-1-daniel.almeida@collabora.com
>=20
...
>  create mode 100644 drivers/media/platform/mediatek/vcodec/vdec/vdec_av1_=
req_lat_if.c
>=20
...
> @@ -10,6 +10,7 @@ mtk-vcodec-dec-y :=3D vdec/vdec_h264_if.o \
...
> @@ -107,11 +107,51 @@ static const struct mtk_stateless_control mtk_state=
less_controls[] =3D {
>  		},
...
> +
> +		},
> +		.codec_type =3D V4L2_PIX_FMT_AV1_FRAME,
> +	},
> +	{
> +		.cfg =3D {
...
> +	{
> +		.cfg =3D {
> +			.id =3D V4L2_CID_MPEG_VIDEO_AV1_LEVEL,
> +			.min =3D V4L2_MPEG_VIDEO_AV1_LEVEL_2_0,
> +			.def =3D V4L2_MPEG_VIDEO_AV1_LEVEL_4_0,
> +			.max =3D V4L2_MPEG_VIDEO_AV1_LEVEL_5_1,
> +		},
> +		.codec_type =3D V4L2_PIX_FMT_AV1_FRAME,
> +	},
>  };
...
> @@ -356,6 +396,7 @@ static void mtk_vcodec_add_formats(unsigned int fourc=
c,
...
> @@ -412,6 +453,10 @@ static void mtk_vcodec_get_supported_formats(struct =
mtk_vcodec_ctx *ctx)
...
> index 0000000000000..5b1b595570887
> --- /dev/null
...
> +#define SEGMENTATION_FLAG(x, name)	(!!((x)->flags & V4L2_AV1_SEGMENTATIO=
N_FLAG_##name))
> +#define QUANT_FLAG(x, name)		(!!((x)->flags & V4L2_AV1_QUANTIZATION_FLAG=
_##name))
> +#define SEQUENCE_FLAG(x, name)		(!!((x)->flags & V4L2_AV1_SEQUENCE_FLAG_=
##name))
...
> +	16384, 16320, 16257, 16194, 16132, 16070, 16009, 15948, 15888, 15828, 1=
5768,
> +	15709, 15650, 15592, 15534, 15477, 15420, 15364, 15308, 15252, 15197, 1=
5142,
> +	15087, 15033, 14980, 14926, 14873, 14821, 14769, 14717, 14665, 14614, 1=
4564,
> +	14513, 14463, 14413, 14364, 14315, 14266, 14218, 14170, 14122, 14075, 1=
4028,
> +	13981, 13935, 13888, 13843, 13797, 13752, 13707, 13662, 13618, 13574, 1=
3530,
> +	13487, 13443, 13400, 13358, 13315, 13273, 13231, 13190, 13148, 13107, 1=
3066,
> +	13026, 12985, 12945, 12906, 12866, 12827, 12788, 12749, 12710, 12672, 1=
2633,
> +	12596, 12558, 12520, 12483, 12446, 12409, 12373, 12336, 12300, 12264, 1=
2228,
> +	12193, 12157, 12122, 12087, 12053, 12018, 11984, 11950, 11916, 11882, 1=
1848,
> +	11815, 11782, 11749, 11716, 11683, 11651, 11619, 11586, 11555, 11523, 1=
1491,
> +	11460, 11429, 11398, 11367, 11336, 11305, 11275, 11245, 11215, 11185, 1=
1155,
> +	11125, 11096, 11067, 11038, 11009, 10980, 10951, 10923, 10894, 10866, 1=
0838,
> +	10810, 10782, 10755, 10727, 10700, 10673, 10645, 10618, 10592, 10565, 1=
0538,
> +	10512, 10486, 10460, 10434, 10408, 10382, 10356, 10331, 10305, 10280, 1=
0255,
> +	10230, 10205, 10180, 10156, 10131, 10107, 10082, 10058, 10034, 10010, 9=
986,
> +	9963,  9939,  9916,  9892,  9869,  9846,  9823,  9800,  9777,  9754,  9=
732,
> +	9709,  9687,  9664,  9642,  9620,  9598,  9576,  9554,  9533,  9511,  9=
489,
> +	9468,  9447,  9425,  9404,  9383,  9362,  9341,  9321,  9300,  9279,  9=
259,
> +	9239,  9218,  9198,  9178,  9158,  9138,  9118,  9098,  9079,  9059,  9=
039,
> +	9020,  9001,  8981,  8962,  8943,  8924,  8905,  8886,  8867,  8849,  8=
830,
> +	8812,  8793,  8775,  8756,  8738,  8720,  8702,  8684,  8666,  8648,  8=
630,
> +	8613,  8595,  8577,  8560,  8542,  8525,  8508,  8490,  8473,  8456,  8=
439,
> +	8422,  8405,  8389,  8372,  8355,  8339,  8322,  8306,  8289,  8273,  8=
257,
> +	8240,  8224,  8208,  8192,
> +};
> +
...
> + * @skip_mode_present:  specified that the skip_mode will be present or =
not
> + * @skip_mode_frame:    specifies the frames to use for compound predict=
ion
> + */
...
> + * @segmentation_enabled:        this frame makes use of the segmentatio=
n tool or not
> + * @segmentation_update_map:     segmentation map are updated during the=
 decoding frame
> + * @segmentation_temporal_update:segmentation map are coded relative the=
 existing segmentaion map
> + * @segmentation_update_data:    new parameters are about to be specifie=
d for each segment
> + * @feature_data:                specifies the feature data for a segmen=
t feature
> + * @feature_enabled_mask:        the corresponding feature value is code=
d or not.
> + * @segid_preskip:               segment id will be read before the skip=
 syntax element.
> + * @last_active_segid:           the highest numbered segment id that ha=
s some enabled feature
> + */
...
> + * @delta_q_present:    specified whether quantizer index delta values a=
re present
> + * @delta_q_res:        specifies the left shift which should be applied=
 to decoded quantizer index
> + * @delta_lf_present:   specifies whether loop filter delta values are p=
resent
> + * @delta_lf_res:       specifies the left shift which should be applied=
 to decoded
> + *                      loop filter delta values
> + * @delta_lf_multi:     specifies that separate loop filter deltas are s=
ent for horizontal
> + *                      luma edges,vertical luma edges,the u edges, and =
the v edges.
> + */
...
> + * @base_q_idx:         indicates the base frame qindex. This is used fo=
r Y AC
> + *                      coefficients and as the base value for the other=
 quantizers.
> + * @qindex:             qindex
> + * @delta_qydc:         indicates the Y DC quantizer relative to base_q_=
idx
> + * @delta_qudc:         indicates the U DC quantizer relative to base_q_=
idx.
> + * @delta_quac:         indicates the U AC quantizer relative to base_q_=
idx
> + * @delta_qvdc:         indicates the V DC quantizer relative to base_q_=
idx
> + * @delta_qvac:         indicates the V AC quantizer relative to base_q_=
idx
> + * @using_qmatrix:      specifies that the quantizer matrix will be used=
 to
> + *                      compute quantizers
> + * @qm_y:               specifies the level in the quantizer matrix that=
 should
> + *                      be used for luma plane decoding
> + * @qm_u:               specifies the level in the quantizer matrix that=
 should
> + *                      be used for chroma U plane decoding.
> + * @qm_v:               specifies the level in the quantizer matrix that=
 should be
...
> + * @frame_restoration_type:     specifies the type of restoration used f=
or each plane
> + * @loop_restoration_size:      pecifies the size of loop restoration un=
its in units
...
> + * @loop_filter_level:          an array containing loop filter strength=
 values.
> + * @loop_filter_ref_deltas:     contains the adjustment needed for the f=
ilter
> + *                              level based on the chosen reference fram=
e
> + * @loop_filter_mode_deltas:    contains the adjustment needed for the f=
ilter
> + *                              level based on the chosen mode
> + * @loop_filter_sharpness:      indicates the sharpness level. The loop_=
filter_level
> + *                              and loop_filter_sharpness together deter=
mine when
> + *                              a block edge is filtered, and by how muc=
h the
> + *                              filtering can change the sample values
> + * @loop_filter_delta_enabled:  filetr level depends on the mode and ref=
erence
...
> + * @cdef_damping:       controls the amount of damping in the deringing =
filter
> + * @cdef_y_strength:    specifies the strength of the primary filter and=
 secondary filter
> + * @cdef_uv_strength:   specifies the strength of the primary filter and=
 secondary filter
> + * @cdef_bits:          specifies the number of bits needed to specify w=
hich
...
> + * @tile_cols:                  specifies the number of tiles across the=
 frame
> + * @tile_rows:                  pecifies the number of tiles down the fr=
ame
> + * @mi_col_starts:              an array specifying the start column
> + * @mi_row_starts:              an array specifying the start row
> + * @context_update_tile_id:     specifies which tile to use for the CDF =
update
> + * @uniform_tile_spacing_flag:  tiles are uniformly spaced across the fr=
ame
...
> +
> +/**
> + * struct vdec_av1_slice_uncompressed_header - Represents an AV1 Frame H=
eader OBU
> + * @use_ref_frame_mvs:          use_ref_frame_mvs flag
> + * @order_hint:                 specifies OrderHintBits least significan=
t bits of the expected
> + * @gm:                         global motion param
> + * @upscaled_width:             the upscaled width
> + * @frame_width:                frame's width
> + * @frame_height:               frame's height
> + * @reduced_tx_set:             frame is restricted to a reduced subset =
of the full
> + *                              set of transform types
> + * @tx_mode:                    specifies how the transform size is dete=
rmined
> + * @uniform_tile_spacing_flag:  tiles are uniformly spaced across the fr=
ame
> + *                              or the tile sizes are coded
...
> + * @is_motion_mode_switchable : euqlt to 0 specifies that only the SIMPL=
E motion mode will be used
> + * @reference_mode :            frame reference mode selected
> + * @allow_high_precision_mv:    specifies that motion vectors are specif=
ied to
> + *                              quarter pel precision or to eighth pel p=
recision
> + * @allow_intra_bc:             ubducates that intra block copy may be u=
sed in this frame
> + * @force_integer_mv:           specifies motion vectors will always be =
integers or
...
> + * @primary_ref_frame:          specifies which reference frame contains=
 the CDF values
> + *                              and other state that should be loaded at=
 the start of the frame
> + *                              slots will be updated with the current f=
rame after it is decoded
> + * @disable_frame_end_update_cdf:indicates the end of frame CDF update i=
s disable or enable
> + * @disable_cdf_update:         specified whether the CDF update in the =
symbol
...
> + * @enable_superres:            specifies whether the use_superres synta=
x element may be present
> + * @enable_filter_intra:        specifies the use_filter_intra syntax el=
ement may be present
> + * @enable_intra_edge_filter:   whether the intra edge filtering process=
 should be enabled
> + * @enable_interintra_compound: specifies the mode info fo rinter blocks=
 may
> + *                              contain the syntax element interintra
> + * @enable_masked_compound:     specifies the mode info fo rinter blocks=
 may
> + *                              contain the syntax element compound_type
> + * @enable_dual_filter:         the inter prediction filter type may be =
specified independently
> + * @enable_jnt_comp:            distance weights process may be used for=
 inter prediction
> + * @mono_chrome:                indicates the video does not contain U a=
nd V color planes
> + * @enable_order_hint:          tools based on the values of order hints=
 may be used
> + * @order_hint_bits:            the number of bits used for the order_hi=
nt field at each frame
> + * @use_128x128_superblock:     indicates superblocks contain 128*128 lu=
ma samples
> + * @subsampling_x:              the chroma subsamling format
> + * @subsampling_y:              the chroma subsamling format
> + * @max_frame_width:            the maximum frame width for the frames r=
epresented by sequence
> + * @max_frame_height:           the maximum frame height for the frames =
...
> +
> +/**
> + * struct vdec_av1_slice_slot - slot info that needs to be saved in the =
global instance
...
> +
> +/**
> + * struct vdec_av1_slice_vsi - exchange frame information between Main C=
PU and MicroP
...
> +
> +/**
> + * struct vdec_av1_slice_pfc - per-frame context that contains a local v=
si.
...
> +}
> +
> +static inline bool vdec_av1_slice_need_scale(u32 ref_width, u32 ref_heig=
ht,
> +					     u32 this_width, u32 this_height)
> +{
> +	return ((this_width << 1) >=3D ref_width) &&
> +		((this_height << 1) >=3D ref_height) &&
> +		(this_width <=3D (ref_width << 4)) &&
...
> +	instance->cdf_table.size =3D vsi->cdf_table_size;
> +
> +	ret =3D mtk_vcodec_mem_alloc(ctx, &instance->cdf_table);
> +	if (ret)
> +		return ret;
> +
...
> +	instance->iq_table.size =3D vsi->iq_table_size;
> +
> +	ret =3D mtk_vcodec_mem_alloc(ctx, &instance->iq_table);
> +	if (ret)
> +		return ret;
> +
...
> +{
> +	struct vdec_av1_slice_slot *slots =3D &vsi->slots;
> +	int new_slot_idx =3D AV1_INVALID_IDX;
> +	int i;
> +
> +	for (i =3D 0; i < AV1_MAX_FRAME_BUF_COUNT; i++) {
> +		if (slots->frame_info[i].ref_count =3D=3D 0) {
> +			new_slot_idx =3D i;
> +			break;
> +		}
> +	}
> +
> +	if (new_slot_idx !=3D AV1_INVALID_IDX) {
> +		slots->frame_info[new_slot_idx].ref_count++;
> +		slots->timestamp[new_slot_idx] =3D vsi->frame.cur_ts;
> +	}
> +
> +	return new_slot_idx;
> +}
> +
> +static inline void vdec_av1_slice_clear_fb(struct vdec_av1_slice_frame_i=
nfo *frame_info)
> +{
...
> +}
> +
> +static void vdec_av1_slice_decrease_ref_count(struct vdec_av1_slice_slot=
 *slots, int fb_idx)
> +{
> +	struct vdec_av1_slice_frame_info *frame_info =3D slots->frame_info;
> +
...
> +}
> +
> +static void vdec_av1_slice_cleanup_slots(struct vdec_av1_slice_slot *slo=
ts,
> +					 struct vdec_av1_slice_frame *frame,
...
> +	int slot_id, ref_id;
> +
> +	for (ref_id =3D 0; ref_id < V4L2_AV1_TOTAL_REFS_PER_FRAME; ref_id++)
> +		frame->ref_frame_map[ref_id] =3D AV1_INVALID_IDX;
> +
> +	for (slot_id =3D 0; slot_id < AV1_MAX_FRAME_BUF_COUNT; slot_id++) {
> +		u64 timestamp =3D slots->timestamp[slot_id];
> +		bool ref_used =3D false;
> +
> +		/* ignored unused slots */
> +		if (slots->frame_info[slot_id].ref_count =3D=3D 0)
> +			continue;
> +
> +		for (ref_id =3D 0; ref_id < V4L2_AV1_TOTAL_REFS_PER_FRAME; ref_id++) {
> +			if (ctrl_fh->reference_frame_ts[ref_id] =3D=3D timestamp) {
> +				frame->ref_frame_map[ref_id] =3D slot_id;
> +				ref_used =3D true;
> +			}
> +		}
> +
...
> +}
> +
> +static void vdec_av1_slice_setup_slot(struct vdec_av1_slice_instance *in=
stance,
> +				      struct vdec_av1_slice_vsi *vsi,
> +				      struct v4l2_ctrl_av1_frame *ctrl_fh)
> +{
> +	struct vdec_av1_slice_frame_info *cur_frame_info;
> +	struct vdec_av1_slice_uncompressed_header *uh =3D &vsi->frame.uh;
> +	int ref_id;
> +
...
> +	cur_frame_info->frame_type =3D uh->frame_type;
> +	cur_frame_info->frame_is_intra =3D ((uh->frame_type =3D=3D AV1_INTRA_ON=
LY_FRAME) ||
> +					  (uh->frame_type =3D=3D AV1_KEY_FRAME));
> +	cur_frame_info->order_hint =3D uh->order_hint;
> +	cur_frame_info->upscaled_width =3D uh->upscaled_width;
> +	cur_frame_info->pic_pitch =3D 0;
> +	cur_frame_info->frame_width =3D uh->frame_width;
> +	cur_frame_info->frame_height =3D uh->frame_height;
> +	cur_frame_info->mi_cols =3D ((uh->frame_width + 7) >> 3) << 1;
> +	cur_frame_info->mi_rows =3D ((uh->frame_height + 7) >> 3) << 1;
> +
> +	/* ensure current frame is properly mapped if referenced */
> +	for (ref_id =3D 0; ref_id < V4L2_AV1_TOTAL_REFS_PER_FRAME; ref_id++) {
> +		u64 timestamp =3D vsi->slots.timestamp[vsi->slot_id];
> +
> +		if (ctrl_fh->reference_frame_ts[ref_id] =3D=3D timestamp)
> +			vsi->frame.ref_frame_map[ref_id] =3D vsi->slot_id;
> +	}
> +}
> +
...
> +		instance->mv[i].size =3D max_sb_w * max_sb_h * SZ_1K;
> +		ret =3D mtk_vcodec_mem_alloc(ctx, &instance->mv[i]);
> +		if (ret)
> +			goto err;
> +
> +		if (instance->seg[i].va)
> +			mtk_vcodec_mem_free(ctx, &instance->seg[i]);
> +		instance->seg[i].size =3D max_sb_w * max_sb_h * 512;
> +		ret =3D mtk_vcodec_mem_alloc(ctx, &instance->seg[i]);
> +		if (ret)
> +			goto err;
> +
> +		if (instance->cdf[i].va)
> +			mtk_vcodec_mem_free(ctx, &instance->cdf[i]);
> +		instance->cdf[i].size =3D AV1_CDF_TABLE_BUFFER_SIZE;
> +		ret =3D mtk_vcodec_mem_alloc(ctx, &instance->cdf[i]);
> +		if (ret)
> +			goto err;
> +	}
> +
> +	if (!instance->cdf_temp.va) {
> +		instance->cdf_temp.size =3D (SZ_1K * 16 * 100);
> +		ret =3D mtk_vcodec_mem_alloc(ctx, &instance->cdf_temp);
> +		if (ret)
> +			goto err;
> +		vsi->cdf_tmp.buf =3D instance->cdf_temp.dma_addr;
> +		vsi->cdf_tmp.size =3D instance->cdf_temp.size;
> +	}
> +
> +	if (instance->tile.va)
> +		mtk_vcodec_mem_free(ctx, &instance->tile);
> +
> +	instance->tile.size =3D AV1_TILE_BUF_SIZE * V4L2_AV1_MAX_TILE_COUNT;
> +	ret =3D mtk_vcodec_mem_alloc(ctx, &instance->tile);
> +	if (ret)
> +		goto err;
> +
...
> +
> +err:
> +	instance->level =3D AV1_RES_NONE;
> +	return ret;
> +}
> +
...
> +		mtk_vcodec_mem_free(ctx, &instance->seg[i]);
> +
> +	for (i =3D 0; i < ARRAY_SIZE(instance->cdf); i++)
> +		mtk_vcodec_mem_free(ctx, &instance->cdf[i]);
> +
> +	mtk_vcodec_mem_free(ctx, &instance->tile);
...
> +}
> +
> +static inline void vdec_av1_slice_vsi_from_remote(struct vdec_av1_slice_=
vsi *vsi,
...
> +}
> +
> +static inline void vdec_av1_slice_vsi_to_remote(struct vdec_av1_slice_vs=
i *vsi,
> +						struct vdec_av1_slice_vsi *remote_vsi)
> +{
...
> +	int e;
> +
> +	*shift =3D vdec_av1_slice_get_msb(D);
...
> +}
> +
> +static void vdec_av1_slice_get_shear_params(struct vdec_av1_slice_gm *gm=
_params)
> +{
> +	const int *mat =3D gm_params->wmmat;
> +	short shift;
> +	short y;
> +	long long gv, dv;
> +
> +	if (gm_params->wmmat[2] <=3D 0)
> +		return;
> +
> +	gm_params->alpha =3D clamp_val(mat[2] - (1 << WARPEDMODEL_PREC_BITS), S=
16_MIN, S16_MAX);
> +	gm_params->beta =3D clamp_val(mat[3], S16_MIN, S16_MAX);
> +
> +	y =3D vdec_av1_slice_resolve_divisor_32(abs(mat[2]), &shift) * (mat[2] =
< 0 ? -1 : 1);
> +
> +	gv =3D ((long long)mat[4] * (1 << WARPEDMODEL_PREC_BITS)) * y;
> +	gm_params->gamma =3D clamp_val((int)AV1_DIV_ROUND_UP_POW2_SIGNED(gv, sh=
ift),
> +				     S16_MIN, S16_MAX);
> +
> +	dv =3D ((long long)mat[3] * mat[4]) * y;
> +	gm_params->delta =3D clamp_val(mat[5] - (int)AV1_DIV_ROUND_UP_POW2_SIGN=
ED(dv, shift) -
> +				     (1 << WARPEDMODEL_PREC_BITS), S16_MIN, S16_MAX);
> +
> +	gm_params->alpha =3D AV1_DIV_ROUND_UP_POW2_SIGNED(gm_params->alpha, WAR=
P_PARAM_REDUCE_BITS) *
> +							(1 << WARP_PARAM_REDUCE_BITS);
> +	gm_params->beta =3D AV1_DIV_ROUND_UP_POW2_SIGNED(gm_params->beta, WARP_=
PARAM_REDUCE_BITS) *
> +						       (1 << WARP_PARAM_REDUCE_BITS);
> +	gm_params->gamma =3D AV1_DIV_ROUND_UP_POW2_SIGNED(gm_params->gamma, WAR=
P_PARAM_REDUCE_BITS) *
> +							(1 << WARP_PARAM_REDUCE_BITS);
> +	gm_params->delta =3D AV1_DIV_ROUND_UP_POW2_SIGNED(gm_params->delta, WAR=
P_PARAM_REDUCE_BITS) *
> +							(1 << WARP_PARAM_REDUCE_BITS);
> +}
> +
...
> +	u32 i, j;
> +
> +	for (i =3D 0; i < V4L2_AV1_TOTAL_REFS_PER_FRAME; i++) {
> +		gm[i].wmtype =3D ctrl_gm->type[i];
> +		for (j =3D 0; j < 6; j++)
> +			gm[i].wmmat[j] =3D ctrl_gm->params[i][j];
> +
> +		gm[i].invalid =3D !!(ctrl_gm->invalid & BIT(i));
> +		gm[i].alpha =3D 0;
> +		gm[i].beta =3D 0;
> +		gm[i].gamma =3D 0;
> +		gm[i].delta =3D 0;
> +		if (gm[i].wmtype <=3D V4L2_AV1_WARP_MODEL_AFFINE)
...
> +	u32 i, j;
> +
> +	seg->segmentation_enabled =3D SEGMENTATION_FLAG(ctrl_seg, ENABLED);
> +	seg->segmentation_update_map =3D SEGMENTATION_FLAG(ctrl_seg, UPDATE_MAP=
);
> +	seg->segmentation_temporal_update =3D SEGMENTATION_FLAG(ctrl_seg, TEMPO=
RAL_UPDATE);
> +	seg->segmentation_update_data =3D SEGMENTATION_FLAG(ctrl_seg, UPDATE_DA=
TA);
> +	seg->segid_preskip =3D SEGMENTATION_FLAG(ctrl_seg, SEG_ID_PRE_SKIP);
> +	seg->last_active_segid =3D ctrl_seg->last_active_seg_id;
> +
> +	for (i =3D 0; i < V4L2_AV1_MAX_SEGMENTS; i++) {
> +		seg->feature_enabled_mask[i] =3D ctrl_seg->feature_enabled[i];
> +		for (j =3D 0; j < V4L2_AV1_SEG_LVL_MAX; j++)
> +			seg->feature_data[i][j] =3D ctrl_seg->feature_data[i][j];
> +	}
> +}
> +
> +static void vdec_av1_slice_setup_quant(struct vdec_av1_slice_quantizatio=
n *quant,
> +				       struct v4l2_av1_quantization *ctrl_quant)
> +{
> +	quant->base_q_idx =3D ctrl_quant->base_q_idx;
> +	quant->delta_qydc =3D ctrl_quant->delta_q_y_dc;
> +	quant->delta_qudc =3D ctrl_quant->delta_q_u_dc;
> +	quant->delta_quac =3D ctrl_quant->delta_q_u_ac;
> +	quant->delta_qvdc =3D ctrl_quant->delta_q_v_dc;
> +	quant->delta_qvac =3D ctrl_quant->delta_q_v_ac;
> +	quant->qm_y =3D ctrl_quant->qm_y;
> +	quant->qm_u =3D ctrl_quant->qm_u;
> +	quant->qm_v =3D ctrl_quant->qm_v;
> +	quant->using_qmatrix =3D QUANT_FLAG(ctrl_quant, USING_QMATRIX);
> +}
> +
> +static int vdec_av1_slice_get_qindex(struct vdec_av1_slice_uncompressed_=
header *uh,
> +				     int segmentation_id)
> +{
> +	struct vdec_av1_slice_seg *seg =3D &uh->seg;
> +	struct vdec_av1_slice_quantization *quant =3D &uh->quant;
> +	int data =3D 0, qindex =3D 0;
> +
> +	if (seg->segmentation_enabled &&
> +	    (seg->feature_enabled_mask[segmentation_id] & BIT(SEG_LVL_ALT_Q))) =
{
> +		data =3D seg->feature_data[segmentation_id][SEG_LVL_ALT_Q];
> +		qindex =3D quant->base_q_idx + data;
...
> +
> +	lr->use_lr =3D 0;
> +	lr->use_chroma_lr =3D 0;
> +	for (i =3D 0; i < V4L2_AV1_NUM_PLANES_MAX; i++) {
> +		lr->frame_restoration_type[i] =3D ctrl_lr->frame_restoration_type[i];
> +		lr->loop_restoration_size[i] =3D ctrl_lr->loop_restoration_size[i];
> +		if (lr->frame_restoration_type[i]) {
> +			lr->use_lr =3D 1;
> +			if (i > 0)
> +				lr->use_chroma_lr =3D 1;
> +		}
> +	}
> +}
> +
> +static void vdec_av1_slice_setup_lf(struct vdec_av1_slice_loop_filter *l=
f,
> +				    struct v4l2_av1_loop_filter *ctrl_lf)
> +{
> +	int i;
> +
> +	for (i =3D 0; i < ARRAY_SIZE(lf->loop_filter_level); i++)
> +		lf->loop_filter_level[i] =3D ctrl_lf->level[i];
> +
> +	for (i =3D 0; i < V4L2_AV1_TOTAL_REFS_PER_FRAME; i++)
> +		lf->loop_filter_ref_deltas[i] =3D ctrl_lf->ref_deltas[i];
> +
> +	for (i =3D 0; i < ARRAY_SIZE(lf->loop_filter_mode_deltas); i++)
> +		lf->loop_filter_mode_deltas[i] =3D ctrl_lf->mode_deltas[i];
> +
> +	lf->loop_filter_sharpness =3D ctrl_lf->sharpness;
> +	lf->loop_filter_delta_enabled =3D
...
> +	int i;
> +
> +	cdef->cdef_damping =3D ctrl_cdef->damping_minus_3 + 3;
> +	cdef->cdef_bits =3D ctrl_cdef->bits;
> +
> +	for (i =3D 0; i < V4L2_AV1_CDEF_MAX; i++) {
> +		if (ctrl_cdef->y_sec_strength[i] =3D=3D 4)
> +			ctrl_cdef->y_sec_strength[i] -=3D 1;
> +
> +		if (ctrl_cdef->uv_sec_strength[i] =3D=3D 4)
> +			ctrl_cdef->uv_sec_strength[i] -=3D 1;
> +
> +		cdef->cdef_y_strength[i] =3D
> +			ctrl_cdef->y_pri_strength[i] << SECONDARY_FILTER_STRENGTH_NUM_BITS |
> +			ctrl_cdef->y_sec_strength[i];
> +		cdef->cdef_uv_strength[i] =3D
> +			ctrl_cdef->uv_pri_strength[i] << SECONDARY_FILTER_STRENGTH_NUM_BITS |
> +			ctrl_cdef->uv_sec_strength[i];
> +	}
> +}
> +
> +static void vdec_av1_slice_setup_seq(struct vdec_av1_slice_seq_header *s=
eq,
> +				     struct v4l2_ctrl_av1_sequence *ctrl_seq)
> +{
> +	seq->bitdepth =3D ctrl_seq->bit_depth;
> +	seq->max_frame_width =3D ctrl_seq->max_frame_width_minus_1 + 1;
> +	seq->max_frame_height =3D ctrl_seq->max_frame_height_minus_1 + 1;
> +	seq->enable_superres =3D SEQUENCE_FLAG(ctrl_seq, ENABLE_SUPERRES);
> +	seq->enable_filter_intra =3D SEQUENCE_FLAG(ctrl_seq, ENABLE_FILTER_INTR=
A);
> +	seq->enable_intra_edge_filter =3D SEQUENCE_FLAG(ctrl_seq, ENABLE_INTRA_=
EDGE_FILTER);
> +	seq->enable_interintra_compound =3D SEQUENCE_FLAG(ctrl_seq, ENABLE_INTE=
RINTRA_COMPOUND);
> +	seq->enable_masked_compound =3D SEQUENCE_FLAG(ctrl_seq, ENABLE_MASKED_C=
OMPOUND);
> +	seq->enable_dual_filter =3D SEQUENCE_FLAG(ctrl_seq, ENABLE_DUAL_FILTER)=
;
> +	seq->enable_jnt_comp =3D SEQUENCE_FLAG(ctrl_seq, ENABLE_JNT_COMP);
> +	seq->mono_chrome =3D SEQUENCE_FLAG(ctrl_seq, MONO_CHROME);
> +	seq->enable_order_hint =3D SEQUENCE_FLAG(ctrl_seq, ENABLE_ORDER_HINT);
> +	seq->order_hint_bits =3D ctrl_seq->order_hint_bits;
> +	seq->use_128x128_superblock =3D SEQUENCE_FLAG(ctrl_seq, USE_128X128_SUP=
ERBLOCK);
> +	seq->subsampling_x =3D SEQUENCE_FLAG(ctrl_seq, SUBSAMPLING_X);
> +	seq->subsampling_y =3D SEQUENCE_FLAG(ctrl_seq, SUBSAMPLING_Y);
> +}
> +
...
> +{
> +	struct vdec_av1_slice_seq_header *seq =3D &frame->seq;
> +	struct vdec_av1_slice_tile *tile =3D &frame->uh.tile;
> +	u32 mib_size_log2 =3D seq->use_128x128_superblock ? 5 : 4;
> +	int i;
> +
> +	tile->tile_cols =3D ctrl_tile->tile_cols;
> +	tile->tile_rows =3D ctrl_tile->tile_rows;
> +	tile->context_update_tile_id =3D ctrl_tile->context_update_tile_id;
> +	tile->uniform_tile_spacing_flag =3D
> +		BIT_FLAG(ctrl_tile, V4L2_AV1_TILE_INFO_FLAG_UNIFORM_TILE_SPACING);
> +
> +	for (i =3D 0; i < tile->tile_cols + 1; i++)
> +		tile->mi_col_starts[i] =3D
> +			ALIGN(ctrl_tile->mi_col_starts[i], BIT(mib_size_log2)) >> mib_size_lo=
g2;
> +
> +	for (i =3D 0; i < tile->tile_rows + 1; i++)
> +		tile->mi_row_starts[i] =3D
> +			ALIGN(ctrl_tile->mi_row_starts[i], BIT(mib_size_log2)) >> mib_size_lo=
g2;
> +}
> +
> +static void vdec_av1_slice_setup_uh(struct vdec_av1_slice_instance *inst=
ance,
> +				    struct vdec_av1_slice_frame *frame,
> +				    struct v4l2_ctrl_av1_frame *ctrl_fh)
> +{
> +	struct vdec_av1_slice_uncompressed_header *uh =3D &frame->uh;
> +	int i;
> +
> +	uh->use_ref_frame_mvs =3D FH_FLAG(ctrl_fh, USE_REF_FRAME_MVS);
> +	uh->order_hint =3D ctrl_fh->order_hint;
> +	vdec_av1_slice_setup_gm(uh->gm, &ctrl_fh->global_motion);
> +	uh->upscaled_width =3D ctrl_fh->upscaled_width;
> +	uh->frame_width =3D ctrl_fh->frame_width_minus_1 + 1;
> +	uh->frame_height =3D ctrl_fh->frame_height_minus_1 + 1;
> +	uh->mi_cols =3D ((uh->frame_width + 7) >> 3) << 1;
> +	uh->mi_rows =3D ((uh->frame_height + 7) >> 3) << 1;
> +	uh->reduced_tx_set =3D FH_FLAG(ctrl_fh, REDUCED_TX_SET);
> +	uh->tx_mode =3D ctrl_fh->tx_mode;
> +	uh->uniform_tile_spacing_flag =3D FH_FLAG(ctrl_fh, UNIFORM_TILE_SPACING=
);
> +	uh->interpolation_filter =3D ctrl_fh->interpolation_filter;
> +	uh->allow_warped_motion =3D FH_FLAG(ctrl_fh, ALLOW_WARPED_MOTION);
> +	uh->is_motion_mode_switchable =3D FH_FLAG(ctrl_fh, IS_MOTION_MODE_SWITC=
HABLE);
> +	uh->frame_type =3D ctrl_fh->frame_type;
> +	uh->frame_is_intra =3D (uh->frame_type =3D=3D V4L2_AV1_INTRA_ONLY_FRAME=
 ||
> +			      uh->frame_type =3D=3D V4L2_AV1_KEY_FRAME);
> +
> +	if (!uh->frame_is_intra && FH_FLAG(ctrl_fh, REFERENCE_SELECT))
> +		uh->reference_mode =3D AV1_REFERENCE_MODE_SELECT;
> +	else
> +		uh->reference_mode =3D AV1_SINGLE_REFERENCE;
> +
> +	uh->allow_high_precision_mv =3D FH_FLAG(ctrl_fh, ALLOW_HIGH_PRECISION_M=
V);
> +	uh->allow_intra_bc =3D FH_FLAG(ctrl_fh, ALLOW_INTRABC);
> +	uh->force_integer_mv =3D FH_FLAG(ctrl_fh, FORCE_INTEGER_MV);
> +	uh->allow_screen_content_tools =3D FH_FLAG(ctrl_fh, ALLOW_SCREEN_CONTEN=
T_TOOLS);
> +	uh->error_resilient_mode =3D FH_FLAG(ctrl_fh, ERROR_RESILIENT_MODE);
> +	uh->primary_ref_frame =3D ctrl_fh->primary_ref_frame;
> +	uh->disable_frame_end_update_cdf =3D
> +			FH_FLAG(ctrl_fh, DISABLE_FRAME_END_UPDATE_CDF);
> +	uh->disable_cdf_update =3D FH_FLAG(ctrl_fh, DISABLE_CDF_UPDATE);
> +	uh->skip_mode.skip_mode_present =3D FH_FLAG(ctrl_fh, SKIP_MODE_PRESENT)=
;
> +	uh->skip_mode.skip_mode_frame[0] =3D
> +		ctrl_fh->skip_mode_frame[0] - V4L2_AV1_REF_LAST_FRAME;
> +	uh->skip_mode.skip_mode_frame[1] =3D
> +		ctrl_fh->skip_mode_frame[1] - V4L2_AV1_REF_LAST_FRAME;
> +	uh->skip_mode.skip_mode_allowed =3D ctrl_fh->skip_mode_frame[0] ? 1 : 0=
;
> +
> +	vdec_av1_slice_setup_seg(&uh->seg, &ctrl_fh->segmentation);
> +	uh->delta_q_lf.delta_q_present =3D QUANT_FLAG(&ctrl_fh->quantization, D=
ELTA_Q_PRESENT);
> +	uh->delta_q_lf.delta_q_res =3D 1 << ctrl_fh->quantization.delta_q_res;
> +	uh->delta_q_lf.delta_lf_present =3D
> +		BIT_FLAG(&ctrl_fh->loop_filter, V4L2_AV1_LOOP_FILTER_FLAG_DELTA_LF_PRE=
SENT);
> +	uh->delta_q_lf.delta_lf_res =3D ctrl_fh->loop_filter.delta_lf_res;
> +	uh->delta_q_lf.delta_lf_multi =3D
> +		BIT_FLAG(&ctrl_fh->loop_filter, V4L2_AV1_LOOP_FILTER_FLAG_DELTA_LF_MUL=
TI);
> +	vdec_av1_slice_setup_quant(&uh->quant, &ctrl_fh->quantization);
> +
> +	uh->coded_loss_less =3D 1;
> +	for (i =3D 0; i < V4L2_AV1_MAX_SEGMENTS; i++) {
> +		uh->quant.qindex[i] =3D vdec_av1_slice_get_qindex(uh, i);
> +		uh->loss_less_array[i] =3D
> +			(uh->quant.qindex[i] =3D=3D 0 && uh->quant.delta_qydc =3D=3D 0 &&
> +			uh->quant.delta_quac =3D=3D 0 && uh->quant.delta_qudc =3D=3D 0 &&
> +			uh->quant.delta_qvac =3D=3D 0 && uh->quant.delta_qvdc =3D=3D 0);
> +
> +		if (!uh->loss_less_array[i])
> +			uh->coded_loss_less =3D 0;
> +	}
> +
> +	vdec_av1_slice_setup_lr(&uh->lr, &ctrl_fh->loop_restoration);
> +	uh->superres_denom =3D ctrl_fh->superres_denom;
...
> +}
> +
> +static int vdec_av1_slice_setup_tile_group(struct vdec_av1_slice_instanc=
e *instance,
> +					   struct vdec_av1_slice_vsi *vsi)
> +{
...
> +	struct vdec_av1_slice_uncompressed_header *uh =3D &vsi->frame.uh;
> +	struct vdec_av1_slice_tile *tile =3D &uh->tile;
> +	struct v4l2_ctrl *ctrl;
> +	u32 tge_size;
> +	int i;
> +
> +	ctrl =3D v4l2_ctrl_find(&instance->ctx->ctrl_hdl, V4L2_CID_STATELESS_AV=
1_TILE_GROUP_ENTRY);
> +	if (!ctrl)
> +		return -EINVAL;
> +
> +	tge_size =3D ctrl->elems;
> +	ctrl_tge =3D (struct v4l2_ctrl_av1_tile_group_entry *)ctrl->p_cur.p;
> +
> +	tile_group->num_tiles =3D tile->tile_cols * tile->tile_rows;
> +
...
> +		tile_group->tile_start_offset[i] =3D ctrl_tge[i].tile_offset;
> +	}
> +
> +	return 0;
> +}
> +
> +static inline void vdec_av1_slice_setup_state(struct vdec_av1_slice_vsi =
*vsi)
> +{
> +	memset(&vsi->state, 0, sizeof(vsi->state));
> +}
> +
> +static void vdec_av1_slice_setup_scale_factors(struct vdec_av1_slice_fra=
me_refs *frame_ref,
> +					       struct vdec_av1_slice_frame_info *ref_frame_info,
> +					       struct vdec_av1_slice_uncompressed_header *uh)
> +{
> +	struct vdec_av1_slice_scale_factors *scale_factors =3D &frame_ref->scal=
e_factors;
> +	u32 ref_upscaled_width =3D ref_frame_info->upscaled_width;
> +	u32 ref_frame_height =3D ref_frame_info->frame_height;
> +	u32 frame_width =3D uh->frame_width;
> +	u32 frame_height =3D uh->frame_height;
> +
> +	if (!vdec_av1_slice_need_scale(ref_upscaled_width, ref_frame_height,
> +				       frame_width, frame_height)) {
> +		scale_factors->x_scale =3D -1;
> +		scale_factors->y_scale =3D -1;
> +		scale_factors->is_scaled =3D 0;
> +		return;
> +	}
> +
> +	scale_factors->x_scale =3D
> +		((ref_upscaled_width << AV1_REF_SCALE_SHIFT) + (frame_width >> 1)) / f=
rame_width;
> +	scale_factors->y_scale =3D
> +		((ref_frame_height << AV1_REF_SCALE_SHIFT) + (frame_height >> 1)) / fr=
ame_height;
> +	scale_factors->is_scaled =3D
> +		(scale_factors->x_scale !=3D AV1_REF_INVALID_SCALE) &&
> +		(scale_factors->y_scale !=3D AV1_REF_INVALID_SCALE) &&
> +		(scale_factors->x_scale !=3D AV1_REF_NO_SCALE ||
> +		 scale_factors->y_scale !=3D AV1_REF_NO_SCALE);
> +	scale_factors->x_step =3D
> +		AV1_DIV_ROUND_UP_POW2(scale_factors->x_scale,
> +				      AV1_REF_SCALE_SHIFT - AV1_SCALE_SUBPEL_BITS);
> +	scale_factors->y_step =3D
...
> +	int diff =3D 0;
> +	int m =3D 0;
> +	unsigned char result =3D 0;
> +
> +	if (!enable_order_hint)
> +		return 0;
> +
> +	diff =3D a - b;
> +	m =3D 1 << (order_hint_bits - 1);
...
> +	struct vdec_av1_slice_frame *frame =3D &vsi->frame;
> +	struct vdec_av1_slice_slot *slots =3D &vsi->slots;
> +	struct vdec_av1_slice_uncompressed_header *uh =3D &frame->uh;
> +	struct vdec_av1_slice_seq_header *seq =3D &frame->seq;
> +	struct vdec_av1_slice_frame_info *cur_frame_info =3D
...
> +		int ref_idx =3D ctrl_fh->ref_frame_idx[i];
> +
> +		pfc->ref_idx[i] =3D ctrl_fh->reference_frame_ts[ref_idx];
...
> +		}
> +
> +		frame->frame_refs[i].ref_fb_idx =3D slot_id;
> +		vdec_av1_slice_setup_scale_factors(&frame->frame_refs[i],
> +						   frame_info, uh);
> +		if (!seq->enable_order_hint)
> +			frame->ref_frame_sign_bias[i + 1] =3D 0;
> +		else
> +			frame->ref_frame_sign_bias[i + 1] =3D
> +				vdec_av1_slice_get_sign_bias(frame_info->order_hint,
> +							     uh->order_hint,
> +							     seq->enable_order_hint,
> +							     seq->order_hint_bits);
> +
> +		frame->order_hints[i] =3D ctrl_fh->order_hints[i + 1];
> +		cur_frame_info->order_hints[i] =3D frame->order_hints[i];
> +		frame->ref_frame_valid[i] =3D 1;
> +	}
> +}
> +
...
> +	struct vdec_av1_slice_frame *frame =3D &vsi->frame;
> +
> +	if (frame->uh.primary_ref_frame =3D=3D AV1_PRIMARY_REF_NONE)
> +		frame->prev_fb_idx =3D AV1_INVALID_IDX;
> +	else
> +		frame->prev_fb_idx =3D frame->frame_refs[frame->uh.primary_ref_frame].=
ref_fb_idx;
> +}
> +
> +static inline void vdec_av1_slice_setup_operating_mode(struct vdec_av1_s=
lice_instance *instance,
> +						       struct vdec_av1_slice_frame *frame)
> +{
> +	frame->large_scale_tile =3D 0;
> +}
> +
> +static int vdec_av1_slice_setup_pfc(struct vdec_av1_slice_instance *inst=
ance,
...
> +}
> +
> +static void vdec_av1_slice_setup_lat_buffer(struct vdec_av1_slice_instan=
ce *instance,
> +					    struct vdec_av1_slice_vsi *vsi,
...
> +	int i;
> +
> +	vsi->bs.dma_addr =3D bs->dma_addr;
> +	vsi->bs.size =3D bs->size;
> +
...
> +	vsi->rd_mv.dma_addr =3D lat_buf->rd_mv_addr.dma_addr;
> +	vsi->rd_mv.size =3D lat_buf->rd_mv_addr.size;
> +
> +	vsi->row_info.buf =3D 0;
> +	vsi->row_info.size =3D 0;
> +
> +	work_buffer =3D vsi->work_buffer;
> +
> +	for (i =3D 0; i < AV1_MAX_FRAME_BUF_COUNT; i++) {
> +		work_buffer[i].mv_addr.buf =3D instance->mv[i].dma_addr;
> +		work_buffer[i].mv_addr.size =3D instance->mv[i].size;
> +		work_buffer[i].segid_addr.buf =3D instance->seg[i].dma_addr;
> +		work_buffer[i].segid_addr.size =3D instance->seg[i].size;
> +		work_buffer[i].cdf_addr.buf =3D instance->cdf[i].dma_addr;
> +		work_buffer[i].cdf_addr.size =3D instance->cdf[i].size;
> +	}
> +
> +	vsi->cdf_tmp.buf =3D instance->cdf_temp.dma_addr;
> +	vsi->cdf_tmp.size =3D instance->cdf_temp.size;
> +
> +	vsi->tile.buf =3D instance->tile.dma_addr;
> +	vsi->tile.size =3D instance->tile.size;
> +	memcpy(lat_buf->tile_addr.va, instance->tile.va, 64 * instance->tile_gr=
oup.num_tiles);
> +
> +	vsi->cdf_table.buf =3D instance->cdf_table.dma_addr;
> +	vsi->cdf_table.size =3D instance->cdf_table.size;
> +	vsi->iq_table.buf =3D instance->iq_table.dma_addr;
> +	vsi->iq_table.size =3D instance->iq_table.size;
> +}
> +
> +static void vdec_av1_slice_setup_seg_buffer(struct vdec_av1_slice_instan=
ce *instance,
> +					    struct vdec_av1_slice_vsi *vsi)
> +{
> +	struct vdec_av1_slice_uncompressed_header *uh =3D &vsi->frame.uh;
...
> +}
> +
> +static void vdec_av1_slice_setup_tile_buffer(struct vdec_av1_slice_insta=
nce *instance,
> +					     struct vdec_av1_slice_vsi *vsi,
> +					     struct mtk_vcodec_mem *bs)
> +{
...
> +
> +	for (tile_num =3D 0; tile_num < tile_group->num_tiles; tile_num++) {
> +		/* each uint32 takes place of 4 bytes */
> +		tile_info_base =3D (AV1_TILE_BUF_SIZE * tile_num) >> 2;
> +		tile_row =3D tile_num / tile->tile_cols;
> +		tile_col =3D tile_num % tile->tile_cols;
...
> +			0x1ff;
> +
> +		tile_info_buf[tile_info_base + 3] =3D (sb_boundary_y_m1 << 7) | sb_bou=
ndary_x_m1;
> +		tile_info_buf[tile_info_base + 4] =3D ((allow_update_cdf << 18) | (1 <=
< 16));
> +
> +		if (tile_num =3D=3D tile->context_update_tile_id &&
...
> +}
> +
> +static int vdec_av1_slice_setup_lat(struct vdec_av1_slice_instance *inst=
ance,
> +				    struct mtk_vcodec_mem *bs,
> +				    struct vdec_lat_buf *lat_buf,
> +				    struct vdec_av1_slice_pfc *pfc)
...
> +	int ret;
> +
> +	ret =3D vdec_av1_slice_setup_lat_from_src_buf(instance, vsi, lat_buf);
> +	if (ret)
> +		return ret;
> +
...
> +		return ret;
> +
> +	ret =3D vdec_av1_slice_setup_tile_group(instance, vsi);
> +	if (ret)
> +		return ret;
> +
> +	ret =3D vdec_av1_slice_alloc_working_buffer(instance, vsi);
> +	if (ret)
> +		return ret;
> +
...
> +}
> +
> +static int vdec_av1_slice_update_lat(struct vdec_av1_slice_instance *ins=
tance,
> +				     struct vdec_lat_buf *lat_buf,
> +				     struct vdec_av1_slice_pfc *pfc)
> +{
...
> +	if (vsi->state.full) {
> +		/* buffer not enough */
> +		if (vsi->trans.dma_addr_end - vsi->trans.dma_addr =3D=3D vsi->ube.size=
)
> +			return -ENOMEM;
> +		return -EAGAIN;
> +	}
> +
> +	instance->width =3D vsi->frame.uh.upscaled_width;
...
> +}
> +
> +static int vdec_av1_slice_setup_core_to_dst_buf(struct vdec_av1_slice_in=
stance *instance,
> +						struct vdec_lat_buf *lat_buf)
> +{
> +	struct vb2_v4l2_buffer *dst;
...
> +}
> +
> +static int vdec_av1_slice_setup_core_buffer(struct vdec_av1_slice_instan=
ce *instance,
> +					    struct vdec_av1_slice_pfc *pfc,
> +					    struct vdec_av1_slice_vsi *vsi,
> +					    struct vdec_fb *fb,
...
> +
> +	/* reference buffers */
> +	vq =3D v4l2_m2m_get_vq(instance->ctx->m2m_ctx, V4L2_BUF_TYPE_VIDEO_CAPT=
URE_MPLANE);
> +	if (!vq)
> +		return -EINVAL;
> +
...
> +	for (i =3D 0; i < V4L2_AV1_REFS_PER_FRAME; i++) {
> +		struct vdec_av1_slice_fb *vref =3D &vsi->ref[i];
> +
> +		vb =3D vb2_find_buffer(vq, pfc->ref_idx[i]);
> +		if (!vb) {
...
> +	}
> +	vsi->tile.dma_addr =3D lat_buf->tile_addr.dma_addr;
> +	vsi->tile.size =3D lat_buf->tile_addr.size;
> +
> +	return 0;
> +}
> +
> +static int vdec_av1_slice_setup_core(struct vdec_av1_slice_instance *ins=
tance,
> +				     struct vdec_fb *fb,
> +				     struct vdec_lat_buf *lat_buf,
> +				     struct vdec_av1_slice_pfc *pfc)
...
> +	int ret;
> +
> +	ret =3D vdec_av1_slice_setup_core_to_dst_buf(instance, lat_buf);
> +	if (ret)
> +		return ret;
> +
> +	ret =3D vdec_av1_slice_setup_core_buffer(instance, pfc, vsi, fb, lat_bu=
f);
> +	if (ret)
> +		return ret;
> +
...
> +}
> +
> +static int vdec_av1_slice_update_core(struct vdec_av1_slice_instance *in=
stance,
> +				      struct vdec_lat_buf *lat_buf,
> +				      struct vdec_av1_slice_pfc *pfc)
> +{
...
> +		goto error_vsi;
> +
> +	ret =3D vdec_av1_slice_init_iq_table(instance);
> +	if (ret)
> +		goto error_vsi;
> +
...
> +}
> +
> +static inline void vdec_av1_slice_get_dpb_size(struct vdec_av1_slice_ins=
tance *instance,
> +					       u32 *dpb_sz)
> +{
> +	/* refer av1 specification */
> +	*dpb_sz =3D V4L2_AV1_TOTAL_REFS_PER_FRAME + 1;
> +}
> +
...
> +}
> +
> +static int vdec_av1_slice_lat_decode(void *h_vdec, struct mtk_vcodec_mem=
 *bs,
> +				     struct vdec_fb *fb, bool *res_chg)
> +{
> +	struct vdec_av1_slice_instance *instance =3D h_vdec;
...
> +	ret =3D vdec_av1_slice_update_lat(instance, lat_buf, pfc);
> +
...
> +}
> +
> +const struct vdec_common_if vdec_av1_slice_lat_if =3D {
> +	.init		=3D vdec_av1_slice_init,
> +	.decode		=3D vdec_av1_slice_lat_decode,
> +	.get_param	=3D vdec_av1_slice_get_param,
> +	.deinit		=3D vdec_av1_slice_deinit,
> +};
...
>  		break;
> +	case V4L2_PIX_FMT_AV1_FRAME:
> +		ctx->dec_if =3D &vdec_av1_slice_lat_if;
...
> index 8b88ba082505e..58281e0d5357a 100644
...
>   */
> @@ -255,6 +258,14 @@ void vdec_msg_queue_deinit(struct vdec_msg_queue *ms=
g_queue,
>  		if (mem->va)
>  			mtk_vcodec_mem_free(ctx, mem);
> =20
> +		mem =3D &lat_buf->rd_mv_addr;
> +		if (mem->va)
> +			mtk_vcodec_mem_free(ctx, mem);
> +
> +		mem =3D &lat_buf->tile_addr;
> +		if (mem->va)
> +			mtk_vcodec_mem_free(ctx, mem);
> +
...
>  	}
>  }
> @@ -347,6 +358,22 @@ int vdec_msg_queue_init(struct vdec_msg_queue *msg_q=
ueue,
>  			goto mem_alloc_err;
>  		}
> =20
> +		if (ctx->current_codec =3D=3D V4L2_PIX_FMT_AV1_FRAME) {
...
> +		}
> +
>  		lat_buf->private_data =3D kzalloc(private_size, GFP_KERNEL);
...
> index 3700a79cd1f81..568ee000e7fa8 100644
> --- a/drivers/media/platform/mediatek/vcodec/vdec_msg_queue.h
> +++ b/drivers/media/platform/mediatek/vcodec/vdec_msg_queue.h
> @@ -42,6 +42,8 @@ struct vdec_msg_queue_ctx {
>   * struct vdec_lat_buf - lat buffer message used to store lat info for c=
ore decode
