...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0E5CB2775AC
	for <lists+devicetree@lfdr.de>; Thu, 24 Sep 2020 17:45:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728373AbgIXPo7 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 24 Sep 2020 11:44:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41408 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728139AbgIXPo6 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 24 Sep 2020 11:44:58 -0400
Received: from mail-ot1-x344.google.com (mail-ot1-x344.google.com [IPv6:2607:f8b0:4864:20::344])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BCA4FC0613CE;
        Thu, 24 Sep 2020 08:44:58 -0700 (PDT)
Received: by mail-ot1-x344.google.com with SMTP id h17so3625120otr.1;
        Thu, 24 Sep 2020 08:44:58 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=sender:date:from:to:cc:subject:message-id:references:mime-version
         ...
         :user-agent;
        bh=11PwEuEyP8EKt7hR7JjFuC7hsNvH3B9+EcDq/fiLnDg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=11PwEuEyP8EKt7hR7JjFuC7hsNvH3B9+EcDq/fiLnDg=;
        b=
X-Gm-Message-State: AOAM532sEhIVZhNg6PBbeKr906KgsMZUPRf1IxpveiCHI/slf+RyE5Un
        2QDPoIVKPY51pkWQq7c8Nag=
X-Google-Smtp-Source: ABdhPJwOuTjAvs8q8wPwKCYSjazVDLqqN5vqETmaqJIM66HPR4V++Gibia2f8axkx/JO6FgwzffbCA==
X-Received: by 2002:a9d:6a8b:: with SMTP id l11mr171393otq.273.1600962297767;
        Thu, 24 Sep 2020 08:44:57 -0700 (PDT)
Received: from localhost ([2600:1700:e321:62f0:329c:23ff:fee3:9d7c])
        by smtp.gmail.com with ESMTPSA id k10sm871991ots.60.2020.09.24.08.44.56
        (version=TLS1_2 cipher=ECDHE-ECDSA-CHACHA20-POLY1305 bits=256/256);
        Thu, 24 Sep 2020 08:44:56 -0700 (PDT)
Sender: Guenter Roeck <groeck7@gmail.com>
Date:   Thu, 24 Sep 2020 08:44:55 -0700
From:   Guenter Roeck <linux@roeck-us.net>
To:     Vadim Pasternak <vadimp@nvidia.com>
Cc:     robh+dt@kernel.org, linux-hwmon@vger.kernel.org,
        devicetree@vger.kernel.org
Subject: Re: [PATCH hwmon-next v3 1/2] hwmon: (pmbus) Add support for MPS
 Multi-phase mp2975 controller
Message-ID: <20200924154455.GA248069@roeck-us.net>
References: <20200923210213.15462-1-vadimp@nvidia.com>
 <20200923210213.15462-2-vadimp@nvidia.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20200923210213.15462-2-vadimp@nvidia.com>
User-Agent: Mutt/1.9.4 (2018-02-28)
Precedence: bulk
List-ID: <devicetree.vger.kernel.org>
X-Mailing-List: devicetree@vger.kernel.org

On Thu, Sep 24, 2020 at 12:02:12AM +0300, Vadim Pasternak wrote:
...
One return statement should be enough. Also, while it doesn't hurt,
the () is really unnecessary.
...
If info->phases[1] is 4, info->phases[1] % (MP2975_MAX_PHASE_RAIL2 - 1)
is 4 % 3 == 1.  So in that case only index 3 will be set. If the number of
phases is 3, nothing will be set (3 % 3 == 0). This is ... not easy to
understand.

> +	for (i = 1; i <= max_rail; i++)
> +		info->pfunc[MP2975_MAX_PHASE_RAIL1 - i] = PMBUS_HAVE_IOUT;

So ... i can be 1..3. This never sets a value for info->pfunc[0]. If the number
of phases is 1 or 4, it will (only) set info->pfunc[3]. And so on.

I think this function warrants a bit of explanation. I for sure can't follow it.
...
... but rail 2 can only support up to 4 phases ?
...
You are going quite overboard with error checking on the number of phases
for rail 2. mp2975_identify_multiphase_rail2() already limits the number
to 4. The calling code, in all but one places, already checks the range,
and there is no real reason to do the remaining check here.
...
The above makes me wonder: Can info->phases[0] ever be 0 ? We checked for
ret == 0 above, but I wonder if it should be ret & GENMASK(3, 0) == 0.
...
Is info->phases[1] == 0 indeed a bug here, ie rail 2 _must_ be enabled
if rail 1 is configured for 1..4 phases ? That doesn't exactly match the
comment above.
...
So let's see ... mp2975_set_phase_rail1(info) is always called except if rail 1
has no phases. In that case we bail out. The number of valid phases for rail 2
is, for the most part, min(8 - info->phases[0], 4).

Hmm... something like

	if (info->phases[0] == 0 || info->phases[0] > MP2975_MAX_PHASE_RAIL1)
		return -EINVAL;
	if (info->phases[0] < 5 && !info->phases[1])		// really ?
		return -EINVAL;

	mp2975_set_phase_rail1(info);
	num_phases2 = min(MP2975_MAX_PHASE_RAIL1 - info->phases[0], MP2975_MAX_PHASE_RAIL2);
	if (info->phases[1] && info->phases[1] <= num_phases2)
		mp2975_set_phase_rail2(info);

should do pretty much the same and would be much easier to read.

> +	default:
> +		return -EINVAL;

This seems to answer my question. With that, the "if (ret == 0)" check above
is really superfluous since it is again checked here.
...
Line length limit is now 100, so you should not need that many continuation
lines.
...
Can't really get here. If the compiler complains it might be better to just add
the default: case to one of the other cases.
