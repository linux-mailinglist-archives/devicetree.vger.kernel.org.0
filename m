...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B9C76259D75
	for <lists+devicetree@lfdr.de>; Tue,  1 Sep 2020 19:43:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728172AbgIARnP (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 1 Sep 2020 13:43:15 -0400
Received: from mail-co1nam11on2065.outbound.protection.outlook.com ([40.107.220.65]:54496
        "EHLO NAM11-CO1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726301AbgIARnO (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Tue, 1 Sep 2020 13:43:14 -0400
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=E+NchDK4uk+eEi86hGe5cQf5v8qYAQFx6QPhieK9hRI=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=E+NchDK4uk+eEi86hGe5cQf5v8qYAQFx6QPhieK9hRI=;
 b=l23rL9FDwWNH8E3zhb56rl977RWCnkCKDcPh+vHlNsxZjCeQPUsACASSQsj8ZtXrmxos+cFRtAuBdc13D4B78MX8bNCSDEQRVsNew7a6JcEqL0hCeLfBZeacFVLqNPl6Vj/Rm6OUneGfBpEJBOtEVCNTQ5im47VvBWXKFFmEajM=
Received: from BYAPR02MB4407.namprd02.prod.outlook.com (2603:10b6:a03:55::31)
 by BY5PR02MB6178.namprd02.prod.outlook.com (2603:10b6:a03:1fc::31) with
...
Received: from BYAPR02MB4407.namprd02.prod.outlook.com
 ...
 ([fe80::b0f6:b3a:6543:26f5%5]) with mapi id 15.20.3326.025; Tue, 1 Sep 2020
 17:43:05 +0000
...
Thread-Topic: [PATCH v9 5/5] remoteproc: Add initial zynqmp R5 remoteproc
 driver
Thread-Index: AQHWe8QVOFVHYsWxu0aNDK2y8QHEVKlK6TOAgAkBH3CAACl58A==
Date:   Tue, 1 Sep 2020 17:43:04 +0000
Message-ID: <BYAPR02MB44071969FAA810EEA143E3CDB52E0@BYAPR02MB4407.namprd02.prod.outlook.com>
References: <20200826161307.1064-1-ben.levinsky@xilinx.com>
 ...
 <BYAPR02MB4407542639384B1D0C84AF36B52E0@BYAPR02MB4407.namprd02.prod.outlook.com>
In-Reply-To: <BYAPR02MB4407542639384B1D0C84AF36B52E0@BYAPR02MB4407.namprd02.prod.outlook.com>
...
x-ms-office365-filtering-correlation-id: fe6bc0b8-727f-4198-e037-08d84e9e7b19
x-ms-traffictypediagnostic: BY5PR02MB6178:
x-microsoft-antispam-prvs: <BY5PR02MB6178812738BED05DF01C37DFB52E0@BY5PR02MB6178.namprd02.prod.outlook.com>
x-ms-oob-tlc-oobclassifiers: OLM:3513;
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam: BCL:0;
x-microsoft-antispam-message-info: 
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:BYAPR02MB4407.namprd02.prod.outlook.com;PTR:;CAT:NONE;SFS:(376002)(136003)(366004)(396003)(39860400002)(346002)(7696005)(86362001)(64756008)(66556008)(76116006)(66476007)(2940100002)(66446008)(2906002)(4326008)(66946007)(30864003)(5660300002)(478600001)(71200400001)(33656002)(52536014)(6506007)(53546011)(26005)(9686003)(186003)(6916009)(55016002)(83380400001)(8936002)(54906003)(966005)(316002)(8676002)(559001)(579004);DIR:OUT;SFP:1101;
x-ms-exchange-antispam-messagedata: 
...
X-MS-Exchange-CrossTenant-Network-Message-Id: fe6bc0b8-727f-4198-e037-08d84e9e7b19
X-MS-Exchange-CrossTenant-originalarrivaltime: 01 Sep 2020 17:43:04.7699
 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: 657af505-d5df-48d0-8300-c31994686c5c
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: T0CbLGhi6/R4u+LMnDRoU+namjrG33yLAA2m/A9A9ddTbztqgbtE2NTWnhdpYYWEiyRYIVANJfgbn/IuIeRWjA==
X-MS-Exchange-Transport-CrossTenantHeadersStamped: BY5PR02MB6178
...
> > Subject: Re: [PATCH v9 5/5] remoteproc: Add initial zynqmp R5 remotepro=
c
> > driver
> >
> > Hello Ben,
...
> > >  - fix formatting as per checkpatch.pl --strict. Note that 1 warning =
and 1
> > check
> > >    are still raised as each is due to fixing the warning results in t=
hat
...
> > >  carveouts are
> > >    now described in reserved memory as needed. That is, TCM nodes are
> not
> > >    coupled to remoteproc anymore. This is reflected in the remoteproc=
 R5
> > >  driver
> > >    and the device tree binding.
> > >  - remove mailbox from device tree binding as it is not necessary for=
 elf
> > >    loading
...
> > >  - remove zynqmp_r5_mem_probe and loop to Probe R5 memory devices
> at
> > >    remoteproc-probe time
> > >  - remove is_r5_mode_set from  zynqmp rpu remote processor private
> data
...
> > > v9:
> > > - as mboxes are now optional, if pdata->tx_mc_skbs not initialized th=
en
> > >   do not call skb_queue_empty
> > > - update usage for zynqmp_pm_set_rpu_mode,
> > zynqmp_pm_set_tcm_config and
> > >   zynqmp_pm_get_rpu_mode
> > > - update 5/5 patch commit message to document supported
> configurations
...
> > >   output arg
> > > - in tcm handling, unconditionally use &=3D 0x000fffff mask since all=
 nodes
> > >   in this fn are for tcm
> > > - update comments for translating dma field in tcm handling to device
> > >   address
> > > - update calls to rproc_mem_entry_init in parse_mem_regions so that
> there
> > >   are only 2 cases for types of carveouts instead of 3
> > > - in parse_mem_regions, check if device tree node is null before usin=
g it
...
> > > - remove call to zynqmp_r5_mem_probe and the fn itself as tcm handlin=
g
...
> > > - make mbox usage optional and gracefully inform user via dev_dbg if =
not
> > >   present
...
> >
> > Can the zynqmp_pm_* functions be reworked to take the correct types fro=
m
...
> >
> [Ben Levinsky] yes will rework in next series.
[Ben Levinsky] for reworking the zynqmp_pm* functions there are few things:
1. it still makes sense to have a return-by-reference variable here as the =
zynqmp_pm* functions expect to have a payload u32* struct to set return val=
ues in. In this case, keeping some ptr other than a simple enum is still re=
quired
2. instead of calling zynqmp_pm* functions we could directly call the IOTCL=
's that are being wrapped in drivers/firmware/Xilinx/zynqmp.c that are call=
ed here if you prefer.

doing the payload ptr's allocation within drivers/firmware/Xilinx/zynqmp.c =
might be a bit much because then we have to pass in the remoteproc driver's=
 device pointer.

With the above in mind, would keeping the original impl. But casting payloa=
d return values to enum's before doing comparisons in this function with th=
em be OK?
...
> >
> [Ben Levinsky] in this use case no. it was ported from another API elsewh=
ere.
> In Linux kernel case, can rework as you suggest in next series.
> > > +		if (ret < 0) {
> > > +			dev_err(dev,
...
> >
> > tcm_bank_idx <=3D 0x10? Seems like this should be tcm_bank_idx <=3D 1
> instead...
> >
...
> > 	};
> >
> [Ben Levinsky] makes sense. Will do so.
> > > +
...
> > specification.readthedocs.io/en/latest/devicetree-basics.html#generic-
> names-
> > recommendation
> >
...
> >
> [Ben Levinsky] Good catch. This was actually how it was done in a previou=
s
> implementation. Issue with that is
> TCM is not regular RAM so does not belong in reserved-mem as a carveout.
>=20
...
> >
> [Ben Levinsky] will do for this and subsequent usages as you pointed out.
> > > +				return -EINVAL;
> > > +			}
> > > +
> > > +			/* request access */
...
> > Cheers,
> >  Michael
> [Ben Levinsky] Thanks for the review BTW I have a question on %pOF... is =
this
> method depenedent on kernel configuration? For example printing ptr vals =
in
> kernel there are few ways to do this that depend on certain kernel config
> options enabled/disabled or earlyprintk.
