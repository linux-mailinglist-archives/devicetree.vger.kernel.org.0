...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 49CA21B33B6
	for <lists+devicetree@lfdr.de>; Wed, 22 Apr 2020 02:01:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726358AbgDVAB2 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 21 Apr 2020 20:01:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52564 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725850AbgDVAB0 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 21 Apr 2020 20:01:26 -0400
Received: from mail-lj1-x242.google.com (mail-lj1-x242.google.com [IPv6:2a00:1450:4864:20::242])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E3188C0610D5;
        Tue, 21 Apr 2020 17:01:25 -0700 (PDT)
Received: by mail-lj1-x242.google.com with SMTP id m8so394249lji.1;
        Tue, 21 Apr 2020 17:01:25 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=tJ9E9yHWxVIuyT4NHch/o5hmFxiFkhbXUoKhbRRgZbs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=tJ9E9yHWxVIuyT4NHch/o5hmFxiFkhbXUoKhbRRgZbs=;
        b=
X-Gm-Message-State: AGi0PuZ525/CUfBP1cC7VLC3brpKvpeG5dfaFI985XWRW4R3j9H/Yupp
        E7ihyerKL2m1enGOsBd/Tv8=
X-Google-Smtp-Source: APiQypJhV0vVQIm3Yf/ocVgYWAKxnDSl6Tomz5yK8U8jUTjtgabHOUY+JoWk51+WM5Q8SPMF4BhdaQ==
X-Received: by 2002:a2e:8108:: with SMTP id d8mr14148813ljg.184.1587513683574;
        Tue, 21 Apr 2020 17:01:23 -0700 (PDT)
Received: from localhost.localdomain (ppp91-78-208-152.pppoe.mtu-net.ru. [91.78.208.152])
        by smtp.gmail.com with ESMTPSA id y9sm2933425ljm.11.2020.04.21.17.01.22
...
Subject: [PATCH v6 1/6] ARM: tegra: Add device-tree for Acer Iconia Tab A500
Date:   Wed, 22 Apr 2020 02:59:38 +0300
Message-Id: <20200421235943.13627-2-digetx@gmail.com>
...
index 47af4ee65673..ee7c05a2fe86 100644
--- a/arch/arm/boot/dts/Makefile
+++ b/arch/arm/boot/dts/Makefile
@@ -1188,6 +1188,7 @@ dtb-$(CONFIG_MACH_SUNIV) += \
