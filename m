...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2B8E96B961B
	for <lists+devicetree@lfdr.de>; Tue, 14 Mar 2023 14:27:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232214AbjCNN1a (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 14 Mar 2023 09:27:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47634 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231372AbjCNN1C (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 14 Mar 2023 09:27:02 -0400
Received: from lahtoruutu.iki.fi (lahtoruutu.iki.fi [IPv6:2a0b:5c81:1c1::37])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3A827A0F3E;
        Tue, 14 Mar 2023 06:24:17 -0700 (PDT)
Received: from hillosipuli.retiisi.eu (dkzbhx1tyyyyyyyyyyyyt-3.rev.dnainternet.fi [IPv6:2001:14ba:4502:69d6::1])
        ...
        by lahtoruutu.iki.fi (Postfix) with ESMTPSA id 4PbZ4H0Tykz4BKLK;
        Tue, 14 Mar 2023 15:24:14 +0200 (EET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=iki.fi; s=lahtoruutu;
        t=1678800255;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=SCPX2cLe3+KYG719FFqHIRj+okhNIz9pYFJRM4uCKnI=;
        b=
ARC-Seal: i=1; s=lahtoruutu; d=iki.fi; t=1678800255; a=rsa-sha256;
        cv=none;
        b=
ARC-Authentication-Results: i=1;
        ORIGINATING;
        auth=pass smtp.auth=sailus smtp.mailfrom=sakari.ailus@iki.fi
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=iki.fi;
        s=lahtoruutu; t=1678800255;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=SCPX2cLe3+KYG719FFqHIRj+okhNIz9pYFJRM4uCKnI=;
        b=
Received: from valkosipuli.retiisi.eu (valkosipuli.localdomain [192.168.4.2])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by hillosipuli.retiisi.eu (Postfix) with ESMTPS id DF291634C91;
        Tue, 14 Mar 2023 15:23:12 +0200 (EET)
Date:   Tue, 14 Mar 2023 15:23:12 +0200
...
Subject: Re: [PATCH v1 2/2] media/i2c: Add a driver for the Sony IMX708 image
 sensor
Message-ID: <ZBB1QPJp4R2m57bx@valkosipuli.retiisi.eu>
