...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9F0F930B8B3
	for <lists+devicetree@lfdr.de>; Tue,  2 Feb 2021 08:36:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231703AbhBBHff (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 2 Feb 2021 02:35:35 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51398 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229920AbhBBHff (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 2 Feb 2021 02:35:35 -0500
Received: from mail-pl1-x636.google.com (mail-pl1-x636.google.com [IPv6:2607:f8b0:4864:20::636])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3F1CCC061756;
        Mon,  1 Feb 2021 23:34:55 -0800 (PST)
Received: by mail-pl1-x636.google.com with SMTP id e12so2774855pls.4;
        Mon, 01 Feb 2021 23:34:55 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=bTyIckat0VeYDwNrIb/cEKYM3J9fLK30TotA+DGc+Qc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=bTyIckat0VeYDwNrIb/cEKYM3J9fLK30TotA+DGc+Qc=;
        b=
X-Gm-Message-State: AOAM533hPRuHs4DFqEBmc0xuOqRTjbg70hdpYNmSaKjQ11fC5p3KZWWp
        Zldtad2LXSRbYTr3dUoWniI=
X-Google-Smtp-Source: ABdhPJzs+a8VxXWG45VWiip/yqVcPOdjYgSAW40ipLQSO0WlS9AYRLCU7wo6B0IKgxPCGxEAZ1tkXQ==
X-Received: by 2002:a17:902:d202:b029:e1:8936:cf31 with SMTP id t2-20020a170902d202b02900e18936cf31mr1721571ply.51.1612251294769;
        Mon, 01 Feb 2021 23:34:54 -0800 (PST)
Received: from ubt.spreadtrum.com ([117.18.48.82])
        by smtp.gmail.com with ESMTPSA id o4sm1752029pjs.57.2021.02.01.23.34.50
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 01 Feb 2021 23:34:53 -0800 (PST)
...
Subject: [PATCH v2 2/2] iommu: add Unisoc iommu basic driver
Date:   Tue,  2 Feb 2021 15:32:58 +0800
Message-Id: <20210202073258.559443-3-zhang.lyra@gmail.com>
...
index 000000000000..0e638d56b309
--- /dev/null
...
+	if (IS_ERR(sdev->base)) {
+		dev_err(dev, "Failed to get registers syscon.\n");
