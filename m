Return-Path: <devicetree+bounces-247-lists+devicetree=lfdr.de@vger.kernel.org>
X-Original-To: lists+devicetree@lfdr.de
Delivered-To: lists+devicetree@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id D23CC7A07FC
	for <lists+devicetree@lfdr.de>; Thu, 14 Sep 2023 16:54:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8AACE2818CE
	for <lists+devicetree@lfdr.de>; Thu, 14 Sep 2023 14:54:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BECC522EE4;
	Thu, 14 Sep 2023 14:39:56 +0000 (UTC)
X-Original-To: devicetree@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D38862137A;
	Thu, 14 Sep 2023 14:39:54 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id AAD41C43397;
	Thu, 14 Sep 2023 14:39:53 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1694702394;
	bh=LVQpf2Ee+KLxBywq1NdTuKmHlHiNzxizey4ccDcwL/Y=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=
...
Subject: [PATCH net-next 12/15] net: ethernet: mtk_wed: introduce partial AMSDU offload support for MT7988
Date: Thu, 14 Sep 2023 16:38:17 +0200
Message-ID: <d9a4b704b299a4b2e220e69ee3f9b83dc120b98d.1694701767.git.lorenzo@kernel.org>
...
index ad7cd6c88d64..7750869509c3 100644
...
@@ -140,6 +142,23 @@ mtk_wdma_rx_reset(struct mtk_wed_device *dev)
 	return ret;
 }
...
+
 ...
 {
@@ -302,6 +321,118 @@ mtk_wed_assign(struct mtk_wed_device *dev)
 	return hw;
 }
...
+
 ...
 {
@@ -677,6 +808,7 @@ __mtk_wed_detach(struct mtk_wed_device *dev)
...
@@ -1114,23 +1246,6 @@ mtk_wed_ring_reset(struct mtk_wed_ring *ring, int size, bool tx)
 	}
 }
...
index 224ff00bdd8b..9c443bb4a850 100644
...
index d50ccdd3a69b..6472650f3a59 100644
--- a/drivers/net/ethernet/mediatek/mtk_wed_regs.h
+++ b/drivers/net/ethernet/mediatek/mtk_wed_regs.h
@@ -681,6 +681,82 @@ struct mtk_wdma_desc {
...
index 0896aaa91dd7..1b00b34dc352 100644
...
index 0beccbe45585..802e38e0840d 100644
