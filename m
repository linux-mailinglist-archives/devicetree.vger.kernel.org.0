...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1643C128023
	for <lists+devicetree@lfdr.de>; Fri, 20 Dec 2019 16:55:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727402AbfLTPzr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 20 Dec 2019 10:55:47 -0500
Received: from lelv0142.ext.ti.com ([198.47.23.249]:33778 "EHLO
        lelv0142.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727359AbfLTPzq (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 20 Dec 2019 10:55:46 -0500
Received: from lelv0265.itg.ti.com ([10.180.67.224])
        by lelv0142.ext.ti.com (8.15.2/8.15.2) with ESMTP id xBKFtSlP026164;
        Fri, 20 Dec 2019 09:55:28 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1576857328;
        bh=XkLox9eqSapiFizCwYomZNcxnN/Bygkr9GIifzwMNBI=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=Z71UbBxR59SHh2nqKr38tEfNFodh+Aa51RclfzsvRvg6wjC+JRjQ7JG45qMnZo0nC
         VQhlB1U77Xcjb6xFtCVUwbW1CEPd5Upp+5ZeB1/7yXJ97mK8mtNoehUmMGI2qSmLri
         FaVaS3VbL+F+ZxwKS0oNEeBLQxB4bJuET5PAoXsM=
Received: from DFLE113.ent.ti.com (dfle113.ent.ti.com [10.64.6.34])
        by lelv0265.itg.ti.com (8.15.2/8.15.2) with ESMTPS id xBKFtSBP110455
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Fri, 20 Dec 2019 09:55:28 -0600
Received: from DFLE107.ent.ti.com (10.64.6.28) by DFLE113.ent.ti.com
 (10.64.6.34) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3; Fri, 20
 Dec 2019 09:55:27 -0600
Received: from lelv0326.itg.ti.com (10.180.67.84) by DFLE107.ent.ti.com
 (10.64.6.28) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1847.3 via
 Frontend Transport; Fri, 20 Dec 2019 09:55:27 -0600
Received: from jadmar.ti.com (ileax41-snat.itg.ti.com [10.172.224.153])
        by lelv0326.itg.ti.com (8.15.2/8.15.2) with ESMTP id xBKFtEE3005603;
        Fri, 20 Dec 2019 09:55:24 -0600
...
Subject: [PATCH v5 4/5] drm/tidss: New driver for TI Keystone platform Display SubSystem
Date:   Fri, 20 Dec 2019 17:55:12 +0200
Message-ID: <082458208aca73c3a44e567abcea87046da038d6.1576857145.git.jsarha@ti.com>
...
---
 ...
 21 files changed, 4849 insertions(+)
...
new file mode 100644
index 000000000000..65f23fba67ee
--- /dev/null
...
new file mode 100644
index 000000000000..fb6cfa55c2c9
--- /dev/null
...
+
+	.vp_feat = { .color = {
+			.has_ctm = false, /* XXX no K2G implementation yet */
+			.gamma_size = 256,
...
+	FLD_GET(dispc_read(dispc, idx), start, end)
+
+#define REG_FLD_MOD(dispc, idx, val, start, end)			\
+	dispc_write(dispc, idx, FLD_MOD(dispc_read(dispc, idx), val, start, end))
+
+#define VID_REG_GET(dispc, hw_plane, idx, start, end)			\
+	FLD_GET(dispc_vid_read(dispc, hw_plane, idx), start, end)
+
+#define VID_REG_FLD_MOD(dispc, hw_plane, idx, val, start, end)		\
+	dispc_vid_write(dispc, hw_plane, idx, FLD_MOD(dispc_vid_read(dispc, hw_plane, idx), val, start, end))
+
+#define VP_REG_GET(dispc, vp, idx, start, end)			\
+	FLD_GET(dispc_vp_read(dispc, vp, idx), start, end)
+
+#define VP_REG_FLD_MOD(dispc, vp, idx, val, start, end)			\
+	dispc_vp_write(dispc, vp, idx, FLD_MOD(dispc_vp_read(dispc, vp, idx), val, start, end))
+
+#define OVR_REG_GET(dispc, ovr, idx, start, end)		\
+	FLD_GET(dispc_ovr_read(dispc, ovr, idx), start, end)
+
+#define OVR_REG_FLD_MOD(dispc, ovr, idx, val, start, end)		\
+	dispc_ovr_write(dispc, ovr, idx, FLD_MOD(dispc_ovr_read(dispc, ovr, idx), val, start, end))
+
...
+}
+
+static void dispc_vid_write(struct dispc_device *dispc, u32 hw_plane, u16 reg, u32 val)
+{
...
+}
+
+static void dispc_ovr_write(struct dispc_device *dispc, u32 hw_videoport, u16 reg, u32 val)
+{
...
+}
+
+static void dispc_vp_write(struct dispc_device *dispc, u32 hw_videoport, u16 reg, u32 val)
+{
...
+}
+
+static void dispc_k2g_write_irqenable(struct dispc_device *dispc,
+				      dispc_irq_t mask)
+{
...
+}
+
+static void dispc_k3_clear_irqstatus(struct dispc_device *dispc,
+				     dispc_irq_t clearmask)
+{
+	unsigned int i;
+	u32 top_clear = 0;
+
...
+ */
+static unsigned int dispc_pclk_diff(unsigned long rate,
...
+
+static void dispc_csc_offset_regval(const struct dispc_csc_coef *csc,
+				    u32 *regval)
+{
...
+static void dispc_csc_yuv2rgb_regval(const struct dispc_csc_coef *csc,
+				     u32 *regval)
+{
...
+}
+
+static void __maybe_unused dispc_csc_rgb2yuv_regval(const struct dispc_csc_coef *csc,
+						    u32 *regval)
+{
...
+	else
+		VID_REG_FLD_MOD(dispc, hw_plane, DISPC_VID_ATTRIBUTES, 0, 28, 28);
+
...
+
+	for (i = 0; i < dispc->feat->num_vps; i++)
+		dispc_vp_write_gamma_table(dispc, i);
+}
+
...
+}
+
+static void dispc_cpr_csc_from_ctm(const struct drm_color_ctm *ctm,
...
+}
+
+static void dispc_vp_write_csc(struct dispc_device *dispc, u32 hw_videoport,
+			       const struct dispc_csc_coef *csc)
+{
...
+	unsigned int i;
+
+	if (!WARN_ON(dispc->feat->subrev == DISPC_K2G))
+		return;
+
+	csc->to_regval(csc, regval);
+
...
+		struct dispc_csc_coef cpr;
+
+		dispc_cpr_csc_from_ctm(ctm, &cpr);
+		dispc_vp_write_csc(dispc, hw_videoport, &cpr);
+
...
+	dispc_vp_set_color_mgmt(dispc, hw_videoport, state);
+}
+
...
+
+	for (i = 0; i < dispc->feat->num_vps; i++)
+		dispc_vp_set_gamma(dispc, i, NULL, 0);
+
+	return 0;
+}
+
...
new file mode 100644
index 000000000000..6199671ca648
--- /dev/null
...
new file mode 100644
index 000000000000..72d7edd80085
--- /dev/null
...
new file mode 100644
index 000000000000..0709a7d5ef71
--- /dev/null
...
new file mode 100644
index 000000000000..033bccb1e473
--- /dev/null
...
new file mode 100644
index 000000000000..16a399a396fa
--- /dev/null
...
new file mode 100644
index 000000000000..710feac7f99f
--- /dev/null
