...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E09A166AF8A
	for <lists+devicetree@lfdr.de>; Sun, 15 Jan 2023 07:26:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229675AbjAOGZz (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 15 Jan 2023 01:25:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50818 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229676AbjAOGZy (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 15 Jan 2023 01:25:54 -0500
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9CD36A263;
        Sat, 14 Jan 2023 22:25:48 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1673763948; x=1705299948;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=PFjxfRgXDjev0Zg6lEJimmKmOmbVCzjp1tzDPSom3cE=;
  b=R2hIQHjjxpoCg6koAxhULc5v37EuSIjwImFua4hxRZ7/rJXsV00NHsaJ
   peBTgoBoxliBjfi7oddb7kahBHiqjnIRp2PwRcw7t2T27fCupOdlR/CYL
   uKVFAdpDe3FnBcHkHCIZMva8x97nn4tu2t5iGml6v8QfzBuQYyITE/Q2o
   aQdjH/4uCjx+Kq/SS3tqDVl1MnJ4WZuPDPBGWupl7itvs01dj+7d+cwsQ
   eg5o0e6hBqKx3rTYDyXw8pqR0WG2ZmA7tAcuvbRLNZCGRT1vsCfivfF2p
   0KTFUQbUsaIwSzX9fQ4faosBGJ0ZWEM2BU0iSSY4NKRZwk5XZ/HEWPMgy
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10590"; a="307823534"
X-IronPort-AV: E=Sophos;i="5.97,218,1669104000"; 
   d="scan'208";a="307823534"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 14 Jan 2023 22:25:45 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10590"; a="658644046"
X-IronPort-AV: E=Sophos;i="5.97,218,1669104000"; 
   d="scan'208";a="658644046"
Received: from lkp-server01.sh.intel.com (HELO 82361ecceba2) ([10.239.97.150])
  by orsmga002.jf.intel.com with ESMTP; 14 Jan 2023 22:25:40 -0800
Received: from kbuild by 82361ecceba2 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1pGwSZ-00008a-0n;
        Sun, 15 Jan 2023 06:25:39 +0000
Date:   Sun, 15 Jan 2023 14:25:07 +0800
...
Message-ID: <202301151450.LL0DW8mQ-lkp@intel.com>
References: <20230113142718.3038265-3-o.rempel@pengutronix.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="eraP/fPa5LHbjeQB"
...
>> drivers/clk/imx/clk-imx6q.c:919:18: error: passing 'const char *const[2]' to parameter of type 'const char **' discards qualifiers [-Werror,-Wincompatible-pointer-types-discards-qualifiers]
                                   IOMUXC_GPR1, enet_ref_sels, ARRAY_SIZE(enet_ref_sels),
                                                ^~~~~~~~~~~~~
   drivers/clk/imx/clk.h:463:33: note: passing argument to parameter 'parent_names' here
