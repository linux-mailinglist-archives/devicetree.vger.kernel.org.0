...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 089986B625
	for <lists+devicetree@lfdr.de>; Wed, 17 Jul 2019 07:56:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726056AbfGQF4A (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 17 Jul 2019 01:56:00 -0400
Received: from hqemgate16.nvidia.com ([216.228.121.65]:12539 "EHLO
        hqemgate16.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725294AbfGQF4A (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 17 Jul 2019 01:56:00 -0400
Received: from hqpgpgate102.nvidia.com (Not Verified[216.228.121.13]) by hqemgate16.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5d2eb8690003>; Tue, 16 Jul 2019 22:55:53 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate102.nvidia.com (PGP Universal service);
  Tue, 16 Jul 2019 22:55:55 -0700
X-PGP-Universal: processed;
        by hqpgpgate102.nvidia.com on Tue, 16 Jul 2019 22:55:55 -0700
...
Message-ID: <093462f3-8c6d-d084-9822-ae4eff041c64@nvidia.com>
Date:   Tue, 16 Jul 2019 22:55:52 -0700
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1563342953; bh=sq2ekyuZ3xTzNOmTE4NY008Kro7j9soJ8gCF6m1k678=;
        h=X-PGP-Universal:Subject:To:CC:References:From:Message-ID:Date:
         User-Agent:MIME-Version:In-Reply-To:X-Originating-IP:
         X-ClientProxiedBy:Content-Type:Content-Transfer-Encoding:
         Content-Language;
        b=
...
>>>>>
>>>>>   =C2=A0=C2=A0=C2=A0 =C2=A0=C2=A0=C2=A0 - Save CPU clock policy regis=
ters, and Perform dfll
...
>>>>>
>>>>>   =C2=A0=C2=A0=C2=A0 =C2=A0=C2=A0=C2=A0 - Re-init DFLL, Set in Open-L=
oop mode, restore CPU Clock
...
cclk_g is registered as clk_super_mux and it doesn't use frac_div ops to=20
do save/restore its divider.

Also, during clock context we cant restore cclk_g as cclk_g source will=20
be dfll and dfll will not be resumed/re-initialized by the time=20
clk_super_mux save/restore happens.

we can't use save/restore context for dfll clk_ops because dfllCPU_out=20
parent to CCLK_G is first in the clock tree and dfll_ref and dfll_soc=20
peripheral clocks are not restored by the time dfll restore happens.=20
Also dfll peripheral clock enables need to be restored before dfll=20
restore happens which involves programming dfll controller for=20
re-initialization.

So dfll resume/re-init is done in clk-tegra210 at end of all clocks=20
restore in V5 series but instead of in clk-tegra210 driver I moved now=20
to dfll-fcpu driver pm_ops as all dfll dependencies will be restored=20
