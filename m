...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 21D211B2C35
	for <lists+devicetree@lfdr.de>; Tue, 21 Apr 2020 18:16:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728597AbgDUQPM (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 21 Apr 2020 12:15:12 -0400
Received: from bhuna.collabora.co.uk ([46.235.227.227]:35684 "EHLO
        bhuna.collabora.co.uk" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725987AbgDUQPL (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 21 Apr 2020 12:15:11 -0400
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (Authenticated sender: aratiu)
        with ESMTPSA id 62B7C2A18D7
...
Cc:     Jernej Skrabec <jernej.skrabec@siol.net>,
        ...
        linux-imx@nxp.com, Boris Brezillon <boris.brezillon@collabora.com>,
        Emil Velikov <emil.velikov@collabora.com>,
        Adrian Pop <pop.adrian61@gmail.com>,
        Arnaud Ferraris <arnaud.ferraris@collabora.com>
Subject: [PATCH v7 2/8] drm: bridge: dw_mipi_dsi: abstract register access using reg_fields
Date:   Tue, 21 Apr 2020 19:16:04 +0300
Message-Id: <20200421161610.1501827-3-adrian.ratiu@collabora.com>
...
@@ -1006,6 +1117,84 @@ static int dw_mipi_dsi_get_hw_version(struct dw_mipi_dsi *dsi)
 	return 0;
 }
...
+
 ...
 __dw_mipi_dsi_probe(struct platform_device *pdev,
 		    const struct dw_mipi_dsi_plat_data *plat_data)
@@ -1086,6 +1275,12 @@ __dw_mipi_dsi_probe(struct platform_device *pdev,
 		return ERR_PTR(ret);
 	}
