...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7A7C37606B3
	for <lists+devicetree@lfdr.de>; Tue, 25 Jul 2023 05:34:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231536AbjGYDe2 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 24 Jul 2023 23:34:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37320 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231514AbjGYDe0 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 24 Jul 2023 23:34:26 -0400
Received: from rtits2.realtek.com.tw (rtits2.realtek.com [211.75.126.72])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 3FB41173D;
        Mon, 24 Jul 2023 20:34:15 -0700 (PDT)
Authenticated-By: 
X-SpamFilter-By: ArmorX SpamTrap 5.77 with qID 36P3XTYt8023830, This message is accepted by code: ctloc85258
Received: from mail.realtek.com (rtexh36506.realtek.com.tw[172.21.6.27])
        by rtits2.realtek.com.tw (8.15.2/2.81/5.90) with ESMTPS id 36P3XTYt8023830
        (version=TLSv1.2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=FAIL);
        Tue, 25 Jul 2023 11:33:29 +0800
Received: from RTEXMBS06.realtek.com.tw (172.21.6.99) by
 RTEXH36506.realtek.com.tw (172.21.6.27) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2507.17; Tue, 25 Jul 2023 11:33:40 +0800
Received: from RTEXH36506.realtek.com.tw (172.21.6.27) by
 RTEXMBS06.realtek.com.tw (172.21.6.99) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2375.34; Tue, 25 Jul 2023 11:33:40 +0800
Received: from localhost.localdomain (172.21.252.101) by
 RTEXH36506.realtek.com.tw (172.21.6.27) with Microsoft SMTP Server id
 15.1.2507.17 via Frontend Transport; Tue, 25 Jul 2023 11:33:40 +0800
...
Subject: [PATCH v9 3/5] phy: realtek: usb: Add driver for the Realtek SoC USB 3.0 PHY
Date:   Tue, 25 Jul 2023 11:31:54 +0800
Message-ID: <20230725033318.8361-3-stanley_chang@realtek.com>
...
v4 to v5 change:
    ...
    2. Remove the set_parameter in debugfs.
    3. Revise the error and debug log.
v3 to v4 change:
...
---
 ...
 drivers/phy/realtek/phy-rtk-usb3.c | 766 +++++++++++++++++++++++++++++
...
index 000000000000..6050f1ef4f6b
--- /dev/null
