...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C2C6612F72B
	for <lists+devicetree@lfdr.de>; Fri,  3 Jan 2020 12:26:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727462AbgACL0j (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Jan 2020 06:26:39 -0500
Received: from mail25.static.mailgun.info ([104.130.122.25]:49545 "EHLO
        mail25.static.mailgun.info" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727220AbgACL0i (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 3 Jan 2020 06:26:38 -0500
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1578050791; h=References: In-Reply-To: Message-Id: Date:
 Subject: To: From: Sender;
 bh=1yJC3vr7vu6nu508nonb+EknF9vsKL22rt0eeyM0BAE=; b=bC4e1c0g+QUWJn98/vnWXdAqxyRWC65jDq0pPAwaw8ZFOqXZXUkJ2NPV/DAX4c+cxorh3yQr
 E5RJX1GUrbqsT5xdr4E8lK7IfU13JIOGEeq5Za8hmi6TvemV3zXcQSpPa7RHp21cmkhC8v1c
 8oqHukSOHFInUdHejt94+EilciE=
X-Mailgun-Sending-Ip: 104.130.122.25
X-Mailgun-Sid: WyI1YmJiNiIsICJkZXZpY2V0cmVlQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171])
 by mxa.mailgun.org with ESMTP id 5e0f24e3.7fe8812b7650-smtp-out-n02;
 Fri, 03 Jan 2020 11:26:27 -0000 (UTC)
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 60C90C447A2; Fri,  3 Jan 2020 11:26:27 +0000 (UTC)
...
Received: from srichara-linux.qualcomm.com (blr-c-bdr-fw-01_GlobalNAT_AllZones-Outside.qualcomm.com [103.229.19.19])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id BF094C43383;
        Fri,  3 Jan 2020 11:25:59 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org BF094C43383
...
Subject: [PATCH 2/2] clk: qcom: Add ipq6018 Global Clock Controller support
Date:   Fri,  3 Jan 2020 16:55:44 +0530
Message-Id: <1578050744-3761-3-git-send-email-sricharan@codeaurora.org>
...
---
 ...
 3 files changed, 4643 insertions(+)
 create mode 100644 drivers/clk/qcom/gcc-ipq6018.c

diff --git a/drivers/clk/qcom/Kconfig b/drivers/clk/qcom/Kconfig
index 3b33ef1..bc9972b 100644
--- a/drivers/clk/qcom/Kconfig
+++ b/drivers/clk/qcom/Kconfig
@@ -95,6 +95,13 @@ config IPQ_GCC_4019
