...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 776D339D5C3
	for <lists+devicetree@lfdr.de>; Mon,  7 Jun 2021 09:16:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230272AbhFGHRy (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 7 Jun 2021 03:17:54 -0400
Received: from twspam01.aspeedtech.com ([211.20.114.71]:35940 "EHLO
        twspam01.aspeedtech.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230217AbhFGHRy (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 7 Jun 2021 03:17:54 -0400
Received: from mail.aspeedtech.com ([192.168.0.24])
        by twspam01.aspeedtech.com with ESMTP id 15771bud056334;
        Mon, 7 Jun 2021 15:01:37 +0800 (GMT-8)
        (envelope-from steven_lee@aspeedtech.com)
Received: from slee-VirtualBox.localdomain (192.168.100.253) by
 TWMBX02.aspeed.com (192.168.0.24) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Mon, 7 Jun 2021 15:15:22 +0800
...
Subject: [PATCH v4 4/7] gpio: gpio-aspeed-sgpio: Add AST2600 sgpio support
Date:   Mon, 7 Jun 2021 15:15:09 +0800
Message-ID: <20210607071514.11727-5-steven_lee@aspeedtech.com>
...
X-ClientProxiedBy: TWMBX02.aspeed.com (192.168.0.24) To TWMBX02.aspeed.com
 (192.168.0.24)
X-DNSRBL: 
X-MAIL: twspam01.aspeedtech.com 15771bud056334
Precedence: bulk
...
@@ -75,7 +81,13 @@ static const struct aspeed_sgpio_bank aspeed_sgpio_banks[] = {
 		.val_regs = 0x0038,
 		.rdata_reg = 0x0078,
 		.irq_regs = 0x003C,
-		.names = { "I", "J" },
...
@@ -139,18 +151,19 @@ static int aspeed_sgpio_init_valid_mask(struct gpio_chip *gc,
...
@@ -161,30 +174,30 @@ static void aspeed_sgpio_irq_init_valid_mask(struct gpio_chip *gc,
 	struct aspeed_sgpio *sgpio = gpiochip_get_data(gc);
 	int n = sgpio->n_sgpio;
...
@@ -194,11 +207,11 @@ static int aspeed_sgpio_get(struct gpio_chip *gc, unsigned int offset)
...
@@ -209,9 +222,9 @@ static int sgpio_set_value(struct gpio_chip *gc, unsigned int offset, int val)
 	reg = ioread32(addr_r);
...
@@ -232,7 +245,9 @@ static void aspeed_sgpio_set(struct gpio_chip *gc, unsigned int offset, int val)
...
@@ -253,7 +268,9 @@ static int aspeed_sgpio_dir_out(struct gpio_chip *gc, unsigned int offset, int v
...
@@ -466,9 +483,21 @@ static int aspeed_sgpio_setup_irqs(struct aspeed_sgpio *gpio,
 	return 0;
 }
...
+	int rc;
 	...
 	if (!gpio)
@@ -489,13 +519,26 @@ static int __init aspeed_sgpio_probe(struct platform_device *pdev)
 	if (IS_ERR(gpio->base))
