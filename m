...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 38AA6362F0C
	for <lists+devicetree@lfdr.de>; Sat, 17 Apr 2021 11:51:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236096AbhDQJvu convert rfc822-to-8bit (ORCPT
        <rfc822;lists+devicetree@lfdr.de>); Sat, 17 Apr 2021 05:51:50 -0400
Received: from aposti.net ([89.234.176.197]:40868 "EHLO aposti.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S236057AbhDQJvr (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Sat, 17 Apr 2021 05:51:47 -0400
Date:   Sat, 17 Apr 2021 10:51:02 +0100
From:   Paul Cercueil <paul@crapouillou.net>
Subject: Re: [PATCH v5 09/11] pinctrl: Ingenic: Add pinctrl driver for JZ4755.
...
Message-Id: <2PCPRQ.K148UFAEZH8K1@crapouillou.net>
In-Reply-To: <1618589645-96504-10-git-send-email-zhouyanjie@wanyeetech.com>
References: <1618589645-96504-1-git-send-email-zhouyanjie@wanyeetech.com>
        <1618589645-96504-10-git-send-email-zhouyanjie@wanyeetech.com>
MIME-Version: 1.0
...
> 0xfffff00f,
>  };
> @@ -2670,6 +2803,7 @@ static const struct of_device_id 
...
> @@ -2877,6 +3011,11 @@ static const struct of_device_id 
