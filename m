...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9A9144893A8
	for <lists+devicetree@lfdr.de>; Mon, 10 Jan 2022 09:37:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241597AbiAJIg2 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 10 Jan 2022 03:36:28 -0500
Received: from mailgw01.mediatek.com ([60.244.123.138]:50560 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S240902AbiAJIfm (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 10 Jan 2022 03:35:42 -0500
X-UUID: 669ed7b174e14fc79afdacbc1ea158d7-20220110
X-UUID: 669ed7b174e14fc79afdacbc1ea158d7-20220110
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by mailgw01.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
        with ESMTP id 658045988; Mon, 10 Jan 2022 16:35:05 +0800
Received: from mtkcas10.mediatek.inc (172.21.101.39) by
 mtkmbs10n2.mediatek.inc (172.21.101.183) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id 15.2.792.3;
 Mon, 10 Jan 2022 16:35:04 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas10.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Mon, 10 Jan 2022 16:35:02 +0800
...
Subject: [PATCH v4, 12/15] media: mtk-vcodec: Extract H264 common code
Date:   Mon, 10 Jan 2022 16:34:39 +0800
Message-ID: <20220110083442.32604-13-yunfei.dong@mediatek.com>
...
---
 ...
 .../mtk-vcodec/vdec/vdec_h264_req_if.c        | 400 +-----------------
 4 files changed, 589 insertions(+), 377 deletions(-)
...
index 000000000000..c8113ca251f5
--- /dev/null
...
new file mode 100644
index 000000000000..0d32fe6a0d29
--- /dev/null
...
index d00219a7587c..ee28686639c9 100644
...
@@ -212,265 +94,35 @@ struct vdec_h264_slice_inst {
...
@@ -478,21 +130,14 @@ static void get_vdec_decode_parameters(struct vdec_h264_slice_inst *inst)
...
-
 ...
 {
 	int err;
@@ -525,7 +170,7 @@ static int alloc_mv_buf(struct vdec_h264_slice_inst *inst,
 	int i;
 	int err;
...
@@ -674,7 +319,8 @@ static int vdec_h264_slice_decode(void *h_vdec, struct mtk_vcodec_mem *bs,
 {
