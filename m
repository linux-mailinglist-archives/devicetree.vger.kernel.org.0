...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 45E161B6C30
	for <lists+devicetree@lfdr.de>; Fri, 24 Apr 2020 05:55:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726565AbgDXDzl (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 23 Apr 2020 23:55:41 -0400
Received: from hqnvemgate24.nvidia.com ([216.228.121.143]:10774 "EHLO
        hqnvemgate24.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726383AbgDXDz1 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 23 Apr 2020 23:55:27 -0400
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate24.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5ea262b80000>; Thu, 23 Apr 2020 20:53:28 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Thu, 23 Apr 2020 20:55:25 -0700
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Thu, 23 Apr 2020 20:55:25 -0700
Received: from HQMAIL105.nvidia.com (172.20.187.12) by HQMAIL107.nvidia.com
 (172.20.187.13) with Microsoft SMTP Server (TLS) id 15.0.1473.3; Fri, 24 Apr
 2020 03:55:25 +0000
Received: from rnnvemgw01.nvidia.com (10.128.109.123) by HQMAIL105.nvidia.com
 (172.20.187.12) with Microsoft SMTP Server (TLS) id 15.0.1473.3 via Frontend
 Transport; Fri, 24 Apr 2020 03:55:24 +0000
Received: from skomatineni-linux.nvidia.com (Not Verified[10.2.165.49]) by rnnvemgw01.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5ea2632b0002>; Thu, 23 Apr 2020 20:55:24 -0700
...
Subject: [RFC PATCH v10 6/9] media: tegra: Add Tegra210 Video input driver
Date:   Thu, 23 Apr 2020 20:55:10 -0700
Message-ID: <1587700513-28449-7-git-send-email-skomatineni@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1587700408; bh=OflZWIuVgPNu5sBhrjKTOh5+Z1/TMOO5XWV3Mpti3bw=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:X-NVConfidentiality:MIME-Version:
         Content-Type;
        b=
...
---
 ...
 14 files changed, 3319 insertions(+)
...
index c6b4fb5..adf3e52 100644
--- a/drivers/staging/media/Kconfig
+++ b/drivers/staging/media/Kconfig
@@ -34,6 +34,8 @@ source "drivers/staging/media/rkvdec/Kconfig"
