...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 11105761B7F
	for <lists+devicetree@lfdr.de>; Tue, 25 Jul 2023 16:24:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230095AbjGYOYo (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 25 Jul 2023 10:24:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36720 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232782AbjGYOYN (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 25 Jul 2023 10:24:13 -0400
Received: from mail.hugovil.com (mail.hugovil.com [162.243.120.170])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2D9CC194;
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=hugovil.com
        ...
        bh=UeVhJ2XRP+zh00CrtzGgW2f/dBwi3qaORDlgNW3muqo=; b=uTqTCfZRXKU9ENEhUonRUdKfE9
        wvl2lsqakD5wyjQJ+TuxyMTy2LJ1fcAXmIAIAsSylDE83mC80xrzed4xcZpBkt1BGGnmIoSKIKWME
        /fgsDI5J9CpZF2BeVRx44xk2Cqo6y2it/DNPTe9avuvFhugJWFT071aLddKGl7UgW94A=;
Received: from modemcable061.19-161-184.mc.videotron.ca ([184.161.19.61]:34256 helo=localhost.localdomain)
        by mail.hugovil.com with esmtpa (Exim 4.92)
        (envelope-from <hugo@hugovil.com>)
        id 1qOIxD-0003Kt-OV; Tue, 25 Jul 2023 10:24:01 -0400
...
Date:   Tue, 25 Jul 2023 10:23:38 -0400
...
X-Spam-Status: No, score=-2.1 required=5.0 tests=BAYES_00,DKIM_SIGNED,
        ...
        version=3.4.6
Subject: [PATCH v9 06/10] serial: sc16is7xx: fix regression with GPIO configuration
