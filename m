...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 06B4B4E953D
	for <lists+devicetree@lfdr.de>; Mon, 28 Mar 2022 13:39:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241298AbiC1LlC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 28 Mar 2022 07:41:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39406 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242139AbiC1LeH (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 28 Mar 2022 07:34:07 -0400
Received: from ssl.serverraum.org (ssl.serverraum.org [176.9.125.105])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E9C105A143;
        Mon, 28 Mar 2022 04:25:22 -0700 (PDT)
Received: from mwalle01.kontron.local. (unknown [213.135.10.150])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-384) server-signature RSA-PSS (2048 bits) server-digest SHA256)
        (No client certificate requested)
        by ssl.serverraum.org (Postfix) with ESMTPSA id 3A79E2224E;
        Mon, 28 Mar 2022 13:25:13 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=walle.cc; s=mail2016061301;
        ...
        bh=5jLHwuZPoCIbU73qP6lRzMFi0PToiOD7l+hzymyFxxg=;
        b=gc+xKBr7+KT+Ej5gdVPM/rtoNatn7of93SriJod78PEndF2+ViyuVZ30SxlS4wI/cg/AdW
        SIi2992TzFdHxj9QEdyJKjPWf2KJ4LDSGBy8Ew/m8jk5pMWFMXEaCQUxtZUBvMvf6JLZV3
        GNVYUZsVwRgjw55jUNBguWR2mTBYMaA=
...
Subject: [PATCH v2 4/4] hwmon: add driver for the Microchip LAN966x SoC
Date:   Mon, 28 Mar 2022 13:25:05 +0200
Message-Id: <20220328112505.3025374-5-michael@walle.cc>
...
index 000000000000..00c93539d842
--- /dev/null
...
+degree C.
+
+The driver exports temperature values, fan tacho input and PWM settings
+via the following sysfs files:
+
+**temp1_input**
+
+**fan1_input**
...
index be9773270e53..26a60e1eebbc 100644
