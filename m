...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 83D53296DB
	for <lists+devicetree@lfdr.de>; Fri, 24 May 2019 13:13:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390996AbfEXLM6 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 24 May 2019 07:12:58 -0400
Received: from metis.ext.pengutronix.de ([85.220.165.71]:48465 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2391080AbfEXLMi (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 24 May 2019 07:12:38 -0400
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
        by metis.ext.pengutronix.de with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.89)
        (envelope-from <ore@pengutronix.de>)
        id 1hU87g-0000GZ-QJ; Fri, 24 May 2019 13:12:28 +0200
Received: from ore by dude.hi.pengutronix.de with local (Exim 4.92)
        (envelope-from <ore@pengutronix.de>)
        id 1hU87e-0007Fr-5M; Fri, 24 May 2019 13:12:26 +0200
...
Subject: [PATCH v6 1/3] dt-bindings: net: add qca,ar71xx.txt documentation
Date:   Fri, 24 May 2019 13:12:22 +0200
Message-Id: <20190524111224.24819-2-o.rempel@pengutronix.de>
