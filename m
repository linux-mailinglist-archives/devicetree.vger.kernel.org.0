...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7BD4827621F
	for <lists+devicetree@lfdr.de>; Wed, 23 Sep 2020 22:30:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726638AbgIWUa0 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 23 Sep 2020 16:30:26 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32770 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726199AbgIWUa0 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 23 Sep 2020 16:30:26 -0400
Received: from mail-qk1-x741.google.com (mail-qk1-x741.google.com [IPv6:2607:f8b0:4864:20::741])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 121D9C0613CE;
        Wed, 23 Sep 2020 13:30:26 -0700 (PDT)
Received: by mail-qk1-x741.google.com with SMTP id c62so1126673qke.1;
        Wed, 23 Sep 2020 13:30:26 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:subject:to:cc:references:message-id:date:user-agent
         :mime-version:in-reply-to:content-language:content-transfer-encoding;
        bh=sCb9zLTGkOusF+DL0udO/j+rbFbU9IzMxb26NFnqoGA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=sCb9zLTGkOusF+DL0udO/j+rbFbU9IzMxb26NFnqoGA=;
        b=
X-Gm-Message-State: AOAM532tg32hYC/8xcLdb5dtXpi5m5BUX1zOpR+Om17So5XaNbg91zhE
        8qLRcZSp+bJ6rPBSY1ws7tYvZEQF3r+Q/u6D
X-Google-Smtp-Source: ABdhPJxUa/pwV53mPTedMryL8yMtOysOKxmNwswF1teEjpeya+BQgvusQAWw5fJHN3B3u/c5hu7O9A==
X-Received: by 2002:a05:620a:815:: with SMTP id s21mr1709020qks.0.1600893023753;
        Wed, 23 Sep 2020 13:30:23 -0700 (PDT)
Received: from ?IPv6:2601:153:900:7730:840b:3625:a950:98cc? ([2601:153:900:7730:840b:3625:a950:98cc])
        by smtp.gmail.com with ESMTPSA id p192sm773066qke.7.2020.09.23.13.30.22
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 23 Sep 2020 13:30:22 -0700 (PDT)
...
References: <20200916122247.534374-1-pgwipeout@gmail.com>
 <20200916122247.534374-2-pgwipeout@gmail.com> <20200923154611.GA797318@bogus>
Message-ID: <3110df89-5cde-7362-3d7e-17d78686f927@gmail.com>
Date:   Wed, 23 Sep 2020 16:30:20 -0400
User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:78.0) Gecko/20100101
 Thunderbird/78.2.2
MIME-Version: 1.0
In-Reply-To: <20200923154611.GA797318@bogus>
...
On 9/23/2020 11:46 AM, Rob Herring wrote:
> On Wed, Sep 16, 2020 at 12:22:45PM +0000, Peter Geis wrote:
...
>> index 000000000000..c0b5d1717dc3
>> --- /dev/null
...
> pmic@2d
> 
> Feel free to go fix whatever you copied this from. :)

Since the Ouya used the cardhu downstream kernel, I used it as the base 
for the device tree. I'll send this as a standalone fix. Thanks!
...
>> +	clk32k_in: clock@0 {
> 
> Drop unit-address as there's no reg property. Please build with 'W=1'
> which would give you a warning on this.

It's interesting that make dtbs-check didn't catch this.

Thank you for your review, I'll address these and send out the v2 shortly.
