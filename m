...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 01E7C490548
	for <lists+devicetree@lfdr.de>; Mon, 17 Jan 2022 10:42:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238135AbiAQJlF (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 17 Jan 2022 04:41:05 -0500
Received: from mailgw02.mediatek.com ([210.61.82.184]:37230 "EHLO
        mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S237678AbiAQJk1 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 17 Jan 2022 04:40:27 -0500
X-UUID: ea31afc7ef5f4c95a73413c26578bb09-20220117
X-UUID: ea31afc7ef5f4c95a73413c26578bb09-20220117
Received: from mtkcas11.mediatek.inc [(172.21.101.40)] by mailgw02.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 75462864; Mon, 17 Jan 2022 17:40:24 +0800
Received: from mtkexhb01.mediatek.inc (172.21.101.102) by
 mtkmbs07n2.mediatek.inc (172.21.101.141) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Mon, 17 Jan 2022 17:40:23 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by mtkexhb01.mediatek.inc
 (172.21.101.102) with Microsoft SMTP Server (TLS) id 15.0.1497.2; Mon, 17 Jan
 2022 17:40:22 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas11.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Mon, 17 Jan 2022 17:40:21 +0800
...
Subject: [PATCH v5, 12/15] media: mtk-vcodec: Extract H264 common code
Date:   Mon, 17 Jan 2022 17:39:58 +0800
Message-ID: <20220117094001.20049-13-yunfei.dong@mediatek.com>
...
index 36f3dc1fbe3b..f0f5872c89cd 100644
...
@@ -212,265 +94,31 @@ struct vdec_h264_slice_inst {
...
+		mtk_vdec_h264_get_ctrl_ptr(inst->ctx, V4L2_CID_STATELESS_H264_SPS);
...
@@ -478,21 +126,14 @@ static void get_vdec_decode_parameters(struct vdec_h264_slice_inst *inst)
...
-
 ...
 {
 	int err;
@@ -525,7 +166,7 @@ static int alloc_mv_buf(struct vdec_h264_slice_inst *inst,
 	int i;
 	int err;
...
@@ -674,7 +315,7 @@ static int vdec_h264_slice_decode(void *h_vdec, struct mtk_vcodec_mem *bs,
 {
