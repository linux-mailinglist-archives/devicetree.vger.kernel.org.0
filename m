...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4DEDF6E1E54
	for <lists+devicetree@lfdr.de>; Fri, 14 Apr 2023 10:31:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230011AbjDNIbC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 14 Apr 2023 04:31:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38062 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230145AbjDNIay (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 14 Apr 2023 04:30:54 -0400
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8147586AA;
        Fri, 14 Apr 2023 01:30:42 -0700 (PDT)
X-UUID: 9aa68152da9e11eda9a90f0bb45854f4-20230414
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:Content-Transfer-Encoding:MIME-Version:Message-ID:Date:Subject:CC:To:From; bh=LoQ8zmbQz7m5+2bdDWLAB5QKBYZ5OAAQdTVJg9Y1yUQ=;
        b=LQ2p/4V4Aah257jqsoDK4VR8XRdsVbb7yjVQU/f25V3J1f3+GVszhsTrJA5a4CYZroR7Rvx40i6OcWHGxIo/fAFqshoIC5E8rfDriDTG7o8qDE+G7X2+17d57nC5GFkQj2gDB10nHhwA4OiYMnUrYwbAX6H4fLLXWxUe8kqJmRY=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.22,REQID:5ae7a11e-0bd0-4b19-948f-a10f6d833e9f,IP:0,U
        RL:0,TC:0,Content:-25,EDM:-30,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACT
        ION:release,TS:-55
X-CID-META: VersionHash:120426c,CLOUDID:228a53a1-8fcb-430b-954a-ba3f00fa94a5,B
        ulkID:nil,BulkQuantity:0,Recheck:0,SF:102,TC:nil,Content:0,EDM:2,IP:nil,UR
        L:0,File:nil,Bulk:nil,QS:nil,BEC:nil,COL:1,OSI:0,OSA:0,AV:0
X-CID-BVR: 2,OSH
X-CID-BAS: 2,OSH,0,_
X-UUID: 9aa68152da9e11eda9a90f0bb45854f4-20230414
Received: from mtkmbs13n2.mediatek.inc [(172.21.101.108)] by mailgw01.mediatek.com
        ...
        with ESMTP id 540112778; Fri, 14 Apr 2023 16:30:25 +0800
Received: from mtkmbs11n1.mediatek.inc (172.21.101.185) by
 mtkmbs10n2.mediatek.inc (172.21.101.183) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.25; Fri, 14 Apr 2023 16:30:23 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkmbs11n1.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.2.1118.25 via Frontend Transport; Fri, 14 Apr 2023 16:30:22 +0800
...
Subject: [v10] media: mediatek: vcodec: support stateless AV1 decoder
Date:   Fri, 14 Apr 2023 16:30:20 +0800
Message-ID: <20230414083020.22219-1-xiaoyong.lu@mediatek.com>
...
X-Spam-Status: No, score=-2.0 required=5.0 tests=BAYES_00,DKIM_SIGNED,
        ...
        HK_RANDOM_FROM,RCVD_IN_MSPIKE_H2,SPF_HELO_PASS,T_SCC_BODY_TEXT_LINE,
...
@@ -356,6 +396,7 @@ static void mtk_vcodec_add_formats(unsigned int fourcc,
...
@@ -412,6 +453,10 @@ static void mtk_vcodec_get_supported_formats(struct mtk_vcodec_ctx *ctx)
...
index 0000000000000..7493d31273c23
--- /dev/null
...
+	if (!lat_buf) {
+		mtk_vcodec_debug(instance, "failed to get AV1 lat buf\n");
+		return -EAGAIN;
+	}
...
+
  ...
  */
@@ -255,6 +258,14 @@ void vdec_msg_queue_deinit(struct vdec_msg_queue *msg_queue,
 		if (mem->va)
...
@@ -347,6 +358,22 @@ int vdec_msg_queue_init(struct vdec_msg_queue *msg_queue,
 			goto mem_alloc_err;
 		}
