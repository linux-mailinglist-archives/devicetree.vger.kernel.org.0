...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 964EC4893AB
	for <lists+devicetree@lfdr.de>; Mon, 10 Jan 2022 09:37:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241275AbiAJIgm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 10 Jan 2022 03:36:42 -0500
Received: from mailgw02.mediatek.com ([210.61.82.184]:52746 "EHLO
        mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S241313AbiAJIfz (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 10 Jan 2022 03:35:55 -0500
X-UUID: 2cb378de08c2489c9b696abf5c5bc74f-20220110
X-UUID: 2cb378de08c2489c9b696abf5c5bc74f-20220110
Received: from mtkexhb01.mediatek.inc [(172.21.101.102)] by mailgw02.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 2095534069; Mon, 10 Jan 2022 16:35:10 +0800
Received: from mtkcas10.mediatek.inc (172.21.101.39) by
 mtkmbs10n1.mediatek.inc (172.21.101.34) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id
 15.2.792.15; Mon, 10 Jan 2022 16:35:09 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas10.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Mon, 10 Jan 2022 16:35:07 +0800
...
Subject: [PATCH v4, 15/15] media: mtk-vcodec: support stateless VP9 decoding
Date:   Mon, 10 Jan 2022 16:34:42 +0800
Message-ID: <20220110083442.32604-16-yunfei.dong@mediatek.com>
...
index 019055a0807d..03c1c873361a 100644
...
@@ -368,6 +383,7 @@ static void mtk_vcodec_add_formats(unsigned int fourcc,
 	switch (fourcc) {
...
@@ -416,6 +432,10 @@ static void mtk_vcodec_get_supported_formats(struct mtk_vcodec_ctx *ctx)
...
index 63ca6458929b..24bfbd1a6b3a 100644
...
index 000000000000..ca93bdc77165
--- /dev/null
