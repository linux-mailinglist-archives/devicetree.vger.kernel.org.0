...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4482D582419
	for <lists+devicetree@lfdr.de>; Wed, 27 Jul 2022 12:22:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231580AbiG0KWA (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 27 Jul 2022 06:22:00 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56314 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231443AbiG0KV7 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 27 Jul 2022 06:21:59 -0400
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3736F37FAE;
        Wed, 27 Jul 2022 03:21:52 -0700 (PDT)
X-UUID: b5dc6fc2afb44852a8aad6df9ce2f8ff-20220727
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.8,REQID:97a2e362-19df-4665-9271-02824eb812a6,OB:0,LO
        B:0,IP:0,URL:0,TC:0,Content:-5,EDM:0,RT:0,SF:0,FILE:0,RULE:Release_Ham,ACT
        ION:release,TS:-5
X-CID-META: VersionHash:0f94e32,CLOUDID:f92685c9-5f65-4fda-abe9-f2436fed4c72,C
...
Received: from mtkexhb02.mediatek.inc [(172.21.101.103)] by mailgw01.mediatek.com
        ...
        with ESMTP id 52771840; Wed, 27 Jul 2022 18:21:45 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by
 mtkmbs10n1.mediatek.inc (172.21.101.34) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id
 15.2.792.15; Wed, 27 Jul 2022 18:21:43 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas11.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Wed, 27 Jul 2022 18:21:42 +0800
...
Subject: [PATCH v2 1/2] dt-bindings: pinctrl: add support for MediaTek mt8188
Date:   Wed, 27 Jul 2022 18:21:39 +0800
Message-ID: <20220727102140.6676-2-hui.liu@mediatek.com>
X-Mailer: git-send-email 2.18.0
In-Reply-To: <20220727102140.6676-1-hui.liu@mediatek.com>
...
+      spi0-pins {
+        pins-spi-clk {
+          pinmux = <PINMUX_GPIO76__FUNC_O_SPIM1_CLK>;
+          drive-strength = <6>;
+        };
+        pins-spi {
...
+      i2c1-pins {
+        pins {
+          pinmux = <PINMUX_GPIO57__FUNC_B1_SCL1>,
+                   <PINMUX_GPIO58__FUNC_B1_SDA1>;
+          bias-pull-up = <1000>;
+          drive-strength-microamp = <1000>;
+        };
+      };
