...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B978664157E
	for <lists+devicetree@lfdr.de>; Sat,  3 Dec 2022 10:57:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229658AbiLCJ5B (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 3 Dec 2022 04:57:01 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37382 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229563AbiLCJ47 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 3 Dec 2022 04:56:59 -0500
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3B5D46D7D2;
        Sat,  3 Dec 2022 01:56:56 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1670061416; x=1701597416;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=sZsNY/O/0EfozwfRoFa6GPJBp02re7nf8GFkeH3WgYU=;
  b=VzE1UOj5q58gFap3QCZZiFzHSJ9aYRB7x3jsZbyRsAzJQBReB2DMAOt+
   h+B2Z+5dyKpqcT4mi1J6mR9231GNMih+I9o5jw4OI22f+FIdZDduHD/yT
   vVvRMMnDTzg9JFL2/IbMScLtfh8XBhLfNJellG+Va8hCZohnweRlV76ao
   dqDqKjS7fuyT+6dmDq1d2MHVSxakIFoUo4kJ4uB/CtjMgG8JnN6in3R1K
   A26C0aZAdYpVMboQsXDGTASX9rukYPwgQkGwFZ9X2upIQ9pnfyZ8b2zbi
   fKA/7T0IW5sj5Me+lssBwmRiqAdMDtahYpyry60xgupdgKlW64ebEZKqz
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10549"; a="316134356"
X-IronPort-AV: E=Sophos;i="5.96,214,1665471600"; 
   d="scan'208";a="316134356"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Dec 2022 01:56:52 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10549"; a="787563108"
X-IronPort-AV: E=Sophos;i="5.96,214,1665471600"; 
   d="scan'208";a="787563108"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by fmsmga001.fm.intel.com with ESMTP; 03 Dec 2022 01:56:46 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p1PGH-000ESn-25;
        Sat, 03 Dec 2022 09:56:45 +0000
Date:   Sat, 3 Dec 2022 17:55:57 +0800
...
Cc:     oe-kbuild-all@lists.linux.dev, linux-pci@vger.kernel.org,
        ...
        linux-phy@lists.infradead.org, Shradha Todi <shradha.t@samsung.com>
Subject: Re: [PATCH 5/6] arm64: dts: fsd: Add PCIe support for Tesla FSD SoC
Message-ID: <202212031726.WUWk1V6f-lkp@intel.com>
References: <20221121105210.68596-6-shradha.t@samsung.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Ev2AcCMYUeJQLaG8"
...
[also build test ERROR on helgaas-pci/for-linus robh/for-next char-misc/char-misc-testing char-misc/char-misc-next char-misc/char-misc-linus linus/master v6.1-rc7 next-20221202]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Shradha-Todi/dt-bindings-phy-Add-PCIe-PHY-bindings-for-FSD/20221121-195220
base:   https://git.kernel.org/pub/scm/linux/kernel/git/helgaas/pci.git next
patch link:    https://lore.kernel.org/r/20221121105210.68596-6-shradha.t%40samsung.com
patch subject: [PATCH 5/6] arm64: dts: fsd: Add PCIe support for Tesla FSD SoC
config: arm64-allyesconfig
compiler: aarch64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/a401bc33a8e52f2a2fbb9bffa8b097bcbfa05e62
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Shradha-Todi/dt-bindings-phy-Add-PCIe-PHY-bindings-for-FSD/20221121-195220
        git checkout a401bc33a8e52f2a2fbb9bffa8b097bcbfa05e62
...
All errors (new ones prefixed by >>):
   ...
   also defined at arch/arm64/boot/dts/tesla/fsd-evb.dts:87.11-91.3
...
CONFIG_PCIE_DW_EP=y
CONFIG_PCIE_FSD=y
CONFIG_PCIE_FSD_HOST=y
CONFIG_PCIE_FSD_EP=y
CONFIG_PCI_DRA7XX=y
