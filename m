...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DB63062E23A
	for <lists+devicetree@lfdr.de>; Thu, 17 Nov 2022 17:48:26 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240076AbiKQQsW (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 17 Nov 2022 11:48:22 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55140 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235001AbiKQQsP (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 17 Nov 2022 11:48:15 -0500
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B2E5656ECC;
        Thu, 17 Nov 2022 08:48:10 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1668703690; x=1700239690;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=ltm5HUHoH5woRdsiVEnlyjVqGMz/PtsmH2EqlRkXyY4=;
  b=B+VXkJUPg+SIk89JCO4cd3yHl0SG43CfmJfzp7+vSPM+YmlkFoXegI8b
   8TlI9HPfTSo3FW0ivjWYUW6HYC/74QtbKcn1D0SNkEAK5JacaTfspsjpe
   rfu0ypklOqXkmNWONWtuZW86hZZrNwdtkKA1pb1VXalFR8C4XuGmK+ZFx
   Xojy7fQhFCeWWnjWvldFpXtYeY4hH0JT5Nu+J9Z6iQLSunKklA2jw9DHk
   gfHuM4W1LZIBatwFvvJQ3mZ9lAPEenweFfyCPE4VfYBtlw+thQzehDj4w
   CywyAOECTkzUJPBA/oV5QzucZvU7zWM/WqDJehnbtkLvNYyxj6a2wpnhN
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10534"; a="399191589"
X-IronPort-AV: E=Sophos;i="5.96,171,1665471600"; 
   d="scan'208";a="399191589"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Nov 2022 08:48:08 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10534"; a="728889810"
X-IronPort-AV: E=Sophos;i="5.96,171,1665471600"; 
   d="scan'208";a="728889810"
Received: from lkp-server01.sh.intel.com (HELO 55744f5052f8) ([10.239.97.150])
  by FMSMGA003.fm.intel.com with ESMTP; 17 Nov 2022 08:48:04 -0800
Received: from kbuild by 55744f5052f8 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ovi3X-0000TV-30;
        Thu, 17 Nov 2022 16:48:03 +0000
Date:   Fri, 18 Nov 2022 00:47:17 +0800
...
Subject: Re: [PATCH v2 2/2] clocking-wizard: Add versal clocking wizard
 support
Message-ID: <202211180039.emllskBh-lkp@intel.com>
References: <20221115145005.4747-3-shubhrajyoti.datta@amd.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="3LHPSBYcBCwRjqxV"
Content-Disposition: inline
In-Reply-To: <20221115145005.4747-3-shubhrajyoti.datta@amd.com>
...
[also build test WARNING on robh/for-next linus/master v6.1-rc5 next-20221117]
[cannot apply to xilinx-xlnx/master]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Shubhrajyoti-Datta/clocking-wizard-Add-versal-clocking-wizard-support/20221115-225040
base:   https://git.kernel.org/pub/scm/linux/kernel/git/clk/linux.git clk-next
patch link:    https://lore.kernel.org/r/20221115145005.4747-3-shubhrajyoti.datta%40amd.com
patch subject: [PATCH v2 2/2] clocking-wizard: Add versal clocking wizard support
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/bbab8365abfe9bcac3b544879ea65055afae59a4
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Shubhrajyoti-Datta/clocking-wizard-Add-versal-clocking-wizard-support/20221115-225040
        git checkout bbab8365abfe9bcac3b544879ea65055afae59a4
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=clang make.cross W=1 O=build_dir ARCH=arm SHELL=/bin/bash drivers/clk/xilinx/ drivers/pci/controller/dwc/
...
>> drivers/clk/xilinx/clk-xlnx-clock-wizard-v.c:224:45: warning: result of comparison of constant 4320000000 with expression of type 'unsigned long' is always true [-Wtautological-constant-out-of-range-compare]
                           if (vco_freq >= WZRD_VCO_MIN && vco_freq <= WZRD_VCO_MAX) {
                                                           ~~~~~~~~ ^  ~~~~~~~~~~~~
   1 warning generated.


vim +224 drivers/clk/xilinx/clk-xlnx-clock-wizard-v.c

   213	
   214	static int clk_wzrd_get_divisors(struct clk_hw *hw, unsigned long rate,
   215					 unsigned long parent_rate)
   216	{
   217		struct clk_wzrd_divider *divider = to_clk_wzrd_divider(hw);
   218		unsigned long vco_freq, freq, diff;
   219		u32 m, d, o;
   220	
   221		for (m = WZRD_M_MIN; m <= WZRD_M_MAX; m++) {
   222			for (d = WZRD_D_MIN; d <= WZRD_D_MAX; d++) {
   223				vco_freq = DIV_ROUND_CLOSEST((parent_rate * m), d);
 > 224				if (vco_freq >= WZRD_VCO_MIN && vco_freq <= WZRD_VCO_MAX) {
   225					for (o = WZRD_O_MIN; o <= WZRD_O_MAX; o++) {
   226						freq = DIV_ROUND_CLOSEST(vco_freq, o);
   227						diff = abs(freq - rate);
   228	
   229						if (diff < WZRD_MIN_ERR) {
   230							divider->valuem = m;
   231							divider->valued = d;
   232							divider->valueo = o;
   233							return 0;
   234						}
   235					}
   236				}
...
CONFIG_COMMON_CLK_XLNX_CLKWZRD_V=y
