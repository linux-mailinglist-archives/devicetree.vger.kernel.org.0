...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EB7AC30C2D4
	for <lists+devicetree@lfdr.de>; Tue,  2 Feb 2021 16:04:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234739AbhBBPAr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 2 Feb 2021 10:00:47 -0500
Received: from gloria.sntech.de ([185.11.138.130]:48858 "EHLO gloria.sntech.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S234880AbhBBO5q (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Tue, 2 Feb 2021 09:57:46 -0500
Received: from ip5f5aa64a.dynamic.kabel-deutschland.de ([95.90.166.74] helo=phil.lan)
        by gloria.sntech.de with esmtpsa (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <heiko@sntech.de>)
        id 1l6x6n-00020V-1m; Tue, 02 Feb 2021 15:56:49 +0100
...
Subject: [PATCH 3/6] drm/rockchip: dsi: add ability to work as a phy instead of full dsi
Date:   Tue,  2 Feb 2021 15:56:29 +0100
Message-Id: <20210202145632.1263136-4-heiko@sntech.de>
...
@@ -1008,11 +1047,220 @@ static const struct dw_mipi_dsi_host_ops dw_mipi_dsi_rockchip_host_ops = {
...
@@ -1109,6 +1357,19 @@ static int dw_mipi_dsi_rockchip_probe(struct platform_device *pdev)
...
+
 	...
 	if (IS_ERR(dsi->dmd)) {
 		ret = PTR_ERR(dsi->dmd);
@@ -1175,6 +1436,75 @@ static const struct rockchip_dw_dsi_chip_data rk3288_chip_data[] = {
 	{ /* sentinel */ }
 };
...
+
 static const struct rockchip_dw_dsi_chip_data rk3399_chip_data[] = {
 	{
 		.reg = 0xff960000,
@@ -1217,6 +1547,10 @@ static const struct rockchip_dw_dsi_chip_data rk3399_chip_data[] = {
