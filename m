...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 84F7D258E97
	for <lists+devicetree@lfdr.de>; Tue,  1 Sep 2020 14:51:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728043AbgIAMvS (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 1 Sep 2020 08:51:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57720 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728152AbgIAMui (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 1 Sep 2020 08:50:38 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 34929C061246;
        Tue,  1 Sep 2020 05:50:34 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=kRHQnmBrJ9Mb8RhcRCHUaJXRAfFQg1hM/EkGSt0QKHA=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1598964632;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=kRHQnmBrJ9Mb8RhcRCHUaJXRAfFQg1hM/EkGSt0QKHA=;
        b=ZxfSYpOBTXaPp+47URkwK3QTNHgrl/YhG76L3fyxpEYuZ/9BCyloRsTNPbhczj1vGhewyK
        w0pwPkWayBYuuMCQ==
...
Subject: [PATCH v4 4/7] net: dsa: hellcreek: Add support for hardware timestamping
Date:   Tue,  1 Sep 2020 14:50:11 +0200
Message-Id: <20200901125014.17801-5-kurt@linutronix.de>
...
index ed75468005a3..cb69840e9042 100644
...
+#include "hellcreek_hwtstamp.h"
 ...
 static const struct hellcreek_counter hellcreek_counter[] = {
 	{ 0x00, "RxFiltered", },
@@ -1087,6 +1088,11 @@ static const struct dsa_switch_ops hellcreek_ds_ops = {
...
@@ -1194,10 +1200,18 @@ static int hellcreek_probe(struct platform_device *pdev)
 		goto err_ptp_setup;
 	}
...
@@ -1208,6 +1222,7 @@ static int hellcreek_remove(struct platform_device *pdev)
 {
...
index 8d872a08f9de..06cfaa0c5503 100644
--- a/drivers/net/dsa/hirschmann/hellcreek.h
+++ b/drivers/net/dsa/hirschmann/hellcreek.h
@@ -213,11 +213,36 @@ struct hellcreek_counter {
