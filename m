...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7A9BA650EC
	for <lists+devicetree@lfdr.de>; Thu, 11 Jul 2019 06:20:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728133AbfGKEU1 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 11 Jul 2019 00:20:27 -0400
Received: from new4-smtp.messagingengine.com ([66.111.4.230]:53533 "EHLO
        new4-smtp.messagingengine.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728025AbfGKEU1 (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Thu, 11 Jul 2019 00:20:27 -0400
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailnew.nyi.internal (Postfix) with ESMTP id 53FCE2F10;
        Thu, 11 Jul 2019 00:20:22 -0400 (EDT)
Received: from mailfrontend1 ([10.202.2.162])
  by compute4.internal (MEProxy); Thu, 11 Jul 2019 00:20:22 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=aj.id.au; h=from
        :to:cc:subject:date:message-id:in-reply-to:references
        :mime-version:content-transfer-encoding; s=fm3; bh=wt31vvSzUpPb6
        oCsP8PSUT9HQv7BG3p0WoTXl13IZXQ=; b=MISmp4IEqrr5UG8gXXwTAyFJ9BfO5
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:content-transfer-encoding:date:from
        :in-reply-to:message-id:mime-version:references:subject:to
        :x-me-proxy:x-me-proxy:x-me-sender:x-me-sender:x-sasl-enc; s=
        fm3; bh=wt31vvSzUpPb6oCsP8PSUT9HQv7BG3p0WoTXl13IZXQ=; b=i+Hvh9mF
        
X-ME-Sender: <xms:BbkmXb5meNU370Ufceh3BM48MxvDoor6zE7gRb-OQnMAFlNYyGaolA>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgeduvddrgeejgdektdcutefuodetggdotefrodftvf
    ...
    ge
X-ME-Proxy: <xmx:BbkmXb6Dlv0A2Y_gnHAiMsUwtoM_8ei4eAXUBmiw7DH8FSUVQaxxKw>
    <xmx:BbkmXZEeYzn8gayFXCbT7RjcNDDxPJ87pomRus_hOdGLl9Hv0gO77A>
    <xmx:BbkmXZxbn2eQ7Q5iQPwRNo-qMath6fnqC-iDU4CDPbKOYklaJYBsew>
    <xmx:BrkmXT8TJcB056NJvqUOtqJEOBH-0edEhSXP4FvYSnlrc6zxxZ0UtQ>
Received: from mistburn.au.ibm.com (bh02i525f01.au.ibm.com [202.81.18.30])
        by mail.messagingengine.com (Postfix) with ESMTPA id 4CE5980059;
...
Subject: [PATCH 6/6] pinctrl: aspeed: Add AST2600 pinmux support
Date:   Thu, 11 Jul 2019 13:49:42 +0930
Message-Id: <20190711041942.23202-7-andrew@aj.id.au>
