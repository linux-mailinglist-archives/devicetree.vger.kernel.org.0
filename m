...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 44F052341EA
	for <lists+devicetree@lfdr.de>; Fri, 31 Jul 2020 11:03:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732134AbgGaJDY (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 31 Jul 2020 05:03:24 -0400
Received: from hqnvemgate24.nvidia.com ([216.228.121.143]:19142 "EHLO
        hqnvemgate24.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1732066AbgGaJDA (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 31 Jul 2020 05:03:00 -0400
Received: from hqpgpgate102.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate24.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5f23dde50001>; Fri, 31 Jul 2020 02:01:25 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate102.nvidia.com (PGP Universal service);
  Fri, 31 Jul 2020 02:02:59 -0700
X-PGP-Universal: processed;
        by hqpgpgate102.nvidia.com on Fri, 31 Jul 2020 02:02:59 -0700
Received: from HQMAIL105.nvidia.com (172.20.187.12) by HQMAIL107.nvidia.com
 (172.20.187.13) with Microsoft SMTP Server (TLS) id 15.0.1473.3; Fri, 31 Jul
 2020 09:02:58 +0000
Received: from hqnvemgw03.nvidia.com (10.124.88.68) by HQMAIL105.nvidia.com
 (172.20.187.12) with Microsoft SMTP Server (TLS) id 15.0.1473.3 via Frontend
 Transport; Fri, 31 Jul 2020 09:02:58 +0000
Received: from skomatineni-linux.nvidia.com (Not Verified[10.2.167.221]) by hqnvemgw03.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5f23de410000>; Fri, 31 Jul 2020 02:02:57 -0700
...
Subject: [RFC PATCH v6 06/10] media: tegra-video: Add support for external sensor capture
Date:   Fri, 31 Jul 2020 02:02:45 -0700
Message-ID: <1596186169-18729-7-git-send-email-skomatineni@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1596186085; bh=/201Cwf5STsok9l2ocK4kOY+8+cJ+85epwKZnXLE0gs=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:X-NVConfidentiality:MIME-Version:
         Content-Type;
        b=
...
---
 ...
 drivers/staging/media/tegra-video/vi.c       | 687 +++++++++++++++++++++++++--
 drivers/staging/media/tegra-video/vi.h       |  25 +-
 7 files changed, 787 insertions(+), 63 deletions(-)
...
@@ -304,26 +307,101 @@ static const struct v4l2_subdev_ops tegra_csi_ops = {
...
+		}
 	...
 	return 0;
@@ -369,6 +447,15 @@ static int tegra_csi_channel_init(struct tegra_csi_channel *chan)
 		return ret;
 	}
...
@@ -408,8 +495,12 @@ static void tegra_csi_channels_cleanup(struct tegra_csi *csi)
...
@@ -446,13 +537,14 @@ static int tegra_csi_init(struct host1x_client *client)
...
+
 ...
 free_v4l2_ctrl_hdl:
@@ -733,28 +935,84 @@ static int tegra_channel_init(struct tegra_vi_channel *chan)
 	return ret;
 }
...
@@ -909,6 +1167,347 @@ static int __maybe_unused vi_runtime_suspend(struct device *dev)
 	return 0;
 }
...
@@ -922,13 +1521,14 @@ static int tegra_vi_init(struct host1x_client *client)
...
@@ -937,6 +1537,12 @@ static int tegra_vi_init(struct host1x_client *client)
...
+
 ...
 free_chans:
@@ -950,6 +1556,8 @@ static int tegra_vi_init(struct host1x_client *client)
...
@@ -957,6 +1565,9 @@ static int tegra_vi_exit(struct host1x_client *client)
