...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 864CB638262
	for <lists+devicetree@lfdr.de>; Fri, 25 Nov 2022 03:29:15 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229675AbiKYC3N (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 24 Nov 2022 21:29:13 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38444 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229455AbiKYC3M (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 24 Nov 2022 21:29:12 -0500
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D75EEE081;
        Thu, 24 Nov 2022 18:29:08 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669343348; x=1700879348;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=idJrQwDNg+6GJoPDcckdMpFsVzhxYrYFlSG8+B/1DM8=;
  b=SlTgW8IcUIM0xjiW9UOnFgaxF1xFdDR5GdFicH/l8Ecvbsasw1t9+97H
   hYfx4ND1Ly95BM2YcIu0G8NQO2SxViLduly9CJYbOZx9JQVS6zNcEBDug
   3+im6O2zIh8XEclO64OgegUf73yZWt0dAeDYDoV9WJeZ2fdiE98P3NfAR
   9kiqz+4EM82dvPZPhr8EhHf8tYHxYPqKrE/ffoYswwql/EaMRpFTbCyKV
   51+u4d3rtjOh8rE5HjEICGTG8mRtb6OR8iu9RJSFbor2gn6fqc8duPKD7
   Kg4Ggt0gkRgKynwY99FXQQqVxfHYxBda3Jc0GnHkZmd2frEfk3AVREA1P
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10541"; a="294100076"
X-IronPort-AV: E=Sophos;i="5.96,192,1665471600"; 
   d="scan'208";a="294100076"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 24 Nov 2022 18:29:07 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10541"; a="675253860"
X-IronPort-AV: E=Sophos;i="5.96,192,1665471600"; 
   d="scan'208";a="675253860"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by orsmga001.jf.intel.com with ESMTP; 24 Nov 2022 18:28:50 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oyOSP-0004Yr-1m;
        Fri, 25 Nov 2022 02:28:49 +0000
Date:   Fri, 25 Nov 2022 10:27:49 +0800
...
Message-ID: <202211251004.OB7EEXr0-lkp@intel.com>
References: <20221122201232.107065-3-tmaimon77@gmail.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="XkrWEkn47MVCTQE8"
...
[also build test ERROR on soc/for-next linus/master v6.1-rc6]
[cannot apply to next-20221124]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Tomer-Maimon/soc-add-NPCM-LPC-BPC-driver-support/20221123-041359
base:   https://git.kernel.org/pub/scm/linux/kernel/git/robh/linux.git for-next
patch link:    https://lore.kernel.org/r/20221122201232.107065-3-tmaimon77%40gmail.com
patch subject: [PATCH v1 2/2] soc: nuvoton: add NPCM LPC BPC driver
config: powerpc-allmodconfig
compiler: powerpc-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/5f3d4d8a7042ae91ec9e46a2a7affe5c84e1de2d
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Tomer-Maimon/soc-add-NPCM-LPC-BPC-driver-support/20221123-041359
        git checkout 5f3d4d8a7042ae91ec9e46a2a7affe5c84e1de2d
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=powerpc SHELL=/bin/bash drivers/soc/
...
>> make[5]: *** No rule to make target 'drivers/soc/nuvoton/npcm-pci-mbox.o', needed by 'drivers/soc/nuvoton/'.
   make[5]: Target 'drivers/soc/nuvoton/' not remade because of errors.
...
# NUVOTON SoC drivers
#
CONFIG_NPCM_LPC_BPC=m
CONFIG_NPCM_PCI_MBOX=m
# end of NUVOTON SoC drivers
