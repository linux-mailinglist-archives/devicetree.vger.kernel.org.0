...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 510F66697F7
	for <lists+devicetree@lfdr.de>; Fri, 13 Jan 2023 14:05:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241451AbjAMNFl (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 13 Jan 2023 08:05:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42548 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239906AbjAMNFN (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 13 Jan 2023 08:05:13 -0500
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9E0BA6E0EF;
        Fri, 13 Jan 2023 04:50:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1673614225; x=1705150225;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=aQYsI+TMY/VdEDi19j6EFPHEL/LPezX3e1zwA2YeTDc=;
  b=VKK+kNwblqjWtKystYKwldsOR0Fq4Pw0l7uuWwii46eGDxFrmHDnQYTx
   jRkuX8s0+wdx8zieIUsrwkOtPsDKZTaPLD/Yf3g6HFFt7G1RkWrsXh1oT
   x3QhGfxAdqfTKjaCB5GXf5EIymkY+DbzH2W+F0jv+dpnpyoxXhjcW8XEB
   gntBNHcSDs06lt4/FhOAcHJ6GIiudx2IXvPOYxHDejHDGnjjjbDzIQmuk
   CrGq9HSeK+sGinSmQueJWk8uI9PX9S/OUI5QLJSxFsnLtyQCKGMNURafs
   +rYMdExEyjz6UL7NcMaYb25esUSM9oIXN//F1/QcwjhlZUV3rzQ+r5Wm3
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10588"; a="351218509"
X-IronPort-AV: E=Sophos;i="5.97,213,1669104000"; 
   d="scan'208";a="351218509"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Jan 2023 04:50:23 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10588"; a="800590350"
X-IronPort-AV: E=Sophos;i="5.97,213,1669104000"; 
   d="scan'208";a="800590350"
Received: from lkp-server02.sh.intel.com (HELO f1920e93ebb5) ([10.239.97.151])
  by fmsmga001.fm.intel.com with ESMTP; 13 Jan 2023 04:50:19 -0800
Received: from kbuild by f1920e93ebb5 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1pGJVi-000B74-1d;
        Fri, 13 Jan 2023 12:50:18 +0000
Date:   Fri, 13 Jan 2023 20:49:59 +0800
...
Subject: Re: [PATCH V9 2/2] firmware: qcom: scm: Add wait-queue handling logic
Message-ID: <202301132004.2abZa0NM-lkp@intel.com>
References: <20230113065303.17727-3-quic_sibis@quicinc.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="icLYtXqonfFflm2m"
Content-Disposition: inline
In-Reply-To: <20230113065303.17727-3-quic_sibis@quicinc.com>
...
[auto build test WARNING on next-20230113]
[also build test WARNING on v6.2-rc3]
[cannot apply to robh/for-next linus/master v6.2-rc3 v6.2-rc2 v6.2-rc1]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Sibi-Sankar/dt-bindings-firmware-qcom-scm-Add-optional-interrupt/20230113-151459
patch link:    https://lore.kernel.org/r/20230113065303.17727-3-quic_sibis%40quicinc.com
patch subject: [PATCH V9 2/2] firmware: qcom: scm: Add wait-queue handling logic
config: m68k-allyesconfig
compiler: m68k-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/b9bb238a0fe7d33d99954dbb0f6d8d9f327e182e
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Sibi-Sankar/dt-bindings-firmware-qcom-scm-Add-optional-interrupt/20230113-151459
        git checkout b9bb238a0fe7d33d99954dbb0f6d8d9f327e182e
...
All warnings (new ones prefixed by >>):
   ...
   drivers/firmware/qcom_scm-smc.c: In function '__scm_smc_do_quirk_handle_waitq':
>> drivers/firmware/qcom_scm-smc.c:96:35: warning: variable 'flags' set but not used [-Wunused-but-set-variable]
      96 |         u32 wq_ctx, smc_call_ctx, flags;
         |                                   ^~~~~


vim +/flags +96 drivers/firmware/qcom_scm-smc.c
    ...
    93	{
    94		int ret;
    95		struct arm_smccc_args resume;
  > 96		u32 wq_ctx, smc_call_ctx, flags;
   ...
   105				flags = res->a3;
   106	
   107				ret = qcom_scm_wait_for_wq_completion(wq_ctx);
   108				if (ret)
   109					return ret;
   110	
   111				fill_wq_resume_args(&resume, smc_call_ctx);
   112				smc = &resume;
   113			}
   114		} while (res->a0 == QCOM_SCM_WAITQ_SLEEP);
   115	
   116		return 0;
   117	}
   118	
...
# Linux/m68k 6.2.0-rc3 Kernel Configuration
#
