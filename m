...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 687C5483D7E
	for <lists+devicetree@lfdr.de>; Tue,  4 Jan 2022 09:02:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233837AbiADICE (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 4 Jan 2022 03:02:04 -0500
Received: from mailgw02.mediatek.com ([210.61.82.184]:53048 "EHLO
        mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S233845AbiADIB4 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 4 Jan 2022 03:01:56 -0500
X-UUID: 577920fab278475fa90654ddb133fd4a-20220104
X-UUID: 577920fab278475fa90654ddb133fd4a-20220104
Received: from mtkcas11.mediatek.inc [(172.21.101.40)] by mailgw02.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 1246187477; Tue, 04 Jan 2022 16:01:52 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by
 mtkmbs10n1.mediatek.inc (172.21.101.34) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id
 15.2.792.15; Tue, 4 Jan 2022 16:01:51 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas11.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Tue, 4 Jan 2022 16:01:49 +0800
...
Subject: [PATCH v3, 07/13] media: mtk-vcodec: Refactor supported vdec formats and framesizes
Date:   Tue, 4 Jan 2022 16:01:32 +0800
Message-ID: <20220104080138.7472-8-yunfei.dong@mediatek.com>
...
index 5347d77300fa..4ae80d2e77d2 100644
--- a/drivers/media/platform/mtk-vcodec/mtk_vcodec_drv.h
+++ b/drivers/media/platform/mtk-vcodec/mtk_vcodec_drv.h
@@ -354,6 +354,15 @@ enum mtk_vdec_hw_arch {
...
@@ -389,12 +398,12 @@ struct mtk_vcodec_dec_pdata {
