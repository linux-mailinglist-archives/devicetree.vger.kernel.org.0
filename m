...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8F0BB128132
	for <lists+devicetree@lfdr.de>; Fri, 20 Dec 2019 18:15:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727362AbfLTRPU (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 20 Dec 2019 12:15:20 -0500
Received: from mail-lf1-f68.google.com ([209.85.167.68]:37516 "EHLO
        mail-lf1-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727394AbfLTRPU (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 20 Dec 2019 12:15:20 -0500
Received: by mail-lf1-f68.google.com with SMTP id b15so7606343lfc.4
        for <devicetree@vger.kernel.org>; Fri, 20 Dec 2019 09:15:15 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=subject:to:cc:references:from:message-id:date:user-agent
         :mime-version:in-reply-to:content-language:content-transfer-encoding;
        bh=E5EL3+SghWvyOCnjBN4zIDeqGgKbey4NZa2FC8T9gq0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=E5EL3+SghWvyOCnjBN4zIDeqGgKbey4NZa2FC8T9gq0=;
        b=
X-Gm-Message-State: APjAAAXU/osKILj7qNasSPnCeLemh96Eu9ihbV1ChNCnZWPzqHuDJt/i
        151QKIXwnVqOSzNFkrj35zcqrQ==
X-Google-Smtp-Source: APXvYqxyh2NfnuBFLbbe5xZ9WMUgF/VkjGEnVNUrDbEoVG3ufIYvWccHYLwJRwLJWIdrNyP6I6WCrA==
X-Received: by 2002:a19:4b55:: with SMTP id y82mr9576286lfa.171.1576862113575;
        Fri, 20 Dec 2019 09:15:13 -0800 (PST)
Received: from [192.168.119.5] (office.dev.rtsoft.ru. [62.117.114.130])
        by smtp.gmail.com with ESMTPSA id d20sm1483079ljg.95.2019.12.20.09.15.12
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 20 Dec 2019 09:15:12 -0800 (PST)
...
References: <20191211115441.10637-1-andrey.konovalov@linaro.org>
 ...
 <CAPY8ntDnhcGOUpTX+k63=MU5PWn1c21vvS6Pqm3t75hDbzWVgg@mail.gmail.com>
From:   Andrey Konovalov <andrey.konovalov@linaro.org>
Message-ID: <f0d7c472-4bc3-e230-36dc-1e8ddd1df2fb@linaro.org>
Date:   Fri, 20 Dec 2019 20:15:11 +0300
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.2.2
MIME-Version: 1.0
In-Reply-To: <CAPY8ntDnhcGOUpTX+k63=MU5PWn1c21vvS6Pqm3t75hDbzWVgg@mail.gmail.com>
...
Hi Dave and Ezequiel,

On 19.12.2019 18:36, Dave Stevenson wrote:
...
In v2 of the patch I'll drop IMX219_REG_ORIENTATION from these tables as it is written
by the control handler.
...
I've checked that - pm_runtime_idle() within probe does make imx219_power_off()
to be called. So on exit from probe() the sensor is not powered *provided that
there were no errors after imx219_identify_module() returns 0* - otherwise the
control doesn't reach the point where pm_runtime_idle() is called.

For this reason in v2 I'll move calling imx219_power_on() from imx219_identify_module()
to imx219_probe(), and add calling imx219_power_off() in the error path.
This will also simplify imx219_identify_module(), and make it easy to
understand. This is similar to how this is done in other drivers (imx319.c, ov5695.c,
mt9m001.c, and few others).
...
I'll changed that comment to "Request optional enable pin" to make it
less confusing (as imx219_power_on() sets it to 1).
...
The current schematics for the imx219 Raspberry Pi camera have the XCLR
signal connected to 1.8V power supply. So indeed, xclr_gpio is not used
in this case.
