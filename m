...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E281B69DE08
	for <lists+devicetree@lfdr.de>; Tue, 21 Feb 2023 11:41:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233703AbjBUKla (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 21 Feb 2023 05:41:30 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41294 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233513AbjBUKl2 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 21 Feb 2023 05:41:28 -0500
Received: from mx0a-00128a01.pphosted.com (mx0a-00128a01.pphosted.com [148.163.135.77])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A00A725E1A;
        Tue, 21 Feb 2023 02:41:25 -0800 (PST)
Received: from pps.filterd (m0167089.ppops.net [127.0.0.1])
        by mx0a-00128a01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 31L8piuV024973;
        Tue, 21 Feb 2023 05:41:02 -0500
Received: from nwd2mta4.analog.com ([137.71.173.58])
        by mx0a-00128a01.pphosted.com (PPS) with ESMTPS id 3nvdwdckar-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Tue, 21 Feb 2023 05:41:01 -0500
Received: from ASHBMBX8.ad.analog.com (ASHBMBX8.ad.analog.com [10.64.17.5])
        by nwd2mta4.analog.com (8.14.7/8.14.7) with ESMTP id 31LAf02F023076
        (version=TLSv1/SSLv3 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL);
        Tue, 21 Feb 2023 05:41:00 -0500
...
Received: from zeus.spd.analog.com (10.66.68.11) by ashbmbx8.ad.analog.com
 ...
 Transport; Tue, 21 Feb 2023 05:40:59 -0500
Received: from okan.localdomain (IST-LT-43126.ad.analog.com [10.25.36.24])
        by zeus.spd.analog.com (8.15.1/8.15.1) with ESMTP id 31LAdbGw012847;
        Tue, 21 Feb 2023 05:40:47 -0500
...
Subject: [PATCH v5 2/5] regulator: max77541: Add ADI MAX77541/MAX77540 Regulator Support
Date:   Tue, 21 Feb 2023 13:39:10 +0300
Message-ID: <20230221103926.49597-3-okan.sahin@analog.com>
...
X-Proofpoint-GUID: oOcyJlqxsz2f26NDmZ7yqeBDfbermXnC
X-Proofpoint-ORIG-GUID: oOcyJlqxsz2f26NDmZ7yqeBDfbermXnC
