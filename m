...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 71C463B9128
	for <lists+devicetree@lfdr.de>; Thu,  1 Jul 2021 13:29:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236378AbhGALaq (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 1 Jul 2021 07:30:46 -0400
Received: from mx0a-00128a01.pphosted.com ([148.163.135.77]:14618 "EHLO
        mx0a-00128a01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S236369AbhGALaq (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 1 Jul 2021 07:30:46 -0400
Received: from pps.filterd (m0167088.ppops.net [127.0.0.1])
        by mx0a-00128a01.pphosted.com (8.16.0.43/8.16.0.43) with SMTP id 161BBDDQ028544;
        Thu, 1 Jul 2021 07:28:15 -0400
Received: from nwd2mta4.analog.com ([137.71.173.58])
        by mx0a-00128a01.pphosted.com with ESMTP id 39h859rwdr-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 01 Jul 2021 07:28:14 -0400
Received: from ASHBMBX9.ad.analog.com (ASHBMBX9.ad.analog.com [10.64.17.10])
        by nwd2mta4.analog.com (8.14.7/8.14.7) with ESMTP id 161BSD6g034185
...
Received: from zeus.spd.analog.com (10.66.68.11) by ashbmbx9.ad.analog.com
 ...
 Transport; Thu, 1 Jul 2021 07:28:12 -0400
Received: from amiclaus-VirtualBox.ad.analog.com (AMICLAUS-L02.ad.analog.com [10.48.65.128])
        by zeus.spd.analog.com (8.15.1/8.15.1) with ESMTP id 161BSAXD006154;
        Thu, 1 Jul 2021 07:28:10 -0400
From:   Antoniu Miclaus <antoniu.miclaus@analog.com>
To:     <linux-iio@vger.kernel.org>, <linux-kernel@vger.kernel.org>,
        <jic23@kernel.org>, <devicetree@vger.kernel.org>,
        <robh+dt@kernel.org>
CC:     Antoniu Miclaus <antoniu.miclaus@analog.com>
Subject: [PATCH v2 1/2] iio: frequency: adrf6780: add support for ADRF6780
Date:   Thu, 1 Jul 2021 14:28:02 +0300
Message-ID: <20210701112803.75815-1-antoniu.miclaus@analog.com>
X-Mailer: git-send-email 2.32.0
MIME-Version: 1.0
Content-Transfer-Encoding: 7BIT
Content-Type:   text/plain; charset=US-ASCII
X-ADIRuleOP-NewSCL: Rule Triggered
X-Proofpoint-GUID: Q39mCHkQkX-RYdWY1q58eGO5xSjSnQNH
X-Proofpoint-ORIG-GUID: Q39mCHkQkX-RYdWY1q58eGO5xSjSnQNH
...
The ADRF6780is a silicon germanium (SiGe) design, wideband,
...
---
v2: fix spdx licence identifier version
    remove unused headers
    remove unused enum
    remove parity check implementation
    remove `det_en` parameter
    condense `spi_update_bits` function call where possible
    add `adrf6780_reset` function
    move `devm_clk_get` to probe function
...
index 000000000000..ddb6767facfd
--- /dev/null
