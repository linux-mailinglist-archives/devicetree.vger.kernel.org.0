...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5C36119D5B4
	for <lists+devicetree@lfdr.de>; Fri,  3 Apr 2020 13:20:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728066AbgDCLUX (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Apr 2020 07:20:23 -0400
Received: from mail-wm1-f68.google.com ([209.85.128.68]:34602 "EHLO
        mail-wm1-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728049AbgDCLUX (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 3 Apr 2020 07:20:23 -0400
Received: by mail-wm1-f68.google.com with SMTP id c195so1863815wme.1
        for <devicetree@vger.kernel.org>; Fri, 03 Apr 2020 04:20:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ffwll.ch; s=google;
        h=date:from:to:cc:subject:message-id:mail-followup-to:references
         :mime-version:content-disposition:in-reply-to;
        bh=t2GzYf9JXfX7mbm+nflqrwvAFX/I9EiHvysxgZFBGVs=;
        b=j+/9TAOBvgiQkdSNe4n/HqsMoJo3kUMtqE8jGaGV4RtqS22gaYAy1wE31B9Hpcn8/K
         /q/jVzOSp82SJIfne4P7Fe4XAcf5JUrrykIjecFB5kZ+DaGK7XnMJ2HuPOV2QBQW2ios
         6U7YkzgUox9nnKePJN7oNif+rWUsxcy7wsjHc=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:from:to:cc:subject:message-id
         ...
         :in-reply-to;
        bh=t2GzYf9JXfX7mbm+nflqrwvAFX/I9EiHvysxgZFBGVs=;
        b=
X-Gm-Message-State: AGi0Pua8XrhzDhuabBVC73yWHSOcRXMqoaeKTnNblmWFINE1nJXoNJ9G
        BKwprvu8sczcoeEekXK4nIirXw==
X-Google-Smtp-Source: APiQypLzmh/V3FsQ26sJq5+6oo76OIo9vEwCmedbqiPMxgavP7O/DbEwTuQ2LI3dGJZgULm57b2BQA==
X-Received: by 2002:a1c:7412:: with SMTP id p18mr8119467wmc.11.1585912817606;
        Fri, 03 Apr 2020 04:20:17 -0700 (PDT)
Received: from phenom.ffwll.local ([2a02:168:57f4:0:efd0:b9e5:5ae6:c2fa])
        by smtp.gmail.com with ESMTPSA id d13sm12006209wrq.11.2020.04.03.04.20.16
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 03 Apr 2020 04:20:16 -0700 (PDT)
Date:   Fri, 3 Apr 2020 13:20:14 +0200
...
Subject: Re: [PATCH v5 2/2] drm: Add support for the LogiCVC display
 controller
Message-ID: <20200403112014.GV2363188@phenom.ffwll.local>
...
In-Reply-To: <20200403093617.760278-3-paul.kocialkowski@bootlin.com>
...
This one here and the one below are btw in the wrong spot. You can just
delete them, if you're ok with some more obvious use-after-free due to
your use of devm_kzalloc for the various drm objects.
-Daniel
