...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7C1135085C8
	for <lists+devicetree@lfdr.de>; Wed, 20 Apr 2022 12:21:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377613AbiDTKYC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 20 Apr 2022 06:24:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54330 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377621AbiDTKXq (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 20 Apr 2022 06:23:46 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A6BCB1D0F3;
        Wed, 20 Apr 2022 03:20:55 -0700 (PDT)
X-UUID: 9fe2be0c358d4d339755cb0bf215dfed-20220420
X-UUID: 9fe2be0c358d4d339755cb0bf215dfed-20220420
Received: from mtkmbs10n1.mediatek.inc [(172.21.101.34)] by mailgw02.mediatek.com
        (envelope-from <roger.lu@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
        with ESMTP id 1958608968; Wed, 20 Apr 2022 18:20:50 +0800
...
Subject: [PATCH v24 7/7] soc: mediatek: SVS: add mt8192 SVS GPU driver
Date:   Wed, 20 Apr 2022 18:20:44 +0800
Message-ID: <20220420102044.10832-8-roger.lu@mediatek.com>
...
---
 drivers/soc/mediatek/mtk-svs.c | 472 ++++++++++++++++++++++++++++++++-
 1 file changed, 467 insertions(+), 5 deletions(-)

diff --git a/drivers/soc/mediatek/mtk-svs.c b/drivers/soc/mediatek/mtk-svs.c
index 4ae9036c98ff..b50bcbfebf52 100644
...
+
 ...
 {
 	struct svs_bank *svsb = svsp->pbank;
@@ -1176,6 +1422,25 @@ static int svs_init02(struct svs_platform *svsp)
 		}
 	}
...
@@ -1220,6 +1485,7 @@ static int svs_suspend(struct device *dev)
...
+	int ret;
 	...
 	for (idx = 0; idx < svsp->bank_max; idx++) {
@@ -1237,6 +1503,12 @@ static int svs_suspend(struct device *dev)
...
+
 	...
 	return 0;
@@ -1253,6 +1525,12 @@ static int svs_resume(struct device *dev)
 		return ret;
 	}
...
+
 	...
 	if (ret)
 		return ret;
@@ -1286,7 +1564,12 @@ static int svs_bank_resource_setup(struct svs_platform *svsp)
 			svsb->name = "SVSB_CCI";
 			break;
 		case SVSB_GPU:
-			svsb->name = "SVSB_GPU";
...
@@ -1359,6 +1642,85 @@ static int svs_bank_resource_setup(struct svs_platform *svsp)
 	return 0;
 }
...
+
 ...
 {
 	struct svs_bank *svsb;
@@ -1644,6 +2006,38 @@ static struct device *svs_add_device_link(struct svs_platform *svsp,
 	return dev;
 }
...
+
 ...
 {
 	struct device *dev;
@@ -1683,6 +2077,61 @@ static int svs_mt8183_platform_probe(struct svs_platform *svsp)
 	return 0;
 }
...
@@ -1787,6 +2236,16 @@ static struct svs_bank svs_mt8183_banks[] = {
 	},
 };
...
@@ -1799,6 +2258,9 @@ static const struct svs_platform_data svs_mt8183_platform_data = {
