...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F28BC427E87
	for <lists+devicetree@lfdr.de>; Sun, 10 Oct 2021 05:25:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230017AbhJJD1D (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 9 Oct 2021 23:27:03 -0400
Received: from mailout3.samsung.com ([203.254.224.33]:48792 "EHLO
        mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229744AbhJJD1D (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 9 Oct 2021 23:27:03 -0400
Received: from epcas2p1.samsung.com (unknown [182.195.41.53])
        by mailout3.samsung.com (KnoxPortal) with ESMTP id 20211010032503epoutp03d66d55d00953ca95dc21af79a3d8755c~sjXYh2R9e1128311283epoutp03L
        for <devicetree@vger.kernel.org>; Sun, 10 Oct 2021 03:25:03 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout3.samsung.com 20211010032503epoutp03d66d55d00953ca95dc21af79a3d8755c~sjXYh2R9e1128311283epoutp03L
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1633836303;
        bh=J346ac2+rk/G4qh9XbLz0fP8wZxBzko47H4c44J76i8=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=dKFN2iuashaapCcuOxzphFwdu2oEouNGKE/h1ccLOfWZKaRLYWduF5gxxe5Le/LUl
         BF64Hv483odzkPM/yoxdFawkIIatBYignM84lb+hEtwV0k4IrDBm85tK7mOWJjoRlL
         mhzZX88NmgSesHE8nPdCwi8U0QpSaCZEhEPZH6B0=
Received: from epsnrtp3.localdomain (unknown [182.195.42.164]) by
        epcas2p4.samsung.com (KnoxPortal) with ESMTP id
        20211010032501epcas2p4f002982218f04775267638b821da3a25~sjXW3Q34Q0499204992epcas2p4K;
        Sun, 10 Oct 2021 03:25:01 +0000 (GMT)
Received: from epsmges2p4.samsung.com (unknown [182.195.36.102]) by
        epsnrtp3.localdomain (Postfix) with ESMTP id 4HRnNn6FDvz4x9Pt; Sun, 10 Oct
        2021 03:24:57 +0000 (GMT)
Received: from epcas2p3.samsung.com ( [182.195.41.55]) by
        epsmges2p4.samsung.com (Symantec Messaging Gateway) with SMTP id
        91.D9.09472.90D52616; Sun, 10 Oct 2021 12:24:57 +0900 (KST)
Received: from epsmtrp1.samsung.com (unknown [182.195.40.13]) by
        epcas2p2.samsung.com (KnoxPortal) with ESMTPA id
        20211010032456epcas2p29de8e098493cbe21a08db86d8253787e~sjXSaDuc81853818538epcas2p2V;
        Sun, 10 Oct 2021 03:24:56 +0000 (GMT)
Received: from epsmgms1p2.samsung.com (unknown [182.195.42.42]) by
        epsmtrp1.samsung.com (KnoxPortal) with ESMTP id
        20211010032456epsmtrp121d31102f58913582c5cc87803794c3b~sjXSZTmFj3229632296epsmtrp1S;
        Sun, 10 Oct 2021 03:24:56 +0000 (GMT)
X-AuditID: b6c32a48-d75ff70000002500-96-61625d0908ff
Received: from epsmtip2.samsung.com ( [182.195.34.31]) by
        epsmgms1p2.samsung.com (Symantec Messaging Gateway) with SMTP id
        47.85.08750.80D52616; Sun, 10 Oct 2021 12:24:56 +0900 (KST)
Received: from localhost.localdomain (unknown [10.229.9.51]) by
        epsmtip2.samsung.com (KnoxPortal) with ESMTPA id
        20211010032456epsmtip2c0669619c54b100d34a7f8b2156dc9d8~sjXSNme9R1129311293epsmtip20;
        Sun, 10 Oct 2021 03:24:56 +0000 (GMT)
...
Subject: [PATCH v3 2/3] arm64: dts: exynos: add initial support for
 exynosautov9 SoC
Date:   Sun, 10 Oct 2021 12:22:45 +0900
Message-Id: <20211010032246.146939-3-chanho61.park@samsung.com>
X-Mailer: git-send-email 2.33.0
In-Reply-To: <20211010032246.146939-1-chanho61.park@samsung.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Brightmail-Tracker: H4sIAAAAAAAAA+NgFprBJsWRmVeSWpSXmKPExsWy7bCmuS5nbFKiwfYvWhaX92tbzD9yjtVi
        ...
        
X-Brightmail-Tracker: 
X-CMS-MailID: 20211010032456epcas2p29de8e098493cbe21a08db86d8253787e
X-Msg-Generator: CA
...
new file mode 100644
index 000000000000..d884ae421e12
--- /dev/null
