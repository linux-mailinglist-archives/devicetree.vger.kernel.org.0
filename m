...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 499D96066AC
	for <lists+devicetree@lfdr.de>; Thu, 20 Oct 2022 19:05:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229845AbiJTRFv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 20 Oct 2022 13:05:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40560 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229886AbiJTRFt (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 20 Oct 2022 13:05:49 -0400
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D6C13159D47;
        Thu, 20 Oct 2022 10:05:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666285545; x=1697821545;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=CxXwxHHtlPhJfHuUu67DIf4ybeS9OxiafDYxGgnrMG8=;
  b=MsiZSjc9yAZmnp++z+Zd79UpNsXUKqSr1bLQYEQuM/izgV25Q/hBXLrw
   lDfu1J/QfUfVUIG/6E7MSmS1Ez5EaNYGNsDQivEprGbzmaU221k4QAt3p
   94fKS7Sh2tKpoR51L9t745ZPLnTw0dioJCPu8Dnf4mSNu7CpONBrLMT+d
   er05c25ut8ZPwZRMZStPFnatu8IT7V2P+A3nCIfm2219uVRXeDIzZ9DCy
   xjQz2759GKIVh93jLUB6qZv2Zig9TYZcPrU9xkeEwAvKE3Rq4OGy89jHI
   veGBSIjDCK0JAI0VbmDdkz/V8Y40WNl4tCjddVfnurcB+nWsT/tByqnBW
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10506"; a="370987936"
X-IronPort-AV: E=Sophos;i="5.95,199,1661842800"; 
   d="scan'208";a="370987936"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 20 Oct 2022 10:05:43 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10506"; a="719179777"
X-IronPort-AV: E=Sophos;i="5.95,199,1661842800"; 
   d="scan'208";a="719179777"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by FMSMGA003.fm.intel.com with ESMTP; 20 Oct 2022 10:05:37 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1olYzA-0001Wd-2Y;
        Thu, 20 Oct 2022 17:05:36 +0000
Date:   Fri, 21 Oct 2022 01:04:56 +0800
...
Message-ID: <202210210050.Mpj5O086-lkp@intel.com>
References: <20221018231112.2142074-5-sean.anderson@seco.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="jne3DT32nI3Qe23q"
...
[also build test WARNING on clk/clk-next krzk/for-next krzk-dt/for-next linus/master v6.1-rc1 next-20221020]
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=clang make.cross W=1 O=build_dir ARCH=powerpc SHELL=/bin/bash drivers/net/ethernet/renesas/ drivers/phy/freescale/ drivers/phy/renesas/
