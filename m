...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 08AFA3D355A
	for <lists+devicetree@lfdr.de>; Fri, 23 Jul 2021 09:33:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233582AbhGWGwC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 23 Jul 2021 02:52:02 -0400
Received: from gloria.sntech.de ([185.11.138.130]:43390 "EHLO gloria.sntech.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S233339AbhGWGwA (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Fri, 23 Jul 2021 02:52:00 -0400
Received: from ip5f5aa64a.dynamic.kabel-deutschland.de ([95.90.166.74] helo=phil.lan)
        by gloria.sntech.de with esmtpsa (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <heiko@sntech.de>)
        id 1m6pfY-0003dj-LT; Fri, 23 Jul 2021 09:32:28 +0200
...
Subject: [PATCH v7 08/10] media: rockchip: rkisp1: add support for v12 isp variants
Date:   Fri, 23 Jul 2021 09:32:19 +0200
Message-Id: <20210723073221.1276358-9-heiko@sntech.de>
...
index d7c422cb3276..2a35bf24e54e 100644
...
index 945225e273a7..96c5e9398b23 100644
...
+
 ...
 {
@@ -1305,6 +1626,18 @@ static const struct rkisp1_params_ops rkisp1_v10_params_ops = {
...
index 1156db31432f..b1503197a5ba 100644
...
+
 static void rkisp1_stats_get_bls_meas(struct rkisp1_stats *stats,
 				      struct rkisp1_stat_buffer *pbuf)
 {
@@ -293,6 +355,12 @@ static const struct rkisp1_stats_ops rkisp1_v10_stats_ops = {
