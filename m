...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C15392DB375
	for <lists+devicetree@lfdr.de>; Tue, 15 Dec 2020 19:16:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731459AbgLOSQl (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 15 Dec 2020 13:16:41 -0500
Received: from bmail1.ministro.hu ([5.249.150.236]:33358 "EHLO
        bmail1.ministro.hu" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731455AbgLOSQe (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 15 Dec 2020 13:16:34 -0500
Received: from localhost (localhost [127.0.0.1])
        by bmail1.ministro.hu (Postfix) with ESMTP id 0D094123B58;
        Tue, 15 Dec 2020 19:15:41 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ministro.hu;
        s=201804; t=1608056141;
        bh=PKJZIETSeUmjS79WlVPEyuJPOHLXub68MSPwl4QoNoA=;
        h=Date:From:To:Subject:From;
        b=
X-Virus-Scanned: Debian amavisd-new at ministro.hu
Received: from bmail1.ministro.hu ([127.0.0.1])
        by localhost (bmail1.ministro.hu [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id JAHdiFZOkTaU; Tue, 15 Dec 2020 19:15:12 +0100 (CET)
Received: from dev (localhost [127.0.0.1])
        by bmail1.ministro.hu (Postfix) with ESMTPSA id DCF1B123B53;
        Tue, 15 Dec 2020 19:15:10 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ministro.hu;
        s=201804; t=1608056112;
        bh=PKJZIETSeUmjS79WlVPEyuJPOHLXub68MSPwl4QoNoA=;
        h=Date:From:To:Subject:From;
        b=
Date:   Tue, 15 Dec 2020 18:15:08 +0000
...
Subject: [PATCH v6] Serial: silabs si4455 serial driver
Message-ID: <20201215181506.GA20057@dev>
MIME-Version: 1.0
...
new file mode 100644
index 000000000000..502d6cb88fa0
--- /dev/null
