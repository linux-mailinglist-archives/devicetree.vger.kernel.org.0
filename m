...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E29354E4E0E
	for <lists+devicetree@lfdr.de>; Wed, 23 Mar 2022 09:20:30 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242599AbiCWIV5 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 23 Mar 2022 04:21:57 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48450 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242591AbiCWIV5 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 23 Mar 2022 04:21:57 -0400
Received: from mail-wr1-x430.google.com (mail-wr1-x430.google.com [IPv6:2a00:1450:4864:20::430])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E97A6673F8
        for <devicetree@vger.kernel.org>; Wed, 23 Mar 2022 01:20:23 -0700 (PDT)
Received: by mail-wr1-x430.google.com with SMTP id a1so927342wrh.10
        for <devicetree@vger.kernel.org>; Wed, 23 Mar 2022 01:20:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=o97Id8SlBx3K0Exp3D6AqIHYUDeIAeuxsksOw6CY0VY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:message-id:date:mime-version:user-agent:subject
         ...
         :content-transfer-encoding;
        bh=o97Id8SlBx3K0Exp3D6AqIHYUDeIAeuxsksOw6CY0VY=;
        b=
X-Gm-Message-State: AOAM53118+eF0yoUiIyU3Ro78fJFxNndxEq9OZe/BY9/7gEeOCnYFnS9
        BZZUwNYtlMApzuL1+8L3WJ0RDA==
X-Google-Smtp-Source: ABdhPJzmc9S+gUxVCBw/MVbcZtyT57TNjHWn2e1pPj/0K48Lo2l4umpPFzPbL6u2tpq49OTQJq/FrA==
X-Received: by 2002:a5d:584f:0:b0:204:171b:a4bc with SMTP id i15-20020a5d584f000000b00204171ba4bcmr10676337wrf.592.1648023621610;
        Wed, 23 Mar 2022 01:20:21 -0700 (PDT)
Received: from ?IPV6:2001:861:44c0:66c0:871b:e667:ca26:e5eb? ([2001:861:44c0:66c0:871b:e667:ca26:e5eb])
        by smtp.gmail.com with ESMTPSA id n14-20020a5d588e000000b00204064a3800sm10169115wrf.51.2022.03.23.01.20.19
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Wed, 23 Mar 2022 01:20:20 -0700 (PDT)
Message-ID: <65ffb63b-69a2-47ed-1b41-9b41c0880506@baylibre.com>
Date:   Wed, 23 Mar 2022 09:20:18 +0100
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:91.0) Gecko/20100101
 Thunderbird/91.5.0
Subject: Re: [PATCH v12 3/3] media: platform: mtk-mdp3: add Mediatek MDP3
 driver
...
References: <20220317145605.25782-1-moudy.ho@mediatek.com>
 <20220317145605.25782-4-moudy.ho@mediatek.com>
From:   Neil Armstrong <narmstrong@baylibre.com>
Organization: Baylibre
In-Reply-To: <20220317145605.25782-4-moudy.ho@mediatek.com>
...
On 17/03/2022 15:56, Moudy Ho wrote:
...
>   22 files changed, 5065 insertions(+)
...
> index 122eb94ed430..374472600378 100644
...
> index 000000000000..2b77d0f5aff6
> --- /dev/null
...
> new file mode 100644
> index 000000000000..042768ec24d9
> --- /dev/null
...
> new file mode 100644
> index 000000000000..5d4256c58902
> --- /dev/null
...
> new file mode 100644
> index 000000000000..b561328895f9
> --- /dev/null
...
> new file mode 100644
> index 000000000000..f21747e2f1b4
> --- /dev/null
...
> +	[MDP_COMP_WDMA]		= {1, 0, 0},
> +	[MDP_COMP_PATH0_SOUT]	= {0, 0, 2},
> +	[MDP_COMP_PATH1_SOUT]	= {0, 0, 3},
> +	[MDP_COMP_CCORR0]	= {1, 0, 0},
> +	[MDP_COMP_ISP_IMGI]	= {0, 0, 4},
> +	[MDP_COMP_ISP_IMGO]	= {0, 0, 4},
> +	[MDP_COMP_CAMIN]	= {2, 2, 1},
> +	[MDP_COMP_CAMIN2]	= {2, 4, 1},
> +};
> +
...
> new file mode 100644
> index 000000000000..4dceee40b893
> --- /dev/null
...
> new file mode 100644
> index 000000000000..1c4925dbb4c9
> --- /dev/null
...
> new file mode 100644
> index 000000000000..46aa7a6d3bab
> --- /dev/null
...
> new file mode 100644
> index 000000000000..2eaa9f312b78
> --- /dev/null
...
This should be MDP_COLOR_BGR565 since RGB565X is a big-endian variant of RGB565, and
MDP_COLOR_BGR565 has the swap bit.
