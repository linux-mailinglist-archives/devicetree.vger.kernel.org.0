...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EB8C65615D1
	for <lists+devicetree@lfdr.de>; Thu, 30 Jun 2022 11:16:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234133AbiF3JOt (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 30 Jun 2022 05:14:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43440 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233082AbiF3JOX (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 30 Jun 2022 05:14:23 -0400
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1E5DF201A5;
        Thu, 30 Jun 2022 02:14:18 -0700 (PDT)
X-UUID: 3573473631404695a33dff85747d5d40-20220630
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.7,REQID:bb7dbd37-8b6d-4572-b1a3-602fb62ca390,OB:0,LO
        B:0,IP:0,URL:0,TC:0,Content:-5,EDM:0,RT:0,SF:0,FILE:0,RULE:Release_Ham,ACT
        ION:release,TS:-5
X-CID-META: VersionHash:87442a2,CLOUDID:def22f86-57f0-47ca-ba27-fe8c57fbf305,C
...
Received: from mtkmbs11n1.mediatek.inc [(172.21.101.185)] by mailgw01.mediatek.com
        ...
        with ESMTP id 1072844191; Thu, 30 Jun 2022 17:14:11 +0800
Received: from mtkcas10.mediatek.inc (172.21.101.39) by
 mtkmbs10n2.mediatek.inc (172.21.101.183) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id 15.2.792.3;
 Thu, 30 Jun 2022 17:14:10 +0800
...
Subject: [PATCH v20 4/4] media: platform: mtk-mdp3: add Mediatek MDP3 driver
Date:   Thu, 30 Jun 2022 17:14:08 +0800
Message-ID: <20220630091408.6438-5-moudy.ho@mediatek.com>
...
Total for mtk-mdp3 device /dev/video2:
	53, Succeeded: 53, Failed: 0, Warnings: 0
...
---
 ...
 .../platform/mediatek/mdp3/mtk-mdp3-cmdq.c    | 528 ++++++++++
 .../platform/mediatek/mdp3/mtk-mdp3-cmdq.h    |  43 +
 .../platform/mediatek/mdp3/mtk-mdp3-comp.c    | 994 ++++++++++++++++++
 .../platform/mediatek/mdp3/mtk-mdp3-comp.h    | 208 ++++
 ...
 22 files changed, 5117 insertions(+)
...
new file mode 100644
index 000000000000..e8e1a0565e9e
--- /dev/null
...
new file mode 100644
index 000000000000..36f53a7bf05f
--- /dev/null
...
new file mode 100644
index 000000000000..70e7be07f888
--- /dev/null
...
+do {								\
+	typeof(cmd) (c) = (cmd);				\
+	cmdq_pkt_wfe(&((c)->pkt), (c)->event[(evt)], true);	\
+} while (0)
+
+#define MM_REG_WAIT_NO_CLEAR(cmd, evt)				\
+do {								\
+	typeof(cmd) (c) = (cmd);				\
+	cmdq_pkt_wfe(&((c)->pkt), (c)->event[(evt)], false);	\
+} while (0)
+
+#define MM_REG_CLEAR(cmd, evt)					\
+do {								\
+	typeof(cmd) (c) = (cmd);				\
+	cmdq_pkt_clear_event(&((c)->pkt), (c)->event[(evt)]);	\
+} while (0)
+
+#define MM_REG_SET_EVENT(cmd, evt)				\
+do {								\
+	typeof(cmd) (c) = (cmd);				\
+	cmdq_pkt_set_event(&((c)->pkt), (c)->event[(evt)]);	\
+} while (0)
+
...
new file mode 100644
index 000000000000..06e6953379d6
--- /dev/null
...
new file mode 100644
index 000000000000..adc4bd173ce8
--- /dev/null
...
new file mode 100644
index 000000000000..d1e70849399b
--- /dev/null
...
new file mode 100644
index 000000000000..e018367b858f
--- /dev/null
