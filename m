...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DBD344267EC
	for <lists+devicetree@lfdr.de>; Fri,  8 Oct 2021 12:31:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239995AbhJHKdB (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 8 Oct 2021 06:33:01 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48806 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239912AbhJHKcz (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 8 Oct 2021 06:32:55 -0400
Received: from mail-pl1-x62e.google.com (mail-pl1-x62e.google.com [IPv6:2607:f8b0:4864:20::62e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4FC14C061755;
        Fri,  8 Oct 2021 03:31:00 -0700 (PDT)
Received: by mail-pl1-x62e.google.com with SMTP id w14so5920399pll.2;
        Fri, 08 Oct 2021 03:31:00 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=3Uuo5i5tIYVvc3Ge2UPsLNyJLtAjQgnnXsFPyBzezbE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=3Uuo5i5tIYVvc3Ge2UPsLNyJLtAjQgnnXsFPyBzezbE=;
        b=
X-Gm-Message-State: AOAM533H0ShRpOLFzMhMo/yz+UQX5kSnkMg9ildKdn1vbU/icjYjgP5E
        vaCe3ppiGLKlsmt00tCbkOw=
X-Google-Smtp-Source: ABdhPJx7EaECN3R3R/stehZ2KQ7tj+0ZtCO/esgXHtyJ6QSkbCj49MKG62Hc6XrqEXO/oeYGhyB0sQ==
X-Received: by 2002:a17:90b:4b85:: with SMTP id lr5mr10979169pjb.66.1633689059653;
        Fri, 08 Oct 2021 03:30:59 -0700 (PDT)
Received: from fmin-OptiPlex-7060.nreal.work ([137.59.103.165])
        by smtp.gmail.com with ESMTPSA id y15sm2620151pfa.64.2021.10.08.03.30.54
...
Subject: [PATCH v3 8/8] media: stm32-dma2d: STM32 DMA2D driver
Date:   Fri,  8 Oct 2021 18:30:12 +0800
Message-Id: <1633689012-14492-9-git-send-email-dillon.minfei@gmail.com>
...
---
v3: all the changes according to Hans's review, thanks.
- remove stm32 private V4L2_CID_DMA2D_R2M_MODE ioctl
- remove some unneed checks
- add V4L2_COLORFX_SET_ARGB in V4L2_CID_COLORFX enum
- add V4L2_CID_COLORFX_ARGB to pass argb parameters
- remove unused code related to alpha blending, crop, etc.
...
new file mode 100644
index 000000000000..c6225147d9a8
--- /dev/null
...
+		if (ctrl->val == V4L2_COLORFX_SET_ARGB)
...
+			       V4L2_COLORFX_SET_ARGB, ~0x10001,
+			       V4L2_COLORFX_NONE);
+
+	v4l2_ctrl_new_std(handler, &dma2d_ctrl_ops, V4L2_CID_COLORFX_ARGB, 0,
+			  0xffffffff, 1, 0);
+
+	return 0;
+}
