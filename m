...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9FA53174844
	for <lists+devicetree@lfdr.de>; Sat, 29 Feb 2020 18:04:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727176AbgB2RES (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 29 Feb 2020 12:04:18 -0500
Received: from mail-wm1-f65.google.com ([209.85.128.65]:38961 "EHLO
        mail-wm1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727168AbgB2RES (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 29 Feb 2020 12:04:18 -0500
Received: by mail-wm1-f65.google.com with SMTP id c84so6671449wme.4
        for <devicetree@vger.kernel.org>; Sat, 29 Feb 2020 09:04:13 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=baylibre-com.20150623.gappssmtp.com; s=20150623;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=fg3BZ7UHsc/oyiO2PSXBTUV1zGE1mx8cKArqdrzQdhQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=fg3BZ7UHsc/oyiO2PSXBTUV1zGE1mx8cKArqdrzQdhQ=;
        b=
X-Gm-Message-State: APjAAAXX26IjzZi0iGrpdKk3Yc/Jhd0kEdqzkN2hNde935zqkARvlobY
        t3q1eO/XyTu0bRG6irdE5njb1MzCJ/4=
X-Google-Smtp-Source: APXvYqylB/gxxD8AryLsyaQAdmOD96KHVyJbeqpaKbb8lx9N5T/FJu9OVE/2SZAFC1DESpbTLWrvkA==
X-Received: by 2002:a7b:c450:: with SMTP id l16mr10965839wmi.31.1582995851653;
        Sat, 29 Feb 2020 09:04:11 -0800 (PST)
Received: from localhost.localdomain ([2a01:e34:ecba:5540:6f5c:582a:cc84:32f5])
        by smtp.gmail.com with ESMTPSA id 18sm7178304wmf.1.2020.02.29.09.04.09
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sat, 29 Feb 2020 09:04:10 -0800 (PST)
From:   Fabien Parent <fparent@baylibre.com>
To:     matthias.bgg@gmail.com, linux-arm-kernel@lists.infradead.org,
        linux-mediatek@lists.infradead.org, devicetree@vger.kernel.org,
        linux-kernel@vger.kernel.org
Cc:     Fabien Parent <fparent@baylibre.com>
Subject: [PATCH v3 1/2] arm64: dts: mediatek: add dtsi for MT8516
Date:   Sat, 29 Feb 2020 18:04:00 +0100
Message-Id: <20200229170401.1287324-1-fparent@baylibre.com>
...
V3:
	* Added usb0 and usb0_phy nodes
	* Fix PSCI compatible list
	* Fix spacings
	* Don't use compatible that are not used and not documented
	* Rename intpol-controller to interrupt-controller
	* Fix bad copy/paste for register address in pio node name
