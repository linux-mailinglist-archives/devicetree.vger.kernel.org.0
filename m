...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6ACFD596D90
	for <lists+devicetree@lfdr.de>; Wed, 17 Aug 2022 13:36:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231539AbiHQLeg (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 17 Aug 2022 07:34:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48122 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230098AbiHQLef (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 17 Aug 2022 07:34:35 -0400
Received: from mail-sh.amlogic.com (mail-sh.amlogic.com [58.32.228.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D72705852B;
        Wed, 17 Aug 2022 04:34:31 -0700 (PDT)
...
Subject: [PATCH v5 1/4] perf/amlogic: Add support for Amlogic meson G12 SoC DDR PMU driver
Date:   Wed, 17 Aug 2022 19:34:20 +0800
Message-ID: <20220817113423.2088581-1-jiucheng.xu@amlogic.com>
...
---
 ...
 drivers/perf/amlogic/meson_ddr_pmu_core.c | 552 ++++++++++++++++++++++
 drivers/perf/amlogic/meson_g12_ddr_pmu.c  | 393 +++++++++++++++
...
new file mode 100644
index 000000000000..300eaba2f266
--- /dev/null
...
+		return capability & (1 << id) ? attr->mode : 0;
+
+	return attr->mode;
+}
+
...
new file mode 100644
index 000000000000..e39142ad829f
--- /dev/null
...
+};
+
+static struct dmc_hw_info g12b_dmc_info = {
+	.enable		= dmc_g12_counter_enable,
+	.disable	= dmc_g12_counter_disable,
+	.irq_handler	= dmc_g12_irq_handler,
+	.get_counters	= dmc_g12_get_counters,
...
+	.dmc_nr = 1,
+	.chann_nr = 4,
+	.capability = 0X7FFF00FF3FDF,
+	.fmt_attr = g12_pmu_format_attrs,
+};
+
+static struct dmc_hw_info sm1_dmc_info = {
+	.enable		= dmc_g12_counter_enable,
+	.disable	= dmc_g12_counter_disable,
+	.irq_handler	= dmc_g12_irq_handler,
+	.get_counters	= dmc_g12_get_counters,
...
new file mode 100644
index 000000000000..ac1c00eaa827
--- /dev/null
