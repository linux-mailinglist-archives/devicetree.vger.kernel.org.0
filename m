...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 682A13F98A2
	for <lists+devicetree@lfdr.de>; Fri, 27 Aug 2021 14:02:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245061AbhH0MDV (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 27 Aug 2021 08:03:21 -0400
Received: from mail.bugwerft.de ([46.23.86.59]:37074 "EHLO mail.bugwerft.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231493AbhH0MDV (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Fri, 27 Aug 2021 08:03:21 -0400
Received: from hq-00021.fritz.box (p57bc979a.dip0.t-ipconnect.de [87.188.151.154])
        by mail.bugwerft.de (Postfix) with ESMTPSA id 2A890327D0E;
        Fri, 27 Aug 2021 11:54:29 +0000 (UTC)
From:   Daniel Mack <daniel@zonque.org>
To:     linux-clk@vger.kernel.org, devicetree@vger.kernel.org
Cc:     robh+dt@kernel.org, kuninori.morimoto.gx@renesas.com,
        mturquette@baylibre.com, sboyd@kernel.org,
        Daniel Mack <daniel@zonque.org>
Subject: [PATCH v4 9/9] clk: cs2000-cp: convert driver to regmap
Date:   Fri, 27 Aug 2021 13:54:20 +0200
Message-Id: <20210827115420.3052019-10-daniel@zonque.org>
...
index e80918be8e9c..8fd5bfdcd71d 100644
...
index 3aae3540e29e..4bea2a9b8d96 100644
...
+		if (ret < 0)
 		...
 		val |= Val_Ratio(tmp, i);
@@ -271,16 +278,16 @@ static int cs2000_ratio_select(struct cs2000_priv *priv, int ch)
 	if (CH_SIZE_ERR(ch))
 		return -EINVAL;
...
@@ -328,8 +335,8 @@ static int cs2000_select_ratio_mode(struct cs2000_priv *priv,
 	 */
...
@@ -338,7 +345,7 @@ static int __cs2000_set_rate(struct cs2000_priv *priv, int ch,
 {
 	int ret;
...
@@ -354,7 +361,7 @@ static int __cs2000_set_rate(struct cs2000_priv *priv, int ch,
 	if (ret < 0)
 		return ret;
...
@@ -472,8 +479,8 @@ static int cs2000_clk_register(struct cs2000_priv *priv)
...
@@ -525,12 +532,13 @@ static int cs2000_clk_register(struct cs2000_priv *priv)
...
+		return ret;
 	...
 	if (val >> 3)
@@ -579,6 +587,10 @@ static int cs2000_probe(struct i2c_client *client,
 	priv->client = client;
