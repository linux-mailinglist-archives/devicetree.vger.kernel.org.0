...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 22E8162F34E
	for <lists+devicetree@lfdr.de>; Fri, 18 Nov 2022 12:09:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241527AbiKRLJN (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 18 Nov 2022 06:09:13 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48384 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241645AbiKRLI5 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 18 Nov 2022 06:08:57 -0500
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2EB253B1;
        Fri, 18 Nov 2022 03:08:54 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1668769734; x=1700305734;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=xwu3kYZIdPmWrk4fLczdJDLyPmPfXqaxKaSJhQ2Vh04=;
  b=YPpoM2wC2DLStSeIkC2NiFOk6BeLqSq8hdQoLuMp+aOYDjw8GGJP1Ghv
   YQkYIlhRTRp9ZhajfB7RChuQfevqaASVGvWZExd9rjtk343bQrRNdGbE/
   XRnTMFphbqnGS1rqxEsingN13VkGSiQZoyii5GBTxK/4NIwpVHXSJcmiF
   STm1iuA48pKXOLjXSnhju+fYnpNH15wn/O4nquBRuKJkNdVQCcwmyjYNQ
   nsvD15YtipBcUzAkg9JbsOLf2iY62aQ7pUR10nWkEEvHaQJXN/MbnHaMG
   Jp80gdLtKBmIoqGosmo5KYPWxKH/g2++hPL8LajpOrSTvdCKWTI2QkV8h
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10534"; a="313125999"
X-IronPort-AV: E=Sophos;i="5.96,174,1665471600"; 
   d="scan'208";a="313125999"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Nov 2022 03:08:53 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10534"; a="671285920"
X-IronPort-AV: E=Sophos;i="5.96,174,1665471600"; 
   d="scan'208";a="671285920"
Received: from lkp-server01.sh.intel.com (HELO 55744f5052f8) ([10.239.97.150])
  by orsmga008.jf.intel.com with ESMTP; 18 Nov 2022 03:08:48 -0800
Received: from kbuild by 55744f5052f8 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ovzEl-0001O1-2K;
        Fri, 18 Nov 2022 11:08:47 +0000
Date:   Fri, 18 Nov 2022 19:08:06 +0800
...
Message-ID: <202211181839.vjGmTnQz-lkp@intel.com>
References: <20221116103146.2556846-11-abel.vesa@linaro.org>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="MUWSySKrUwSi1Ypj"
...
[cannot apply to robh/for-next v6.1-rc5 v6.1-rc4 v6.1-rc3 linus/master v6.1-rc5]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Abel-Vesa/Add-base-device-tree-files-for-SM8550/20221116-184638
patch link:    https://lore.kernel.org/r/20221116103146.2556846-11-abel.vesa%40linaro.org
patch subject: [PATCH 10/10] arm64: dts: qcom: Add base SM8550 MTP dts
config: arm64-allyesconfig
compiler: aarch64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/731e77874bd8ac1ab586a173e63a52262e743820
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Abel-Vesa/Add-base-device-tree-files-for-SM8550/20221116-184638
        git checkout 731e77874bd8ac1ab586a173e63a52262e743820
...
>> arch/arm64/boot/dts/qcom/sm8550.dtsi:7:10: fatal error: dt-bindings/clock/qcom,gcc-sm8550.h: No such file or directory
       7 | #include <dt-bindings/clock/qcom,gcc-sm8550.h>
         |          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
c456da7c709bda Abel Vesa 2022-11-16  @7  #include <dt-bindings/clock/qcom,gcc-sm8550.h>
c456da7c709bda Abel Vesa 2022-11-16   8  #include <dt-bindings/clock/qcom,tcsrcc-sm8550.h>
c456da7c709bda Abel Vesa 2022-11-16   9  #include <dt-bindings/clock/qcom,rpmh.h>
c456da7c709bda Abel Vesa 2022-11-16  10  #include <dt-bindings/dma/qcom-gpi.h>
c456da7c709bda Abel Vesa 2022-11-16  11  #include <dt-bindings/gpio/gpio.h>
c456da7c709bda Abel Vesa 2022-11-16  12  #include <dt-bindings/mailbox/qcom-ipcc.h>
c456da7c709bda Abel Vesa 2022-11-16  13  #include <dt-bindings/power/qcom-rpmpd.h>
c456da7c709bda Abel Vesa 2022-11-16  14  #include <dt-bindings/interconnect/qcom,sm8550.h>
c456da7c709bda Abel Vesa 2022-11-16  15  #include <dt-bindings/soc/qcom,rpmh-rsc.h>
c456da7c709bda Abel Vesa 2022-11-16  16  #include <dt-bindings/thermal/thermal.h>
c456da7c709bda Abel Vesa 2022-11-16  17  
