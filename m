...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 32FF46C067
	for <lists+devicetree@lfdr.de>; Wed, 17 Jul 2019 19:30:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727515AbfGQR3n (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 17 Jul 2019 13:29:43 -0400
Received: from hqemgate14.nvidia.com ([216.228.121.143]:11381 "EHLO
        hqemgate14.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727351AbfGQR3n (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 17 Jul 2019 13:29:43 -0400
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqemgate14.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5d2f5b040001>; Wed, 17 Jul 2019 10:29:40 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Wed, 17 Jul 2019 10:29:40 -0700
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Wed, 17 Jul 2019 10:29:40 -0700
...
Message-ID: <d7892bfc-2cbf-27af-518d-dc7e243815b8@nvidia.com>
Date:   Wed, 17 Jul 2019 10:29:36 -0700
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1563384580; bh=+IvJtw+/0nuHiFpw+RcP0aJAsXpYHTcMb8IuYSkyUTg=;
        h=X-PGP-Universal:Subject:To:CC:References:From:Message-ID:Date:
         User-Agent:MIME-Version:In-Reply-To:X-Originating-IP:
         X-ClientProxiedBy:Content-Type:Content-Transfer-Encoding:
         Content-Language;
        b=
...
>>>>>>>>>>>>>>>>> 16.07.2019 21:30, Sowjanya Komatineni =D0=BF=D0=B8=D1=88=
=D0=B5=D1=82:
...
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>> [1]
>>>>>>>>>>>>>>>>>>>>>> https://elixir.bootlin.com/linux/v5.2.1/source/drive=
rs/gpu/drm/tegra/dc.c#L2383
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>>
...
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>> [2]
>>>>>>>>>>>>>>>>>>>>>> https://www.kernel.org/doc/html/latest/driver-api/de=
vice_link.html
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>>
...
/linux-next.git/tree/drivers/devfreq/tegra20-devfreq.c#n100
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>>
>>>>>>>>>>>>>>>>>>>>>>
...
>>>>>>>>>
>>>>>>>>>  =C2=A0=C2=A0 =C2=A0=C2=A0=C2=A0 =C2=A0=C2=A0=C2=A0 - Save CPU cl=
ock policy registers, and Perform dfll
...
>>>>>>>>>
>>>>>>>>>  =C2=A0=C2=A0 =C2=A0=C2=A0=C2=A0 =C2=A0=C2=A0=C2=A0 - Re-init DFL=
L, Set in Open-Loop mode, restore CPU
...
>>>>>>>>>
>>>>>>>>>  =C2=A0=C2=A0 =C2=A0=C2=A0=C2=A0 =C2=A0=C2=A0=C2=A0 - do clk_prep=
are_enable which acutally sets DFLL in
>>>>>>>>> Closed loop mode
>>>>>>>>>
>>>>>>>>>
...
During bootup, cclk_g is registered after all pll's and peripheral=20
clocks which is the way we wanted, So cclk_g will be the first one in=20
the clk list as clk_register adds new clock first in the list.

When clk_save_context and clk_restore_context APIs iterates over the=20
...
My above comment is in reference to your request of doing save/restore=20
for cclk_g in normal fashion thru save/restore context. Because of the=20
clk order I mentioned above, we cclk_g will be the first one to go thru=20
save/context.

During save_context of cclk_g, source can be from PLLX, dfll.

Issue will be when we do restore during clk_restore_context of cclk_g as=20
