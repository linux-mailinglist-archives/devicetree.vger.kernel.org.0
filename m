...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BF9324B2358
	for <lists+devicetree@lfdr.de>; Fri, 11 Feb 2022 11:40:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1349150AbiBKKjO (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 11 Feb 2022 05:39:14 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:43066 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1349121AbiBKKis (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 11 Feb 2022 05:38:48 -0500
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A61C7D46;
        Fri, 11 Feb 2022 02:38:39 -0800 (PST)
X-UUID: 40b4f993395e45008e9ec29a2e0e28af-20220211
X-UUID: 40b4f993395e45008e9ec29a2e0e28af-20220211
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by mailgw01.mediatek.com
        (envelope-from <jiaxin.yu@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
        with ESMTP id 513119243; Fri, 11 Feb 2022 18:38:36 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by
 mtkmbs07n1.mediatek.inc (172.21.101.16) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Fri, 11 Feb 2022 18:38:33 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas11.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Fri, 11 Feb 2022 18:38:32 +0800
...
Subject: [PATCH 10/15] ASoC: mediatek: mt8186: add platform driver
Date:   Fri, 11 Feb 2022 18:38:13 +0800
Message-ID: <20220211103818.8266-11-jiaxin.yu@mediatek.com>
...
---
 ...
 13 files changed, 9993 insertions(+)
...
index 3b1ddea26a9e..f0f234cc451f 100644
...
+	  If unsure select "N".
+
+config SND_SOC_MT8186_MT6366_RT1019_RT5682
+	tristate "ASoC Audio driver for MT8186 with RT1019 RT5682 codec"
+	depends on I2C && GPIOLIB
+	depends on SND_SOC_MT8186 && MTK_PMIC_WRAP
+	select SND_SOC_MT6366
...
+	help
+	  This adds ASoC driver for Mediatek MT8186 boards
+	  with the MT6366 RT1019 RT5682 codecs.
+	  Select Y if you have such device.
+	  If unsure select "N".
+
...
index 000000000000..f92e0fe0a0aa
--- /dev/null
...
+obj-$(CONFIG_SND_SOC_MT8186_MT6366_RT1019_RT5682) += mt8186-mt6366-rt1019-rt5682.o
...
new file mode 100644
index 000000000000..eb955f50fb91
--- /dev/null
...
new file mode 100644
index 000000000000..583f77628508
--- /dev/null
...
new file mode 100644
index 000000000000..f227c330be12
--- /dev/null
...
new file mode 100644
index 000000000000..e81d3bd99c19
--- /dev/null
...
new file mode 100644
index 000000000000..50c444462102
--- /dev/null
...
new file mode 100644
index 000000000000..5f0e09ae09ad
--- /dev/null
...
new file mode 100644
index 000000000000..fbdf8eb3107c
--- /dev/null
...
new file mode 100644
index 000000000000..c25898a2a5ff
--- /dev/null
...
new file mode 100644
index 000000000000..ace606439c6a
--- /dev/null
