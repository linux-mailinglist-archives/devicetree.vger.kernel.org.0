...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5E21B5FB9FA
	for <lists+devicetree@lfdr.de>; Tue, 11 Oct 2022 19:56:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229698AbiJKR4q (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 11 Oct 2022 13:56:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38098 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229446AbiJKR4p (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 11 Oct 2022 13:56:45 -0400
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9506C62919;
        Tue, 11 Oct 2022 10:56:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1665511001; x=1697047001;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=IbQXwifT12cdVVmjafdTf/RnpH2zHlOKzCo3G3+QRtA=;
  b=cQHQdLeNXJ0Gvbv337cIyUda0CTeF8Yhv1lYEUVdDKxESI+xPdLslZ9z
   9tOAoPEFrR2WWnR4idUNLTUmza1ga+9xrgTTW8JQxTlTE0LjwHEuwRaL/
   ga0xEKpYyM9jt2YPDsFuGhD1in6pV7VVTvyGTy0Zdd8alA2tbj4b7YdLE
   TIDmgUXdAcW23qw6b0jiy4Wu/hKfQN7bJaPdrGm6wqzBW230QuthnRM+m
   zB+sGpfZauIVDxVWjrjY0HhFOZIA97wfbd5/HSDaNuNU1WFRG9MlcFuvb
   3dkXsfFMY2ssd3MZXB1WsV4DIevUlHdRoUEpLFk2YwPQwdrBh6HLJz0sL
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10497"; a="368750196"
X-IronPort-AV: E=Sophos;i="5.95,176,1661842800"; 
   d="scan'208";a="368750196"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Oct 2022 10:56:40 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10497"; a="695160385"
X-IronPort-AV: E=Sophos;i="5.95,176,1661842800"; 
   d="scan'208";a="695160385"
Received: from lkp-server01.sh.intel.com (HELO 2af0a69ca4e0) ([10.239.97.150])
  by fmsmga004.fm.intel.com with ESMTP; 11 Oct 2022 10:56:32 -0700
Received: from kbuild by 2af0a69ca4e0 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oiJUW-00034d-0F;
        Tue, 11 Oct 2022 17:56:32 +0000
Date:   Wed, 12 Oct 2022 01:55:53 +0800
...
Subject: Re: [PATCH v5 13/13] tty: gunyah: Add tty console driver for RM
 Console Services
Message-ID: <202210120133.Z5ySiBS2-lkp@intel.com>
References: <20221011000840.289033-14-quic_eberman@quicinc.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="XKhnn9sZHzsjEEyI"
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/959054eb26b8711586a7835aadc3795b77e9a694
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Elliot-Berman/Drivers-for-gunyah-hypervisor/20221011-081934
        git checkout 959054eb26b8711586a7835aadc3795b77e9a694
...
>> drivers/tty/gunyah_console.c:422:40: error: array type has incomplete element type 'struct gunyah_rm_cons_device_id'
     422 | static struct gunyah_rm_cons_device_id rm_cons_console_ids[] = {
         |                                        ^~~~~~~~~~~~~~~~~~~
   drivers/tty/gunyah_console.c:422:40: warning: 'rm_cons_console_ids' defined but not used [-Wunused-variable]


vim +422 drivers/tty/gunyah_console.c

   421	
 > 422	static struct gunyah_rm_cons_device_id rm_cons_console_ids[] = {
   423		{ .name = GH_RM_DEVICE_CONSOLE },
   424		{}
   425	};
   426	MODULE_DEVICE_TABLE(gunyah_rsc_mgr, rm_cons_console_ids);
   427	
...
CONFIG_GUNYAH=y
CONFIG_GUNYAH_RESORUCE_MANAGER=y
