...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9907D55F39C
	for <lists+devicetree@lfdr.de>; Wed, 29 Jun 2022 04:53:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231200AbiF2CwI (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 28 Jun 2022 22:52:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55216 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230455AbiF2Cvr (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 28 Jun 2022 22:51:47 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6123B2EA00;
        Tue, 28 Jun 2022 19:51:41 -0700 (PDT)
X-UUID: 9a0d014d7d3340ab9047af4d5de84059-20220629
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.7,REQID:878d8026-4566-4b95-b298-e5218abb2251,OB:0,LO
        B:0,IP:0,URL:0,TC:0,Content:0,EDM:0,RT:0,SF:0,FILE:0,RULE:Release_Ham,ACTI
        ON:release,TS:0
X-CID-META: VersionHash:87442a2,CLOUDID:227d0a86-57f0-47ca-ba27-fe8c57fbf305,C
...
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by mailgw02.mediatek.com
        ...
        with ESMTP id 1263323629; Wed, 29 Jun 2022 10:51:30 +0800
Received: from mtkmbs11n2.mediatek.inc (172.21.101.187) by
 mtkmbs11n2.mediatek.inc (172.21.101.187) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.2.792.3;
 Wed, 29 Jun 2022 10:51:28 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkmbs11n2.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.2.792.3 via Frontend
 Transport; Wed, 29 Jun 2022 10:51:26 +0800
...
Subject: [PATCH net-next v4 09/10] net: ethernet: mtk-star-emac: separate tx/rx handling with two NAPIs
Date:   Wed, 29 Jun 2022 10:51:08 +0800
Message-ID: <20220629025109.21933-10-biao.huang@mediatek.com>
...
---
 drivers/net/ethernet/mediatek/mtk_star_emac.c | 342 ++++++++++--------
 1 file changed, 201 insertions(+), 141 deletions(-)

diff --git a/drivers/net/ethernet/mediatek/mtk_star_emac.c b/drivers/net/ethernet/mediatek/mtk_star_emac.c
index a1165f293494..1ee2bba29eef 100644
...
@@ -1091,31 +1159,41 @@ static int mtk_star_tx_complete_one(struct mtk_star_priv *priv)
 	return ret;
 }
...
@@ -1195,7 +1273,7 @@ static const struct ethtool_ops mtk_star_ethtool_ops = {
...
+static int mtk_star_rx(struct mtk_star_priv *priv, int budget)
 {
 	...
 	struct device *dev = mtk_star_get_dev(priv);
@@ -1203,107 +1281,86 @@ static int mtk_star_receive_packet(struct mtk_star_priv *priv)
 	struct net_device *ndev = priv->ndev;
...
@@ -1602,7 +1659,10 @@ static int mtk_star_probe(struct platform_device *pdev)
