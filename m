...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0FD3643F690
	for <lists+devicetree@lfdr.de>; Fri, 29 Oct 2021 07:24:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231893AbhJ2F03 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 29 Oct 2021 01:26:29 -0400
Received: from esa.microchip.iphmx.com ([68.232.154.123]:26384 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231860AbhJ2F0Z (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 29 Oct 2021 01:26:25 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1635485037; x=1667021037;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=xgrdTaENT8Z5hJmK21IWkx18beoc5O5yvjm6x13LXSg=;
  b=Kl5YZY+tFlUlp1rtx0QmDqFYz+35rR5t6fPk/50w2JSldvItWUgg5RQb
   UznB8PQGWr24ZHKjQTTqjaONtOvKNHlukXDjPkNoUQnKd5YED6o+J+yHI
   XCn+TAKm6Ym1PRdyf+ET3EJx9UQpmRROOXPUM7/9m5r7XZbmnlRU9brgB
   Sm05ClsO1ly7SqUfnFd2Atntk7THxMd3TSaXsd+BJtI5z7IdbfGt32JW/
   fkaxMAk3jgIk46eYp+o29YP0hDhroKGb/Ym2fKC+iqaLiz6k95BFINpSm
   yByXUAqQ2VfmVO+qgEB0n9YpgBN7sK/xiThd1ccG9g1EXD/Sv9qrVD42+
   Q==;
IronPort-SDR: 
 ehxvYZsPl8GvcEnRGSNTUX6J
X-IronPort-AV: E=Sophos;i="5.87,191,1631602800"; 
   d="scan'208";a="74669097"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa6.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 28 Oct 2021 22:23:56 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.14; Thu, 28 Oct 2021 22:23:55 -0700
Received: from CHE-LT-I21427LX.microchip.com (10.10.115.15) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server id
 15.1.2176.14 via Frontend Transport; Thu, 28 Oct 2021 22:23:46 -0700
...
Subject: [PATCH v6 net-next 05/10] net: dsa: microchip: add DSA support for microchip lan937x
Date:   Fri, 29 Oct 2021 10:52:51 +0530
Message-ID: <20211029052256.144739-6-prasanna.vengateshan@microchip.com>
...
Min and max values of RGMII internal delay are arrived from
characterisation results. If the property is not found, the value
will be forced to 0.
...
---
 ...
 drivers/net/dsa/microchip/lan937x_dev.c  | 576 +++++++++++++++++++
 drivers/net/dsa/microchip/lan937x_dev.h  |  75 +++
 drivers/net/dsa/microchip/lan937x_main.c | 351 ++++++++++++
...
index 1597c63988b4..8dcd4772ceab 100644
--- a/drivers/net/dsa/microchip/ksz_common.h
+++ b/drivers/net/dsa/microchip/ksz_common.h
@@ -41,6 +41,8 @@ struct ksz_port {
...
+	u8 rgmii_rx_val;
 ...
 struct ksz_device {
@@ -146,6 +148,9 @@ void ksz_switch_remove(struct ksz_device *dev);
...
index 000000000000..b04881e66abd
--- /dev/null
...
new file mode 100644
index 000000000000..9e276f317cb3
--- /dev/null
...
new file mode 100644
index 000000000000..fff60b55eba8
--- /dev/null
...
new file mode 100644
index 000000000000..a7ecacab907d
--- /dev/null
...
new file mode 100644
index 000000000000..73729b167897
--- /dev/null
