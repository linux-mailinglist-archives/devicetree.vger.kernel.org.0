...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D10424CEBC
	for <lists+devicetree@lfdr.de>; Thu, 20 Jun 2019 15:32:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731553AbfFTNcn (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 20 Jun 2019 09:32:43 -0400
Received: from heliosphere.sirena.org.uk ([172.104.155.198]:59044 "EHLO
        heliosphere.sirena.org.uk" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726951AbfFTNcn (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 20 Jun 2019 09:32:43 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        List-Archive; bh=IKCq0coxVWSfRqbuSzuR8qQoaaFahZ8e/GyuvEbyLsY=; b=mzkktF0WtBNI
        kbosOtm0aFZx/AS73Sw8uEo8uZphHJHA5pUKcM+yWOgabQ6Gws/scjV+MNJypWvjv9M98fgNv0iGz
        KS5wFZ371tBqoCKFVqtjzKQzDSgssHGi85WFqvCndP3lu1cppQvpjjs8nNTw/ySOPQZ7B6dK2kaCZ
        mVtLc=;
Received: from [2001:470:1f1d:6b5:7e7a:91ff:fede:4a45] (helo=finisterre.sirena.org.uk)
        by heliosphere.sirena.org.uk with esmtpsa (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.89)
        (envelope-from <broonie@sirena.org.uk>)
        id 1hdxAv-0000im-TK; Thu, 20 Jun 2019 13:32:26 +0000
Received: by finisterre.sirena.org.uk (Postfix, from userid 1000)
        id 1A57D440050; Thu, 20 Jun 2019 14:32:25 +0100 (BST)
...
Cc:     alsa-devel@alsa-project.org, broonie@kernel.org,
        ...
        mark.rutland@arm.com, Nikesh Oswal <nikesh@opensource.cirrus.com>,
        patches@opensource.cirrus.com, robh+dt@kernel.org
Subject: Applied "ASoC: cs47l90: Add codec driver for Cirrus Logic CS47L90" to the asoc tree
In-Reply-To: <20190619134159.23580-5-ckeepax@opensource.cirrus.com>
X-Patchwork-Hint: ignore
Message-Id: <20190620133225.1A57D440050@finisterre.sirena.org.uk>
Date:   Thu, 20 Jun 2019 14:32:25 +0100 (BST)
...
From f1572a4489543c051a6097a706b91ff0f1c2175d Mon Sep 17 00:00:00 2001
From: Richard Fitzgerald <rf@opensource.cirrus.com>
Date: Wed, 19 Jun 2019 14:41:59 +0100
Subject: [PATCH] ASoC: cs47l90: Add codec driver for Cirrus Logic CS47L90
...
index a8aa801b9342..ff88f0b7d61d 100644
...
@@ -587,6 +588,9 @@ config SND_SOC_CS47L35
...
@@ -718,8 +722,10 @@ config SND_SOC_MADERA
 	tristate
...
index ce02d1fb250b..ed74f5babf59 100644
...
index 000000000000..83c4e4628bde
--- /dev/null
