...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5C2D6128219
	for <lists+devicetree@lfdr.de>; Fri, 20 Dec 2019 19:15:53 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727452AbfLTSPp (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 20 Dec 2019 13:15:45 -0500
Received: from mail-pl1-f196.google.com ([209.85.214.196]:44982 "EHLO
        mail-pl1-f196.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727724AbfLTSPn (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 20 Dec 2019 13:15:43 -0500
Received: by mail-pl1-f196.google.com with SMTP id az3so4420411plb.11;
        Fri, 20 Dec 2019 10:15:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=B8tQZZIPFBH7o841EDpYEZv9YKodWYIMP2Y+sKpNGnM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=B8tQZZIPFBH7o841EDpYEZv9YKodWYIMP2Y+sKpNGnM=;
        b=
X-Gm-Message-State: APjAAAUt3XFNx6m/baQuSCbQ/BNGbRUJRVTuEGCpDc9Jk+GzxFH0qLv9
        ZgxhGosxq5ud3/4slAcQoTinfKqc
X-Google-Smtp-Source: APXvYqwRYKyzsaFrvoMGb73d8HSYUr0KiDErMZCVcUm7MdSXcREOTEyTSc5+FmIyAn+QqsL6/2lGpA==
X-Received: by 2002:a17:902:b40e:: with SMTP id x14mr13716997plr.242.1576865741811;
        Fri, 20 Dec 2019 10:15:41 -0800 (PST)
Received: from localhost.localdomain (c-73-241-114-122.hsd1.ca.comcast.net. [73.241.114.122])
        by smtp.gmail.com with ESMTPSA id j28sm11833869pgb.36.2019.12.20.10.15.40
...
Subject: [PATCH V7 net-next 11/11] ptp: Add a driver for InES time stamping IP core.
Date:   Fri, 20 Dec 2019 10:15:20 -0800
Message-Id: <18c9fd4f00db0a397b16df928a80abb6530376db.1576865315.git.richardcochran@gmail.com>
