...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B87B25F204D
	for <lists+devicetree@lfdr.de>; Sun,  2 Oct 2022 00:24:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229441AbiJAWYH (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 1 Oct 2022 18:24:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44814 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229517AbiJAWYF (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 1 Oct 2022 18:24:05 -0400
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 74F6211159
        for <devicetree@vger.kernel.org>; Sat,  1 Oct 2022 15:24:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1664663042; x=1696199042;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=bHRwei5acwwoJeVK27Sk+RMAA+mWT0g26sPPszZIz0c=;
  b=PXG2YofURdPZwFBpngDGfGX0jJ9xd2Wbtg1SpxrpnMCnRbcu0Nr0Sn7j
   7OgKnh1f5lQqXz3rynUPrXaJ/XDr+YHjXw7qMb1GH/z2YO9cJ1gKexXWB
   vI3i3FkdQVXGgS1OnQIdWDtbAfNsW5hESxI4Yr3OXGr4b5Tihxqjlv+eJ
   2m3fyEI/+UX4O93p49V3zLfzsraz2pyut5J2qfwjEosuSS+BnOXQkoCDo
   NY4p6T4Cm9BO2qLlcbcxPaiCEzvyWgNVScuJrSSkAlQl65JjlZsZ64Fre
   YP+WK0/3IOS2qcWXKhmh7IItAtozZcugrhRGhlyQRN+J+2R5yk92YyG4b
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10487"; a="302401032"
X-IronPort-AV: E=Sophos;i="5.93,361,1654585200"; 
   d="scan'208";a="302401032"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Oct 2022 15:24:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10487"; a="691640422"
X-IronPort-AV: E=Sophos;i="5.93,361,1654585200"; 
   d="scan'208";a="691640422"
Received: from lkp-server01.sh.intel.com (HELO 14cc182da2d0) ([10.239.97.150])
  by fmsmga004.fm.intel.com with ESMTP; 01 Oct 2022 15:23:58 -0700
Received: from kbuild by 14cc182da2d0 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oektp-0002nh-1q;
        Sat, 01 Oct 2022 22:23:57 +0000
Date:   Sun, 2 Oct 2022 06:23:31 +0800
...
Message-ID: <202210020642.ts8UPw06-lkp@intel.com>
References: <20221001200039.21049-3-doug@schmorgal.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="qetlXuc1CC+j7rVA"
...
[also build test WARNING on robh/for-next linus/master v6.0-rc7 next-20220930]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Doug-Brown/ASoC-add-devicetree-support-for-WM8961-codec/20221002-040322
base:   https://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound.git for-next
config: x86_64-allyesconfig
compiler: gcc-11 (Debian 11.3.0-5) 11.3.0
reproduce (this is a W=1 build):
        # https://github.com/intel-lab-lkp/linux/commit/d216c50500d7cdd8df4ed7ee57b8fc9d8acf1ada
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Doug-Brown/ASoC-add-devicetree-support-for-WM8961-codec/20221002-040322
        git checkout d216c50500d7cdd8df4ed7ee57b8fc9d8acf1ada
...
vim +/wm8961_of_match +974 sound/soc/codecs/wm8961.c
