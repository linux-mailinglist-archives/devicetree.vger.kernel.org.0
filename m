...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 202382C0493
	for <lists+devicetree@lfdr.de>; Mon, 23 Nov 2020 12:32:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728650AbgKWLcD (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 23 Nov 2020 06:32:03 -0500
Received: from relay1.mymailcheap.com ([144.217.248.100]:56180 "EHLO
        relay1.mymailcheap.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728484AbgKWLcC (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 23 Nov 2020 06:32:02 -0500
Received: from filter2.mymailcheap.com (filter2.mymailcheap.com [91.134.140.82])
        by relay1.mymailcheap.com (Postfix) with ESMTPS id 88CE13F1C5;
        Mon, 23 Nov 2020 11:31:59 +0000 (UTC)
Received: from localhost (localhost [127.0.0.1])
        by filter2.mymailcheap.com (Postfix) with ESMTP id CF8702A510;
        Mon, 23 Nov 2020 12:31:58 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=mymailcheap.com;
        s=default; t=1606131118;
        bh=z2fP8/PSzCbXQO+A7KEq/k6IkIhE9a9AlAXvgrcy00s=;
        h=Date:In-Reply-To:References:Subject:To:CC:From:From;
        b=B6vhuMdWdP9wsSZgmlRQevk04PMtfJ+0OcNiqbivXmtNUCVrU3/w1jxI2RaSHAOoh
         z16KsiFeUC2tjayKf9NhULxUWkcDFznnnX6TVTBeNNblFFK2W5As2la/uAxyLA8o0u
         hrQ3uMygN6Fa8ywwIBJM31NjlozjMrEqoSDC2Xzg=
X-Virus-Scanned: Debian amavisd-new at filter2.mymailcheap.com
Received: from filter2.mymailcheap.com ([127.0.0.1])
        by localhost (filter2.mymailcheap.com [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id qH8IYop_XnE2; Mon, 23 Nov 2020 12:31:57 +0100 (CET)
Received: from mail20.mymailcheap.com (mail20.mymailcheap.com [51.83.111.147])
        (using TLSv1.2 with cipher ADH-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by filter2.mymailcheap.com (Postfix) with ESMTPS;
        Mon, 23 Nov 2020 12:31:57 +0100 (CET)
Received: from [148.251.23.173] (ml.mymailcheap.com [148.251.23.173])
        by mail20.mymailcheap.com (Postfix) with ESMTP id 98EC341A21;
        Mon, 23 Nov 2020 11:31:56 +0000 (UTC)
Authentication-Results: mail20.mymailcheap.com;
        dkim=pass (1024-bit key; unprotected) header.d=aosc.io header.i=@aosc.io header.b="lyMExo4b";
        dkim-atps=neutral
...
Received: from [172.19.0.1] (unknown [64.225.114.122])
        ...
        (No client certificate requested)
        by mail20.mymailcheap.com (Postfix) with ESMTPSA id E2CE941AB7;
        Mon, 23 Nov 2020 11:31:43 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=aosc.io; s=default;
        t=1606131105; bh=z2fP8/PSzCbXQO+A7KEq/k6IkIhE9a9AlAXvgrcy00s=;
        h=Date:In-Reply-To:References:Subject:To:CC:From:From;
        b=lyMExo4boAj3+Han0w1w36pOh5BCTQ6Ic8ka+eWCL2YpfVX1taurn/y2tS24yu19+
         5aJ34mN7FR75YAXhumOkVg/6Q/5WRGc23sHK49RpNhobwD5/9AknB9He2Suznv+02y
         P7GuDezxZ6e6gaXZKWlK20Xq/kzjhX+mWXD5jE9M=
Date:   Mon, 23 Nov 2020 19:25:47 +0800
User-Agent: K-9 Mail for Android
In-Reply-To: <20201123111512.y7lbwsipbkcpuleb@gilmour>
References: <20201107124958.2222253-1-icenowy@aosc.io> <20201107125332.2223197-1-icenowy@aosc.io> <20201110103925.rbej5ueo2fefbmlp@gilmour.lan> <6175E674-E8BC-4199-8BE8-A983065C32D5@aosc.io> <20201116155508.364dg6ycklwylswe@gilmour.lan> <8FFC1A6C-9CA4-4F94-91C4-F111A7519979@aosc.io> <20201120155939.3ajmbny2pka2vsnf@gilmour> <A8E91BA0-22FD-47F4-A5B2-A80A38FE9A0E@aosc.io> <38ee5feb-e35d-801f-99a1-65e23618e73b@sholland.org> <20201123111512.y7lbwsipbkcpuleb@gilmour>
MIME-Version: 1.0
...
Message-ID: <97E2037C-3C3C-4B0B-8462-39B9E38CB3BB@aosc.io>
X-Rspamd-Queue-Id: 98EC341A21
...
7:15:12, Maxime Ripard <maxime@cerno=2Etech> =E5=86=99=E5=88=B0:
>Hi!
>
...
>version-neutral
>> >>> but then transitioned to model B, then reverted to model A=2E Here
>the DT is always
>> >>> for the sample=2E
>> >>>
...
>any DT
>> >> submitted is for the current version of whatever board there is=2E
>This is
>>=20
>> I don't think that was the intention at all=2E The DT was submitted for
>a
...
>> out-of-the-box mainline Linux support=2E Because if there any hardware
...
>
>The first board that is shipped to a user=2E From the wiki, the version
>supported here (I guess?) has been shipped to around 100 people, so it
>doesn't really qualify for the "non-public prototype"=2E We still have to
...
>
>There's a few things that are interleaved here=2E First, there's two hard
...
>not
>finalized though, because this is also fairly bad for the users=2E Let's
...
>upstreamed=2E This means that any user that would use a kernel with that
>bugfix would have the display working, while rolling back to 5=2E9 would
...
>
>I mean, it's not black and white either=2E One could very well send the
>DT
