...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C03F763CDC7
	for <lists+devicetree@lfdr.de>; Wed, 30 Nov 2022 04:27:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231363AbiK3D1J (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 29 Nov 2022 22:27:09 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47684 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230117AbiK3D1H (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 29 Nov 2022 22:27:07 -0500
Received: from mga05.intel.com (mga05.intel.com [192.55.52.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 478DA71F14;
        Tue, 29 Nov 2022 19:27:04 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669778824; x=1701314824;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=Epxi+PyABjdO568PuQrqLIDspFYJgjuX7KkrkSoSlDk=;
  b=IM2zPVKS7K45fZwqBA5ZPUH2uYnuMnlByani/Z+TzZiiSqgSWAFuPh8f
   cVBOpu40z9ogU1CVlsDdEHEikRmp4ui5sJrbLvKZ4bRA0SWUGAhLn+Q3h
   2rWKQgX2CVZRgM1gkDRz5TqMBdMKUFgYP/bpdKF8/o5YhZKU6b8EMuULi
   Xw7DW2m1uwGkgzFTURQ4kogstQs44uqSBGoLWYD0Ma8eS4vsrgD1/UvT0
   nXjARi3Wvnhm6PfAcXnbso32GCthKyIZpLTjvN8QDe2H9gN8Fk5R1c2FT
   tqJUtmSE7qnSg6Dqnl38RLqRVOXilwsyJ7XIZjhv8TGZuq8lcTWS0NFkI
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10546"; a="401575637"
X-IronPort-AV: E=Sophos;i="5.96,205,1665471600"; 
   d="scan'208";a="401575637"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga105.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Nov 2022 19:27:02 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10546"; a="818472523"
X-IronPort-AV: E=Sophos;i="5.96,205,1665471600"; 
   d="scan'208";a="818472523"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by orsmga005.jf.intel.com with ESMTP; 29 Nov 2022 19:26:57 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p0DkO-0009Sl-1I;
        Wed, 30 Nov 2022 03:26:56 +0000
Date:   Wed, 30 Nov 2022 11:26:15 +0800
...
Subject: Re: [PATCH v3 10/10] arm64: dts: qcom: Add base SM8550 MTP dts
Message-ID: <202211301118.iogZ8qzM-lkp@intel.com>
References: <20221126114617.497677-11-abel.vesa@linaro.org>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Sic9HO01Th5FQee+"
Content-Disposition: inline
In-Reply-To: <20221126114617.497677-11-abel.vesa@linaro.org>
...
[cannot apply to robh/for-next v6.1-rc6 v6.1-rc5 v6.1-rc4 linus/master v6.1-rc7]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Abel-Vesa/arm64-dts-Add-base-device-tree-files-for-SM8550/20221126-194944
patch link:    https://lore.kernel.org/r/20221126114617.497677-11-abel.vesa%40linaro.org
patch subject: [PATCH v3 10/10] arm64: dts: qcom: Add base SM8550 MTP dts
config: arm64-allyesconfig
compiler: aarch64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/20b8bf71957f9b4d03c825e90766298834524cf6
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Abel-Vesa/arm64-dts-Add-base-device-tree-files-for-SM8550/20221126-194944
        git checkout 20b8bf71957f9b4d03c825e90766298834524cf6
...
>> arch/arm64/boot/dts/qcom/sm8550.dtsi:7:10: fatal error: dt-bindings/clock/qcom,sm8550-gcc.h: No such file or directory
       7 | #include <dt-bindings/clock/qcom,sm8550-gcc.h>
         |          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   compilation terminated.


vim +7 arch/arm64/boot/dts/qcom/sm8550.dtsi

317d11abf45e83 Abel Vesa 2022-11-26  @7  #include <dt-bindings/clock/qcom,sm8550-gcc.h>
317d11abf45e83 Abel Vesa 2022-11-26   8  #include <dt-bindings/clock/qcom,sm8550-tcsrcc.h>
317d11abf45e83 Abel Vesa 2022-11-26   9  #include <dt-bindings/dma/qcom-gpi.h>
317d11abf45e83 Abel Vesa 2022-11-26  10  #include <dt-bindings/gpio/gpio.h>
317d11abf45e83 Abel Vesa 2022-11-26  11  #include <dt-bindings/interconnect/qcom,sm8550.h>
317d11abf45e83 Abel Vesa 2022-11-26  12  #include <dt-bindings/interrupt-controller/arm-gic.h>
317d11abf45e83 Abel Vesa 2022-11-26  13  #include <dt-bindings/mailbox/qcom-ipcc.h>
317d11abf45e83 Abel Vesa 2022-11-26  14  #include <dt-bindings/power/qcom-rpmpd.h>
317d11abf45e83 Abel Vesa 2022-11-26  15  #include <dt-bindings/soc/qcom,rpmh-rsc.h>
317d11abf45e83 Abel Vesa 2022-11-26  16  #include <dt-bindings/thermal/thermal.h>
317d11abf45e83 Abel Vesa 2022-11-26  17  
