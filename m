...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 64F8A43E64F
	for <lists+devicetree@lfdr.de>; Thu, 28 Oct 2021 18:41:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230375AbhJ1QoL (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 28 Oct 2021 12:44:11 -0400
Received: from esa.microchip.iphmx.com ([68.232.153.233]:16438 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229846AbhJ1QoK (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 28 Oct 2021 12:44:10 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1635439303; x=1666975303;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=kiFnXTPKHIUjBHNwuuY3RGL9wavjxqSUKSsK4OsSr7c=;
  b=SkZE+qss8CBzm8XXQz95Uhy1OAVs4vTLuVssKvXkUQn5eQ6fTOBpXmfI
   gvZXCmcTy+15sH6tZjjjjyFii3pmwpaAOxiIw6RmG6QbmD9WuHBr4uOM8
   g0VgxsXZDb4C0gRor6EIsZSi+f9MmvLENNgrFBIbOjQBgvouAW3sZ06kf
   C1YEGgU/Q40sA6VVatp8DkDE59Y1rKEHN+khQ2S88DzxGZj80Ss6pjpg3
   lc0d3TftU9fGEBLfZMsotjBnKfZc+Xz9UTUGN6bYnm45l65ysNMgI6opm
   VGm7U0ebJrf5FIUBlDpBn1O0NR3wY29O7+R6wsIeOhvLjaKToAeBeve/y
   Q==;
IronPort-SDR: 
 WQDhIGGXTpkMvOfjSFEBuPPU
X-IronPort-AV: E=Sophos;i="5.87,190,1631602800"; 
   d="scan'208";a="142031789"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa3.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 28 Oct 2021 09:41:42 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex03.mchp-main.com (10.10.85.151) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.14; Thu, 28 Oct 2021 09:41:42 -0700
Received: from CHE-LT-I21427LX.microchip.com (10.10.115.15) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server id
 15.1.2176.14 via Frontend Transport; Thu, 28 Oct 2021 09:41:35 -0700
...
Subject: [PATCH v5 net-next 03/10] net: phy: Add support for LAN937x T1 phy driver
Date:   Thu, 28 Oct 2021 22:11:04 +0530
Message-ID: <20211028164111.521039-4-prasanna.vengateshan@microchip.com>
...
---
 ...
 1 file changed, 270 insertions(+), 80 deletions(-)

diff --git a/drivers/net/phy/microchip_t1.c b/drivers/net/phy/microchip_t1.c
index 4dc00bd5a8d2..891f71024763 100644
...
+
 	...
 	if (rc < 0)
 		return rc;
@@ -86,89 +161,166 @@ static int access_ereg(struct phy_device *phydev, u8 mode, u8 bank,
 	return rc;
 }
...
@@ -223,32 +375,70 @@ static int lan87xx_config_init(struct phy_device *phydev)
 {
