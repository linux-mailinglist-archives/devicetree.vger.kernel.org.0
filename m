...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8AB486D6802
	for <lists+devicetree@lfdr.de>; Tue,  4 Apr 2023 17:55:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235312AbjDDPzr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 4 Apr 2023 11:55:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55046 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235776AbjDDPzf (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 4 Apr 2023 11:55:35 -0400
Received: from mx.sberdevices.ru (mx.sberdevices.ru [45.89.227.171])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F2EE55275;
        Tue,  4 Apr 2023 08:55:11 -0700 (PDT)
Received: from s-lin-edge02.sberdevices.ru (localhost [127.0.0.1])
        by mx.sberdevices.ru (Postfix) with ESMTP id EE71B5FD38;
        Tue,  4 Apr 2023 18:53:48 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=sberdevices.ru;
        s=mail; t=1680623629;
        bh=2tUv89393YdNL/S2QaVyiEYKa/leStnVLf8COK65e1I=;
        h=From:To:Subject:Date:Message-ID:MIME-Version:Content-Type;
        b=
...
Subject: [PATCH v12 6/6] clk: meson: a1: add Amlogic A1 Peripherals clock controller driver
Date:   Tue, 4 Apr 2023 18:53:32 +0300
Message-ID: <20230404155332.9571-7-ddrokosov@sberdevices.ru>
...
---
 ...
 4 files changed, 2402 insertions(+)
...
index 000000000000..4caf07ce92cd
--- /dev/null
...
new file mode 100644
index 000000000000..89d592249ee6
--- /dev/null
...
+ */
+#define CLKID_XTAL_IN		100
+#define CLKID_DSPA_SEL		101
+#define CLKID_DSPB_SEL		102
+#define CLKID_SARADC_SEL	103
+#define CLKID_SYS_A_SEL		104
+#define CLKID_SYS_A_DIV		105
+#define CLKID_SYS_A		106
+#define CLKID_SYS_B_SEL		107
+#define CLKID_SYS_B_DIV		108
+#define CLKID_SYS_B		109
+#define CLKID_DSPA_A_DIV	110
+#define CLKID_DSPA_A		111
+#define CLKID_DSPA_B_DIV	112
+#define CLKID_DSPA_B		113
+#define CLKID_DSPB_A_DIV	114
+#define CLKID_DSPB_A		115
+#define CLKID_DSPB_B_DIV	116
+#define CLKID_DSPB_B		117
+#define CLKID_RTC_32K_IN	118
+#define CLKID_RTC_32K_DIV	119
+#define CLKID_RTC_32K_XTAL	120
+#define CLKID_RTC_32K_SEL	121
+#define CLKID_CECB_32K_IN	122
+#define CLKID_CECB_32K_DIV	123
+#define CLKID_CECA_32K_IN	124
+#define CLKID_CECA_32K_DIV	125
+#define CLKID_DIV2_PRE		126
+#define CLKID_24M_DIV2		127
+#define CLKID_GEN_DIV		128
+#define CLKID_SARADC_DIV	129
+#define CLKID_PWM_A_DIV		130
+#define CLKID_PWM_B_DIV		131
+#define CLKID_PWM_C_DIV		132
+#define CLKID_PWM_D_DIV		133
+#define CLKID_PWM_E_DIV		134
