...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3D7DE17AD33
	for <lists+devicetree@lfdr.de>; Thu,  5 Mar 2020 18:27:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726259AbgCER0k (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 5 Mar 2020 12:26:40 -0500
Received: from mail27.static.mailgun.info ([104.130.122.27]:10576 "EHLO
        mail27.static.mailgun.info" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726413AbgCER0j (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 5 Mar 2020 12:26:39 -0500
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1583429188; h=In-Reply-To: Content-Type: MIME-Version:
 References: Message-ID: Subject: Cc: To: From: Date: Sender;
 bh=VfckQqb2sYG33t4X66kKRjPffog+SjHLtMB1lmyLF6k=; b=fOzC0GiDc+erclm50E11DuU+ZR9FonL98plflcmRyaJyTSdgpqhrag+/2xKZwUTs6WFapVb0
 NcLnARZyTIef+yo8JT+aQH7JOOHP9xP33QD2AgH2oH8JtTg0C50x9dQ/nDe55k3JZJ2pCoQJ
 mOSoY+/T3W0au+Cx7j9deZkvn3M=
X-Mailgun-Sending-Ip: 104.130.122.27
X-Mailgun-Sid: WyI1YmJiNiIsICJkZXZpY2V0cmVlQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171])
 by mxa.mailgun.org with ESMTP id 5e613644.7fc39d4f8880-smtp-out-n03;
 Thu, 05 Mar 2020 17:26:28 -0000 (UTC)
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 8555EC4479D; Thu,  5 Mar 2020 17:26:27 +0000 (UTC)
...
Received: from jcrouse1-lnx.qualcomm.com (i-global254.qualcomm.com [199.106.103.254])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id 931CCC433A2;
        Thu,  5 Mar 2020 17:26:04 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org 931CCC433A2
Authentication-Results: aws-us-west-2-caf-mail-1.web.codeaurora.org; dmarc=none (p=none dis=none) header.from=codeaurora.org
Authentication-Results: aws-us-west-2-caf-mail-1.web.codeaurora.org; spf=none smtp.mailfrom=jcrouse@codeaurora.org
Date:   Thu, 5 Mar 2020 10:26:02 -0700
...
Cc:     freedreno@lists.freedesktop.org, linux-arm-msm@vger.kernel.org,
        ...
        dri-devel@lists.freedesktop.org, jsanka@codeaurora.org,
        aravindh@codeaurora.org, Chandan Uddaraju <chandanu@codeaurora.org>
Subject: Re: [Freedreno] [DPU PATCH v4 3/5] drm/msm/dp: add displayPort
 driver support
Message-ID: <20200305172601.GA4625@jcrouse1-lnx.qualcomm.com>
Mail-Followup-To: Vara Reddy <varar@codeaurora.org>,
...
References: <1583367028-19979-1-git-send-email-varar@codeaurora.org>
 <1583367028-19979-4-git-send-email-varar@codeaurora.org>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <1583367028-19979-4-git-send-email-varar@codeaurora.org>
...
On Wed, Mar 04, 2020 at 04:10:26PM -0800, Vara Reddy wrote:
...
>    function pointers.
> -- Added separate change that adds standard value in drm_dp_helper file.
...
>  drivers/gpu/drm/msm/dp/dp_display.c                |  974 +++++++++++
...
>  drivers/gpu/drm/msm/dp/dp_parser.h                 |  224 +++
...
>  27 files changed, 8836 insertions(+), 3 deletions(-)
...
default n is assumed if there is no default specified.
...
> index f8ac3bf..b063243 100644
> --- a/drivers/gpu/drm/msm/disp/dpu1/dpu_encoder.c
> +++ b/drivers/gpu/drm/msm/disp/dpu1/dpu_encoder.c
> @@ -978,6 +978,9 @@ static void dpu_encoder_virt_mode_set(struct drm_encoder *drm_enc,
>  
...
>  			conn = conn_iter;
> @@ -1141,6 +1144,7 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
>  {
...
>  
>  	if (!drm_enc) {
> @@ -1151,6 +1155,7 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
>  
...
>  			     cur_mode->vdisplay);
> @@ -1171,6 +1176,15 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
>  
...
>  
>  out:
> @@ -1201,6 +1215,12 @@ static void dpu_encoder_virt_disable(struct drm_encoder *drm_enc)
>  	priv = drm_enc->dev->dev_private;
...
There is only one pr_ log in this file, and I think it might be a mistake (see
below).  If so, yo you drop this.
...
This should be static const char * const dp_aux_get_error
...
This is a really fancy way of saying

	return "DP_AUX_ERR_NONE";

You can use the macro if you want, but it just introduces an extra layer of
sugar that isn't pleasing to the eye. 

Also, my personal preference is to use if/else instead of a switch statement for
these sorts of things, but it all ends up the same to the compiler.
...
I do not find const variables useful, especially when they are lower case. I
would suggest either using a #define or just use the constant directly - it
looks like this is only used in one place anyway and the comment specifically
states that you want to restrict it to 128 bytes.
...
I feel like this could be a more descriptive error, especially since you are
purposely limiting the size.
...
You don't need to initialize ret or len.

> +	int const aux_timeout_ms = HZ/4;

No need for const. Especially for things like timeouts using an actual function
call is a saver because you don't need to grep around to figure out what timeout
you expect.
...
You can set data = 0 or you can set
...
You use DRM errors why nearly everywhere, why switch back?
...
Same concern about const - this would be readable if you just used the
constants.
...
Data does not need to be initialized.  In fact, data doesn't need to exist if
you are just reading the first byte of input_msg->buffer.
...
Per the DRM standards, you don't need to use formal kerneldoc comments for
static functions, but its up to Rob to decide how he feels about these.
...
As throughout, const variables are more of a hindrance than a help.
...
Specifically this is a invalid sized message.  I think it would make more sense
to print the size and the expected size than to print msg->request and force the
developer to do the translation in their head.
...
This looks like it could be rewritten as:

if (ret < 0) {
	if (aux->native) {
		aux->retry_cnt++;
		if (!(aux->retry_cnt % retry_count))
			dp_catalog_aux_update_cfg(...);
		dp_catalog_aux_reset(aux->catalog);
	}
...
You do not need to initialize 'i' here.
...
If seems if you get to this point, you don't care if dp_aux is NULL or not.
Might not be worth a message.
...
You do not need to initialize 'ret'.
...
return ret; and then you can drop the goto.
...
This definitely doesn't seem worth logging.
...
And then you can get rid of the label and the error return.  And 'rc'.
...
I will have to check where this is called from to be sure but if this is a
probed device the resource will be collected for you, so you do not need to
free it.

> +}
> diff --git a/drivers/gpu/drm/msm/dp/dp_aux.h b/drivers/gpu/drm/msm/dp/dp_aux.h
> new file mode 100644
> index 0000000..ca22b5c
> --- /dev/null
...
I have an extremely dim view of enums especially enums that go the wrong
direction.  If you are doing to define each member of the enum then for my money
a #define is a better choice.
...
Not sure how Rob feels, but I think some documentation here would be useful.

> +
> +#endif /*__DP_AUX_H_*/
> diff --git a/drivers/gpu/drm/msm/dp/dp_catalog.c b/drivers/gpu/drm/msm/dp/dp_catalog.c
> new file mode 100644
> index 0000000..bd1debd
> --- /dev/null
...
Personally I don't like tagging functions in a C file with inline, I prefer to
...
It is hard to tell in an email review, but these are a lot of helper functions
for what is essentially a one line operation. You would never save enough lines
to make a helper function pay off since you will always be trading one line in
the code for a full function.  I would suggest going through and determining
these helper functions are really worth it.
...
rc is not needed.  Just return 0.
...
By this point a helper function function to get the catalog private
struct would have saved you lines.
...
This looks DIV_ROUND_UP. But more fundamentally, if len isn't a multiple of 16
should you be printing extra registers at the end?
...
There feels like a ton of code repetition here, especially since most of the
read helper functions can be broken down into single lines.  I feel like this
whole function could be greatly compressed - say for example:
...
void dump_regs(void * __iomem *base, int len)
{
	...
	pr_info(%08x: %08x %08x %08x %08x, base, x0, x4, x7, xc);
	base += 16;
   }
}

And then as an example the last block would turn into:

dump_regs(catalog->pcatalog->io->phy_io.base, catalog->io->phy_io.len);
...
You use DRM_DEBUG_DP a lot - you probably don't want to mix debugging methods.
...
You shouldn't use readx_poll_timeout directly - use readl_poll_timeout instead.
...
Base again appeasr to be unused.
...
You can just return &catalog->dp_catalog and save the temporary variable.
...
goto, label and rc are not needed.
...
You likely do not need to call devm_kfree() and in fact, you probably don't need
this function at all.

> +}
> diff --git a/drivers/gpu/drm/msm/dp/dp_catalog.h b/drivers/gpu/drm/msm/dp/dp_catalog.h
> new file mode 100644
> index 0000000..c453586d
> --- /dev/null
...
You don't need to formally document static funcs.
...
This seems like it could be broken down to:

if (ctrl->lin->link_params.rate == 810000)
   ctrl->link->link_params.rate = 540000;
else if (ctrl->link->link_params.rate == 540000)
   ctrl->link->link_params.rate = 270000;
else
   ctrl->link->link_params.rate = 162000;
...
This function doesn't look like it needs to return a value.
...
Is this the success path?  If so, replacing this with return 0 might be a bit
less confusing.
...
The actual error here seems to be that clock 'name' doesn't exist, not that you
...
tried < 10 is clearer here rather than using a temporary variable.
...
You don't need the goto, or the label or 'rc'
> +}
> +
...
You almost never need to call devm_kfree

> +}
> diff --git a/drivers/gpu/drm/msm/dp/dp_ctrl.h b/drivers/gpu/drm/msm/dp/dp_ctrl.h
> new file mode 100644
> index 0000000..63681e82
> --- /dev/null
...
I don't think I saw pr_ being used in this file.  You can remove this.
...
This isn't possible - assume the priv is valid on an interrupt handler callback.
...
None of these will be NULL on a component bind.
...
Neither of these will be NULL. You don't need to check these.
...
Neither of the two if statements above will ever be false;

> +	(void)dp_power_client_deinit(dp->power);
> +	(void)dp_aux_unregister(dp->aux);

Aren't these private functions?  If you specifically do not want them to return
a error code, then you should make them void rather than casting them at call
time.
...
This doesn't seem like it is possible.
...
and this seems very unlikely that if you have a valid device that it wouldn't
have drvdata set up.
...
As above - these checks to not seem useful.
...
yo udon not need rc - just return 0;
...
but you don't actually return a error.
> +
> +	dp_ctrl_off(dp->ctrl);
> +
> +	dp->power_on = false;
...
rc is unused - you can return 0 here.
...
This could all be return (dp_display->panel->video_test);
...
You do not need to call devm_kfree out of a probe function.
...
You do not need to call devm_kfree in a release function
...
It would be helpful to say which driver register failed.

> +		return ret;

You don't need this - you can drop out and return ret at the bottom of the
function.
...
This could be WARN_ON(!encoder || !dp_display || !dev)
...
pr_ does not appear to be used in this file.
...
I believe we prefer these to be functions for typechecking purposes.
...
Curious - why do you need to allocate dp_mode on the heap.  Is it huge?
...
Did you forget to kfree dp_mode here?
...
This is a callback - it doesn't seem likely you'll be called with NULL variables
here.
...
And then it doesn't appear like you need rc anymore.
...
return &dp_hdp->dp_usbpd and you don't need dp_usbpd;
...
You almost never need to call devm_kfree and as a result, it appears this
function doesn't have much value.

> +}
> diff --git a/drivers/gpu/drm/msm/dp/dp_hpd.h b/drivers/gpu/drm/msm/dp/dp_hpd.h
> new file mode 100644
> index 0000000..08ae8aa
> --- /dev/null
...
You don't need t formally document static functions
...
I'm not sure what the whole struct looks like but maybe a memset() would be more
useful here?
...
Since you probably don't need to call devm_kfree here, this whole function isn't
needed.

> +}
> diff --git a/drivers/gpu/drm/msm/dp/dp_link.h b/drivers/gpu/drm/msm/dp/dp_link.h
> new file mode 100644
> index 0000000..7d7866d
> --- /dev/null
...
I didn't see any uses of pr_ in this file
...
You do not need to call devm_kfree here nor do you need to set dp_panel_edid =
NULL since that memory will soon disappear.

> +}
> diff --git a/drivers/gpu/drm/msm/dp/dp_panel.h b/drivers/gpu/drm/msm/dp/dp_panel.h
> new file mode 100644
> index 0000000..85e61a8
> --- /dev/null
...
It looks like none of the callers are calling this function with a NULL for
io_data so this isn't needed.
...
Why not devm - is this function ever called for regions that don't exist for the
entire device lifespan?
...
This error message isn't useful - you don't care if they give you a NULL
function for a unmap function and it looks like none of the callers ever will.
...
msm_dss_ioremap_byname returns an error message on each failure path so you do
not need an addtional one here (and throughout this function).
...
of_property_read_u32 does not modify the value of the pointer on error, so you
can safely do this:
...
devm_pinctrl_get never returns NULL so you just use IS_ERR()

> +		DRM_ERROR("failed to get pinctrl, rc=%d\n",

ERR_PTR always returns an unsigned long so this should be rc=%ld

> +					PTR_ERR_OR_ZERO(pinctrl->pin));

And here you can use ERR_PTR()
...
Same as above - this only returns IS_ERR() on error
...
This is very unlikely since you already queried the number of clock names.
...
This looks like it should be devm_kcalloc()
...
Doesn't seem like you even need to bother defining this.

> diff --git a/drivers/gpu/drm/msm/dp/dp_parser.h b/drivers/gpu/drm/msm/dp/dp_parser.h
> new file mode 100644
> index 0000000..1dc592f
> --- /dev/null
...
The other functions use DRM_ERROR instead
...
Not a useful log message on a de-init path
...
devm_kfree is not needed here and the rest of the function likely isn't either.

> +}
> diff --git a/drivers/gpu/drm/msm/dp/dp_power.h b/drivers/gpu/drm/msm/dp/dp_power.h
> new file mode 100644
> index 0000000..52b6194
> --- /dev/null
...
> index f50fefb..4b8bd2b 100644
> --- a/drivers/gpu/drm/msm/msm_drv.c
> +++ b/drivers/gpu/drm/msm/msm_drv.c
> @@ -1344,6 +1344,7 @@ static int __init msm_drm_register(void)
>  	msm_dsi_register();
>  	msm_edp_register();
>  	msm_hdmi_register();
> +	msm_dp_register();
...
>  }
> @@ -1352,6 +1353,7 @@ static void __exit msm_drm_unregister(void)
>  {
>  	DBG("fini");
...
> @@ -375,6 +377,49 @@ static inline int msm_dsi_modeset_init(struct msm_dsi *msm_dsi,
>  }
>  #endif
>  
...
> @@ -395,8 +440,9 @@ void msm_rd_dump_submit(struct msm_rd_state *rd, struct msm_gem_submit *submit,
>  #else
...
>  #endif
> @@ -414,7 +460,8 @@ void __iomem *msm_ioremap(struct platform_device *pdev, const char *name,
