...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0BD9A5289AF
	for <lists+devicetree@lfdr.de>; Mon, 16 May 2022 18:09:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S245695AbiEPQIm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 16 May 2022 12:08:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33958 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S245713AbiEPQIY (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 16 May 2022 12:08:24 -0400
Received: from ams.source.kernel.org (ams.source.kernel.org [IPv6:2604:1380:4601:e00::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 28DEB37BED;
        Mon, 16 May 2022 09:08:18 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by ams.source.kernel.org (Postfix) with ESMTPS id 9EBE3B8125A;
        Mon, 16 May 2022 16:08:16 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 94B7AC34115;
        Mon, 16 May 2022 16:08:12 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1652717295;
        bh=iMrlZwNouCsE2/lev2Gal4DO5Wl2oRqF5YpiHwwXe6A=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v2 net-next 11/15] net: ethernet: mtk_eth_soc: introduce device register map
Date:   Mon, 16 May 2022 18:06:38 +0200
Message-Id: <78e8c6ed230130b75aae77e6d05a9b35e298860a.1652716741.git.lorenzo@kernel.org>
...
index 1e2fddc2bdcb..4dfd43023d80 100644
...
index 150d692633fa..2b98f0812655 100644
...
@@ -857,6 +903,7 @@ struct mtk_tx_dma_desc_info {
...
@@ -869,6 +916,7 @@ struct mtk_tx_dma_desc_info {
