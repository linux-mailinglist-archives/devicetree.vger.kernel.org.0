...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 65CCC75DAB2
	for <lists+devicetree@lfdr.de>; Sat, 22 Jul 2023 09:42:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230375AbjGVHmv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 22 Jul 2023 03:42:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56172 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229546AbjGVHmt (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 22 Jul 2023 03:42:49 -0400
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3509B270F;
        Sat, 22 Jul 2023 00:42:44 -0700 (PDT)
X-UUID: 558da4ac286311ee9cb5633481061a41-20230722
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=XUMYgWyyElLvBuSJqm6ErjnOFxG8Ecka5aAbAEyBM+0=;
        b=kLurJ4UG3F5oPGpnEC5oqcvgp4w4lfB6m85DV/4EYFzUzMQbTYbOnvqg6JXrikDiQGQ/3acZvXnAaUMI7Do35TbqyMe13pnIxTdi7jt/USt4BihsQZrYDzXERYNz5J9LtnGPLenIYBoL0JtWQtaXFY1xoZAcM5mFfQLeFB5GkcI=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.28,REQID:ad5585df-2b53-4013-b060-b2e3f0788a43,IP:0,U
        RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Release_Ham,ACTI
        ON:release,TS:70
X-CID-INFO: VERSION:1.1.28,REQID:ad5585df-2b53-4013-b060-b2e3f0788a43,IP:0,URL
        :0,TC:0,Content:-25,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Spam_GS981B3D,ACTI
        ON:quarantine,TS:70
X-CID-META: VersionHash:176cd25,CLOUDID:4a03f48e-7caa-48c2-8dbb-206f0389473c,B
        ulkID:230722154240QZONK5TK,BulkQuantity:0,Recheck:0,SF:48|38|29|28|17|19,T
...
Received: from mtkmbs10n1.mediatek.inc [(172.21.101.34)] by mailgw01.mediatek.com
        ...
        with ESMTP id 93996371; Sat, 22 Jul 2023 15:42:39 +0800
Received: from mtkmbs13n1.mediatek.inc (172.21.101.193) by
 MTKMBS14N1.mediatek.inc (172.21.101.75) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26; Sat, 22 Jul 2023 15:42:38 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkmbs13n1.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.2.1118.26 via Frontend Transport; Sat, 22 Jul 2023 15:42:37 +0800
...
Subject: [PATCH v7,06/11] media: mediatek: vcodec: replace pr_* with dev_* for v4l2 debug message
Date:   Sat, 22 Jul 2023 15:42:25 +0800
Message-ID: <20230722074230.30558-7-yunfei.dong@mediatek.com>
...
index 1a293331ba2d..69f0a57650fb 100644
...
@@ -136,7 +134,7 @@ static int mtk_vcodec_get_reg_bases(struct mtk_vcodec_dev *dev)
...
+			dev_dbg(&pdev->dev, "reg[%d] base=%p", i, dev->reg_base[i]);
 		...
 		for (i = 0; i < reg_num; i++) {
@@ -144,7 +142,7 @@ static int mtk_vcodec_get_reg_bases(struct mtk_vcodec_dev *dev)
...
@@ -212,7 +210,7 @@ static int fops_vcodec_open(struct file *file)
...
@@ -232,15 +230,14 @@ static int fops_vcodec_open(struct file *file)
...
+		mtk_v4l2_vdec_err(ctx, "Failed to v4l2_m2m_ctx_init() (%d)", ret);
 	...
 	src_vq = v4l2_m2m_get_vq(ctx->m2m_ctx,
@@ -258,14 +255,14 @@ static int fops_vcodec_open(struct file *file)
...
@@ -274,8 +271,7 @@ static int fops_vcodec_open(struct file *file)
...
@@ -297,7 +293,7 @@ static int fops_vcodec_release(struct file *file)
...
+	mtk_v4l2_vdec_dbg(0, ctx, "[%d] decoder", ctx->id);
 	...
 	/*
@@ -352,7 +348,7 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
 					 &rproc_phandle)) {
 		fw_type = SCP;
 	} else {
...
@@ -372,7 +368,7 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
@@ -388,13 +384,13 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
@@ -415,7 +411,7 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
@@ -424,7 +420,7 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
@@ -433,7 +429,7 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
@@ -446,7 +442,7 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
@@ -465,21 +461,21 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
index 41aa66c7295b..4a5b2eca1606 100644
...
index ab8c0adadc0b..346eae2a7ef6 100644
...
index 805f8afbd26a..cb222d9d5c17 100644
...
index 3e2d2c00a1bd..fe4aa2dede03 100644
...
index 1545848156c6..f4db3f9f135d 100644
...
index 963233028893..40dd43a4a2d8 100644
...
index 898f9dbb9f46..bb2573e859eb 100644
