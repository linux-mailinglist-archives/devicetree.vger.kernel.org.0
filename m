...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E0108431F16
	for <lists+devicetree@lfdr.de>; Mon, 18 Oct 2021 16:13:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233257AbhJROQC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 18 Oct 2021 10:16:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44234 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232849AbhJROP4 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 18 Oct 2021 10:15:56 -0400
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e3e3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 53162C07E5FB;
        Mon, 18 Oct 2021 06:49:45 -0700 (PDT)
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (Authenticated sender: kholk11)
        with ESMTPSA id C77011F4167F
...
References: <20211015123832.17914-1-moudy.ho@mediatek.com>
 <20211015123832.17914-8-moudy.ho@mediatek.com>
From:   AngeloGioacchino Del Regno 
        <angelogioacchino.delregno@collabora.com>
Message-ID: <df3ca43b-ea02-36f7-2d37-7240a1ba4f96@collabora.com>
Date:   Mon, 18 Oct 2021 15:49:39 +0200
...
> index 80321e03809a..b480d19832c7 100644
...
#define DISP_MUTEX_MOD_MDP_AAL	BIT(23)

...and then here:
			subfrm->mutex_mod |= DISP_MUTEX_MOD_MDP_AAL;

Also, by defining things like shown, everything is going to be pretty
much self-documenting, so the big comment above that's trying to document
the layout can be removed.

Please do the same for all other similar occurrences.
...
> new file mode 100644
> index 000000000000..837491ef2d0c
> --- /dev/null
...
BIT(MDP_COMP_RDMA0) | BIT(MDP_COMP_RSZ1)
...
Please remove leading zeros, here and everywhere else.
...
If this has to be an error print, then you want to use dev_err.
Apparently, you can use ctx->comp->comp_dev as a device pointer, but feel free to
use another one from struct mdp_dev instead, if applicable.
...
Please remove commented out ops, here and everywhere else.
...
BIT(27) and/or #define something
...
Is this print really necessary? In any case, if you really want to keep this
one here, then it should be dev_dbg().
...
This is another dev_dbg() (or remove the print).
...
83 columns is ok to have, don't break this line.
...
> new file mode 100644
> index 000000000000..b3aa169d16da
> --- /dev/null
...
This is probably another dev_dbg().
...
> new file mode 100644
> index 000000000000..664076294730
> --- /dev/null
...
This is describing an error condition, hence use dev_err().
...
> new file mode 100644
> index 000000000000..53cf8e406f7a
> --- /dev/null
...
This at least enhances human readability. Also, dev_info is wrong here.
...
This will print a lot of spam in the kmsg. Use dev_dbg() please.
...
I really think that this one, others before and others after are here only
for development related debugging, in which case.... dev_dbg() please.

I won't repeat that across the entire code, as that'd be useless.
...
Did you forget to add flags.. or what's happening here?

If this is something that you plan to add in a later commit, then you should
add a comment like /* TODO: handle sharpness and dither */ but you should
in no case leave commented out code like you did here, or developers/reviewers
will be confused.
...
> new file mode 100644
> index 000000000000..3483fe6afe4e
> --- /dev/null
...
Please use tabulations instead of spaces.
...
Also because here and everywhere else you're using tabulations.
...
> new file mode 100644
> index 000000000000..bbec056e4097
> --- /dev/null
