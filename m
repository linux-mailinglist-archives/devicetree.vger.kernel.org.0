...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B3EF12C8100
	for <lists+devicetree@lfdr.de>; Mon, 30 Nov 2020 10:29:56 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727621AbgK3J3v (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 30 Nov 2020 04:29:51 -0500
Received: from mga01.intel.com ([192.55.52.88]:8057 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726345AbgK3J3u (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Mon, 30 Nov 2020 04:29:50 -0500
IronPort-SDR: 4n9843JsWprRUY3CbuTofSsEng5LrvpzwIudFUxgrTpL3pQ7pa031q1Lvy6pseb/Gtv2gcsP2j
 JWjME02R1kwg==
X-IronPort-AV: E=McAfee;i="6000,8403,9820"; a="190786597"
X-IronPort-AV: E=Sophos;i="5.78,381,1599548400"; 
   d="scan'208";a="190786597"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga002.fm.intel.com ([10.253.24.26])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Nov 2020 01:28:07 -0800
IronPort-SDR: jQqiNANw8nN1PMT1ngFqxx+dsVozzUbEOC2cgFvcfr6wUJL97RMwwgCsfa/xVNEj+epxUziWU6
 PLLBQEfGBu4Q==
X-IronPort-AV: E=Sophos;i="5.78,381,1599548400"; 
   d="scan'208";a="367054438"
Received: from paasikivi.fi.intel.com ([10.237.72.42])
  by fmsmga002-auth.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Nov 2020 01:28:04 -0800
Received: by paasikivi.fi.intel.com (Postfix, from userid 1000)
        id 3D9F320884; Mon, 30 Nov 2020 11:28:02 +0200 (EET)
Date:   Mon, 30 Nov 2020 11:28:02 +0200
...
Subject: Re: [PATCH v4 2/2] media: i2c: Add support for the OV5648 image
 sensor
Message-ID: <20201130092802.GU3940@paasikivi.fi.intel.com>
...
> index 000000000000..43e0c2c3ccfa
> --- /dev/null
...
> +		return -EINVAL;
> +
> +	ret = ov5648_write(sensor, OV5648_ISP_CTRL3D_REG,
...
> +};
> +
> +static int __maybe_unused ov5648_suspend(struct device *dev)
> +{
...
> +}
> +
> +static int __maybe_unused ov5648_resume(struct device *dev)
> +{
> +	struct i2c_client *client = to_i2c_client(dev);
> +	struct v4l2_subdev *subdev = i2c_get_clientdata(client);
> +	struct ov5648_sensor *sensor = ov5648_subdev_sensor(subdev);
