...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 962D74C11CD
	for <lists+devicetree@lfdr.de>; Wed, 23 Feb 2022 12:47:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240353AbiBWLsT (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 23 Feb 2022 06:48:19 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50758 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239889AbiBWLrt (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 23 Feb 2022 06:47:49 -0500
Received: from mx0a-00128a01.pphosted.com (mx0a-00128a01.pphosted.com [148.163.135.77])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D9ADA12AC5;
        Wed, 23 Feb 2022 03:47:18 -0800 (PST)
Received: from pps.filterd (m0167088.ppops.net [127.0.0.1])
        by mx0a-00128a01.pphosted.com (8.16.1.2/8.16.1.2) with ESMTP id 21N8b8Aa031323;
        Wed, 23 Feb 2022 06:47:11 -0500
Received: from nwd2mta4.analog.com ([137.71.173.58])
        by mx0a-00128a01.pphosted.com (PPS) with ESMTPS id 3eckeq8a07-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 23 Feb 2022 06:47:10 -0500
Received: from ASHBMBX8.ad.analog.com (ASHBMBX8.ad.analog.com [10.64.17.5])
        by nwd2mta4.analog.com (8.14.7/8.14.7) with ESMTP id 21NBl9fS019824
        (version=TLSv1/SSLv3 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL);
        Wed, 23 Feb 2022 06:47:09 -0500
Received: from ASHBCASHYB5.ad.analog.com (10.64.17.133) by
 ASHBMBX8.ad.analog.com (10.64.17.5) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.14; Wed, 23 Feb 2022 06:47:08 -0500
...
Received: from zeus.spd.analog.com (10.66.68.11) by ashbmbx9.ad.analog.com
 ...
 Transport; Wed, 23 Feb 2022 06:47:08 -0500
Received: from localhost.localdomain ([10.48.65.12])
        by zeus.spd.analog.com (8.15.1/8.15.1) with ESMTP id 21NBkw2Z022328;
        Wed, 23 Feb 2022 06:47:04 -0500
From:   Cristian Pop <cristian.pop@analog.com>
To:     <linux-iio@vger.kernel.org>, <linux-kernel@vger.kernel.org>
CC:     <jic23@kernel.org>, <devicetree@vger.kernel.org>,
        <robh+dt@kernel.org>, Cristian Pop <cristian.pop@analog.com>
Subject: [PATCH v6 2/2] iio: frequency: admv4420.c: Add support for ADMV4420
Date:   Wed, 23 Feb 2022 13:57:36 +0200
Message-ID: <20220223115736.12485-2-cristian.pop@analog.com>
...
X-Proofpoint-GUID: KoewGdtWWXMHu1U24ItlOhJfsOjJ0Hp3
X-Proofpoint-ORIG-GUID: KoewGdtWWXMHu1U24ItlOhJfsOjJ0Hp3
...
---
Changes in v6:
 - Use macros 'ADMV4420_REFERENCE_MODE_MASK' and
   'ADMV4420_REFERENCE_DOUBLER_MASK' inline.
 - Use 'device_property_read_u32' instead of 'fwnode_property_read_u32'
 - Use 'device_property_read_bool' instead of 'fwnode_property_read_bool'
