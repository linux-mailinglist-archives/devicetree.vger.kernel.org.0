...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3BC551B2C32
	for <lists+devicetree@lfdr.de>; Tue, 21 Apr 2020 18:16:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728419AbgDUQPL (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 21 Apr 2020 12:15:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36722 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1728287AbgDUQPJ (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Tue, 21 Apr 2020 12:15:09 -0400
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e3e3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2A928C061A10;
        Tue, 21 Apr 2020 09:15:09 -0700 (PDT)
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (Authenticated sender: aratiu)
        with ESMTPSA id 43D0A2A18D8
...
Subject: [PATCH v7 3/8] drm: bridge: synopsis: add dsi v1.01 support
Date:   Tue, 21 Apr 2020 19:16:05 +0300
Message-Id: <20200421161610.1501827-4-adrian.ratiu@collabora.com>
...
+		regmap_field_write(dsi->field_phy_forcepll, 1);
 	...
 	ret = regmap_field_read_poll_timeout(dsi->field_phy_status,
 					     val, val & PHY_LOCK,
@@ -1133,6 +1243,9 @@ static int dw_mipi_dsi_regmap_fields_init(struct dw_mipi_dsi *dsi)
 	case HWVER_131:
