...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3D2DE29CD6
	for <lists+devicetree@lfdr.de>; Fri, 24 May 2019 19:24:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2391437AbfEXRYi (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 24 May 2019 13:24:38 -0400
Received: from mail-lj1-f193.google.com ([209.85.208.193]:43896 "EHLO
        mail-lj1-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2391239AbfEXRYd (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 24 May 2019 13:24:33 -0400
Received: by mail-lj1-f193.google.com with SMTP id z5so9320512lji.10;
        Fri, 24 May 2019 10:24:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=O/do2auy8iZbWJyeiLf7edf+iOabTggczXf+A3ZMzNw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=O/do2auy8iZbWJyeiLf7edf+iOabTggczXf+A3ZMzNw=;
        b=
X-Gm-Message-State: APjAAAXexfvH3Gn6TjjW73VmMuDiMIGP1yhhGAePvTZA06RTt6jisNxt
        4BpIk34iR7/kkycUDY518oQ=
X-Google-Smtp-Source: APXvYqwynEpgmbRAPKpzMKHVmOfG78CuU68gZ47JA2LtltzGHv71V3dTRbAwg/w7uQBZR3i37rSBuw==
X-Received: by 2002:a2e:98c1:: with SMTP id s1mr44403063ljj.68.1558718668405;
        Fri, 24 May 2019 10:24:28 -0700 (PDT)
Received: from localhost.localdomain ([94.29.35.141])
        by smtp.gmail.com with ESMTPSA id d13sm196957lfm.27.2019.05.24.10.24.26
...
Subject: [PATCH v3 7/8] memory: tegra: Introduce Tegra30 EMC driver
Date:   Fri, 24 May 2019 20:23:52 +0300
Message-Id: <20190524172353.29087-8-digetx@gmail.com>
...
index 163b6c69e651..94ac507f6f3b 100644
...
index 000000000000..88bc9800795e
--- /dev/null
...
+
+	val = ~(EMC_DBG_READ_MUX_ASSEMBLY | EMC_DBG_WRITE_MUX_ACTIVE);
+	writel_relaxed(emc_dbg & val, emc->regs + EMC_DBG);
+
