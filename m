...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 46E9D3D72C1
	for <lists+devicetree@lfdr.de>; Tue, 27 Jul 2021 12:12:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236310AbhG0KLv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 27 Jul 2021 06:11:51 -0400
Received: from mailgw01.mediatek.com ([60.244.123.138]:56988 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S236302AbhG0KLn (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 27 Jul 2021 06:11:43 -0400
X-UUID: 86b98e8f44464c8cb13f40e5646bae31-20210727
X-UUID: 86b98e8f44464c8cb13f40e5646bae31-20210727
Received: from mtkcas11.mediatek.inc [(172.21.101.40)] by mailgw01.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 533246856; Tue, 27 Jul 2021 18:11:38 +0800
Received: from mtkcas07.mediatek.inc (172.21.101.84) by
 mtkmbs07n1.mediatek.inc (172.21.101.16) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Tue, 27 Jul 2021 18:11:36 +0800
Received: from localhost.localdomain (10.17.3.153) by mtkcas07.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Tue, 27 Jul 2021 18:11:35 +0800
...
Subject: [PATCH v3, 08/15] media: mtk-vcodec: Add msg queue feature for lat and core architecture
Date:   Tue, 27 Jul 2021 18:10:44 +0800
Message-ID: <20210727101051.24418-9-yunfei.dong@mediatek.com>
...
---
v3: add document for structs and functions
---
...
index 91b678e2ac56..bf4f8515420d 100644
...
@@ -287,6 +289,8 @@ struct vdec_pic_info {
...
@@ -330,6 +334,7 @@ struct mtk_vcodec_ctx {
