...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A7C3A310989
	for <lists+devicetree@lfdr.de>; Fri,  5 Feb 2021 11:53:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231708AbhBEKvh (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 5 Feb 2021 05:51:37 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33302 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231704AbhBEKr4 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 5 Feb 2021 05:47:56 -0500
Received: from mail-wr1-x435.google.com (mail-wr1-x435.google.com [IPv6:2a00:1450:4864:20::435])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 20EE6C0611BD
        for <devicetree@vger.kernel.org>; Fri,  5 Feb 2021 02:45:03 -0800 (PST)
Received: by mail-wr1-x435.google.com with SMTP id v15so7145552wrx.4
        for <devicetree@vger.kernel.org>; Fri, 05 Feb 2021 02:45:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=tcPtKZqPSaCjZU9j6bKq4+7PDAya2PWZYN9IAnpfWr4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=tcPtKZqPSaCjZU9j6bKq4+7PDAya2PWZYN9IAnpfWr4=;
        b=
X-Gm-Message-State: AOAM530S+G2baHSP66rDgffJYln4rttLEKRcBtwPKKaL+AAwREkQOe2G
        99cqyoheI7aQXo8U/bkXMqjulg==
X-Google-Smtp-Source: ABdhPJzu5YLJ5gsmvcvxwFam/2zUarChcYP9U5zGmI9auoShKnaUdtP8f3ioDZCQQ+/mLmwDIOXNig==
X-Received: by 2002:adf:e48b:: with SMTP id i11mr4339567wrm.406.1612521901257;
        Fri, 05 Feb 2021 02:45:01 -0800 (PST)
Received: from localhost.localdomain ([2a02:2450:102f:d6a:38fd:e0db:ea01:afc8])
        by smtp.gmail.com with ESMTPSA id u4sm11300233wrr.37.2021.02.05.02.44.58
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 05 Feb 2021 02:44:59 -0800 (PST)
...
Subject: [PATCH v4 06/22] media: camss: Refactor VFE HW version support
Date:   Fri,  5 Feb 2021 11:43:58 +0100
Message-Id: <20210205104414.299732-7-robert.foss@linaro.org>
...
Changes since v3:
 ...
 .../media/platform/qcom/camss/camss-vfe-4-1.c |  116 +-
 .../media/platform/qcom/camss/camss-vfe-4-7.c |  237 ++--
 ...
 8 files changed, 2240 insertions(+), 1035 deletions(-)
...
index 85b9bcbc7321..f1f9dc543a0d 100644
...
@@ -975,46 +938,61 @@ static irqreturn_t vfe_isr(int irq, void *dev)
 	return IRQ_HANDLED;
 }
...
index f7e00a2de393..0c506a80efae 100644
...
@@ -1108,150 +1091,80 @@ static irqreturn_t vfe_isr(int irq, void *dev)
 	return IRQ_HANDLED;
 }
...
index 000000000000..50e2b0569007
--- /dev/null
...
index 94c9ca7d5cbb..75b4e866c01b 100644
