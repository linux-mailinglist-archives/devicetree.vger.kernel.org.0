...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1A2CB15409B
	for <lists+devicetree@lfdr.de>; Thu,  6 Feb 2020 09:45:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727738AbgBFIph (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 6 Feb 2020 03:45:37 -0500
Received: from mail-pl1-f193.google.com ([209.85.214.193]:42045 "EHLO
        mail-pl1-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727851AbgBFIph (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 6 Feb 2020 03:45:37 -0500
Received: by mail-pl1-f193.google.com with SMTP id e8so2056959plt.9;
        Thu, 06 Feb 2020 00:45:36 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=UWdyHtqZK8vfIndcfQvcNNS3B5v8ddPMxqJbmaARG9A=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=UWdyHtqZK8vfIndcfQvcNNS3B5v8ddPMxqJbmaARG9A=;
        b=
X-Gm-Message-State: APjAAAUJsSjiPhqC4UbmtSTA2vGGwK5PFv/ktDq5+CroAdN73cJ4fkMG
        RLf2XNlj6iQrNFQ/9HmwBhMOVqZSj7gt9g==
X-Google-Smtp-Source: APXvYqyLGrv6suKnY9/HY+/+1VhbWl0YrwZfFPcVn6PS1HZNnXo0X34lIbE2D7PLR6HFiZ/m2n9E8Q==
X-Received: by 2002:a17:90a:a88f:: with SMTP id h15mr3064157pjq.32.1580978735923;
        Thu, 06 Feb 2020 00:45:35 -0800 (PST)
Received: from localhost.localdomain ([240e:379:947:2855::fa3])
        by smtp.gmail.com with ESMTPSA id 6sm2638370pgh.0.2020.02.06.00.45.27
...
Subject: [PATCH resend 1/2] spi: add driver for ar934x spi controller
Date:   Thu,  6 Feb 2020 16:44:42 +0800
Message-Id: <20200206084443.209719-2-gch981213@gmail.com>
