...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 786FD6C5CD5
	for <lists+devicetree@lfdr.de>; Thu, 23 Mar 2023 03:52:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229806AbjCWCwo (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 22 Mar 2023 22:52:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42440 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229694AbjCWCwn (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 22 Mar 2023 22:52:43 -0400
Received: from loongson.cn (mail.loongson.cn [114.242.206.163])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 3A4DB2056D;
        Wed, 22 Mar 2023 19:52:39 -0700 (PDT)
Received: from loongson.cn (unknown [10.20.42.35])
        by gateway (Coremail) with SMTP id _____8BxMI_2vhtk4SwQAA--.24708S3;
        Thu, 23 Mar 2023 10:52:38 +0800 (CST)
Received: from user-pc.202.106.0.20 (unknown [10.20.42.35])
        by localhost.localdomain (Coremail) with SMTP id AQAAf8BxLL7uvhtkXhEKAA--.3341S3;
...
Subject: [PATCH v16 2/2] clk: clk-loongson2: add clock controller driver support
Date:   Thu, 23 Mar 2023 10:52:29 +0800
Message-Id: <20230323025229.2971-2-zhuyinbo@loongson.cn>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20230323025229.2971-1-zhuyinbo@loongson.cn>
References: <20230323025229.2971-1-zhuyinbo@loongson.cn>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-CM-TRANSID: AQAAf8BxLL7uvhtkXhEKAA--.3341S3
X-CM-SenderInfo: 52kx5xhqerqz5rrqw2lrqou0/
X-Coremail-Antispam: 1Uk129KBjvAXoW3ZFW7CrW7Cr43ZF1DZFyDGFg_yoW8XrWxuo
        WfuFnxJr4fJ348XFW0vw15tr47XFsIvFnIyw1fArn8CayY9r98JrW8A3W3GFn7ZFyrKFnx
        AFyfKayrJF4xXrZrn29KB7ZKAUJUUUU7529EdanIXcx71UUUUU7KY7ZEXasCq-sGcSsGvf
...
Change in v16:
		...
		2. Return an error instead of be void on loongson2_check_clk_hws.
		3. Replace clk_hw_register_divider with devm_clk_hw_register_divider.
		4. Return an error code when call devm_of_clk_add_hw_provider.
		5. Move the loongson2_clk_match_table above loongson2_clk_driver.
		6. Use IS_ERR to judge loongson2_pll_base whether was a err pointer.
		7. Get rid of the function loongson2_clocks_init() and move the code
		   in that function into probe function.
Change in v15:
