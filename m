...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D4B2C23C1DE
	for <lists+devicetree@lfdr.de>; Wed,  5 Aug 2020 00:24:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726282AbgHDWYi (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 4 Aug 2020 18:24:38 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45820 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725863AbgHDWYh (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 4 Aug 2020 18:24:37 -0400
Received: from mail-pj1-x1044.google.com (mail-pj1-x1044.google.com [IPv6:2607:f8b0:4864:20::1044])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 249A8C06174A
        for <devicetree@vger.kernel.org>; Tue,  4 Aug 2020 15:24:37 -0700 (PDT)
Received: by mail-pj1-x1044.google.com with SMTP id lx9so3187804pjb.2
        for <devicetree@vger.kernel.org>; Tue, 04 Aug 2020 15:24:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=U0tEVlYpQpW8Sy84NboeshORr9XY6+sAp9gsBVMvSPM=;
        b=ZesHvgvNdqfFFCsMgN6QMjI2gpVCI3aKwb1/lmHlk/T0y5NyTjWrLRmUzIM0qsEywe
         dDjn5QdZ+0QBKEnf3rqTmZEEAhPjir2UAeiZgttMTF4gCDTXcNLPGYMr97UPM/3/eDyf
         rooN2eJOrZJxEUgKGTwls61I2sladBJ7/4qP8=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:mime-version
         :content-transfer-encoding;
        bh=U0tEVlYpQpW8Sy84NboeshORr9XY6+sAp9gsBVMvSPM=;
        b=
X-Gm-Message-State: AOAM531mqLDtB760H6QxaFgCdJrBy/j8pOjWDJ6joyY7Zo4o3swWR9/w
        fR13T+v2Eq7TNiq8usfBfeiEzA==
X-Google-Smtp-Source: ABdhPJwIitbJj1YLBVXC6BM+La7MuPr5Bwvnk7FsA2Kq30S7vdm7oU5jqnhy1tZpnOxmktZiRJuAmw==
X-Received: by 2002:a17:90b:349:: with SMTP id fh9mr296293pjb.73.1596579876005;
        Tue, 04 Aug 2020 15:24:36 -0700 (PDT)
Received: from bhanumaiya-glaptop.hsd1.ca.comcast.net ([2601:646:9500:590:250:b6ff:fe8e:b459])
        by smtp.gmail.com with ESMTPSA id y23sm76559pfb.66.2020.08.04.15.24.33
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 04 Aug 2020 15:24:35 -0700 (PDT)
...
Subject: [PATCH v4 1/2] platform/chrome: cros_ec_uart: Add cros-ec-uart transport layer
Date:   Tue,  4 Aug 2020 15:24:15 -0700
Message-Id: <20200804151643.v4.1.Ic98067cd92a0b7fed9cd3dfb7b4e736e76551cda@changeid>
...
index 0000000000000..9ec964c0b96ce
--- /dev/null
...
+ * function. Byte count can range from 1 to MAX bytes supported by EC's firmware.
...
+ * Worst case: TTY driver sends bytes in multiple callbacks. In this case this driver
+ * will wait for ~1 sec beyond which it will timeout.
+ * This timeout value should not exceed ~1.2 secs because in case if EC_CMD_REBOOT_EC
+ * sent, high level driver should be able to intercept EC in RO.
+ */
