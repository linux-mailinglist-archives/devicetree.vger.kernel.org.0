...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 32641250199
	for <lists+devicetree@lfdr.de>; Mon, 24 Aug 2020 18:03:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726803AbgHXQDB (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 24 Aug 2020 12:03:01 -0400
Received: from mail.kernel.org ([198.145.29.99]:45376 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725973AbgHXQCw (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Mon, 24 Aug 2020 12:02:52 -0400
Received: from coco.lan (unknown [95.90.213.182])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 950662072D;
        Mon, 24 Aug 2020 16:02:28 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1598284956;
        bh=IY+iYJeURKzkcqSrIrAD23fhgS5jWL0J2apNF/QB/0U=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=d/BaD7r2IgUCIQGo2RXFGAprTAvLCC8j+lhq2i4wOukwiQ1ETGOR8sw7kM4JQHjQ4
         Xl2/U6r7MGyrVPFd8edGJwauIsatC0fJ61UMOoXWDENko5hhIzbhTX51ZamLqy6gSe
         YSACtnDX8JNmWM7Bhm2bLqwMZCbaYaxfZRRhT43A=
Date:   Mon, 24 Aug 2020 18:02:25 +0200
...
Message-ID: <20200824180225.1a515b6a@coco.lan>
In-Reply-To: <20200821155505.GA300361@ravnborg.org>
...
Em Fri, 21 Aug 2020 17:55:05 +0200
...
For now, I would prefer not using it, as I don't want to rebase
on the top of a -rc1 Kernel. I got a breakage on WiFi when
I rebased from 5.7 to 5.8. I would prefer avoiding it just
due to a new printk macro.

Once gets merged, I can post a followup patch replacing the
above by dev_err_probe().
...
Except for the Kconfig/Makefile changes (which I folded with the
original patch), the other changes are written as incremental
patches on the top of the previous version.

I also added a fixup patch from John Stultz for adv7511:

	https://gitlab.freedesktop.org/mchehab_kernel/hikey-970/-/commit/81686cb9f01d5c356d67f63eda7a93ec2db5d0f1

With this change, EDID now works fine.
