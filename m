...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 100637152B4
	for <lists+devicetree@lfdr.de>; Tue, 30 May 2023 02:54:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229501AbjE3Axx (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 29 May 2023 20:53:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51420 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229478AbjE3Axu (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 29 May 2023 20:53:50 -0400
Received: from gate2.alliedtelesis.co.nz (gate2.alliedtelesis.co.nz [IPv6:2001:df5:b000:5::4])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2033ED9
        for <devicetree@vger.kernel.org>; Mon, 29 May 2023 17:53:47 -0700 (PDT)
Received: from svr-chch-seg1.atlnz.lc (mmarshal3.atlnz.lc [10.32.18.43])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by gate2.alliedtelesis.co.nz (Postfix) with ESMTPS id B7E6B2C0593;
        Tue, 30 May 2023 12:53:44 +1200 (NZST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=alliedtelesis.co.nz;
        s=mail181024; t=1685408024;
        bh=VswQV9z0Hns2zO6GxEDodgxFnIlrIS5Ey5+baidM5mk=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: from pat.atlnz.lc (Not Verified[10.32.16.33]) by svr-chch-seg1.atlnz.lc with Trustwave SEG (v8,2,6,11305)
        id <B647549180001>; Tue, 30 May 2023 12:53:44 +1200
Received: from chrisp-dl.ws.atlnz.lc (chrisp-dl.ws.atlnz.lc [10.33.22.30])
        by pat.atlnz.lc (Postfix) with ESMTP id 7F5D413EE41;
        Tue, 30 May 2023 12:53:44 +1200 (NZST)
Received: by chrisp-dl.ws.atlnz.lc (Postfix, from userid 1030)
        id 7F260283D16; Tue, 30 May 2023 12:53:44 +1200 (NZST)
...
Subject: [PATCH v6 1/2] dt-bindings: mtd: marvell-nand: Convert to YAML DT scheme
Date:   Tue, 30 May 2023 12:53:36 +1200
Message-Id: <20230530005337.3687938-2-chris.packham@alliedtelesis.co.nz>
...
d to set
+          it (otherwise it is harmless) so whether or not this property =
is set,
