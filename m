...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BF82B700231
	for <lists+devicetree@lfdr.de>; Fri, 12 May 2023 10:05:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240112AbjELIFj (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 12 May 2023 04:05:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36196 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240401AbjELIEs (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 12 May 2023 04:04:48 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3F42211B74;
        Fri, 12 May 2023 01:04:15 -0700 (PDT)
X-UUID: 932f71aaf09b11edb20a276fd37b9834-20230512
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=JjgYCtFV/9DpjvnW+raRsijyxlEVvjaJ25KjfOxBbm8=;
        b=AT8yj85169IPpe66r1X7p8uC0BIKOnsleu9YmW/epYxIksuvTe4prs0D73WbFEA8BWJmiJYvfGAd8Ui71Nhjhp5Jet+TjSPt5YsKph1J76uUbVXRF/RITYKsxyno797bIM/2qrQOvFBDkx4PBbQnD/xOzOhk3vjm7zimPqQ+qm4=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.24,REQID:2a664c66-c3d3-4f76-9c5f-0fbb8fc75dd8,IP:0,U
        RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:100,FILE:0,BULK:0,RULE:Release_Ham,ACT
        ION:release,TS:75
X-CID-INFO: VERSION:1.1.24,REQID:2a664c66-c3d3-4f76-9c5f-0fbb8fc75dd8,IP:0,URL
        :0,TC:0,Content:-25,EDM:0,RT:0,SF:100,FILE:0,BULK:0,RULE:Spam_GS981B3D,ACT
        ION:quarantine,TS:75
X-CID-META: VersionHash:178d4d4,CLOUDID:1165f53a-de1e-4348-bc35-c96f92f1dcbb,B
        ulkID:230512160411S4XULEVQ,BulkQuantity:0,Recheck:0,SF:29|28|17|19|48|38,T
...
Received: from mtkmbs13n1.mediatek.inc [(172.21.101.193)] by mailgw02.mediatek.com
        ...
        with ESMTP id 1446368848; Fri, 12 May 2023 16:04:09 +0800
...
Subject: [PATCH v3 7/7] virt: geniezone: Add ioeventfd support
Date:   Fri, 12 May 2023 16:04:05 +0800
Message-ID: <20230512080405.12043-8-yi-de.wu@mediatek.com>
...
index aa52cee3ca8e..25493a4d1c63 100644
...
index fdf6e6297e66..d57385395a21 100644
...
index 403192731597..c90111e4b23e 100644
--- a/drivers/virt/geniezone/gzvm_vm.c
+++ b/drivers/virt/geniezone/gzvm_vm.c
@@ -307,6 +307,15 @@ static long gzvm_vm_ioctl(struct file *filp, unsigned int ioctl,
...
@@ -385,6 +394,14 @@ static struct gzvm *gzvm_create_vm(unsigned long vm_type)
 		return ERR_PTR(ret);
 	}
...
index 0751f9f4f76f..cf4d3cf296d3 100644
--- a/include/uapi/linux/gzvm.h
+++ b/include/uapi/linux/gzvm.h
@@ -244,4 +244,27 @@ struct gzvm_irqfd {
