...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C3E0064C419
	for <lists+devicetree@lfdr.de>; Wed, 14 Dec 2022 07:58:00 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237471AbiLNG56 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 14 Dec 2022 01:57:58 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41902 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237481AbiLNG5w (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 14 Dec 2022 01:57:52 -0500
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C93CC10B7F
        for <devicetree@vger.kernel.org>; Tue, 13 Dec 2022 22:57:48 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1671001068; x=1702537068;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=ZqrTgMd6SWBcOwVYymoFuRILQdSDR0rcBslCcd7iJUU=;
  b=OuXpwtg3u9UqNlUE+R2Uk1PczLVNKBR/xzuB63jYKvWSfbwQD/6RU1s9
   0VfqNg8XhMATQUViRFnlTRe5jhm2NPBnxjzexMmhmjUf4rpcVxGoj8Rg6
   ngSWWYMr+p06RjwTa5pSpaNzVzuFikMETPsfLsmZYEfO3UxKIm1TQtP4U
   njIMZBFGfLxsrrw52MUA3C4y7eG5XvLUBEgpvQipxet2GIJ7VVgEVmxR1
   D8IEfZ946C4OWu/W9A5h0hULpXIBue43DvjxgNQ4dyj28hPVtBaBUMGBo
   pDL3aV+DSNGJDyHS8YH/yXcH/7adGBs1uHk652GoYvYL3aMQLEbVsYi3q
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10560"; a="318371137"
X-IronPort-AV: E=Sophos;i="5.96,243,1665471600"; 
   d="scan'208";a="318371137"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Dec 2022 22:57:46 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10560"; a="681415892"
X-IronPort-AV: E=Sophos;i="5.96,243,1665471600"; 
   d="scan'208";a="681415892"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
  by orsmga001.jf.intel.com with ESMTP; 13 Dec 2022 22:57:41 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p5Li0-0005H5-0r;
        Wed, 14 Dec 2022 06:57:40 +0000
Date:   Wed, 14 Dec 2022 14:56:50 +0800
...
Subject: Re: [PATCH 4/4] soc: imx: imx8mp-blk-ctrl: expose high performance
 PLL clock
Message-ID: <202212141453.1ylZU7Fn-lkp@intel.com>
References: <20221213160112.1900410-4-l.stach@pengutronix.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="i/LTy4Q7DNaQDyqW"
...
[also build test ERROR on krzk/for-next krzk-dt/for-next linus/master v6.1 next-20221213]
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=clang make.cross W=1 O=build_dir ARCH=s390 SHELL=/bin/bash drivers/soc/
...
vim +/FIELD_PREP +105 drivers/soc/imx/imx8mp-blk-ctrl.c

    96	
    97	static int clk_hsio_pll_prepare(struct clk_hw *hw)
    98	{
    99		struct clk_hsio_pll *clk = to_clk_hsio_pll(hw);
   100		u32 val;
   101	
   102		/* set the PLL configuration */
   103		regmap_update_bits(clk->regmap, GPR_REG2,
   104				   P_PLL_MASK | M_PLL_MASK | S_PLL_MASK,
 > 105				   FIELD_PREP(P_PLL_MASK, 12) |
   106				   FIELD_PREP(M_PLL_MASK, 800) |
   107				   FIELD_PREP(S_PLL_MASK, 4));
   108	
   109		/* de-assert PLL reset */
   110		regmap_update_bits(clk->regmap, GPR_REG3, PLL_RST, PLL_RST);
   111	
   112		/* enable PLL */
   113		regmap_update_bits(clk->regmap, GPR_REG3, PLL_CKE, PLL_CKE);
   114	
   115		return regmap_read_poll_timeout(clk->regmap, GPR_REG1, val,
   116						val & PLL_LOCK, 10, 100);
   117	}
   118	
