...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 8F4A8182B55
	for <lists+devicetree@lfdr.de>; Thu, 12 Mar 2020 09:35:56 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726646AbgCLIfb (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 12 Mar 2020 04:35:31 -0400
Received: from mail-wm1-f67.google.com ([209.85.128.67]:50917 "EHLO
        mail-wm1-f67.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726599AbgCLIf3 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 12 Mar 2020 04:35:29 -0400
Received: by mail-wm1-f67.google.com with SMTP id a5so5087371wmb.0;
        Thu, 12 Mar 2020 01:35:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=7vZsEpO07BVIWUwm8etqmQBOOthNDAuboMSdlmMNhE0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=7vZsEpO07BVIWUwm8etqmQBOOthNDAuboMSdlmMNhE0=;
        b=
X-Gm-Message-State: ANhLgQ3VuTI0pZVKzMVOLQR7hDgvB02D9fiMmMFIOLIVotuRC1VDZbtL
        EgplB57/dVxY7lO6ZQeQOh16uU9pmsA=
X-Google-Smtp-Source: ADFU+vsl1yOFN8dTg8+QDNmLTZI15MsVP1zNO18XbNF/+cpBBTogXO0mWJVnCcpMgV95+Ma37pxm5w==
X-Received: by 2002:a7b:c202:: with SMTP id x2mr3544161wmi.71.1584002125908;
        Thu, 12 Mar 2020 01:35:25 -0700 (PDT)
Received: from localhost.localdomain ([188.26.73.247])
        by smtp.gmail.com with ESMTPSA id 9sm11543334wmo.38.2020.03.12.01.35.24
...
Subject: [PATCH v9 5/8] iio: adc: adi-axi-adc: add support for AXI ADC IP core
Date:   Thu, 12 Mar 2020 10:35:08 +0200
Message-Id: <20200312083511.28832-6-alexandru.ardelean@analog.com>
...
index 000000000000..042fff77e21f
--- /dev/null
...
+	 ADI_AXI_REG_CHAN_CTRL_IQCOR_EN |	\
+	 ADI_AXI_REG_CHAN_CTRL_ENABLE)
+
+#define ADI_AXI_REG_CHAN_IQCOR_CTRL(c)		(0x0414 + (c) * 0x40)
...
+		adi_axi_adc_write(st, ADI_AXI_REG_CHAN_IQCOR_CTRL(i), val);
+
