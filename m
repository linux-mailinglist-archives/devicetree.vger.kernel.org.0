...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AEC8D4F78FB
	for <lists+devicetree@lfdr.de>; Thu,  7 Apr 2022 10:04:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242626AbiDGIEf (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 7 Apr 2022 04:04:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47540 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242710AbiDGIEB (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 7 Apr 2022 04:04:01 -0400
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F39D9158D88;
        Thu,  7 Apr 2022 01:01:47 -0700 (PDT)
X-UUID: 256befa7e0634904814314aa5b575529-20220407
X-UUID: 256befa7e0634904814314aa5b575529-20220407
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by mailgw01.mediatek.com
        (envelope-from <yong.wu@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
        with ESMTP id 1748168225; Thu, 07 Apr 2022 16:01:41 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by
 mtkmbs10n2.mediatek.inc (172.21.101.183) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id 15.2.792.3;
 Thu, 7 Apr 2022 16:01:38 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas11.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Thu, 7 Apr 2022 16:01:37 +0800
...
Subject: [PATCH v6 28/34] iommu/mediatek: Add mtk_iommu_bank_data structure
Date:   Thu, 7 Apr 2022 15:57:20 +0800
Message-ID: <20220407075726.17771-29-yong.wu@mediatek.com>
...
@@ -1123,8 +1161,6 @@ static int mtk_iommu_probe(struct platform_device *pdev)
 	if (ret)
...
@@ -1174,6 +1210,7 @@ static int mtk_iommu_probe(struct platform_device *pdev)
...
@@ -1190,7 +1227,7 @@ static int mtk_iommu_remove(struct platform_device *pdev)
 #endif
 	}
...
@@ -1198,7 +1235,7 @@ static int __maybe_unused mtk_iommu_runtime_suspend(struct device *dev)
 {
...
@@ -1216,8 +1253,8 @@ static int __maybe_unused mtk_iommu_runtime_resume(struct device *dev)
 {
 	struct mtk_iommu_data *data = dev_get_drvdata(dev);
 	struct mtk_iommu_suspend_reg *reg = &data->reg;
...
@@ -1265,6 +1302,8 @@ static const struct mtk_iommu_plat_data mt2712_data = {
 	.hw_list      = &m4ulist,
...
@@ -1274,6 +1313,8 @@ static const struct mtk_iommu_plat_data mt6779_data = {
...
@@ -1284,6 +1325,8 @@ static const struct mtk_iommu_plat_data mt8167_data = {
...
@@ -1315,6 +1362,8 @@ static const struct mtk_iommu_plat_data mt8192_data = {
...
@@ -1327,6 +1376,8 @@ static const struct mtk_iommu_plat_data mt8195_data_infra = {
...
@@ -1338,6 +1389,8 @@ static const struct mtk_iommu_plat_data mt8195_data_vdo = {
...
@@ -1351,6 +1404,8 @@ static const struct mtk_iommu_plat_data mt8195_data_vpp = {
 			  SHARE_PGTABLE | MTK_IOMMU_TYPE_MM,
 	.hw_list        = &m4ulist,
 	.inv_sel_reg    = REG_MMU_INV_SEL_GEN2,
+	.banks_num      = 1,
