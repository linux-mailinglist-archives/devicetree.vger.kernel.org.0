...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 574672E7D12
	for <lists+devicetree@lfdr.de>; Thu, 31 Dec 2020 00:02:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726292AbgL3XCH (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 30 Dec 2020 18:02:07 -0500
Received: from fllv0015.ext.ti.com ([198.47.19.141]:46360 "EHLO
        fllv0015.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726285AbgL3XCG (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 30 Dec 2020 18:02:06 -0500
Received: from lelv0265.itg.ti.com ([10.180.67.224])
        by fllv0015.ext.ti.com (8.15.2/8.15.2) with ESMTP id 0BUN1Mvn080617;
        Wed, 30 Dec 2020 17:01:22 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1609369282;
        bh=V5tx7V7tgHfLkM+hI4+SL9t83+6lHrUGk8o3QMJY8SM=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=A2NkhhsOT3LJitN2D+71XIuwX2uV8yS4SxN9ife0t4fjw2cPkE5rQ3qOAEKVOTit/
         KLfzp53GCP9rv+UKCxbKvbSVQFXhPsikKPsADuXo9XAqfYyT0lpyOaDH3ejvn9X4oy
         ijoF4hpJPYveqVEDdNyVKjflR4trb2DrKMHrUAB0=
Received: from DLEE109.ent.ti.com (dlee109.ent.ti.com [157.170.170.41])
        by lelv0265.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 0BUN1M0P029371
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Wed, 30 Dec 2020 17:01:22 -0600
Received: from DLEE106.ent.ti.com (157.170.170.36) by DLEE109.ent.ti.com
 (157.170.170.41) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1979.3; Wed, 30
 Dec 2020 17:01:21 -0600
Received: from lelv0327.itg.ti.com (10.180.67.183) by DLEE106.ent.ti.com
 (157.170.170.36) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1979.3 via
 Frontend Transport; Wed, 30 Dec 2020 17:01:22 -0600
Received: from localhost (ileax41-snat.itg.ti.com [10.172.224.153])
        by lelv0327.itg.ti.com (8.15.2/8.15.2) with ESMTP id 0BUN1LOe007910;
...
Subject: [PATCH v7 2/2] power: supply: bq256xx: Introduce the BQ256XX charger driver
Date:   Wed, 30 Dec 2020 17:01:16 -0600
Message-ID: <20201230230116.29697-3-r-rivera-matos@ti.com>
X-Mailer: git-send-email 2.28.0
In-Reply-To: <20201230230116.29697-1-r-rivera-matos@ti.com>
...
index 000000000000..4a5973524a70
--- /dev/null
...
+};
+
+static int bq256xx_power_supply_init(struct bq256xx_device *bq, struct power_supply_config *psy_cfg, struct device *dev)
+{
...
+}
+
+static int bq256xx_parse_dt(struct bq256xx_device *bq, struct power_supply_config *psy_cfg, struct device *dev)
+{
+	int ret = 0;
+
+	psy_cfg->drv_data = bq;
