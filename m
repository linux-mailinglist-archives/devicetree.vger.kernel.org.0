...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3E16047F0F8
	for <lists+devicetree@lfdr.de>; Fri, 24 Dec 2021 21:10:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1353572AbhLXUKU (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 24 Dec 2021 15:10:20 -0500
Received: from mout.gmx.net ([212.227.17.20]:46877 "EHLO mout.gmx.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1353573AbhLXUKK (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Fri, 24 Dec 2021 15:10:10 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=gmx.net;
        s=badeba3b8450; t=1640376600;
        bh=EKF57liAmJbmCqbN6i/80P2ZfR9oc2gWRl5Mi95BcPo=;
        h=X-UI-Sender-Class:From:To:Cc:Subject:Date:In-Reply-To:References;
        b=XzUH6zeKI9vB424pIdOY4vssYbz7GEpAIFE8ISbz58F8NMiNEdSyQoNTSbSWzCXQO
         12043nCS/3cPCCCYdma/HmbzgMDchqFkhD8w5V11yABnWPsW6rIXCjFAWe0P1pbxTn
         z8MofpRo88KpXCIjbJ5sVAq4uWsxoQQ56XNCoWBc=
X-UI-Sender-Class: 01bb95c1-4bf8-414a-932a-4f6e2808ef9c
Received: from longitude ([5.146.194.160]) by mail.gmx.net (mrgmx105
 [212.227.17.168]) with ESMTPSA (Nemesis) id 1MWRRT-1myQCJ0F59-00Xsy7; Fri, 24
 Dec 2021 21:10:00 +0100
...
Subject: [PATCH v3 5/9] pinctrl: nuvoton: Add driver for WPCM450
Date:   Fri, 24 Dec 2021 21:09:31 +0100
Message-Id: <20211224200935.93817-6-j.neuschaefer@gmx.net>
...
X-Provags-ID: V03:K1:i3prFEDVYVwHOhJqhi9635NHtGqWmKS1DI3c7vVLTb+zicQx4A+
 GoZFnUPK24pIRW0ZRXZse2d68OkaBJjVwNlQ/4fkhX9oSesl5wpIPIAm8ZGIJrYaHtpnsRv
 j74dVTWP+d9yOU7Pm8KEyG3YvP5jLXjId82AXuS3oMdPLqVZjiYxYVC6Kbrf3fBbZSZN1JE
 dH81eQOUXwCn6LsGcRIhg==
X-Spam-Flag: NO
X-UI-Out-Filterresults: notjunk:1;V03:K0:+3x6TNW0zBw=:DWrDZx/MgmY0kiv1zSQ9zy
 
Precedence: bulk
...
+	unsigned int bit;
+
+	ours =3D GENMASK(gpio->bank->first_irq_bit + gpio->bank->num_irqs - 1,
...
+	if (!pctrl->gpio_base)
+		return dev_err_probe(pctrl->dev, -ENOMEM, "Resource fail for GPIO contr=
oller\n");
+
...
+		}
+
+		ret =3D devm_gpiochip_add_data(pctrl->dev, &gpio->gc, gpio);
+		if (ret)
