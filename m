...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3595D1AB6FB
	for <lists+devicetree@lfdr.de>; Thu, 16 Apr 2020 06:57:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2404733AbgDPE4u (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 16 Apr 2020 00:56:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60604 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2404729AbgDPE4h (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 16 Apr 2020 00:56:37 -0400
Received: from mail-pf1-x444.google.com (mail-pf1-x444.google.com [IPv6:2607:f8b0:4864:20::444])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BDC2BC061A0C;
        Wed, 15 Apr 2020 21:56:35 -0700 (PDT)
Received: by mail-pf1-x444.google.com with SMTP id u65so1131949pfb.4;
        Wed, 15 Apr 2020 21:56:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=/HqhnFEXMs361rq5dmyggfKPCBf7dlvRIisjvHzmV60=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=/HqhnFEXMs361rq5dmyggfKPCBf7dlvRIisjvHzmV60=;
        b=
X-Gm-Message-State: AGi0PuaZpXTLF9Xg0ActArB8zh2brTIdCPrWhobrmk97JfSOD7Xcu3vy
        bRHaGP9KZS/oWSOKpjxiNg0=
X-Google-Smtp-Source: APiQypJTouSNG4kCG5bo9Ynbg9OejuWrFcnDqbxaiVJhWKX2yDGNSgCa+Oum+GEg1iPX8KOQj4m2cA==
X-Received: by 2002:aa7:9f03:: with SMTP id g3mr32886022pfr.287.1587012994281;
        Wed, 15 Apr 2020 21:56:34 -0700 (PDT)
Received: from localhost.localdomain ([183.82.182.213])
        by smtp.gmail.com with ESMTPSA id 3sm4749198pgh.75.2020.04.15.21.56.31
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Wed, 15 Apr 2020 21:56:33 -0700 (PDT)
...
Subject: [PATCH v3 2/4] tty/serial: ttvys: add null modem driver for emulation
Date:   Thu, 16 Apr 2020 10:26:12 +0530
Message-Id: <1587012974-21219-2-git-send-email-gupt21@gmail.com>
...
- Added virtual-tty-ttyvs.rst in MAINTAINERS
...
index e64e5db..6532f0e 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -17129,6 +17129,15 @@ F:	include/uapi/linux/serial.h
...
index 2dff93d..ce65103 100644
--- a/drivers/tty/Kconfig
+++ b/drivers/tty/Kconfig
@@ -478,6 +478,23 @@ config VCC
 	help
...
+
+/*
+ * Notifies tty core that a framing/parity/overrun error has happened
