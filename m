...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BC94F3AC1EC
	for <lists+devicetree@lfdr.de>; Fri, 18 Jun 2021 06:19:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230377AbhFREVw (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 18 Jun 2021 00:21:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49918 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230315AbhFREVv (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 18 Jun 2021 00:21:51 -0400
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e3e3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 14098C061574;
        Thu, 17 Jun 2021 21:19:43 -0700 (PDT)
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (Authenticated sender: dafna)
        with ESMTPSA id 31AE41F4466D
Subject: Re: [PATCH v5 07/10] media: rockchip: rkisp1: add prefixes for v10
 specific parts
...
References: <20210617162745.4080975-1-heiko@sntech.de>
 <20210617162745.4080975-8-heiko@sntech.de>
From:   Dafna Hirschfeld <dafna.hirschfeld@collabora.com>
Message-ID: <f47ab570-a46a-42c7-1333-f978a2d42593@collabora.com>
Date:   Fri, 18 Jun 2021 07:19:35 +0300
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.10.0
MIME-Version: 1.0
In-Reply-To: <20210617162745.4080975-8-heiko@sntech.de>
...
>   .../platform/rockchip/rkisp1/rkisp1-regs.h    | 266 +++++++++---------
>   .../platform/rockchip/rkisp1/rkisp1-stats.c   |  32 +--
>   3 files changed, 240 insertions(+), 238 deletions(-)
> 
> diff --git a/drivers/media/platform/rockchip/rkisp1/rkisp1-params.c b/drivers/media/platform/rockchip/rkisp1/rkisp1-params.c
> index 1aab2720ffa2..31a2194e003d 100644
...
>   
>   	/* set the  range */
> @@ -1290,16 +1290,16 @@ void rkisp1_params_disable(struct rkisp1_params *params)
...
> @@ -1469,7 +1469,7 @@ static void rkisp1_init_params(struct rkisp1_params *params)
...
> index fa33080f51db..2982399968a1 100644
...
Those two defines belong to the next patch, with that change
