...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3441A4F5F13
	for <lists+devicetree@lfdr.de>; Wed,  6 Apr 2022 15:29:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232009AbiDFNMI (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 6 Apr 2022 09:12:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60998 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232946AbiDFNLD (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 6 Apr 2022 09:11:03 -0400
Received: from lelv0143.ext.ti.com (lelv0143.ext.ti.com [198.47.23.248])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E7BE15F4762;
        Wed,  6 Apr 2022 02:45:42 -0700 (PDT)
Received: from fllv0034.itg.ti.com ([10.64.40.246])
        by lelv0143.ext.ti.com (8.15.2/8.15.2) with ESMTP id 2369idT9124152;
        Wed, 6 Apr 2022 04:44:39 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1649238279;
        bh=Tm8YGAQLb1w0gITS2TXRLlNnOIu+9g51K+J3YnxiF4k=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=FfpRM6nHPxXmz6pLt35pKRTT0L6wst7Qgl+vZJpsuWkPaKomNtqZGB7hQ1M7KB01R
         7NFPwNrYTcuspfANki3HsdzrnJG/vjNTs0MZ2mWsUX4lvSaBklHHdZ+tdETbouvEeI
         7L0QzakJSP/hJCc1fO0U8Jaun0a3v+os16gJznuo=
Received: from DFLE103.ent.ti.com (dfle103.ent.ti.com [10.64.6.24])
        by fllv0034.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 2369id74014920
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Wed, 6 Apr 2022 04:44:39 -0500
Received: from DFLE113.ent.ti.com (10.64.6.34) by DFLE103.ent.ti.com
 (10.64.6.24) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2308.14; Wed, 6
 Apr 2022 04:44:38 -0500
Received: from fllv0040.itg.ti.com (10.64.41.20) by DFLE113.ent.ti.com
 (10.64.6.34) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2308.14 via
 Frontend Transport; Wed, 6 Apr 2022 04:44:38 -0500
Received: from localhost (ileax41-snat.itg.ti.com [10.172.224.153])
        by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id 2369iYRD025964;
        Wed, 6 Apr 2022 04:44:35 -0500
...
Subject: [RFC 13/13] net: ti: icssg-prueth: Add ICSSG ethernet driver
Date:   Wed, 6 Apr 2022 15:13:58 +0530
Message-ID: <20220406094358.7895-14-p-mohan@ti.com>
...
---
 ...
 12 files changed, 3914 insertions(+)
...
index affcf92cd3aa..6fae016e7466 100644
--- a/drivers/net/ethernet/ti/Kconfig
+++ b/drivers/net/ethernet/ti/Kconfig
@@ -181,4 +181,19 @@ config CPMAC
 	help
...
new file mode 100644
index 000000000000..e02bc2ced12a
--- /dev/null
...
new file mode 100644
index 000000000000..aa6cd6992f18
--- /dev/null
...
new file mode 100644
index 000000000000..aff7c8d67872
--- /dev/null
...
new file mode 100644
index 000000000000..90779e797f19
--- /dev/null
