...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7B890467340
	for <lists+devicetree@lfdr.de>; Fri,  3 Dec 2021 09:28:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1379134AbhLCIb6 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Dec 2021 03:31:58 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54934 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244052AbhLCIb5 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 3 Dec 2021 03:31:57 -0500
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 37F84C06173E
        for <devicetree@vger.kernel.org>; Fri,  3 Dec 2021 00:28:33 -0800 (PST)
Received: from ptx.hi.pengutronix.de ([2001:67c:670:100:1d::c0])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mtr@pengutronix.de>)
        id 1mt3vg-0003yp-JO; Fri, 03 Dec 2021 09:28:28 +0100
Received: from mtr by ptx.hi.pengutronix.de with local (Exim 4.92)
        (envelope-from <mtr@pengutronix.de>)
        id 1mt3ve-0003V7-1r; Fri, 03 Dec 2021 09:28:26 +0100
Date:   Fri, 3 Dec 2021 09:28:26 +0100
...
Subject: Re: [PATCH v9 3/3] media: i2c: isl7998x: Add driver for Intersil
 ISL7998x
Message-ID: <20211203082825.GG14798@pengutronix.de>
...
References: <20211129112708.3219754-1-m.tretter@pengutronix.de>
 ...
 <YaiEaSsNLjwRCHAH@paasikivi.fi.intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
Content-Disposition: inline
In-Reply-To: <YaiEaSsNLjwRCHAH@paasikivi.fi.intel.com>
X-Sent-From: Pengutronix Hildesheim
X-URL:  http://www.pengutronix.de/
X-IRC:  #ptxdist @freenode
X-Accept-Language: de,en
X-Accept-Content-Type: text/plain
X-Uptime: 09:13:01 up 288 days, 11:36, 138 users,  load average: 0.16, 0.39,
 0.29
...
On Thu, 02 Dec 2021 10:31:37 +0200, Sakari Ailus wrote:
> A few more comments. These could be addressed in a separate patch I think.

Thanks. I'll send a follow-up patch.
...
pm_runtime_get_if_in_use() returns -EINVAL, if runtime PM is disabled. I
haven't thought of using the error code as a valid response and will change
it.
...
I'll add a lock and use it where necessary.
