...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B1C9A547DF4
	for <lists+devicetree@lfdr.de>; Mon, 13 Jun 2022 05:23:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232892AbiFMDXD (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 12 Jun 2022 23:23:03 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54602 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238449AbiFMDXA (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 12 Jun 2022 23:23:00 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 135FC13D1C;
        Sun, 12 Jun 2022 20:22:56 -0700 (PDT)
X-UUID: 039cb8bca72a48108f65a028fbf23363-20220613
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.5,REQID:4a4a0f5c-926e-4217-9d15-8ea55c01ca52,OB:10,L
        OB:0,IP:0,URL:0,TC:0,Content:0,EDM:0,RT:0,SF:100,FILE:0,RULE:Release_Ham,A
        CTION:release,TS:100
X-CID-INFO: VERSION:1.1.5,REQID:4a4a0f5c-926e-4217-9d15-8ea55c01ca52,OB:10,LOB
        :0,IP:0,URL:0,TC:0,Content:0,EDM:0,RT:0,SF:100,FILE:0,RULE:Spam_GS981B3D,A
        CTION:quarantine,TS:100
X-CID-META: VersionHash:2a19b09,CLOUDID:61547837-84c0-4f9a-9fbd-acd4a0e9ad0f,C
...
Received: from mtkcas11.mediatek.inc [(172.21.101.40)] by mailgw02.mediatek.com
        ...
        with ESMTP id 2073240684; Mon, 13 Jun 2022 11:22:52 +0800
Received: from mtkcas10.mediatek.inc (172.21.101.39) by
 mtkmbs10n1.mediatek.inc (172.21.101.34) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id
 15.2.792.15; Mon, 13 Jun 2022 11:22:51 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas10.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Mon, 13 Jun 2022 11:22:50 +0800
...
Subject: [V3,7/8] media: mtk-jpegdec: refactor jpegdec func interface
Date:   Mon, 13 Jun 2022 11:22:31 +0800
Message-ID: <20220613032232.23187-8-irui.wang@mediatek.com>
...
index 25fa3ad8de3d..ee351625bf81 100644
...
@@ -1214,7 +1239,6 @@ static void mtk_jpegdec_worker(struct work_struct *work)
...
@@ -1244,9 +1268,11 @@ static void mtk_jpegdec_worker(struct work_struct *work)
 	}
...
@@ -1308,8 +1334,10 @@ if (!jpeg->variant->is_multihw) {
...
index 4da6d0621981..16634de8bd0f 100644
--- a/drivers/media/platform/mediatek/jpeg/mtk_jpeg_core.h
+++ b/drivers/media/platform/mediatek/jpeg/mtk_jpeg_core.h
@@ -81,6 +81,7 @@ struct mtk_jpeg_src_buf {
 	u32 frame_num;
...
index 71cbf1e6e0de..3e603ccb9781 100644
