...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D00AD602F5B
	for <lists+devicetree@lfdr.de>; Tue, 18 Oct 2022 17:14:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230259AbiJRPOj (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 18 Oct 2022 11:14:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34980 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230144AbiJRPOg (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 18 Oct 2022 11:14:36 -0400
Received: from madras.collabora.co.uk (madras.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e5ab])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1CD4E1583E;
...
Received: from jupiter.universe (dyndsl-095-033-155-016.ewe-ip-backbone.de [95.33.155.16])
        ...
        by madras.collabora.co.uk (Postfix) with ESMTPSA id 61ABD6602392;
        Tue, 18 Oct 2022 16:14:21 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1666106061;
        bh=qJbr5cIzbMDZTrz4GQ4yOnIYKC4F9i0eBXaCAzLA1zU=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: by jupiter.universe (Postfix, from userid 1000)
        id 34D1348032E; Tue, 18 Oct 2022 17:14:16 +0200 (CEST)
...
Subject: [PATCHv3 9/9] clk: rockchip: add clock controller for the RK3588
Date:   Tue, 18 Oct 2022 17:14:07 +0200
Message-Id: <20221018151407.63395-10-sebastian.reichel@collabora.com>
...
index 000000000000..bcdb26021239
--- /dev/null
...
index 7ee231d9585d..758ebaf2236b 100644
...
+#define ROCKCHIP_CPUCLK_NUM_DIVIDERS	6
 ...
 struct rockchip_cpuclk_rate_table {
 	unsigned long prate;
@@ -978,4 +1023,6 @@ static inline void rockchip_register_softrst(struct device_node *np,
