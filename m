...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 82BAB4BA4C0
	for <lists+devicetree@lfdr.de>; Thu, 17 Feb 2022 16:45:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242669AbiBQPob (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 17 Feb 2022 10:44:31 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:46380 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242665AbiBQPoa (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 17 Feb 2022 10:44:30 -0500
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 63B6E2B2FCE
        for <devicetree@vger.kernel.org>; Thu, 17 Feb 2022 07:44:11 -0800 (PST)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mtr@pengutronix.de>)
        id 1nKiwz-0005u1-Ji; Thu, 17 Feb 2022 16:44:09 +0100
Received: from [2a0a:edc0:0:1101:1d::39] (helo=dude03.red.stw.pengutronix.de)
        by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.94.2)
        (envelope-from <mtr@pengutronix.de>)
        id 1nKiwz-00HCTf-JA; Thu, 17 Feb 2022 16:44:08 +0100
Received: from mtr by dude03.red.stw.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <mtr@pengutronix.de>)
        id 1nKiwx-00C8ZH-KT; Thu, 17 Feb 2022 16:44:07 +0100
...
Subject: [PATCH v10 2/2] media: i2c: isl7998x: Add driver for Intersil ISL7998x
Date:   Thu, 17 Feb 2022 16:44:07 +0100
Message-Id: <20220217154407.2892822-3-m.tretter@pengutronix.de>
...
index 83d27b57016f..3620a98286ef 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index fe66093b8849..2c8324226d98 100644
...
index f6b80ef6f41d..9392f2cb74c0 100644
--- a/drivers/media/i2c/Makefile
+++ b/drivers/media/i2c/Makefile
@@ -133,6 +133,7 @@ obj-$(CONFIG_VIDEO_IMX334)	+= imx334.o
...
index 000000000000..df124a0b401c
--- /dev/null
...
index c8e0f84d204d..92576ed03fc4 100644
