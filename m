...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C10E85B0B29
	for <lists+devicetree@lfdr.de>; Wed,  7 Sep 2022 19:10:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230007AbiIGRKg (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 7 Sep 2022 13:10:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48398 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230140AbiIGRK1 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 7 Sep 2022 13:10:27 -0400
Received: from wout5-smtp.messagingengine.com (wout5-smtp.messagingengine.com [64.147.123.21])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1A791A3441;
        Wed,  7 Sep 2022 10:10:11 -0700 (PDT)
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailout.west.internal (Postfix) with ESMTP id 4E9823200941;
        Wed,  7 Sep 2022 13:10:09 -0400 (EDT)
Received: from mailfrontend1 ([10.202.2.162])
  by compute4.internal (MEProxy); Wed, 07 Sep 2022 13:10:10 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=svenpeter.dev;
         h=cc:cc:content-transfer-encoding:date:date:from:from
        :in-reply-to:in-reply-to:message-id:mime-version:references
        :reply-to:sender:subject:subject:to:to; s=fm2; t=1662570608; x=
        1662657008; bh=DGcCaKEVmFMF12iZWcMKIe0xseNfoqi5pE58JkCQVlc=; b=n
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:cc:content-transfer-encoding:date:date
        :feedback-id:feedback-id:from:from:in-reply-to:in-reply-to
        :message-id:mime-version:references:reply-to:sender:subject
        :subject:to:to:x-me-proxy:x-me-proxy:x-me-sender:x-me-sender
        :x-sasl-enc; s=fm2; t=1662570608; x=1662657008; bh=DGcCaKEVmFMF1
        2iZWcMKIe0xseNfoqi5pE58JkCQVlc=; b=tfipsNMIhdb1T/FLIc1gq/7G0Yckz
        
X-ME-Sender: <xms:cNAYY0ESRAX-l4I_KtpNiykqZBqYVIok-E1YYSXtGEDDg7LiRv7O7Q>
    <xme:cNAYY9VHRODWd-GEiLkrx19UqhprNsAgV02H82eu0hFYD7ortFDQtxZMyzlCIg_nf
    Fx-aUKwFFQjhcACisg>
X-ME-Received: <xmr:cNAYY-JLWLtkjOu2TB2F-udE4g8d78G2LoMsmDOwFwT2pdCFwmdQV0ui8rECkT3KM1h9B2TkJuoxLNFzwHBRegoejOXa_sLFbLwgMWDseLLCwROj7H23Z08>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgedvfedrfedttddguddutdcutefuodetggdotefrod
    ...
    jeegnecuvehluhhsthgvrhfuihiivgepvdenucfrrghrrghmpehmrghilhhfrhhomhepsh
    hvvghnsehsvhgvnhhpvghtvghrrdguvghv
X-ME-Proxy: <xmx:cNAYY2HHAE4NstL-3PqQKaXtkT7Gi0Li879fB1DzDrARbqXQvYMLXw>
    <xmx:cNAYY6XOJRHlMSZJaFsw7gSSsijWhuf_SAUFBL0EcG7GCyEyD7rChQ>
    <xmx:cNAYY5PWw1sHtnQVUrKrKpy1jQr0iGlc4tgXvukW2tg0NeNZ7_258Q>
    <xmx:cNAYY2nOccUHQKKTFNiH-bGsosblhExyku1zpkgmaeZTQgsro53RUQ>
Feedback-ID: i51094778:Fastmail
Received: by mail.messagingengine.com (Postfix) with ESMTPA; Wed,
 7 Sep 2022 13:10:06 -0400 (EDT)
...
Subject: [PATCH v2 5/5] Bluetooth: hci_bcm4377: Add new driver for BCM4377 PCI boards
Date:   Wed,  7 Sep 2022 19:09:35 +0200
Message-Id: <20220907170935.11757-6-sven@svenpeter.dev>
...
index 5cc9c2da1140..f7977fc3f82b 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index 000000000000..ee80bb883b07
--- /dev/null
