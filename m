...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 556F945A436
	for <lists+devicetree@lfdr.de>; Tue, 23 Nov 2021 14:56:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237300AbhKWN7M (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 23 Nov 2021 08:59:12 -0500
Received: from esa.microchip.iphmx.com ([68.232.154.123]:61051 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237335AbhKWN7F (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 23 Nov 2021 08:59:05 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1637675756; x=1669211756;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=OvmUOUFAk5k+F4JP/WnUOJBulZIX54STXJS5t1qzLuU=;
  b=FWCsbXSFqGHFK/+RuzLhA4aSXEVh37+TxJqVE5UV36wJawPK2djX1p65
   iPWyoQZqoTxHs0U5dbG/eWYk7uGgMVB9KmcxliVf0LBNmxz3SjRfM357r
   5kCGH7KNuxqqconlkiExmDkKYtUK/yz6UpKKLnWy0wiiHkVzR1iwyZTyl
   JLJRzDl3p/VYqXqLm5mo92ZfKmqtIkoHED65kSZwf4EjDcmHPyWAOLW6J
   PSalNxfxZ+zCWVzzy3SaAbXZ4K2HCGX5aBJ0G+2ELB/FHUjVOKb97yjgz
   z9bHye7471KmQsZmHR8Ld92lrlW95z9YTpEjG4aynZ2XZMB5Y/65XodiF
   g==;
IronPort-SDR: 
 Zdkz89PUiE+o/pi0pY49Zkxw
X-IronPort-AV: E=Sophos;i="5.87,257,1631602800"; 
   d="scan'208";a="137464860"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa4.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 23 Nov 2021 06:55:56 -0700
Received: from chn-vm-ex01.mchp-main.com (10.10.85.143) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.14; Tue, 23 Nov 2021 06:55:56 -0700
Received: from soft-dev3-1.microsemi.net (10.10.115.15) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server id
 15.1.2176.14 via Frontend Transport; Tue, 23 Nov 2021 06:55:53 -0700
...
Subject: [PATCH net-next v2 4/6] net: lan966x: add mactable support
Date:   Tue, 23 Nov 2021 14:55:15 +0100
Message-ID: <20211123135517.4037557-5-horatiu.vultur@microchip.com>
...
index 44d71e789c74..c1abe16ad579 100644
...
+
 static int lan966x_port_get_phys_port_name(struct net_device *dev,
 					   char *buf, size_t len)
 {
@@ -310,13 +331,49 @@ static int lan966x_port_change_mtu(struct net_device *dev, int new_mtu)
 	return 0;
 }
...
@@ -526,6 +583,11 @@ static int lan966x_probe_port(struct lan966x *lan966x, u32 p,
...
@@ -573,6 +635,9 @@ static void lan966x_init(struct lan966x *lan966x)
 {
 	u32 p, i;
...
+
 	...
 	lan_wr(lan_rd(lan966x, QS_XTR_FLUSH) |
 	       GENMASK(1, 0),
@@ -742,6 +807,7 @@ static int lan966x_probe(struct platform_device *pdev)
 {
...
@@ -751,6 +817,14 @@ static int lan966x_probe(struct platform_device *pdev)
