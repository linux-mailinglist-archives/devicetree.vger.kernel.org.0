...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 27D85211AB6
	for <lists+devicetree@lfdr.de>; Thu,  2 Jul 2020 05:52:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726081AbgGBDwH (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 1 Jul 2020 23:52:07 -0400
Received: from mx0b-0014ca01.pphosted.com ([208.86.201.193]:52600 "EHLO
        mx0a-0014ca01.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726173AbgGBDwF (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 1 Jul 2020 23:52:05 -0400
Received: from pps.filterd (m0042333.ppops.net [127.0.0.1])
        by mx0b-0014ca01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 0623jggZ014464;
        Wed, 1 Jul 2020 20:48:36 -0700
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cadence.com; h=from : to : cc :
 subject : date : message-id : references : in-reply-to : content-type :
 content-transfer-encoding : mime-version; s=proofpoint;
 bh=nZKD94Koyfm077+ERczt/daJBQZyJGo/KEhPUAa3HsU=;
 b= QQ== 
Received: from nam10-mw2-obe.outbound.protection.outlook.com (mail-mw2nam10lp2103.outbound.protection.outlook.com [104.47.55.103])
        by mx0b-0014ca01.pphosted.com with ESMTP id 31x1pyv11h-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 01 Jul 2020 20:48:34 -0700
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=nZKD94Koyfm077+ERczt/daJBQZyJGo/KEhPUAa3HsU=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cadence.com;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=nZKD94Koyfm077+ERczt/daJBQZyJGo/KEhPUAa3HsU=;
 b=VrefU8mBj4mo+WQr7VN/pCd8qvQ9S1ia21lxkR4zruQdMDTyc6ZXx+/pLalLVa8ZCpfQl3c+wihJRzWVkp4+IJ4WOS3LbKVjZtB9yeykIT3X84uFNJzr+VENNY/qulh2SZFSclCmWBcnj9pT/W/l0rpPHq50PFH3Cb54q86zQ7U=
Received: from DM6PR07MB5529.namprd07.prod.outlook.com (2603:10b6:5:7a::30) by
 DM5PR07MB2812.namprd07.prod.outlook.com (2603:10b6:3:c::16) with Microsoft
 SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.3153.23; Thu, 2 Jul 2020 03:48:26 +0000
Received: from DM6PR07MB5529.namprd07.prod.outlook.com
 ([fe80::f447:6767:a746:9699]) by DM6PR07MB5529.namprd07.prod.outlook.com
 ([fe80::f447:6767:a746:9699%7]) with mapi id 15.20.3153.024; Thu, 2 Jul 2020
 03:48:26 +0000
...
Subject: RE: [PATCH RFC 4/5] usb: cdnsp: usb:cdns3 Add main part of Cadence
 USBSSP DRD Driver
Thread-Topic: [PATCH RFC 4/5] usb: cdnsp: usb:cdns3 Add main part of Cadence
 USBSSP DRD Driver
Thread-Index: AQHWS3YgvsrehrifaEGvUKGSdDas+qjvZbyAgAArnBA=
Date:   Thu, 2 Jul 2020 03:48:26 +0000
Message-ID: <DM6PR07MB5529736F9CCC13FA6373B041DD6D0@DM6PR07MB5529.namprd07.prod.outlook.com>
References: <20200626045450.10205-1-pawell@cadence.com>
 <20200626045450.10205-5-pawell@cadence.com> <20200629101619.GH2571@kadam>
In-Reply-To: <20200629101619.GH2571@kadam>
Accept-Language: en-US
Content-Language: en-US
X-MS-Has-Attach: 
X-MS-TNEF-Correlator: 
x-dg-tag-bcast: {F0B656D1-F768-43A1-A424-45742A6E25CF}
x-dg-ref: =?us-ascii?Q?PG1ldGE+PGF0IG5tPSJib2R5LnR4dCIgcD0iYzpcdXNlcnNccGF3ZWxsXGFw?=
 =?us-ascii?Q?cGRhdGFccm9hbWluZ1wwOWQ4NDliNi0zMmQzLTRhNDAtODVlZS02Yjg0YmEy?=
 =?us-ascii?Q?OWUzNWJcbXNnc1xtc2ctYTMzNDEyNzUtYmMxNi0xMWVhLTg3NjctMWM0ZDcw?=
 =?us-ascii?Q?MWRmYmE0XGFtZS10ZXN0XGEzMzQxMjc2LWJjMTYtMTFlYS04NzY3LTFjNGQ3?=
 =?us-ascii?Q?MDFkZmJhNGJvZHkudHh0IiBzej0iMjQ0ODk0IiB0PSIxMzIzODEzNTIwMTIy?=
 =?us-ascii?Q?ODYwNDAiIGg9IkNDUSswRVJ6ZXFnaStJQzkxWDMxZFVQVUpBZz0iIGlkPSIi?=
 =?us-ascii?Q?IGJsPSIwIiBibz0iMSIgY2k9ImNBQUFBRVJIVTFSU1JVRk5DZ1VBQUlZSkFB?=
 =?us-ascii?Q?Q2dpYmQ3OVV2VUFUMVlycW5vdCtnUmh5RWNUWEFkKzZRT0FBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFPSUFBQUNrQ0FBQWNBQUFBSElBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQURBQUFBKzVRYmdRQUFBQUFBQUFBQUFBQUFBSElBQUFBQUFBQUFI?=
 =?us-ascii?Q?QUFBQUFFQUFBQUFBQUFBTE1BQU5pK2ZFRXVmZkxsN3ZuaHBtUndBQUFBQkFB?=
 =?us-ascii?Q?QUFBQUFBQU1OaHVaWDI5dXhNbFF0OTVLZnVhL3N5QUFBQUFRQUFBQ29BQUFB?=
 =?us-ascii?Q?QUFBQUFZd0JrQUc0QUlBQnpBRzhBZFFCeUFHTUFaUUFnQUdNQWJ3QmtBR1VB?=
 =?us-ascii?Q?Y3dBQUFKNEFBQUJqQUdFQVpBQmxBRzRBWXdCbEFGOEFZd0J2QUc0QVpnQnBB?=
 =?us-ascii?Q?R1FBWlFCdUFIUUFhUUJoQUd3QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBRUFBQUFBQUFBQUFnQUFBQUFBbmdBQUFHTUFZ?=
 =?us-ascii?Q?UUJrQUdVQWJnQmpBR1VBWHdCa0FHVUFjd0JwQUdjQWJnQmZBSE1BZVFCekFI?=
 =?us-ascii?Q?UUFaUUJ0QUhNQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQVFBQUFBQUFBQUFDQUFBQUFBQ2VBQUFBWXdCaEFHUUFaUUJ1QUdNQVpR?=
 =?us-ascii?Q?QmZBSEFBY2dCdkFHUUFkUUJqQUhRQWN3QUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQkFBQUFBQUFBQUFBQUFBQUJBQUFBQUFBQUFB?=
 =?us-ascii?Q?SUFBQUFBQUo0QUFBQnpBRzhBZFFCeUFHTUFaUUJqQUc4QVpBQmxBRjhBWVFC?=
 =?us-ascii?Q?ekFHMEFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFFQUFBQUFBQUFBQWdBQUFBQUFuZ0FBQUhN?=
 =?us-ascii?Q?QWJ3QjFBSElBWXdCbEFHTUFid0JrQUdVQVh3QmpBRzhBWWdCdkFHd0FBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFRQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBUUFBQUFBQUFBQUNBQUFBQUFDZUFBQUFjd0J2QUhVQWNnQmpBR1VB?=
 =?us-ascii?Q?WXdCdkFHUUFaUUJmQUdNQWNBQndBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFFQUFBQUFBQUFBQUFBQUFBQkFBQUFBQUFB?=
 =?us-ascii?Q?QUFJQUFBQUFBSjRBQUFCekFHOEFkUUJ5QUdNQVpRQmpBRzhBWkFCbEFGOEFZ?=
 =?us-ascii?Q?d0J6QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUVBQUFBQUFBQUFBZ0FBQUFBQW5nQUFB?=
 =?us-ascii?Q?SE1BYndCMUFISUFZd0JsQUdNQWJ3QmtBR1VBWHdCbEFIVUFjQUJvQUc4QWNn?=
 =?us-ascii?Q?QnBBR0VBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFRQUFBQUFBQUFBQ0FBQUFBQUNlQUFBQWN3QnZBSFVBY2dCakFH?=
 =?us-ascii?Q?VUFZd0J2QUdRQVpRQmZBR1lBYndCeUFIUUFjZ0JoQUc0QUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFCQUFBQUFB?=
 =?us-ascii?Q?QUFBQUlBQUFBQUFKNEFBQUJ6QUc4QWRRQnlBR01BWlFCakFHOEFaQUJsQUY4?=
 =?us-ascii?Q?QWFnQmhBSFlBWVFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBRUFBQUFBQUFBQUFnQUFBQUFBbmdB?=
 =?us-ascii?Q?QUFITUFid0IxQUhJQVl3QmxBR01BYndCa0FHVUFYd0J3QUhrQWRBQm9BRzhB?=
 =?us-ascii?Q?YmdBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQVFBQUFBQUFBQUFDQUFBQUFBQ2VBQUFBY3dCdkFIVUFjZ0Jq?=
 =?us-ascii?Q?QUdVQVl3QnZBR1FBWlFCZkFISUFkUUJpQUhrQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUJBQUFB?=
 =?us-ascii?Q?QUFBQUFBSUFBQUFBQUo0QUFBQnpBRzhBZFFCeUFHTUFaUUJqQUc4QVpBQmxB?=
 =?us-ascii?Q?RjhBY3dCMEFHd0FBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFFQUFBQUFBQUFBQWdBQUFBQUFu?=
 =?us-ascii?Q?Z0FBQUhNQWJ3QjFBSElBWXdCbEFHTUFid0JrQUdVQVh3QjJBR0lBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFBQUFB?=
 =?us-ascii?Q?QUFBQUFBQUFBQUFBUUFBQUFBQUFBQUNBQUFBQUFBPSIvPjwvbWV0YT4=3D?=
x-dg-paste: 
x-dg-rorf: true
...
x-ms-office365-filtering-correlation-id: 32498f85-98b8-4509-e7f8-08d81e3ac6da
x-ms-traffictypediagnostic: DM5PR07MB2812:
x-ms-exchange-transport-forked: True
x-microsoft-antispam-prvs: <DM5PR07MB28125ADF508A712E4FE5C07CDD6D0@DM5PR07MB2812.namprd07.prod.outlook.com>
x-ms-oob-tlc-oobclassifiers: OLM:10000;
x-forefront-prvs: 0452022BE1
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam: BCL:0;
x-microsoft-antispam-message-info: 
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:DM6PR07MB5529.namprd07.prod.outlook.com;PTR:;CAT:NONE;SFTY:;SFS:(4636009)(396003)(366004)(39860400002)(136003)(376002)(346002)(36092001)(186003)(7416002)(83380400001)(52536014)(86362001)(5660300002)(71200400001)(26005)(316002)(64756008)(76116006)(2906002)(4326008)(6916009)(66556008)(66476007)(66946007)(66446008)(33656002)(478600001)(9686003)(30864003)(54906003)(45080400002)(7696005)(55016002)(8676002)(6506007)(8936002)(107886003)(559001)(579004)(569008);DIR:OUT;SFP:1101;
x-ms-exchange-antispam-messagedata: 
...
X-MS-Exchange-CrossTenant-Network-Message-Id: 32498f85-98b8-4509-e7f8-08d81e3ac6da
X-MS-Exchange-CrossTenant-originalarrivaltime: 02 Jul 2020 03:48:26.0449
 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: d36035c5-6ce6-4662-a3dc-e762e61ae4c9
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: JhREO/xssfwnhIbbTz7k6GqyJPYMMvwOQPF3wrOQ96ZI7iVno0JTTVCZPYWe0/wHtASCeIpeKUVP6xXk6wgUakc8AFYJELIKo7oH4yrqSM4=
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DM5PR07MB2812
...
X-Proofpoint-Spam-Details: rule=outbound_check_notspam policy=outbound_check score=0
 ...
 suspectscore=0 impostorscore=0 mlxlogscore=999 spamscore=0 clxscore=1015
 classifier=spam adjust=0 reason=mlx scancount=1 engine=8.12.0-2004280000
 definitions=main-2007020026
...
I made your suggestions in cdnsp driver.=20

Taking into account my 4 weeks holiday in July and=20
...
>>
>> +cdnsp-y					:=3D core.o drd.o
>> +
>> +obj-$(CONFIG_USB_CDNSP) 		+=3D cdnsp.o
>> +cdnsp-$(CONFIG_USB_CDNSP_GADGET)	+=3D ring.o gadget.o mem.o ep0.o
>> +
>> +cdnsp-$(CONFIG_USB_CDNSP_HOST)		+=3D host.o
>> +
...
>> +
>> +static inline
>> +struct cdnsp_role_driver *cdnsp_get_current_role_driver(struct cdnsp *c=
dns)
>> +{
...
>> +		return -ENXIO;
>> +
>> +	if (cdns->roles[role]->state =3D=3D CDNSP_ROLE_STATE_ACTIVE)
>> +		return 0;
>> +
>> +	mutex_lock(&cdns->mutex);
>> +	ret =3D cdns->roles[role]->start(cdns);
>> +	if (!ret)
>> +		cdns->roles[role]->state =3D CDNSP_ROLE_STATE_ACTIVE;
>> +	mutex_unlock(&cdns->mutex);
>> +
>> +	return ret;
>> +}
...
>> +		return;
>> +
>> +	if (cdns->roles[role]->state =3D=3D CDNSP_ROLE_STATE_INACTIVE)
>> +		return;
>> +
>> +	mutex_lock(&cdns->mutex);
>> +	cdns->roles[role]->stop(cdns);
>> +	cdns->roles[role]->state =3D CDNSP_ROLE_STATE_INACTIVE;
>> +	mutex_unlock(&cdns->mutex);
>> +}
>> +
...
>> +
>> +	ret =3D cdnsp_drd_update_mode(cdns);
>> +	if (ret)
>> +		goto err;
>> +
>> +	/* Initialize idle role to start with. */
>> +	ret =3D cdnsp_role_start(cdns, USB_ROLE_NONE);
>> +	if (ret)
>> +		goto err;
>> +
>> +	switch (cdns->dr_mode) {
>> +	case USB_DR_MODE_OTG:
>> +		ret =3D cdnsp_hw_role_switch(cdns);
>> +		if (ret)
>> +			goto err;
>> +		break;
>> +	case USB_DR_MODE_PERIPHERAL:
>> +		ret =3D cdnsp_role_start(cdns, USB_ROLE_DEVICE);
>> +		if (ret)
>> +			goto err;
>> +		break;
>> +	case USB_DR_MODE_HOST:
>> +		ret =3D cdnsp_role_start(cdns, USB_ROLE_HOST);
>> +		if (ret)
>> +			goto err;
>> +		break;
>> +	default:
...
>> +
>> +/**
>> + * cdnsp_hw_role_state_machine  - role switch state machine based on hw=
 events.
...
>
>> +
>> +	id =3D cdnsp_get_id(cdns);
>> +	vbus =3D cdnsp_get_vbus(cdns);
>> +
>> +	/*
...
>> +		return -ENOMEM;
>> +
>> +	rdrv->start =3D cdnsp_idle_role_start;
>> +	rdrv->stop =3D cdnsp_idle_role_stop;
>> +	rdrv->state =3D CDNSP_ROLE_STATE_INACTIVE;
>> +	rdrv->suspend =3D NULL;
>> +	rdrv->resume =3D NULL;
>> +	rdrv->name =3D "idle";
>> +
>> +	cdns->roles[USB_ROLE_NONE] =3D rdrv;
>> +
>> +	return 0;
>> +}
>> +
...
>> +	real_role =3D cdnsp_hw_role_state_machine(cdns);
>> +
>> +	/* Do nothing if nothing changed. */
>> +	if (current_role =3D=3D real_role)
>> +		goto exit;
>> +
>> +	cdnsp_role_stop(cdns);
>> +
...
;
>> +
>> +	ret =3D cdnsp_role_start(cdns, real_role);
>> +	if (ret) {
>> +		/* Back to current role. */
>> +		dev_err(cdns->dev, "set %d has failed, back to %d\n",
>> +			real_role, current_role);
>> +		ret =3D cdnsp_role_start(cdns, current_role);
>> +		if (ret)
...
>> +{
>> +	struct cdnsp *cdns =3D usb_role_switch_get_drvdata(sw);
>> +
>> +	return cdns->role;
>> +}
>> +
...
>> + */
>> +static int cdnsp_role_set(struct usb_role_switch *sw, enum usb_role rol=
e)
>> +{
>> +	struct cdnsp *cdns =3D usb_role_switch_get_drvdata(sw);
>> +	int ret =3D 0;
...
>> +
>> +	cdnsp_role_stop(cdns);
>> +	ret =3D cdnsp_role_start(cdns, role);
>> +	if (ret) {
...
Driver still can support only Host side.=20
It can be configured as only Host, only Device or HOST +  DEVICE.=20
cdns->otg_irq is mandatory.=20
...
>> +
>> +	cdns->usb2_phy =3D devm_phy_optional_get(dev, "cdnsp,usb2-phy");
...
>> +		return ret;
>> +
>> +	cdns->usb3_phy =3D devm_phy_optional_get(dev, "cdnsp,usb3-phy");
...
>> +		goto err3;
>> +
>> +	sw_desc.set =3D cdnsp_role_set;
>> +	sw_desc.get =3D cdnsp_role_get;
...
>> +	}
>> +
>> +	ret =3D cdnsp_drd_init(cdns);
>> +	if (ret)
>> +		goto err5;
>> +
>> +	ret =3D cdnsp_core_init_role(cdns);
>> +	if (ret)
>> +		goto err5;
>> +
...
>> +{
>> +	struct cdnsp *cdns =3D platform_get_drvdata(pdev);
>> +
...
>> +{
>> +	struct cdnsp *cdns =3D dev_get_drvdata(dev);
>> +	unsigned long flags;
>> +
...
>> +#endif
>> +
>> +static const struct dev_pm_ops cdnsp_pm_ops =3D {
>> +	SET_SYSTEM_SLEEP_PM_OPS(cdnsp_suspend, cdnsp_resume)
>> +};
>> +
>> +#ifdef CONFIG_OF
>> +static const struct of_device_id of_cdnsp_match[] =3D {
>> +	{ .compatible =3D "cdns,usbssp" },
>> +	{ },
>> +};
>> +MODULE_DEVICE_TABLE(of, of_cdnsp_match);
>> +#endif
>> +
>> +static struct platform_driver cdnsp_driver =3D {
>> +	.probe		=3D cdnsp_probe,
>> +	.remove		=3D cdnsp_remove,
>> +	.driver		=3D {
>> +		.name	=3D "cdns-usbssp",
>> +		.of_match_table	=3D of_match_ptr(of_cdnsp_match),
>> +		.pm	=3D &cdnsp_pm_ops,
>> +	},
>> +};
>> +
...
>to its own line:
>
>	id =3D readl(&cdns->otg_regs->sts);
>	id &=3D OTGSTS_ID_VALUE;
>
...
>to
>
>+	if (cdnsp_get_id() =3D=3D MY_WHATEVER_IDENDTIFIER) {
>
>
...
>> +
>> +	ret =3D cdnsp_set_mode(cdns, USB_DR_MODE_OTG);
>> +	if (ret)
>> +		return ret;
>> +
...
>> +	switch (cdns->dr_mode) {
>> +	case USB_DR_MODE_PERIPHERAL:
>> +		ret =3D cdnsp_set_mode(cdns, USB_DR_MODE_PERIPHERAL);
>> +		break;
>> +	case USB_DR_MODE_HOST:
>> +		ret =3D cdnsp_set_mode(cdns, USB_DR_MODE_HOST);
>> +		break;
>> +	case USB_DR_MODE_OTG:
>> +		ret =3D cdnsp_init_otg_mode(cdns);
>> +		break;
>> +	default:
>> +		dev_err(cdns->dev, "Unsupported mode of operation %d\n",
>> +			cdns->dr_mode);
...
>> +	u32 state;
>> +
>> +	cdns->otg_regs =3D devm_ioremap_resource(cdns->dev, &cdns->otg_res);
...
>> +		ret =3D cdnsp_halt_endpoint(pdev, pep, true);
>> +
>> +		if (preq)
...
>> +		pdev->remote_wakeup_allowed =3D !!set;
>> +		break;
...
Yes,  I think that this request should be delegate to function.=20
I will fix it.
...
>> +		}
>> +
>> +		ret =3D cdnsp_halt_endpoint(pdev, pep, set);
>> +		break;
>> +	default:
...
>> +	 */
>> +	pdev->ep0_preq.request.length =3D 0x6;
>
...
>> +	}
>> +
>> +	ret =3D cdnsp_remove_request(pdev, preq, pep);
>> +
>> +	return ret;
>
...
>> +
>> +	ep_sts =3D GET_EP_CTX_STATE(pep->out_ctx);
>> +	new_add_flags =3D le32_to_cpu(ctrl_ctx->add_flags);
>> +	new_drop_flags =3D le32_to_cpu(ctrl_ctx->drop_flags);
>> +
...
>"event =3D pdev->event_ring->dequeue;"  Forever loop?

Yes, it's serious bug.  event should be initialized before while.=20
I don't know why it's never caused the problem during testing :)=20
...
>> +	temp =3D readl(&port_regs->portpmsc);
>> +	if (!(temp & PORT_RWE))
>> +		return 0;
>
...
>
>> +
>> +	temp =3D readl(&port_regs->portsc);
>> +	temp &=3D ~PORT_PLS_MASK;
...
>> +	struct cdnsp *cdns =3D dev_get_drvdata(pdev->dev);
>> +
>> +	if (!is_on) {
>> +		cdnsp_reset_device(pdev);
...
>> +
>> +	retval =3D cdnsp_mem_init(pdev, GFP_KERNEL);
>> +	if (retval)
>> +		return retval;
>> +
>> +	return 0;
...
Failure in this case doesn't guarantee that device will be detached or driv=
er
removed.=20
>
...
It can be called during changing role from device to host, device still=20
...
>> +		return -ENOMEM;
>> +
>> +	rdrv->start	=3D __cdnsp_host_init;
>> +	rdrv->stop	=3D cdnsp_host_exit;
>> +	rdrv->state	=3D CDNSP_ROLE_STATE_INACTIVE;
>> +	rdrv->name	=3D "host";
>> +
...
>> +	prev =3D cdnsp_segment_alloc(pdev, cycle_state,
>> +				   max_packet, flags);
>
...
>> +	num_segs =3D ring->num_segs > num_segs_needed ?
...
>> +	val |=3D ((val & ~MAX_DEVS) | CDNSP_DEV_MAX_SLOTS);
...
I agree with you, but in other hand I reuse the code that exist.=20
...
This function was borrowed for XHCI driver.  I think that there exist some =
bugged
...
I have to test it, but rather I haven't seen such cases.=20
>
>
>> +		return 0;
>> +
>> +	/* offset in TRBs */
>> +	segment_offset =3D trb - seg->trbs;
>> +	if (segment_offset >=3D TRBS_PER_SEGMENT)
>> +		return 0;
>> +
>> +	return seg->dma + (segment_offset * sizeof(*trb));
>> +}
...
>> +	if ((portsc & PORT_PLC)) {
>> +		if (link_state =3D=3D XDEV_RESUME) {
...
>> +					      pdev->link_state =3D=3D XDEV_U2 ||
>> +					      pdev->link_state =3D=3D XDEV_U1)) {
>> +			cdnsp_resume_gadget(pdev);
>> +		}
>> +
>> +		if (link_state =3D=3D XDEV_U1 && DEV_SUPERSPEED_ANY(portsc))
...
>> +			     int *status)
>> +{
>> +	struct cdnsp_request *preq =3D NULL;
>
...
Any Transfer event should be generated only for existing usb endpoint and  =
ep_ring.=20
ep_ring will be null only if there will be some bug in controller and
controller generate unexpected or incorrect event. During testing I've not =
seen=20
such case during testing.=20
...
.
It's not needed. I will remove default statement.=20
...
>> + * Returns >0 for "possibly more events to process" (caller should call=
 again),
>> + * otherwise 0 if done.
>> + */
...
>> +	event_ring_deq =3D pdev->event_ring->dequeue;
>> +
>> +	while ((ret =3D cdnsp_handle_event(pdev)) =3D=3D 1) {
>
...
>> +		trb_buff_len =3D min_t(unsigned int, trb_buff_len, block_len);
