...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 91DD6595B69
	for <lists+devicetree@lfdr.de>; Tue, 16 Aug 2022 14:10:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234245AbiHPMIm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 16 Aug 2022 08:08:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50152 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235196AbiHPMID (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 16 Aug 2022 08:08:03 -0400
Received: from mail-sh.amlogic.com (mail-sh.amlogic.com [58.32.228.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5E6CABFB;
        Tue, 16 Aug 2022 05:00:09 -0700 (PDT)
Received: from [10.18.29.47] (10.18.29.47) by mail-sh.amlogic.com (10.18.11.5)
 with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id 15.1.2507.9; Tue, 16 Aug
 2022 20:00:06 +0800
Message-ID: <8f40cb49-fdc5-20cd-343b-8ce50e5d6d97@amlogic.com>
Date:   Tue, 16 Aug 2022 20:00:05 +0800
MIME-Version: 1.0
...
In-Reply-To: <1jedxlzxyz.fsf@starbuckisacylon.baylibre.com>
...
On 2022/8/10 21:57, Jerome Brunet wrote:
> [ EXTERNAL EMAIL ]
> 
> 
...
Sorry, I forgot to change the name when I copied it. I will correct it.
> 
>>
...
I will change it according to your suggestion in the next patch.
...
AXI_CLK. You can see the comment above。
> 
...
gp0_pll are used by other specialized modules, vid_pll has 
CLK_SET_RATE_PARENT. The parent of vid_pll is that vid_pll_sel uses 
...
> 
I will delete CLK_SET_RATE_GATE .
>> +	},
>> +};
>> +
...
Same 
g12a.https://elixir.bootlin.com/linux/latest/source/drivers/clk/meson/g12a.c#L2818
> 
>> +	},
>> +};
>> +
...
debugging clock peripherals will not be used.
> 
