...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F2A606AA884
	for <lists+devicetree@lfdr.de>; Sat,  4 Mar 2023 08:14:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229547AbjCDHOi (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 4 Mar 2023 02:14:38 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60830 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229452AbjCDHOh (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 4 Mar 2023 02:14:37 -0500
X-Greylist: delayed 303 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Fri, 03 Mar 2023 23:14:33 PST
Received: from m239-7.eu.mailgun.net (m239-7.eu.mailgun.net [185.250.239.7])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8442514491
        for <devicetree@vger.kernel.org>; Fri,  3 Mar 2023 23:14:33 -0800 (PST)
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=hewittfamily.org.uk;
 q=dns/txt; s=s1; t=1677914071; x=1677921271; h=To: To: References:
 ...
 bh=X6MB24yYZgyV25yIVgAiAUwH/CNUMJ09e67LFz+X9sE=;
 b=
X-Mailgun-Sending-Ip: 185.250.239.7
X-Mailgun-Sid: WyIzZDI1OSIsImRldmljZXRyZWVAdmdlci5rZXJuZWwub3JnIiwiZTM3MjAiXQ==
Received: from mail.hewittfamily.org.uk (<unknown> [87.200.95.144]) by 90d6986d9796 with
 SMTP id 6402eea8eda7f746717104dd (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Sat, 04 Mar 2023 07:09:28 GMT
Sender: christian@hewittfamily.org.uk
Received: from smtpclient.apple (unknown [167.99.200.149])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.hewittfamily.org.uk (Postfix) with ESMTPSA id 2FCB07EBF38;
        Sat,  4 Mar 2023 11:09:21 +0400 (+04)
...
Date:   Sat, 4 Mar 2023 11:09:11 +0400
...
Message-Id: <CBE0CDB2-AADE-4A5B-936F-B728E53917CD@hewittfamily.org.uk>
...
X-Synology-Spam-Status: score=2.909, required 5, MID_RHS_MATCH_FROM 0, SUSPICIOUS_RECIPS 2.51, FROM_HAS_DN 0, TO_DN_SOME 0, MV_CASE 0.5, FREEMAIL_ENVRCPT 0, TAGGED_RCPT 0, __THREADED 0, MIME_GOOD -0.1, TO_MATCH_ENVRCPT_ALL 0, RCPT_COUNT_SEVEN 0, RCVD_COUNT_ZERO 0, FROM_EQ_ENVFROM 0, MIME_TRACE 0, __NOT_SPOOFED 0, __BODY_URI_ONLY 0, __HDRS_LCASE_KNOWN 0, NO_RECEIVED -0.001
