...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4EFEB74725E
	for <lists+devicetree@lfdr.de>; Tue,  4 Jul 2023 15:14:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231534AbjGDNON (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 4 Jul 2023 09:14:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35664 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231463AbjGDNOM (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 4 Jul 2023 09:14:12 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3071AE7A;
        Tue,  4 Jul 2023 06:14:00 -0700 (PDT)
X-UUID: a2eea93a1a6c11eeb20a276fd37b9834-20230704
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=4PpT0En8332hip6lOhrvR7/28VWHX1v3coJutIHIavU=;
        b=rNlU8gvsXuGDcY6HudpFWjBFXdq8eDn1n8F5eHU3ciMGklfIPhuImmTx7zDEVARJ5BIxVhJ70D43AL/nP632SQ9wBBOfsr/vIcuVoSAlt41SegVGDSwVIr0ZfuYx2MuZBLGRU9R9JZjqwbgt+wY0KDc4vMwz9wtyhUBQA8kn7Kk=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.27,REQID:d21261b7-0588-4cb3-9851-72b6650c8fae,IP:0,U
        RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Release_Ham,ACTI
        ON:release,TS:70
X-CID-INFO: VERSION:1.1.27,REQID:d21261b7-0588-4cb3-9851-72b6650c8fae,IP:0,URL
        :0,TC:0,Content:-25,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Spam_GS981B3D,ACTI
        ON:quarantine,TS:70
X-CID-META: VersionHash:01c9525,CLOUDID:8fc08d0d-26a8-467f-b838-f99719a9c083,B
        ulkID:2307042113595S17GKGK,BulkQuantity:0,Recheck:0,SF:38|29|28|17|19|48,T
...
Received: from mtkmbs10n1.mediatek.inc [(172.21.101.34)] by mailgw02.mediatek.com
        ...
        with ESMTP id 2075797076; Tue, 04 Jul 2023 21:13:58 +0800
Received: from mtkmbs11n2.mediatek.inc (172.21.101.187) by
 MTKMBS14N1.mediatek.inc (172.21.101.75) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26; Tue, 4 Jul 2023 21:13:57 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkmbs11n2.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.2.1118.26 via Frontend Transport; Tue, 4 Jul 2023 21:13:56 +0800
...
Subject: [PATCH v6,06/11] media: mediatek: vcodec: replace pr_* with dev_* for v4l2 debug message
Date:   Tue, 4 Jul 2023 21:13:44 +0800
Message-ID: <20230704131349.8354-7-yunfei.dong@mediatek.com>
...
@@ -306,7 +303,7 @@ int vdec_msg_queue_init(struct vdec_msg_queue *msg_queue,
 					     ctx->picinfo.buf_h);
...
@@ -316,20 +313,21 @@ int vdec_msg_queue_init(struct vdec_msg_queue *msg_queue,
...
@@ -337,14 +335,14 @@ int vdec_msg_queue_init(struct vdec_msg_queue *msg_queue,
...
@@ -360,7 +358,7 @@ int vdec_msg_queue_init(struct vdec_msg_queue *msg_queue,
