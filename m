...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 90E334BDE01
	for <lists+devicetree@lfdr.de>; Mon, 21 Feb 2022 18:46:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1379839AbiBUQFG (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 21 Feb 2022 11:05:06 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:48412 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1379836AbiBUQFF (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 21 Feb 2022 11:05:05 -0500
Received: from mx1.tq-group.com (mx1.tq-group.com [93.104.207.81])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7444426AF9
        for <devicetree@vger.kernel.org>; Mon, 21 Feb 2022 08:04:40 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=tq-group.com; i=@tq-group.com; q=dns/txt; s=key1;
  t=1645459480; x=1676995480;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=rCaGYFgFRY5m+tIvcUEcjuIzRCULtoDc7dr7t9jxujo=;
  b=k9OeDbn7uWc4anoIp7HXuld8ARpoRWbLu9bCzxSF+zp0U4rI7uD94Pso
   1XZuCqui0q5cAGs6HuZnObHBKZ52+P4SQ6sBV2O36vacX6mQG8D7TeAJc
   29esKUgos4kcehL3MShKB8TTzBB+9iZwmcdNi0DrTNsT0jeVqjgUv3AB0
   SkE8alDUSTS1JkcBFOHzgH4iXveDQu48XCqUx0cysSQk6cc22AATmz23/
   S+Rflzr8YvejFl6mlKAWai3IhL5gkh8hQSWxjQYddwWh5S/tLdKKIrJsT
   sLO7c5JgxTN/kr7LE90evpH8iF9cJC0JqARTBdU0tnUaZ/s5aJGKXKlBJ
   Q==;
X-IronPort-AV: E=Sophos;i="5.88,386,1635199200"; 
   d="scan'208";a="22216141"
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  ...
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=rCaGYFgFRY5m+tIvcUEcjuIzRCULtoDc7dr7t9jxujo=;
  b=Ju1y/NGGqid9qXqVrEI+jalFDbrh/vZIQ6mX4mT/2I4jRKr7O7PhYOzk
   3cInScrjWyYOWzZAGoj4iBZkevTrX0B+sc/4WpU5Ci7lDWWrxJtZ+aGRP
   dzx2quoeXCR5HlYLdLfjWx0eJE4Fg/w4fePYX13siXBmQwzYIDfw7AMj0
   x9ABl+WxDH9HTwcslXNVu5X6kBSNPfUftV0/dYSETOWPin1DXDLP2kgQO
   7D5DFcu0Ge5zIUebBZK9oGHGV4+p/ZZvECX3v1hV5bbAhtdB2tIl/pMyq
   s2DfCgsGwafHgeZHxTg4IDvkjAa1NQxL5h474GQDk4EQJkVnKua2atOwi
   Q==;
X-IronPort-AV: E=Sophos;i="5.88,386,1635199200"; 
   d="scan'208";a="22216140"
Received: from vtuxmail01.tq-net.de ([10.115.0.20])
  by mx1.tq-group.com with ESMTP; 21 Feb 2022 17:04:37 +0100
Received: from steina-w.tq-net.de (unknown [10.123.49.12])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (No client certificate requested)
        by vtuxmail01.tq-net.de (Postfix) with ESMTPSA id 3147A280065;
...
Subject: [PATCH v2 2/5] ARM: dts: imx6ul: add TQ-Systems MBa6ULx device trees
Date:   Mon, 21 Feb 2022 17:04:16 +0100
Message-Id: <20220221160419.550640-3-alexander.stein@ew.tq-group.com>
...
---
Changes in v2:
* Removed 'status' property for non-disabled devices
* Removed superfluous blank lines
* Removed doubled status = "disabled"
* Moved 'chosen' node up
* Removed unit-address for GPIO buttons
* Removed internal (und unsupported) SPI device node
* Removed QSPI flash partitions
* Rename audio-codec node name
...
new file mode 100644
index 000000000000..941f8725032c
--- /dev/null
