...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C45D36D0B58
	for <lists+devicetree@lfdr.de>; Thu, 30 Mar 2023 18:32:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229912AbjC3Qcm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 30 Mar 2023 12:32:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39278 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229680AbjC3Qcl (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 30 Mar 2023 12:32:41 -0400
Received: from mail-wr1-x42a.google.com (mail-wr1-x42a.google.com [IPv6:2a00:1450:4864:20::42a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C657ABDD3;
        Thu, 30 Mar 2023 09:32:34 -0700 (PDT)
Received: by mail-wr1-x42a.google.com with SMTP id t4so14472823wra.7;
        Thu, 30 Mar 2023 09:32:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112; t=1680193953;
        h=user-agent:in-reply-to:content-disposition:mime-version:references
         :message-id:subject:cc:to:from:date:from:to:cc:subject:date
         :message-id:reply-to;
        bh=35VCD4SXVJUp0Hlsfg/fAVWZvVtVAJghPfXDNf1WA8U=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1680193953;
        h=user-agent:in-reply-to:content-disposition:mime-version:references
         :message-id:subject:cc:to:from:date:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=35VCD4SXVJUp0Hlsfg/fAVWZvVtVAJghPfXDNf1WA8U=;
        b=
X-Gm-Message-State: AAQBX9cvZyAhOTr7mN9ERIICykENTTHwRFHTkVIlmGuaYMB/TawdsX/G
        N9zs9CAJwfF9OMVfYQMq8EemNVFCV3I=
X-Google-Smtp-Source: AKy350a1GCUz0PjS+h9p2d7mF0yE2x6bepOec10P+8MXKO6C5TGfqqcclz91hBU0Oj4RsGjTw4879w==
X-Received: by 2002:adf:f487:0:b0:2bf:bf05:85ac with SMTP id l7-20020adff487000000b002bfbf0585acmr4763264wro.23.1680193952888;
        Thu, 30 Mar 2023 09:32:32 -0700 (PDT)
Received: from orome (p200300e41f1c0800f22f74fffe1f3a53.dip0.t-ipconnect.de. [2003:e4:1f1c:800:f22f:74ff:fe1f:3a53])
        by smtp.gmail.com with ESMTPSA id c15-20020adffb0f000000b002c6e8cb612fsm33110515wrr.92.2023.03.30.09.32.32
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 30 Mar 2023 09:32:32 -0700 (PDT)
Date:   Thu, 30 Mar 2023 18:32:30 +0200
...
Message-ID: <ZCW5nuHXt7G1ety7@orome>
...
Content-Type: multipart/signed; micalg=pgp-sha256;
        protocol="application/pgp-signature"; boundary="/GY2I9QV6N1wTiTR"
Content-Disposition: inline
In-Reply-To: <0b39b19e-e5ee-2751-cd57-68278354da5f@linaro.org>
...
--/GY2I9QV6N1wTiTR
Content-Type: multipart/mixed; boundary="eYUDQjZ24OU9AQgg"
Content-Disposition: inline
...
> >>>>>> <jonathanh@nvidia.com>; linus.walleij@linaro.org; robh+dt@kernel.o=
rg;
> >>>>>> krzysztof.kozlowski+dt@linaro.org; devicetree@vger.kernel.org; lin=
ux-
> >>>>>> tegra@vger.kernel.org; linux-gpio@vger.kernel.org; Suresh Mangipudi
> >>>>>> <smangipudi@nvidia.com>
> >>>>>> Subject: Re: [PATCH 1/3] dt-bindings: pinctrl: tegra234: Add DT bi=
nding doc
> >>>>>>
...
> >>>>>>> On Tue, Feb 07, 2023 at 04:33:08PM +0100, Krzysztof Kozlowski wro=
te:
> >>>>>>
> >>>>>>
> >>>>>>>>> +          type: object
...
contains the name
> >>>>>>>>> +                  of a pin or group. Valid values for these na=
mes are listed
> >>>>>>>>> +                  below.
> >>>>>>>>
> >>>>>>>> Define properties in top level, which points to the complexity of
> >>>>>>>> your if-else, thus probably this should be split into two bindin=
gs.
> >>>>>>>> Dunno, your other bindings repeat this pattern :(
> >>>>>>>
> >>>>>>> The property itself is already defined in the common schema found=
 in
...
> >>>>>>> attempted to roll all Tegra pinctrl bindings into a single dt-sch=
ema,
> >>>>>>> but that turned out truly horrible =3D) Splitting this into per-S=
oC
...
> >>>>>> patternProperties(pinmux) and nvidia,pins. And an example. Maybe I=
 miss
> >>>>>> something but I would say this would create many but very easy to =
read
> >>>>>> bindings, referencing common pieces.
> >>>>>>
> >>>>>>> though splitting
> >>>>>>> off the common bits into nvidi,tegra-pinmux-common.yaml helps a b=
it
> >>>>>>> with that already. Splitting this into per-instance bindings would
> >>>>>>> effectively duplicate everything but the pin array here, so we ki=
nd of
...
> >>>>>> nvidia,pins.
> >>>>> This is inline with the existing bindings and I think this is the c=
ompromise that was reached during review when the bindings were submitted,
> >>>>
> >>>> So the code might be totally unreadable, but it is inline with exist=
ing
...
> >>>
> >>>>> offer to rework if a better alternative can be found, but that only=
 makes sense if all the other bindings get changed as well, so I think it'd=
 be good if we can merge in the same format as the existing bindings for no=
w and change all of them later on.
> >>>>
> >>>> Cleanup should happen before adding new bindings.
> >>>
> >>> I don't recall the exact problems that I ran into last time, but I do
> >>> remember that pulling out the common bindings to the very top-level w=
as
> >>> the main issue.
> >>>
...
> >> problem is reluctance to change it with argument "existing bindings al=
so
...
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline;
	filename="0001-dt-bindings-pinctrl-tegra234.patch"
Content-Transfer-Encoding: quoted-printable

=46rom 00cb909f6d8732680d65cdb67e0573c8e6dc7b7a Mon Sep 17 00:00:00 2001
=46rom: Prathamesh Shete <pshete@nvidia.com>
...
---
 ...
 create mode 100644 Documentation/devicetree/bindings/pinctrl/nvidia,tegra2=
34-pinmux-aon.yaml
 create mode 100644 Documentation/devicetree/bindings/pinctrl/nvidia,tegra2=
34-pinmux-common.yaml
 create mode 100644 Documentation/devicetree/bindings/pinctrl/nvidia,tegra2=
34-pinmux.yaml

diff --git a/Documentation/devicetree/bindings/pinctrl/nvidia,tegra234-pinm=
ux-aon.yaml b/Documentation/devicetree/bindings/pinctrl/nvidia,tegra234-pin=
mux-aon.yaml
new file mode 100644
index 000000000000..9d7017a39408
--- /dev/null
+++ b/Documentation/devicetree/bindings/pinctrl/nvidia,tegra234-pinmux-aon.=
yaml
@@ -0,0 +1,61 @@
...
+...
diff --git a/Documentation/devicetree/bindings/pinctrl/nvidia,tegra234-pinm=
ux-common.yaml b/Documentation/devicetree/bindings/pinctrl/nvidia,tegra234-=
pinmux-common.yaml
new file mode 100644
index 000000000000..a09d050b7d37
--- /dev/null
+++ b/Documentation/devicetree/bindings/pinctrl/nvidia,tegra234-pinmux-comm=
on.yaml
@@ -0,0 +1,65 @@
+# SPDX-License-Identifier: (GPL-2.0-only OR BSD-2-Clause)
+%YAML 1.2
+---
+$id: http://devicetree.org/schemas/pinctrl/nvidia,tegra234-pinmux-common.y=
aml#
+$schema: http://devicetree.org/meta-schemas/core.yaml#
+
...
+      properties:
+        nvidia,function:
+          enum: [ gp, uartc, i2c8, spi2, i2c2, can1, can0, rsvd0, eth0, et=
h2,
+                  eth1, dp, eth3, i2c4, i2c7, i2c9, eqos, pe2, pe1, pe0, p=
e3,
+                  pe4, pe5, pe6, pe7, pe8, pe9, pe10, qspi0, qspi1, qpsi,
+                  sdmmc1, sce, soc, gpio, hdmi, ufs0, spi3, spi1, uartb, u=
arte,
+                  usb, extperiph2, extperiph1, i2c3, vi0, i2c5, uarta, uar=
td,
+                  i2c1, i2s4, i2s6, aud, spi5, touch, uartj, rsvd1, wdt, t=
sc,
+                  dmic3, led, vi0_alt, i2s5, nv, extperiph3, extperiph4, s=
pi4,
+                  ccla, i2s1, i2s2, i2s3, i2s8, rsvd2, dmic5, dca, display=
b,
+                  displaya, vi1, dcb, dmic1, dmic4, i2s7, dmic2, dspk0, rs=
vd3,
...
+...
diff --git a/Documentation/devicetree/bindings/pinctrl/nvidia,tegra234-pinm=
ux.yaml b/Documentation/devicetree/bindings/pinctrl/nvidia,tegra234-pinmux.=
yaml
new file mode 100644
...
+                    uart2_rx_px5, uart2_rts_px6, uart2_cts_px7, spi3_sck_p=
y0,
...

=t8LG
-----END PGP SIGNATURE-----
