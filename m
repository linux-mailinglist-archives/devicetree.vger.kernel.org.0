...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A2DDF5F850E
	for <lists+devicetree@lfdr.de>; Sat,  8 Oct 2022 13:42:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229714AbiJHLmm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 8 Oct 2022 07:42:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35558 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229609AbiJHLmj (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 8 Oct 2022 07:42:39 -0400
Received: from mail.pr-group.ru (mail.pr-group.ru [178.18.215.3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8D2DC476C5;
        Sat,  8 Oct 2022 04:42:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
        d=metrotek.ru; s=mail;
        h=from:subject:date:message-id:to:cc:mime-version:content-transfer-encoding:
         in-reply-to:references;
        bh=rjO67t+zXmKxIB0eX8qQDBRCOgOsyNwALgCiCSqBL1I=;
        b=
X-Kerio-Anti-Spam:  Build: [Engines: 2.16.4.1445, Stamp: 3], Multi: [Enabled, t: (0.000019,0.062602)], BW: [Enabled, t: (0.000024,0.000001)], RTDA: [Enabled, t: (0.080030), Hit: No, Details: v2.42.0; Id: 15.52ka9q.1germeoim.9p7te; mclb], total: 0(700)
...
Subject: [PATCH v15 1/2] fpga: lattice-sysconfig-spi: add Lattice sysCONFIG FPGA manager
Date:   Sat,  8 Oct 2022 14:14:18 +0300
Message-Id: <20221008111419.21245-2-i.bornyakov@metrotek.ru>
