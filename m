...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B3D971C969
	for <lists+devicetree@lfdr.de>; Tue, 14 May 2019 15:29:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725854AbfENN2i (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 14 May 2019 09:28:38 -0400
Received: from node.akkea.ca ([192.155.83.177]:47012 "EHLO node.akkea.ca"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726251AbfENN2c (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Tue, 14 May 2019 09:28:32 -0400
Received: from localhost (localhost [127.0.0.1])
        by node.akkea.ca (Postfix) with ESMTP id 933EE4E2056;
        Tue, 14 May 2019 13:28:31 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=akkea.ca; s=mail;
        t=1557840511; bh=12uWBr2PDcvZv+QQV5FXIKirNFbsN2k9XEjCxlIyUTg=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References;
        b=I5abSzn5rs/+EH6P6+fH8sbxfbnx+MHMkfACfQY1QpI0j+ulH120rsfRaffrN0zdG
         Rgifk+Y1+oVHvQypGfYar8j4fDY/PeYYdZbgGSkGqD87S6g0gGVWNgqG/mH7PDEZpz
         1QFypubcqRJAwFrrp36QT9WQPaS9jj+Np772kGw4=
X-Virus-Scanned: Debian amavisd-new at mail.akkea.ca
Received: from node.akkea.ca ([127.0.0.1])
        by localhost (mail.akkea.ca [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id RkrqbgstNspu; Tue, 14 May 2019 13:28:29 +0000 (UTC)
Received: from midas.localdomain (S0106788a2041785e.gv.shawcable.net [70.66.86.75])
        by node.akkea.ca (Postfix) with ESMTPSA id 338804E204B;
        Tue, 14 May 2019 13:28:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=akkea.ca; s=mail;
        t=1557840509; bh=12uWBr2PDcvZv+QQV5FXIKirNFbsN2k9XEjCxlIyUTg=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References;
        b=HXcUADiqU5K2PDqzRyX/8hLdF8mp1vY4fAFgJwA7X3V0ZDdjjgG7I5h9Qaqxs9S4T
         XOnRenJ5amk+lYWcrvskQPmjPuyqBlHgVIn9G3ONs4/v8oioKdRtDRYTgAN/rokgp9
         9OKgolcUZePCEWIf2yY4Iwte6jKY14zouGUoXb3M=
...
Subject: [PATCH v12 2/4] arm64: dts: fsl: librem5: Add a device tree for the Librem5 devkit
Date:   Tue, 14 May 2019 06:28:20 -0700
Message-Id: <20190514132822.27023-3-angus@akkea.ca>
