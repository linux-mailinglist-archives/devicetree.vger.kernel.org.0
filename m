...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 696DE584BD1
	for <lists+devicetree@lfdr.de>; Fri, 29 Jul 2022 08:28:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234869AbiG2G04 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 29 Jul 2022 02:26:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43236 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234873AbiG2G0x (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 29 Jul 2022 02:26:53 -0400
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5AEBF6E899;
        Thu, 28 Jul 2022 23:26:47 -0700 (PDT)
X-UUID: 34ae4f76e35c45fe912a156a28051968-20220729
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.8,REQID:f66c2ac0-2888-4263-af76-09299f279f50,OB:0,LO
        B:50,IP:0,URL:5,TC:0,Content:-5,EDM:0,RT:0,SF:95,FILE:0,RULE:Release_Ham,A
        CTION:release,TS:95
X-CID-INFO: VERSION:1.1.8,REQID:f66c2ac0-2888-4263-af76-09299f279f50,OB:0,LOB:
        50,IP:0,URL:5,TC:0,Content:-5,EDM:0,RT:0,SF:95,FILE:0,RULE:Spam_GS981B3D,A
        CTION:quarantine,TS:95
X-CID-META: VersionHash:0f94e32,CLOUDID:20aaa9d0-841b-4e95-ad42-8f86e18f54fc,C
        OID:01617ddd0c3b,Recheck:0,SF:28|17|19|48,TC:nil,Content:0,EDM:-3,IP:nil,U
        RL:1,File:nil,QS:nil,BEC:nil,COL:0
X-UUID: 34ae4f76e35c45fe912a156a28051968-20220729
Received: from mtkcas11.mediatek.inc [(172.21.101.40)] by mailgw01.mediatek.com
        (envelope-from <irui.wang@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 1489989768; Fri, 29 Jul 2022 14:26:41 +0800
Received: from mtkmbs11n1.mediatek.inc (172.21.101.185) by
 mtkmbs11n1.mediatek.inc (172.21.101.185) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.792.15; Fri, 29 Jul 2022 14:26:39 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkmbs11n1.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.2.792.15 via Frontend
 Transport; Fri, 29 Jul 2022 14:26:38 +0800
...
Subject: [V12,5/7] mtk-jpegenc: add jpeg encode worker interface
Date:   Fri, 29 Jul 2022 14:26:28 +0800
Message-ID: <20220729062630.5592-6-irui.wang@mediatek.com>
...
index 690d0e676481..88e3ac098a7c 100644
...
+
 	...
 	v4l2_fh_add(&ctx->fh);
@@ -1508,6 +1674,17 @@ static const struct mtk_jpeg_variant mtk_jpeg_drvdata = {
...
+
 ...
 static const struct of_device_id mtk_jpeg_match[] = {
 	{
@@ -1522,6 +1699,10 @@ static const struct of_device_id mtk_jpeg_match[] = {
...
index caa9370ac8ac..36bdcd0f1cf9 100644
