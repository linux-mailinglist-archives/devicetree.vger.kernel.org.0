...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 22F443BFAB4
	for <lists+devicetree@lfdr.de>; Thu,  8 Jul 2021 14:54:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231519AbhGHM5M (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 8 Jul 2021 08:57:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56030 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230433AbhGHM5M (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 8 Jul 2021 08:57:12 -0400
Received: from lahtoruutu.iki.fi (lahtoruutu.iki.fi [IPv6:2a0b:5c81:1c1::37])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0B9E4C061574;
        Thu,  8 Jul 2021 05:54:29 -0700 (PDT)
Received: from hillosipuli.retiisi.eu (dbdx-ftd5cf51mv6xr7xy-3.rev.dnainternet.fi [IPv6:2001:14ba:8e7:f240:7911:3355:4753:76e6])
        ...
        by lahtoruutu.iki.fi (Postfix) with ESMTPSA id 43AC91B00046;
        Thu,  8 Jul 2021 15:54:25 +0300 (EEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=iki.fi; s=lahtoruutu;
        t=1625748865;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=eyU4MWyhDXvpOi4mNOhJCefcoLfFxwpLY0qXOIyKWTY=;
        b=
Received: from valkosipuli.localdomain (valkosipuli.localdomain [IPv6:fd35:1bc8:1a6:d3d5::80:2])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by hillosipuli.retiisi.eu (Postfix) with ESMTPS id E02A7634C87;
        Thu,  8 Jul 2021 15:53:45 +0300 (EEST)
Received: from localhost ([127.0.0.1] helo=valkosipuli.retiisi.eu)
        by valkosipuli.localdomain with esmtp (Exim 4.92)
        (envelope-from <sakari.ailus@iki.fi>)
        id 1m1TXs-0001zR-5D; Thu, 08 Jul 2021 15:54:24 +0300
Date:   Thu, 8 Jul 2021 15:54:24 +0300
...
Subject: Re: [PATCH v6 3/5] media: i2c: add driver for the SK Hynix Hi-846 8M
 pixel camera
Message-ID: <20210708125424.GY3@valkosipuli.retiisi.eu>
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=iki.fi;
        s=lahtoruutu; t=1625748865;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=eyU4MWyhDXvpOi4mNOhJCefcoLfFxwpLY0qXOIyKWTY=;
        b=
ARC-Authentication-Results: i=1;
        ORIGINATING;
        auth=pass smtp.auth=sailus smtp.mailfrom=sakari.ailus@iki.fi
ARC-Seal: i=1; s=lahtoruutu; d=iki.fi; t=1625748865; a=rsa-sha256;
        cv=none;
        b=
Precedence: bulk
...
> index 2c5dc7d20d81..e10783523636 100644
> --- a/MAINTAINERS
> +++ b/MAINTAINERS
> @@ -8579,6 +8579,12 @@ S:	Maintained
...
> index 588f8eb95984..5b020d05960c 100644
> --- a/drivers/media/i2c/Kconfig
> +++ b/drivers/media/i2c/Kconfig
> @@ -753,6 +753,19 @@ config VIDEO_IMX208
...
> index 1168fa6b84ed..303cd7bc4e66 100644
...
> index 000000000000..4b660ef9284e
> --- /dev/null
...
> +	hi846_write_reg_16(hi846, HI846_REG_LLP, HI846_LINE_LENGTH & 0xFFFF, &ret);

Could you wrap the lines over 80, unless you have a sound reason to keep
them longer, please?
...
This needs to be taken into account when the mode is selected, not at the
time when streaming is about to start.
...
If you can't change it, then the values related to a given mode should be
returned for CROP and CROP_DEFAULT, and these values here for BOUNDS.
Please also add NATIVE_SIZE rectangle, same values as BOUNDS here.
...
Could you add a check here for the supported link frequencies? This is
generally a property of the board, not the sensor. See e.g. imx290 driver
for an example.
...
> +	}
> +
> +	hi846->shutdown_gpio = devm_gpiod_get_optional(dev, "shutdown", GPIOD_OUT_LOW);
...
> +	if (ret) {
> +		dev_err(&client->dev, "failed to check HW configuration: %d", ret);
> +		return ret;
> +	}
> +
