...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 800F631EBCC
	for <lists+devicetree@lfdr.de>; Thu, 18 Feb 2021 16:52:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232689AbhBRPtO (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 18 Feb 2021 10:49:14 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47738 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231792AbhBROiK (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 18 Feb 2021 09:38:10 -0500
Received: from mail-io1-xd35.google.com (mail-io1-xd35.google.com [IPv6:2607:f8b0:4864:20::d35])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6B92DC061574;
        Thu, 18 Feb 2021 06:37:25 -0800 (PST)
Received: by mail-io1-xd35.google.com with SMTP id u20so2179405iot.9;
        Thu, 18 Feb 2021 06:37:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=c1NAyByYx0K9nJ4aLBJ/gBfw+jZ7u+HZBVAvDgmza3E=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=c1NAyByYx0K9nJ4aLBJ/gBfw+jZ7u+HZBVAvDgmza3E=;
        b=
X-Gm-Message-State: AOAM5326vj31jF56hJYUF7CZAfp3L3+A4Qb4qd9kqEa6B4WwH8/btrE6
        zi4/TXk2NKbjM8oxzcD/RNJT7oYwpltwSD2iEE0=
X-Google-Smtp-Source: ABdhPJzIROu/HmLcc2/s4Nmn12CLIeqOwFXBLX0dy0zWOq6VxdSxEC6nPOyqDmaQQn2uBFEdICdYjubwdG/gv1X49wk=
X-Received: by 2002:a6b:8f97:: with SMTP id r145mr3801422iod.133.1613659044506;
 Thu, 18 Feb 2021 06:37:24 -0800 (PST)
MIME-Version: 1.0
References: <20210218123327.25486-1-heiko.thiery@gmail.com>
 <20210218123327.25486-3-heiko.thiery@gmail.com> <f797ddd4cb16ccbf0c0deb42682bb8ae@walle.cc>
In-Reply-To: <f797ddd4cb16ccbf0c0deb42682bb8ae@walle.cc>
From:   Heiko Thiery <heiko.thiery@gmail.com>
Date:   Thu, 18 Feb 2021 15:37:12 +0100
Message-ID: <CAEyMn7YcLrArM5EWYA7tsnE8zMRROz-DaO8sVPX6Gv=+PszVPQ@mail.gmail.com>
...
Am Do., 18. Feb. 2021 um 13:50 Uhr schrieb Michael Walle <michael@walle.cc>:
>
...
This regulator is not used on the board. Shall I set the name to 'NC'
or is there a way to completely disable this one?
...
The codec is not used yet in the dtb. As I saw on an other board
(imx8mn-var-som.dtsi) there was also just a placeholder. I can also
add an comment here.
...
About the order I did not checked correctly. I can bring this in the
right order for sure. But about the needs I hope someone from e.g.
from NXP can give a hint.
...
I wait for more review comments before sending a new version.
