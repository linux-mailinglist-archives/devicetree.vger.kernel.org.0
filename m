...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EF7376F3D4A
	for <lists+devicetree@lfdr.de>; Tue,  2 May 2023 08:18:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233326AbjEBGSP (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 2 May 2023 02:18:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41628 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229586AbjEBGSO (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 2 May 2023 02:18:14 -0400
Received: from lelv0142.ext.ti.com (lelv0142.ext.ti.com [198.47.23.249])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BB83B4C20;
        Mon,  1 May 2023 23:17:46 -0700 (PDT)
Received: from fllv0034.itg.ti.com ([10.64.40.246])
        by lelv0142.ext.ti.com (8.15.2/8.15.2) with ESMTP id 3426GxxZ107944;
        Tue, 2 May 2023 01:16:59 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1683008219;
        bh=t7G5DQqzA9cFhdlXtzLRRzEYIhPJBh/G6RUV6EyYz8I=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=qqxE5UaNM/qcarZ+cn+RGJf725fK5vV/Lry0drulOSsbSG0NTt9gHlSP3+8koIB4D
         EONB5IiKTLbVZVJrML9PvLFxEpmJ6rb98ZIOHU8lKKrNUQxxMvNEhP+43KjBlYMDfy
         7biIzmGqjuksU96eOvzGqGhG7DkL2dFxAL59v+Og=
Received: from DFLE103.ent.ti.com (dfle103.ent.ti.com [10.64.6.24])
        by fllv0034.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 3426GxZB048903
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Tue, 2 May 2023 01:16:59 -0500
Received: from DFLE110.ent.ti.com (10.64.6.31) by DFLE103.ent.ti.com
 (10.64.6.24) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23; Tue, 2
 May 2023 01:16:59 -0500
Received: from fllv0039.itg.ti.com (10.64.41.19) by DFLE110.ent.ti.com
 (10.64.6.31) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23 via
 Frontend Transport; Tue, 2 May 2023 01:16:58 -0500
Received: from fllv0122.itg.ti.com (fllv0122.itg.ti.com [10.247.120.72])
        by fllv0039.itg.ti.com (8.15.2/8.15.2) with ESMTP id 3426Gwmc099317;
        Tue, 2 May 2023 01:16:58 -0500
Received: from localhost (uda0501179.dhcp.ti.com [10.24.69.114])
        by fllv0122.itg.ti.com (8.14.7/8.14.7) with ESMTP id 3426Gva4015267;
        Tue, 2 May 2023 01:16:57 -0500
...
Subject: [RFC PATCH v7 2/2] net: ti: icssg-prueth: Add ICSSG ethernet driver
Date:   Tue, 2 May 2023 11:46:50 +0530
Message-ID: <20230502061650.2716736-3-danishanwar@ti.com>
...
---
 ...
 11 files changed, 3961 insertions(+)
...
index 000000000000..7d16916f6b62
--- /dev/null
...
+};
+
+/* These are the offset values for miig_rt_offsets resgisters */
...
new file mode 100644
index 000000000000..34a96e49f456
--- /dev/null
...
new file mode 100644
index 000000000000..4e70f50921ee
--- /dev/null
...
new file mode 100644
index 000000000000..db7144665b09
--- /dev/null
...
new file mode 100644
index 000000000000..1bffb4545b6f
--- /dev/null
...
new file mode 100644
index 000000000000..60abc11dd176
--- /dev/null
...
new file mode 100644
index 000000000000..138a7a1c96a2
--- /dev/null
