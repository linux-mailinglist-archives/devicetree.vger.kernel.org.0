...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3699C6BE5DE
	for <lists+devicetree@lfdr.de>; Fri, 17 Mar 2023 10:48:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229943AbjCQJsE (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 17 Mar 2023 05:48:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39528 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229826AbjCQJr4 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 17 Mar 2023 05:47:56 -0400
Received: from phobos.denx.de (phobos.denx.de [85.214.62.61])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6896A442D7
        for <devicetree@vger.kernel.org>; Fri, 17 Mar 2023 02:47:54 -0700 (PDT)
Received: from tr.lan (ip-86-49-120-218.bb.vodafone.cz [86.49.120.218])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (No client certificate requested)
        (Authenticated sender: marex@denx.de)
        by phobos.denx.de (Postfix) with ESMTPSA id 852D08598A;
        Fri, 17 Mar 2023 10:47:51 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=denx.de;
        s=phobos-20191101; t=1679046472;
        bh=vilRcHomfLkpoVzMDXwVkdgFzwylY9xsCBk4zVNKwQg=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v3 2/2] arm64: dts: imx8mp: Add support for DH electronics i.MX8M Plus DHCOM and PDK3
Date:   Fri, 17 Mar 2023 10:47:25 +0100
Message-Id: <20230317094725.48305-2-marex@denx.de>
...
---
V2: - Rename clk-xtal25 node name to clock-xtal25
    - Rename i2cmux@ to i2c-mux@
    - Rename clk@6b node to clock@6b
    - Drop so far unused clock-codec
    - Drop status = "okay" from typec@3d and ethernet-phy@7 nodes
V3: - Switch PCIe to fixed-clock source until Si521xx driver lands,
      this is OK since the Si521xx is always on anyway and the I2C
      interface is only used to tune it if necessary, which it is
      not on this board.
---
...
index 836dcc501e6f8..00af4f0ea31e0 100644
