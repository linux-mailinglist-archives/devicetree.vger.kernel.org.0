...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CE0D84BF481
	for <lists+devicetree@lfdr.de>; Tue, 22 Feb 2022 10:17:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230136AbiBVJQq (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 22 Feb 2022 04:16:46 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55046 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230134AbiBVJQo (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 22 Feb 2022 04:16:44 -0500
Received: from cpanel.siel.si (cpanel.siel.si [46.19.9.99])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C0A72108BC9
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=norik.com;
        ...
        bh=c+dwypSoZexbQyQjPRQkoyCQu5SReIB4AxeIwrfhAwQ=; b=V/ZDqhk/+v+eTg9skpCrvHNJ5V
        ;
Received: from [89.212.21.243] (port=33310 helo=localhost.localdomain)
        by cpanel.siel.si with esmtpsa  (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
        (Exim 4.94.2)
        (envelope-from <andrej.picej@norik.com>)
        id 1nMRHA-001d57-8Z; Tue, 22 Feb 2022 10:16:12 +0100
...
Subject: [PATCH v2 2/3] ARM: dts: imx6ull: Add support for PHYTEC phyGATE-Tauri-S with i.MX 6ULL
Date:   Tue, 22 Feb 2022 10:16:05 +0100
Message-Id: <20220222091606.530581-3-andrej.picej@norik.com>
