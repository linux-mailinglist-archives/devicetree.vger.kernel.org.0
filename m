...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3F5CC607E03
	for <lists+devicetree@lfdr.de>; Fri, 21 Oct 2022 20:01:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229941AbiJUSA7 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 21 Oct 2022 14:00:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56700 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229929AbiJUSA6 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 21 Oct 2022 14:00:58 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D37FC27A890;
        Fri, 21 Oct 2022 11:00:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666375254; x=1697911254;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=9vOBUhlkPyQsI4GGIJhSHu2epsMOojD3gfNHqG899uA=;
  b=ZucVOWcTSDwzNvwhZhTD+4fAKbDFcu0vwPoriZ599nTwy2sGqUffA9Bw
   1A5ocg4SKHR7icdPvYk5WsupwFVN7IQPx/ffLVUYFAr1gH/j1HSGKYAIC
   FrcOD/tih8MEzeYlRNCnBns1RRgJqdNQZ34Rn9/V5hOOncN2BfaLMeb7k
   Zi4+TRb37w9kvqYpz6UAqVvW1dKQz+a1QIxEsRCTFtcNZLjB/IW+mQvO6
   lc2t0yCCfP16XRipHNLA3XgN/6ESJQCv/u9KL/zm26KaQ/91lZ75SRz3R
   bBtCs60h3imDZvPk8gps3M5L/aCmq6w58YGJ2zJZKv8AU4wjCGPynRxDv
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10507"; a="308163502"
X-IronPort-AV: E=Sophos;i="5.95,202,1661842800"; 
   d="scan'208";a="308163502"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 21 Oct 2022 11:00:51 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10507"; a="719825958"
X-IronPort-AV: E=Sophos;i="5.95,202,1661842800"; 
   d="scan'208";a="719825958"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by FMSMGA003.fm.intel.com with ESMTP; 21 Oct 2022 11:00:46 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1olwK6-0002qW-03;
        Fri, 21 Oct 2022 18:00:46 +0000
Date:   Sat, 22 Oct 2022 01:59:45 +0800
...
Subject: Re: [PATCH net-next v5 2/5] net: ipqess: introduce the Qualcomm
 IPQESS driver
Message-ID: <202210220120.50uv2XtD-lkp@intel.com>
References: <20221021124556.100445-3-maxime.chevallier@bootlin.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Ori+mrJDTdRLS2z3"
...
patch link:    https://lore.kernel.org/r/20221021124556.100445-3-maxime.chevallier%40bootlin.com
patch subject: [PATCH net-next v5 2/5] net: ipqess: introduce the Qualcomm IPQESS driver
config: x86_64-allyesconfig
compiler: gcc-11 (Debian 11.3.0-8) 11.3.0
reproduce (this is a W=1 build):
        # https://github.com/intel-lab-lkp/linux/commit/0444279489c24f9afd9b1fb11bd1a927053b73e0
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Maxime-Chevallier/net-ipqess-introduce-Qualcomm-IPQESS-driver/20221021-204717
        git checkout 0444279489c24f9afd9b1fb11bd1a927053b73e0
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        make W=1 O=build_dir ARCH=x86_64 SHELL=/bin/bash drivers/net/ethernet/qualcomm/ipqess/
...
>> drivers/net/ethernet/qualcomm/ipqess/ipqess.c:1189:29: warning: cast from pointer to integer of different size [-Wpointer-to-int-cast]
    1189 |         netdev->base_addr = (u32)ess->hw_addr;
         |                             ^
