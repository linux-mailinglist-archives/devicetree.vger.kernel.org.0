...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A520A4CF200
	for <lists+devicetree@lfdr.de>; Mon,  7 Mar 2022 07:38:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235633AbiCGGjS (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 7 Mar 2022 01:39:18 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33670 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235621AbiCGGjM (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 7 Mar 2022 01:39:12 -0500
Received: from inva020.nxp.com (inva020.nxp.com [92.121.34.13])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5B6D92183D;
        Sun,  6 Mar 2022 22:38:18 -0800 (PST)
Received: from inva020.nxp.com (localhost [127.0.0.1])
        by inva020.eu-rdc02.nxp.com (Postfix) with ESMTP id 0A5871A20F0;
        Mon,  7 Mar 2022 07:38:17 +0100 (CET)
Received: from aprdc01srsp001v.ap-rdc01.nxp.com (aprdc01srsp001v.ap-rdc01.nxp.com [165.114.16.16])
        by inva020.eu-rdc02.nxp.com (Postfix) with ESMTP id 778771A0EE0;
        Mon,  7 Mar 2022 07:38:16 +0100 (CET)
Received: from localhost.localdomain (shlinux2.ap.freescale.net [10.192.224.44])
        by aprdc01srsp001v.ap-rdc01.nxp.com (Postfix) with ESMTP id A08F0183AC94;
        Mon,  7 Mar 2022 14:38:14 +0800 (+08)
...
Subject: [PATCH v1 3/7] phy: freescale: imx8m-pcie: Add iMX8MP PCIe PHY support
Date:   Mon,  7 Mar 2022 14:29:12 +0800
Message-Id: <1646634556-23779-4-git-send-email-hongxing.zhu@nxp.com>
...
index 04b1aafb29f4..fbaec72d9143 100644
...
@@ -67,6 +133,87 @@ static int imx8_pcie_phy_init(struct phy *phy)
...
@@ -91,42 +238,30 @@ static int imx8_pcie_phy_init(struct phy *phy)
 	regmap_update_bits(imx8_phy->iomuxc_gpr, IOMUXC_GPR14,
...
@@ -153,18 +288,33 @@ static const struct phy_ops imx8_pcie_phy_ops = {
 	.owner		= THIS_MODULE,
 };
...
@@ -201,6 +351,22 @@ static int imx8_pcie_phy_probe(struct platform_device *pdev)
...
@@ -218,12 +384,6 @@ static int imx8_pcie_phy_probe(struct platform_device *pdev)
