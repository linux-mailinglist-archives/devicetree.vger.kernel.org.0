...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 76E3D6CFFBC
	for <lists+devicetree@lfdr.de>; Thu, 30 Mar 2023 11:23:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230112AbjC3JXN (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 30 Mar 2023 05:23:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52474 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229895AbjC3JXM (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 30 Mar 2023 05:23:12 -0400
Received: from mail-wr1-x435.google.com (mail-wr1-x435.google.com [IPv6:2a00:1450:4864:20::435])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E58EC6EAD
        for <devicetree@vger.kernel.org>; Thu, 30 Mar 2023 02:23:08 -0700 (PDT)
Received: by mail-wr1-x435.google.com with SMTP id l12so18328240wrm.10
        for <devicetree@vger.kernel.org>; Thu, 30 Mar 2023 02:23:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1680168187;
        h=content-transfer-encoding:in-reply-to:organization:references:cc:to
         :content-language:subject:reply-to:from:user-agent:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=zVbJBPOpKkbhGyx27wqJIbibuzsS8krruWYUofYY0Zk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1680168187;
        h=content-transfer-encoding:in-reply-to:organization:references:cc:to
         :content-language:subject:reply-to:from:user-agent:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=zVbJBPOpKkbhGyx27wqJIbibuzsS8krruWYUofYY0Zk=;
        b=
X-Gm-Message-State: AAQBX9fLXLAOwlbjqbbNT9r3Q47r8lFb8gyx7Z4up/iDtOoi2S7b54bY
        dIEsSr2oWoT4lO/hAdSlmD0klw==
X-Google-Smtp-Source: AKy350apytzG5kQ6EWhbRum3TcFZIe9Nl+6/MHdLr/z9vYr/N8u1MF3zm0kHDNFanxdCdDzj/ErWOg==
X-Received: by 2002:adf:e44d:0:b0:2d0:d739:f901 with SMTP id t13-20020adfe44d000000b002d0d739f901mr18959334wrm.20.1680168187293;
        Thu, 30 Mar 2023 02:23:07 -0700 (PDT)
Received: from ?IPV6:2a01:e0a:982:cbb0:fe8e:8291:fc25:6c8f? ([2a01:e0a:982:cbb0:fe8e:8291:fc25:6c8f])
        by smtp.gmail.com with ESMTPSA id m14-20020a056000008e00b002e52dfb9256sm49668wrx.41.2023.03.30.02.23.06
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Thu, 30 Mar 2023 02:23:06 -0700 (PDT)
Message-ID: <eff6f028-2fbc-9677-312e-70cd4d809c6e@linaro.org>
Date:   Thu, 30 Mar 2023 11:23:05 +0200
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:102.0) Gecko/20100101
 Thunderbird/102.8.0
From:   Neil Armstrong <neil.armstrong@linaro.org>
Reply-To: neil.armstrong@linaro.org
Subject: Re: [PATCH v2 2/2] spi: add support for Meson A1 SPI Flash Controller
...
References: <20230327211351.686831-1-mmkurbanov@sberdevices.ru>
 <20230327211351.686831-3-mmkurbanov@sberdevices.ru>
Organization: Linaro Developer Services
In-Reply-To: <20230327211351.686831-3-mmkurbanov@sberdevices.ru>
...
Looks really clean, drop meson everywhere in favor to amlogic and rename to spi-amlogic-a1.

It looks like a bold move, but we started dropping the meson name for a
while now in bindings, but I think it's time to drop meson in driver
name for new SoCs which aren't related to the old Set-Top-Box SoC
seris which were named "Meson".

Since it's a new driver, it's the right moment :-)
