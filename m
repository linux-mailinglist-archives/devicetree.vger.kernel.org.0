...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6BD553443C9
	for <lists+devicetree@lfdr.de>; Mon, 22 Mar 2021 13:55:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230078AbhCVMyN (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 22 Mar 2021 08:54:13 -0400
Received: from www381.your-server.de ([78.46.137.84]:40876 "EHLO
        www381.your-server.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232457AbhCVMwQ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 22 Mar 2021 08:52:16 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=metafoo.de;
         s=default2002; h=Content-Transfer-Encoding:Content-Type:In-Reply-To:
        MIME-Version:Date:Message-ID:From:References:Cc:To:Subject:Sender:Reply-To:
        Content-ID:Content-Description:Resent-Date:Resent-From:Resent-Sender:
        Resent-To:Resent-Cc:Resent-Message-ID;
        bh=RezqIKQhg5CpSvy6mq7dsioA64mAlwIlEOmYkxX1hOo=; b=KcKdyMxO3+ZnCemhlivt8/5hpx
        ;
Received: from sslproxy05.your-server.de ([78.46.172.2])
        by www381.your-server.de with esmtpsa (TLSv1.3:TLS_AES_256_GCM_SHA384:256)
        (Exim 4.92.3)
        (envelope-from <lars@metafoo.de>)
        id 1lOK2T-000BXr-2n; Mon, 22 Mar 2021 13:52:10 +0100
Received: from [2001:a61:2aa9:e001:9e5c:8eff:fe01:8578]
        by sslproxy05.your-server.de with esmtpsa (TLSv1.3:TLS_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <lars@metafoo.de>)
        id 1lOK2S-000PUR-Sm; Mon, 22 Mar 2021 13:52:08 +0100
...
Message-ID: <c6b2152e-7331-201d-d64a-5e5eba46e76d@metafoo.de>
Date:   Mon, 22 Mar 2021 13:52:08 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.8.0
MIME-Version: 1.0
In-Reply-To: <SN6PR02MB4093DFF8D832D8ABABCEBF78CA659@SN6PR02MB4093.namprd02.prod.outlook.com>
