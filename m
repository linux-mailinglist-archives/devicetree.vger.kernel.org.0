...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 82FB761A314
	for <lists+devicetree@lfdr.de>; Fri,  4 Nov 2022 22:14:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229994AbiKDVOx (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 4 Nov 2022 17:14:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56960 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230035AbiKDVOM (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 4 Nov 2022 17:14:12 -0400
Received: from wout3-smtp.messagingengine.com (wout3-smtp.messagingengine.com [64.147.123.19])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 982D151C1E;
        Fri,  4 Nov 2022 14:13:55 -0700 (PDT)
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailout.west.internal (Postfix) with ESMTP id A21DA32007F1;
        Fri,  4 Nov 2022 17:13:53 -0400 (EDT)
Received: from mailfrontend2 ([10.202.2.163])
  by compute4.internal (MEProxy); Fri, 04 Nov 2022 17:13:54 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=svenpeter.dev;
         h=cc:cc:content-transfer-encoding:date:date:from:from
        :in-reply-to:in-reply-to:message-id:mime-version:references
        :reply-to:sender:subject:subject:to:to; s=fm3; t=1667596433; x=
        1667682833; bh=nKZ0YCQo9l3KxJTd8yuA+kBy56Qjf/hhoDEzwhRv0w8=; b=K
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:cc:content-transfer-encoding:date:date
        :feedback-id:feedback-id:from:from:in-reply-to:in-reply-to
        :message-id:mime-version:references:reply-to:sender:subject
        :subject:to:to:x-me-proxy:x-me-proxy:x-me-sender:x-me-sender
        :x-sasl-enc; s=fm3; t=1667596433; x=1667682833; bh=nKZ0YCQo9l3Kx
        JTd8yuA+kBy56Qjf/hhoDEzwhRv0w8=; b=OrkzSEXI78tX0PVrUPYjvscsaPkeH
        
X-ME-Sender: <xms:kYBlYwTViBNcS3mkWSUlHHcbAa6yMl_gTaM2Jksnxe3Vu_tmQkTWhA>
    <xme:kYBlY9xmSmBxetthQCcJMpepqD3xjydHchQOGSmYrthTNiCeFX4VqaG7QT2xOytYZ
    umZcgdE7JB2OB8BMAA>
X-ME-Received: <xmr:kYBlY93LR2qBMO9MqPG3EvGQmVXGP7i2bqQLTbFHlbWoQSrsWlSbL1TMJclr9Ksh3ZQMJfXT6NeG9PcpbQcXzQsT-M6717c3Ze17BfPCwMsvfg4TPfGcASqtOr7qYw>
...
X-ME-Proxy: <xmx:kYBlY0DHWZzjgx3grc-6ObszI0qut8WOIU0x2I-IEmcgy1H8Rh3fhQ>
    <xmx:kYBlY5gagaYSlRSfZxckLW1HRAoCFPM2FvHTXSIQHX7VD_SkW_FR6g>
    <xmx:kYBlYwp_47fYBWGJoP5mihzuvFHsY1OQC5JfF7kcmoNfGzq3dslytA>
    <xmx:kYBlY4T_8r8GJ0aCVw4cN4kIPL45NXxQYq0H69msKwf3Q2NWDNVhDA>
Feedback-ID: i51094778:Fastmail
Received: by mail.messagingengine.com (Postfix) with ESMTPA; Fri,
 4 Nov 2022 17:13:49 -0400 (EDT)
...
Subject: [PATCH v5 7/7] Bluetooth: hci_bcm4377: Add new driver for BCM4377 PCIe boards
Date:   Fri,  4 Nov 2022 22:13:03 +0100
Message-Id: <20221104211303.70222-8-sven@svenpeter.dev>
...
index ca45551220f5..82828ef36f85 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index 000000000000..74f44562ac33
--- /dev/null
