...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 52C9017C91B
	for <lists+devicetree@lfdr.de>; Sat,  7 Mar 2020 00:53:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727196AbgCFXt0 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 6 Mar 2020 18:49:26 -0500
Received: from lelv0142.ext.ti.com ([198.47.23.249]:33758 "EHLO
        lelv0142.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726237AbgCFXsB (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 6 Mar 2020 18:48:01 -0500
Received: from fllv0035.itg.ti.com ([10.64.41.0])
        by lelv0142.ext.ti.com (8.15.2/8.15.2) with ESMTP id 026NluDj098207;
        Fri, 6 Mar 2020 17:47:56 -0600
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1583538476;
        bh=9lIbx0mNqzP1JyKLy6UJp6LzWKzR8Bwe6WHVWmev3GM=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=sBpdKogLeSPUYt8iInPcQjDl7WYEk6GWAzR1yVOExy8wxWcv8q9Wbr+CubUb0bGj5
         Cn0s/n9wEwLk1uCzmEMLEfC0r+2dGiNSU7SY2pI0Vj1amxpxFUpNaCxL/NmDUD47LA
         0tVq1UjJr2mq13hROQBZ4AHEolvzH3zSRoQl9m20=
Received: from DFLE100.ent.ti.com (dfle100.ent.ti.com [10.64.6.21])
        by fllv0035.itg.ti.com (8.15.2/8.15.2) with ESMTP id 026Nlu5k124629;
        Fri, 6 Mar 2020 17:47:56 -0600
...
Received: from fllv0040.itg.ti.com (10.64.41.20) by DFLE112.ent.ti.com
 ...
 Frontend Transport; Fri, 6 Mar 2020 17:47:56 -0600
Received: from localhost (ileax41-snat.itg.ti.com [10.172.224.153])
        by fllv0040.itg.ti.com (8.15.2/8.15.2) with ESMTP id 026Nlrwn101333;
        Fri, 6 Mar 2020 17:47:53 -0600
...
Subject: [PATCH net-next v2 5/9] net: ethernet: ti: introduce am65x/j721e gigabit eth subsystem driver
Date:   Sat, 7 Mar 2020 01:47:30 +0200
Message-ID: <20200306234734.15014-6-grygorii.strashko@ti.com>
...
---
 ...
 7 files changed, 3073 insertions(+), 2 deletions(-)
...
index 000000000000..4a3f77d18045
--- /dev/null
...
new file mode 100644
index 000000000000..2837606d1039
--- /dev/null
...
+		   k3_udma_desc_pool_avail(tx_chn->desc_pool));
+
...
+	void *swdata;
+
+	desc_rx = k3_udma_desc_pool_alloc(rx_chn->desc_pool);
+	if (!desc_rx) {
+		dev_err(dev, "Failed to allocate RXFDQ descriptor\n");
+		return -ENOMEM;
+	}
+	desc_dma = k3_udma_desc_pool_virt2dma(rx_chn->desc_pool, desc_rx);
+
...
+	void **swdata;
+
+	desc_rx = k3_udma_desc_pool_dma2virt(rx_chn->desc_pool, desc_dma);
+	swdata = cppi5_hdesc_get_swdata(desc_rx);
+	skb = *swdata;
...
+	while (next_desc_dma) {
+		next_desc = k3_udma_desc_pool_dma2virt(tx_chn->desc_pool,
+						       next_desc_dma);
...
+
+		k3_udma_desc_pool_free(tx_chn->desc_pool, next_desc);
+	}
+
+	k3_udma_desc_pool_free(tx_chn->desc_pool, first_desc);
+}
+
+static void am65_cpsw_nuss_tx_cleanup(void *data, dma_addr_t desc_dma)
+{
...
+	void **swdata;
+
+	desc_tx = k3_udma_desc_pool_dma2virt(tx_chn->desc_pool, desc_dma);
...
+		}
+
+		desc_tx = k3_udma_desc_pool_dma2virt(tx_chn->desc_pool,
+						     desc_dma);
+		swdata = cppi5_hdesc_get_swdata(desc_tx);
+		skb = *(swdata);
...
+
+		next_desc = k3_udma_desc_pool_alloc(tx_chn->desc_pool);
+
+		if (!next_desc) {
...
+
+		desc_dma = k3_udma_desc_pool_virt2dma(tx_chn->desc_pool,
+						      next_desc);
...
+		tx_chn->desc_pool =
+			k3_udma_desc_pool_create_name(dev,
+						      tx_chn->descs_num,
+						      hdesc_size,
+						      tx_chn->tx_chn_name);
...
+		k3_udma_desc_pool_destroy(rx_chn->desc_pool);
+}
+
...
+	rx_chn->desc_pool = k3_udma_desc_pool_create_name(dev,
+							  rx_chn->descs_num,
+							  hdesc_size, "rx");
...
+
+static void am65_cpsw_pm_runtime_free(void *data)
+{
...
new file mode 100644
index 000000000000..2c202d5a626a
--- /dev/null
...
+	struct am65_cpsw_common	*common;
+	struct k3_udma_desc_pool *desc_pool;
...
diff --git a/drivers/net/ethernet/ti/k3-udma-desc-pool.c b/drivers/net/ethernet/ti/k3-udma-desc-pool.c
new file mode 100644
index 000000000000..65a4e2f10db9
--- /dev/null
+++ b/drivers/net/ethernet/ti/k3-udma-desc-pool.c
@@ -0,0 +1,126 @@
+// SPDX-License-Identifier: GPL-2.0
+/* TI K3 UDMA CPPI5 descriptors pool API
+ *
+ * Copyright (C) 2020 Texas Instruments Incorporated - http://www.ti.com
+ */
+
...
+};
+
+void k3_udma_desc_pool_destroy(struct k3_udma_desc_pool *pool)
+{
+	if (!pool)
+		return;
+
...
+
+struct k3_udma_desc_pool *
+k3_udma_desc_pool_create_name(struct device *dev, size_t size,
+			      size_t desc_size,
+			      const char *name)
+{
+	struct k3_udma_desc_pool *pool;
...
+}
+
+dma_addr_t k3_udma_desc_pool_virt2dma(struct k3_udma_desc_pool *pool,
+				      void *addr)
+{
+	return addr ? pool->dma_addr + (addr - pool->cpumem) : 0;
+}
+
+void *k3_udma_desc_pool_dma2virt(struct k3_udma_desc_pool *pool, dma_addr_t dma)
+{
+	return dma ? pool->cpumem + (dma - pool->dma_addr) : NULL;
+}
+
+void *k3_udma_desc_pool_alloc(struct k3_udma_desc_pool *pool)
+{
+	return (void *)gen_pool_alloc(pool->gen_pool, pool->desc_size);
+}
+
+void k3_udma_desc_pool_free(struct k3_udma_desc_pool *pool, void *addr)
+{
+	gen_pool_free(pool->gen_pool, (unsigned long)addr, pool->desc_size);
+}
+
+size_t k3_udma_desc_pool_avail(struct k3_udma_desc_pool *pool)
+{
+	return gen_pool_avail(pool->gen_pool) / pool->desc_size;
+}
diff --git a/drivers/net/ethernet/ti/k3-udma-desc-pool.h b/drivers/net/ethernet/ti/k3-udma-desc-pool.h
new file mode 100644
index 000000000000..ad5617525b66
--- /dev/null
+++ b/drivers/net/ethernet/ti/k3-udma-desc-pool.h
@@ -0,0 +1,30 @@
+/* SPDX-License-Identifier: GPL-2.0 */
...
+ */
+
+#ifndef K3_UDMA_DESC_POOL_H_
+#define K3_UDMA_DESC_POOL_H_
+
+#include <linux/device.h>
...
+			      size_t desc_size,
+			      const char *name);
+#define k3_udma_desc_pool_create(dev, size, desc_size) \
+		k3_udma_desc_pool_create_name(dev, size, desc_size, NULL)
+dma_addr_t
+k3_udma_desc_pool_virt2dma(struct k3_udma_desc_pool *pool, void *addr);
+void *
+k3_udma_desc_pool_dma2virt(struct k3_udma_desc_pool *pool, dma_addr_t dma);
+void *k3_udma_desc_pool_alloc(struct k3_udma_desc_pool *pool);
+void k3_udma_desc_pool_free(struct k3_udma_desc_pool *pool, void *addr);
+size_t k3_udma_desc_pool_avail(struct k3_udma_desc_pool *pool);
+
+#endif /* K3_UDMA_DESC_POOL_H_ */
-- 
2.17.1
