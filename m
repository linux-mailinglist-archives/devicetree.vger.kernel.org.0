...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9699924A352
	for <lists+devicetree@lfdr.de>; Wed, 19 Aug 2020 17:40:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728393AbgHSPkz (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 19 Aug 2020 11:40:55 -0400
Received: from mail.kernel.org ([198.145.29.99]:47112 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726894AbgHSPkx (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Wed, 19 Aug 2020 11:40:53 -0400
Received: from coco.lan (ip5f5ad5a3.dynamic.kabel-deutschland.de [95.90.213.163])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id A7E8120639;
        Wed, 19 Aug 2020 15:40:29 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1597851638;
        bh=r3UquZFi55Ockyiy1ZtlC/6CW9uwvS7c2o8OkYtlx0k=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=f4gxfhCMacqWwOuwFgnlQ8tTx3zsCb4N9+f67P6xNVdq1LF2aP+ipOjOJQ9/YirW2
         dy4cVXFWmU+uLTvrM2cIz+QeCoB7PnyH3+f56LZpRUQeUPxL1sd71fIo9ol8XfUbGE
         VNNzxYfqhBbJxs82F9WLdOrks06QngvxBGwMx1M0=
Date:   Wed, 19 Aug 2020 17:40:27 +0200
...
Message-ID: <20200819174027.70b39ee9@coco.lan>
...
Em Wed, 19 Aug 2020 17:21:20 +0200
...
Yep. the adv7535 fork is there at the beginning mainly because the original
patch do some other I2C inits for a different group, which the upstream
driver doesn't (plus there is a hack there). Those are not essential for
DRM to work, but it could give some clues about the EDID issue. So, I 
opted to maintain this file at the original patch, as having the
history can help debug some things in the future.
...
I did some changes at the bridge handling code, but not sure if those
are 100%. It would be nice to get some review about that, as this is
my first incursion at the DRM subsystem ;-)
