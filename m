...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id F100319F6E2
	for <lists+devicetree@lfdr.de>; Mon,  6 Apr 2020 15:25:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728470AbgDFNYr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 6 Apr 2020 09:24:47 -0400
Received: from smtprelay-out1.synopsys.com ([149.117.73.133]:37566 "EHLO
        smtprelay-out1.synopsys.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728284AbgDFNYb (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 6 Apr 2020 09:24:31 -0400
Received: from mailhost.synopsys.com (mdc-mailhost2.synopsys.com [10.225.0.210])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (No client certificate requested)
        by smtprelay-out1.synopsys.com (Postfix) with ESMTPS id 242A6404BF;
        Mon,  6 Apr 2020 13:24:30 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=synopsys.com; s=mail;
        t=1586179471; bh=2QP/AMCYY5OZlhosxCkkAXzxRgBxPrrSDdzsBqHJb9o=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:In-Reply-To:
         References:From;
        b=
Received: from de02dwia024.internal.synopsys.com (de02dwia024.internal.synopsys.com [10.225.19.81])
        by mailhost.synopsys.com (Postfix) with ESMTP id C1D93A0069;
...
Subject: [PATCH v2 3/4] drm: ipk: Add extensions for DW MIPI DSI Host driver
Date:   Mon,  6 Apr 2020 15:24:13 +0200
Message-Id: <8b63a8390bbc0e81d01540648da7e6b03b8577fa.1586174459.git.angelo.ribeiro@synopsys.com>
