...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1F5BD4A4E8B
	for <lists+devicetree@lfdr.de>; Mon, 31 Jan 2022 19:37:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1357024AbiAaShJ (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 31 Jan 2022 13:37:09 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38028 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1356737AbiAaSg5 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 31 Jan 2022 13:36:57 -0500
Received: from mail-pj1-x1035.google.com (mail-pj1-x1035.google.com [IPv6:2607:f8b0:4864:20::1035])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B0ED0C06173D
        for <devicetree@vger.kernel.org>; Mon, 31 Jan 2022 10:36:56 -0800 (PST)
Received: by mail-pj1-x1035.google.com with SMTP id s61-20020a17090a69c300b001b4d0427ea2so19148677pjj.4
        for <devicetree@vger.kernel.org>; Mon, 31 Jan 2022 10:36:56 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=XhtaPvJ4KDjgMW6HismLYV3qW9+tVs3SCOlAswUe2kY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=XhtaPvJ4KDjgMW6HismLYV3qW9+tVs3SCOlAswUe2kY=;
        b=
X-Gm-Message-State: AOAM532NOjNS19o3EBAEkOHyUZvMrjSq8DcxFUcNkop8U2AXCEao8OYs
        YoPCBQaMY3HuuYJtM4TDyugPRQ==
X-Google-Smtp-Source: ABdhPJwRmjdqnML7Ml+iiV7xz3g4NrKOdsCQDMcx+A0noJcrfysO6g9pqgnK9Si89mbgDSckI60hxQ==
X-Received: by 2002:a17:902:c409:: with SMTP id k9mr22265294plk.80.1643654215939;
        Mon, 31 Jan 2022 10:36:55 -0800 (PST)
Received: from p14s (S0106889e681aac74.cg.shawcable.net. [68.147.0.187])
        by smtp.gmail.com with ESMTPSA id d10sm16433046pfl.16.2022.01.31.10.36.53
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 31 Jan 2022 10:36:55 -0800 (PST)
Date:   Mon, 31 Jan 2022 11:36:52 -0700
From:   Mathieu Poirier <mathieu.poirier@linaro.org>
To:     Hari Nagalla <hnagalla@ti.com>
Cc:     bjorn.andersson@linaro.org, robh+dt@kernel.org,
        devicetree@vger.kernel.org, linux-remoteproc@vger.kernel.org,
        linux-kernel@vger.kernel.org, linux-arm-kernel@lists.infradead.org
Subject: Re: [PATCH 2/2] remoteproc: k4-m4: Add a remoteproc driver for M4F
 subsystem
Message-ID: <20220131183652.GC2404841@p14s>
References: <20220110040650.18186-1-hnagalla@ti.com>
 <20220110040650.18186-3-hnagalla@ti.com>
 <20220131182741.GB2404841@p14s>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20220131182741.GB2404841@p14s>
Precedence: bulk
List-ID: <devicetree.vger.kernel.org>
X-Mailing-List: devicetree@vger.kernel.org

On Mon, Jan 31, 2022 at 11:27:41AM -0700, Mathieu Poirier wrote:
> On Sun, Jan 09, 2022 at 10:06:50PM -0600, Hari Nagalla wrote:
...
> > for the M4F processing core. For loading the image remoteoproc driver
> 
> s/remoteoproc/remote processor
> 
...
> > index 3ddd426fc969..059490822b6f 100644
> > --- a/drivers/remoteproc/Kconfig
> > +++ b/drivers/remoteproc/Kconfig
> > @@ -348,6 +348,19 @@ config TI_K3_R5_REMOTEPROC
...
> > index 5478c7cb9e07..449948f2e466 100644
...
> > index 000000000000..d8fb419bb269
> > --- /dev/null
...
> 
> This is the third definition of this symbol.  Please move it to a common header
> file (omap_remoteproc.h perhaprs) and fix the other locations, i.e
> keystone_remoteproc.c and ti_k3_dsp_remoteproc.c
> 
> > +
> > +/**
...
> > +};
> 
> This one is in ti_k3_r5_remoteproc.c and ti_k3_dsp_remoteproc.c, with the exact
> same documentation.
> 
> > +
> > +/**
...
> > +}
> 
> This is a copy/paste from ti_k3_dsp_remoteproc.c
> 
> > +
...
> > +}
> 
> Same.  In fact when I look closer 70% of this file is an exact copy of
> ti_k3_dsp_remoteproc.c.
> 
> I'm all good with introducing new functions when they are needed but it is
> simply not the case here - please consolidate and cleanup.  I will stop here
> with this set. 

Some clarification here...  "Refactor" is a better choice of word than
"consolidate".  I support having K4 M4 in its own file as you did here but move
all the common code between it and K4 DSP in a common file to avoid bloating and
ease maintenance.
