...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9E6E351F7AE
	for <lists+devicetree@lfdr.de>; Mon,  9 May 2022 11:12:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238234AbiEIJNb (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 9 May 2022 05:13:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51092 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233689AbiEIImD (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 9 May 2022 04:42:03 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3592F21E10
        for <devicetree@vger.kernel.org>; Mon,  9 May 2022 01:38:06 -0700 (PDT)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <sha@pengutronix.de>)
        id 1nnytn-0007CL-6X; Mon, 09 May 2022 10:37:47 +0200
Received: from [2a0a:edc0:0:1101:1d::28] (helo=dude02.red.stw.pengutronix.de)
        by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.94.2)
        (envelope-from <sha@pengutronix.de>)
        id 1nnytk-001G86-96; Mon, 09 May 2022 10:37:42 +0200
Received: from sha by dude02.red.stw.pengutronix.de with local (Exim 4.94.2)
        (envelope-from <sha@pengutronix.de>)
        id 1nnyth-005EQX-OX; Mon, 09 May 2022 10:37:41 +0200
...
Subject: [PATCH v12 3/3] drm: rockchip: Add VOP2 driver
Date:   Mon,  9 May 2022 10:37:38 +0200
Message-Id: <20220509083738.1246866-4-s.hauer@pengutronix.de>
...
Notes:
    Changes since v11:
    - rename "regs" reg-names property to "vop"
    - rename "gamma_lut" reg-names property to gamma-lut"
...
index 3080832d3e47f..299f8da4813a8 100644
--- a/drivers/gpu/drm/rockchip/rockchip_drm_drv.c
+++ b/drivers/gpu/drm/rockchip/rockchip_drm_drv.c
@@ -457,6 +457,7 @@ static int __init rockchip_drm_init(void)
...
index 686f687a76a37..a70526e254a4c 100644
...
@@ -67,6 +70,7 @@ extern struct platform_driver rockchip_dp_driver;
...
index 0000000000000..d463ea80b6569
--- /dev/null
