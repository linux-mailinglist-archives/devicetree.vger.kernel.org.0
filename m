...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 993602F0FF2
	for <lists+devicetree@lfdr.de>; Mon, 11 Jan 2021 11:22:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728983AbhAKKUF (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 11 Jan 2021 05:20:05 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40366 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728929AbhAKKUF (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 11 Jan 2021 05:20:05 -0500
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A2519C0617A2
        for <devicetree@vger.kernel.org>; Mon, 11 Jan 2021 02:19:24 -0800 (PST)
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <ore@pengutronix.de>)
        id 1kyuHu-0008UF-6c; Mon, 11 Jan 2021 11:19:02 +0100
Received: from ore by dude.hi.pengutronix.de with local (Exim 4.92)
        (envelope-from <ore@pengutronix.de>)
        id 1kyuHt-0000pn-AD; Mon, 11 Jan 2021 11:19:01 +0100
...
Subject: [PATCH v7 3/5] ARM: dts: add Kverneland UT1, UT1Q and UT1P
Date:   Mon, 11 Jan 2021 11:18:53 +0100
Message-Id: <20210111101855.3121-4-o.rempel@pengutronix.de>
...
index 8b422215df4b..4ed61e88d7ba 100644
--- a/arch/arm/boot/dts/Makefile
+++ b/arch/arm/boot/dts/Makefile
@@ -490,6 +490,7 @@ dtb-$(CONFIG_SOC_IMX6Q) += \
...
@@ -583,6 +584,7 @@ dtb-$(CONFIG_SOC_IMX6Q) += \
 	imx6q-udoo.dtb \
...
@@ -597,6 +599,7 @@ dtb-$(CONFIG_SOC_IMX6Q) += \
