...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DC4EC1477C6
	for <lists+devicetree@lfdr.de>; Fri, 24 Jan 2020 05:56:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729388AbgAXE4i (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 23 Jan 2020 23:56:38 -0500
Received: from out28-53.mail.aliyun.com ([115.124.28.53]:49017 "EHLO
        out28-53.mail.aliyun.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729253AbgAXE4h (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 23 Jan 2020 23:56:37 -0500
X-Alimail-AntiSpam: AC=CONTINUE;BC=0.07436282|-1;CH=green;DM=CONTINUE|CONTINUE|true|0.421906-0.0107096-0.567384;DS=CONTINUE|ham_regular_dialog|0.188355-0.0059891-0.805656;FP=0|0|0|0|0|-1|-1|-1;HT=e02c03306;MF=zhouyanjie@wanyeetech.com;NM=1;PH=DS;RN=23;RT=23;SR=0;TI=SMTPD_---.Ggt9nNS_1579841788;
Received: from 192.168.10.218(mailfrom:zhouyanjie@wanyeetech.com fp:SMTPD_---.Ggt9nNS_1579841788)
          by smtp.aliyun-inc.com(10.147.41.143);
          Fri, 24 Jan 2020 12:56:30 +0800
...
References: <1579195429-59828-1-git-send-email-zhouyanjie@wanyeetech.com>
 ...
 <1579227152.3.0@crapouillou.net>
...
Message-ID: <5E2A78FA.901@wanyeetech.com>
Date:   Fri, 24 Jan 2020 12:56:26 +0800
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:38.0) Gecko/20100101
 Thunderbird/38.8.0
MIME-Version: 1.0
In-Reply-To: <1579227152.3.0@crapouillou.net>
...
On 2020年01月17日 10:12, Paul Cercueil wrote:
> Hi Zhou,
>
>
> Le ven., janv. 17, 2020 at 01:23, 周琰杰 (Zhou Yanjie) 
...
>> Notes:
>>     v1-v2:
>>     1.Remove Remove unnecessary "plat_irq_dispatch(void)" in 
>> irq-ingenic.c.
...
>> +            }
>
> The LPCR register is part of the CPM (Ingenic's clock IP). I believe 
> this should be handled in the CGU driver as part of the init for the 
> 2nd CPU clock.

I will try to move it to CGU driver.
