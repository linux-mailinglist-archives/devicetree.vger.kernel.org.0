...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8237E1F0C86
	for <lists+devicetree@lfdr.de>; Sun,  7 Jun 2020 17:44:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726738AbgFGPnv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 7 Jun 2020 11:43:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55382 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726595AbgFGPnr (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 7 Jun 2020 11:43:47 -0400
Received: from mail-lj1-x241.google.com (mail-lj1-x241.google.com [IPv6:2a00:1450:4864:20::241])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 17BAAC08C5C3;
        Sun,  7 Jun 2020 08:43:47 -0700 (PDT)
Received: by mail-lj1-x241.google.com with SMTP id j18so4360461lji.2;
        Sun, 07 Jun 2020 08:43:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=wvAg2lZzBvexIznG6AAvO/cC0HCC9zIRRbxHPlu/yOw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=wvAg2lZzBvexIznG6AAvO/cC0HCC9zIRRbxHPlu/yOw=;
        b=
X-Gm-Message-State: AOAM532a+09Oy/6PqyIhHA/cptb/BmNTpROPYnXYUKXu8guHjC8IfkWp
        DsxINmXNSl8n3EEJFyTuj0g=
X-Google-Smtp-Source: ABdhPJzfkMiTq1W5bbl3s5BRpfxrGLLcq8UJUzwDcLgc+6KIoy9nMknHNm1rPWtH87jeN+rMaUaiUw==
X-Received: by 2002:a05:651c:c9:: with SMTP id 9mr9590501ljr.365.1591544624103;
        Sun, 07 Jun 2020 08:43:44 -0700 (PDT)
Received: from localhost.localdomain (79-139-237-54.dynamic.spd-mgts.ru. [79.139.237.54])
        by smtp.gmail.com with ESMTPSA id a7sm3592234lfm.4.2020.06.07.08.43.42
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 07 Jun 2020 08:43:43 -0700 (PDT)
...
Subject: [PATCH v9 1/6] ARM: tegra: Add device-tree for Acer Iconia Tab A500
Date:   Sun,  7 Jun 2020 18:43:22 +0300
Message-Id: <20200607154327.18589-2-digetx@gmail.com>
...
index e6a1cac0bfc7..8bdfa28f79ca 100644
--- a/arch/arm/boot/dts/Makefile
+++ b/arch/arm/boot/dts/Makefile
@@ -1197,6 +1197,7 @@ dtb-$(CONFIG_MACH_SUNIV) += \
...
index 000000000000..f259d1ad400e
--- /dev/null
