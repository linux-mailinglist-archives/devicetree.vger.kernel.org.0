...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E57A18B535
	for <lists+devicetree@lfdr.de>; Tue, 13 Aug 2019 12:16:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727297AbfHMKQy (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 13 Aug 2019 06:16:54 -0400
Received: from hqemgate14.nvidia.com ([216.228.121.143]:11879 "EHLO
        hqemgate14.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727097AbfHMKQy (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 13 Aug 2019 06:16:54 -0400
Received: from hqpgpgate102.nvidia.com (Not Verified[216.228.121.13]) by hqemgate14.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5d528dc60003>; Tue, 13 Aug 2019 03:15:34 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate102.nvidia.com (PGP Universal service);
  Tue, 13 Aug 2019 03:15:32 -0700
X-PGP-Universal: processed;
        by hqpgpgate102.nvidia.com on Tue, 13 Aug 2019 03:15:32 -0700
...
References: <1565257046-9890-1-git-send-email-nkristam@nvidia.com>
 ...
 <1565613783.23705.49.camel@mhfsdcap03>
X-Nvconfidentiality: public
From:   Nagarjuna Kristam <nkristam@nvidia.com>
Message-ID: <94d07c29-dd22-1b5e-8c62-3508227a4c85@nvidia.com>
Date:   Tue, 13 Aug 2019 15:46:36 +0530
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1565691334; bh=rPe896hDRTw/DnpTp43gDxmZU1JFYODvY1AqUKQIRU0=;
        h=X-PGP-Universal:Subject:To:CC:References:X-Nvconfidentiality:From:
         Message-ID:Date:User-Agent:MIME-Version:In-Reply-To:
         X-Originating-IP:X-ClientProxiedBy:Content-Type:Content-Language:
         Content-Transfer-Encoding;
        b=
...
> 
Will update MASK and SHIFT accordingly and add a new macro for
register update as per Felipe and your inputs.
...
>> +}
> add () for shift and mask ?
> and there may be side effect for shift and mask, you use many times in
> one macro
>
Sure will bound mask and shift inside ()
w.r.t frequent usage of shift and mask, for this purpose they are assigned as
constants in the caller.
