...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B4F9A39B673
	for <lists+devicetree@lfdr.de>; Fri,  4 Jun 2021 12:02:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230185AbhFDKDv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 4 Jun 2021 06:03:51 -0400
Received: from mailout2.w1.samsung.com ([210.118.77.12]:54990 "EHLO
        mailout2.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230118AbhFDKDt (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 4 Jun 2021 06:03:49 -0400
Received: from eucas1p2.samsung.com (unknown [182.198.249.207])
        by mailout2.w1.samsung.com (KnoxPortal) with ESMTP id 20210604100201euoutp02b6d4963f71e1205bbb26a9f64120212c~FWNcf_3Xc1235012350euoutp02R
        for <devicetree@vger.kernel.org>; Fri,  4 Jun 2021 10:02:01 +0000 (GMT)
DKIM-Filter: OpenDKIM Filter v2.11.0 mailout2.w1.samsung.com 20210604100201euoutp02b6d4963f71e1205bbb26a9f64120212c~FWNcf_3Xc1235012350euoutp02R
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=samsung.com;
        s=mail20170921; t=1622800921;
        bh=QJl3/ZwjdSR+hkZPYX3x4R7FlvB12W6CHnnTvo0dXgM=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=BZ3/hk7K1XFBepoBv300TBq9puPRpBDva83Zz4JXkbO6KHiljHz58P4xJzEkvxBxE
         ruBoMERmlr1i6S20Ouy9RqmVMcobnl6tGK8IlxWbO4Pm/cQBa2OwDEz/uqtNi1JDPX
         obpFUtukXKhb0/oVlCr+akAnlEszXWnUVAk7A1Cw=
Received: from eusmges1new.samsung.com (unknown [203.254.199.242]) by
        eucas1p1.samsung.com (KnoxPortal) with ESMTP id
        20210604100200eucas1p1f326e899d5b06abdd3798df99806c138~FWNbzsiAb0541805418eucas1p1v;
        Fri,  4 Jun 2021 10:02:00 +0000 (GMT)
Received: from eucas1p1.samsung.com ( [182.198.249.206]) by
        eusmges1new.samsung.com (EUCPMTA) with SMTP id 28.7D.09452.81AF9B06; Fri,  4
        Jun 2021 11:02:00 +0100 (BST)
Received: from eusmtrp2.samsung.com (unknown [182.198.249.139]) by
        eucas1p2.samsung.com (KnoxPortal) with ESMTPA id
        20210604100200eucas1p29d94f0326c6071ae815f3df9036a943f~FWNbTeAjs2222522225eucas1p28;
        Fri,  4 Jun 2021 10:02:00 +0000 (GMT)
Received: from eusmgms1.samsung.com (unknown [182.198.249.179]) by
        eusmtrp2.samsung.com (KnoxPortal) with ESMTP id
        20210604100200eusmtrp2b02e0c18f4c537d275e751fdbd7f6bcf~FWNbSi6td1054110541eusmtrp2I;
        Fri,  4 Jun 2021 10:02:00 +0000 (GMT)
X-AuditID: cbfec7f2-ab7ff700000024ec-fe-60b9fa18c7bd
Received: from eusmtip1.samsung.com ( [203.254.199.221]) by
        eusmgms1.samsung.com (EUCPMTA) with SMTP id FB.A7.08705.81AF9B06; Fri,  4
        Jun 2021 11:02:00 +0100 (BST)
Received: from localhost (unknown [106.120.51.46]) by eusmtip1.samsung.com
        (KnoxPortal) with ESMTPA id
        20210604100200eusmtip1cac3b23476ca772e3a0fccdb0bd83c4b~FWNa6es9P1588215882eusmtip13;
...
Subject: [PATCH 3/3] net: ax88796c: ASIX AX88796C SPI Ethernet Adapter
 Driver
Date:   Fri,  4 Jun 2021 12:01:48 +0200
Message-Id: <20210604100148.17177-4-l.stelmach@samsung.com>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20210604100148.17177-1-l.stelmach@samsung.com>
MIME-Version: 1.0
Organization: Samsung R&D Institute Poland
Content-Transfer-Encoding: 8bit
X-Brightmail-Tracker: 
X-Brightmail-Tracker: 
X-CMS-MailID: 20210604100200eucas1p29d94f0326c6071ae815f3df9036a943f
X-Msg-Generator: CA
Content-Type: text/plain; charset="utf-8"
X-RootMTR: 20210604100200eucas1p29d94f0326c6071ae815f3df9036a943f
X-EPHeader: CA
CMS-TYPE: 201P
X-CMS-RootMailID: 20210604100200eucas1p29d94f0326c6071ae815f3df9036a943f
References: <20210604100148.17177-1-l.stelmach@samsung.com>
        <CGME20210604100200eucas1p29d94f0326c6071ae815f3df9036a943f@eucas1p2.samsung.com>
Precedence: bulk
...
index d8e882229a48..a2bc8940af53 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -2817,6 +2817,12 @@ S:	Maintained
...
new file mode 100644
index 000000000000..46c94f29df9f
--- /dev/null
...
new file mode 100644
index 000000000000..1252a97d1c52
--- /dev/null
