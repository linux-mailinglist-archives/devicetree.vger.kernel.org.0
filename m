...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2D53C6199EF
	for <lists+devicetree@lfdr.de>; Fri,  4 Nov 2022 15:30:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232193AbiKDOaT (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 4 Nov 2022 10:30:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46828 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232120AbiKDO3u (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 4 Nov 2022 10:29:50 -0400
Received: from relay1-d.mail.gandi.net (relay1-d.mail.gandi.net [IPv6:2001:4b98:dc4:8::221])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 431D6317D5;
        Fri,  4 Nov 2022 07:28:01 -0700 (PDT)
Received: (Authenticated sender: maxime.chevallier@bootlin.com)
        by mail.gandi.net (Postfix) with ESMTPSA id 8AE48240011;
        Fri,  4 Nov 2022 14:27:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=bootlin.com; s=gm1;
        ...
        bh=vpk4eqgkU7k5mDQQ4PcCF0HzAkml9xCqBAd0eylWTls=;
        b=
...
Subject: [PATCH net-next v7 3/5] net: dsa: add out-of-band tagging protocol
Date:   Fri,  4 Nov 2022 15:27:44 +0100
Message-Id: <20221104142746.350468-4-maxime.chevallier@bootlin.com>
...
index 6c6ffbb0f6ed..46bf0a4bfbaa 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
new file mode 100644
index 000000000000..11f21c35c81d
--- /dev/null
+++ b/net/dsa/tag_oob.c
@@ -0,0 +1,48 @@
+// SPDX-License-Identifier: GPL-2.0-only
