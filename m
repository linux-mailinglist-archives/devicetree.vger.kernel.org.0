...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0207335C1D8
	for <lists+devicetree@lfdr.de>; Mon, 12 Apr 2021 11:58:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240149AbhDLJeU (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 12 Apr 2021 05:34:20 -0400
Received: from so254-9.mailgun.net ([198.61.254.9]:53157 "EHLO
        so254-9.mailgun.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240151AbhDLJcM (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 12 Apr 2021 05:32:12 -0400
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1618219914; h=Content-Transfer-Encoding: Content-Type:
 In-Reply-To: MIME-Version: Date: Message-ID: From: References: Cc: To:
 Subject: Sender; bh=baH4wFULe5MFO+77H10ae7ORExzZ5Gqv7+/iToOlDQs=; b=OBScBCj6c5IzwrVEYWWEMXO4zCHGpHe7pPQ5sBaGZFBQf6XXsvE4gme4RyxSYBrB6H+Ek3sq
 jbQbfCquqwKXOLrLLvaEjjBfnxXoJ/eOBXkka5OzD8l8sSVgdKr7UeX1jB1SexMmlyFOow4I
 0IrBHbZMh0+O1134+7Yh6xCngMA=
X-Mailgun-Sending-Ip: 198.61.254.9
X-Mailgun-Sid: WyI1YmJiNiIsICJkZXZpY2V0cmVlQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org
 (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171]) by
 smtp-out-n01.prod.us-west-2.postgun.com with SMTP id
 60741386f34440a9d4ce14fb (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Mon, 12 Apr 2021 09:31:50
 GMT
Sender: tdas=codeaurora.org@mg.codeaurora.org
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id A6ED6C4346E; Mon, 12 Apr 2021 09:31:50 +0000 (UTC)
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on
        aws-us-west-2-caf-mail-1.web.codeaurora.org
X-Spam-Level: 
X-Spam-Status: No, score=-2.9 required=2.0 tests=ALL_TRUSTED,BAYES_00,
        NICE_REPLY_A,SPF_FAIL autolearn=no autolearn_force=no version=3.4.0
Received: from [192.168.0.102] (unknown [49.204.181.120])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        (Authenticated sender: tdas)
        by smtp.codeaurora.org (Postfix) with ESMTPSA id 8D261C4346A;
        Mon, 12 Apr 2021 09:31:28 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org 8D261C4346A
...
Message-ID: <92e465e4-a0d9-43eb-84f7-69fa355097a9@codeaurora.org>
Date:   Mon, 12 Apr 2021 15:01:25 +0530
...
debugging much more troublesome if we try to accomodate multiple 
versions of CPUFREQ-HW in the same code.

Thus to keep it simple, easy to read, debug, the suggestion is to keep 
it with "v1" tag as the OSM version we are trying to put here is from 
OSM1.0.
