...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 84FE13535A2
	for <lists+devicetree@lfdr.de>; Sun,  4 Apr 2021 00:11:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236869AbhDCWLF (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 3 Apr 2021 18:11:05 -0400
Received: from pbmsgap01.intersil.com ([192.157.179.201]:34906 "EHLO
        pbmsgap01.intersil.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236625AbhDCWLE (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 3 Apr 2021 18:11:04 -0400
Received: from pps.filterd (pbmsgap01.intersil.com [127.0.0.1])
        by pbmsgap01.intersil.com (8.16.0.42/8.16.0.42) with SMTP id 133M9QgS015578;
        Sat, 3 Apr 2021 18:10:53 -0400
Received: from pbmxdp03.intersil.corp (pbmxdp03.pb.intersil.com [132.158.200.224])
        by pbmsgap01.intersil.com with ESMTP id 37pkw3068h-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-SHA384 bits=256 verify=NOT);
        Sat, 03 Apr 2021 18:10:53 -0400
Received: from pbmxdp01.intersil.corp (132.158.200.222) by
 pbmxdp03.intersil.corp (132.158.200.224) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384_P384) id
 15.1.2176.2; Sat, 3 Apr 2021 18:10:51 -0400
Received: from localhost (132.158.202.108) by pbmxdp01.intersil.corp
 (132.158.200.222) with Microsoft SMTP Server id 15.1.2176.2 via Frontend
 Transport; Sat, 3 Apr 2021 18:10:51 -0400
From:   <min.li.xe@renesas.com>
To:     <sameo@linux.intel.com>, <lee.jones@linaro.org>,
        <grant.likely@linaro.org>, <robh+dt@kernel.org>
CC:     <linux-kernel@vger.kernel.org>, <devicetree@vger.kernel.org>,
        Min Li <min.li.xe@renesas.com>
Subject: [PATCH next 1/2] mfd: Add Renesas Synchronization Management Unit (SMU) support
Date:   Sat, 3 Apr 2021 18:09:09 -0400
Message-ID: <1617487749-8737-1-git-send-email-min.li.xe@renesas.com>
X-Mailer: git-send-email 2.7.4
X-TM-AS-MML: disable
MIME-Version: 1.0
Content-Type: text/plain
X-Proofpoint-GUID: RMLLEDkys37dfPQDw4uzJM6EmF3U20Ur
X-Proofpoint-ORIG-GUID: RMLLEDkys37dfPQDw4uzJM6EmF3U20Ur
X-Proofpoint-Virus-Version: vendor=fsecure engine=2.50.10434:6.0.369,18.0.761
 definitions=2021-04-03_12:2021-04-01,2021-04-03 signatures=0
X-Proofpoint-Spam-Details: rule=junk_notspam policy=junk score=0 bulkscore=0 suspectscore=0
 mlxlogscore=999 mlxscore=0 phishscore=0 spamscore=0 malwarescore=0
 adultscore=0 classifier=spam adjust=0 reason=mlx scancount=1
 engine=8.12.0-2103310000 definitions=main-2104030152
