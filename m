...
Received: from mail.cognitivepilot.com ([127.0.0.1])
        ...
        with ESMTP id lJUQW57DfghT for <devicetree@vger.kernel.org>;
        Wed, 31 Mar 2021 18:56:18 +0300 (MSK)
Received: from localhost.localdomain (unknown [185.68.147.27])
        by mail.cognitivepilot.com (Postfix) with ESMTP id 4F9WBn33T6zpnMxD;
...
Subject: [PATCH v3 1/4] ARM: dts: sun8i: r40: add /omit-if-no-ref/ to pinmux nodes for UARTs 0&3
Date:   Wed, 31 Mar 2021 18:56:13 +0300
Message-Id: <20210331155616.793550-2-i.uvarov@cognitivepilot.com>
