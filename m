...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 43E1151D38F
	for <lists+devicetree@lfdr.de>; Fri,  6 May 2022 10:41:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1390216AbiEFIoy (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 6 May 2022 04:44:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33046 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1390225AbiEFIor (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 6 May 2022 04:44:47 -0400
Received: from mail-pf1-x430.google.com (mail-pf1-x430.google.com [IPv6:2607:f8b0:4864:20::430])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6A1525C740
        for <devicetree@vger.kernel.org>; Fri,  6 May 2022 01:41:02 -0700 (PDT)
Received: by mail-pf1-x430.google.com with SMTP id 204so2928412pfx.3
        for <devicetree@vger.kernel.org>; Fri, 06 May 2022 01:41:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=qt7nQIG+R3dSZlWmm/ZctcoawhzPSbnR+xWfwAW2W1M=;
        b=AuW6Cjo+SgZwc2UlV0AY4oJeKzry10OCWLt21P3uYyxtMqa9hQi9g7CPhLHDJ9791A
         Kmit7ijW2M1wR8TnuJ4KMcA9/OJwZrMar+0ZrCV4u7SmNBe7eORAiD9MMo//tJqVn8/A
         2ar8ONEtJ1AMhiipHcXl2qwa3sS5r+Y8EBFdY=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         :mime-version:content-disposition:in-reply-to;
        bh=qt7nQIG+R3dSZlWmm/ZctcoawhzPSbnR+xWfwAW2W1M=;
        b=
X-Gm-Message-State: AOAM5335ULyvoYeGwLGjp7znwvzOkiX54rtgxgslq9Fi632H9Zjt2seX
        PUB/xLdD9+R0FV5w3At5I50Utw==
X-Google-Smtp-Source: ABdhPJy4cjqpneM1S3sKU0jUFML4vNw6mSFmKGbUx+hgXuClNYMbUXGB9PMzb4UJc4HPjvFsZ14Cbg==
X-Received: by 2002:a62:170b:0:b0:50a:6901:b633 with SMTP id 11-20020a62170b000000b0050a6901b633mr2540358pfx.34.1651826460810;
        Fri, 06 May 2022 01:41:00 -0700 (PDT)
Received: from google.com ([2401:fa00:1:10:692c:94a4:b75f:3f5e])
        by smtp.gmail.com with ESMTPSA id g6-20020a170902740600b0015e8d4eb219sm1096572pll.99.2022.05.06.01.40.56
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 06 May 2022 01:41:00 -0700 (PDT)
Date:   Fri, 6 May 2022 16:40:54 +0800
...
Message-ID: <YnTfFrZ+2yOmHmfu@google.com>
References: <20220420102044.10832-1-roger.lu@mediatek.com>
 ...
 <CAGXv+5FyYoZsjktVjMAYthhKieiF+t4eyQBb-QF6RURWjOGNKw@mail.gmail.com>
 <7hfslpp0bu.fsf@baylibre.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <7hfslpp0bu.fsf@baylibre.com>
...
On Wed, May 04, 2022 at 12:25:09PM -0700, Kevin Hilman wrote:
...
> 
> OK, that's where I stole the CCI regulator snippet from. :)
...
> 
> I traced it a bit deeper, and basically the devfreq init is returning
> -EPROBE_DEFER, and the CCI driver is not handling that properly.
> 
> I'm guessing the difference between your setup and mine is probably the
> defconfig.  I'm based on upstream defconfig, which is lots of stuff as
> modules) plus a handful of mt8183 related options setup.  With lots of
> stuff as modules, I'm probably getting more deferred probes, and the
> CCI driver is not behaving well with that.
> 
> Could you share your defconfig for comparison?   Mine is below.

My config is from ChromeOS, so has most of the critical stuff
built-in. Full config below.
...
> 
> Yeah, this mali vs panfrost mismatch I raised in an earlier review also.
> IMO, this driver should be fixed to work with upstream panfrost before
> merging.

I have something working, and I'll rebase (some cpufreq patches were
picked up) my branch and that on.
...
#
CONFIG_CC_VERSION_TEXT="aarch64-linux-gnu-gcc (Debian 11.2.0-16) 11.2.0"
CONFIG_CC_IS_GCC=y
...
# CONFIG_HID_GOOGLE_ATRUS is not set
...
CONFIG_LSM="lockdown,yama,loadpin,safesetid,integrity,chromiumos,selinux,bpf"
