...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 970E6AC861
	for <lists+devicetree@lfdr.de>; Sat,  7 Sep 2019 19:47:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2393289AbfIGRrL (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 7 Sep 2019 13:47:11 -0400
Received: from mo4-p02-ob.smtp.rzone.de ([85.215.255.81]:35298 "EHLO
        mo4-p02-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731865AbfIGRrL (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 7 Sep 2019 13:47:11 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1567878426;
        s=strato-dkim-0002; d=goldelico.com;
        h=References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:
        X-RZG-CLASS-ID:X-RZG-AUTH:From:Subject:Sender;
        bh=amrmxoaiFMIzqzcum0VuhDvILwcjxO4elB2hPWqfZ60=;
        b=
X-RZG-AUTH: ":JGIXVUS7cutRB/49FwqZ7WcJeFKiMhflhwDubTJ9o1mfYzBGHXL8GTntuxg="
X-RZG-CLASS-ID: mo00
Received: from iMac.fritz.box
        by smtp.strato.de (RZmta 44.27.0 DYNA|AUTH)
        with ESMTPSA id u036f9v87Hkvrbl
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (curve secp521r1 with 521 ECDH bits, eq. 15360 bits RSA))
        (Client did not present a certificate);
        Sat, 7 Sep 2019 19:46:57 +0200 (CEST)
...
Date:   Sat,  7 Sep 2019 19:46:52 +0200
Message-Id: <8f002b26667b91b0d13771e5a17535075e82b343.1567878413.git.hns@goldelico.com>
