...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CDDC55342C8
	for <lists+devicetree@lfdr.de>; Wed, 25 May 2022 20:16:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242803AbiEYSQE (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 25 May 2022 14:16:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46668 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1343662AbiEYSPy (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 25 May 2022 14:15:54 -0400
Received: from mail.sberdevices.ru (mail.sberdevices.ru [45.89.227.171])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B042EA7769;
        Wed, 25 May 2022 11:15:49 -0700 (PDT)
Received: from s-lin-edge02.sberdevices.ru (localhost [127.0.0.1])
        by mail.sberdevices.ru (Postfix) with ESMTP id 1A1A65FD0A;
        Wed, 25 May 2022 21:15:48 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=sberdevices.ru;
        s=mail; t=1653502548;
        bh=MZFVdGu+Wc1AhK/eMPjLjUZonwlQPjbrVknRbXL5r2E=;
        h=From:To:Subject:Date:Message-ID:Content-Type:MIME-Version;
        b=
...
Thread-Topic: [PATCH v2 2/3] iio: add MEMSensing MSA311 3-axis accelerometer
 driver
Thread-Index: AQHYcGNscv5GHcvjkkaBriw+oOvmsg==
Date:   Wed, 25 May 2022 18:15:32 +0000
Message-ID: <20220525181532.6805-3-ddrokosov@sberdevices.ru>
...
+	err =3D regmap_bulk_read(msa311->regs, axis_reg, axis, sizeof(*axis));
+	if (err) {
+		dev_err(&msa311->i2c->dev,
...
+	int err;
+
+	err =3D pm_runtime_resume_and_get(&msa311->i2c->dev);
+	if (err) {
...
+
+/**
+ * msa311_read_avail() - IIO interface to request available device attr va=
lues
+ * @indio_dev: The IIO device associated with MSA311
+ * @chan: IIO channel specification
...
+ *
+ * Ack all internal interrupts, check their statuses and wake up appropria=
te
+ * triggers or send events if needed
+ *
+ * Return: IRQ_HANDLED on success (all interrupts are handled without prob=
lems)
...
+ *         0 with warning notice when MSA311 device was found on the I2C b=
us,
...
+ * @msa311: MSA311 internal private state
+ *
+ * We register new data trigger firstly and then setup MSA311 int register=
s.
...
+{
+	struct device *dev =3D &((struct msa311_priv *)msa311)->i2c->dev;
+
