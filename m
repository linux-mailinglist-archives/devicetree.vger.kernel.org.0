...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1FC6645B6AB
	for <lists+devicetree@lfdr.de>; Wed, 24 Nov 2021 09:41:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241396AbhKXIoF (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 24 Nov 2021 03:44:05 -0500
Received: from esa.microchip.iphmx.com ([68.232.154.123]:24463 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241406AbhKXIoC (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 24 Nov 2021 03:44:02 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1637743253; x=1669279253;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=FO5YHPTmxrCXIOhDkkd5PMaqAipv8UjZ7OJTkwq1pog=;
  b=giWwB9DdFFKpSS8r1GsJ/iDP7N9Pgmmmkz/c/NiVgDeHpR9Oqq/iauYu
   3lWCOSUz8wZeboNB19cLxlalfv0wKDSoJq/AOLnmhwwA3opXRzJBMpvYs
   WgA1MgFfzXTQDPrWXCTYVsIyMy/IJbRSG5H88Z39eKhpQ33Ts7E/fKm/U
   3WAPdgHTxEZcyQ+tL5QPQLfjRauSfb+i+smZ7vTfav7jZz7ld2qtWNudm
   9clNwWc16syNQvvqSnF0Abo1qN01awO23I8LXRp2Qgq+j1cCR96kardHU
   KruadkWghFmX2/H9l9SDxzcu0uY7y1Z2u/NcMnUtcScOkkNQ7aaPpLrFL
   w==;
IronPort-SDR: 
 Pqbehw+YipwegE4Rx94XVAkj
X-IronPort-AV: E=Sophos;i="5.87,260,1631602800"; 
   d="scan'208";a="140157782"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa2.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 24 Nov 2021 01:40:52 -0700
Received: from chn-vm-ex01.mchp-main.com (10.10.85.143) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.14; Wed, 24 Nov 2021 01:40:52 -0700
Received: from soft-dev3-1.microsemi.net (10.10.115.15) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server id
 15.1.2176.14 via Frontend Transport; Wed, 24 Nov 2021 01:40:49 -0700
...
Subject: [PATCH net-next v3 3/6] net: lan966x: add port module support
Date:   Wed, 24 Nov 2021 09:39:12 +0100
Message-ID: <20211124083915.2223065-4-horatiu.vultur@microchip.com>
...
---
 ...
 .../ethernet/microchip/lan966x/lan966x_main.c | 504 +++++++++++++++++-
...
index 2a559266a4ac..4286cc1b0417 100644
...
@@ -87,23 +99,472 @@ static int lan966x_create_targets(struct platform_device *pdev,
 	return 0;
 }
...
@@ -317,21 +778,46 @@ static int lan966x_probe(struct platform_device *pdev)
...
+		lan966x_port_init(lan966x->ports[p]);
 	...
 	return 0;
@@ -339,11 +825,21 @@ static int lan966x_probe(struct platform_device *pdev)
 cleanup_ports:
