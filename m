...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 945E94752AF
	for <lists+devicetree@lfdr.de>; Wed, 15 Dec 2021 07:16:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240118AbhLOGQL (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 15 Dec 2021 01:16:11 -0500
Received: from mailgw02.mediatek.com ([210.61.82.184]:42240 "EHLO
        mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S240084AbhLOGQI (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 15 Dec 2021 01:16:08 -0500
X-UUID: e499877777c34ae69e7aa5bf39b61f09-20211215
X-UUID: e499877777c34ae69e7aa5bf39b61f09-20211215
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by mailgw02.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
        with ESMTP id 371352322; Wed, 15 Dec 2021 14:16:04 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by
 mtkmbs07n2.mediatek.inc (172.21.101.141) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Wed, 15 Dec 2021 14:16:02 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkcas11.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.0.1497.2 via Frontend Transport; Wed, 15 Dec 2021 14:16:01 +0800
...
Subject: [PATCH v14, 06/19] media: mtk-vcodec: Add to support multi hardware decode
Date:   Wed, 15 Dec 2021 14:15:39 +0800
Message-ID: <20211215061552.8523-7-yunfei.dong@mediatek.com>
...
@@ -95,6 +91,42 @@ static int mtk_vcodec_get_reg_bases(struct mtk_vcodec_dev *dev)
 	return 0;
 }
...
@@ -329,6 +343,15 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
index 000000000000..b6703b444827
--- /dev/null
...
new file mode 100644
index 000000000000..0db0c8c310da
--- /dev/null
...
index 0fa9d85114b9..7f97fbf0f073 100644
