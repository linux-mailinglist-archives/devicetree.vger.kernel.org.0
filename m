...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D260F2D1416
	for <lists+devicetree@lfdr.de>; Mon,  7 Dec 2020 15:53:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727128AbgLGOv4 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 7 Dec 2020 09:51:56 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43628 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725774AbgLGOvz (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 7 Dec 2020 09:51:55 -0500
Received: from mail-pg1-x52a.google.com (mail-pg1-x52a.google.com [IPv6:2607:f8b0:4864:20::52a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1FCA3C06138C;
        Mon,  7 Dec 2020 06:50:59 -0800 (PST)
Received: by mail-pg1-x52a.google.com with SMTP id o4so9079531pgj.0;
        Mon, 07 Dec 2020 06:50:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=f6SHfOQu0vOtJabyLCbnNQZEUz66G09SuiXTzVp7dPU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=f6SHfOQu0vOtJabyLCbnNQZEUz66G09SuiXTzVp7dPU=;
        b=
X-Gm-Message-State: AOAM531DWzhUz2Nl/Af2UH8QnDzxUrNTKwweybI+cAuYanTFK/7ZjPvR
        ojQNluT+8Lzb5eq7X1MkxTg=
X-Google-Smtp-Source: ABdhPJzXrPEFNlhEa91w1lECUXnJ3JAm/gj7N922ey0MWjwKIiq5TFbont46AC5If/rZfs1uVR+97w==
X-Received: by 2002:a17:902:446:b029:d7:cdda:87 with SMTP id 64-20020a1709020446b02900d7cdda0087mr16496737ple.11.1607352657805;
        Mon, 07 Dec 2020 06:50:57 -0800 (PST)
Received: from nj08008nbu.spreadtrum.com ([117.18.48.82])
        by smtp.gmail.com with ESMTPSA id u25sm10360249pgl.68.2020.12.07.06.50.53
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 07 Dec 2020 06:50:56 -0800 (PST)
...
Subject: [PATCH v1 6/6] drm/sprd: add Unisoc's drm mipi dsi&dphy driver
Date:   Mon,  7 Dec 2020 22:50:26 +0800
Message-Id: <1607352626-26088-7-git-send-email-kevin3.tang@gmail.com>
...
+}
+
+void dsi_phy_clklane_ulps_rqst(struct dsi_context *ctx, int en)
+{
+	struct dsi_reg *reg = (struct dsi_reg *)ctx->base;
+	union _0x78 phy_interface_ctrl;
+
...
+}
+
+void dsi_phy_clklane_ulps_exit(struct dsi_context *ctx, int en)
+{
+	struct dsi_reg *reg = (struct dsi_reg *)ctx->base;
+	union _0x78 phy_interface_ctrl;
+
...
+}
+
+void dsi_phy_datalane_ulps_rqst(struct dsi_context *ctx, int en)
+{
+	struct dsi_reg *reg = (struct dsi_reg *)ctx->base;
+	union _0x78 phy_interface_ctrl;
+
...
+}
+
+void dsi_phy_datalane_ulps_exit(struct dsi_context *ctx, int en)
+{
+	struct dsi_reg *reg = (struct dsi_reg *)ctx->base;
+	union _0x78 phy_interface_ctrl;
+
...
+}
+
+u8 dsi_phy_is_stop_state_datalane(struct dsi_context *ctx)
+{
+	u8 state = 0;
+	struct dsi_reg *reg = (struct dsi_reg *)ctx->base;
+	union _0x9C phy_status;
...
+}
+
+u8 dsi_phy_is_stop_state_clklane(struct dsi_context *ctx)
+{
+	struct dsi_reg *reg = (struct dsi_reg *)ctx->base;
+	union _0x9C phy_status;
+
...
+}
+
+u8 dsi_phy_is_ulps_active_datalane(struct dsi_context *ctx)
+{
+	u8 state = 0;
+	struct dsi_reg *reg = (struct dsi_reg *)ctx->base;
+	union _0x9C phy_status;
...
+}
+
+u8 dsi_phy_is_ulps_active_clklane(struct dsi_context *ctx)
+{
+	struct dsi_reg *reg = (struct dsi_reg *)ctx->base;
+	union _0x9C phy_status;
+
...
+
+	if (!ctx->enabled) {
+		DRM_WARN("dsi isn't initialized\n");
+		return;
+	}
+
...
+	if (!ctx->pll) {
+		DRM_ERROR("failed to allocate dphy pll data.\n");
+		return -ENOMEM;
+	}
+
