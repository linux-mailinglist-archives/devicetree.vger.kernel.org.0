...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 860243D6AB
	for <lists+devicetree@lfdr.de>; Tue, 11 Jun 2019 21:21:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2407577AbfFKTVe (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 11 Jun 2019 15:21:34 -0400
Received: from smtprelay-out1.synopsys.com ([198.182.47.102]:37680 "EHLO
        smtprelay-out1.synopsys.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S2407520AbfFKTVU (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Tue, 11 Jun 2019 15:21:20 -0400
Received: from mailhost.synopsys.com (unknown [10.225.0.210])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (No client certificate requested)
        by smtprelay-out1.synopsys.com (Postfix) with ESMTPS id 1FD87C00C9;
        Tue, 11 Jun 2019 19:21:19 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=synopsys.com; s=mail;
        t=1560280879; bh=lFxjOybRSnysOq38YtrDzVC7aSn6ROGVUmUTVuoYxc8=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: from de02.synopsys.com (de02.internal.synopsys.com [10.225.17.21])
        by mailhost.synopsys.com (Postfix) with ESMTP id EB0BDA022F;
        Tue, 11 Jun 2019 19:21:17 +0000 (UTC)
Received: from de02dwia024.internal.synopsys.com (de02dwia024.internal.synopsys.com [10.225.19.81])
        by de02.synopsys.com (Postfix) with ESMTP id D19FA3F8A5;
        Tue, 11 Jun 2019 21:21:17 +0200 (CEST)
...
Subject: [v4 5/6] media: platform: dwc: Add DW MIPI DPHY Rx driver
Date:   Tue, 11 Jun 2019 21:20:54 +0200
Message-Id: <1560280855-18085-6-git-send-email-luis.oliveira@synopsys.com>
...
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -15193,8 +15193,10 @@ L:	linux-media@vger.kernel.org
