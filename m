...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0726F2AB7B4
	for <lists+devicetree@lfdr.de>; Mon,  9 Nov 2020 13:04:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726410AbgKIMEc (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 9 Nov 2020 07:04:32 -0500
Received: from szxga05-in.huawei.com ([45.249.212.191]:7066 "EHLO
        szxga05-in.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728927AbgKIMEb (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 9 Nov 2020 07:04:31 -0500
Received: from DGGEMS401-HUB.china.huawei.com (unknown [172.30.72.60])
        by szxga05-in.huawei.com (SkyGuard) with ESMTP id 4CV8mQ74NNzhj26;
        Mon,  9 Nov 2020 20:04:06 +0800 (CST)
...
Subject: [PATCH] clk: hisilicon: Add clock driver for hi3559A SoC
Date:   Mon, 9 Nov 2020 20:28:38 +0000
Message-ID: <20201109202838.43105-1-gengdongjiu@huawei.com>
...
+		ARRAY_SIZE(shub_source_clk_mux_p), 0, 0x0, 0, 2, 0, shub_source_clk_mux_table,
+	},
+
+	{
...
+	{ HI3559AV100_SHUB_SPI_SOURCE_CLK, "clk_spi_clk", "shub_clk",
+	  0, 0x20, 24, 2, CLK_DIVIDER_ALLOW_ZERO, shub_spi_clk_table,
+	},
+	{ HI3559AV100_SHUB_UART_DIV_CLK, "clk_uart_div_clk", "shub_clk",
+	  0, 0x1c, 28, 2, CLK_DIVIDER_ALLOW_ZERO, shub_uart_div_clk_table,
+	},
+};
+
+
...
new file mode 100644
index 000000000000..f4ab064a26f8
--- /dev/null
