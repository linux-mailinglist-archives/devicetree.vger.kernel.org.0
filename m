...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F3BD04A9E33
	for <lists+devicetree@lfdr.de>; Fri,  4 Feb 2022 18:46:26 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377209AbiBDRqV (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 4 Feb 2022 12:46:21 -0500
Received: from esa.microchip.iphmx.com ([68.232.153.233]:20466 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377239AbiBDRqF (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 4 Feb 2022 12:46:05 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1643996766; x=1675532766;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=pH829WZN4HmhkDpF0W+71zSZu0p4hjsFnTuw1r9nsx8=;
  b=MO6U8EkSV9jBap4RaBP2DIPcR7tutLKpwZ/eyuuedqkmTUZwrDPHcqlv
   H75mabiasesDN5hIDSZBlzB1iBilYJvQ4M4uJ7xLosGgEX5cuUdGias6y
   tspZsra0Hbwp4ee3BeKKgGVpRHc5IM8KXCQwH7IlDjoHzVMoL9XzuCHF9
   WRYyhyVg+dStVcc+eLe+QPaG5WGtNTtrpop5S3NBhVZnsadLIKCux0brs
   /O6lYg61WLhw0wthr+B3p/QRz2OS8wwwi4EyEMdt1rOqMxQwqpHduDxAs
   DndZQutpuadxlHlHojWWvcIzUC4Erkrwf8u0MQS37JrqHSpbBLOEJBgwL
   w==;
IronPort-SDR: 
 5V49/zW7xOOaie28B5lYLB/4
X-IronPort-AV: E=Sophos;i="5.88,343,1635231600"; 
   d="scan'208";a="151993909"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa5.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 04 Feb 2022 10:46:05 -0700
Received: from chn-vm-ex01.mchp-main.com (10.10.85.143) by
 chn-vm-ex03.mchp-main.com (10.10.85.151) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2375.17; Fri, 4 Feb 2022 10:46:03 -0700
Received: from CHE-LT-I21427LX.microchip.com (10.10.115.15) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server id
 15.1.2375.17 via Frontend Transport; Fri, 4 Feb 2022 10:45:57 -0700
...
Subject: [PATCH v7 net-next 09/10] net: dsa: microchip: add support for fdb and mdb management
Date:   Fri, 4 Feb 2022 23:14:59 +0530
Message-ID: <20220204174500.72814-10-prasanna.vengateshan@microchip.com>
...
index 8e5edb89bd38..bc1b66777e03 100644
...
@@ -99,6 +163,448 @@ static void lan937x_port_stp_state_set(struct dsa_switch *ds, int port,
...
+
 static int lan937x_port_mirror_add(struct dsa_switch *ds, int port,
 				   ...
 				   bool ingress)
@@ -596,6 +1102,11 @@ const struct dsa_switch_ops lan937x_switch_ops = {
