...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E2C06659D4A
	for <lists+devicetree@lfdr.de>; Fri, 30 Dec 2022 23:55:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235585AbiL3WzT (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 30 Dec 2022 17:55:19 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57880 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235541AbiL3WzQ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 30 Dec 2022 17:55:16 -0500
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1A2E51AA0F;
        Fri, 30 Dec 2022 14:55:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1672440911; x=1703976911;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=9bKIrB+T90EKmulK3Bk0BMJMe+oDrhlzjpbSRuL46cQ=;
  b=NpOwAcm5SPflU3iE6FTBe/6ZXwa8sP2yfX6IywtJwUkmBxwmmMpJ+/kC
   1Z/vCsLWwXazL688d+GbvtwaYc5RiWNkPnZQKopJompGE/cbVVLZhRUQY
   LiWz33k2jQjnOU9KU8AOGIYtYuG4gmjVa3mAgzy9lhQUlaz+mUOiY48jH
   wbHkd17UfOx6QunO6vR90bdyHKjAs05KifrMwORGD7QNMr2Gcm1XEkRxJ
   UDJEcw668hGb8nWkHie+DtyRsHERFxOcnUsc0qdYbRU86l197bVbrma3f
   mOeAwsCA//TwuT9mRx5B01hGbSu7JSy6rqU25JnudtcPKypIu06TCXhGD
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10576"; a="323252311"
X-IronPort-AV: E=Sophos;i="5.96,288,1665471600"; 
   d="scan'208";a="323252311"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Dec 2022 14:55:08 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10576"; a="717275003"
X-IronPort-AV: E=Sophos;i="5.96,288,1665471600"; 
   d="scan'208";a="717275003"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
  by fmsmga008.fm.intel.com with ESMTP; 30 Dec 2022 14:55:04 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1pBOHI-000Ij7-0S;
        Fri, 30 Dec 2022 22:55:04 +0000
Date:   Sat, 31 Dec 2022 06:54:29 +0800
...
Message-ID: <202212310638.FZqL0ixC-lkp@intel.com>
References: <20221230001442.369608-3-mailingradian@gmail.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="WRN9TsMWCfXRhNH+"
...
url:    https://github.com/intel-lab-lkp/linux/commits/Richard-Acayan/dt-bindings-interconnect-add-sdm670-interconnects/20221230-081654
base:   https://git.kernel.org/pub/scm/linux/kernel/git/robh/linux.git for-next
patch link:    https://lore.kernel.org/r/20221230001442.369608-3-mailingradian%40gmail.com
patch subject: [PATCH v2 2/4] interconnect: qcom: add sdm670 interconnects
config: arm-allyesconfig
compiler: arm-linux-gnueabi-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/d276a827a6b949d176d23f0bc03c600a1b431c0e
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Richard-Acayan/dt-bindings-interconnect-add-sdm670-interconnects/20221230-081654
        git checkout d276a827a6b949d176d23f0bc03c600a1b431c0e
...
>> drivers/interconnect/qcom/sdm670.c:11:10: fatal error: dt-bindings/interconnect/qcom,sdm670.h: No such file or directory
      11 | #include <dt-bindings/interconnect/qcom,sdm670.h>
         |          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   compilation terminated.


vim +11 drivers/interconnect/qcom/sdm670.c
