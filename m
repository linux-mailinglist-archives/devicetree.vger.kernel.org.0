...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 332CF258EA8
	for <lists+devicetree@lfdr.de>; Tue,  1 Sep 2020 14:54:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726326AbgIAMyC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 1 Sep 2020 08:54:02 -0400
Received: from Galois.linutronix.de ([193.142.43.55]:40154 "EHLO
        galois.linutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728148AbgIAMuk (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 1 Sep 2020 08:50:40 -0400
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=mA6+WxbJlIMWboPOtDXSFyJecOrxcPpylvnH/AG1Ey8=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1598964631;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=mA6+WxbJlIMWboPOtDXSFyJecOrxcPpylvnH/AG1Ey8=;
        b=mOzmTt8GDNe5jUJQNzG3s80V+TsQiw5BbNnbMcMsxt5PiwhW0L++tdlT3mGSZD5dtyUe3L
        PEMT/+nfnSxiiZDg==
...
Subject: [PATCH v4 3/7] net: dsa: hellcreek: Add PTP clock support
Date:   Tue,  1 Sep 2020 14:50:10 +0200
Message-Id: <20200901125014.17801-4-kurt@linutronix.de>
...
index 242d6a843143..ed75468005a3 100644
...
+#include "hellcreek_ptp.h"
 ...
 static const struct hellcreek_counter hellcreek_counter[] = {
 	{ 0x00, "RxFiltered", },
@@ -952,6 +953,43 @@ static void hellcreek_setup_tc_identity_mapping(struct hellcreek *hellcreek)
 	}
 }
...
@@ -994,6 +1032,14 @@ static int hellcreek_setup(struct dsa_switch *ds)
...
@@ -1084,6 +1130,7 @@ static int hellcreek_probe(struct platform_device *pdev)
 	}
...
@@ -1099,6 +1146,18 @@ static int hellcreek_probe(struct platform_device *pdev)
...
@@ -1129,15 +1188,27 @@ static int hellcreek_probe(struct platform_device *pdev)
 		return ret;
 	}
...
index 79e553e2e57d..8d872a08f9de 100644
...
@@ -235,10 +236,17 @@ struct hellcreek {
