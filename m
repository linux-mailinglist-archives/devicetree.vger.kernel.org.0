...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C8BF162D0C6
	for <lists+devicetree@lfdr.de>; Thu, 17 Nov 2022 02:44:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230377AbiKQBoi (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 16 Nov 2022 20:44:38 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43318 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234308AbiKQBoh (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 16 Nov 2022 20:44:37 -0500
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7DB886A6B9;
        Wed, 16 Nov 2022 17:44:33 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1668649473; x=1700185473;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=EFK7mbmVhWbERHTOP2xAjK4CQDr5BKQc7FUH3QRDp5A=;
  b=aDyMFK4MAesBMyAXW3VccBbXtXR9clv+F5Q2T+ZyfL4Z53b26OSb5yfq
   dMo3LPHX5ne4xOFxkkghGa59S145glqa6w5zwuONaCYMb702MlXwfyduL
   Bf0RbJQi8Ey8TyqoY3WNmdZpOOBSwEIhYeFsjvSCaHtZOKnX8Q+wvG09l
   xmR6QLwbViLNS+wQJEXq9BMMX3AzHmM//g91xjD0gLNgbCpk/fg9VsP20
   4nVNOfy5veUNuK6z2SanoLb444y4A0F/pP0Gbg+IHNb+9NNTwd9McGEao
   s44nG5HjZoUTcK2aeakhHNcYQ+hehPe2mkJvW2vwoFRbxkG6KYjdZBuqz
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10533"; a="296086436"
X-IronPort-AV: E=Sophos;i="5.96,169,1665471600"; 
   d="scan'208";a="296086436"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Nov 2022 17:44:32 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10533"; a="764559580"
X-IronPort-AV: E=Sophos;i="5.96,169,1665471600"; 
   d="scan'208";a="764559580"
Received: from lkp-server01.sh.intel.com (HELO ebd99836cbe0) ([10.239.97.150])
  by orsmga004.jf.intel.com with ESMTP; 16 Nov 2022 17:44:28 -0800
Received: from kbuild by ebd99836cbe0 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ovTx5-0002wL-1I;
        Thu, 17 Nov 2022 01:44:27 +0000
Date:   Thu, 17 Nov 2022 09:43:36 +0800
...
Subject: Re: [PATCH 10/10] phy: qualcomm: phy-qcom-snps-eusb2: Add support
 for eUSB2 repeater
Message-ID: <202211170900.ruxTa6ST-lkp@intel.com>
References: <20221116120157.2706810-11-abel.vesa@linaro.org>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="JQl6JCWxqy6BGe33"
Content-Disposition: inline
In-Reply-To: <20221116120157.2706810-11-abel.vesa@linaro.org>
...
patch link:    https://lore.kernel.org/r/20221116120157.2706810-11-abel.vesa%40linaro.org
patch subject: [PATCH 10/10] phy: qualcomm: phy-qcom-snps-eusb2: Add support for eUSB2 repeater
config: s390-allyesconfig
compiler: s390-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/05e41426432fca60ef9f4389b0275f0c5c44cc31
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Abel-Vesa/phy-qualcomm-Add-support-for-SM8550/20221116-200911
        git checkout 05e41426432fca60ef9f4389b0275f0c5c44cc31
...
>> drivers/phy/qualcomm/phy-qcom-snps-eusb2.c:19:10: fatal error: linux/usb/repeater.h: No such file or directory
      19 | #include <linux/usb/repeater.h>
         |          ^~~~~~~~~~~~~~~~~~~~~~
   compilation terminated.


vim +19 drivers/phy/qualcomm/phy-qcom-snps-eusb2.c
