...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E0B87222769
	for <lists+devicetree@lfdr.de>; Thu, 16 Jul 2020 17:39:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729278AbgGPPjp (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 16 Jul 2020 11:39:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58552 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1729422AbgGPPjY (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 16 Jul 2020 11:39:24 -0400
Received: from mail-pf1-x441.google.com (mail-pf1-x441.google.com [IPv6:2607:f8b0:4864:20::441])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4CB05C061755
        for <devicetree@vger.kernel.org>; Thu, 16 Jul 2020 08:39:24 -0700 (PDT)
Received: by mail-pf1-x441.google.com with SMTP id a24so3861192pfc.10
        for <devicetree@vger.kernel.org>; Thu, 16 Jul 2020 08:39:24 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=Yi1s8hLCI0RCiUfWmTLRQoY8wYRpDqwOFsfkKAMjhUw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Yi1s8hLCI0RCiUfWmTLRQoY8wYRpDqwOFsfkKAMjhUw=;
        b=
X-Gm-Message-State: AOAM533RAcWIMVcSlH6hYQA0kRQlHriGj50zgy0TIX5uXmX3LA/THJhM
        9TAl2wPOys0QLBoRJQjjHlXtYg==
X-Google-Smtp-Source: ABdhPJybhffN3T48hqaV8obnExLi92YkFHiv4mvyPtccSztW49ZcRboQdT17d1OWfESzjnIOpYnifQ==
X-Received: by 2002:a62:6285:: with SMTP id w127mr4088130pfb.12.1594913963378;
        Thu, 16 Jul 2020 08:39:23 -0700 (PDT)
Received: from nagraj.local ([49.206.21.239])
        by smtp.gmail.com with ESMTPSA id f14sm417056pjq.36.2020.07.16.08.39.19
...
Subject: [PATCH 2/2] drm: panel: Add tianma nt36672a panel driver
Date:   Thu, 16 Jul 2020 21:08:58 +0530
Message-Id: <20200716153858.526-3-sumit.semwal@linaro.org>
...
index 000000000000..166773612ad2
--- /dev/null
...
+	 * for 10ms, but for Android / AOSP, we needed to bump it upto
+	 * 20 otherwise we get white screen sometimes.
+	 */
+	gpiod_set_value(pinfo->reset_gpio, 0);
+	msleep(20);
