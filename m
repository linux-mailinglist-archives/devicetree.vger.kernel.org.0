...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C942666A641
	for <lists+devicetree@lfdr.de>; Fri, 13 Jan 2023 23:56:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230144AbjAMW4Z (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 13 Jan 2023 17:56:25 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48046 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229854AbjAMW4Y (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 13 Jan 2023 17:56:24 -0500
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4746476AE9;
        Fri, 13 Jan 2023 14:56:18 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1673650578; x=1705186578;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=79ZRe/G9qEDQZII8/ylnn3+LS2t9erDi1g9KDiHJ0U4=;
  b=Zh6IBN/QUvJ3j+ZpnSV7T8cFjA3sD635nHDnBs0Zoey4s+2moVmZ46X/
   iv2SDX8hMlSVUKMdLXpfi3gsWk/97Jcrtz9pZrdcaBiFIv5IkaSyKdZbD
   myqx0ikHrn+DaHo7qyxSL+w488FsMciRTfcqLdAJ+MmpA21Xlu/EXI1ke
   4L0jgBRXv5wcougpTczvEG6heOItEifYTWaWRcgwFvQ9wPxAArR1+Hnil
   c26yUOX5BpqO8xQhkZF6+zkwIw8MjsODBcM8dIk3N7ewhSNjtlMQyLCEA
   Xk3ptk841NnufnrWuQW3c+DXpGQ0FhKo22hx27yfUDvYkhNwYbH4zC8kO
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10589"; a="324180166"
X-IronPort-AV: E=Sophos;i="5.97,215,1669104000"; 
   d="scan'208";a="324180166"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Jan 2023 14:56:15 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10589"; a="608304554"
X-IronPort-AV: E=Sophos;i="5.97,215,1669104000"; 
   d="scan'208";a="608304554"
Received: from lkp-server02.sh.intel.com (HELO f1920e93ebb5) ([10.239.97.151])
  by orsmga003.jf.intel.com with ESMTP; 13 Jan 2023 14:56:10 -0800
Received: from kbuild by f1920e93ebb5 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1pGSy1-000BUY-13;
        Fri, 13 Jan 2023 22:56:09 +0000
Date:   Sat, 14 Jan 2023 06:56:01 +0800
...
Subject: Re: [PATCH v1 02/20] clk: imx6q: add ethernet refclock mux support
Message-ID: <202301140610.v7DyNAQW-lkp@intel.com>
References: <20230113142718.3038265-3-o.rempel@pengutronix.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="xT056EAot20eU1Ai"
Content-Disposition: inline
In-Reply-To: <20230113142718.3038265-3-o.rempel@pengutronix.de>
...
patch link:    https://lore.kernel.org/r/20230113142718.3038265-3-o.rempel%40pengutronix.de
patch subject: [PATCH v1 02/20] clk: imx6q: add ethernet refclock mux support
config: arm-defconfig
compiler: arm-linux-gnueabi-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/8ec2b91ab3f8fec133349862f30f382030946461
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Oleksij-Rempel/clk-imx-add-clk-gpr-mux-driver/20230113-223542
        git checkout 8ec2b91ab3f8fec133349862f30f382030946461
...
>> drivers/clk/imx/clk-imx6q.c:919:46: warning: passing argument 4 of 'imx_clk_gpr_mux' discards 'const' qualifier from pointer target type [-Wdiscarded-qualifiers]
     919 |                                 IOMUXC_GPR1, enet_ref_sels, ARRAY_SIZE(enet_ref_sels),
         |                                              ^~~~~~~~~~~~~
   In file included from drivers/clk/imx/clk-imx6q.c:22:
   drivers/clk/imx/clk.h:463:54: note: expected 'const char **' but argument is of type 'const char * const*'
     463 |                                u32 reg, const char **parent_names,
         |                                         ~~~~~~~~~~~~~^~~~~~~~~~~~


vim +919 drivers/clk/imx/clk-imx6q.c
