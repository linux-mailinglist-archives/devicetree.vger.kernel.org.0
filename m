...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 876B2E6452
	for <lists+devicetree@lfdr.de>; Sun, 27 Oct 2019 17:49:53 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727491AbfJ0Qtv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 27 Oct 2019 12:49:51 -0400
Received: from mail.kernel.org ([198.145.29.99]:51434 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727346AbfJ0Qtv (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Sun, 27 Oct 2019 12:49:51 -0400
Received: from archlinux (cpc149474-cmbg20-2-0-cust94.5-4.cable.virginm.net [82.4.196.95])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id AB8DC20679;
        Sun, 27 Oct 2019 16:49:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1572194989;
        bh=cq8+x17NS7KXsQyNQEZi3b9h25ZjLmT4y7mjyLRCGXM=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=qcyjZWTzDbz8kz+wrtDv3boAIoX4z0sR1kimAaSDZegJsFd/OJjLRWOe67Z42g4Cc
         NxNOXWB4nVnXhE4d38pt7z4MAldQgchoqaC2Z4+QvdTpTGexS6FIbxSg2K+h9gmb6j
         Z3cAxMcIJX8sVO2wHTfDg7yWxtQKidu8DWAd3zSI=
Date:   Sun, 27 Oct 2019 16:49:43 +0000
...
Subject: Re: [PATCH v5 1/3] iio: light: add driver for veml6030 ambient
 light sensor
Message-ID: <20191027164943.029645e0@archlinux>
In-Reply-To: <1571749796-8608-1-git-send-email-gupt21@gmail.com>
References: <1571749796-8608-1-git-send-email-gupt21@gmail.com>
...
On Tue, 22 Oct 2019 18:39:56 +0530
...
The issue I point out in the docs for 'period' is unsurprisingly an 
issue here as well.  You have to do the magic to make it be in
seconds. Note that often means the _available isn't constant
as it will change as other factors change (sampling_frequency
which in this case directly maps to the inverse of the
integration period - I think!).
...
> +		return -EINVAL;
This doesn't match the documented behavior of period.  You need
to do the magic to make this take values in seconds rather than
sampling periods.
