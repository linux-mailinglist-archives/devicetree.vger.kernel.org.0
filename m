...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CF6965EFBE8
	for <lists+devicetree@lfdr.de>; Thu, 29 Sep 2022 19:24:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235091AbiI2RYg (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 29 Sep 2022 13:24:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32848 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236234AbiI2RYL (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 29 Sep 2022 13:24:11 -0400
Received: from mail-wr1-x430.google.com (mail-wr1-x430.google.com [IPv6:2a00:1450:4864:20::430])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A769C1205A1;
        Thu, 29 Sep 2022 10:24:04 -0700 (PDT)
Received: by mail-wr1-x430.google.com with SMTP id bq9so3239328wrb.4;
        Thu, 29 Sep 2022 10:24:04 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date;
        bh=MfKhGzOWZz37zL4fBv1KOPrnzQR6pPs5jvVlV98gxEg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:references:in-reply-to
         ...
         :subject:date;
        bh=MfKhGzOWZz37zL4fBv1KOPrnzQR6pPs5jvVlV98gxEg=;
        b=
X-Gm-Message-State: ACrzQf1BlBVO6HTHMK5e+bq2ROdNQ4yNjhIQA1glFdwT9dkCfyk2lHnb
        PLi/nEpALswnKiR+w65eIpc=
X-Google-Smtp-Source: AMsMyM6DeCsPPTySCewj7behr8rPfWHw0i3eazyu4zdeDfypG6ObYt44IafeVUxnbPE79ez2FEyZQA==
X-Received: by 2002:a05:6000:2c3:b0:22b:237b:a6a8 with SMTP id o3-20020a05600002c300b0022b237ba6a8mr3174316wry.484.1664472242970;
        Thu, 29 Sep 2022 10:24:02 -0700 (PDT)
Received: from prasmi.home ([2a00:23c8:2501:c701:9174:aca4:83d8:90fd])
        by smtp.gmail.com with ESMTPSA id d18-20020adfe852000000b0022a293ab1e9sm11815wrn.11.2022.09.29.10.24.01
...
Subject: [RFC PATCH 1/2] arm64: dts: renesas: r9a07g043: Introduce SOC_PERIPHERAL_IRQ() macro to specify interrupt property
Date:   Thu, 29 Sep 2022 18:23:55 +0100
Message-Id: <20220929172356.301342-2-prabhakar.mahadev-lad.rj@bp.renesas.com>
...
---
 arch/arm64/boot/dts/renesas/r9a07g043.dtsi    | 305 +++++++++---------
...
index 689aa4ba416b..dfb8e1e30236 100644
...
+				     <SOC_PERIPHERAL_IRQ(50, IRQ_TYPE_LEVEL_HIGH)>;
 			...
 			power-domains = <&cpg>;
@@ -827,8 +826,8 @@ wdt2: watchdog@12800400 {
...
+				     <SOC_PERIPHERAL_IRQ(54, IRQ_TYPE_LEVEL_HIGH)>;
 			...
 			power-domains = <&cpg>;
@@ -839,7 +838,7 @@ ostm0: timer@12801000 {
...
+			interrupts = <SOC_PERIPHERAL_IRQ(46, IRQ_TYPE_EDGE_RISING)>;
 			...
 			power-domains = <&cpg>;
@@ -850,7 +849,7 @@ ostm1: timer@12801400 {
 			compatible = "renesas,r9a07g043-ostm",
 				     "renesas,ostm";
...
+			interrupts = <SOC_PERIPHERAL_IRQ(47, IRQ_TYPE_EDGE_RISING)>;
 			...
 			power-domains = <&cpg>;
@@ -861,7 +860,7 @@ ostm2: timer@12801800 {
 			compatible = "renesas,r9a07g043-ostm",
 				     "renesas,ostm";
