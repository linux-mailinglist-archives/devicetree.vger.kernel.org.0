...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 211C797379
	for <lists+devicetree@lfdr.de>; Wed, 21 Aug 2019 09:31:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728319AbfHUHbW (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 21 Aug 2019 03:31:22 -0400
Received: from metis.ext.pengutronix.de ([85.220.165.71]:54917 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728332AbfHUHbV (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 21 Aug 2019 03:31:21 -0400
Received: from dude02.hi.pengutronix.de ([2001:67c:670:100:1d::28] helo=dude02.lab.pengutronix.de)
        by metis.ext.pengutronix.de with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mfe@pengutronix.de>)
        id 1i0L5J-0003au-9E; Wed, 21 Aug 2019 09:31:09 +0200
Received: from mfe by dude02.lab.pengutronix.de with local (Exim 4.89)
        (envelope-from <mfe@pengutronix.de>)
        id 1i0L5H-0005Mu-BK; Wed, 21 Aug 2019 09:31:07 +0200
...
Subject: [PATCH v8 03/13] media: v4l2-fwnode: add initial connector parsing support
Date:   Wed, 21 Aug 2019 09:30:53 +0200
Message-Id: <20190821073103.19634-4-m.felsch@pengutronix.de>
...
index 3bd1888787eb..3b755afe4c6b 100644
--- a/drivers/media/v4l2-core/v4l2-fwnode.c
+++ b/drivers/media/v4l2-core/v4l2-fwnode.c
@@ -595,6 +595,139 @@ void v4l2_fwnode_put_link(struct v4l2_fwnode_link *link)
 }
...
+	default:
+		pr_err("Unknown connector type or parsing not supported\n");
+		err = -EINVAL;
+		goto err_free_links;
+	};
+
...
index 7ca5669ef6fa..fb8790b7b95c 100644
