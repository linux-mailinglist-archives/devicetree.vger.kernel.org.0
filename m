...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BD35B45E9EA
	for <lists+devicetree@lfdr.de>; Fri, 26 Nov 2021 10:06:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1359819AbhKZJJT (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 26 Nov 2021 04:09:19 -0500
Received: from esa.microchip.iphmx.com ([68.232.154.123]:1165 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1359850AbhKZJHR (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 26 Nov 2021 04:07:17 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1637917444; x=1669453444;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=cLWviyAxZ1sNv4z4bpsALbCbj9EWDciGFc+gtz+zzvE=;
  b=qLhxgZ4djCbjsfMikOsAepgi8uutmBAHKG72AnvGlQ0OPz1g2HMKFi8e
   p0h8PGPcn4CBJrFQ/cpv6sw2hX3awM/2qUIgeBEFHzCZ4rzNMhBDysTBk
   B8tkr3wwXTHMG9mLTuRzAlWAzlDbtCRKnXL5WDNlMOzV36eHzIYGIrjse
   /WagDHF49wZ8V5Mt9F8DEUMUnxHQ1nHQHk3IFCS2Ic6HLaQgiVkcYSRfl
   qL64goz7jfhP4712xBJlWjHetD84OlqYtlVTCAXFCcTD1uSYKSrq68QbZ
   etyyYfBnWq1EgnrDBgKIEC5+qAdq3GIASODwdAcLpraa6JvkC2ZSXspgO
   g==;
IronPort-SDR: 
 5XLoqNevDml5b+cDiVvoDv1x
X-IronPort-AV: E=Sophos;i="5.87,265,1631602800"; 
   d="scan'208";a="140385796"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa2.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 26 Nov 2021 02:04:04 -0700
Received: from chn-vm-ex02.mchp-main.com (10.10.85.144) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.14; Fri, 26 Nov 2021 02:04:03 -0700
Received: from soft-dev3-1.microsemi.net (10.10.115.15) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server id
 15.1.2176.14 via Frontend Transport; Fri, 26 Nov 2021 02:04:01 -0700
...
Subject: [PATCH net-next v4 3/6] net: lan966x: add port module support
Date:   Fri, 26 Nov 2021 10:05:37 +0100
Message-ID: <20211126090540.3550913-4-horatiu.vultur@microchip.com>
...
---
 ...
 .../ethernet/microchip/lan966x/lan966x_main.c | 506 +++++++++++++++++-
 ...
 6 files changed, 1252 insertions(+), 5 deletions(-)
...
index 2a559266a4ac..6a3d4011994a 100644
...
@@ -317,21 +785,45 @@ static int lan966x_probe(struct platform_device *pdev)
...
+		lan966x_port_init(lan966x->ports[p]);
 	...
 	return 0;
@@ -339,11 +831,17 @@ static int lan966x_probe(struct platform_device *pdev)
 cleanup_ports:
...
new file mode 100644
index 000000000000..11706e75e427
--- /dev/null
...
new file mode 100644
index 000000000000..54d598045b66
--- /dev/null
