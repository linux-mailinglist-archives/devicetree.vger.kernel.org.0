...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6E05A11A8AD
	for <lists+devicetree@lfdr.de>; Wed, 11 Dec 2019 11:12:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727829AbfLKKMv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 11 Dec 2019 05:12:51 -0500
Received: from mx07-002cda01.pphosted.com ([185.132.180.122]:17496 "EHLO
        mx07-002cda01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728480AbfLKKMv (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Wed, 11 Dec 2019 05:12:51 -0500
Received: from pps.filterd (m0135535.ppops.net [127.0.0.1])
        by mx07-002cda01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id xBB9oqDe021478;
        Wed, 11 Dec 2019 09:59:48 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=avl.com; h=from : to : cc : subject
 : date : message-id : in-reply-to : references : mime-version :
 content-type; s=08102019; bh=+QNnm6Bi0x5PwakXJ9uy98hXa+Q7XMDpEDbcnZIYQyg=;
 b= fA== 
Received: from atgrzso8133.avl01.avlcorp.lan ([192.102.17.76])
        by mx07-002cda01.pphosted.com with ESMTP id 2wr59gpu5k-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 11 Dec 2019 09:59:48 +0000
Received: from pps.filterd (atgrzso8133.avl01.avlcorp.lan [127.0.0.1])
        by atgrzso8133.avl01.avlcorp.lan (8.16.0.27/8.16.0.27) with SMTP id xBB7mf7w026664;
        Wed, 11 Dec 2019 10:59:47 +0100
Received: from atgrzsw1695.avl01.avlcorp.lan ([10.13.100.86])
        by atgrzso8133.avl01.avlcorp.lan with ESMTP id 2wr3hmsyve-2
...
Subject: [PATCH v4 1/3] iio: pressure: Add driver for DLH pressure sensors
Date:   Wed, 11 Dec 2019 10:59:44 +0100
Message-ID: <20191211095946.7904-2-tomislav.denis@avl.com>
