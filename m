...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 769CB639958
	for <lists+devicetree@lfdr.de>; Sun, 27 Nov 2022 06:08:37 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229600AbiK0FIf (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 27 Nov 2022 00:08:35 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34602 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229453AbiK0FId (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 27 Nov 2022 00:08:33 -0500
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 94504BE08;
        Sat, 26 Nov 2022 21:08:28 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669525708; x=1701061708;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=XiPpXU4IBJRNrgSMEdNkkChv/EeXBZrLDO645TxiyMQ=;
  b=V6AcsmxQS/9e0kHSyCJgE2jhcP7olfgy7UmPYSWLRSmJ954TG3n4Mvem
   07cKBp5SlZ4ozIHHvn50a1atTFEsrXWkl5ZftD5tj8nTSJHKjcx3pHYtI
   ijYClQwDFvPDBOnIrqaYs0rVjyuoV8HJhmyZVUTS+dVeksY/rY04NqUOP
   M+H6yl3khCZBN8aUKbBYSZPh7ePffBwvO8AAw1uqlqo0vm0jjOexIgO6x
   VGKyW9UJngK/XogDpxEzMLKfZL7ze/8rRvAVYEvdpUcD9cUOE9BnXTBOK
   Jiqnx/TSZkuLzK3/St+Lc2b+YNUF7HR9OLcMPOXeYX5y05qrTnYWfUJO8
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10543"; a="312280419"
X-IronPort-AV: E=Sophos;i="5.96,197,1665471600"; 
   d="scan'208";a="312280419"
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 26 Nov 2022 21:08:26 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10543"; a="706413855"
X-IronPort-AV: E=Sophos;i="5.96,197,1665471600"; 
   d="scan'208";a="706413855"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by fmsmga008.fm.intel.com with ESMTP; 26 Nov 2022 21:08:20 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oz9ts-0006m9-0R;
        Sun, 27 Nov 2022 05:08:20 +0000
Date:   Sun, 27 Nov 2022 13:07:28 +0800
...
Message-ID: <202211271224.yTDgXPma-lkp@intel.com>
References: <20221126224740.311625-5-marex@denx.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="U4tt8FXLLCqoTi28"
...
[also build test WARNING on soc/for-next linus/master v6.1-rc6 next-20221125]
...
All warnings (new ones prefixed by >>):
   ...
   drivers/thermal/imx8mm_thermal.c: In function 'imx8mm_tmu_probe_set_calib_v2':
   drivers/thermal/imx8mm_thermal.c:214:9: error: implicit declaration of function 'kfree'; did you mean 'vfree'? [-Werror=implicit-function-declaration]
     214 |         kfree(buf);
         |         ^~~~~
         |         vfree
   In file included from include/linux/device.h:15,
                    ...
                    from drivers/thermal/imx8mm_thermal.c:15:
>> drivers/thermal/imx8mm_thermal.c:218:25: warning: format '%ld' expects argument of type 'long int', but argument 3 has type 'size_t' {aka 'unsigned int'} [-Wformat=]
   ...
   include/linux/dev_printk.h:144:56: note: in expansion of macro 'dev_fmt'
     144 |         dev_printk_index_wrap(_dev_err, KERN_ERR, dev, dev_fmt(fmt), ##__VA_ARGS__)
         |                                                        ^~~~~~~
   drivers/thermal/imx8mm_thermal.c:217:17: note: in expansion of macro 'dev_err'
     217 |                 dev_err(dev,
         |                 ^~~~~~~
   drivers/thermal/imx8mm_thermal.c:218:55: note: format string is defined here
     218 |                         "OCOTP nvmem cell length is %ld, must be 16.\n", len);
         |                                                     ~~^
         |                                                       |
         |                                                       long int
...
vim +218 drivers/thermal/imx8mm_thermal.c
