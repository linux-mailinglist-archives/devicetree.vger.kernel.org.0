...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A15EF51D48E
	for <lists+devicetree@lfdr.de>; Fri,  6 May 2022 11:32:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242435AbiEFJex (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 6 May 2022 05:34:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44834 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1390705AbiEFJeF (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 6 May 2022 05:34:05 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E2E5869283;
        Fri,  6 May 2022 02:29:37 -0700 (PDT)
X-UUID: f213b1d8565e427484fac01f3f7bf4b1-20220506
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.4,REQID:6b161a90-faef-4c52-99d5-bd0b695d8f05,OB:0,LO
        B:0,IP:0,URL:8,TC:0,Content:-20,EDM:0,RT:0,SF:-3,FILE:0,RULE:Release_Ham,A
        CTION:release,TS:-15
X-CID-INFO: VERSION:1.1.4,REQID:6b161a90-faef-4c52-99d5-bd0b695d8f05,OB:0,LOB:
        0,IP:0,URL:8,TC:0,Content:-20,EDM:0,RT:0,SF:-3,FILE:0,RULE:Release_Ham,ACT
        ION:release,TS:-15
X-CID-META: VersionHash:faefae9,CLOUDID:a2677416-2e53-443e-b81a-655c13977218,C
...
Received: from mtkcas11.mediatek.inc [(172.21.101.40)] by mailgw02.mediatek.com
        ...
        with ESMTP id 1698442180; Fri, 06 May 2022 17:29:32 +0800
Received: from mtkcas10.mediatek.inc (172.21.101.39) by
 mtkmbs10n1.mediatek.inc (172.21.101.34) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id
 15.2.792.15; Fri, 6 May 2022 17:29:30 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkcas10.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Fri, 6 May 2022 17:29:28 +0800
...
Subject: [PATCH v11, 16/17] media: mediatek: vcodec: support stateless VP9 decoding
Date:   Fri, 6 May 2022 17:28:54 +0800
Message-ID: <20220506092855.22940-17-yunfei.dong@mediatek.com>
...
---
 ...
 7 files changed, 2062 insertions(+), 3 deletions(-)
...
index 000000000000..3ebdb3c29e0e
--- /dev/null
...
+	}
+
+	memcpy_fromio(frame_ctx, (void __iomem *)remote_frame_ctx, sizeof(*frame_ctx));
...
+					   struct vdec_vp9_slice_vsi __iomem *remote_vsi,
+					   int skip)
+{
+	struct vdec_vp9_slice_frame __iomem *rf;
...
+			      sizeof(f->uh.dequant));
+		memcpy_fromio(&vsi->trans, (void __iomem *)&remote_vsi->trans, sizeof(vsi->trans));
+	}
+
...
+		goto err;
+	}
+	vdec_vp9_slice_vsi_to_remote(&pfc->vsi, (void __iomem *)instance->core_vsi);
+
...
+	}
+
+	vdec_vp9_slice_vsi_from_remote(&pfc->vsi, (void __iomem *)instance->core_vsi, 1);
