...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 75A5D13F7A
	for <lists+devicetree@lfdr.de>; Sun,  5 May 2019 14:53:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727665AbfEEMxV (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 5 May 2019 08:53:21 -0400
Received: from hamsrv800.servertools24.de ([213.238.32.28]:58397 "EHLO
        hamsrv800.servertools24.de" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727649AbfEEMxV (ORCPT
...
Received: from christian-pc.localdomain (p54A59A9B.dip0.t-ipconnect.de [84.165.154.155])
        by hamsrv800.servertools24.de (Postfix) with ESMTPSA id D939F2381A74;
        Sun,  5 May 2019 14:53:16 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=c-mauderer.de;
        s=default; t=1557060797;
        bh=CnxuMEqjDrOa9df2dI/2gzEQNvM+9qqI/uR5g50EVJA=; l=2955;
        h=From:To:Subject;
        b=ejNsrlpwZLl2a6WA84+w5DzoNB2Dui2FsbD6U4435b5NOaxKFMFRcMXIo7S35Kiad
         t5zHFFWBYA2YvR0FHOdUX9R/Uww988M5st0ZSG7bO0hFFJ5Q76oRaT44zZZuYonA+m
         FEsoxqZQeMkmt89zVzFM9/UgPd7rEf56SXbMCZT0=
...
Subject: [PATCH v2 1/2] dt-bindings: leds: Add binding for spi-byte LED.
Date:   Sun,  5 May 2019 14:52:41 +0200
Message-Id: <20190505125242.10298-1-oss@c-mauderer.de>
X-Mailer: git-send-email 2.21.0
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-PPP-Message-ID: <155706079729.85279.2978407823587543726@hamsrv800.servertools24.de>
