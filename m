...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 71D64120571
	for <lists+devicetree@lfdr.de>; Mon, 16 Dec 2019 13:21:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727707AbfLPMVI (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 16 Dec 2019 07:21:08 -0500
Received: from mail-pf1-f195.google.com ([209.85.210.195]:40675 "EHLO
        mail-pf1-f195.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727580AbfLPMVI (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 16 Dec 2019 07:21:08 -0500
Received: by mail-pf1-f195.google.com with SMTP id q8so5490586pfh.7;
        Mon, 16 Dec 2019 04:21:06 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=vtEMSI2qplR7r5IsbhqvpIonAOa6be46J5qI2B9SlNw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=vtEMSI2qplR7r5IsbhqvpIonAOa6be46J5qI2B9SlNw=;
        b=
X-Gm-Message-State: APjAAAVRWjlsWETjmSCfz+der1Z9U3AePCFk9NSrEUyWvfZyu/NJusWp
        pffJWQfr4eaJa82DAA/y9uw=
X-Google-Smtp-Source: APXvYqyzJ3J2frr68BqfppVJt1BOynEPvEUFJlyiSc3OE5JllJ5tioTPKoxCVJPDEp/QSeP42Xyguw==
X-Received: by 2002:a63:ce50:: with SMTP id r16mr17817417pgi.32.1576498865081;
        Mon, 16 Dec 2019 04:21:05 -0800 (PST)
Received: from ubt.spreadtrum.com ([117.18.48.82])
        by smtp.gmail.com with ESMTPSA id o17sm18633910pjq.1.2019.12.16.04.20.58
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 16 Dec 2019 04:21:04 -0800 (PST)
...
Subject: [PATCH V2 6/6] clk: sprd: add clocks support for SC9863A
Date:   Mon, 16 Dec 2019 20:19:32 +0800
Message-Id: <20191216121932.22967-7-zhang.lyra@gmail.com>
...
+
+/* mm clocks */
+static SPRD_GATE_CLK_HW(mipi_csi_clk, "mipi-csi-clk", &mm_ahb.common.hw, 0x20,
+			BIT(16), CLK_IGNORE_UNUSED, 0);
+static SPRD_GATE_CLK_HW(mipi_csi_s_clk, "mipi-csi-s-clk", &mm_ahb.common.hw, 0x24,
+			BIT(16), CLK_IGNORE_UNUSED, 0);
+static SPRD_GATE_CLK_HW(mipi_csi_m_clk, "mipi-csi-m-clk", &mm_ahb.common.hw, 0x28,
+			BIT(16), CLK_IGNORE_UNUSED, 0);
+
...
+static SPRD_SC_GATE_CLK_HW(vjpg_eb, "vjpg-eb", &mm_ahb.common.hw, 0x0, 0x1000,
+			   BIT(2), CLK_IGNORE_UNUSED, 0);
+static SPRD_SC_GATE_CLK_HW(vcpp_eb, "vcpp-eb", &mm_ahb.common.hw, 0x0, 0x1000,
...
+
+MODULE_DESCRIPTION("Unisoc SC9863A Clock Driver");
