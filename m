...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A6629183A2C
	for <lists+devicetree@lfdr.de>; Thu, 12 Mar 2020 21:05:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726569AbgCLUF3 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 12 Mar 2020 16:05:29 -0400
Received: from mail-ot1-f65.google.com ([209.85.210.65]:43010 "EHLO
        mail-ot1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726114AbgCLUF3 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 12 Mar 2020 16:05:29 -0400
Received: by mail-ot1-f65.google.com with SMTP id a6so7618490otb.10;
        Thu, 12 Mar 2020 13:05:28 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         :mime-version:content-disposition:in-reply-to:user-agent;
        bh=E7ir6yqbubXq67o2fEz4OT6tW6dYO1BgN+D1mftfxuQ=;
        b=
X-Gm-Message-State: ANhLgQ3i8lkl3MYfaRueJbtoDAOt9mxxZm1QVUumBbbivaQbnQcjfDm1
        5UKDF1PUsZVPZRu1c3ugyw==
X-Google-Smtp-Source: ADFU+vsR2Ix1h23VCBHJUcpvNgTNbGlF7Q4ybcZ0ElycIzWFDv0FGXFFdNEX8GF49m2swQ4ZQOVcZg==
X-Received: by 2002:a05:6830:134b:: with SMTP id r11mr2717249otq.305.1584043526327;
        Thu, 12 Mar 2020 13:05:26 -0700 (PDT)
Received: from rob-hp-laptop (24-155-109-49.dyn.grandenetworks.net. [24.155.109.49])
        by smtp.gmail.com with ESMTPSA id t21sm5900182otp.80.2020.03.12.13.05.24
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 12 Mar 2020 13:05:25 -0700 (PDT)
Received: (nullmailer pid 17967 invoked by uid 1000);
        Thu, 12 Mar 2020 20:05:23 -0000
Date:   Thu, 12 Mar 2020 15:05:23 -0500
...
Message-ID: <20200312200523.GA17854@bogus>
References: <20200306090720.9365-1-geert+renesas@glider.be>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200306090720.9365-1-geert+renesas@glider.be>
...
These 2 should have 'maxItems: 1'.
...
You really need this to be in any possible order? I'd rather fix the 
inconsistency in dts files.

The comments can be 'description' entries under 'interrupts'.
