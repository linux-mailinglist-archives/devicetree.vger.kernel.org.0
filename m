...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 20EA464E3AE
	for <lists+devicetree@lfdr.de>; Thu, 15 Dec 2022 23:12:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229884AbiLOWMZ (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 15 Dec 2022 17:12:25 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54312 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229882AbiLOWMY (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 15 Dec 2022 17:12:24 -0500
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0FC4E24BD8
        for <devicetree@vger.kernel.org>; Thu, 15 Dec 2022 14:12:21 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1671142341; x=1702678341;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=dJjHM5KgeX295TuRZjgiMQeVppEF+kXTTRbAo/TEqZ4=;
  b=A57Z/pEy1i1xAAf7WipXru+K5jtxyJqpLJKyjg8Lvke3alsYL2qxRJrC
   lUok+p0h7gLex/nCyRFP6ErkC4r1xcQYtF0yX12MjfmXegdjS0kHZrGFe
   PnHYjhLgDAhv1sVlz6Y4CtVdKZpqg3bRhQvTCGW7DP6wZvtl2sLqwzbsW
   zvgETh5QFKCR8LeM1VRucQF7C9U3enfqkIHq0nAfFbDp+XpgowvI75u3r
   sAUZ9AxGPvII2yBI95bZQXV0yhm/g81LEkcY3F4x5ipRY/B01FuLEWgtL
   WLwcaf5VfuNdL5C7ZmlNebr8/dxi2ap3hSkZiiqp46Nig1ox7qj/KptPB
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10562"; a="302239435"
X-IronPort-AV: E=Sophos;i="5.96,248,1665471600"; 
   d="scan'208";a="302239435"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 15 Dec 2022 14:12:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10562"; a="718151589"
X-IronPort-AV: E=Sophos;i="5.96,248,1665471600"; 
   d="scan'208";a="718151589"
...
Date:   Fri, 16 Dec 2022 06:11:06 +0800
...
Message-ID: <202212160650.mpIT03xb-lkp@intel.com>
References: <20221215185211.1560736-2-macroalpha82@gmail.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="JIGYYqjMvb1yzHjR"
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=clang make.cross W=1 O=build_dir ARCH=hexagon SHELL=/bin/bash drivers/gpu/drm/etnaviv/
...
All errors (new ones prefixed by >>):
   ...
   In file included from drivers/gpu/drm/etnaviv/etnaviv_drv.c:7:
   ...
   include/asm-generic/io.h:604:59: warning: performing pointer arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
           __raw_writel((u32 __force)cpu_to_le32(value), PCI_IOBASE + addr);
                                                         ~~~~~~~~~~ ^
   In file included from drivers/gpu/drm/etnaviv/etnaviv_drv.c:16:
>> include/drm/drm_of.h:138:1: error: expected identifier or '('
   {
   ^
