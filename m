...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 650845F19CD
	for <lists+devicetree@lfdr.de>; Sat,  1 Oct 2022 06:32:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229470AbiJAEc1 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 1 Oct 2022 00:32:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40954 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229458AbiJAEcY (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 1 Oct 2022 00:32:24 -0400
Received: from mga09.intel.com (mga09.intel.com [134.134.136.24])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D142519BBDB;
        Fri, 30 Sep 2022 21:32:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1664598739; x=1696134739;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=lTjwvWR9r4CYPom9BVA3JdpcaqcD6mI8u+A8z/FMOZA=;
  b=JD4P3yZGETiLksRzCpksfBGfGc3Anto5xRbLrC6p5W8VWhfENO6JUG0G
   iAdiw7iOm79NZ1GGz+eHlmqBLKYhnKSLvViNAjhIEOBwZc8YBXopFn2+x
   7wGfhbSvFoL244KVc2wFU7Hm3+XvOTeClu3Kq227xCfqhkGwg+wgndXpE
   ielqgQL2w456ecCv1w0aVDLAixAZ3ZyBTpcqsCmhwkfb51S+2+yl/6vxv
   u3SOoJJUqd3aj5dYh+THsOSVXy6IxVTIy3ukY9wmh6qS2M7JunvNlCY4K
   g8B8NqMGOAaNdVTG3bKna0PZFqZfhnqNRE4pJtRKKhyvbnAazg3pCTbIq
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10486"; a="303246633"
X-IronPort-AV: E=Sophos;i="5.93,359,1654585200"; 
   d="scan'208";a="303246633"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga102.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Sep 2022 21:32:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10486"; a="712027402"
X-IronPort-AV: E=Sophos;i="5.93,359,1654585200"; 
   d="scan'208";a="712027402"
Received: from lkp-server01.sh.intel.com (HELO 14cc182da2d0) ([10.239.97.150])
  by FMSMGA003.fm.intel.com with ESMTP; 30 Sep 2022 21:32:14 -0700
Received: from kbuild by 14cc182da2d0 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oeUAg-0001rD-0b;
        Sat, 01 Oct 2022 04:32:14 +0000
Date:   Sat, 1 Oct 2022 12:31:56 +0800
...
Subject: Re: [PATCHv2 9/9] clk: rockchip: add clock controller for the RK3588
Message-ID: <202210011252.v5JH8L6z-lkp@intel.com>
References: <20220930153857.299396-10-sebastian.reichel@collabora.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="IpfpxCa/Xvl+b7ei"
Content-Disposition: inline
In-Reply-To: <20220930153857.299396-10-sebastian.reichel@collabora.com>
...
[also build test WARNING on robh/for-next clk/clk-next linus/master v6.0-rc7 next-20220930]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Sebastian-Reichel/RK3588-Clock-and-Reset-Support/20220930-234036
base:   https://git.kernel.org/pub/scm/linux/kernel/git/mmind/linux-rockchip.git for-next
config: arm-randconfig-r012-20220926
compiler: arm-linux-gnueabi-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/87b741ef99e7c798cdccb1f1e3c9f91ee8f57a98
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Sebastian-Reichel/RK3588-Clock-and-Reset-Support/20220930-234036
        git checkout 87b741ef99e7c798cdccb1f1e3c9f91ee8f57a98
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=arm SHELL=/bin/bash drivers/clk/rockchip/
...
>> drivers/clk/rockchip/rst-rk3588.c:850:6: warning: no previous prototype for 'rk3588_rst_init' [-Wmissing-prototypes]
     850 | void rk3588_rst_init(struct device_node *np, void __iomem *reg_base)
         |      ^~~~~~~~~~~~~~~


vim +/rk3588_rst_init +850 drivers/clk/rockchip/rst-rk3588.c
...
# CONFIG_REALVIEW_EB_ARM1136 is not set
# CONFIG_REALVIEW_EB_ARM1176 is not set
CONFIG_REALVIEW_EB_A9MP=y
# CONFIG_REALVIEW_EB_ARM11MP is not set
