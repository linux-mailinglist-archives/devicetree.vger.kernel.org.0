...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 788B85F0DB8
	for <lists+devicetree@lfdr.de>; Fri, 30 Sep 2022 16:39:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230019AbiI3Ojx (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 30 Sep 2022 10:39:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35382 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229644AbiI3Ojv (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 30 Sep 2022 10:39:51 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 551DA1CFDA;
        Fri, 30 Sep 2022 07:39:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1664548785; x=1696084785;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=tEH2S9g/beZLtT2xQGPo8UOrbKE/IYIr68En5jwGDxo=;
  b=jSpwkWn99GTDSQBPyKWt4gXGV6nnHTAmqCLqC3lEG4TyglQUgYoIECyR
   tK3V63see7hCdNxc6o/u/2nZiIB0kFOsPy/ALNI85yde2HtsZFlUkIrpO
   H4/hsg8gd9T+Jugb1ML8Wqf3weKgtvTV1eN5+Afw4NzbklQq8I3tJYAQq
   S3Lgn106NUGoTQzVs3D3Z2mD82z5ed9SAbb7fBj3sGoIU6Do64ohsM/qZ
   5KO0CiVjsv1ZPNi9vDCwcZdd7l2Tw3dLpQaZisNMRIdBoG/xRxxIp2YPn
   ws5QFtCNj/H1iCj0b3mcLehjbvbTWQAcyoH3ggKZM3JbxSaCV9Mwody4x
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10486"; a="282568813"
X-IronPort-AV: E=Sophos;i="5.93,358,1654585200"; 
   d="scan'208";a="282568813"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Sep 2022 07:39:44 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10486"; a="951566171"
X-IronPort-AV: E=Sophos;i="5.93,358,1654585200"; 
   d="scan'208";a="951566171"
Received: from lkp-server01.sh.intel.com (HELO 14cc182da2d0) ([10.239.97.150])
  by fmsmga005.fm.intel.com with ESMTP; 30 Sep 2022 07:39:41 -0700
Received: from kbuild by 14cc182da2d0 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oeHAy-0001EB-3A;
        Fri, 30 Sep 2022 14:39:40 +0000
Date:   Fri, 30 Sep 2022 22:39:24 +0800
From:   kernel test robot <lkp@intel.com>
To:     Shubhrajyoti Datta <shubhrajyoti.datta@amd.com>,
        linux-clk@vger.kernel.org
Cc:     kbuild-all@lists.01.org, git@amd.com, devicetree@vger.kernel.org,
        krzysztof.kozlowski+dt@linaro.org, robh+dt@kernel.org,
        sboyd@kernel.org, mturquette@baylibre.com
Subject: Re: [PATCH 2/2] clocking-wizard: Add versal clocking wizard support
Message-ID: <202209302254.wRtWQ2wb-lkp@intel.com>
References: <20220930080400.15619-3-shubhrajyoti.datta@amd.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="xfhAjjvV/3Vin++Z"
Content-Disposition: inline
In-Reply-To: <20220930080400.15619-3-shubhrajyoti.datta@amd.com>
...
[cannot apply to xilinx-xlnx/master robh/for-next linus/master v6.0-rc7]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Shubhrajyoti-Datta/clocking-wizard-Add-versal-clocking-wizard-support/20220930-160608
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/bc89695e24c483cc25d86da24ea23b8763c45573
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Shubhrajyoti-Datta/clocking-wizard-Add-versal-clocking-wizard-support/20220930-160608
        git checkout bc89695e24c483cc25d86da24ea23b8763c45573
...
All errors (new ones prefixed by >>):
   ...
   mips-linux-ld: drivers/clk/xilinx/clk-xlnx-clock-wizard-v.o: in function `clk_wzrd_dynamic_all_nolock':
>> clk-xlnx-clock-wizard-v.c:(.text.clk_wzrd_dynamic_all_nolock+0x15c): undefined reference to `__udivdi3'
