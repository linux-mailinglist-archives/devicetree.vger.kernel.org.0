...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9121F52067A
	for <lists+devicetree@lfdr.de>; Mon,  9 May 2022 23:09:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230183AbiEIVLu (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 9 May 2022 17:11:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36480 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230020AbiEIVLq (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 9 May 2022 17:11:46 -0400
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [46.235.227.227])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CD9FBE7328;
        Mon,  9 May 2022 14:07:50 -0700 (PDT)
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (Authenticated sender: kholk11)
        with ESMTPSA id D30E11F430F3
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1652130469;
        bh=JLghvR/iOn7Dwgag/eEFL3hJl1MmWcjIvBMeSXosG2A=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Cc:     tglx@linutronix.de, robh+dt@kernel.org,
        ...
        <angelogioacchino.delregno@collabora.com>
Subject: [PATCH v2 2/2] clocksource/drivers/timer-mediatek: Implement CPUXGPT timers
Date:   Mon,  9 May 2022 23:07:40 +0200
