...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D168E44D0BA
	for <lists+devicetree@lfdr.de>; Thu, 11 Nov 2021 05:15:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233852AbhKKESN (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 10 Nov 2021 23:18:13 -0500
Received: from mailgw02.mediatek.com ([210.61.82.184]:50270 "EHLO
        mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S233929AbhKKESJ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 10 Nov 2021 23:18:09 -0500
X-UUID: b5f1bfe1b8e540a4b29ad64f8b6e05cc-20211111
X-UUID: b5f1bfe1b8e540a4b29ad64f8b6e05cc-20211111
Received: from mtkcas10.mediatek.inc [(172.21.101.39)] by mailgw02.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 128776434; Thu, 11 Nov 2021 12:15:17 +0800
Received: from mtkmbs10n2.mediatek.inc (172.21.101.183) by
 mtkmbs10n1.mediatek.inc (172.21.101.34) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.792.15; Thu, 11 Nov 2021 12:15:14 +0800
Received: from localhost.localdomain (10.17.3.154) by mtkmbs10n2.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.2.792.3 via Frontend
 Transport; Thu, 11 Nov 2021 12:15:13 +0800
...
Subject: [PATCH v10, 09/19] media: mtk-vcodec: Add irq interface for multi hardware
Date:   Thu, 11 Nov 2021 12:14:50 +0800
Message-ID: <20211111041500.17363-10-yunfei.dong@mediatek.com>
...
index c56411768234..b49ca8240185 100644
--- a/drivers/media/platform/mtk-vcodec/mtk_vcodec_dec_drv.c
+++ b/drivers/media/platform/mtk-vcodec/mtk_vcodec_dec_drv.c
@@ -63,6 +63,20 @@ static int mtk_vcodec_subdev_device_check(struct mtk_vcodec_ctx *ctx)
 	return 0;
 }
...
@@ -94,7 +108,7 @@ static irqreturn_t mtk_vcodec_dec_irq_handler(int irq, void *priv)
...
@@ -167,7 +181,7 @@ static int fops_vcodec_open(struct file *file)
 {
...
@@ -181,7 +195,19 @@ static int fops_vcodec_open(struct file *file)
 	v4l2_fh_add(&ctx->fh);
...
@@ -244,6 +270,7 @@ static int fops_vcodec_open(struct file *file)
 err_m2m_ctx_init:
...
index 8280c575bd99..9f294470c06d 100644
...
index 519002048fc1..8c2c0005a66a 100644
