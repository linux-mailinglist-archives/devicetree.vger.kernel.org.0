...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F1FF47536E3
	for <lists+devicetree@lfdr.de>; Fri, 14 Jul 2023 11:45:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235865AbjGNJpj (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 14 Jul 2023 05:45:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38508 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235549AbjGNJph (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 14 Jul 2023 05:45:37 -0400
Received: from fllv0016.ext.ti.com (fllv0016.ext.ti.com [198.47.19.142])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 032B530C4;
        Fri, 14 Jul 2023 02:45:24 -0700 (PDT)
Received: from lelv0265.itg.ti.com ([10.180.67.224])
        by fllv0016.ext.ti.com (8.15.2/8.15.2) with ESMTP id 36E9irG1035628;
        Fri, 14 Jul 2023 04:44:53 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1689327893;
        bh=4/VUfKQZ6EX1Vb/U2z3MYZ/fwg63UhpmGGFNPnVPKaE=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=sQcoPwHPXSrJXOTSTamoEifqF8i+a9HruT6JloNZnjKEMEQKE/NUFnDI6DUO/u3WQ
         F8s3KwgplygtZANv/wHGuysWn0CR5hDC44SOw2qANtIAy0aRAJjXTuXw9zStfWJ1nn
         40aP28Rgn9zzgHwu06H2fvv6I888+EsaOFApOdcY=
Received: from DLEE103.ent.ti.com (dlee103.ent.ti.com [157.170.170.33])
        by lelv0265.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 36E9irgU022837
        (version=TLSv1.2 cipher=AES256-GCM-SHA384 bits=256 verify=FAIL);
        Fri, 14 Jul 2023 04:44:53 -0500
Received: from DLEE104.ent.ti.com (157.170.170.34) by DLEE103.ent.ti.com
 (157.170.170.33) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23; Fri, 14
 Jul 2023 04:44:52 -0500
Received: from lelv0326.itg.ti.com (10.180.67.84) by DLEE104.ent.ti.com
 (157.170.170.34) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.2507.23 via
 Frontend Transport; Fri, 14 Jul 2023 04:44:52 -0500
Received: from lelv0854.itg.ti.com (lelv0854.itg.ti.com [10.181.64.140])
        by lelv0326.itg.ti.com (8.15.2/8.15.2) with ESMTP id 36E9iqbp027031;
        Fri, 14 Jul 2023 04:44:52 -0500
Received: from localhost (uda0501179.dhcp.ti.com [172.24.227.217])
        by lelv0854.itg.ti.com (8.14.7/8.14.7) with ESMTP id 36E9ip9b005831;
        Fri, 14 Jul 2023 04:44:52 -0500
...
Subject: [PATCH v9 2/2] net: ti: icssg-prueth: Add ICSSG ethernet driver
Date:   Fri, 14 Jul 2023 15:14:32 +0530
Message-ID: <20230714094432.1834489-3-danishanwar@ti.com>
X-Mailer: git-send-email 2.34.1
In-Reply-To: <20230714094432.1834489-1-danishanwar@ti.com>
...
---
 ...
 12 files changed, 4042 insertions(+)
...
index 75f761efbea7..62be0ef11342 100644
...
new file mode 100644
index 000000000000..f864fd5747fb
--- /dev/null
...
+#include <linux/regmap.h>
+
+/* ICSSG Stats base address for ICSSG Slice 0 and 1 */
...
new file mode 100644
index 000000000000..75c36fb8f74a
--- /dev/null
...
new file mode 100644
index 000000000000..fd4216400004
--- /dev/null
