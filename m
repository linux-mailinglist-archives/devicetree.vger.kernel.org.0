...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C6C283B25AB
	for <lists+devicetree@lfdr.de>; Thu, 24 Jun 2021 05:44:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230189AbhFXDq1 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 23 Jun 2021 23:46:27 -0400
Received: from mo-csw1516.securemx.jp ([210.130.202.155]:52138 "EHLO
        mo-csw.securemx.jp" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230116AbhFXDqZ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 23 Jun 2021 23:46:25 -0400
Received: by mo-csw.securemx.jp (mx-mo-csw1516) id 15O3ho9i011021; Thu, 24 Jun 2021 12:43:50 +0900
X-Iguazu-Qid: 34tMQAG0ehSTK7CpI9
X-Iguazu-QSIG: v=2; s=0; t=1624506230; q=34tMQAG0ehSTK7CpI9; m=nSCibdBp2qz8ao+yXumu/B85KQU5XHdxZl/C68VonM4=
Received: from imx2-a.toshiba.co.jp (imx2-a.toshiba.co.jp [106.186.93.35])
        by relay.securemx.jp (mx-mr1510) id 15O3hmXc029656
        (version=TLSv1.2 cipher=AES128-GCM-SHA256 bits=128 verify=NOT);
        Thu, 24 Jun 2021 12:43:49 +0900
Received: from enc01.toshiba.co.jp (enc01.toshiba.co.jp [106.186.93.100])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by imx2-a.toshiba.co.jp (Postfix) with ESMTPS id 515FC1000B7;
        Thu, 24 Jun 2021 12:43:48 +0900 (JST)
Received: from hop001.toshiba.co.jp ([133.199.164.63])
        by enc01.toshiba.co.jp  with ESMTP id 15O3hlTK008911;
...
Subject: [PATCH v3 1/4] clk: visconti: Add support common clock driver and reset driver
Date:   Thu, 24 Jun 2021 12:43:34 +0900
X-TSB-HOP: ON
Message-Id: <20210624034337.282386-2-nobuhiro1.iwamatsu@toshiba.co.jp>
...
new file mode 100644
index 000000000000..c72b50299e36
--- /dev/null
...
+	if (IS_ERR(clk)) {
+		pr_err("Failed to register OSC3 clock: %ld\n", PTR_ERR(clk));
+		return;
+	}
+
...
new file mode 100644
index 000000000000..f1c1bd1fb44d
--- /dev/null
