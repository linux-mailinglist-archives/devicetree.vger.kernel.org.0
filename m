...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 01CA0736FFD
	for <lists+devicetree@lfdr.de>; Tue, 20 Jun 2023 17:13:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233635AbjFTPNd (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 20 Jun 2023 11:13:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43966 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233616AbjFTPN3 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 20 Jun 2023 11:13:29 -0400
Received: from www530.your-server.de (www530.your-server.de [188.40.30.78])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 47F68198;
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=geanix.com;
        ...
        bh=2CrDY7R+Zqndz7jiijGinHpgv4VdmR4fNUdaajMT4/0=; b=Uij6d1i48WdCba1aTRYADH6+h1
        ;
Received: from sslproxy02.your-server.de ([78.47.166.47])
        by www530.your-server.de with esmtpsa  (TLS1.3) tls TLS_AES_256_GCM_SHA384
        (Exim 4.94.2)
        (envelope-from <sean@geanix.com>)
        id 1qBd2s-0001ZD-Cf; Tue, 20 Jun 2023 17:13:26 +0200
Received: from [185.17.218.86] (helo=zen..)
        by sslproxy02.your-server.de with esmtpsa (TLSv1.3:TLS_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <sean@geanix.com>)
        id 1qBd2r-0003u6-NE; Tue, 20 Jun 2023 17:13:25 +0200
...
Subject: [PATCH v1 2/7] ARM: dts: stm32: Add alternate pinmux for ldtc pins
Date:   Tue, 20 Jun 2023 17:13:07 +0200
Message-Id: <20230620151312.1064629-2-sean@geanix.com>
