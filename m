...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BDDD43D72C6
	for <lists+devicetree@lfdr.de>; Tue, 27 Jul 2021 12:12:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236384AbhG0KLx (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 27 Jul 2021 06:11:53 -0400
Received: from mailgw01.mediatek.com ([60.244.123.138]:57028 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S236299AbhG0KLo (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 27 Jul 2021 06:11:44 -0400
X-UUID: 2bf720077cfa496d84ed945a089be252-20210727
X-UUID: 2bf720077cfa496d84ed945a089be252-20210727
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by mailgw01.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
        with ESMTP id 1180176070; Tue, 27 Jul 2021 18:11:40 +0800
Received: from mtkcas07.mediatek.inc (172.21.101.84) by
 mtkmbs02n1.mediatek.inc (172.21.101.77) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Tue, 27 Jul 2021 18:11:37 +0800
Received: from localhost.localdomain (10.17.3.153) by mtkcas07.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Tue, 27 Jul 2021 18:11:36 +0800
...
Subject: [PATCH v3, 09/15] media: mtk-vcodec: Generalize power and clock on/off interfaces
Date:   Tue, 27 Jul 2021 18:10:45 +0800
Message-ID: <20210727101051.24418-10-yunfei.dong@mediatek.com>
...
index 693299ffb9fd..7d4c3afcd301 100644
--- a/drivers/media/platform/mtk-vcodec/mtk_vcodec_dec_drv.c
+++ b/drivers/media/platform/mtk-vcodec/mtk_vcodec_dec_drv.c
@@ -133,7 +133,7 @@ static irqreturn_t mtk_vcodec_dec_irq_handler(int irq, void *priv)
...
+		ret = mtk_vcodec_dec_pw_on(dev, MTK_VDEC_LAT0);
 		if (ret < 0)
 			goto err_load_fw;
 		/*
@@ -355,7 +355,7 @@ static int fops_vcodec_release(struct file *file)
...
@@ -36,6 +38,8 @@ struct mtk_vdec_comp_dev {
...
index 20bd157a855c..c2de88bb8092 100644
...
index bf4f8515420d..a34514597a10 100644
...
+ * @hw_id: hardware index used to identify different hardware.
  ...
  */
@@ -333,6 +334,7 @@ struct mtk_vcodec_ctx {
...
index ac5973b6735f..bee0f22db36e 100644
