...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 46E6966793
	for <lists+devicetree@lfdr.de>; Fri, 12 Jul 2019 09:17:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726074AbfGLHRF (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 12 Jul 2019 03:17:05 -0400
Received: from mail-eopbgr80041.outbound.protection.outlook.com ([40.107.8.41]:55814
        "EHLO EUR04-VI1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1725840AbfGLHRF (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Fri, 12 Jul 2019 03:17:05 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=KoCoConnector.onmicrosoft.com; s=selector1-KoCoConnector-onmicrosoft-com;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=fdyiOfbu7zoP17n3qodIRIvxA67DhqXaxoMOjod0e9A=;
 b=OvpNh5RvGz+E48pPhA8LR8eMehr3MdMcQpy3WNPfJts8AiiuseSKSMLu/wFkhCpI18DA0Phkd3iPh6tqBiYhmd+/uppEGeWNEi5d2qjUrP4H0PD2xbIqsBgCTOvF/FqMzGkjtaSkBZjFoW4roEEXL85jEow/rC8jBitybVCombk=
Received: from DB6PR0902MB2072.eurprd09.prod.outlook.com (10.170.212.23) by
 DB6PR0902MB2136.eurprd09.prod.outlook.com (10.170.216.21) with Microsoft SMTP
 Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.20.2052.18; Fri, 12 Jul 2019 07:16:50 +0000
Received: from DB6PR0902MB2072.eurprd09.prod.outlook.com
 ([fe80::bd28:7381:fb18:6de3]) by DB6PR0902MB2072.eurprd09.prod.outlook.com
 ([fe80::bd28:7381:fb18:6de3%3]) with mapi id 15.20.2073.008; Fri, 12 Jul 2019
 07:16:50 +0000
...
Subject: [PATCHv3] clk: add imx8 clk defines
Thread-Topic: [PATCHv3] clk: add imx8 clk defines
Thread-Index: AQHVOIHFYNgEQRYD2kSnvZDMbWWGLA==
Date:   Fri, 12 Jul 2019 07:16:49 +0000
Message-ID: <20190712065441.28928-1-oliver.graute@kococonnector.com>
Accept-Language: de-DE, en-US
Content-Language: en-US
X-MS-Has-Attach: 
X-MS-TNEF-Correlator: 
x-clientproxiedby: AM6P192CA0079.EURP192.PROD.OUTLOOK.COM
 (2603:10a6:209:8d::20) To DB6PR0902MB2072.eurprd09.prod.outlook.com
 (2603:10a6:6:8::23)
...
x-ms-office365-filtering-correlation-id: 02cc5e63-5cb0-4cd8-39cc-08d70698e834
x-microsoft-antispam: BCL:0;PCL:0;RULEID:(2390118)(7020095)(4652040)(7021145)(8989299)(4534185)(7022145)(4603075)(4627221)(201702281549075)(8990200)(7048125)(7024125)(7027125)(7023125)(5600148)(711020)(4605104)(1401327)(2017052603328)(7193020);SRVR:DB6PR0902MB2136;
x-ms-traffictypediagnostic: DB6PR0902MB2136:
x-microsoft-antispam-prvs: <DB6PR0902MB21363C384CCFE0F939DF4B2DEBF20@DB6PR0902MB2136.eurprd09.prod.outlook.com>
x-ms-oob-tlc-oobclassifiers: OLM:454;
x-forefront-prvs: 00963989E5
x-forefront-antispam-report: SFV:NSPM;SFS:(10009020)(39830400003)(396003)(376002)(346002)(136003)(366004)(189003)(199004)(14454004)(86362001)(3846002)(25786009)(305945005)(50226002)(7736002)(6486002)(1076003)(2906002)(2616005)(68736007)(186003)(2351001)(476003)(5640700003)(6116002)(4326008)(508600001)(26005)(44832011)(486006)(7416002)(6436002)(66066001)(99286004)(36756003)(66946007)(66446008)(53946003)(66556008)(6512007)(66476007)(52116002)(2501003)(256004)(53936002)(316002)(81166006)(54906003)(8676002)(102836004)(5660300002)(1730700003)(8936002)(71190400001)(71200400001)(386003)(6506007)(30864003)(6916009)(64756008)(81156014)(559001)(579004);DIR:OUT;SFP:1101;SCL:1;SRVR:DB6PR0902MB2136;H:DB6PR0902MB2072.eurprd09.prod.outlook.com;FPR:;SPF:None;LANG:en;PTR:InfoNoRecords;MX:1;A:1;
received-spf: None (protection.outlook.com: kococonnector.com does not
 designate permitted sender hosts)
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam-message-info: 
Content-Type: text/plain; charset="iso-8859-1"
Content-Transfer-Encoding: quoted-printable
MIME-Version: 1.0
X-OriginatorOrg: kococonnector.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 02cc5e63-5cb0-4cd8-39cc-08d70698e834
X-MS-Exchange-CrossTenant-originalarrivaltime: 12 Jul 2019 07:16:50.0774
 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: 59845429-0644-4099-bd7e-17fba65a2f2b
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: oliver.graute@kococonnector.com
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DB6PR0902MB2136
...
diff --git a/include/dt-bindings/clock/imx8qm-clock.h b/include/dt-bindings=
/clock/imx8qm-clock.h
