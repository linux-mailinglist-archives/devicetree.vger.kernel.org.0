...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 396642D8E19
	for <lists+devicetree@lfdr.de>; Sun, 13 Dec 2020 15:58:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2406266AbgLMO60 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 13 Dec 2020 09:58:26 -0500
Received: from mail.kernel.org ([198.145.29.99]:51228 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2395125AbgLMO60 (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Sun, 13 Dec 2020 09:58:26 -0500
Received: from archlinux (cpc108967-cmbg20-2-0-cust86.5-4.cable.virginm.net [81.101.6.87])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 6609A23123;
        Sun, 13 Dec 2020 14:57:43 +0000 (UTC)
Date:   Sun, 13 Dec 2020 14:57:39 +0000
From:   Jonathan Cameron <jic23@kernel.org>
To:     Cristian Pop <cristian.pop@analog.com>
Cc:     <linux-iio@vger.kernel.org>, <linux-kernel@vger.kernel.org>,
        <devicetree@vger.kernel.org>, <robh+dt@kernel.org>
Subject: Re: [PATCH v3 3/3] iio: dac: ad5766: add driver support for AD5766
Message-ID: <20201213145739.1282fc23@archlinux>
In-Reply-To: <20201208131957.34381-3-cristian.pop@analog.com>
References: <20201208131957.34381-1-cristian.pop@analog.com>
        <20201208131957.34381-3-cristian.pop@analog.com>
...
I'm not sure if Andy's review crossed with this, but there are a few questions
outstanding there I think.

A few minor comments in here, but mostly stuff following on from the
...
return -EINVAL;
and drop the break + return below.
...
It's a not reset signal. Which means that you should treat it as active
low which at least means that when we set it to off we come out of reset
and hence aligns with the naming.

Lots of drivers get this wrong :( Let's not introduce another one.
