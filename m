...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 574A54EA405
	for <lists+devicetree@lfdr.de>; Tue, 29 Mar 2022 02:14:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231264AbiC2AE1 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 28 Mar 2022 20:04:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44458 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231266AbiC2AEZ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 28 Mar 2022 20:04:25 -0400
Received: from gate2.alliedtelesis.co.nz (gate2.alliedtelesis.co.nz [IPv6:2001:df5:b000:5::4])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F29FB13DEA
        for <devicetree@vger.kernel.org>; Mon, 28 Mar 2022 17:02:41 -0700 (PDT)
Received: from svr-chch-seg1.atlnz.lc (mmarshal3.atlnz.lc [10.32.18.43])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by gate2.alliedtelesis.co.nz (Postfix) with ESMTPS id C5B392C0A8F;
        Tue, 29 Mar 2022 00:02:39 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=alliedtelesis.co.nz;
        s=mail181024; t=1648512159;
        bh=uuO73TBArnojo32FAUqEeqKYU+t9qgbBl7fh4ixsSZM=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: from pat.atlnz.lc (Not Verified[10.32.16.33]) by svr-chch-seg1.atlnz.lc with Trustwave SEG (v8,2,6,11305)
        id <B62424c9f0002>; Tue, 29 Mar 2022 13:02:39 +1300
Received: from chrisp-dl.ws.atlnz.lc (chrisp-dl.ws.atlnz.lc [10.33.22.30])
        by pat.atlnz.lc (Postfix) with ESMTP id 734D413EE9B;
        Tue, 29 Mar 2022 13:02:39 +1300 (NZDT)
Received: by chrisp-dl.ws.atlnz.lc (Postfix, from userid 1030)
        id CF1B12A2678; Tue, 29 Mar 2022 13:02:35 +1300 (NZDT)
...
Subject: [PATCH v4 2/2] dt-bindings: mmc: xenon: Convert to JSON schema
Date:   Tue, 29 Mar 2022 13:02:31 +1300
Message-Id: <20220329000231.3544810-3-chris.packham@alliedtelesis.co.nz>
...
index 000000000000..3079ca018b51
--- /dev/null
