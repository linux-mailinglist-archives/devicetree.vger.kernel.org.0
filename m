...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 10DF56D1A51
	for <lists+devicetree@lfdr.de>; Fri, 31 Mar 2023 10:36:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231678AbjCaIgs (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 31 Mar 2023 04:36:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59524 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231676AbjCaIgI (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 31 Mar 2023 04:36:08 -0400
Received: from mail-wr1-x433.google.com (mail-wr1-x433.google.com [IPv6:2a00:1450:4864:20::433])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 12A5F1A959
        for <devicetree@vger.kernel.org>; Fri, 31 Mar 2023 01:35:03 -0700 (PDT)
Received: by mail-wr1-x433.google.com with SMTP id y14so21603284wrq.4
        for <devicetree@vger.kernel.org>; Fri, 31 Mar 2023 01:35:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google; t=1680251702;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:from:to:cc:subject:date:message-id
         :reply-to;
        bh=k/TYdKgoSim2+xSfOigBUDJU4lf9oh2e9OdwFXL6q5k=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1680251702;
        h=cc:to:in-reply-to:references:message-id:content-transfer-encoding
         :mime-version:subject:date:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=k/TYdKgoSim2+xSfOigBUDJU4lf9oh2e9OdwFXL6q5k=;
        b=
X-Gm-Message-State: AAQBX9ewBlh6/f1/Kvgw3QGdVN4CM0qON9POfw5QTAxmsPMdcOLK9PFM
        02G3aXcXdR41ybrpqnH+NaTRBg==
X-Google-Smtp-Source: AKy350bEKMVmeD9B19l6wARVVoUt+DvX7VSiWbSakhumbzRX8KlNU6PhTUSGGGjNJmi9lggLLv3SGw==
X-Received: by 2002:a5d:500a:0:b0:2cb:29eb:a35e with SMTP id e10-20020a5d500a000000b002cb29eba35emr6804953wrt.11.1680251702354;
        Fri, 31 Mar 2023 01:35:02 -0700 (PDT)
Received: from arrakeen.starnux.net ([2a01:e0a:982:cbb0:8261:5fff:fe11:bdda])
        by smtp.gmail.com with ESMTPSA id e11-20020a5d4e8b000000b002cde626cd96sm1563153wru.65.2023.03.31.01.35.01
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 31 Mar 2023 01:35:02 -0700 (PDT)
From:   Neil Armstrong <neil.armstrong@linaro.org>
Date:   Fri, 31 Mar 2023 10:34:51 +0200
Subject: [PATCH RFC 13/20] pinctrl: pinctrl-oxnas: remove obsolete pinctrl
 driver
MIME-Version: 1.0
Content-Type: text/plain; charset="utf-8"
Content-Transfer-Encoding: 7bit
Message-Id: <20230331-topic-oxnas-upstream-remove-v1-13-5bd58fd1dd1f@linaro.org>
...
index dcb53c4a9584..d2c1c9bd541a 100644
...
index d5939840bb2a..f8eb7f3eefa0 100644
--- a/drivers/pinctrl/Makefile
+++ b/drivers/pinctrl/Makefile
@@ -37,7 +37,6 @@ obj-$(CONFIG_PINCTRL_MCP23S08_SPI)	+= pinctrl-mcp23s08_spi.o
