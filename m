...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D9CCA5B9916
	for <lists+devicetree@lfdr.de>; Thu, 15 Sep 2022 12:50:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230035AbiIOKun (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 15 Sep 2022 06:50:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33202 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229984AbiIOKum (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 15 Sep 2022 06:50:42 -0400
Received: from mailgw.felk.cvut.cz (mailgw.felk.cvut.cz [147.32.82.15])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 95C75474C9;
        Thu, 15 Sep 2022 03:50:38 -0700 (PDT)
Received: from mailgw.felk.cvut.cz (localhost.localdomain [127.0.0.1])
        by mailgw.felk.cvut.cz (Proxmox) with ESMTP id DE12930B294F;
        Thu, 15 Sep 2022 12:50:35 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        cmp.felk.cvut.cz; h=cc:cc:content-transfer-encoding:content-type
        :content-type:date:from:from:in-reply-to:message-id:mime-version
        :references:reply-to:subject:subject:to:to; s=felkmail; bh=5r0n0
        x3RZNlMMMaK62plOzR1ZqzbTK6bnhgKpt+dm+0=; b=D+zW/fAkhz5GrIvH2IC66
        
Received: from cmp.felk.cvut.cz (haar.felk.cvut.cz [147.32.84.19])
        by mailgw.felk.cvut.cz (Proxmox) with ESMTPS id 6169E30ADE7F;
        Thu, 15 Sep 2022 12:50:33 +0200 (CEST)
Received: from haar.felk.cvut.cz (localhost [127.0.0.1])
        by cmp.felk.cvut.cz (8.14.0/8.12.3/SuSE Linux 0.6) with ESMTP id 28FAoXvJ007441;
        Thu, 15 Sep 2022 12:50:33 +0200
Received: (from pisa@localhost)
        by haar.felk.cvut.cz (8.14.0/8.13.7/Submit) id 28FAoWdB007440;
        Thu, 15 Sep 2022 12:50:32 +0200
X-Authentication-Warning: haar.felk.cvut.cz: pisa set sender to pisa@cmp.felk.cvut.cz using -f
From:   Pavel Pisa <pisa@cmp.felk.cvut.cz>
To:     Matej Vasilevski <matej.vasilevski@seznam.cz>
Subject: Re: [PATCH v4 2/3] can: ctucanfd: add HW timestamps to RX and error CAN frames
Date:   Thu, 15 Sep 2022 12:50:27 +0200
...
References: <20220914233944.598298-1-matej.vasilevski@seznam.cz> <20220914233944.598298-3-matej.vasilevski@seznam.cz>
...
Message-Id: <202209151250.27948.pisa@cmp.felk.cvut.cz>
