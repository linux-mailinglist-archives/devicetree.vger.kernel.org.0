...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E059861A6E9
	for <lists+devicetree@lfdr.de>; Sat,  5 Nov 2022 03:34:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229540AbiKECeC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 4 Nov 2022 22:34:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45030 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229445AbiKECeB (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 4 Nov 2022 22:34:01 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EF8A631344;
        Fri,  4 Nov 2022 19:33:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1667615637; x=1699151637;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=h73vrc60KdGfFNF895KjnA/Vnraqn2EpFHmeL0a4Zp4=;
  b=SGiFUvOgtVbCmAd4kcKfkAkpKxk4MwE/A1/oAd8tbu9kfAf7SPbf5kpr
   pHsanL8r7iib7siL5imYbOxRm3dmn6N8MdJlHpVZcDlPvCk4TQ7CLsXJn
   gRH8DprFurerLrYzuwz6gZH1n2OvP03bOP+6jZLJlxh0jF1PMU8OQv4MM
   v9kO6dmmmDlVtlf6teiWw/+zWDcH4vs1mKFTxLOAGWqF1YWhV+w+gkwuI
   B3nTEs51mXGUHwksbRIvEowXE6evCC6GX9ta1Eps4Zc9vn4ePPWMEVHFH
   B2VYkLGqg3nigPycx8Na0t+Bis3DLSfYaROyoGpYTOa236zjgky/6AAO7
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10521"; a="289841638"
X-IronPort-AV: E=Sophos;i="5.96,139,1665471600"; 
   d="scan'208";a="289841638"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 04 Nov 2022 19:33:57 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10521"; a="964551361"
X-IronPort-AV: E=Sophos;i="5.96,139,1665471600"; 
   d="scan'208";a="964551361"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by fmsmga005.fm.intel.com with ESMTP; 04 Nov 2022 19:33:53 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1or90K-000HZ7-2f;
        Sat, 05 Nov 2022 02:33:52 +0000
Date:   Sat, 5 Nov 2022 10:33:41 +0800
...
Message-ID: <202211051031.jim9UPYd-lkp@intel.com>
References: <20221026131124.289-2-Ibrahim.Tilki@analog.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="hL6xlxKkTxT4zr4W"
...
All warnings (new ones prefixed by >>):
   ...
   In file included from drivers/rtc/rtc-max313xx.c:13:
   ...
   include/asm-generic/io.h:604:59: warning: performing pointer arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
           __raw_writel((u32 __force)cpu_to_le32(value), PCI_IOBASE + addr);
                                                         ~~~~~~~~~~ ^
>> drivers/rtc/rtc-max313xx.c:583:2: warning: unannotated fall-through between switch labels [-Wimplicit-fallthrough]
           default:
           ^
   drivers/rtc/rtc-max313xx.c:583:2: note: insert 'break;' to avoid fall-through
           default:
           ^
           break; 
...
vim +583 drivers/rtc/rtc-max313xx.c

   569	
   570	static void max313xx_clkout_disable(struct clk_hw *hw)
   571	{
   572		struct max313xx *rtc = clk_hw_to_max313xx(hw);
   573		struct clkout_cfg *clkout = rtc->chip->clkout;
   574	
   575		switch (rtc->id) {
   576		case ID_MAX31331:
   577		case ID_MAX31334:
   578			if (rtc->irq > 0) {
   579				dev_err(rtc->rtc->dev.parent,
   580					"clkout cannot be disabled when IRQ is requested");
   581				return;
   582			}
 > 583		default:
   584			break;
   585		}
   586	
   587		if (clkout->en_invert)
   588			regmap_set_bits(rtc->regmap, clkout->reg, clkout->en_bit);
   589		else
   590			regmap_clear_bits(rtc->regmap, clkout->reg,  clkout->en_bit);
   591	}
   592	
