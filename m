...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 95EE16E20E4
	for <lists+devicetree@lfdr.de>; Fri, 14 Apr 2023 12:35:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230287AbjDNKfS (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 14 Apr 2023 06:35:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40712 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230242AbjDNKfO (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 14 Apr 2023 06:35:14 -0400
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com [205.220.180.131])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C2E2A7ED7;
        Fri, 14 Apr 2023 03:35:08 -0700 (PDT)
Received: from pps.filterd (m0279870.ppops.net [127.0.0.1])
        by mx0a-0031df01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 33EAJ0rv003894;
        Fri, 14 Apr 2023 10:34:46 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=quicinc.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=qcppdkim1;
 bh=fJ1E4zcH1nMTHTuG2r3YCxCdtWaT7/P36aW7dV4/KHA=;
 b= xQ== 
Received: from nalasppmta01.qualcomm.com (Global_NAT1.qualcomm.com [129.46.96.20])
        by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 3pxked26wk-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Fri, 14 Apr 2023 10:34:46 +0000
Received: from nalasex01c.na.qualcomm.com (nalasex01c.na.qualcomm.com [10.47.97.35])
        by NALASPPMTA01.qualcomm.com (8.17.1.5/8.17.1.5) with ESMTPS id 33EAYi9V027686
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Fri, 14 Apr 2023 10:34:44 GMT
Received: from srichara-linux.qualcomm.com (10.80.80.8) by
 nalasex01c.na.qualcomm.com (10.47.97.35) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.42; Fri, 14 Apr 2023 03:34:36 -0700
...
Subject: [PATCH V3 2/9] clk: qcom: Add Global Clock controller (GCC) driver for IPQ5018
Date:   Fri, 14 Apr 2023 15:59:20 +0530
Message-ID: <1681468167-11689-3-git-send-email-quic_srichara@quicinc.com>
...
X-Proofpoint-GUID: R3ctjUQ7VlBtxrv_JytXbG679FRWvBES
X-Proofpoint-ORIG-GUID: R3ctjUQ7VlBtxrv_JytXbG679FRWvBES
...
---
 [v3] Fixed all review comments
      Changed all fixed clocks to be DT index based
      Fixed all CLK_IS_CRITICAL and CLK_IGNORE_UNUSED usages
...
index d71c9d6..2eddf12 100644
--- a/drivers/clk/qcom/Kconfig
+++ b/drivers/clk/qcom/Kconfig
@@ -141,13 +141,19 @@ config IPQ_GCC_4019
