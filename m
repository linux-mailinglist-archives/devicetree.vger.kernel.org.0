...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3204D614E52
	for <lists+devicetree@lfdr.de>; Tue,  1 Nov 2022 16:30:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229738AbiKAPaM (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 1 Nov 2022 11:30:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50446 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229601AbiKAPaL (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 1 Nov 2022 11:30:11 -0400
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F1FC710DC;
        Tue,  1 Nov 2022 08:30:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1667316607; x=1698852607;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=Lrx7ZmlsQs9HoAkAgVaBMG2q/FcMH/Y52a39fhcby7s=;
  b=GT5zAmbljc+NQ5raxgRII2rEHY8tXVxuK6S3Hezvohkil1FC249pcbx/
   Mweahn2/Vr2aqPZAhz0EwE8lF69lFB8YekyxDvsE6PfLu8dWzkzCopuwS
   HXqrPzwsZQexENgR7xm6Fv8gkiAoSptLVkJNA02yBvVSQIHmKHRFO7KCb
   4R4CKFWcyhnj4/ykWiKxWJVKohq6agO3jNdxaCQ6+OzeRmKcSiPgvxD3c
   ZAbSc95b6VKTJqBCZ5/v7YjNb7j+adIh4HtR+YcWt3VHwQTEl3YeDGFGq
   SBf/2hMY+JEawe0zy/GutYhwIFF1b1oQQWpG4D7tJNfmBeJHyJP8Ex3DH
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10518"; a="289552837"
X-IronPort-AV: E=Sophos;i="5.95,231,1661842800"; 
   d="scan'208";a="289552837"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 01 Nov 2022 08:30:06 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10518"; a="759211573"
X-IronPort-AV: E=Sophos;i="5.95,231,1661842800"; 
   d="scan'208";a="759211573"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by orsmga004.jf.intel.com with ESMTP; 01 Nov 2022 08:30:00 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1optDD-000Dl0-2q;
        Tue, 01 Nov 2022 15:29:59 +0000
Date:   Tue, 1 Nov 2022 23:29:48 +0800
...
Subject: Re: [PATCH net-next v6 3/5] net: dsa: add out-of-band tagging
 protocol
Message-ID: <202211012332.dFUexcmJ-lkp@intel.com>
References: <20221028154924.789116-4-maxime.chevallier@bootlin.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="BJk4G8G+IyYEr2GW"
Content-Disposition: inline
In-Reply-To: <20221028154924.789116-4-maxime.chevallier@bootlin.com>
...
url:    https://github.com/intel-lab-lkp/linux/commits/Maxime-Chevallier/net-ipqess-introduce-Qualcomm-IPQESS-driver/20221028-235225
patch link:    https://lore.kernel.org/r/20221028154924.789116-4-maxime.chevallier%40bootlin.com
patch subject: [PATCH net-next v6 3/5] net: dsa: add out-of-band tagging protocol
config: ia64-allmodconfig
compiler: ia64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/884e36895753174613b5411e0b1da1f2ccb719bc
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Maxime-Chevallier/net-ipqess-introduce-Qualcomm-IPQESS-driver/20221028-235225
        git checkout 884e36895753174613b5411e0b1da1f2ccb719bc
...
>> net/core/skbuff.c:4491:49: error: invalid application of 'sizeof' to incomplete type 'struct dsa_oob_tag_info'
    4491 |         [SKB_EXT_DSA_OOB] = SKB_EXT_CHUNKSIZEOF(struct dsa_oob_tag_info),
         |                                                 ^~~~~~
   ...
   include/linux/align.h:8:33: note: in expansion of macro '__ALIGN_KERNEL'
       8 | #define ALIGN(x, a)             __ALIGN_KERNEL((x), (a))
         |                                 ^~~~~~~~~~~~~~
   net/core/skbuff.c:4472:34: note: in expansion of macro 'ALIGN'
    4472 | #define SKB_EXT_CHUNKSIZEOF(x)  (ALIGN((sizeof(x)), SKB_EXT_ALIGN_VALUE) / SKB_EXT_ALIGN_VALUE)
         |                                  ^~~~~
   net/core/skbuff.c:4491:29: note: in expansion of macro 'SKB_EXT_CHUNKSIZEOF'
    4491 |         [SKB_EXT_DSA_OOB] = SKB_EXT_CHUNKSIZEOF(struct dsa_oob_tag_info),
         |                             ^~~~~~~~~~~~~~~~~~~
>> net/core/skbuff.c:4491:49: error: invalid application of 'sizeof' to incomplete type 'struct dsa_oob_tag_info'
    4491 |         [SKB_EXT_DSA_OOB] = SKB_EXT_CHUNKSIZEOF(struct dsa_oob_tag_info),
...
vim +4491 net/core/skbuff.c

  4473	
  4474	static const u8 skb_ext_type_len[] = {
  4475	#if IS_ENABLED(CONFIG_BRIDGE_NETFILTER)
  4476		[SKB_EXT_BRIDGE_NF] = SKB_EXT_CHUNKSIZEOF(struct nf_bridge_info),
  4477	#endif
  4478	#ifdef CONFIG_XFRM
  4479		[SKB_EXT_SEC_PATH] = SKB_EXT_CHUNKSIZEOF(struct sec_path),
  4480	#endif
  4481	#if IS_ENABLED(CONFIG_NET_TC_SKB_EXT)
  4482		[TC_SKB_EXT] = SKB_EXT_CHUNKSIZEOF(struct tc_skb_ext),
  4483	#endif
  4484	#if IS_ENABLED(CONFIG_MPTCP)
  4485		[SKB_EXT_MPTCP] = SKB_EXT_CHUNKSIZEOF(struct mptcp_ext),
  4486	#endif
  4487	#if IS_ENABLED(CONFIG_MCTP_FLOWS)
  4488		[SKB_EXT_MCTP] = SKB_EXT_CHUNKSIZEOF(struct mctp_flow),
  4489	#endif
  4490	#if IS_ENABLED(CONFIG_NET_DSA_TAG_OOB)
> 4491		[SKB_EXT_DSA_OOB] = SKB_EXT_CHUNKSIZEOF(struct dsa_oob_tag_info),
  4492	#endif
  4493	};
  4494	
...
CONFIG_QCOM_EMAC=m
CONFIG_QCOM_IPQ4019_ESS_EDMA=m
CONFIG_RMNET=m
