...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 07E653DFABA
	for <lists+devicetree@lfdr.de>; Wed,  4 Aug 2021 06:41:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233816AbhHDElx (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 4 Aug 2021 00:41:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34222 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229892AbhHDElw (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 4 Aug 2021 00:41:52 -0400
Received: from mail-pj1-x102c.google.com (mail-pj1-x102c.google.com [IPv6:2607:f8b0:4864:20::102c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2E064C061799
        for <devicetree@vger.kernel.org>; Tue,  3 Aug 2021 21:41:40 -0700 (PDT)
Received: by mail-pj1-x102c.google.com with SMTP id q17-20020a17090a2e11b02901757deaf2c8so1928769pjd.0
        for <devicetree@vger.kernel.org>; Tue, 03 Aug 2021 21:41:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=cyGV/K7HaLI17hY3jjwcFjE7TEksKDQNc+4bXSvapPs=;
        b=VP/knhjz33igAl/Ff4PZ2yRHa8rhy2NZtdbtKKyYhf9g1pmo5fRuUuAltsLzyW6Y6n
         a+nKvFC5Jig1IL2eIs6I35wVX8Os3Nszn3DPzNwmmH5KNiwIuJ/FT3uT5no8wl6pQyhP
         wTKhWMrS6YOaOM/k0xUt64b4xWzUj7HVPqNXE=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=cyGV/K7HaLI17hY3jjwcFjE7TEksKDQNc+4bXSvapPs=;
        b=
X-Gm-Message-State: AOAM531ojNgM7hC42p4hgP+UAW75tLe6Ooyqrisq8b44Ex47zU5+jBEr
        9px27QEEVs6RWfTVP0zNZjfjVA==
X-Google-Smtp-Source: ABdhPJzi7YebXHuKQEc+VqgqFqOZEW7KgH/hC7FDB3CQP91kBQNvpAeGtRKNEggqs8tdsQEhceXPtw==
X-Received: by 2002:a63:f63:: with SMTP id 35mr87708pgp.148.1628052099029;
        Tue, 03 Aug 2021 21:41:39 -0700 (PDT)
Received: from hsinyi-z840.tpe.corp.google.com ([2401:fa00:1:10:6fea:f7c3:8233:dc51])
        by smtp.gmail.com with ESMTPSA id t9sm1075355pgc.81.2021.08.03.21.41.36
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 03 Aug 2021 21:41:38 -0700 (PDT)
...
Subject: [PATCH v4 3/3] dt-bindings: mediatek: convert pinctrl to yaml
Date:   Wed,  4 Aug 2021 12:40:34 +0800
Message-Id: <20210804044033.3047296-3-hsinyi@chromium.org>
...
- update MAINTAINERS
v2->v3:
- fix pattern regex '-pins'
- drop duplicate enum that constraints already have
- fix typos
v1->v2:
- fix a few minItems/maxItems
- convert text constraints into schema in mt7622
- fix pattern regex
---
 ...
 MAINTAINERS                                   |   6 +-
 9 files changed, 984 insertions(+), 863 deletions(-)
...
index 0000000000000..f8e6e138dc13a
--- /dev/null
...
new file mode 100644
index 0000000000000..76a6df75ed9c3
--- /dev/null
...
new file mode 100644
index 0000000000000..0feecd376c694
--- /dev/null
...
new file mode 100644
index 0000000000000..cc1509e9b981b
--- /dev/null
...
index 50df0c02ba030..c957c8841043b 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -14667,8 +14667,10 @@ PIN CONTROLLER - MEDIATEK
