...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3C8EB709BCF
	for <lists+devicetree@lfdr.de>; Fri, 19 May 2023 17:57:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232340AbjESP5o (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 19 May 2023 11:57:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34758 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232220AbjESP5j (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 19 May 2023 11:57:39 -0400
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com [205.220.180.131])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7DCD010FC;
        Fri, 19 May 2023 08:57:24 -0700 (PDT)
Received: from pps.filterd (m0279871.ppops.net [127.0.0.1])
        by mx0a-0031df01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 34JDrHBd018092;
        Fri, 19 May 2023 15:57:16 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=quicinc.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=qcppdkim1;
 bh=O6igQCqum+fka5uxWsiosIRmdWcLbnQWAMhcGnUyhg0=;
 b= Xg== 
Received: from nalasppmta05.qualcomm.com (Global_NAT1.qualcomm.com [129.46.96.20])
        by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 3qpad1gd2x-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Fri, 19 May 2023 15:57:15 +0000
Received: from nalasex01a.na.qualcomm.com (nalasex01a.na.qualcomm.com [10.47.209.196])
        by NALASPPMTA05.qualcomm.com (8.17.1.5/8.17.1.5) with ESMTPS id 34JFvE4b007670
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Fri, 19 May 2023 15:57:14 GMT
Received: from hu-jkona-hyd.qualcomm.com (10.80.80.8) by
 nalasex01a.na.qualcomm.com (10.47.209.196) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.42; Fri, 19 May 2023 08:57:09 -0700
...
Subject: [PATCH 3/4] clk: qcom: camcc-sm8550: Add camera clock controller driver for SM8550
Date:   Fri, 19 May 2023 21:26:01 +0530
Message-ID: <20230519155602.6642-4-quic_jkona@quicinc.com>
...
X-Proofpoint-GUID: wINYzxZi_184PBWfZzRQmg-LepuD1uAn
X-Proofpoint-ORIG-GUID: wINYzxZi_184PBWfZzRQmg-LepuD1uAn
...
+};
+
+static const struct clk_parent_data cam_cc_parent_data_12_ao[] = {
+	{ .index = DT_SLEEP_CLK },
+};
+
...
+		.parent_data = cam_cc_parent_data_12_ao,
+		.num_parents = ARRAY_SIZE(cam_cc_parent_data_12_ao),
+		.flags = CLK_SET_RATE_PARENT,
+		.ops = &clk_rcg2_shared_ops,
+	},
+};
