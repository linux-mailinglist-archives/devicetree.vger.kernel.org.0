...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9B8986BAEE1
	for <lists+devicetree@lfdr.de>; Wed, 15 Mar 2023 12:10:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232122AbjCOLKh (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 15 Mar 2023 07:10:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44072 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232169AbjCOLJ4 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 15 Mar 2023 07:09:56 -0400
Received: from mail-wr1-x434.google.com (mail-wr1-x434.google.com [IPv6:2a00:1450:4864:20::434])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 80D757A8B
        for <devicetree@vger.kernel.org>; Wed, 15 Mar 2023 04:07:59 -0700 (PDT)
Received: by mail-wr1-x434.google.com with SMTP id p4so10730609wre.11
        for <devicetree@vger.kernel.org>; Wed, 15 Mar 2023 04:07:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=baylibre-com.20210112.gappssmtp.com; s=20210112; t=1678878464;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=Rfd+RkRegShcK6ufel0NX/KZd7F84DdOpUtGGCG2OHk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1678878464;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=Rfd+RkRegShcK6ufel0NX/KZd7F84DdOpUtGGCG2OHk=;
        b=
X-Gm-Message-State: AO0yUKWjanAhbcQFbyyilkcdEBIQj9CLY9YehJ/lIp9astkcvB8TBY5W
        JIuLiRovclBncy3N5lbwhM+/ZA==
X-Google-Smtp-Source: AK7set95KbQp31V0R/c4ATvVkWLGkYX4Cqey5iWtSshXj2KJOVOICA1BZ0BH0ylKmkz/rrF7oPp5Kw==
X-Received: by 2002:a05:6000:108a:b0:2cf:f3d6:d27e with SMTP id y10-20020a056000108a00b002cff3d6d27emr1236171wrw.34.1678878464064;
        Wed, 15 Mar 2023 04:07:44 -0700 (PDT)
Received: from baylibre-ThinkPad-T14s-Gen-2i.. (151.31.102.84.rev.sfr.net. [84.102.31.151])
        by smtp.gmail.com with ESMTPSA id n5-20020adfe785000000b002c7066a6f77sm4339745wrm.31.2023.03.15.04.07.41
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 15 Mar 2023 04:07:43 -0700 (PDT)
...
Subject: [PATCH v2 2/4] mfd: tps6594: Add driver for TI TPS6594 PMIC
Date:   Wed, 15 Mar 2023 12:07:34 +0100
Message-Id: <20230315110736.35506-3-jpanis@baylibre.com>
...
index 000000000000..5dc2d239784a
--- /dev/null
...
+	 */
+	is_primary = of_property_read_bool(dev->of_node, "ti,spmi-controller");
+	if (is_primary) {
...
new file mode 100644
index 000000000000..edba0d231e41
--- /dev/null
...
new file mode 100644
index 000000000000..7281d5fb0a00
--- /dev/null
...
new file mode 100644
index 000000000000..40b9b5664233
--- /dev/null
