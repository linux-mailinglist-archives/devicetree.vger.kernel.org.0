...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3EE13290ABA
	for <lists+devicetree@lfdr.de>; Fri, 16 Oct 2020 19:28:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390962AbgJPR2e (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 16 Oct 2020 13:28:34 -0400
Received: from mga02.intel.com ([134.134.136.20]:5396 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2390689AbgJPR2d (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Fri, 16 Oct 2020 13:28:33 -0400
IronPort-SDR: xwxLO3O0HX2fBTKYNvkMQiE5ksHyo8JvWYfd7fpCgrf7T+q2iDu6NTbb9RBrxDh8eiTe+H/4wP
 QLB0pxh1Z1zQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9776"; a="153570088"
X-IronPort-AV: E=Sophos;i="5.77,383,1596524400"; 
   d="scan'208";a="153570088"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Oct 2020 10:28:30 -0700
IronPort-SDR: 3Qf3MZc9h5h962cBGCvwcLJZqIVhzu6kBcn7NjBUb/7VOc37k4zrxfoSAnognyqXSEeXb3k0Gf
 LUzjnWP9/TuA==
X-IronPort-AV: E=Sophos;i="5.77,383,1596524400"; 
   d="scan'208";a="464750856"
Received: from apurdea-mobl1.ger.corp.intel.com (HELO dalessan-mobl1.ir.intel.com) ([10.251.84.178])
  by orsmga004-auth.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Oct 2020 10:28:26 -0700
...
Subject: [PATCH 2/3] crypto: keembay: Add Keem Bay OCS HCU driver
Date:   Fri, 16 Oct 2020 18:27:58 +0100
Message-Id: <20201016172759.1260407-3-daniele.alessandrelli@linux.intel.com>
...
index 000000000000..e505afba850c
--- /dev/null
...
new file mode 100644
index 000000000000..f1009c54d1bf
--- /dev/null
...
+		return 0;
+
+	if (addr > OCS_HCU_DMA_MAX_ADDR_MASK) {
+		dev_err(dev,
...
new file mode 100644
index 000000000000..b1b8f2a10341
--- /dev/null
...
+
+/*
+ * ocs_hcu_set_intermediate_data() - Get intermediate data.
...
+ * @final:	Whether or not this is the last hashing operation and therefore
...
+			      u8 *buf, u32 sz, u32 algo, bool final)
+{
...
new file mode 100644
index 000000000000..cd964d0da3a8
--- /dev/null
...
+#define OCS_HCU_DMA_MAX_ADDR_MASK	0xFFFFFFFF
+
