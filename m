...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7DAC04F0C72
	for <lists+devicetree@lfdr.de>; Sun,  3 Apr 2022 22:08:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1354764AbiDCUKH (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 3 Apr 2022 16:10:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40258 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1354586AbiDCUKG (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 3 Apr 2022 16:10:06 -0400
Received: from mail-pl1-x635.google.com (mail-pl1-x635.google.com [IPv6:2607:f8b0:4864:20::635])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A34F43A1B2;
        Sun,  3 Apr 2022 13:08:02 -0700 (PDT)
Received: by mail-pl1-x635.google.com with SMTP id d15so1218288pll.10;
        Sun, 03 Apr 2022 13:08:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=n5tgMOrOz22Du+TocY/g6F8LF70GLQEvEOntkaewGtQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=n5tgMOrOz22Du+TocY/g6F8LF70GLQEvEOntkaewGtQ=;
        b=
X-Gm-Message-State: AOAM533V4uMzEoCkSWJUKAac63ptFBZ5Qgq0xzZBBOlvN6r0vUxK8KIu
        wv+M2Ol2eGrMy5tWMh4AnL8=
X-Google-Smtp-Source: ABdhPJz6hMRzdjH1iz7+bj0dLgClTpF7wws+H5ZicDBQWk/DwF1BaGVJlQK2iWsJuyjMO+eyPCXLYA==
X-Received: by 2002:a17:902:70c1:b0:156:16c0:dc7b with SMTP id l1-20020a17090270c100b0015616c0dc7bmr34123212plt.85.1649016481476;
        Sun, 03 Apr 2022 13:08:01 -0700 (PDT)
Received: from scdiu3.sunplus.com ([113.196.136.192])
        by smtp.googlemail.com with ESMTPSA id p10-20020a637f4a000000b00373a2760775sm8154660pgn.2.2022.04.03.13.07.58
...
Subject: [PATCH net-next v6 2/2] net: ethernet: Add driver for Sunplus SP7021
Date:   Mon,  4 Apr 2022 04:07:39 +0800
Message-Id: <1649016459-23989-3-git-send-email-wellslutw@gmail.com>
...
Changes in v6
  - Removed the second item of 'reg'.
    Address of the second item of 'reg'. is used to set polarity of RMII signals.
    The settings are moved to boot-loader.
...
index 84e8f36..e5056d1 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -18843,6 +18843,7 @@ L:	netdev@vger.kernel.org
 S:	Maintained
