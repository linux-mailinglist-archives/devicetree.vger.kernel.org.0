...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DA113722BA9
	for <lists+devicetree@lfdr.de>; Mon,  5 Jun 2023 17:43:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235036AbjFEPnt (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 5 Jun 2023 11:43:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44570 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235080AbjFEPnc (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 5 Jun 2023 11:43:32 -0400
Received: from mail-lj1-x22d.google.com (mail-lj1-x22d.google.com [IPv6:2a00:1450:4864:20::22d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 13F12E7C;
        Mon,  5 Jun 2023 08:43:10 -0700 (PDT)
Received: by mail-lj1-x22d.google.com with SMTP id 38308e7fff4ca-2b1ac373c9eso45185051fa.0;
        Mon, 05 Jun 2023 08:43:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1685979758; x=1688571758;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=ADQA6WsLAIQgoeXQ7hVeeeAzKFJfIF4muhKGOzwetK4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ADQA6WsLAIQgoeXQ7hVeeeAzKFJfIF4muhKGOzwetK4=;
        b=
X-Gm-Message-State: AC+VfDzqG2RxQzM+Sc2ufqFAyAAiAYZb4+EN2WOL+i3DNsptodle1ix/
        4TE4+YAJU0PxtJpWBIcUyUk=
X-Google-Smtp-Source: ACHHUZ63FagdxHEZAxK02A8T7nTO2qR0Ejd6rNZAwx2fopXr0jYkKOEnla2vJb0aQFk/qX5E5w8vcA==
X-Received: by 2002:a05:651c:237:b0:2b1:bd37:e7e1 with SMTP id z23-20020a05651c023700b002b1bd37e7e1mr3684915ljn.32.1685979757169;
        Mon, 05 Jun 2023 08:42:37 -0700 (PDT)
Received: from localhost (p200300e41f305300f22f74fffe1f3a53.dip0.t-ipconnect.de. [2003:e4:1f30:5300:f22f:74ff:fe1f:3a53])
        by smtp.gmail.com with ESMTPSA id sd17-20020a170906ce3100b0095fbb1b72c2sm4400824ejb.63.2023.06.05.08.42.36
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 05 Jun 2023 08:42:36 -0700 (PDT)
...
Subject: [PATCH v5 2/3] pinctrl: tegra: Add Tegra234 pinmux driver
Date:   Mon,  5 Jun 2023 17:42:29 +0200
Message-Id: <20230605154230.2910847-3-thierry.reding@gmail.com>
...
---
Changes in v5:
- prefer device_get_match_data() over of_device_get_match_data()
- drop comma for of_device_id sentinel entry
- drop unneeded .owner initialization
- drop redundant license text
- add missing includes

Changes in v3:
- rebase on top of pinmux function table fix:
...
index 000000000000..fd7072539216
--- /dev/null
...
index e4c319f2c725..f075e2d88664 100644
