...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5796719E21B
	for <lists+devicetree@lfdr.de>; Sat,  4 Apr 2020 03:25:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726621AbgDDBZ2 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Apr 2020 21:25:28 -0400
Received: from hqnvemgate24.nvidia.com ([216.228.121.143]:9132 "EHLO
        hqnvemgate24.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726271AbgDDBZX (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 3 Apr 2020 21:25:23 -0400
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate24.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5e87e19b0000>; Fri, 03 Apr 2020 18:23:39 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Fri, 03 Apr 2020 18:25:18 -0700
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Fri, 03 Apr 2020 18:25:18 -0700
Received: from HQMAIL101.nvidia.com (172.20.187.10) by HQMAIL111.nvidia.com
 (172.20.187.18) with Microsoft SMTP Server (TLS) id 15.0.1473.3; Sat, 4 Apr
 2020 01:25:17 +0000
Received: from rnnvemgw01.nvidia.com (10.128.109.123) by HQMAIL101.nvidia.com
 (172.20.187.10) with Microsoft SMTP Server (TLS) id 15.0.1473.3 via Frontend
 Transport; Sat, 4 Apr 2020 01:25:17 +0000
Received: from skomatineni-linux.nvidia.com (Not Verified[10.2.164.193]) by rnnvemgw01.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5e87e1fc0001>; Fri, 03 Apr 2020 18:25:17 -0700
...
Subject: [RFC PATCH v6 6/9] media: tegra: Add Tegra210 Video input driver
Date:   Fri, 3 Apr 2020 18:25:04 -0700
Message-ID: <1585963507-12610-7-git-send-email-skomatineni@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1585963419; bh=5AYSaDWiS80s+IJVIv7/XjSRxb/kNHgV4RX0xDSiaXQ=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:X-NVConfidentiality:MIME-Version:
         Content-Type;
        b=
...
---
 ...
 14 files changed, 3420 insertions(+)
...
+* Add SMMU support for VI to avoid cma_alloc failures with higher resolutions
+  of some video formats.
+
diff --git a/drivers/staging/media/tegra/tegra-common.h b/drivers/staging/media/tegra/tegra-common.h
new file mode 100644
index 0000000..40b79e5
--- /dev/null
...
+		}
+	} else {
+		ret = csi_runtime_resume(csi->dev);
+		if (ret < 0) {
...
+}
+
+static void channel_video_device_release(struct video_device *vdev)
+{
+	struct tegra_vi_channel *chan = video_get_drvdata(vdev);
+
...
+	chan->video.release = channel_video_device_release;
...
+
+	/*
+	 * For registered video devices, do not cleanup the channel here
+	 * as resources might still be in use and cleanup for those video
+	 * devices happens in the release callback which gets called when
+	 * the last user of the video device exits.
+	 */
+	list_for_each_entry_safe(chan, tmp, &vi->vi_chans, list) {
