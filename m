...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CE7A51CC0F5
	for <lists+devicetree@lfdr.de>; Sat,  9 May 2020 13:27:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728528AbgEIL1Q (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 9 May 2020 07:27:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45820 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1728379AbgEIL1B (ORCPT
...
Received: from pruto.48.io (48.io [IPv6:2a01:430:17:1::ffff:361])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3DC01C05BD0A;
        Sat,  9 May 2020 04:27:01 -0700 (PDT)
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by pruto.48.io (Postfix) with ESMTPSA id DEA8593BE9;
        Sat,  9 May 2020 13:18:10 +0200 (CEST)
DMARC-Filter: OpenDMARC Filter v1.3.2 pruto.48.io DEA8593BE9
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=48.io; s=default;
        t=1589023091; bh=rHyf/EmV85PmV8RV9QykZRXwxLvcpVSqaaSLkjWR3B0=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References;
        b=obJhxHQmDpqDs7LbOA9lVeblmZfc8vHSp+8l6Ude0zd+BrkOaF78PLtHEC5MLrYRR
         cslZe+jPg8NKNfKT/7XvSqR1rFETSokQPa9X1ITTvGAGlNrjGTBHUvs6m6V1nmtsXp
         m535eHCpMqTv+ShbSpQLkMq2UtZlEBeOKxa189G8=
From:   srk@48.io
...
Subject: [PATCH 2/2] drm/bridge: Add ITE IT6251 bridge driver
Date:   Sat,  9 May 2020 13:17:32 +0200
Message-Id: <20200509111732.26102-3-srk@48.io>
