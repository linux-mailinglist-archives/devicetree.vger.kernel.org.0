...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B91BC650D9
	for <lists+devicetree@lfdr.de>; Thu, 11 Jul 2019 06:20:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728018AbfGKEUK (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 11 Jul 2019 00:20:10 -0400
Received: from new4-smtp.messagingengine.com ([66.111.4.230]:34397 "EHLO
        new4-smtp.messagingengine.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726119AbfGKEUJ (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Thu, 11 Jul 2019 00:20:09 -0400
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailnew.nyi.internal (Postfix) with ESMTP id 6D7FA2EE3;
        Thu, 11 Jul 2019 00:20:02 -0400 (EDT)
Received: from mailfrontend1 ([10.202.2.162])
  by compute4.internal (MEProxy); Thu, 11 Jul 2019 00:20:02 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=aj.id.au; h=from
        :to:cc:subject:date:message-id:in-reply-to:references
        :mime-version:content-transfer-encoding; s=fm3; bh=P3LeEaEqBthJC
        n/9tKuFRWpYAZbhkWTw4IU5tN+ZihI=; b=ZmrIWVhL7CuUiWC7BjtO7xp3T3GnU
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:content-transfer-encoding:date:from
        :in-reply-to:message-id:mime-version:references:subject:to
        :x-me-proxy:x-me-proxy:x-me-sender:x-me-sender:x-sasl-enc; s=
        fm3; bh=P3LeEaEqBthJCn/9tKuFRWpYAZbhkWTw4IU5tN+ZihI=; b=rD6sfpEp
        
X-ME-Sender: <xms:8rgmXaox22vJiWJjaOajVpyFFpfHOdRTdarC0W3JSN2BcAydtpeFjQ>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgeduvddrgeejgdektdcutefuodetggdotefrodftvf
    ...
    td
X-ME-Proxy: <xmx:8rgmXTPvlH3LXMHS90okgBACcHK33gPL4mWMx8bVyZy35HO9TBHcIQ>
    <xmx:8rgmXby4dd2WCZZ6k3YIw2uAjTPPmuUxbKgjqNoIlSngqkFOob8TEg>
    <xmx:8rgmXcvFqRHws5PLcTHUboYe6a002FnbaH3Jnt17RFRh-fFvxRGGtQ>
    <xmx:8rgmXTbZmOhI3sDx9StCOC8ZRoIUjQ_pjpO1ViTrRy0-hFga3G5mIg>
Received: from mistburn.au.ibm.com (bh02i525f01.au.ibm.com [202.81.18.30])
        by mail.messagingengine.com (Postfix) with ESMTPA id D0A828005B;
...
Subject: [PATCH 2/6] pinctrl: aspeed: Rename pin declaration macros
Date:   Thu, 11 Jul 2019 13:49:38 +0930
Message-Id: <20190711041942.23202-3-andrew@aj.id.au>
