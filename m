...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6CB9373403C
	for <lists+devicetree@lfdr.de>; Sat, 17 Jun 2023 12:35:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233862AbjFQKdU (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 17 Jun 2023 06:33:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55512 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1346206AbjFQKdR (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 17 Jun 2023 06:33:17 -0400
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E799A120;
        Sat, 17 Jun 2023 03:33:09 -0700 (PDT)
X-UUID: 58810de00cfa11ee9cb5633481061a41-20230617
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=ryfBf3QrKgooxyPFS5HfA+/4CviqdVhqidmEOK9dWTE=;
        b=dAzIwiA5B7+OVYaJCh9N4Syc15KzdWXm/49CT/cpV846UsW3a+RRfvpX3+Jg8LmZ6b1woGqVOtuLTuBltDi+Iiq7nnhl3AGOKVzzDEcCkqiH6Y7lUqNpwzgjNotRXoFTyGMqVhUiYhRza6ZGB8dCCHcWm3XgcqFBV2VPp6WGA9U=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.26,REQID:493e0549-3e4b-4485-84ce-84a01e5225f7,IP:0,U
        RL:0,TC:0,Content:-5,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTION
        :release,TS:-5
X-CID-META: VersionHash:cb9a4e1,CLOUDID:2195bc3e-de1e-4348-bc35-c96f92f1dcbb,B
...
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by mailgw01.mediatek.com
        ...
        with ESMTP id 79467091; Sat, 17 Jun 2023 18:33:06 +0800
Received: from mtkmbs13n2.mediatek.inc (172.21.101.108) by
 mtkmbs11n2.mediatek.inc (172.21.101.187) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26; Sat, 17 Jun 2023 18:33:04 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkmbs13n2.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.2.1118.26 via Frontend Transport; Sat, 17 Jun 2023 18:33:03 +0800
...
Subject: [PATCH v3,07/11] mediatek: vcodec: separate struct mtk_vcodec_ctx
Date:   Sat, 17 Jun 2023 18:32:51 +0800
Message-ID: <20230617103255.20239-8-yunfei.dong@mediatek.com>
...
index d3930e8030de..3445fe1c738c 100644
...
+	struct mtk_vcodec_dec_ctx *ctx = fh_to_dec_ctx(priv);
 	...
 	struct mtk_q_data *q_data;
 	int ret = 0;
@@ -551,7 +551,7 @@ static int vidioc_enum_framesizes(struct file *file, void *priv,
...
+	struct mtk_vcodec_dec_ctx *ctx = fh_to_dec_ctx(priv);
 	...
 	if (fsize->index != 0)
@@ -583,7 +583,7 @@ static int vidioc_enum_framesizes(struct file *file, void *priv,
...
+	struct mtk_vcodec_dec_ctx *ctx = fh_to_dec_ctx(priv);
 	...
 	const struct mtk_video_fmt *fmt;
 	int i, j = 0;
@@ -629,7 +629,7 @@ static int vidioc_vdec_enum_fmt_vid_out(struct file *file, void *priv,
...
+	struct mtk_vcodec_dec_ctx *ctx = fh_to_dec_ctx(priv);
 	...
 	struct vb2_queue *vq;
 	struct mtk_q_data *q_data;
@@ -718,7 +718,7 @@ int vb2ops_vdec_queue_setup(struct vb2_queue *vq, unsigned int *nbuffers,
...
@@ -760,7 +760,7 @@ int vb2ops_vdec_queue_setup(struct vb2_queue *vq, unsigned int *nbuffers,
...
@@ -784,7 +784,7 @@ int vb2ops_vdec_buf_prepare(struct vb2_buffer *vb)
...
+	struct mtk_vcodec_dec_ctx *ctx = vb2_get_drv_priv(vb->vb2_queue);
 	...
 	bool buf_error;
@@ -822,7 +822,7 @@ int vb2ops_vdec_buf_init(struct vb2_buffer *vb)
...
@@ -833,7 +833,7 @@ int vb2ops_vdec_start_streaming(struct vb2_queue *q, unsigned int count)
...
@@ -888,7 +888,7 @@ void vb2ops_vdec_stop_streaming(struct vb2_queue *q)
...
@@ -896,7 +896,7 @@ static void m2mops_vdec_device_run(void *priv)
...
@@ -915,7 +915,7 @@ static int m2mops_vdec_job_ready(void *m2m_priv)
...
@@ -963,7 +963,7 @@ const struct v4l2_ioctl_ops mtk_vdec_ioctl_ops = {
...
index 1056a661f981..b6a15f7fbee3 100644
...
@@ -139,7 +139,7 @@ static int mtk_vcodec_init_dec_resources(struct mtk_vcodec_dev *dev)
...
@@ -237,7 +237,7 @@ static int fops_vcodec_open(struct file *file)
...
index 08e76387ad54..189bb36571ec 100644
...
index d70cf4f405b3..e92bae40c767 100644
...
index f20b8f652d1b..e543690b06d1 100644
...
index e92d0f05df41..ee7d41f3b751 100644
...
index 8d849916634f..b86d939ee26f 100644
--- a/drivers/media/platform/mediatek/vcodec/vdec_msg_queue.c
+++ b/drivers/media/platform/mediatek/vcodec/vdec_msg_queue.c
@@ -200,7 +200,7 @@ bool vdec_msg_queue_wait_lat_buf_full(struct vdec_msg_queue *msg_queue)
 }
...
+			   struct mtk_vcodec_dec_ctx *ctx)
 {
 	struct vdec_lat_buf *lat_buf;
 	struct mtk_vcodec_mem *mem;
@@ -238,8 +238,8 @@ static void vdec_msg_queue_core_work(struct work_struct *work)
 {
 	struct vdec_msg_queue *msg_queue =
...
@@ -279,7 +279,7 @@ static void vdec_msg_queue_core_work(struct work_struct *work)
 }
