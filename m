...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 52FAD652014
	for <lists+devicetree@lfdr.de>; Tue, 20 Dec 2022 13:01:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233346AbiLTMBV (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 20 Dec 2022 07:01:21 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57484 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233189AbiLTMBS (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 20 Dec 2022 07:01:18 -0500
Received: from mail-wm1-x32f.google.com (mail-wm1-x32f.google.com [IPv6:2a00:1450:4864:20::32f])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2B491D2C6;
        Tue, 20 Dec 2022 04:01:17 -0800 (PST)
Received: by mail-wm1-x32f.google.com with SMTP id 131-20020a1c0289000000b003d35acb0f9fso853562wmc.2;
        Tue, 20 Dec 2022 04:01:17 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=content-transfer-encoding:mime-version:references:in-reply-to
         ...
         :message-id:reply-to;
        bh=JcHOUhgSFFiaqpaBXX3hPEgTgTHj2YDiRrWfKIMBgxY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=JcHOUhgSFFiaqpaBXX3hPEgTgTHj2YDiRrWfKIMBgxY=;
        b=
X-Gm-Message-State: ANoB5pkUYGPMEIRbIsr6dX/Fhjtp9FXUcq7EbHzmFi8PxCk3eEUYGW55
        /JdVmngjHbFKp4jkILg5DIk=
X-Google-Smtp-Source: AA0mqf5G6fv9afgpz4guu9NKRa0plyEFapM1G8sVAIrlpJKg2ZTLDexEnFzoMB75yw8P3F9W2odz3Q==
X-Received: by 2002:a05:600c:3b8a:b0:3d1:f0f1:ceb4 with SMTP id n10-20020a05600c3b8a00b003d1f0f1ceb4mr34427897wms.19.1671537675618;
        Tue, 20 Dec 2022 04:01:15 -0800 (PST)
Received: from localhost.localdomain (2a02-8428-46a0-7c01-43c0-f52a-beed-541b.rev.sfr.net. [2a02:8428:46a0:7c01:43c0:f52a:beed:541b])
        by smtp.gmail.com with ESMTPSA id q1-20020a1c4301000000b003d04e4ed873sm22843188wma.22.2022.12.20.04.01.14
...
Subject: [PATCH v3 1/2] drm/panel: Add driver for the AUO A030JTN01 TFT LCD
Date:   Tue, 20 Dec 2022 13:01:07 +0100
Message-Id: <20221220120108.481554-2-cbranchereau@gmail.com>
...
index 000000000000..b9fc64f9e49c
--- /dev/null
...
+	}
+
+	priv->panel_info = (const struct a030jtn01_info *) id->driver_data;
+	if (!priv->panel_info)
+		return -EINVAL;
+
