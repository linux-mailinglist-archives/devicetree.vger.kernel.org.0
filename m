...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8E88D20DD6E
	for <lists+devicetree@lfdr.de>; Mon, 29 Jun 2020 23:50:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729442AbgF2Svr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 29 Jun 2020 14:51:47 -0400
Received: from new4-smtp.messagingengine.com ([66.111.4.230]:39983 "EHLO
        new4-smtp.messagingengine.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1729597AbgF2Sva (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Mon, 29 Jun 2020 14:51:30 -0400
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailnew.nyi.internal (Postfix) with ESMTP id 080EC5805A8;
        Mon, 29 Jun 2020 10:58:46 -0400 (EDT)
Received: from mailfrontend1 ([10.202.2.162])
  by compute4.internal (MEProxy); Mon, 29 Jun 2020 10:58:46 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cerno.tech; h=
        date:from:to:cc:subject:message-id:references:mime-version
        :content-type:in-reply-to; s=fm3; bh=rS523zfni98zzKzWSdemo2xPJcG
        G9OnvTTJuO3HKYsQ=; b=ABAWjVn4Xjk1sqBiXry6QbEb+5dZuwnks7pi3tQkats
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:content-type:date:from:in-reply-to
        :message-id:mime-version:references:subject:to:x-me-proxy
        :x-me-proxy:x-me-sender:x-me-sender:x-sasl-enc; s=fm3; bh=rS523z
        fni98zzKzWSdemo2xPJcGG9OnvTTJuO3HKYsQ=; b=vVSIq13PURqrBFmCv5FUBe
        
        ==
X-ME-Sender: <xms:pAH6XsiPvCbOQICeZSEBwm9jU4K2wdIu1KLY8Sdxklp3egLuboq3Gg>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgeduhedrudelledguddtucetufdoteggodetrfdotf
...
X-ME-Proxy: <xmx:pAH6XlAEzSsAO1GVJQO1qt_MmCP6mcg1CNmicXnGpPvq5wOIWxgClg>
    <xmx:pAH6XkEOSynOvTLKWurKLajfukSt7L3Qjd6qQGf2GN9GzI3dHlC_lg>
    <xmx:pAH6XtTjkspq5C9l5g9g-7VBob-61ecdl6nhDGm6whozoAHRInIhdg>
    <xmx:pQH6XgguXbhxGxMUPyBRWOpFwokPsZddPceCmCZiM1FvehS2vRMALg>
Received: from localhost (lfbn-tou-1-1502-76.w90-89.abo.wanadoo.fr [90.89.68.76])
        by mail.messagingengine.com (Postfix) with ESMTPA id A71573280059;
        Mon, 29 Jun 2020 10:58:43 -0400 (EDT)
Date:   Mon, 29 Jun 2020 16:58:42 +0200
...
Subject: Re: [PATCH v2 02/11] clk: sunxi-ng: add support for the Allwinner
 A100 CCU
Message-ID: <20200629145842.c2jayko6efaitq3z@gilmour.lan>
References: <20200622025907.32574-1-frank@allwinnertech.com>
 <20200622025907.32574-3-frank@allwinnertech.com>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
        protocol="application/pgp-signature"; boundary="wzcxuodc6uqtqbpk"
Content-Disposition: inline
In-Reply-To: <20200622025907.32574-3-frank@allwinnertech.com>
...
You've been using the public name for all of the other header guards as
far as I can tell, it would be great to use it here too

> diff --git a/drivers/clk/sunxi-ng/ccu-sun50i-a100.c b/drivers/clk/sunxi-ng/ccu-sun50i-a100.c
> new file mode 100644
> index 0000000..57c6910
> --- /dev/null
...
Having a define for the BIT(29) and the enable and lock bits earlier
would be nice.
...
This is hard to tell without the datasheet, but I'd rather have them
ordered by registers that functions. It's easier to debug later on, but
usually the core clocks are in lower address registers than the "leaves"
clocks, which allows to avoid most of the registration order issues.
...
iHUEABYIAB0WIQRcEzekXsqa64kGDp7j7w1vZxhRxQUCXvoBogAKCRDj7w1vZxhR
xfRJAP0RI/7Mt7SjGPx1mCnF+/ravwu/j8UjILj74Xkb1XuhvgEApBuE+R9JTt5W
VFMhaIo2kRI5PCiJcO08ht0fMtoPigg=
=/g7M
-----END PGP SIGNATURE-----
