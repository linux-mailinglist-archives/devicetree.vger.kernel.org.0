...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 27D152424E0
	for <lists+devicetree@lfdr.de>; Wed, 12 Aug 2020 06:44:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725941AbgHLEoc (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 12 Aug 2020 00:44:32 -0400
Received: from mail29.static.mailgun.info ([104.130.122.29]:58908 "EHLO
        mail29.static.mailgun.info" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726673AbgHLEoa (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Wed, 12 Aug 2020 00:44:30 -0400
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1597207439; h=Content-Transfer-Encoding: MIME-Version:
 References: In-Reply-To: Message-Id: Date: Subject: Cc: To: From:
 Sender; bh=KEJopDmnhe9tGpLhJgeA7A7lkbEzBuhZ+g53a3hcp0k=; b=X9nJz2epNXEMUAbVtYc0ANBhaYdmZNycrgZuE4jtGoDjW7piA39opaWu4zKw9YSJUyRYHdEV
 wKQxjJmeDnEjqBtFeTmhk4DZdmLU2Lz51nMzn++BN9kRzrcG1M7PzjMLJbM0f+/X3Z4QTwj+
 spQ9R4aoDO1yVIRs+dnm6W0c5Ek=
X-Mailgun-Sending-Ip: 104.130.122.29
X-Mailgun-Sid: WyI1YmJiNiIsICJkZXZpY2V0cmVlQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org
 (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171]) by
 smtp-out-n04.prod.us-east-1.postgun.com with SMTP id
 5f33738dd78a2e583327e450 (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Wed, 12 Aug 2020 04:43:57
 GMT
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 9DC9FC433A1; Wed, 12 Aug 2020 04:43:55 +0000 (UTC)
...
Received: from linuxdisplay-lab-04.qualcomm.com (i-global254.qualcomm.com [199.106.103.254])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id 5FD23C433CA;
        Wed, 12 Aug 2020 04:43:27 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org 5FD23C433CA
...
Subject: [PATCH v10 2/5] drm/msm/dp: add displayPort driver support
Date:   Tue, 11 Aug 2020 21:42:20 -0700
Message-Id: <20200812044223.19279-3-tanmay@codeaurora.org>
...
-- Remove parsing of AUX configuration properties and use default values
...
-- Replace dp_aux structure with drm_dp_aux from dp_helpers.
   As aux config properties are removed, no need of dp_aux structure.
-- Delete driver component during driver remove.
   This fixes use-after-free bug if DP device node is child node of MDSS
   device.
-- Assign default max lanes if data-lanes property is not available

Changes in v9:

-- Remove clk_set_parent for link clock source.
-- Remove register address space parsing by name.
-- Fix DP register dump utility
-- Disable DP clocks ater last vsync generated so that timing
   generator can be off gracefully.
-- Drop unused code, fix function prototypes and return type
-- Avoid 64-bit modulo operation

Changes in v10:

-- Fix help description of DisplayPort driver's Kconfig entry
...
---
 ...
 drivers/gpu/drm/msm/dp/dp_catalog.c           | 1004 ++++++++++
 drivers/gpu/drm/msm/dp/dp_catalog.h           |  101 +
 drivers/gpu/drm/msm/dp/dp_ctrl.c              | 1694 +++++++++++++++++
 drivers/gpu/drm/msm/dp/dp_ctrl.h              |   35 +
 drivers/gpu/drm/msm/dp/dp_display.c           |  907 +++++++++
 ...
 27 files changed, 7991 insertions(+), 3 deletions(-)
...
index b0b264e30ce5..0a5ad6a9e609 100644
--- a/drivers/gpu/drm/msm/disp/dpu1/dpu_encoder.c
+++ b/drivers/gpu/drm/msm/disp/dpu1/dpu_encoder.c
@@ -965,6 +965,9 @@ static void dpu_encoder_virt_mode_set(struct drm_encoder *drm_enc,
...
+
 	list_for_each_entry(conn_iter, connector_list, head)
 		if (conn_iter->encoder == drm_enc)
 			conn = conn_iter;
@@ -1107,6 +1110,7 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
 {
...
+	struct msm_drm_private *priv;
 	...
 	if (!drm_enc) {
@@ -1117,6 +1121,7 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
...
+	priv = drm_enc->dev->dev_private;
 	...
 	trace_dpu_enc_enable(DRMID(drm_enc), cur_mode->hdisplay,
 			     cur_mode->vdisplay);
@@ -1137,6 +1142,15 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
...
+	}
 ...
 out:
@@ -1199,6 +1213,11 @@ static void dpu_encoder_virt_disable(struct drm_encoder *drm_enc)
...
index 000000000000..582b551f8689
--- /dev/null
...
new file mode 100644
index 000000000000..2de11021d84a
--- /dev/null
...
new file mode 100644
index 000000000000..497f97f86c82
--- /dev/null
...
new file mode 100644
index 000000000000..4cf9ad4206cc
--- /dev/null
...
new file mode 100644
index 000000000000..4b0d64e504ac
--- /dev/null
...
new file mode 100644
index 000000000000..7400a7ba45f8
--- /dev/null
...
new file mode 100644
index 000000000000..fd5c959bdcaf
--- /dev/null
...
index c981cc10aebf..565feaea9a77 100644
