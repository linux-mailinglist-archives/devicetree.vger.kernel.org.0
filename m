...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 528004E7D08
	for <lists+devicetree@lfdr.de>; Sat, 26 Mar 2022 01:22:25 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231670AbiCYRhG (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 25 Mar 2022 13:37:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42000 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230476AbiCYRhD (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 25 Mar 2022 13:37:03 -0400
Received: from mail-lf1-x130.google.com (mail-lf1-x130.google.com [IPv6:2a00:1450:4864:20::130])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1C17BD5EA7
        for <devicetree@vger.kernel.org>; Fri, 25 Mar 2022 10:35:18 -0700 (PDT)
Received: by mail-lf1-x130.google.com with SMTP id d5so14531511lfj.9
        for <devicetree@vger.kernel.org>; Fri, 25 Mar 2022 10:35:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=baylibre-com.20210112.gappssmtp.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=pKYjYwRpB4h7RRL3cstt6OLqAd2/FqdfjKzUbHCjoWU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=pKYjYwRpB4h7RRL3cstt6OLqAd2/FqdfjKzUbHCjoWU=;
        b=
X-Gm-Message-State: AOAM532FH0Xe4PAx3jahFRqTU4z14pE8ycvjv9ZqC+YRKHjqQgDxZzS3
        kQesNA2iNMFKuDU3w8lMht31MWnrv4N3eA==
X-Google-Smtp-Source: ABdhPJyMgPYDEJw3WY3vuojt+lBzWrG9a9nbVMY0lmdkWBZBBzgPnOQv9X1x4MQRXTws1Zvo33nY7A==
X-Received: by 2002:a5d:6b4c:0:b0:1e6:8ece:62e8 with SMTP id x12-20020a5d6b4c000000b001e68ece62e8mr10023997wrw.201.1648228643632;
        Fri, 25 Mar 2022 10:17:23 -0700 (PDT)
Received: from localhost.localdomain (2a02-8440-6240-cc41-3074-96af-9642-0003.rev.sfr.net. [2a02:8440:6240:cc41:3074:96af:9642:3])
        by smtp.gmail.com with ESMTPSA id p16-20020a5d6390000000b00203ffebddf3sm7547464wru.99.2022.03.25.10.17.21
...
Subject: [PATCH 18/22] drm/mediatek: Add mt8195 Embedded DisplayPort driver
Date:   Fri, 25 Mar 2022 18:15:07 +0100
Message-Id: <20220325171511.23493-19-granquet@baylibre.com>
...
---
 ...
 drivers/gpu/drm/mediatek/mtk_dp.c      | 2223 ++++++++++++++++++++++++
 drivers/gpu/drm/mediatek/mtk_dp_reg.h  |  568 ++++++
 drivers/gpu/drm/mediatek/mtk_drm_drv.c |    1 +
 drivers/gpu/drm/mediatek/mtk_drm_drv.h |    1 +
 6 files changed, 2803 insertions(+)
...
index a38e88e82d12..8bfd9fb64db9 100644
--- a/drivers/gpu/drm/mediatek/Makefile
+++ b/drivers/gpu/drm/mediatek/Makefile
@@ -22,3 +22,5 @@ mediatek-drm-hdmi-objs := mtk_cec.o \
 			  mtk_hdmi_ddc.o
...
index 000000000000..e8d918e92e31
--- /dev/null
...
new file mode 100644
index 000000000000..bdd2715beced
--- /dev/null
...
index 4cbfa7cd5c57..5f3148454608 100644
--- a/drivers/gpu/drm/mediatek/mtk_drm_drv.c
+++ b/drivers/gpu/drm/mediatek/mtk_drm_drv.c
@@ -736,6 +736,7 @@ static struct platform_driver * const mtk_drm_drivers[] = {
 	&mtk_disp_ovl_driver,
...
index a58cebd01d35..302936afe1d5 100644
--- a/drivers/gpu/drm/mediatek/mtk_drm_drv.h
+++ b/drivers/gpu/drm/mediatek/mtk_drm_drv.h
@@ -54,6 +54,7 @@ extern struct platform_driver mtk_disp_merge_driver;
