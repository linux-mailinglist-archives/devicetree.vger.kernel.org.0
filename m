...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DAE52651525
	for <lists+devicetree@lfdr.de>; Mon, 19 Dec 2022 22:56:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232589AbiLSV43 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 19 Dec 2022 16:56:29 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59116 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231942AbiLSV41 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 19 Dec 2022 16:56:27 -0500
Received: from mail-qt1-x832.google.com (mail-qt1-x832.google.com [IPv6:2607:f8b0:4864:20::832])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A41BE11A3E
        for <devicetree@vger.kernel.org>; Mon, 19 Dec 2022 13:56:24 -0800 (PST)
Received: by mail-qt1-x832.google.com with SMTP id s9so9520886qtx.6
        for <devicetree@vger.kernel.org>; Mon, 19 Dec 2022 13:56:24 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=kMwdIFQeRKK06VDXZw3zBzLT/HVoG3TeIl2SI0oGt0Y=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=kMwdIFQeRKK06VDXZw3zBzLT/HVoG3TeIl2SI0oGt0Y=;
        b=
X-Gm-Message-State: AFqh2krnqmzdGb4lPxPQkVJ3e22Sgi2tySBqHDEnTtPZxTC6MFBbxXWr
        xc9RBJl1W4AHorjblh6fZEll/Q==
X-Google-Smtp-Source: AMrXdXtWs1ydnzk/4qiM9U++dBECCcTXiJR0uvPyFK7VRWEpk5kHeI+oGhWZ3Azs4f3TDbZz8WDOkw==
X-Received: by 2002:ac8:534d:0:b0:3a9:81f0:d8e9 with SMTP id d13-20020ac8534d000000b003a981f0d8e9mr93029qto.68.1671486983017;
        Mon, 19 Dec 2022 13:56:23 -0800 (PST)
Received: from nicolas-tpx395.localdomain (192-222-136-102.qc.cable.ebox.net. [192.222.136.102])
        by smtp.gmail.com with ESMTPSA id r2-20020ac867c2000000b003995f6513b9sm6558180qtp.95.2022.12.19.13.56.21
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 19 Dec 2022 13:56:22 -0800 (PST)
Message-ID: <092f76873a914c52c5157a21401be6cf78e3f188.camel@ndufresne.ca>
...
Date:   Mon, 19 Dec 2022 16:56:21 -0500
In-Reply-To: <20221219155616.848690-8-benjamin.gaignard@collabora.com>
...
Can you clarify ? I knew the filmgrain was, but didn't expect spatial scali=
ng to
need it. On this aspect, I don't see any new code to let Hantro driver know=
 that
the postproc is needed. The frame header value should be taken into account=
 in
...
This is the same as V4L2_AV1_TOTAL_REFS_PER_FRAME. AV1_TOTAL_REFS_PER_FRAME=
 is
...
include/linux/minmax.h:#define clamp(val, lo, hi) min((typeof(val))max(val,=
 lo), hi)
...
This ref_count is only ever 0 and 1. Would be nicer if it was some boolean,=
 like
"valid", or "active".
...
> +}
> +
> +static void rockchip_vpu981_av1_dec_get_shear_params(const uint32_t *par=
ams,
...
> +}
> +
> +static int rockchip_vpu981_av1_dec_get_relative_dist(struct hantro_ctx *=
ctx,
> +						     int a, int b)
> +{
> +	struct hantro_av1_dec_hw_ctx *av1_dec =3D &ctx->av1_dec;
...
I think I've seen this one in MTK. Will be nice to make a v4l2-av1.h eventu=
ally
...
> +	uint32_t segval[V4L2_AV1_MAX_SEGMENTS][V4L2_AV1_SEG_LVL_MAX] =3D { 0 };
> +	struct hantro_dev *vpu =3D ctx->dev;
> +	uint8_t segsign =3D 0, preskip_segid =3D 0, last_active_seg =3D 0, i, j=
;
> +
...
> +	uint8_t restoration_unit_size[V4L2_AV1_NUM_PLANES_MAX] =3D { 3, 3, 3 };
> +	int i;
> +
...
> +		((-((upscaledLumaPlaneW - downscaledLumaPlaneW) << (RS_SCALE_SUBPEL_BI=
TS - 1))
...
> +		((-((upscaledChromaPlaneW - downscaledChromaPlaneW) << (RS_SCALE_SUBPE=
L_BITS - 1))
> +		  + upscaledChromaPlaneW / 2)
> +		 / upscaledChromaPlaneW + (1 << (RS_SCALE_EXTRA_BITS - 1)) - errChroma=
 / 2)
> +		& RS_SCALE_SUBPEL_MASK;
> +	superres_luma_step =3D stepLumaX;
> +	superres_chroma_step =3D stepChromaX;
> +	superres_luma_step_invra =3D
> +		((upscaledLumaPlaneW << RS_SCALE_SUBPEL_BITS) + (downscaledLumaPlaneW =
/ 2))
> +		/ downscaledLumaPlaneW;
> +	superres_chroma_step_invra =3D
> +		((upscaledChromaPlaneW << RS_SCALE_SUBPEL_BITS) + (downscaledChromaPla=
neW / 2))
...
> +	const struct v4l2_ctrl_av1_frame *frame =3D ctrls->frame;
> +	struct hantro_dev *vpu =3D ctx->dev;
> +	int pic_width_in_cbs =3D ALIGN(frame->frame_width_minus_1 + 1, 8) >> 3;
...
> +	if (rockchip_vpu981_av1_dec_get_relative_dist
> +	    (ctx, alt_frame_offset, cur_frame_offset) > 0 && ref_stamp >=3D 0) =
{
...
I said I'd stop, but can't this be calculate once and saved in the referenc=
e
frame structure ?
...
E_DISTANCE) {
> +		int rf_order_hint =3D rockchip_vpu981_get_order_hint(ctx, refs_selecte=
d[0]);
...
I believe these register are read by PP when using format 0, perhaps someth=
ing
...
sw_bit_depth_out_minus8, but I don't know if its used for AV1, in my doc it=
s
only used for AVS2 CODEC.

I think its good to underline that in VC8000/VC9000, some registers are sha=
red
...
As enabling the post-proc is done by the common driver, we need a mechanism=
 to
altern the core decisions, as we really need to enable post-proc to produce
filmgrain. Fortunatly, not applying this filter isn't visually bad, but tha=
t's
...
Just a note that a lot of this is identical to VC8000 register sets. But un=
til
someone upstream VC8000 and till we have more VC9000 support, its fine to k=
eep
