...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 47E41398D25
	for <lists+devicetree@lfdr.de>; Wed,  2 Jun 2021 16:36:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231670AbhFBOhw (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 2 Jun 2021 10:37:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40468 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230440AbhFBOhs (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 2 Jun 2021 10:37:48 -0400
Received: from lahtoruutu.iki.fi (lahtoruutu.iki.fi [IPv6:2a0b:5c81:1c1::37])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 279E5C061574;
        Wed,  2 Jun 2021 07:36:04 -0700 (PDT)
Received: from hillosipuli.retiisi.eu (dsl-hkibng32-54fb5d-176.dhcp.inet.fi [84.251.93.176])
        ...
        by lahtoruutu.iki.fi (Postfix) with ESMTPSA id 6B8D01B00273;
        Wed,  2 Jun 2021 17:36:02 +0300 (EEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=iki.fi; s=lahtoruutu;
        t=1622644562;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=gue5MzzNgaB371Q3vLxFSHh6OHi3d9GnQC8Y0ghZez4=;
        b=
Received: from valkosipuli.localdomain (valkosipuli.localdomain [IPv6:fd35:1bc8:1a6:d3d5::80:2])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by hillosipuli.retiisi.eu (Postfix) with ESMTPS id 10825634C87;
        Wed,  2 Jun 2021 17:35:09 +0300 (EEST)
Received: from localhost ([127.0.0.1] helo=valkosipuli.retiisi.eu)
        by valkosipuli.localdomain with esmtp (Exim 4.92)
        (envelope-from <sakari.ailus@iki.fi>)
        id 1loRyU-0002VK-2o; Wed, 02 Jun 2021 17:36:02 +0300
Date:   Wed, 2 Jun 2021 17:36:02 +0300
...
Subject: Re: [PATCH v2 3/5] media: i2c: add driver for the SK Hynix Hi-846 8M
 pixel camera
Message-ID: <20210602143601.GY3@valkosipuli.retiisi.eu>
References: <20210528081336.3858700-1-martin.kepplinger@puri.sm>
 <20210528081336.3858700-4-martin.kepplinger@puri.sm>
MIME-Version: 1.0
...
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=iki.fi;
        s=lahtoruutu; t=1622644562;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=gue5MzzNgaB371Q3vLxFSHh6OHi3d9GnQC8Y0ghZez4=;
        b=
ARC-Seal: i=1; s=lahtoruutu; d=iki.fi; t=1622644562; a=rsa-sha256;
        cv=none;
        b=
Precedence: bulk
...
On Fri, May 28, 2021 at 10:13:34AM +0200, Martin Kepplinger wrote:
...
> index 81e1edeceae4..b5ec5c66ec0e 100644
> --- a/MAINTAINERS
> +++ b/MAINTAINERS
> @@ -8425,6 +8425,12 @@ S:	Maintained
...
> index 000000000000..3f896e45f99a
> --- /dev/null
...
Please declare ret as last, and remove the empty line below.
...
You can return zero here and avoid the goto.

This check also needs to take place after handling for vblank below.
...
You should handle this instead by changing the control range (min and max).
...
Please align right of opening parenthesis. What you can also do:
...
Please keep the opening parenthesis on the previous line.
...
No need to check if a regulator is enabled before disabling it.
...
Could you rely on runtime PM here?
...
Please align with the opening parenthesis.

Could you check checkpatch.pl is relatively happy? Keep 80 chars per line
in mind, too.
...
The caller has checked for this already, so you can remove it here.

Same for the other similar callbacks.
...
There's no need for implementing s_power anymore in sensor drivers using
runtime PM. Please remove it.
...
Doesn't the GPIO framework handle this already?

You also should use the gpiod API instead.
...
Assigning ret here is redundant.
...
I'd return an error from probe here.
...
Almost all sensors need a delay here (but not often before lifting
xshutdown). Have you checked this sequence is as the spec says (just
wondering)?
