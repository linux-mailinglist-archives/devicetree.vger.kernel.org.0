...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 89C2224935C
	for <lists+devicetree@lfdr.de>; Wed, 19 Aug 2020 05:17:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726751AbgHSDRv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 18 Aug 2020 23:17:51 -0400
Received: from pb-smtp2.pobox.com ([64.147.108.71]:63287 "EHLO
        pb-smtp2.pobox.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726605AbgHSDRt (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 18 Aug 2020 23:17:49 -0400
Received: from pb-smtp2.pobox.com (unknown [127.0.0.1])
        by pb-smtp2.pobox.com (Postfix) with ESMTP id 472886A6B9;
        Tue, 18 Aug 2020 23:17:30 -0400 (EDT)
        (envelope-from nico@fluxnic.net)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=pobox.com; h=from:to:cc
        :subject:date:message-id:in-reply-to:references:mime-version
        :content-transfer-encoding; s=sasl; bh=SzM9MZutv2PiM869ovFHelTKd
        5o=; b=Kp7ZF2c+rQneT+YBy6LEc5MlU/tRbLWryQ58n6v4zmQc3SS/3nsYWl3Xo
        w7mux85z++LyDb363cydblTCXtNuczrD8WMFhD/M7ObpUZ6WW7ucCwu0wPscHVz0
        bkafuWShq0eN6cVJwYzBjGskRa0tosdxmtjyXICJTeLWK3qfWs=
Received: from pb-smtp2.nyi.icgroup.com (unknown [127.0.0.1])
        by pb-smtp2.pobox.com (Postfix) with ESMTP id 3D1F46A6B7;
        Tue, 18 Aug 2020 23:17:30 -0400 (EDT)
        (envelope-from nico@fluxnic.net)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed; d=fluxnic.net;
 h=from:to:cc:subject:date:message-id:in-reply-to:references:mime-version:content-transfer-encoding; s=2016-12.pbsmtp; bh=YVg1yq6J0v2oiyJiHtn+DP/EJCEH8lelkUQ+ckAfW8c=; b=UfphHTSuPi4017uid4gKjHykUUbmvwlP8vFXRohA//qTpAIOoQulQfgnl5eTTJbmsdrcohAIGjKh4jMKHh2DTIBGYa/zZMNumCJGwQMREAukiDNEpG5erobWADvA2Ajn2mUsZOufr07p2vr3ZAAIG2Y+36ZXANTHLHa3V0v/URI=
Received: from yoda.home (unknown [24.203.50.76])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by pb-smtp2.pobox.com (Postfix) with ESMTPSA id 637176A6B5;
        Tue, 18 Aug 2020 23:17:29 -0400 (EDT)
        (envelope-from nico@fluxnic.net)
Received: from xanadu.home (xanadu.home [192.168.2.2])
        by yoda.home (Postfix) with ESMTP id 4F7812DA0E95;
...
Subject: [PATCH v2 2/2] i3c/master: add the mipi-i3c-hci driver
Date:   Tue, 18 Aug 2020 23:17:23 -0400
Message-Id: <20200819031723.1398378-3-nico@fluxnic.net>
X-Mailer: git-send-email 2.26.2
In-Reply-To: <20200819031723.1398378-1-nico@fluxnic.net>
References: <20200819031723.1398378-1-nico@fluxnic.net>
MIME-Version: 1.0
X-Pobox-Relay-ID: 8382D720-E1CA-11EA-B05F-2F5D23BA3BAF-78420484!pb-smtp2.pobox.com
...
+				return -ENOMEM;
+			}
+			*ring_data++ =3D lo32(xfer->data_phys);
+			*ring_data++ =3D hi32(xfer->data_phys);
+		} else {
+			*ring_data++ =3D 0;
+			*ring_data++ =3D 0;
+		}
