...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id ADE40681223
	for <lists+devicetree@lfdr.de>; Mon, 30 Jan 2023 15:18:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237616AbjA3OSk (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 30 Jan 2023 09:18:40 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60688 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237587AbjA3OSL (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 30 Jan 2023 09:18:11 -0500
Received: from relay11.mail.gandi.net (relay11.mail.gandi.net [IPv6:2001:4b98:dc4:8::231])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 212553EC6E;
        Mon, 30 Jan 2023 06:17:27 -0800 (PST)
Received: from booty.fritz.box (unknown [77.244.183.192])
        (Authenticated sender: luca.ceresoli@bootlin.com)
        by mail.gandi.net (Postfix) with ESMTPA id D6FBB10001A;
        Mon, 30 Jan 2023 14:17:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=bootlin.com; s=gm1;
        ...
        b=
...
Subject: [PATCH v4 13/21] staging: media: tegra-video: move tegra_channel_fmt_align to a per-soc op
Date:   Mon, 30 Jan 2023 15:15:55 +0100
Message-Id: <20230130141603.323221-14-luca.ceresoli@bootlin.com>
