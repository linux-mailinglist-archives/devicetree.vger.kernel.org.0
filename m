...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 51E672D91F5
	for <lists+devicetree@lfdr.de>; Mon, 14 Dec 2020 04:02:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727240AbgLNDAw (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 13 Dec 2020 22:00:52 -0500
Received: from server-x.ipv4.hkg02.ds.network ([27.111.83.178]:54562 "EHLO
        mail.gtsys.com.hk" rhost-flags-OK-FAIL-OK-OK) by vger.kernel.org
        with ESMTP id S2438154AbgLNDAr (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 13 Dec 2020 22:00:47 -0500
Received: from localhost (localhost [127.0.0.1])
        by mail.gtsys.com.hk (Postfix) with ESMTP id BE1EC20138C6;
        Mon, 14 Dec 2020 11:00:00 +0800 (HKT)
X-Virus-Scanned: Debian amavisd-new at gtsys.com.hk
Received: from mail.gtsys.com.hk ([127.0.0.1])
        by localhost (mail.gtsys.com.hk [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id T-qUF-1OW8tw; Mon, 14 Dec 2020 11:00:00 +0800 (HKT)
Received: from s01.gtsys.com.hk (unknown [10.128.4.2])
        by mail.gtsys.com.hk (Postfix) with ESMTP id A8A3120139A0;
        Mon, 14 Dec 2020 11:00:00 +0800 (HKT)
Received: from armhf2.gtsys.com.hk (unknown [10.128.4.15])
        by s01.gtsys.com.hk (Postfix) with ESMTP id AD798C01FAD;
        Mon, 14 Dec 2020 11:00:00 +0800 (HKT)
Received: by armhf2.gtsys.com.hk (Postfix, from userid 1000)
        id A1B4D2000CF; Mon, 14 Dec 2020 11:00:00 +0800 (HKT)
...
Subject: [PATCH v1 2/4] phy: rockchip: emmc, add vendor prefix to optional dts properties
Date:   Mon, 14 Dec 2020 10:59:43 +0800
Message-Id: <20201214025946.25753-3-chris.ruehl@gtsys.com.hk>
