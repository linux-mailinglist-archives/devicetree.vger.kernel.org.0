...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5622F4AC79B
	for <lists+devicetree@lfdr.de>; Mon,  7 Feb 2022 18:34:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235972AbiBGRc0 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 7 Feb 2022 12:32:26 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45262 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1347271AbiBGRX5 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 7 Feb 2022 12:23:57 -0500
Received: from esa.microchip.iphmx.com (esa.microchip.iphmx.com [68.232.154.123])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D0C39C0401D8;
        Mon,  7 Feb 2022 09:23:53 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1644254634; x=1675790634;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=wEQR3xNJXj1v6e0R5ednQxcFEgwIcX6csRyPpMpte3I=;
  b=dWOIllajfLUu1bbMjmJky9Gu0Y/+epf6S60PtvoPDqx+BRCbftyPrhYn
   XYne6cHUSAGtvZlaA5N6FSblam5o7RhP4zL+HsrEs4v2aAPLY+s1HpKFN
   VHAmOz6Vui9ICd8FaiGeSaaVPk2C3T4KpTO/xZuWR2jtf8Vbi6bNdOXYy
   5/UgNaF8jYHuYMQ5qnu0efrZUrD9aRiSD1hRfBs/FDnqFOWgfR/Q9FMvA
   d50PnUC90699s8ooTaoRaiaCA8okvFXna0IHd2VH5+kRPjyX5F+ZO30+N
   ly4FhusAfqXGU41PzJBrNSbsJnOtGljolrOXNAbM0wKw6AKpWLFZ40zlg
   Q==;
IronPort-SDR: 
 70PX72IusZzTpSOdhhg8sBT2
X-IronPort-AV: E=Sophos;i="5.88,350,1635231600"; 
   d="scan'208";a="147879324"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa2.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 07 Feb 2022 10:22:51 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2375.17; Mon, 7 Feb 2022 10:22:50 -0700
Received: from CHE-LT-I21427LX.microchip.com (10.10.115.15) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server id
 15.1.2375.17 via Frontend Transport; Mon, 7 Feb 2022 10:22:44 -0700
...
Subject: [PATCH v8 net-next 05/10] net: dsa: microchip: add DSA support for microchip lan937x
Date:   Mon, 7 Feb 2022 22:51:59 +0530
Message-ID: <20220207172204.589190-6-prasanna.vengateshan@microchip.com>
...
---
 ...
 drivers/net/dsa/microchip/lan937x_dev.c  | 584 +++++++++++++++++++
 drivers/net/dsa/microchip/lan937x_dev.h  | 116 ++++
 drivers/net/dsa/microchip/lan937x_main.c | 297 ++++++++++
 drivers/net/dsa/microchip/lan937x_reg.h  | 688 +++++++++++++++++++++++
 drivers/net/dsa/microchip/lan937x_spi.c  | 238 ++++++++
 8 files changed, 1945 insertions(+)
...
index 3db63f62f0a1..6363d022695b 100644
--- a/drivers/net/dsa/microchip/ksz_common.h
+++ b/drivers/net/dsa/microchip/ksz_common.h
@@ -39,6 +39,8 @@ struct ksz_port {
...
+	u32 rgmii_rx_val;
 ...
 struct ksz_device {
@@ -143,6 +145,9 @@ void ksz_switch_remove(struct ksz_device *dev);
...
index 000000000000..e0bd1eb3d3ab
--- /dev/null
...
new file mode 100644
index 000000000000..4b412f79854a
--- /dev/null
...
new file mode 100644
index 000000000000..1b8fabdf9b35
--- /dev/null
...
new file mode 100644
index 000000000000..5a316977a8eb
--- /dev/null
