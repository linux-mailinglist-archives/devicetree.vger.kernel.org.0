...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 532234A7680
	for <lists+devicetree@lfdr.de>; Wed,  2 Feb 2022 18:08:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244540AbiBBRI2 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 2 Feb 2022 12:08:28 -0500
Received: from bhuna.collabora.co.uk ([46.235.227.227]:32972 "EHLO
        bhuna.collabora.co.uk" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233696AbiBBRI1 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 2 Feb 2022 12:08:27 -0500
Received: from [IPV6:2a01:e0a:120:3210:3185:7f74:37d4:845b] (unknown [IPv6:2a01:e0a:120:3210:3185:7f74:37d4:845b])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        (Authenticated sender: benjamin.gaignard)
        by bhuna.collabora.co.uk (Postfix) with ESMTPSA id EBC6B1F443AC;
        Wed,  2 Feb 2022 17:08:24 +0000 (GMT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1643821705;
        bh=oNitQz7ZEaP/oKK1oHgMBTSWmk0+EkBzimlbxR3pGmI=;
        h=Date:Subject:To:Cc:References:From:In-Reply-To:From;
        b=
Message-ID: <e08cfb7c-4eb4-8451-4a63-a2e971cc3c2f@collabora.com>
Date:   Wed, 2 Feb 2022 18:08:22 +0100
MIME-Version: 1.0
...
References: <20220105093758.6850-1-moudy.ho@mediatek.com>
 <20220105093758.6850-4-moudy.ho@mediatek.com>
...
Le 05/01/2022 à 10:37, Moudy Ho a écrit :
...
> ---
> Depend on:
> [1]https://patchwork.kernel.org/project/linux-mediatek/patch/20220104091712.25670-2-moudy.ho@mediatek.com/
> [2]https://patchwork.kernel.org/project/linux-mediatek/patch/20220104091712.25670-3-moudy.ho@mediatek.com/
> [3]https://patchwork.kernel.org/project/linux-mediatek/patch/20220104091712.25670-4-moudy.ho@mediatek.com/
> [4]https://patchwork.kernel.org/project/linux-mediatek/patch/20220104091712.25670-5-moudy.ho@mediatek.com/
> ---
...
>   22 files changed, 5247 insertions(+)
...
> index cf4adc64c953..f879b93a623b 100644
> --- a/drivers/media/platform/Kconfig
> +++ b/drivers/media/platform/Kconfig
> @@ -315,6 +315,26 @@ config VIDEO_MEDIATEK_MDP
...
> new file mode 100644
> index 000000000000..4a08502952d6
> --- /dev/null
...
> new file mode 100644
> index 000000000000..622900d2152c
> --- /dev/null
...
When testing MDP3 with GStreamer pipeline I notice R and B component swap when using
RGB16 pixel format.
V4L2_PIX_FMT_RGB565 should be mapped on MDP_COLOR_RGB565 to avoid this problem.
