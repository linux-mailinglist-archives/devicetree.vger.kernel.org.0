...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 500D86618D8
	for <lists+devicetree@lfdr.de>; Sun,  8 Jan 2023 20:54:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233848AbjAHTyA (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 8 Jan 2023 14:54:00 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53444 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233805AbjAHTx7 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 8 Jan 2023 14:53:59 -0500
Received: from amity.mint.lgbt (vmi888983.contaboserver.net [149.102.157.145])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 79575D102
        for <devicetree@vger.kernel.org>; Sun,  8 Jan 2023 11:53:57 -0800 (PST)
Received: from amity.mint.lgbt (mx.mint.lgbt [127.0.0.1])
        by amity.mint.lgbt (Postfix) with ESMTP id 4Nqnnt31FMz1S59v
        for <devicetree@vger.kernel.org>; Sun,  8 Jan 2023 14:53:54 -0500 (EST)
Authentication-Results: amity.mint.lgbt (amavisd-new);
        dkim=pass (2048-bit key) reason="pass (just generated, assumed good)"
        header.d=mint.lgbt
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=mint.lgbt; h=
        content-transfer-encoding:mime-version:x-mailer:message-id:date
        :subject:to:from; s=dkim; t=1673207632; x=1674071633; bh=9dsgbhg
        A9vnJIYjG6YuVbFl47O4RVEcVJHNR4rpiPy0=; b=naSAOTwmELJXYqHQfuW74qo
        
        =
X-Virus-Scanned: amavisd-new at amity.mint.lgbt
Received: from amity.mint.lgbt ([127.0.0.1])
        by amity.mint.lgbt (amity.mint.lgbt [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id 1IjXih6tWQYZ for <devicetree@vger.kernel.org>;
