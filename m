...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AB58F50C4C2
	for <lists+devicetree@lfdr.de>; Sat, 23 Apr 2022 01:46:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230104AbiDVXW7 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 22 Apr 2022 19:22:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33586 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231292AbiDVXWp (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 22 Apr 2022 19:22:45 -0400
Received: from mail-oi1-x22c.google.com (mail-oi1-x22c.google.com [IPv6:2607:f8b0:4864:20::22c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3E48F190692
        for <devicetree@vger.kernel.org>; Fri, 22 Apr 2022 15:58:14 -0700 (PDT)
Received: by mail-oi1-x22c.google.com with SMTP id a10so10639062oif.9
        for <devicetree@vger.kernel.org>; Fri, 22 Apr 2022 15:58:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=sKwahJ6h991paGx7JDYhUy3ZYqbFv7jGH6rPELKsrf4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=sKwahJ6h991paGx7JDYhUy3ZYqbFv7jGH6rPELKsrf4=;
        b=
X-Gm-Message-State: AOAM53089vaJR473x2jalCKn82aKWI2BZlu5+R+xn5SvdTuJwktvgg4l
        +KzBqGizcQ9aNcyv6DTqYLIpRQ==
X-Google-Smtp-Source: ABdhPJyqmYd1z9Rq15AUVm9dUC1P1UVABW5yYfL7O6OF2a1QkjjdylDjBFkVtXmtrQFlQUJmu0psVw==
X-Received: by 2002:aca:1109:0:b0:322:dfc8:82c6 with SMTP id 9-20020aca1109000000b00322dfc882c6mr3344849oir.129.1650668292690;
        Fri, 22 Apr 2022 15:58:12 -0700 (PDT)
Received: from ripper.. ([2600:1700:a0:3dc8:205:1bff:fec0:b9b3])
        by smtp.gmail.com with ESMTPSA id w18-20020a056808141200b00324fa65e89csm579055oiv.43.2022.04.22.15.58.11
...
Subject: [PATCH v2 2/2] clk: qcom: add sc8280xp GCC driver
Date:   Fri, 22 Apr 2022 16:00:13 -0700
Message-Id: <20220422230013.1332993-2-bjorn.andersson@linaro.org>
...
Changes since v1:
- Extracted gcc_parent_data_tcxo
- Dropped some leftover comments

 drivers/clk/qcom/Kconfig        |    9 +
 drivers/clk/qcom/Makefile       |    1 +
 drivers/clk/qcom/gcc-sc8280xp.c | 7451 +++++++++++++++++++++++++++++++
 3 files changed, 7461 insertions(+)
 create mode 100644 drivers/clk/qcom/gcc-sc8280xp.c

diff --git a/drivers/clk/qcom/Kconfig b/drivers/clk/qcom/Kconfig
index e27f37ac2d9c..bc4dcf356d82 100644
...
index dff6aeb980e6..36789f5233ef 100644
...
+};
+
+static const struct clk_parent_data gcc_parent_data_tcxo = { .fw_name = "bi_tcxo" };
+
...
+	{ .fw_name = "usb4_phy_gcc_usb4rtr_max_pipe_clk" },
+	{ .fw_name = "gcc_usb4_phy_pipegmux_clk_src" },
+};
+
...
+	{ .fw_name = "gcc_usb4_1_phy_dp_gmux_clk_src" },
+	{ .fw_name = "usb4_1_phy_gcc_usb4rtr_max_pipe_clk" },
+};
+
...
+	{ .fw_name = "gcc_usb4_phy_dp_gmux_clk_src" },
+	{ .fw_name = "usb4_phy_gcc_usb4rtr_max_pipe_clk" },
+};
+
...
+	{ .fw_name = "usb4_phy_gcc_usb4_pcie_pipe_clk" },
+	{ .fw_name = "bi_tcxo" },
+};
+
...
+	{ .fw_name = "gcc_usb4_phy_sys_pipegmux_clk_src" },
...
+	{ .fw_name = "qusb4phy_gcc_usb4_rx0_clk" },
+	{ .fw_name = "bi_tcxo" },
+};
+
...
+	{ .fw_name = "qusb4phy_gcc_usb4_rx1_clk" },
+	{ .fw_name = "bi_tcxo" },
+};
+
