...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E03495F3C7E
	for <lists+devicetree@lfdr.de>; Tue,  4 Oct 2022 07:48:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229486AbiJDFsf (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 4 Oct 2022 01:48:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36030 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229453AbiJDFsd (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 4 Oct 2022 01:48:33 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6C5112DAB2;
        Mon,  3 Oct 2022 22:48:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1664862510; x=1696398510;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=GVztGqEF+3zxgGqeh6lqQinXARwu5+5KIpBLxXe7EfE=;
  b=m0mdBn5MPJlQ5IwV3+G9xkhnQFRxUTfpRJ7iznb4bO+FH9cglXTT49hi
   gVDSGmKitpkF6v4M3l9Tt5NEGCEce7AmmMXTjl6/F1Jxzm3itbU8ylv1g
   dvZWmZz65UMqpu6Vl2vd63cXCR+h8RRLfNSdboiCLJfW5mxqyHfRfHQAt
   lLtQ2NdEHAR2tJnpyOhKds8sLxLvWvmxt3oRZ1HtZNJu1Q417F4QI99si
   U5FcqwIq+cC+wVlKup3NHbl2Ox1wLUOpDpmmQ3ePzLaKt4VnP1wV/P0PN
   ylOZnSXhWkRmNWRJPLOQdItPHyDOKg3Nepu4bYqMypHUSqzLu3+B83yBC
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10489"; a="282545643"
X-IronPort-AV: E=Sophos;i="5.93,367,1654585200"; 
   d="scan'208";a="282545643"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Oct 2022 22:48:29 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10489"; a="952649909"
X-IronPort-AV: E=Sophos;i="5.93,367,1654585200"; 
   d="scan'208";a="952649909"
Received: from lkp-server01.sh.intel.com (HELO 14cc182da2d0) ([10.239.97.150])
  by fmsmga005.fm.intel.com with ESMTP; 03 Oct 2022 22:48:25 -0700
Received: from kbuild by 14cc182da2d0 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ofan3-0005Mt-09;
        Tue, 04 Oct 2022 05:48:25 +0000
Date:   Tue, 4 Oct 2022 13:48:07 +0800
...
Message-ID: <202210041350.4dRhGF7P-lkp@intel.com>
References: <20221004032841.3714928-2-neal_liu@aspeedtech.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="W34OO6E8Y7HtNlZ2"
Content-Disposition: inline
In-Reply-To: <20221004032841.3714928-2-neal_liu@aspeedtech.com>
...
[cannot apply to herbert-crypto-2.6/master robh/for-next linus/master v6.0]
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=alpha SHELL=/bin/bash drivers/crypto/aspeed/
...
All warnings (new ones prefixed by >>):
   ...
   In file included from include/linux/device.h:15,
                    ...
                    from drivers/crypto/aspeed/aspeed-acry.c:12:
   drivers/crypto/aspeed/aspeed-acry.c: In function 'aspeed_acry_rsa_ctx_copy':
>> drivers/crypto/aspeed/aspeed-acry.c:27:28: warning: format '%x' expects argument of type 'unsigned int', but argument 4 has type 'size_t' {aka 'long unsigned int'} [-Wformat=]
      27 |         dev_info((d)->dev, "%s() " fmt, __func__, ##__VA_ARGS__)
         |                            ^~~~~~~
   ...
   include/linux/dev_printk.h:150:58: note: in expansion of macro 'dev_fmt'
     150 |         dev_printk_index_wrap(_dev_info, KERN_INFO, dev, dev_fmt(fmt), ##__VA_ARGS__)
         |                                                          ^~~~~~~
   drivers/crypto/aspeed/aspeed-acry.c:27:9: note: in expansion of macro 'dev_info'
      27 |         dev_info((d)->dev, "%s() " fmt, __func__, ##__VA_ARGS__)
         |         ^~~~~~~~
   drivers/crypto/aspeed/aspeed-acry.c:269:9: note: in expansion of macro 'ACRY_DBG'
     269 |         ACRY_DBG(acry_dev, "nbytes:0x%x, mode:%d\n", nbytes, mode);
         |         ^~~~~~~~


vim +27 drivers/crypto/aspeed/aspeed-acry.c

    24	
    25	#ifdef CONFIG_CRYPTO_DEV_ASPEED_DEBUG
    26	#define ACRY_DBG(d, fmt, ...)	\
  > 27		dev_info((d)->dev, "%s() " fmt, __func__, ##__VA_ARGS__)
    28	#else
    29	#define ACRY_DBG(d, fmt, ...)	\
    30		dev_dbg((d)->dev, "%s() " fmt, __func__, ##__VA_ARGS__)
    31	#endif
    32	
