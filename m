...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 889AD64BE05
	for <lists+devicetree@lfdr.de>; Tue, 13 Dec 2022 21:40:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237003AbiLMUkm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 13 Dec 2022 15:40:42 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49024 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236862AbiLMUkl (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 13 Dec 2022 15:40:41 -0500
Received: from mga11.intel.com (mga11.intel.com [192.55.52.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D9A731401C
        for <devicetree@vger.kernel.org>; Tue, 13 Dec 2022 12:40:37 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1670964037; x=1702500037;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=lBlM7dqnTIT3X7zZP/n06vhZ0biwhhOPwL79jtgaiFo=;
  b=aZ0WeNsVqJ+YugMHgSpPdKKb/VCan8ZsslCsFtI0AqPUfwr29BKGm111
   KpyGeZWh/rYxTgJK3wuzrwvRNiYKL1UuJ5RP4d1rdrSfu9KovD2LfrYRr
   2Xf8x3sxIOhDz9qbXFMzHqI/XiyNiHFlBLwkALh46I1gR112KwIJ19nyq
   OMvTzktPQscyDMeqmFUxD6fHGz8s2u77+Hje/REEwRoCBRuiTgfrXR6+z
   v8V4rm7fPt3cjiei6WENpy4s63aKA5Uztp5vhFryQx6K8wgvbn6tzk5RE
   VrsSB+/glLt+FXFG7vqmC8C2L1FXdqEYeAr8LqHnCQ2dh/MBb7tudTEGc
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10560"; a="315872302"
X-IronPort-AV: E=Sophos;i="5.96,242,1665471600"; 
   d="scan'208";a="315872302"
Received: from orsmga003.jf.intel.com ([10.7.209.27])
  by fmsmga102.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Dec 2022 12:40:34 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10560"; a="598929834"
X-IronPort-AV: E=Sophos;i="5.96,242,1665471600"; 
   d="scan'208";a="598929834"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
  by orsmga003.jf.intel.com with ESMTP; 13 Dec 2022 12:40:29 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p5C4i-0004lr-2P;
        Tue, 13 Dec 2022 20:40:28 +0000
Date:   Wed, 14 Dec 2022 04:40:24 +0800
...
Subject: Re: [PATCH 4/4] soc: imx: imx8mp-blk-ctrl: expose high performance
 PLL clock
Message-ID: <202212140421.k5Qj6UGm-lkp@intel.com>
References: <20221213160112.1900410-4-l.stach@pengutronix.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="XomnLcVQQQ6ActVL"
...
[also build test WARNING on shawnguo/for-next krzk/for-next krzk-dt/for-next linus/master v6.1 next-20221213]
...
All warnings (new ones prefixed by >>):
   ...
   drivers/soc/imx/imx8mp-blk-ctrl.c: In function 'clk_hsio_pll_prepare':
   drivers/soc/imx/imx8mp-blk-ctrl.c:105:28: error: implicit declaration of function 'FIELD_PREP' [-Werror=implicit-function-declaration]
     105 |                            FIELD_PREP(P_PLL_MASK, 12) |
         |                            ^~~~~~~~~~
   drivers/soc/imx/imx8mp-blk-ctrl.c: At top level:
>> drivers/soc/imx/imx8mp-blk-ctrl.c:146:5: warning: no previous prototype for 'imx8mp_hsio_blk_ctrl_probe' [-Wmissing-prototypes]
