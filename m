...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3A97A44EA60
	for <lists+devicetree@lfdr.de>; Fri, 12 Nov 2021 16:36:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235362AbhKLPjh (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 12 Nov 2021 10:39:37 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56982 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235364AbhKLPjF (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 12 Nov 2021 10:39:05 -0500
Received: from mail-wm1-x32b.google.com (mail-wm1-x32b.google.com [IPv6:2a00:1450:4864:20::32b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D05BCC06121D;
        Fri, 12 Nov 2021 07:36:12 -0800 (PST)
Received: by mail-wm1-x32b.google.com with SMTP id y84-20020a1c7d57000000b00330cb84834fso10180795wmc.2;
        Fri, 12 Nov 2021 07:36:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=wL7L0zM+ReIseP46K3nvlZUucTcfqTz6dCmuGO1pTzA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=wL7L0zM+ReIseP46K3nvlZUucTcfqTz6dCmuGO1pTzA=;
        b=
X-Gm-Message-State: AOAM531K79ZWIJyODbicoMYm8+mxPHCHpIZJqtbP0rZCPsaAoeRvcQVG
        IqWCgW1Y2qKzfd8525S4NQAQlsAMXIU=
X-Google-Smtp-Source: ABdhPJz8onwLSFdn5Os0pQ8royLNYvknWj9Qy/pIsXOl1hMo5Nj8dcyiLl9qEJ7xn/QcCeTE8ex6Bg==
X-Received: by 2002:a05:600c:21c3:: with SMTP id x3mr17878169wmj.13.1636731371113;
        Fri, 12 Nov 2021 07:36:11 -0800 (PST)
Received: from Ansuel-xps.localdomain (93-42-71-246.ip85.fastwebnet.it. [93.42.71.246])
        by smtp.googlemail.com with ESMTPSA id az4sm4217543wmb.20.2021.11.12.07.36.09
...
Subject: [PATCH v5 7/8] net: dsa: qca8k: add LEDs support
Date:   Fri, 12 Nov 2021 16:35:56 +0100
Message-Id: <20211112153557.26941-8-ansuelsmth@gmail.com>
...
index 7b1457a6e327..1e59ee50ec92 100644
--- a/drivers/net/dsa/Kconfig
+++ b/drivers/net/dsa/Kconfig
@@ -67,6 +67,17 @@ config NET_DSA_QCA8K
...
+	select LEDS_TRIGGER_HARDWARE_PHY_ACTIVITY
+	help
+	  This enables support for LEDs present on the Qualcomm Atheros
+	  QCA8K Ethernet switch chips. This requires the LEDs offload
