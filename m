...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 619E761A2DC
	for <lists+devicetree@lfdr.de>; Fri,  4 Nov 2022 22:05:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229681AbiKDVFT (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 4 Nov 2022 17:05:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54294 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229745AbiKDVFR (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 4 Nov 2022 17:05:17 -0400
Received: from mail-oa1-f44.google.com (mail-oa1-f44.google.com [209.85.160.44])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D18D343871
        for <devicetree@vger.kernel.org>; Fri,  4 Nov 2022 14:05:14 -0700 (PDT)
Received: by mail-oa1-f44.google.com with SMTP id 586e51a60fabf-12c8312131fso6849765fac.4
        for <devicetree@vger.kernel.org>; Fri, 04 Nov 2022 14:05:14 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=date:subject:message-id:references:in-reply-to:cc:to:from
         :mime-version:content-transfer-encoding:x-gm-message-state:from:to
         :cc:subject:date:message-id:reply-to;
        bh=hg1TBATTi5v9B+ws/Alt/sU+yuqFZ9MD4lnIOY19fu4=;
        b=
X-Gm-Message-State: ACrzQf3zTDytNYCRGhhE06yk+ODAzKl9NnLDbx82OpkTcrTdqZjCzPb8
        5Acm1gAiet/sqz6QeC+qHw==
X-Google-Smtp-Source: AMsMyM5v6dMqxlurpOOzkTE9k9BOkPA3+mnUjnedL06ymsDh0955h2zpN2/qQn00B5rNi0Bct1OWXA==
X-Received: by 2002:a05:6870:460f:b0:13b:c839:e5c8 with SMTP id z15-20020a056870460f00b0013bc839e5c8mr31398861oao.137.1667595913934;
        Fri, 04 Nov 2022 14:05:13 -0700 (PDT)
Received: from robh_at_kernel.org (66-90-144-107.dyn.grandenetworks.net. [66.90.144.107])
        by smtp.gmail.com with ESMTPSA id n18-20020a056870a45200b00130e66a7644sm38093oal.25.2022.11.04.14.05.12
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 04 Nov 2022 14:05:13 -0700 (PDT)
Received: (nullmailer pid 2799519 invoked by uid 1000);
        Fri, 04 Nov 2022 21:05:15 -0000
...
Message-Id: <166759567170.2791628.16497393111855269961.robh@kernel.org>
Subject: Re: [RFC][PATCH v3 1/3] dt-bindings: imx6q-pcie: Handle various clock
 configurations
Date:   Fri, 04 Nov 2022 16:05:15 -0500
...
On Fri, 04 Nov 2022 18:04:15 +0100, Marek Vasut wrote:
...
pcie@33800000: clock-names: ['pcie', 'pcie_aux', 'pcie_phy', 'pcie_bus'] is too long
	arch/arm64/boot/dts/freescale/imx8mq-evk.dtb
	arch/arm64/boot/dts/freescale/imx8mq-kontron-pitx-imx8m.dtb
	arch/arm64/boot/dts/freescale/imx8mq-tqma8mq-mba8mx.dtb
	arch/arm64/boot/dts/freescale/imx8mq-zii-ultra-rmb3.dtb
...
pcie@33c00000: clock-names: ['pcie', 'pcie_aux', 'pcie_phy', 'pcie_bus'] is too long
	arch/arm64/boot/dts/freescale/imx8mq-evk.dtb
	arch/arm64/boot/dts/freescale/imx8mq-kontron-pitx-imx8m.dtb
	arch/arm64/boot/dts/freescale/imx8mq-mnt-reform2.dtb
	arch/arm64/boot/dts/freescale/imx8mq-tqma8mq-mba8mx.dtb
...
pcie@8ffc000: clock-names: ['pcie', 'pcie_bus', 'pcie_phy', 'pcie_inbound_axi'] is too long
