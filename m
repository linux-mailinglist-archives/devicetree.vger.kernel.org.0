...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8AE31496529
	for <lists+devicetree@lfdr.de>; Fri, 21 Jan 2022 19:37:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1352069AbiAUShi (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 21 Jan 2022 13:37:38 -0500
Received: from finn.gateworks.com ([108.161.129.64]:48802 "EHLO
        finn.localdomain" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1346158AbiAUShg (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 21 Jan 2022 13:37:36 -0500
Received: from 068-189-091-139.biz.spectrum.com ([68.189.91.139] helo=tharvey.pdc.gateworks.com)
        by finn.localdomain with esmtp (Exim 4.93)
        (envelope-from <tharvey@gateworks.com>)
        id 1nAyVD-00A3Dc-66; Fri, 21 Jan 2022 18:19:11 +0000
...
Subject: [PATCH] arm64: dts: imx8mm-venice-gw72xx-0x: add dt overlay for imx219 rpi v2 camera
Date:   Fri, 21 Jan 2022 10:19:09 -0800
Message-Id: <20220121181909.13727-1-tharvey@gateworks.com>
...
---
 ...
 .../imx8mm-venice-gw72xx-0x-imx219.dts        | 84 +++++++++++++++++++
 2 files changed, 85 insertions(+)
 create mode 100644 arch/arm64/boot/dts/freescale/imx8mm-venice-gw72xx-0x-imx219.dts

diff --git a/arch/arm64/boot/dts/freescale/Makefile b/arch/arm64/boot/dts/freescale/Makefile
index 324c1b01989a..08d1f28a5165 100644
--- a/arch/arm64/boot/dts/freescale/Makefile
+++ b/arch/arm64/boot/dts/freescale/Makefile
@@ -43,6 +43,7 @@ dtb-$(CONFIG_ARCH_MXC) += imx8mm-nitrogen-r2.dtb
 dtb-$(CONFIG_ARCH_MXC) += imx8mm-var-som-symphony.dtb
 dtb-$(CONFIG_ARCH_MXC) += imx8mm-venice-gw71xx-0x.dtb
 dtb-$(CONFIG_ARCH_MXC) += imx8mm-venice-gw72xx-0x.dtb
+dtb-$(CONFIG_ARCH_MXC) += imx8mm-venice-gw72xx-0x-imx219.dtbo
...
index 000000000000..6fbae90735d4
--- /dev/null
