...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 903512D1CBC
	for <lists+devicetree@lfdr.de>; Mon,  7 Dec 2020 23:07:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727556AbgLGWFb (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 7 Dec 2020 17:05:31 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55030 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725799AbgLGWFa (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 7 Dec 2020 17:05:30 -0500
Received: from mail-ot1-x342.google.com (mail-ot1-x342.google.com [IPv6:2607:f8b0:4864:20::342])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 52DC8C06179C;
        Mon,  7 Dec 2020 14:04:50 -0800 (PST)
Received: by mail-ot1-x342.google.com with SMTP id h18so10057030otq.12;
        Mon, 07 Dec 2020 14:04:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=oTOogPziojRwILiSR772n5ZnxP6esLrWgsnWYEYIfck=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=oTOogPziojRwILiSR772n5ZnxP6esLrWgsnWYEYIfck=;
        b=
X-Gm-Message-State: AOAM530qxyfAjG8dOKEJKk+FAHw5yNeXcLypFSFM6t9qXBPDMYHA7cVn
        In2eoW60aEgWEsINGNoPig==
X-Google-Smtp-Source: ABdhPJy4yCg5p9eBLHA5MZ2HqRlTXOoo2xjswy8tnuKC9MujcwSxiKhdI0BaOj70+iww6vG5u3MO4A==
X-Received: by 2002:a9d:6c44:: with SMTP id g4mr14161315otq.246.1607378689465;
        Mon, 07 Dec 2020 14:04:49 -0800 (PST)
Received: from threadripper.novatech-llc.local ([216.21.169.52])
        by smtp.gmail.com with ESMTPSA id g5sm2940472otq.43.2020.12.07.14.04.47
        (version=TLS1_2 cipher=ECDHE-ECDSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 07 Dec 2020 14:04:48 -0800 (PST)
...
Subject: [PATCH net-next v3 2/3] net: dsa: add Arrow SpeedChips XRS700x driver
Date:   Mon,  7 Dec 2020 16:03:54 -0600
Message-Id: <20201207220355.8707-3-george.mccollister@gmail.com>
...
new file mode 100644
index 000000000000..9d09b816f8eb
--- /dev/null
...
+}
+
+static void xrs700x_getstats64(struct dsa_switch *ds, int port,
...
+	.get_stats64		= xrs700x_getstats64,
