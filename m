...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 27F7864F537
	for <lists+devicetree@lfdr.de>; Sat, 17 Dec 2022 00:37:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230052AbiLPXhy (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 16 Dec 2022 18:37:54 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59258 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230060AbiLPXhw (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 16 Dec 2022 18:37:52 -0500
Received: from mga17.intel.com (mga17.intel.com [192.55.52.151])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 55E1C102;
        Fri, 16 Dec 2022 15:37:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1671233869; x=1702769869;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=8A9hDQOcePrF9df8vS8wTss+cs7fKhpR9VB2Iec+s/k=;
  b=g9y1Kod7HMgoiI8Z7X0NnAJ6tVw1Bey+AJrPkWOK40WS7GGRSGxOauTo
   THGDjOvJH8OZlORNaO3rUOJdOL/D+idA9pDzYsWArrf+d6iQOr3xe5/qF
   PWVs9mrt7UOvwODV9IvM2fxSyZ3gO9wQBZmPu68QvHbXVbjkuYQPqOs/9
   9Q04W6a9zLGoF62GdQCowiG0adPqeW5yhIGbr3ef0Vykvu+JxgoVQ+sCm
   /96Uzi3cYvLCMvrS4PWOFCBmnPwB5XgV++OEUm3sIcBszkyPd2s9orejE
   b8AEL9FsOsEmFpqAVJ2iBwMOdkj1lopRhAIcPqwipxZ/xaIMekDtvHVJQ
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10563"; a="299411918"
X-IronPort-AV: E=Sophos;i="5.96,251,1665471600"; 
   d="scan'208";a="299411918"
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga107.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Dec 2022 15:37:48 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10563"; a="718524522"
X-IronPort-AV: E=Sophos;i="5.96,251,1665471600"; 
   d="scan'208";a="718524522"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
  by fmsmga004.fm.intel.com with ESMTP; 16 Dec 2022 15:37:45 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p6KGv-0007TE-0Z;
        Fri, 16 Dec 2022 23:37:45 +0000
Date:   Sat, 17 Dec 2022 07:37:05 +0800
...
Subject: Re: [PATCH 2/2] clk: si521xx: Clock driver for Skyworks Si521xx I2C
 PCIe clock generators
Message-ID: <202212170724.OY3WYsAg-lkp@intel.com>
References: <20221216212158.600220-2-marex@denx.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="DOx7XyX5M8uLIIBD"
Content-Disposition: inline
In-Reply-To: <20221216212158.600220-2-marex@denx.de>
...
url:    https://github.com/intel-lab-lkp/linux/commits/Marek-Vasut/dt-bindings-clk-si521xx-Add-Skyworks-Si521xx-I2C-PCIe-clock-generators/20221217-052230
base:   https://git.kernel.org/pub/scm/linux/kernel/git/clk/linux.git clk-next
patch link:    https://lore.kernel.org/r/20221216212158.600220-2-marex%40denx.de
patch subject: [PATCH 2/2] clk: si521xx: Clock driver for Skyworks Si521xx I2C PCIe clock generators
config: s390-allmodconfig
compiler: s390-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/ff54f4a6ecbd12c7aa14713e861a29ddb4e2ca0c
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Marek-Vasut/dt-bindings-clk-si521xx-Add-Skyworks-Si521xx-I2C-PCIe-clock-generators/20221217-052230
        git checkout ff54f4a6ecbd12c7aa14713e861a29ddb4e2ca0c
...
All errors (new ones prefixed by >>):
   ...
   drivers/clk/clk-si521xx.c: In function 'si521xx_get_common_config':
>> drivers/clk/clk-si521xx.c:37:9: error: implicit declaration of function 'FIELD_PREP' [-Werror=implicit-function-declaration]
      37 |         FIELD_PREP(SI521XX_REG_DA_AMP_MASK,     \
         |         ^~~~~~~~~~
   drivers/clk/clk-si521xx.c:225:29: note: in expansion of macro 'SI521XX_REG_DA_AMP'
     225 |         si->pll_amplitude = SI521XX_REG_DA_AMP(SI521XX_REG_DA_AMP_DEFAULT);
         |                             ^~~~~~~~~~~~~~~~~~
   cc1: some warnings being treated as errors


vim +/FIELD_PREP +37 drivers/clk/clk-si521xx.c
