...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 175222CD375
	for <lists+devicetree@lfdr.de>; Thu,  3 Dec 2020 11:30:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388676AbgLCK2j (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 3 Dec 2020 05:28:39 -0500
Received: from mailout07.rmx.de ([94.199.90.95]:58146 "EHLO mailout07.rmx.de"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727431AbgLCK2j (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Thu, 3 Dec 2020 05:28:39 -0500
Received: from kdin02.retarus.com (kdin02.dmz1.retloc [172.19.17.49])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mailout07.rmx.de (Postfix) with ESMTPS id 4CmsVD71gMzBvJV;
        Thu,  3 Dec 2020 11:27:48 +0100 (CET)
Received: from mta.arri.de (unknown [217.111.95.66])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-SHA384 (256/256 bits))
        (No client certificate requested)
        by kdin02.retarus.com (Postfix) with ESMTPS id 4CmsTQ22KDz2TT8N;
...
Subject: [PATCH net-next v5 8/9] net: dsa: microchip: ksz9477: remaining hardware time stamping support
Date:   Thu, 3 Dec 2020 11:21:16 +0100
Message-ID: <20201203102117.8995-9-ceggers@arri.de>
...
X-RMX-ID: 20201203-112706-nxPrhMsspQQF-0@out02.hq
...
Peer delay messages have never been forwarded.
 ...
 8 files changed, 679 insertions(+), 24 deletions(-)
...
index 0ade40bf27c7..a7ec86873277 100644
--- a/drivers/net/dsa/microchip/ksz9477_main.c
+++ b/drivers/net/dsa/microchip/ksz9477_main.c
@@ -1410,7 +1410,7 @@ static const struct dsa_switch_ops ksz9477_switch_ops = {
...
@@ -1537,6 +1537,7 @@ static const struct ksz_chip_data ksz9477_switch_chips[] = {
