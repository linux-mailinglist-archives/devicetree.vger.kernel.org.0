...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BBD7C76045D
	for <lists+devicetree@lfdr.de>; Tue, 25 Jul 2023 02:53:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229793AbjGYAxe (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 24 Jul 2023 20:53:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39652 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230453AbjGYAxd (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 24 Jul 2023 20:53:33 -0400
Received: from pidgin.makrotopia.org (pidgin.makrotopia.org [185.142.180.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8CCB5171E;
        Mon, 24 Jul 2023 17:53:20 -0700 (PDT)
Received: from local
        by pidgin.makrotopia.org with esmtpsa (TLS1.3:TLS_AES_256_GCM_SHA384:256)
         (Exim 4.96)
        (envelope-from <daniel@makrotopia.org>)
        id 1qO6IV-0004VU-1X;
        Tue, 25 Jul 2023 00:53:07 +0000
...
Subject: [PATCH net-next v6 6/8] net: ethernet: mtk_eth_soc: add NETSYS_V3
 version support
Message-ID: <0db2260910755d76fa48e303b9f9bdf4e5a82340.1690246066.git.daniel@makrotopia.org>
...
index 1bd570881a0f0..0ddeb3fb95d49 100644
...
@@ -4351,7 +4396,11 @@ static int mtk_add_mac(struct mtk_eth *eth, struct device_node *np)
 	}
