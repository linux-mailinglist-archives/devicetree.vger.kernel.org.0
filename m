...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BE22929740D
	for <lists+devicetree@lfdr.de>; Fri, 23 Oct 2020 18:34:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1750682AbgJWQdd (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 23 Oct 2020 12:33:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48882 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S465674AbgJWQdP (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 23 Oct 2020 12:33:15 -0400
Received: from mail-wr1-x443.google.com (mail-wr1-x443.google.com [IPv6:2a00:1450:4864:20::443])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 82280C0613CE;
        Fri, 23 Oct 2020 09:33:14 -0700 (PDT)
Received: by mail-wr1-x443.google.com with SMTP id i1so2706201wro.1;
        Fri, 23 Oct 2020 09:33:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=8t9hqQpD56vzXt+ucGs4HMLV57vq4fKx2r0BhLhDtSU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8t9hqQpD56vzXt+ucGs4HMLV57vq4fKx2r0BhLhDtSU=;
        b=
X-Gm-Message-State: AOAM530Ph65+WS8s7by6bFR01AkajLVEDA3DzqCebXhSDqDahBzT6ga5
        QgEkFWE88Tb4e8LFTBowjRjzSv6Au5Pt2/ir
X-Google-Smtp-Source: ABdhPJx1GU9ghJrUfOx/DqHuiQJaxbFCJxXXHLfO0IkSyTy5jfpphsFp6ryWgmLwYNnePUd2gtHEOg==
X-Received: by 2002:adf:80cb:: with SMTP id 69mr3452077wrl.325.1603470792886;
        Fri, 23 Oct 2020 09:33:12 -0700 (PDT)
Received: from IcarusMOD.eternityproject.eu ([2.237.20.237])
        by smtp.gmail.com with ESMTPSA id u15sm4334808wrm.77.2020.10.23.09.33.11
...
Subject: [PATCH v6 2/3] Input: Add Novatek NT36xxx touchscreen driver
Date:   Fri, 23 Oct 2020 18:32:55 +0200
Message-Id: <20201023163256.96000-3-kholk11@gmail.com>
...
+		return ret;
+
+	ts->fw_info.nvt_pid = be16_to_cpu(buf);
+	return 0;
+}
+
+/**
