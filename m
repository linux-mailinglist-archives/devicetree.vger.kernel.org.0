...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3A210776803
	for <lists+devicetree@lfdr.de>; Wed,  9 Aug 2023 21:11:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232531AbjHITLp (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 9 Aug 2023 15:11:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49188 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232518AbjHITLm (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 9 Aug 2023 15:11:42 -0400
Received: from mx0b-001ae601.pphosted.com (mx0a-001ae601.pphosted.com [67.231.149.25])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9C76F2125;
        Wed,  9 Aug 2023 12:11:39 -0700 (PDT)
Received: from pps.filterd (m0077473.ppops.net [127.0.0.1])
        by mx0a-001ae601.pphosted.com (8.17.1.22/8.17.1.22) with ESMTP id 379BdcDt030001;
        Wed, 9 Aug 2023 14:10:47 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=cirrus.com; h=
        from:to:cc:subject:date:message-id:in-reply-to:references
        :mime-version:content-transfer-encoding:content-type; s=
        PODMain02222019; bh=vWFFLBAHxfp+/0bOJ0MC8abqwRxTo+aatTugYyk9FGE=; b=
        
Received: from ediex02.ad.cirrus.com ([84.19.233.68])
        by mx0a-001ae601.pphosted.com (PPS) with ESMTPS id 3sb7vtax66-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 09 Aug 2023 14:10:47 -0500 (CDT)
...
Received: from aus-sw-rshr002.ad.cirrus.com (141.131.215.158) by
 ...
 15.2.1118.30 via Frontend Transport; Wed, 9 Aug 2023 20:10:44 +0100
Received: by aus-sw-rshr002.ad.cirrus.com (Postfix, from userid 46936)
        id 8E5AE4C0CD1; Wed,  9 Aug 2023 19:10:43 +0000 (UTC)
...
Subject: [PATCH v3 2/2] Input: cs40l50 - Initial support for Cirrus Logic CS40L50
Date:   Wed, 9 Aug 2023 19:10:28 +0000
Message-ID: <20230809191032.820271-3-james.ogletree@cirrus.com>
...
X-Proofpoint-GUID: aVS12ZwJU-BNevlPKLardZoaUnYeZMf_
X-Proofpoint-ORIG-GUID: aVS12ZwJU-BNevlPKLardZoaUnYeZMf_
