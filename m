...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E89AB39DA35
	for <lists+devicetree@lfdr.de>; Mon,  7 Jun 2021 12:53:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231211AbhFGKyi (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 7 Jun 2021 06:54:38 -0400
Received: from comms.puri.sm ([159.203.221.185]:53102 "EHLO comms.puri.sm"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230294AbhFGKyh (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Mon, 7 Jun 2021 06:54:37 -0400
Received: from localhost (localhost [127.0.0.1])
        by comms.puri.sm (Postfix) with ESMTP id B6A8DE0FB7;
        Mon,  7 Jun 2021 03:52:46 -0700 (PDT)
Received: from comms.puri.sm ([127.0.0.1])
        by localhost (comms.puri.sm [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id iDHDvxVTWDA2; Mon,  7 Jun 2021 03:52:38 -0700 (PDT)
...
Subject: [PATCH v4 3/5] media: i2c: add driver for the SK Hynix Hi-846 8M pixel camera
Date:   Mon,  7 Jun 2021 12:52:11 +0200
Message-Id: <20210607105213.1211722-4-martin.kepplinger@puri.sm>
...
---
 ...
 4 files changed, 2137 insertions(+)
 create mode 100644 drivers/media/i2c/hi846.c

diff --git a/MAINTAINERS b/MAINTAINERS
index a7667b5d0bc6..43ea93e92b0c 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -8517,6 +8517,12 @@ S:	Maintained
...
index 000000000000..87b8007f0557
--- /dev/null
...
+}
+
+static int hi846_init_cfg(struct v4l2_subdev *sd, struct v4l2_subdev_pad_config *cfg)
+{
+	struct hi846 *hi846 = to_hi846(sd);
