...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CF252662031
	for <lists+devicetree@lfdr.de>; Mon,  9 Jan 2023 09:40:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236585AbjAIIks (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 9 Jan 2023 03:40:48 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49614 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231264AbjAIIk3 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 9 Jan 2023 03:40:29 -0500
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3627C13F2C;
        Mon,  9 Jan 2023 00:40:25 -0800 (PST)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 45A0C60F52;
        Mon,  9 Jan 2023 08:40:25 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 35ABDC433EF;
        Mon,  9 Jan 2023 08:40:21 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1673253624;
        bh=U5DKoW+OPM3RonaccyqE/mk6gVZ2dhwMoQvYw4BqN6k=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Mon, 9 Jan 2023 16:40:16 +0800
...
Subject: Re: [PATCH v2 5/5] arm64: dts: freescale: add initial support for
 apalis imx8 aka quadmax
Message-ID: <20230109084014.GH18301@T480>
References: <20230102171023.33853-1-marcel@ziswiler.com>
 <20230102171023.33853-6-marcel@ziswiler.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20230102171023.33853-6-marcel@ziswiler.com>
...
On Mon, Jan 02, 2023 at 06:10:22PM +0100, Marcel Ziswiler wrote:
...
>  12 files changed, 2576 insertions(+)
...
It's too much for a single patch.  Can you split it a bit to make the
...
Can this be put after `compatible`?
...
The identical atmel_mxt_ts seems to appear for 3 times.  Don't you have
a .dtsi to save such duplications?
...
Can we use the following indent style?
...
Did you run DT schema check?  It doesn't seem to match pattern
"(^led-[0-9a-f]$|led)"?
...
> new file mode 100644
> index 000000000000..a0cc1b4c135d
> --- /dev/null
