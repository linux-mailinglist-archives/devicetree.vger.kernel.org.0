...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C13826035A7
	for <lists+devicetree@lfdr.de>; Wed, 19 Oct 2022 00:11:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229717AbiJRWLP (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 18 Oct 2022 18:11:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39806 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229779AbiJRWLO (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 18 Oct 2022 18:11:14 -0400
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D721D25F1;
        Tue, 18 Oct 2022 15:11:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666131068; x=1697667068;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=70qYwBUtVQ0XDIE1STVEhqbxh19Cm5ppVcFqbIjd7Xg=;
  b=hfcDbB6BUNpPk89tONNIE0JpuoeAHqI+0druVPf25Q8IFSSbykellxXf
   DpqHDyUvpITQvTIJnXIOW00398eSR1tyMNpMahnaqWk0OwRmf3ZHYd92+
   DuastKrvSknxaSbIgXZSsLcEuQ7F3hi11pp+zdV+SecC0eDIV/aet9fQ5
   OmbO/C06ycNZTxYyBmLop0OFAOIIC+Wjaeu3mC9Gz8qB8FWVaL+ONZbm2
   DLAxcL3WwCm6QPKgkc5AQvVnLEKpcW+Y4t8qtnxjPOIu+RitXd0GBJiwn
   kgUa1nRaL3ula7og1ewMoLIF6QNqEM6AvEjKw3uxyMtCGT4s/sC9CsAZK
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10504"; a="293642578"
X-IronPort-AV: E=Sophos;i="5.95,194,1661842800"; 
   d="scan'208";a="293642578"
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Oct 2022 15:11:07 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10504"; a="958006380"
X-IronPort-AV: E=Sophos;i="5.95,194,1661842800"; 
   d="scan'208";a="958006380"
Received: from lkp-server01.sh.intel.com (HELO 8381f64adc98) ([10.239.97.150])
  by fmsmga005.fm.intel.com with ESMTP; 18 Oct 2022 15:11:04 -0700
Received: from kbuild by 8381f64adc98 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1okunf-00027H-1U;
        Tue, 18 Oct 2022 22:11:03 +0000
Date:   Wed, 19 Oct 2022 06:10:20 +0800
...
Message-ID: <202210190553.EgHCi9q5-lkp@intel.com>
References: <20221014221138.7552-4-quic_molvera@quicinc.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="jCUBuhWma/rFIrru"
...
url:    https://github.com/intel-lab-lkp/linux/commits/Melody-Olvera/dt-bindings-arm-qcom-Document-QDU1000-QRU1000-SoCs-and-boards/20221017-130730
base:   https://git.kernel.org/pub/scm/linux/kernel/git/robh/linux.git for-next
patch link:    https://lore.kernel.org/r/20221014221138.7552-4-quic_molvera%40quicinc.com
patch subject: [PATCH v2 3/3] arm64: dts: qcom: Add base QDU1000/QRU1000 IDP DTs
config: arm64-allyesconfig
compiler: aarch64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/713803878765e4e2e8e7801441d9b3094a89316f
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Melody-Olvera/dt-bindings-arm-qcom-Document-QDU1000-QRU1000-SoCs-and-boards/20221017-130730
        git checkout 713803878765e4e2e8e7801441d9b3094a89316f
...
All errors (new ones prefixed by >>):
   ...
   In file included from arch/arm64/boot/dts/qcom/qdu1000-idp.dts:9:
>> arch/arm64/boot/dts/qcom/qdu1000.dtsi:7:10: fatal error: dt-bindings/clock/qcom,gcc-qdu1000.h: No such file or directory
       7 | #include <dt-bindings/clock/qcom,gcc-qdu1000.h>
         |          ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   compilation terminated.


vim +7 arch/arm64/boot/dts/qcom/qdu1000.dtsi

ea267b70bd037f9 Melody Olvera 2022-10-14  @7  #include <dt-bindings/clock/qcom,gcc-qdu1000.h>
ea267b70bd037f9 Melody Olvera 2022-10-14   8  #include <dt-bindings/clock/qcom,rpmh.h>
ea267b70bd037f9 Melody Olvera 2022-10-14   9  #include <dt-bindings/dma/qcom-gpi.h>
ea267b70bd037f9 Melody Olvera 2022-10-14  10  #include <dt-bindings/interconnect/qcom,qdu1000.h>
ea267b70bd037f9 Melody Olvera 2022-10-14  11  #include <dt-bindings/power/qcom-rpmpd.h>
ea267b70bd037f9 Melody Olvera 2022-10-14  12  #include <dt-bindings/soc/qcom,rpmh-rsc.h>
ea267b70bd037f9 Melody Olvera 2022-10-14  13  
...
CONFIG_LSM="landlock,lockdown,yama,loadpin,safesetid,selinux,smack,tomoyo,apparmor,bpf,integrity"
