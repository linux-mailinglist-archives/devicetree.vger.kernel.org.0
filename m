...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 22340596056
	for <lists+devicetree@lfdr.de>; Tue, 16 Aug 2022 18:34:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229861AbiHPQck (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 16 Aug 2022 12:32:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33160 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235775AbiHPQcS (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 16 Aug 2022 12:32:18 -0400
Received: from mga01.intel.com (mga01.intel.com [192.55.52.88])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2E79F8053B;
        Tue, 16 Aug 2022 09:32:13 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1660667533; x=1692203533;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=OPil3XlFqaBBvcrxGsR2bDtjyxZIxvYLxXI3Mfhp6eY=;
  b=UQjrENTJ5Qrfvp1+VkB9i1gw2v6cETToZRdgC2to2Dcdks2WA6xLAdTv
   nbBWbE3YyxYsKEZkVZE4ki6baZ1Gbm7mroMATpK/oc75U+ZN/5tdRvYCL
   uGZVJHWFK/1H+Zn3xS2ifQpxQqOnX1IVvflPqqYMYgSK5rU6Q4/sJdmQN
   d3rRJ2eN0Snrn6zhp9wbigNmF528/XI4ShuxbT/I3kSKYz9WtS6VZH4cf
   wkNe1pGOxjgCTKbuhnOUxl3yS1hFY12OfOKP1ZzqrWPabZ89YSBpm56DC
   FZtnPSdCCbuJak6eiobpLEDc+KKxo9QvW/Ura+aqaqW29Q7Yn8zbnEzkI
   g==;
X-IronPort-AV: E=McAfee;i="6400,9594,10441"; a="318267575"
X-IronPort-AV: E=Sophos;i="5.93,241,1654585200"; 
   d="scan'208";a="318267575"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by fmsmga101.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 16 Aug 2022 09:32:02 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.93,241,1654585200"; 
   d="scan'208";a="640101326"
Received: from lkp-server02.sh.intel.com (HELO 81d7e1ade3ba) ([10.239.97.151])
  by orsmga001.jf.intel.com with ESMTP; 16 Aug 2022 09:31:57 -0700
Received: from kbuild by 81d7e1ade3ba with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1oNzTx-00004u-0L;
        Tue, 16 Aug 2022 16:31:57 +0000
Date:   Wed, 17 Aug 2022 00:31:53 +0800
From:   kernel test robot <lkp@intel.com>
To:     George Mois <george.mois@analog.com>, jic23@kernel.org,
        robh+dt@kernel.org, krzysztof.kozlowski+dt@linaro.org,
        linux-iio@vger.kernel.org, devicetree@vger.kernel.org,
        linux-kernel@vger.kernel.org
Cc:     kbuild-all@lists.01.org, lucas.p.stankus@gmail.com,
        George Mois <george.mois@analog.com>
Subject: Re: [PATCH 2/2] drivers: iio: accel adxl312 and adxl314 support
Message-ID: <202208170045.5ZKKQgdR-lkp@intel.com>
References: <20220816102828.182345-3-george.mois@analog.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="bl95IbQaAHoJScPz"
...
config: parisc-buildonly-randconfig-r004-20220815
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=parisc SHELL=/bin/bash drivers/iio/accel/
...
All errors (new ones prefixed by >>):
   ...
   drivers/iio/accel/adxl313_i2c.c: In function 'adxl313_i2c_probe':
>> drivers/iio/accel/adxl313_i2c.c:36:63: error: passing argument 3 of 'adxl313_core_probe' from incompatible pointer type [-Werror=incompatible-pointer-types]
      36 |         return adxl313_core_probe(&client->dev, regmap, client->name, NULL);
         |                                                         ~~~~~~^~~~~~
         |                                                               |
         |                                                               char *
   In file included from drivers/iio/accel/adxl313_i2c.c:15:
   drivers/iio/accel/adxl313.h:63:52: note: expected 'const struct spi_device_id *' but argument is of type 'char *'
      63 |                        const struct spi_device_id *id,
         |                        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~^~
   cc1: some warnings being treated as errors


vim +/adxl313_core_probe +36 drivers/iio/accel/adxl313_i2c.c
