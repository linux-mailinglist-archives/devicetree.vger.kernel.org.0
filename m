...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B307F49AFF9
	for <lists+devicetree@lfdr.de>; Tue, 25 Jan 2022 10:40:22 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1355566AbiAYJVq (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 25 Jan 2022 04:21:46 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47768 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1456497AbiAYJLm (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 25 Jan 2022 04:11:42 -0500
Received: from mail-pl1-x632.google.com (mail-pl1-x632.google.com [IPv6:2607:f8b0:4864:20::632])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D0442C061A7E;
        Tue, 25 Jan 2022 00:59:23 -0800 (PST)
Received: by mail-pl1-x632.google.com with SMTP id c9so18592810plg.11;
        Tue, 25 Jan 2022 00:59:23 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=yUx4sSQ0RRS1TVlvgPuYa4WmqZUQfWPJUjb0ao2p0wA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=yUx4sSQ0RRS1TVlvgPuYa4WmqZUQfWPJUjb0ao2p0wA=;
        b=
X-Gm-Message-State: AOAM533pwokIO60/7CpePFOi7ILc9ecM87YesU4xxVCHRypV9QLvBJH0
        4CXwk+38ULzdbdrB0ugxUSU=
X-Google-Smtp-Source: ABdhPJyzQQnFvRFh1j63215rO0apWTrYtRyJNiAI30f5mdbTlVI/r3VJ1V0ujPI6+dBPBMHn9GIFJA==
X-Received: by 2002:a17:90b:1e0e:: with SMTP id pg14mr2344157pjb.235.1643101163034;
        Tue, 25 Jan 2022 00:59:23 -0800 (PST)
Received: from localhost.localdomain (61-231-119-59.dynamic-ip.hinet.net. [61.231.119.59])
        by smtp.gmail.com with ESMTPSA id lr7sm2154905pjb.42.2022.01.25.00.59.20
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 25 Jan 2022 00:59:22 -0800 (PST)
...
Subject: [PATCH v13, 2/2] net: Add dm9051 driver
Date:   Tue, 25 Jan 2022 16:58:37 +0800
Message-Id: <20220125085837.10357-3-josright123@gmail.com>
...
index 000000000000..809b47557ca4
--- /dev/null
...
+		return ret;
+
+	/* GPR power-on for the internal phy of the dm9051 chip,
+	 * Note, if this bit is updated from 1 to 0, the whole dm9051 chip registers
+	 * could not be accessed within 1 ms
+	 */
...
+	int ret;
+
+	/* GPR power saving of the internal phy, still could access the internal phy
+	 * after this power saving control
+	 */
...
new file mode 100644
index 000000000000..0cee956726f6
--- /dev/null
