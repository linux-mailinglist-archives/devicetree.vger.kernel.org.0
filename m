...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 36D4675DABF
	for <lists+devicetree@lfdr.de>; Sat, 22 Jul 2023 09:43:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231136AbjGVHnM (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 22 Jul 2023 03:43:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56214 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230411AbjGVHmw (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 22 Jul 2023 03:42:52 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 60A3F2727;
        Sat, 22 Jul 2023 00:42:46 -0700 (PDT)
X-UUID: 55ffb1fa286311eeb20a276fd37b9834-20230722
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=U1Jmq8+x2I2RmyufMiI0KXzGLa1E5mJmvZk5SbDMexM=;
        b=DLR8XcNl7uVT2gSUOKZQEZSxyC7qHZEipLsMuj8Kz/P/q5B40mg26U79DWWIwIHamc8uyi8i9E41DMSpuBE0WE6vEV2Ys7QkFOYWwhOnIoB6isH1FPEvDbwEsCuhTYJB/OS75Vr9yBgAP7h0OqnOjYmA4i1a2aUS2nsCS/IUMc0=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.28,REQID:effaf8bf-91f8-4d2e-b342-54bc90e535f9,IP:0,U
        RL:0,TC:0,Content:-5,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Release_Ham,ACTIO
        N:release,TS:90
X-CID-INFO: VERSION:1.1.28,REQID:effaf8bf-91f8-4d2e-b342-54bc90e535f9,IP:0,URL
        :0,TC:0,Content:-5,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Spam_GS981B3D,ACTIO
        N:quarantine,TS:90
X-CID-META: VersionHash:176cd25,CLOUDID:ff29e3dc-dc79-4898-9235-1134b97257a8,B
        ulkID:230722154241X3ZGRO8V,BulkQuantity:0,Recheck:0,SF:19|48|38|29|28|17,T
...
Received: from mtkmbs13n1.mediatek.inc [(172.21.101.193)] by mailgw02.mediatek.com
        ...
        with ESMTP id 1050332544; Sat, 22 Jul 2023 15:42:40 +0800
Received: from mtkmbs13n1.mediatek.inc (172.21.101.193) by
 mtkmbs10n2.mediatek.inc (172.21.101.183) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26; Sat, 22 Jul 2023 15:42:39 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkmbs13n1.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.2.1118.26 via Frontend Transport; Sat, 22 Jul 2023 15:42:38 +0800
...
Subject: [PATCH v7,07/11] media: mediatek: vcodec: separate struct 'mtk_vcodec_ctx'
Date:   Sat, 22 Jul 2023 15:42:26 +0800
Message-ID: <20230722074230.30558-8-yunfei.dong@mediatek.com>
...
---
 .../mediatek/vcodec/mtk_vcodec_cmn_drv.h      |  76 +++++
 ...
 .../mediatek/vcodec/mtk_vcodec_dec_drv.h      | 156 ++++++++++
 ...
 .../mediatek/vcodec/mtk_vcodec_enc_drv.h      | 148 ++++++++++
 .../mediatek/vcodec/mtk_vcodec_fw_vpu.c       |  35 ++-
 .../mediatek/vcodec/mtk_vcodec_intr.c         |  33 ++-
 .../mediatek/vcodec/mtk_vcodec_intr.h         |   3 +-
 .../mediatek/vcodec/mtk_vcodec_util.c         |  14 +-
 .../mediatek/vcodec/mtk_vcodec_util.h         |  10 +-
 ...
 46 files changed, 688 insertions(+), 516 deletions(-)
 create mode 100644 drivers/media/platform/mediatek/vcodec/mtk_vcodec_cmn_drv.h
...
index 6957105492ae..95fd51817b8e 100644
...
index 69f0a57650fb..d36a05275f11 100644
...
@@ -194,7 +194,7 @@ static int mtk_vcodec_init_dec_resources(struct mtk_vcodec_dev *dev)
...
@@ -291,7 +291,7 @@ static int fops_vcodec_open(struct file *file)
...
new file mode 100644
index 000000000000..468583a43b7e
--- /dev/null
...
index 4a5b2eca1606..73c25b0c7678 100644
...
index ff250e3be78e..696e9eeb03a2 100644
...
index 346eae2a7ef6..fe1813d72336 100644
...
index f4f278d4bce3..9f9d2425a060 100644
...
index 6b056bafaf94..0b32a7869993 100644
...
index cb222d9d5c17..a557fc5aebef 100644
...
new file mode 100644
index 000000000000..4b0dfa119f27
--- /dev/null
...
index 2cec6b39a884..59970aa51ab2 100644
...
index f4db3f9f135d..05e04050ac89 100644
...
index 6bc822c7d825..05b2548a3854 100644
--- a/drivers/media/platform/mediatek/vcodec/mtk_vcodec_util.h
+++ b/drivers/media/platform/mediatek/vcodec/mtk_vcodec_util.h
@@ -25,7 +25,7 @@ struct mtk_vcodec_fb {
 	dma_addr_t dma_addr;
 };
...
+struct mtk_vcodec_dec_ctx;
 ...
 #undef pr_fmt
@@ -84,13 +84,13 @@ extern int mtk_vcodec_dbg;
...
index 40dd43a4a2d8..10f5b58c7302 100644
...
index 1d4597f28a42..16007b659664 100644
...
index b418db1b3e89..a8b3d1a06d78 100644
