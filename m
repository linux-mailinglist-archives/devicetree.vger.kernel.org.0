...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A535571590A
	for <lists+devicetree@lfdr.de>; Tue, 30 May 2023 10:51:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229870AbjE3Ivb (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 30 May 2023 04:51:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54654 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229972AbjE3Iv3 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 30 May 2023 04:51:29 -0400
Received: from mx07-00178001.pphosted.com (mx08-00178001.pphosted.com [91.207.212.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 64444B2
        for <devicetree@vger.kernel.org>; Tue, 30 May 2023 01:51:27 -0700 (PDT)
Received: from pps.filterd (m0046661.ppops.net [127.0.0.1])
        by mx07-00178001.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 34U8Ri5T011756;
...
Received: from PAXPR10MB4718.EURPRD10.PROD.OUTLOOK.COM (2603:10a6:102:158::12)
 by VI1PR10MB3568.EURPRD10.PROD.OUTLOOK.COM (2603:10a6:800:136::10) with
...
x-forefront-antispam-report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:PAXPR10MB4718.EURPRD10.PROD.OUTLOOK.COM;PTR:;CAT:NONE;SFS:(13230028)(4636009)(39860400002)(366004)(396003)(376002)(136003)(346002)(451199021)(966005)(186003)(38100700002)(41300700001)(83380400001)(9686003)(53546011)(55236004)(6506007)(26005)(7696005)(478600001)(110136005)(54906003)(71200400001)(4326008)(64756008)(66446008)(76116006)(66946007)(66476007)(66556008)(122000001)(55016003)(316002)(52536014)(5660300002)(8936002)(7416002)(2906002)(33656002)(38070700005)(86362001);DIR:OUT;SFP:1101;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 30 May 2023 08:51:02.6072
 (UTC)
...
Theses declarations depend on the coprocessor firmware more than the board =
itself.
All are optional:
...
> +			interrupts =3D <68 IRQ_TYPE_EDGE_RISING>;
> +			mbox-names =3D "vq0", "vq1", "shutdown", "detach";
> +			mboxes =3D <&ipcc 0>, <&ipcc 1>, <&ipcc 2>, <&ipcc
> 3>;
>  			resets =3D <&rcc MCU_R>;
>  			st,syscfg-holdboot =3D <&rcc 0x10C 0x1>;
>  			st,syscfg-tz =3D <&rcc 0x000 0x1>;
