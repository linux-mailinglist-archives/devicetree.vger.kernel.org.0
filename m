...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 01116605F08
	for <lists+devicetree@lfdr.de>; Thu, 20 Oct 2022 13:37:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230163AbiJTLhc (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 20 Oct 2022 07:37:32 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40648 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229587AbiJTLhb (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 20 Oct 2022 07:37:31 -0400
Received: from mail-lj1-x230.google.com (mail-lj1-x230.google.com [IPv6:2a00:1450:4864:20::230])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 210E41DD88F;
        Thu, 20 Oct 2022 04:37:23 -0700 (PDT)
Received: by mail-lj1-x230.google.com with SMTP id h8so25946031lja.11;
        Thu, 20 Oct 2022 04:37:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=in-reply-to:content-disposition:mime-version:references:message-id
         :subject:cc:to:from:date:from:to:cc:subject:date:message-id:reply-to;
        bh=U5/HzHYch3AyboxlwGthLwrYbTNgWg0X4ysslQJ6aIg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=in-reply-to:content-disposition:mime-version:references:message-id
         ...
         :message-id:reply-to;
        bh=U5/HzHYch3AyboxlwGthLwrYbTNgWg0X4ysslQJ6aIg=;
        b=
X-Gm-Message-State: ACrzQf3SVT/qJhP6oHlboKJk/WW2edu8BiYNXLxg6bp07a0adKwE/0cj
        OHa1aLuBiaoZ9BG9PdtQcWU=
X-Google-Smtp-Source: AMsMyM5wg4eopGnAwpqpK68qFIicEn3sDjsT1/QfO4O3+F8qC31VmdY48dVMLuxWkzOqSUPIxLzejQ==
X-Received: by 2002:a2e:bd8b:0:b0:26d:e6a1:9a41 with SMTP id o11-20020a2ebd8b000000b0026de6a19a41mr4477407ljq.204.1666265840940;
        Thu, 20 Oct 2022 04:37:20 -0700 (PDT)
Received: from dc75zzyyyyyyyyyyyyycy-3.rev.dnainternet.fi (dc75zzyyyyyyyyyyyyycy-3.rev.dnainternet.fi. [2001:14ba:16f3:4a00::4])
        by smtp.gmail.com with ESMTPSA id q21-20020a056512211500b00497a7dfe6a9sm2680222lfr.64.2022.10.20.04.37.19
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 20 Oct 2022 04:37:20 -0700 (PDT)
Date:   Thu, 20 Oct 2022 14:37:15 +0300
...
Subject: [PATCH v3 2/3] iio: accel: Support Kionix/ROHM KX022A accelerometer
Message-ID: <5000bd61650554658d13619c8244f02cedbc182a.1666263249.git.mazziesaccount@gmail.com>
References: <cover.1666263249.git.mazziesaccount@gmail.com>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha256;
        protocol="application/pgp-signature"; boundary="We/z66EFCIGIHDwn"
...
index 000000000000..2fdae9f1925e
--- /dev/null
...
ix-kx022a-spi.c
new file mode 100644
index 000000000000..dbb5409d05f3
--- /dev/null
...
x022a.c
new file mode 100644
index 000000000000..d292bc70120d
--- /dev/null
...
+	}
+
+	fw =3D dev_fwnode(dev);
+	if (!fw)
+		return -ENODEV;
+
+	irq =3D fwnode_irq_get_byname(fw, "INT1");
+	if (irq > 0) {
...

=MzQe
-----END PGP SIGNATURE-----
