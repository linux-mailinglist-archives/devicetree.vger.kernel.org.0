...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 173D7132844
	for <lists+devicetree@lfdr.de>; Tue,  7 Jan 2020 15:00:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727658AbgAGOAc (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 7 Jan 2020 09:00:32 -0500
Received: from metis.ext.pengutronix.de ([85.220.165.71]:37973 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728060AbgAGOAc (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 7 Jan 2020 09:00:32 -0500
Received: from pty.hi.pengutronix.de ([2001:67c:670:100:1d::c5])
        by metis.ext.pengutronix.de with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mfe@pengutronix.de>)
        id 1iopPK-00016S-Hb; Tue, 07 Jan 2020 15:00:30 +0100
Received: from mfe by pty.hi.pengutronix.de with local (Exim 4.89)
        (envelope-from <mfe@pengutronix.de>)
        id 1iopPI-0005z7-H8; Tue, 07 Jan 2020 15:00:28 +0100
Date:   Tue, 7 Jan 2020 15:00:28 +0100
...
Subject: Re: [PATCH v10 03/14] media: v4l2-fwnode: add initial connector
 parsing support
Message-ID: <20200107140028.i26s427mymdzehah@pengutronix.de>
References: <20191023105739.GN5433@paasikivi.fi.intel.com>
...
In-Reply-To: <20200107134923.GP19828@paasikivi.fi.intel.com>
X-Sent-From: Pengutronix Hildesheim
X-URL:  http://www.pengutronix.de/
X-IRC:  #ptxdist @freenode
X-Accept-Language: de,en
X-Accept-Content-Type: text/plain
X-Uptime: 14:53:01 up 53 days,  5:11, 47 users,  load average: 0.01, 0.08,
 0.07
