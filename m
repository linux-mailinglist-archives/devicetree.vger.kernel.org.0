...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 16F0D4A30CA
	for <lists+devicetree@lfdr.de>; Sat, 29 Jan 2022 17:44:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1352914AbiA2Qon (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 29 Jan 2022 11:44:43 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54530 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1352844AbiA2Qo2 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 29 Jan 2022 11:44:28 -0500
Received: from mail-pj1-x1029.google.com (mail-pj1-x1029.google.com [IPv6:2607:f8b0:4864:20::1029])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 43E74C06174A;
        Sat, 29 Jan 2022 08:44:27 -0800 (PST)
Received: by mail-pj1-x1029.google.com with SMTP id qe6-20020a17090b4f8600b001b7aaad65b9so3290723pjb.2;
        Sat, 29 Jan 2022 08:44:27 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=UNkb9Ga0G1tC1MnC54BpgmT7mXiBkQRW06TnmE6zr9M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=UNkb9Ga0G1tC1MnC54BpgmT7mXiBkQRW06TnmE6zr9M=;
        b=
X-Gm-Message-State: AOAM532BJ0nSSPeKt4AvXi+Fv4ZLw2Ns2Z/DMaXt/du/KqACaqVfMaJI
        XuXfwuzPMzN5h0o106VbuouFV3z97ZRrkg==
X-Google-Smtp-Source: ABdhPJzfbjC1NS3aoJAnB2c3aYQhhnILmCzyO0c/LmdTaHPloIfXew/bNAW5dRvoRQJpdgKmDeJhGg==
X-Received: by 2002:a17:90a:764f:: with SMTP id s15mr25626748pjl.80.1643474666457;
        Sat, 29 Jan 2022 08:44:26 -0800 (PST)
Received: from localhost.localdomain (111-243-37-162.dynamic-ip.hinet.net. [111.243.37.162])
        by smtp.gmail.com with ESMTPSA id y193sm13770337pfb.7.2022.01.29.08.44.24
...
Subject: [PATCH v16, 2/2] net: Add dm9051 driver
Date:   Sun, 30 Jan 2022 00:43:46 +0800
Message-Id: <20220129164346.5535-3-josright123@gmail.com>
...
index 000000000000..e839fa0472af
--- /dev/null
...
+	if (ret)
+		return ret;
+	ret = regmap_write(db->regmap_dm, DM9051_RCR, db->rcr_all); /* enable rx */
+	if (ret)
+		return ret;
+
...
+	}
+
+	result = regmap_write(db->regmap_dm, DM9051_RCR, db->rcr_all); /* enable rx */
+	if (result)
