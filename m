...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BEC861F71EE
	for <lists+devicetree@lfdr.de>; Fri, 12 Jun 2020 03:53:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726543AbgFLBxE (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 11 Jun 2020 21:53:04 -0400
Received: from mail27.static.mailgun.info ([104.130.122.27]:50981 "EHLO
        mail27.static.mailgun.info" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726321AbgFLBxE (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Thu, 11 Jun 2020 21:53:04 -0400
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1591926769; h=Content-Transfer-Encoding: MIME-Version:
 References: In-Reply-To: Message-Id: Date: Subject: Cc: To: From:
 Sender; bh=m+NDsKcjB06t5KL17cG5MzDsm+VsxUSP+kqTAyBYyKQ=; b=LXSD9H8+NT+St4jbfKApLPvav5o1lFlBSt9Ty5Uy5u4URMF8fU3MEAHZc30zxU8pp4lFjrvJ
 WnA9H6jcvwIdfosBx4cFXfKedPdDXTCQLgDYrRMJQZlPuEALHKghUPrHHveOKDDqRbuhWL7X
 LCDOEA5TpO3lGSGayAWpuECY03U=
X-Mailgun-Sending-Ip: 104.130.122.27
X-Mailgun-Sid: WyI1YmJiNiIsICJkZXZpY2V0cmVlQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org
 (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171]) by
 smtp-out-n04.prod.us-east-1.postgun.com with SMTP id
 5ee2dfee567385e8e71c81ce (version=TLS1.2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256); Fri, 12 Jun 2020 01:52:46
 GMT
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 7676EC4339C; Fri, 12 Jun 2020 01:52:45 +0000 (UTC)
...
Received: from linuxdisplay-lab-04.qualcomm.com (i-global254.qualcomm.com [199.106.103.254])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id 89B3CC433C8;
        Fri, 12 Jun 2020 01:52:15 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org 89B3CC433C8
...
Subject: [PATCH v6 3/5] drm/msm/dp: add displayPort driver support
Date:   Thu, 11 Jun 2020 18:50:28 -0700
Message-Id: <20200612015030.16072-4-tanmay@codeaurora.org>
...
---
 ...
 drivers/gpu/drm/msm/dp/dp_catalog.c           |  999 ++++++++++
 ...
 drivers/gpu/drm/msm/dp/dp_parser.c            |  417 ++++
 drivers/gpu/drm/msm/dp/dp_parser.h            |  207 ++
 drivers/gpu/drm/msm/dp/dp_power.c             |  412 ++++
 drivers/gpu/drm/msm/dp/dp_power.h             |   46 +
 drivers/gpu/drm/msm/dp/dp_reg.h               |  489 +++++
 drivers/gpu/drm/msm/msm_drv.c                 |    2 +
 drivers/gpu/drm/msm/msm_drv.h                 |   53 +-
 27 files changed, 8260 insertions(+), 3 deletions(-)
...
index 63976dcd2ac8..d796710ff4aa 100644
--- a/drivers/gpu/drm/msm/disp/dpu1/dpu_encoder.c
+++ b/drivers/gpu/drm/msm/disp/dpu1/dpu_encoder.c
@@ -988,6 +988,9 @@ static void dpu_encoder_virt_mode_set(struct drm_encoder *drm_enc,
...
+
 	list_for_each_entry(conn_iter, connector_list, head)
 		if (conn_iter->encoder == drm_enc)
 			conn = conn_iter;
@@ -1130,6 +1133,7 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
 {
...
+	struct msm_drm_private *priv;
 	...
 	if (!drm_enc) {
@@ -1140,6 +1144,7 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
...
+	priv = drm_enc->dev->dev_private;
 	...
 	trace_dpu_enc_enable(DRMID(drm_enc), cur_mode->hdisplay,
 			     cur_mode->vdisplay);
@@ -1160,6 +1165,15 @@ static void dpu_encoder_virt_enable(struct drm_encoder *drm_enc)
...
+	}
 ...
 out:
@@ -1192,6 +1206,13 @@ static void dpu_encoder_virt_disable(struct drm_encoder *drm_enc)
...
new file mode 100644
index 000000000000..d02f4eba5d1d
--- /dev/null
...
new file mode 100644
index 000000000000..6ff8b991de07
--- /dev/null
...
new file mode 100644
index 000000000000..58a3d86bc3f2
--- /dev/null
...
new file mode 100644
index 000000000000..a129924aff27
--- /dev/null
...
new file mode 100644
index 000000000000..e1f93f5e69ca
--- /dev/null
...
+const u8 aux_cfg2_settings[] = {0x28, 0x24};
+const u8 aux_cfg3_settings[] = {0x2c, 0x00};
+const u8 aux_cfg4_settings[] = {0x30, 0x0a};
+const u8 aux_cfg5_settings[] = {0x34, 0x26};
+const u8 aux_cfg6_settings[] = {0x38, 0x0a};
+const u8 aux_cfg7_settings[] = {0x3c, 0x03};
+const u8 aux_cfg8_settings[] = {0x40, 0xbb};
+const u8 aux_cfg9_settings[] = {0x44, 0x03};
+
+const u8 *aux_cfg_settings[] = {
+	aux_cfg0_settings,
+	aux_cfg1_settings,
+	aux_cfg2_settings,
+	aux_cfg3_settings,
...
+};
+
+const u8 aux_cfg_settings_size[] = {
+	sizeof(aux_cfg0_settings),
+	sizeof(aux_cfg1_settings),
+	sizeof(aux_cfg2_settings),
+	sizeof(aux_cfg3_settings),
+	sizeof(aux_cfg4_settings),
+	sizeof(aux_cfg5_settings),
+	sizeof(aux_cfg6_settings),
+	sizeof(aux_cfg7_settings),
+	sizeof(aux_cfg8_settings),
+	sizeof(aux_cfg9_settings),
+};
+
...
+
+		data = (const u8 *)of_get_property(of_node, property, &len);
+		if (!data) {
+			DRM_DEBUG_DP("Using default val for %s\n", property);
+			data = aux_cfg_settings[i];
+			len = aux_cfg_settings_size[i];
+		}
+
+		config_count = len - 1;
...
+	if (len < 0) {
+		DRM_ERROR("property %s does not exist or invalid size\n",
+				data_lane_property);
+		return len;
+	}
+
...
new file mode 100644
index 000000000000..b99677f32469
--- /dev/null
...
new file mode 100644
index 000000000000..19a1777a2374
--- /dev/null
...
+	}
+
+	power->pixel_clk_rcg = devm_clk_get(dev, "pixel_rcg");
...
new file mode 100644
index 000000000000..9d24f36c68e5
--- /dev/null
...
index f6ce40bf3699..266de1d081eb 100644
--- a/drivers/gpu/drm/msm/msm_drv.c
+++ b/drivers/gpu/drm/msm/msm_drv.c
@@ -1358,6 +1358,7 @@ static int __init msm_drm_register(void)
 	msm_dsi_register();
 	msm_edp_register();
 	msm_hdmi_register();
+	msm_dp_register();
...
@@ -1366,6 +1367,7 @@ static void __exit msm_drm_unregister(void)
 {
 	DBG("fini");
...
index e2d6a6056418..7be4c4f17fcd 100644
...
@@ -379,6 +381,49 @@ static inline int msm_dsi_modeset_init(struct msm_dsi *msm_dsi,
 }
 #endif
...
@@ -399,8 +444,9 @@ void msm_perf_debugfs_cleanup(struct msm_drm_private *priv);
 #else
...
+			const char *fmt, ...) {}
 ...
 #endif
@@ -418,7 +464,8 @@ struct msm_gpu_submitqueue;
