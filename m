...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 414C92BFC86
	for <lists+devicetree@lfdr.de>; Sun, 22 Nov 2020 23:41:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726827AbgKVWkA (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 22 Nov 2020 17:40:00 -0500
Received: from mail-dm6nam12on2069.outbound.protection.outlook.com ([40.107.243.69]:26720
        "EHLO NAM12-DM6-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726810AbgKVWj5 (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Sun, 22 Nov 2020 17:39:57 -0500
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=k4E4JBrHqd124oTN69EKJQS2bxui42mv0QeeM28LyKE=;
...
Subject: [PATCH 2/2] input: Add support for Azoteq IQS626A
Date:   Sun, 22 Nov 2020 16:39:08 -0600
Message-Id: <1606084748-4097-3-git-send-email-jeff@labundy.com>
...
Received: from localhost.localdomain (136.49.227.119) by SN6PR01CA0017.prod.exchangelabs.com (2603:10b6:805:b6::30) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256) id 15.20.3589.20 via Frontend Transport; Sun, 22 Nov 2020 22:39:45 +0000
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 073b1c25-17e4-48b9-be98-08d88f37831c
X-MS-TrafficTypeDiagnostic: SA2PR08MB6604:
X-MS-Exchange-Transport-Forked: True
X-Microsoft-Antispam-PRVS: <SA2PR08MB66047754251CDC96584912CFD3FD0@SA2PR08MB6604.namprd08.prod.outlook.com>
...
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:SN6PR08MB5517.namprd08.prod.outlook.com;PTR:;CAT:NONE;SFS:(346002)(136003)(396003)(366004)(376002)(39830400003)(6512007)(316002)(6486002)(83380400001)(86362001)(69590400008)(36756003)(478600001)(8676002)(4326008)(5660300002)(107886003)(6506007)(66946007)(66556008)(66476007)(2906002)(26005)(6666004)(30864003)(8936002)(52116002)(2616005)(16526019)(186003)(956004)(579004)(559001)(309714004);DIR:OUT;SFP:1101;
X-MS-Exchange-AntiSpam-MessageData: 
X-OriginatorOrg: labundy.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 073b1c25-17e4-48b9-be98-08d88f37831c
X-MS-Exchange-CrossTenant-AuthSource: SN6PR08MB5517.namprd08.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 22 Nov 2020 22:39:46.1216
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 00b69d09-acab-4585-aca7-8fb7c6323e6f
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: vggAWDNZ4ef+AXQKYqQOdjrl03K2ozpERhPIJZ7xIa4dl0ctBmfu3J0k0rqkl6XmgSNnqjCK+RIPXbVvMdgRrQ==
...
index 362e8a0..7b6d568 100644
--- a/drivers/input/misc/Kconfig
+++ b/drivers/input/misc/Kconfig
@@ -729,6 +729,17 @@ config INPUT_IQS269A
...
index a48e5f2..f965122 100644
--- a/drivers/input/misc/Makefile
+++ b/drivers/input/misc/Makefile
@@ -40,6 +40,7 @@ obj-$(CONFIG_INPUT_HISI_POWERKEY)	+= hisi_powerkey.o
...
+#else
+			input_report_abs(iqs626->trackpad, ABS_X,
+					 flags.trackpad_x);
+			input_report_abs(iqs626->trackpad, ABS_Y,
+					 flags.trackpad_y);
+#endif /* CONFIG_TOUCHSCREEN_PROPERTIES */
+		}
+	} else {
