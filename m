...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AAE4C4AC145
	for <lists+devicetree@lfdr.de>; Mon,  7 Feb 2022 15:32:25 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1392389AbiBGOaC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 7 Feb 2022 09:30:02 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57092 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1390977AbiBGOGr (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 7 Feb 2022 09:06:47 -0500
X-Greylist: delayed 841 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Mon, 07 Feb 2022 06:06:42 PST
Received: from mx0a-00128a01.pphosted.com (mx0a-00128a01.pphosted.com [148.163.135.77])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D9ED2C0401C5;
        Mon,  7 Feb 2022 06:06:42 -0800 (PST)
Received: from pps.filterd (m0167088.ppops.net [127.0.0.1])
        by mx0a-00128a01.pphosted.com (8.16.1.2/8.16.1.2) with ESMTP id 2178cwBT010319;
        Mon, 7 Feb 2022 08:15:34 -0500
Received: from nwd2mta4.analog.com ([137.71.173.58])
        by mx0a-00128a01.pphosted.com (PPS) with ESMTPS id 3e1ky9n084-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Mon, 07 Feb 2022 08:15:33 -0500
Received: from ASHBMBX8.ad.analog.com (ASHBMBX8.ad.analog.com [10.64.17.5])
        by nwd2mta4.analog.com (8.14.7/8.14.7) with ESMTP id 217DFWO2062627
        (version=TLSv1/SSLv3 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=FAIL);
        Mon, 7 Feb 2022 08:15:32 -0500
Received: from ASHBCASHYB4.ad.analog.com (10.64.17.132) by
 ASHBMBX8.ad.analog.com (10.64.17.5) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.14; Mon, 7 Feb 2022 08:15:31 -0500
...
Received: from zeus.spd.analog.com (10.66.68.11) by ashbmbx9.ad.analog.com
 ...
 Transport; Mon, 7 Feb 2022 08:15:31 -0500
Received: from amiclaus-VirtualBox.ad.analog.com (AMICLAUS-L02.ad.analog.com [10.48.65.131])
        by zeus.spd.analog.com (8.15.1/8.15.1) with ESMTP id 217DFMUT004584;
        Mon, 7 Feb 2022 08:15:25 -0500
From:   Antoniu Miclaus <antoniu.miclaus@analog.com>
To:     <jic23@kernel.org>, <robh+dt@kernel.org>,
        <linux-iio@vger.kernel.org>, <devicetree@vger.kernel.org>,
        <linux-kernel@vger.kernel.org>
CC:     Antoniu Miclaus <antoniu.miclaus@analog.com>
Subject: [PATCH v6 1/4] iio:frequency:admv1014: add support for ADMV1014
Date:   Mon, 7 Feb 2022 15:05:46 +0200
Message-ID: <20220207130549.98415-1-antoniu.miclaus@analog.com>
X-Mailer: git-send-email 2.35.1
MIME-Version: 1.0
Content-Transfer-Encoding: 7BIT
Content-Type:   text/plain; charset=US-ASCII
X-ADIRuleOP-NewSCL: Rule Triggered
X-Proofpoint-ORIG-GUID: hznn9J2YZwOxxv2EcRPA-6ggVMa6Z462
X-Proofpoint-GUID: hznn9J2YZwOxxv2EcRPA-6ggVMa6Z462
...
changes in v6:
 - add missing commas
 - remove explicit init for spi transfer variable `t`
 - use sizeof for transfer length
 - use `mult_frac` when computing `vcm_comp`
 - update quad filters comparison
 - remove explicit cast cast of `private` in switch...case
 - use `kstrtoint`
 - update `reg_name` array alignment
 - rework input modes dt parse
 - use reversed xmas tree order for variable declaration where needed
