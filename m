...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 29E2D70FBF2
	for <lists+devicetree@lfdr.de>; Wed, 24 May 2023 18:50:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235146AbjEXQux (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 24 May 2023 12:50:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55414 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235021AbjEXQuu (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 24 May 2023 12:50:50 -0400
Received: from mail-pf1-x431.google.com (mail-pf1-x431.google.com [IPv6:2607:f8b0:4864:20::431])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 968E9FC
        for <devicetree@vger.kernel.org>; Wed, 24 May 2023 09:50:45 -0700 (PDT)
Received: by mail-pf1-x431.google.com with SMTP id d2e1a72fcca58-64d2467d640so1285398b3a.1
        for <devicetree@vger.kernel.org>; Wed, 24 May 2023 09:50:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google; t=1684947045; x=1687539045;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=LTS9XBWdZxrD7I/P8PEJ5V99CF14hntxpbLPhxKuDI0=;
        b=DZ/Dlr4VYXhVgpLty1MmC9InSpSdz9tPuTOZLG8VpUtONkMCK3rlbosf0M20oVK9ID
         HO4Lw+iVKX53dydW777tv5wOMZktl6IrhjtktVSg1zrtXoctu8p5kRIOuLnUK1wlVFdO
         1KVm/yhko4ngCnLyxU3Q6+0A86iiKL9xmn9po=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1684947045; x=1687539045;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=LTS9XBWdZxrD7I/P8PEJ5V99CF14hntxpbLPhxKuDI0=;
        b=
X-Gm-Message-State: AC+VfDzaw4eQOpYXjktDvjtf6PVDCTp0Ov+y2pBEZzWaetuYh0itdAFz
        YYI7lyg5ATtcf0mo52mwxbXxhf530HDZy6J627hh1w==
X-Google-Smtp-Source: ACHHUZ6iMBpx3f0I8NSrXqsXKW0ae1zjCEbiLXvWe283SmrueBHutYfSIe5Wsje5vumfbupSwjaRbdeGYGpZFI5zKlQ=
X-Received: by 2002:a05:6a21:9016:b0:103:f088:105e with SMTP id
 tq22-20020a056a21901600b00103f088105emr14597347pzb.16.1684947044833; Wed, 24
 May 2023 09:50:44 -0700 (PDT)
MIME-Version: 1.0
References: <20230524080739.17264-1-yunfei.dong@mediatek.com> <20230524080739.17264-3-yunfei.dong@mediatek.com>
In-Reply-To: <20230524080739.17264-3-yunfei.dong@mediatek.com>
From:   Nathan Hebert <nhebert@chromium.org>
Date:   Wed, 24 May 2023 09:50:33 -0700
Message-ID: <CANHAJhGTVAMBz489idaiehmRmxTQGDfj=EVvai3b-NKySxLAxQ@mail.gmail.com>
Subject: Re: [PATCH v7,2/2] media: mediatek: vcodec: support stateless hevc decoder
...
On Wed, May 24, 2023 at 1:07=E2=80=AFAM Yunfei Dong <yunfei.dong@mediatek.c=
om> wrote:
>
...
>  6 files changed, 1162 insertions(+), 1 deletion(-)
...
> index 000000000000..26c04421dca5
> --- /dev/null
...
ed int height)
> +{
> +       const unsigned int unit_size =3D (width / 16) * (height / 16) + 8=
;
> +
> +       return 64 * unit_size;
> +}
...
> +
> +       for (i =3D 0; i < ARRAY_SIZE(src_param->column_width_minus1); i++=
)
> +               GET_HEVC_VDEC_PARAM(column_width_minus1[i]);
> +       for (i =3D 0; i < ARRAY_SIZE(src_param->row_height_minus1); i++)
...
> +       int i;
> +
> +       for (i =3D 0; i < ARRAY_SIZE(dst_param->dpb); i++) {
> +               dst_entry =3D &dst_param->dpb[i];
> +               src_entry =3D &dpb[i];
> +
