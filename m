...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4C5113754F0
	for <lists+devicetree@lfdr.de>; Thu,  6 May 2021 15:39:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234400AbhEFNkS (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 6 May 2021 09:40:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35976 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234033AbhEFNkR (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 6 May 2021 09:40:17 -0400
Received: from mail-wm1-x329.google.com (mail-wm1-x329.google.com [IPv6:2a00:1450:4864:20::329])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 35ABEC061761
        for <devicetree@vger.kernel.org>; Thu,  6 May 2021 06:39:19 -0700 (PDT)
Received: by mail-wm1-x329.google.com with SMTP id s82so3392835wmf.3
        for <devicetree@vger.kernel.org>; Thu, 06 May 2021 06:39:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=mime-version:content-transfer-encoding:date:message-id:cc:subject
         :from:to:references:in-reply-to;
        bh=fk1TsRB1z+braMAhx/8/SEIkCFMb2DQ2ynDUWwpbvqY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=fk1TsRB1z+braMAhx/8/SEIkCFMb2DQ2ynDUWwpbvqY=;
        b=
X-Gm-Message-State: AOAM532MtU9N94IXPPd1F1JsAUwS0/6ZHmv4sx1P/jXRkndqPRqeALBp
        OxHdkPDeFKQ5NqGe66handIn9w==
X-Google-Smtp-Source: ABdhPJw5t7N/5he3EnGGV30uzs1Mk4US/uW3emW2RIN0oqejUWkR6Vuiu9jxj5Yu4tsyoFKBz8BOfA==
X-Received: by 2002:a1c:1bc9:: with SMTP id b192mr15237409wmb.3.1620308355862;
        Thu, 06 May 2021 06:39:15 -0700 (PDT)
Received: from localhost (a109-49-46-234.cpe.netcabo.pt. [109.49.46.234])
        by smtp.gmail.com with ESMTPSA id x8sm4261900wru.70.2021.05.06.06.39.14
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 06 May 2021 06:39:15 -0700 (PDT)
Mime-Version: 1.0
Content-Transfer-Encoding: quoted-printable
Content-Type: text/plain; charset=UTF-8
Date:   Thu, 06 May 2021 14:39:13 +0100
Message-Id: <CB67DHRVT0FW.1JTB39XCX16VU@arch-thunder>
...
In-Reply-To: <YJPgFaJEFqHfYQSj@pendragon.ideasonboard.com>
Precedence: bulk
...
> >=20
> > diff --git a/drivers/usb/isp1760/isp1760-core.c b/drivers/usb/isp1760/i=
sp1760-core.c
...
> >  	if (isp->rst_gpio) {
> > @@ -39,24 +39,22 @@ static void isp1760_init_core(struct isp1760_device=
 *isp)
...
> but still), but also a functional impact. I'd rather keep a single write
> for this kind of sequence, especially when no read-modify-write sequence
...
> > =20
> >  	/*
> >  	 * The ISP1761 has a dedicated DC IRQ line but supports sharing the H=
C
> > @@ -65,18 +63,10 @@ static void isp1760_init_core(struct isp1760_device=
 *isp)
...
> >  	 * on ISP1761.
> > @@ -85,14 +75,15 @@ static void isp1760_init_core(struct isp1760_device=
 *isp)
...
> > @@ -101,16 +92,43 @@ static void isp1760_init_core(struct isp1760_devic=
e *isp)
> > =20
...
> > +};
> > +
> >  int isp1760_register(struct resource *mem, int irq, unsigned long irqf=
lags,
...
> > @@ -126,19 +144,52 @@ int isp1760_register(struct resource *mem, int ir=
q, unsigned long irqflags,
> > =20
> >  	isp->dev =3D dev;
...
> > +	}
> > =20
> >  	isp->rst_gpio =3D devm_gpiod_get_optional(dev, NULL, GPIOD_OUT_HIGH);
...
> > +
> > +	hcd->regs =3D devm_regmap_init_mmio(dev, base, &isp1760_hc_regmap_con=
f);
> > +	if (IS_ERR(hcd->regs))
...
> > +	}
> > +
> > +	udc->regs =3D devm_regmap_init_mmio(dev, base, &isp1761_dc_regmap_con=
f);
> > +	if (IS_ERR(udc->regs))
...
> >  		if (ret < 0)
> >  			return ret;
> > @@ -147,7 +198,7 @@ int isp1760_register(struct resource *mem, int irq,=
...
> >  		}
> >  	}
> > diff --git a/drivers/usb/isp1760/isp1760-core.h b/drivers/usb/isp1760/i=
sp1760-core.h
...
> > +static inline u32 isp1760_field_read(struct regmap_field **fields, u32=
 field)
> >  {
...
> > +}
> > +
> > +static inline void isp1760_field_write(struct regmap_field **fields, u=
32 field,
> > +				       u32 val)
> > +{
...
> > +}
> > +
> > +static inline void isp1760_field_set(struct regmap_field **fields, u32=
 field)
> > +{
> > +	isp1760_field_write(fields, field, 0xFFFFFFFF);
> >  }
> > =20
> > -static inline void isp1760_write32(void __iomem *base, u32 reg, u32 va=
l)
> > +static inline void isp1760_field_clear(struct regmap_field **fields, u=
32 field)
> >  {
> > -	writel(val, base + reg);
...
> > +}
> > +
> > +static inline void isp1760_reg_write(struct regmap *regs, u32 reg, u32=
 val)
> > +{
> > +	regmap_write(regs, reg, val);
> > +}
> >  #endif
> > diff --git a/drivers/usb/isp1760/isp1760-hcd.c b/drivers/usb/isp1760/is=
p1760-hcd.c
...
> > +static int isp1760_hcd_clear_poll_timeout(struct usb_hcd *hcd, u32 fie=
ld,
> > +					  u32 timeout_us)
> >  {
...
> > =20
> >  /*
> > @@ -231,12 +278,15 @@ static void bank_reads8(void __iomem *src_base, u=
32 src_offset, u32 bank_addr,
> >  	}
> >  }
> > =20
> > -static void mem_reads8(void __iomem *src_base, u32 src_offset, void *d=
st,
> > -								u32 bytes)
...
> > @@ -278,14 +328,15 @@ static void mem_writes8(void __iomem *dst_base, u=
32 dst_offset,
...
> > @@ -377,34 +428,15 @@ static void free_mem(struct usb_hcd *hcd, struct =
isp1760_qtd *qtd)
...
> >  	return 0;
> >  }
> > @@ -462,12 +498,13 @@ static int isp1760_hc_setup(struct usb_hcd *hcd)
> >  {
> >  	struct isp1760_hcd *priv =3D hcd_to_priv(hcd);
> >  	int result;
> > -	u32 scratch, hwmode;
...
> >  		return -ENODEV;
> > @@ -481,10 +518,13 @@ static int isp1760_hc_setup(struct usb_hcd *hcd)
> >  	 * the host controller through the EHCI USB Command register. The dev=
ice
...
> >  	if (result)
> > @@ -493,14 +533,11 @@ static int isp1760_hc_setup(struct usb_hcd *hcd)
> >  	/* Step 11 passed */
> > =20
> >  	/* ATL reset */
> > -	hwmode =3D reg_read32(hcd->regs, HC_HW_MODE_CTRL) & ~ALL_ATX_RESET;
...
> >  }
> > @@ -730,12 +767,12 @@ static void start_bus_transfer(struct usb_hcd *hc=
d, u32 ptd_offset, int slot,
> > =20
...
> >  	}
> > =20
> > @@ -744,16 +781,20 @@ static void start_bus_transfer(struct usb_hcd *hc=
d, u32 ptd_offset, int slot,
...
> >  }
> > =20
> > @@ -766,9 +807,10 @@ static int is_short_bulk(struct isp1760_qtd *qtd)
...
> > @@ -783,9 +825,10 @@ static void collect_qtds(struct usb_hcd *hcd, stru=
ct isp1760_qh *qh,
...
> > @@ -873,8 +916,8 @@ static void enqueue_qtds(struct usb_hcd *hcd, struc=
t isp1760_qh *qh)
> >  			if ((qtd->length) &&
...
> > @@ -1074,9 +1117,9 @@ static void handle_done_ptds(struct usb_hcd *hcd)
> >  	int modified;
> >  	int skip_map;
> > =20
> > -	skip_map =3D reg_read32(hcd->regs, HC_INT_PTD_SKIPMAP_REG);
> > +	skip_map =3D isp1760_reg_read(priv->regs, ISP176x_HC_INT_PTD_SKIPMAP)=
;
> >  	priv->int_done_map &=3D ~skip_map;
> > -	skip_map =3D reg_read32(hcd->regs, HC_ATL_PTD_SKIPMAP_REG);
> > +	skip_map =3D isp1760_reg_read(priv->regs, ISP176x_HC_ATL_PTD_SKIPMAP)=
;
> >  	priv->atl_done_map &=3D ~skip_map;
> > =20
> >  	modified =3D priv->int_done_map || priv->atl_done_map;
> > @@ -1094,7 +1137,7 @@ static void handle_done_ptds(struct usb_hcd *hcd)
> >  				continue;
> >  			}
...
> >  							slots[slot].qtd->urb);
> >  		} else {
> > @@ -1109,7 +1152,7 @@ static void handle_done_ptds(struct usb_hcd *hcd)
> >  				continue;
> >  			}
...
> >  							slots[slot].qtd->urb);
> >  		}
> > @@ -1134,7 +1177,7 @@ static void handle_done_ptds(struct usb_hcd *hcd)
> > =20
...
> > @@ -1210,13 +1253,15 @@ static irqreturn_t isp1760_irq(struct usb_hcd *=
hcd)
...
*/
> > =20
> > -	priv->int_done_map |=3D reg_read32(hcd->regs, HC_INT_PTD_DONEMAP_REG)=
;
> > -	priv->atl_done_map |=3D reg_read32(hcd->regs, HC_ATL_PTD_DONEMAP_REG)=
;
> > +	priv->int_done_map |=3D isp1760_reg_read(priv->regs,
> > +					       ISP176x_HC_INT_PTD_DONEMAP);
> > +	priv->atl_done_map |=3D isp1760_reg_read(priv->regs,
...
> > =20
> > @@ -1271,7 +1316,7 @@ static void errata2_function(struct timer_list *u=
nused)
...
> >  				priv->atl_done_map |=3D 1 << slot;
> > @@ -1288,9 +1333,8 @@ static void errata2_function(struct timer_list *u=
nused)
> > =20
...
> > =20
> > -	retval =3D handshake(hcd, HC_CONFIGFLAG, FLAG_CF, FLAG_CF, 250 * 1000=
);
...
> >  	errata2_timer.expires =3D jiffies + msecs_to_jiffies(SLOT_CHECK_PERIO=
D);
...
> > @@ -1584,15 +1625,19 @@ static void kill_transfer(struct usb_hcd *hcd, =
struct urb *urb,
...
> >  	}
> > @@ -1705,8 +1750,7 @@ static void isp1760_endpoint_disable(struct usb_h=
cd *hcd,
...
> >  	unsigned long flags;
> > =20
> > @@ -1716,17 +1760,13 @@ static int isp1760_hub_status_data(struct usb_h=
cd *hcd, char *buf)
> > =20
...
> > =20
> >  	/*
> > @@ -1735,11 +1775,9 @@ static int isp1760_hub_status_data(struct usb_hc=
d *hcd, char *buf)
...
> >  		status =3D STS_PCD;
> >  	}
> > @@ -1752,9 +1790,11 @@ static int isp1760_hub_status_data(struct usb_hc=
d *hcd, char *buf)
...
> > @@ -1770,7 +1810,7 @@ static void isp1760_hub_descriptor(struct isp1760=
_hcd *priv,
> > =20
...
> >  	else
> > @@ -1781,38 +1821,37 @@ static void isp1760_hub_descriptor(struct isp17=
60_hcd *priv,
> > =20
...
> > @@ -1837,7 +1876,6 @@ static int isp1760_hub_control(struct usb_hcd *hc=
d, u16 typeReq,
...
> > @@ -1848,22 +1886,22 @@ static int isp1760_hub_control(struct usb_hcd *=
hcd, u16 typeReq,
> > =20
> >  		switch (wValue) {
...
> >  			}
> > @@ -1872,12 +1910,11 @@ static int isp1760_hub_control(struct usb_hcd *=
hcd, u16 typeReq,
...
> >  			/* XXX error ?*/
> > @@ -1888,7 +1925,7 @@ static int isp1760_hub_control(struct usb_hcd *hc=
d, u16 typeReq,
> >  		default:
> >  			goto error;
> >  		}
...
> > @@ -1903,15 +1940,14 @@ static int isp1760_hub_control(struct usb_hcd *=
hcd, u16 typeReq,
> >  			goto error;
> >  		wIndex--;
> >  		status =3D 0;
...
> > @@ -1930,35 +1966,31 @@ static int isp1760_hub_control(struct usb_hcd *=
hcd, u16 typeReq,
...
> >  						wIndex + 1, retval);
> > @@ -1966,8 +1998,7 @@ static int isp1760_hub_control(struct usb_hcd *hc=
d, u16 typeReq,
> >  			}
> > =20
...
> > @@ -1975,21 +2006,22 @@ static int isp1760_hub_control(struct usb_hcd *=
hcd, u16 typeReq,
...
> > @@ -2009,41 +2041,39 @@ static int isp1760_hub_control(struct usb_hcd *=
hcd, u16 typeReq,
> >  		if (!wIndex || wIndex > ports)
> >  			goto error;
> >  		wIndex--;
...
> > @@ -2052,12 +2082,11 @@ static int isp1760_hub_control(struct usb_hcd *=
hcd, u16 typeReq,
> >  				priv->reset_done =3D jiffies +
> >  					msecs_to_jiffies(50);
> >  			}
...
> > =20
> >  	default:
> > @@ -2074,14 +2103,13 @@ static int isp1760_get_frame(struct usb_hcd *hc=
d)
> >  	struct isp1760_hcd *priv =3D hcd_to_priv(hcd);
> >  	u32 fr;
> > =20
...
> > =20
> > @@ -2092,24 +2120,19 @@ static void isp1760_stop(struct usb_hcd *hcd)
> >  	spin_lock_irq(&priv->lock);
> >  	ehci_reset(hcd);
> >  	/* Disable IRQ */
> > -	temp =3D reg_read32(hcd->regs, HC_HW_MODE_CTRL);
> > -	reg_write32(hcd->regs, HC_HW_MODE_CTRL, temp &=3D ~HW_GLOBAL_INTR_EN)=
;
...
> > +int isp1760_hcd_register(struct isp1760_hcd *priv, struct resource *me=
m,
> > +			 int irq, unsigned long irqflags,
> >  			 struct device *dev)
> >  {
> >  	struct usb_hcd *hcd;
> > @@ -2200,7 +2223,6 @@ int isp1760_hcd_register(struct isp1760_hcd *priv=
, void __iomem *regs,
> >  	init_memory(priv);
> > =20
> >  	hcd->irq =3D irq;
...
> > =20
> > diff --git a/drivers/usb/isp1760/isp1760-hcd.h b/drivers/usb/isp1760/is=
p1760-hcd.h
...
> >  				       struct device *dev)
> >  {
> > diff --git a/drivers/usb/isp1760/isp1760-if.c b/drivers/usb/isp1760/isp=
1760-if.c
...
> >  	}
> > =20
> > diff --git a/drivers/usb/isp1760/isp1760-regs.h b/drivers/usb/isp1760/i=
sp1760-regs.h
...
> > -#define HCS_INDICATOR(p)	((p) & (1 << 16))	/* true: has port indicator=
s */
> > -#define HCS_PPC(p)		((p) & (1 << 4))	/* true: port power control */
> > -#define HCS_N_PORTS(p)		(((p) >> 0) & 0xf)	/* bits 3:0, ports on HC */
> > -
> > -#define HC_HCCPARAMS		0x008
> > -#define HCC_ISOC_CACHE(p)       ((p) & (1 << 7))	/* true: can cache is=
oc frame */
> > -#define HCC_ISOC_THRES(p)       (((p) >> 4) & 0x7)	/* bits 6:4, uframe=
s cached */
...
> > +};
> > +
> > +static const struct regmap_access_table isp176x_hc_volatile_table =3D =
{
...
> > +	HW_DATA_BUS_WIDTH, HW_DACK_POL_HIGH, HW_DREQ_POL_HIGH, HW_INTR_HIGH_A=
CT,
...
> > +};
> > +
> > +static const struct regmap_access_table isp176x_dc_volatile_table =3D =
{
...
> > =20
> >  #endif
> > diff --git a/drivers/usb/isp1760/isp1760-udc.c b/drivers/usb/isp1760/is=
p1760-udc.c
> > index 1714b2258b54..1ce21ef291b6 100644
> > --- a/drivers/usb/isp1760/isp1760-udc.c
> > +++ b/drivers/usb/isp1760/isp1760-udc.c
> > @@ -45,16 +45,62 @@ static inline struct isp1760_request *req_to_udc_re=
q(struct usb_request *req)
...
> >  }
> > =20
> > -static inline void isp1760_udc_write(struct isp1760_udc *udc, u16 reg,=
 u32 val)
> > +static void isp1760_udc_write(struct isp1760_udc *udc, u16 field, u32 =
val)
> >  {
...
> > +}
> > +
> > +static void isp1760_udc_write_raw(struct isp1760_udc *udc, u16 reg, u3=
2 val)
> > +{
...
> > +}
> > +
> > +static void isp1760_udc_write_raw16(struct isp1760_udc *udc, u16 reg, =
u16 val)
> > +{
...
> >   * Endpoint Management
> >   */
> > @@ -75,11 +121,15 @@ static struct isp1760_ep *isp1760_udc_find_ep(stru=
ct isp1760_udc *udc,
> >  	return NULL;
> >  }
> > =20
...
> > +	isp1760_udc_write(udc, DC_ENDPIDX, ep->addr & USB_ENDPOINT_NUMBER_MAS=
K);
> > +
...
> > =20
> >  /**
> > @@ -93,9 +143,10 @@ static void __isp1760_udc_select_ep(struct isp1760_=
ep *ep, int dir)
> >   *
...
> > =20
> >  /* Called with the UDC spinlock held. */
> > @@ -108,9 +159,13 @@ static void isp1760_udc_ctrl_send_status(struct is=
p1760_ep *ep, int dir)
> >  	 * the direction opposite to the data stage data packets, we thus nee=
d
...
> > =20
> >  	/*
> >  	 * The hardware will terminate the request automatically and go back =
to
> > @@ -157,10 +212,10 @@ static void isp1760_udc_ctrl_send_stall(struct is=
p1760_ep *ep)
...
> > @@ -181,8 +236,8 @@ static bool isp1760_udc_receive(struct isp1760_ep *=
ep,
> >  	u32 *buf;
> >  	int i;
> > =20
...
> > @@ -198,7 +253,7 @@ static bool isp1760_udc_receive(struct isp1760_ep *=
ep,
...
> >  	}
> > =20
> > @@ -209,9 +264,9 @@ static bool isp1760_udc_receive(struct isp1760_ep *=
ep,
...
> > =20
> > @@ -253,7 +308,7 @@ static void isp1760_udc_transmit(struct isp1760_ep =
*ep,
...
> > @@ -265,14 +320,14 @@ static void isp1760_udc_transmit(struct isp1760_e=
p *ep,
...
> > @@ -408,19 +463,24 @@ static int __isp1760_udc_set_halt(struct isp1760_=
ep *ep, bool halt)
> >  		return -EINVAL;
> >  	}
> > =20
...
> > @@ -479,12 +539,14 @@ static int isp1760_udc_get_status(struct isp1760_=
udc *udc,
> >  		return -EINVAL;
> >  	}
> > =20
...
> > =20
> > @@ -508,7 +570,8 @@ static int isp1760_udc_set_address(struct isp1760_u=
dc *udc, u16 addr)
...
> > @@ -650,9 +713,9 @@ static void isp1760_ep0_setup(struct isp1760_udc *u=
dc)
> > =20
> >  	spin_lock(&udc->lock);
> > =20
...
> > =20
> > @@ -663,8 +726,8 @@ static void isp1760_ep0_setup(struct isp1760_udc *u=
dc)
> >  		return;
> >  	}
> > =20
...
> > =20
> > @@ -864,8 +931,8 @@ static int isp1760_ep_queue(struct usb_ep *ep, stru=
ct usb_request *_req,
> > =20
...
> > @@ -1025,14 +1092,14 @@ static void isp1760_ep_fifo_flush(struct usb_ep=
 *ep)
> > =20
> >  	spin_lock_irqsave(&udc->lock, flags);
> > =20
...
> >  	spin_unlock_irqrestore(&udc->lock, flags);
> >  }
> > @@ -1091,19 +1158,30 @@ static void isp1760_udc_init_hw(struct isp1760_=
udc *udc)
...
> > @@ -1152,7 +1230,7 @@ static int isp1760_udc_get_frame(struct usb_gadge=
t *gadget)
> >  {
...
> > @@ -1219,7 +1297,7 @@ static int isp1760_udc_start(struct usb_gadget *g=
adget,
...
> > =20
> > @@ -1238,7 +1316,7 @@ static int isp1760_udc_stop(struct usb_gadget *ga=
dget)
> > =20
...
> >  	spin_lock_irqsave(&udc->lock, flags);
> >  	udc->driver =3D NULL;
> > @@ -1266,9 +1344,9 @@ static irqreturn_t isp1760_udc_irq(int irq, void =
*dev)
> >  	unsigned int i;
> >  	u32 status;
> > =20
...
> > @@ -1313,7 +1391,7 @@ static irqreturn_t isp1760_udc_irq(int irq, void =
*dev)
...
> > @@ -1335,7 +1413,7 @@ static void isp1760_udc_vbus_poll(struct timer_li=
st *t)
> > =20
> >  	spin_lock_irqsave(&udc->lock, flags);
> > =20
...
> > @@ -1412,9 +1490,9 @@ static int isp1760_udc_init(struct isp1760_udc *u=
dc)
...
> >  		dev_err(udc->isp->dev,
> > @@ -1429,9 +1507,9 @@ static int isp1760_udc_init(struct isp1760_udc *u=
dc)
> >  	}
> > =20
...
> > =20
> >  	return 0;
> > @@ -1445,7 +1523,6 @@ int isp1760_udc_register(struct isp1760_device *i=
sp, int irq,
> > =20
> >  	udc->irq =3D -1;
> >  	udc->isp =3D isp;
...
> > diff --git a/drivers/usb/isp1760/isp1760-udc.h b/drivers/usb/isp1760/is=
p1760-udc.h
