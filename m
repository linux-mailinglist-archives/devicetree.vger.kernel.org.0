...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E64EB583837
	for <lists+devicetree@lfdr.de>; Thu, 28 Jul 2022 07:43:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232465AbiG1Fnn (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 28 Jul 2022 01:43:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35038 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232726AbiG1Fnj (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 28 Jul 2022 01:43:39 -0400
Received: from mail-sh.amlogic.com (mail-sh.amlogic.com [58.32.228.43])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9D12957217;
        Wed, 27 Jul 2022 22:43:34 -0700 (PDT)
...
Subject: [PATCH V2 3/3] clk: meson: s4: add s4 SoC clock controller driver
Date:   Thu, 28 Jul 2022 13:42:02 +0800
Message-ID: <20220728054202.6981-4-yu.tu@amlogic.com>
...
---
 ...
 4 files changed, 5044 insertions(+)
 create mode 100644 drivers/clk/meson/s4.c
 create mode 100644 drivers/clk/meson/s4.h

diff --git a/drivers/clk/meson/Kconfig b/drivers/clk/meson/Kconfig
index fc002c155bc3..a3b630db991c 100644
--- a/drivers/clk/meson/Kconfig
+++ b/drivers/clk/meson/Kconfig
@@ -115,4 +115,19 @@ config COMMON_CLK_G12A
 	help
...
index 000000000000..03dc603ab023
--- /dev/null
...
+	}
+
+	ret = regmap_multi_reg_write(pll_map, s4_init_regs, ARRAY_SIZE(s4_init_regs));
+	if (ret) {
...
new file mode 100644
index 000000000000..be11316ba244
--- /dev/null
...
+#define CLKID_RTC_32K_CLKIN		32
+#define CLKID_RTC_32K_DIV		33
+#define CLKID_RTC_32K_SEL		34
+#define CLKID_RTC_32K_XATL		35
+#define CLKID_SYS_CLK_B_SEL		37
+#define CLKID_SYS_CLK_B_DIV		38
+#define CLKID_SYS_CLK_A_SEL		40
+#define CLKID_SYS_CLK_A_DIV		41
+#define CLKID_CECA_32K_CLKIN		44
+#define CLKID_CECA_32K_DIV		45
+#define CLKID_CECA_32K_SEL_PRE		46
+#define CLKID_CECA_32K_SEL		47
+#define CLKID_CECB_32K_CLKIN		49
+#define CLKID_CECB_32K_DIV		50
+#define CLKID_CECB_32K_SEL_PRE		51
+#define CLKID_CECB_32K_SEL		52
+#define CLKID_SC_CLK_SEL		54
+#define CLKID_SC_CLK_DIV		55
+#define CLKID_12_24M_CLK_GATE		57
+#define CLKID_12M_CLK_DIV		58
+#define CLKID_VID_PLL_DIV		60
+#define CLKID_VID_PLL_SEL		61
+#define CLKID_VCLK_SEL			63
+#define CLKID_VCLK2_SEL			64
+#define CLKID_VCLK_INPUT		65
+#define CLKID_VCLK2_INPUT		66
+#define CLKID_VCLK_DIV			67
+#define CLKID_VCLK2_DIV			68
+#define CLKID_VCLK_DIV2_EN		72
+#define CLKID_VCLK_DIV4_EN		73
+#define CLKID_VCLK_DIV6_EN		74
+#define CLKID_VCLK_DIV12_EN		75
+#define CLKID_VCLK2_DIV2_EN		77
+#define CLKID_VCLK2_DIV4_EN		78
+#define CLKID_VCLK2_DIV6_EN		79
+#define CLKID_VCLK2_DIV12_EN		80
+#define CLKID_CTS_ENCI_SEL		89
+#define CLKID_CTS_ENCP_SEL		90
+#define CLKID_CTS_VDAC_SEL		91
+#define CLKID_HDMI_TX_SEL		92
+#define CLKID_HDMI_TX			96
+#define CLKID_HDMI_SEL			97
+#define CLKID_HDMI_DIV			98
+#define CLKID_TS_CLK_DIV		100
+#define CLKID_MALI_0_SEL		102
+#define CLKID_MALI_0_DIV		103
+#define CLKID_MALI_1_SEL		105
+#define CLKID_MALI_1_DIV		106
+#define CLKID_VDEC_P0_SEL		109
+#define CLKID_VDEC_P0_DIV		110
+#define CLKID_VDEC_P1_SEL		112
+#define CLKID_VDEC_P1_DIV		113
+#define CLKID_HEVCF_P0_SEL		116
+#define CLKID_HEVCF_P0_DIV		117
+#define CLKID_HEVCF_P1_SEL		119
+#define CLKID_HEVCF_P1_DIV		120
+#define CLKID_VPU_0_SEL			123
+#define CLKID_VPU_0_DIV			124
+#define CLKID_VPU_1_SEL			126
+#define CLKID_VPU_1_DIV			127
+#define CLKID_VPU_CLKB_TMP_SEL		130
+#define CLKID_VPU_CLKB_TMP_DIV		131
+#define CLKID_VPU_CLKB_DIV		133
+#define CLKID_VPU_CLKC_P0_SEL		135
+#define CLKID_VPU_CLKC_P0_DIV		136
+#define CLKID_VPU_CLKC_P1_SEL		138
+#define CLKID_VPU_CLKC_P1_DIV		139
+#define CLKID_VAPB_0_SEL		142
+#define CLKID_VAPB_0_DIV		143
+#define CLKID_VAPB_1_SEL		145
+#define CLKID_VAPB_1_DIV		146
+#define CLKID_VDIN_MEAS_SEL		150
+#define CLKID_VDIN_MEAS_DIV		151
+#define CLKID_SD_EMMC_C_CLK_SEL		153
+#define CLKID_SD_EMMC_C_CLK_DIV		154
+#define CLKID_SD_EMMC_A_CLK_SEL		156
+#define CLKID_SD_EMMC_A_CLK_DIV		157
+#define CLKID_SD_EMMC_B_CLK_SEL		159
+#define CLKID_SD_EMMC_B_CLK_DIV		160
+#define CLKID_SPICC0_SEL		162
+#define CLKID_SPICC0_DIV		163
+#define CLKID_PWM_A_SEL			165
+#define CLKID_PWM_A_DIV			166
+#define CLKID_PWM_B_SEL			168
+#define CLKID_PWM_B_DIV			169
+#define CLKID_PWM_C_SEL			171
+#define CLKID_PWM_C_DIV			172
+#define CLKID_PWM_D_SEL			174
+#define CLKID_PWM_D_DIV			175
+#define CLKID_PWM_E_SEL			177
+#define CLKID_PWM_E_DIV			178
+#define CLKID_PWM_F_SEL			180
+#define CLKID_PWM_F_DIV			181
+#define CLKID_PWM_G_SEL			183
+#define CLKID_PWM_G_DIV			184
+#define CLKID_PWM_H_SEL			186
+#define CLKID_PWM_H_DIV			187
+#define CLKID_PWM_I_SEL			189
+#define CLKID_PWM_I_DIV			190
+#define CLKID_PWM_J_SEL			192
+#define CLKID_PWM_J_DIV			193
+#define CLKID_SARADC_SEL		195
+#define CLKID_SARADC_DIV		196
+#define CLKID_GEN_SEL			198
+#define CLKID_GEN_DIV			199
+#define CLKID_HDCP22_ESMCLK_SEL		251
+#define CLKID_HDCP22_ESMCLK_DIV		252
+#define CLKID_HDCP22_SKPCLK_SEL		254
+#define CLKID_HDCP22_SKPCLK_DIV		255
+
+#define NR_CLKS				257
