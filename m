...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 874AB2BFEE3
	for <lists+devicetree@lfdr.de>; Mon, 23 Nov 2020 04:49:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728014AbgKWDsm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 22 Nov 2020 22:48:42 -0500
Received: from mailgw02.mediatek.com ([210.61.82.184]:37107 "EHLO
        mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S1727813AbgKWDsl (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 22 Nov 2020 22:48:41 -0500
X-UUID: 6b2cb66cd6424ad5b94b3603f12ab93d-20201123
X-UUID: 6b2cb66cd6424ad5b94b3603f12ab93d-20201123
Received: from mtkcas10.mediatek.inc [(172.21.101.39)] by mailgw02.mediatek.com
        (envelope-from <hsin-hsiung.wang@mediatek.com>)
        (Cellopoint E-mail Firewall v4.1.14 Build 0819 with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 12112857; Mon, 23 Nov 2020 11:48:27 +0800
Received: from mtkcas10.mediatek.inc (172.21.101.39) by
 mtkmbs05n2.mediatek.inc (172.21.101.140) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Mon, 23 Nov 2020 11:48:25 +0800
Received: from mtksdaap41.mediatek.inc (172.21.77.4) by mtkcas10.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Mon, 23 Nov 2020 11:48:25 +0800
...
Subject: [PATCH v3 7/8] regulator: mt6359: Add support for MT6359P regulator
Date:   Mon, 23 Nov 2020 11:48:09 +0800
Message-ID: <1606103290-15034-8-git-send-email-hsin-hsiung.wang@mediatek.com>
...
@@ -381,6 +417,78 @@ static int mt6359_regulator_set_mode(struct regulator_dev *rdev,
 	return ret;
 }
...
@@ -414,6 +522,18 @@ static const struct regulator_ops mt6359_volt_fixed_ops = {
...
@@ -687,24 +807,307 @@ static struct mt6359_regulator_info mt6359_regulators[] = {
