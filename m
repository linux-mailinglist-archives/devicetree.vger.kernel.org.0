...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 434913A6659
	for <lists+devicetree@lfdr.de>; Mon, 14 Jun 2021 14:16:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233363AbhFNMS2 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 14 Jun 2021 08:18:28 -0400
Received: from comms.puri.sm ([159.203.221.185]:56584 "EHLO comms.puri.sm"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232559AbhFNMS2 (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Mon, 14 Jun 2021 08:18:28 -0400
Received: from localhost (localhost [127.0.0.1])
        by comms.puri.sm (Postfix) with ESMTP id CAA83E144E;
        Mon, 14 Jun 2021 05:15:55 -0700 (PDT)
Received: from comms.puri.sm ([127.0.0.1])
        by localhost (comms.puri.sm [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id XV-zGnXN-2dt; Mon, 14 Jun 2021 05:15:53 -0700 (PDT)
...
Subject: [PATCH v4 2/3] media: imx: add a driver for i.MX8MQ mipi csi rx phy and controller
Date:   Mon, 14 Jun 2021 14:15:21 +0200
Message-Id: <20210614121522.2944593-3-martin.kepplinger@puri.sm>
...
index 000000000000..183a28b8cea7
--- /dev/null
...
+	}
+
+	ret = of_property_read_u32(np, "resets", &ph);
+	if (ret) {
+		dev_err(dev, "no resets property found: %d\n", ret);
+		return ret;
+	}
+
...
+	if (!node) {
+		ret = -ENODEV;
+		dev_err(dev, "Error finding resets node by phandle\n");
+		goto out;
+	}
