...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 779616A910D
	for <lists+devicetree@lfdr.de>; Fri,  3 Mar 2023 07:34:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229535AbjCCGex (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Mar 2023 01:34:53 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46468 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229498AbjCCGew (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 3 Mar 2023 01:34:52 -0500
Received: from mail-oi1-x22a.google.com (mail-oi1-x22a.google.com [IPv6:2607:f8b0:4864:20::22a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1D61D15561;
        Thu,  2 Mar 2023 22:34:47 -0800 (PST)
Received: by mail-oi1-x22a.google.com with SMTP id bk32so1045419oib.10;
        Thu, 02 Mar 2023 22:34:47 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112; t=1677825286;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=n8BWtrZT97OHc7cVjO7SMlUAa9Qyq9g9ISE9J0sMy48=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1677825286;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=n8BWtrZT97OHc7cVjO7SMlUAa9Qyq9g9ISE9J0sMy48=;
        b=
X-Gm-Message-State: AO0yUKXR7u8vYRWrLx/30WI2XWVCItjVJI/fks6NKIsamSpS3fMC1jBI
        WigNx6pmIPMulkgoAZh2M0f97bNh1EucYDC8ziQ=
X-Google-Smtp-Source: AK7set8eGeBihwPmng74te1vhqlUiNn6/7cwhnY3YR93WTUDjnLjTc/GNvxr1/KMgjiYiW/2X3THXLAc1VDUGfSPMYY=
X-Received: by 2002:a05:6808:2098:b0:383:f981:b1e5 with SMTP id
 s24-20020a056808209800b00383f981b1e5mr2392679oiw.5.1677825286031; Thu, 02 Mar
 2023 22:34:46 -0800 (PST)
MIME-Version: 1.0
...
In-Reply-To: <CAMhs-H-VGjP32AZc2cuY=Co4iqx8xPtvjr+hMg-haMMFaQzzsg@mail.gmail.com>
From:   Sergio Paracuellos <sergio.paracuellos@gmail.com>
Date:   Fri, 3 Mar 2023 07:34:33 +0100
Message-ID: <CAMhs-H8OsG-SEWigimG3fT-SGjZruH-7tnjff198Z2qhb0O=yA@mail.gmail.com>
...
> >
> > This platform from Ralink was acquired by MediaTek in 2011. Then, Media=
Tek
...
> >  rename drivers/pinctrl/{ralink/pinctrl-ralink.c =3D> mediatek/pinctrl-=
mtmips.c} (74%)
> >  rename drivers/pinctrl/{ralink/pinctrl-ralink.h =3D> mediatek/pinctrl-=
mtmips.h} (75%)
...
> > diff --git a/drivers/pinctrl/mediatek/Kconfig b/drivers/pinctrl/mediate=
k/Kconfig
...
> > diff --git a/drivers/pinctrl/mediatek/Makefile b/drivers/pinctrl/mediat=
ek/Makefile
...
> > +obj-$(CONFIG_PINCTRL_MT8516)           +=3D pinctrl-mt8516.o
> > +obj-$(CONFIG_PINCTRL_MT6397)           +=3D pinctrl-mt6397.o
> > diff --git a/drivers/pinctrl/ralink/pinctrl-mt7620.c b/drivers/pinctrl/=
mediatek/pinctrl-mt7620.c
> > similarity index 81%
...
> > -static struct ralink_pmx_func uartlite_grp[] =3D { FUNC("uartlite", 0,=
 15, 2) };
...
> > +static struct mtmips_pmx_func uartlite_grp[] =3D { FUNC("uartlite", 0,=
 15, 2) };
> > +static struct mtmips_pmx_func mdio_grp[] =3D {
> >         FUNC("mdio", MT7620_GPIO_MODE_MDIO, 22, 2),
> >         FUNC("refclk", MT7620_GPIO_MODE_MDIO_REFCLK, 22, 2),
> >  };
> > -static struct ralink_pmx_func rgmii1_grp[] =3D { FUNC("rgmii1", 0, 24,=
 12) };
> > -static struct ralink_pmx_func refclk_grp[] =3D { FUNC("spi refclk", 0,=
 37, 3) };
> > -static struct ralink_pmx_func ephy_grp[] =3D { FUNC("ephy", 0, 40, 5) =
};
> > -static struct ralink_pmx_func rgmii2_grp[] =3D { FUNC("rgmii2", 0, 60,=
 12) };
...
> > +static struct mtmips_pmx_func rgmii1_grp[] =3D { FUNC("rgmii1", 0, 24,=
 12) };
> > +static struct mtmips_pmx_func refclk_grp[] =3D { FUNC("spi refclk", 0,=
 37, 3) };
> > +static struct mtmips_pmx_func ephy_grp[] =3D { FUNC("ephy", 0, 40, 5) =
};
> > +static struct mtmips_pmx_func rgmii2_grp[] =3D { FUNC("rgmii2", 0, 60,=
 12) };
...
> > diff --git a/drivers/pinctrl/ralink/pinctrl-mt7621.c b/drivers/pinctrl/=
mediatek/pinctrl-mt7621.c
> > similarity index 80%
...
> > -static struct ralink_pmx_func rgmii2_grp[] =3D { FUNC("rgmii2", 0, 22,=
 12) };
> > -static struct ralink_pmx_func spi_grp[] =3D {
> > +static struct mtmips_pmx_func mdio_grp[] =3D { FUNC("mdio", 0, 20, 2) =
};
> > +static struct mtmips_pmx_func rgmii2_grp[] =3D { FUNC("rgmii2", 0, 22,=
 12) };
...
> >         FUNC("nand2", 2, 41, 8),
> >  };
> > -static struct ralink_pmx_func rgmii1_grp[] =3D { FUNC("rgmii1", 0, 49,=
 12) };
> > +static struct mtmips_pmx_func rgmii1_grp[] =3D { FUNC("rgmii1", 0, 49,=
 12) };
> >
...
> > diff --git a/drivers/pinctrl/ralink/pinctrl-mt76x8.c b/drivers/pinctrl/=
...
> >  };
> >
> > -static struct ralink_pmx_func refclk_grp[] =3D { FUNC("refclk", 0, 37,=
 1) };
...
> > +static struct mtmips_pmx_func refclk_grp[] =3D { FUNC("refclk", 0, 37,=
 1) };
...
> > diff --git a/drivers/pinctrl/ralink/pinctrl-ralink.c b/drivers/pinctrl/=
...
> > +       struct mtmips_priv *p =3D pinctrl_dev_get_drvdata(pctrldev);
> >
> >         return (group >=3D p->group_count) ? NULL : p->group_names[grou=
p];
> >  }
> >
...
> > @@ -114,10 +114,10 @@ static int ralink_pmx_group_get_groups(struct pin=
ctrl_dev *pctrldev,
> >         return 0;
> >  }
> >
...
> >                                    unsigned int func, unsigned int grou=
p)
> >  {
> > -       struct ralink_priv *p =3D pinctrl_dev_get_drvdata(pctrldev);
> > +       struct mtmips_priv *p =3D pinctrl_dev_get_drvdata(pctrldev);
...
> >         int i;
> > @@ -158,11 +158,11 @@ static int ralink_pmx_group_enable(struct pinctrl=
_dev *pctrldev,
> >         return 0;
> >  }
> >
> > -static int ralink_pmx_group_gpio_request_enable(struct pinctrl_dev *pc=
trldev,
> > +static int mtmips_pmx_group_gpio_request_enable(struct pinctrl_dev *pc=
trldev,
> >                                                 struct pinctrl_gpio_ran=
ge *range,
> >                                                 unsigned int pin)
> >  {
> > -       struct ralink_priv *p =3D pinctrl_dev_get_drvdata(pctrldev);
...
;
> > @@ -172,28 +172,28 @@ static int ralink_pmx_group_gpio_request_enable(s=
truct pinctrl_dev *pctrldev,
> >         return 0;
> >  }
> >
...
> > -       .gpio_request_enable    =3D ralink_pmx_group_gpio_request_enabl=
e,
...
> > +       .gpio_request_enable    =3D mtmips_pmx_group_gpio_request_enabl=
e,
> >  };
> >
...
> > @@ -248,7 +248,7 @@ static int ralink_pinctrl_index(struct ralink_priv =
*p)
> >         return 0;
> >  }
> >
...
> >         int err;
> >
> > @@ -324,23 +324,23 @@ int ralink_pinctrl_init(struct platform_device *p=
dev,
> >                 return -ENOTSUPP;
> >
> >         /* setup the private data */
> > -       p =3D devm_kzalloc(&pdev->dev, sizeof(struct ralink_priv), GFP_=
KERNEL);
> > +       p =3D devm_kzalloc(&pdev->dev, sizeof(struct mtmips_priv), GFP_=
KERNEL);
> >         if (!p)
> >                 return -ENOMEM;
> >
...
> >                 return err;
> > diff --git a/drivers/pinctrl/ralink/pinctrl-ralink.h b/drivers/pinctrl/=
mediatek/pinctrl-mtmips.h
> > similarity index 75%
...
> >
> >  #endif
> > diff --git a/drivers/pinctrl/ralink/pinctrl-rt2880.c b/drivers/pinctrl/=
mediatek/pinctrl-rt2880.c
> > similarity index 71%
...
> > -static struct ralink_pmx_func sdram_grp[] =3D { FUNC("sdram", 0, 24, 1=
6) };
...
> > +static struct mtmips_pmx_func sdram_grp[] =3D { FUNC("sdram", 0, 24, 1=
6) };
...
> > diff --git a/drivers/pinctrl/ralink/pinctrl-rt305x.c b/drivers/pinctrl/=
mediatek/pinctrl-rt305x.c
> > similarity index 75%
...
> >         FUNC("rgmii", 0, 24, 12)
> >  };
> > -static struct ralink_pmx_func rgmii_grp[] =3D { FUNC("rgmii", 0, 40, 1=
2) };
> > -static struct ralink_pmx_func rt3352_lna_grp[] =3D { FUNC("lna", 0, 36=
, 2) };
> > -static struct ralink_pmx_func rt3352_pa_grp[] =3D { FUNC("pa", 0, 38, =
2) };
> > -static struct ralink_pmx_func rt3352_led_grp[] =3D { FUNC("led", 0, 40=
, 5) };
> > -static struct ralink_pmx_func rt3352_cs1_grp[] =3D {
> > +static struct mtmips_pmx_func rgmii_grp[] =3D { FUNC("rgmii", 0, 40, 1=
2) };
> > +static struct mtmips_pmx_func rt3352_lna_grp[] =3D { FUNC("lna", 0, 36=
, 2) };
> > +static struct mtmips_pmx_func rt3352_pa_grp[] =3D { FUNC("pa", 0, 38, =
2) };
...
> >                 return -EINVAL;
> >  }
> > diff --git a/drivers/pinctrl/ralink/pinctrl-rt3883.c b/drivers/pinctrl/=
mediatek/pinctrl-rt3883.c
> > similarity index 80%
...
> >  #define RT3883_GPIO_MODE_LNA_G         _RT3883_GPIO_MODE_LNA_G(RT3883_=
GPIO_MODE_LNA_G_MASK)
> >
> > -static struct ralink_pmx_func i2c_grp[] =3D  { FUNC("i2c", 0, 1, 2) };
> > -static struct ralink_pmx_func spi_grp[] =3D { FUNC("spi", 0, 3, 4) };
> > -static struct ralink_pmx_func uartf_grp[] =3D {
...
> > diff --git a/drivers/pinctrl/ralink/Kconfig b/drivers/pinctrl/ralink/Kc=
onfig
...
> > -
> > -endmenu
> > diff --git a/drivers/pinctrl/ralink/Makefile b/drivers/pinctrl/ralink/M=
akefile
> > deleted file mode 100644
