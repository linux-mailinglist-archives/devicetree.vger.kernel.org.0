...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6B2424C30E7
	for <lists+devicetree@lfdr.de>; Thu, 24 Feb 2022 17:03:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231250AbiBXQDr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 24 Feb 2022 11:03:47 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46272 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233851AbiBXQDh (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 24 Feb 2022 11:03:37 -0500
Received: from mx07-00178001.pphosted.com (mx08-00178001.pphosted.com [91.207.212.93])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ADC701A2768;
        Thu, 24 Feb 2022 08:02:51 -0800 (PST)
Received: from pps.filterd (m0046661.ppops.net [127.0.0.1])
        by mx07-00178001.pphosted.com (8.16.1.2/8.16.1.2) with ESMTP id 21OAGB8N025527;
        Thu, 24 Feb 2022 17:02:11 +0100
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=foss.st.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-transfer-encoding : content-type; s=selector1;
 bh=gfEK2z6lENZ5vSya0367Tl4gG2p1BCAQh5LY2WZhoj4=;
 b= vw== 
Received: from beta.dmz-eu.st.com (beta.dmz-eu.st.com [164.129.1.35])
        by mx07-00178001.pphosted.com (PPS) with ESMTPS id 3ee2sh47xe-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 24 Feb 2022 17:02:11 +0100
Received: from euls16034.sgp.st.com (euls16034.sgp.st.com [10.75.44.20])
        by beta.dmz-eu.st.com (STMicroelectronics) with ESMTP id 8D921100038;
        Thu, 24 Feb 2022 17:02:10 +0100 (CET)
Received: from Webmail-eu.st.com (sfhdag2node2.st.com [10.75.127.5])
        by euls16034.sgp.st.com (STMicroelectronics) with ESMTP id 7B12D22A6FC;
        Thu, 24 Feb 2022 17:02:10 +0100 (CET)
Received: from localhost (10.75.127.50) by SFHDAG2NODE2.st.com (10.75.127.5)
 with Microsoft SMTP Server (TLS) id 15.0.1497.26; Thu, 24 Feb 2022 17:02:09
 +0100
...
Subject: [PATCH 02/13] clk: stm32: Introduce STM32MP13 RCC drivers (Reset Clock Controller)
Date:   Thu, 24 Feb 2022 17:01:30 +0100
Message-ID: <20220224160141.455881-3-gabriel.fernandez@foss.st.com>
...
index 3cdf33470a75..5eaa17add136 100644
--- a/drivers/clk/Kconfig
+++ b/drivers/clk/Kconfig
@@ -349,6 +349,11 @@ config COMMON_CLK_VC5
...
index 6a98291350b6..07623056c4b1 100644
--- a/drivers/clk/Makefile
+++ b/drivers/clk/Makefile
@@ -112,6 +112,7 @@ obj-y					+= socfpga/
...
new file mode 100644
index 000000000000..6908c2fcd594
--- /dev/null
