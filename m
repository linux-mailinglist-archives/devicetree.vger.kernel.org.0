...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B9BA238DCEB
	for <lists+devicetree@lfdr.de>; Sun, 23 May 2021 22:39:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232031AbhEWUka (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 23 May 2021 16:40:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48470 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232057AbhEWUk2 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 23 May 2021 16:40:28 -0400
Received: from relay01.th.seeweb.it (relay01.th.seeweb.it [IPv6:2001:4b7a:2000:18::162])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5690AC061756
        for <devicetree@vger.kernel.org>; Sun, 23 May 2021 13:39:01 -0700 (PDT)
Received: from TimeMachine.localdomain (bband-dyn255.178-41-232.t-com.sk [178.41.232.255])
        by m-r1.th.seeweb.it (Postfix) with ESMTPA id DF546200E1;
        Sun, 23 May 2021 22:32:12 +0200 (CEST)
...
Subject: [PATCH 2/2] clk: qcom: Add SM6125 (TRINKET) GCC driver
Date:   Sun, 23 May 2021 22:32:00 +0200
Message-Id: <20210523203202.691900-2-martin.botka@somainline.org>
X-Mailer: git-send-email 2.31.1
In-Reply-To: <20210523203202.691900-1-martin.botka@somainline.org>
References: <20210523203202.691900-1-martin.botka@somainline.org>
MIME-Version: 1.0
...
---
 ...
 drivers/clk/qcom/gcc-sm6125.c               | 4198 +++++++++++++++++++
 include/dt-bindings/clock/qcom,gcc-sm6125.h |  240 ++
 4 files changed, 4446 insertions(+)
...
index 000000000000..fb237d158860
--- /dev/null
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_ahb_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_csiphy_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_cpp_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_csi0_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_csi1_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_csi2_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_csi3_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_vfe0_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_vfe1_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_gp0_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_gp1_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
...
+			.parent_data = &(const struct clk_parent_data){
+				.hw = &gcc_camss_jpeg_clk_src.clkr.hw,
+			},
+			.num_parents = 1,
+			.flags = CLK_SET_RATE_PARENT,
+			.ops = &clk_branch2_ops,
