...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7760A6038F8
	for <lists+devicetree@lfdr.de>; Wed, 19 Oct 2022 06:55:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229520AbiJSEzl (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 19 Oct 2022 00:55:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37688 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229437AbiJSEzk (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 19 Oct 2022 00:55:40 -0400
Received: from mga02.intel.com (mga02.intel.com [134.134.136.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AC8176704F;
        Tue, 18 Oct 2022 21:55:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1666155335; x=1697691335;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=Krl+nsBEosBnBCaiFIFP7q0Z9ooxFY8j/FuqJeDyJRk=;
  b=bbS++FPvmEMCOs3i0NjcT4CmAjYjG0PlI2Tve9hyT0kl/aTBsFXEqYQE
   tEVmaOOgE31gEv37Nm1DOfb3HuCEQKmHHkybw54VPmKSYb1l+hFQjcK3M
   7yXMEkd8seS/ZWqCwoxuvTcWnzfm8YsYFlrrfQZZSt5RiOU5hLEG5EVn/
   d2mYpOIkBeYy2SLfEy1+YTumyNT+bQRp3qDmfDB9Zs26vz5MB3MPU0cz8
   odT9HVe2/fcpoQRawd/LAGw5R/6Ejm2CMHbbJXIMbD8TiMz3gANQXNMHD
   6Xqdjnrb4oGuzKYSFKXWirGLso2L93kEDHy8XXOO2qlPGVmNTOPwMoBaa
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10504"; a="293701451"
X-IronPort-AV: E=Sophos;i="5.95,195,1661842800"; 
   d="scan'208";a="293701451"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga101.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 18 Oct 2022 21:55:34 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10504"; a="662262892"
X-IronPort-AV: E=Sophos;i="5.95,195,1661842800"; 
   d="scan'208";a="662262892"
Received: from lkp-server01.sh.intel.com (HELO 8381f64adc98) ([10.239.97.150])
  by orsmga001.jf.intel.com with ESMTP; 18 Oct 2022 21:55:29 -0700
Received: from kbuild by 8381f64adc98 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ol172-0002T1-35;
        Wed, 19 Oct 2022 04:55:28 +0000
Date:   Wed, 19 Oct 2022 12:54:42 +0800
...
Subject: Re: [PATCH v7 4/8] phy: fsl: Add Lynx 10G SerDes driver
Message-ID: <202210191233.UFitLbi3-lkp@intel.com>
References: <20221018231112.2142074-5-sean.anderson@seco.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="Bkabps9h/3v2J6ME"
Content-Disposition: inline
In-Reply-To: <20221018231112.2142074-5-sean.anderson@seco.com>
...
[also build test WARNING on clk/clk-next krzk/for-next krzk-dt/for-next linus/master v6.1-rc1 next-20221019]
[cannot apply to shawnguo/for-next]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Sean-Anderson/phy-Add-support-for-Lynx-10G-SerDes/20221019-071314
base:   https://git.kernel.org/pub/scm/linux/kernel/git/robh/linux.git for-next
patch link:    https://lore.kernel.org/r/20221018231112.2142074-5-sean.anderson%40seco.com
patch subject: [PATCH v7 4/8] phy: fsl: Add Lynx 10G SerDes driver
config: m68k-allmodconfig
compiler: m68k-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/61841850159f548e5ce4940701a4c75e9ff1a4b1
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Sean-Anderson/phy-Add-support-for-Lynx-10G-SerDes/20221019-071314
        git checkout 61841850159f548e5ce4940701a4c75e9ff1a4b1
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=m68k SHELL=/bin/bash drivers/phy/freescale/
...
All warnings (new ones prefixed by >>):
   ...
   drivers/phy/freescale/phy-fsl-lynx-10g.c: In function 'lynx_ls_mode_apply':
>> drivers/phy/freescale/phy-fsl-lynx-10g.c:1045:13: warning: variable 'base' set but not used [-Wunused-but-set-variable]
    1045 |         u32 base, pccr, off, shift, mask;
         |             ^~~~


vim +/base +1045 drivers/phy/freescale/phy-fsl-lynx-10g.c

  1040	
  1041	static void lynx_ls_mode_apply(struct lynx_priv *serdes,
  1042				       const struct lynx_mode *mode,
  1043				       enum lynx_protocol proto)
  1044	{
> 1045		u32 base, pccr, off, shift, mask;
  1046	
  1047		if (WARN_ON_ONCE(proto != LYNX_PROTO_NONE &&
  1048				 !(mode->protos & BIT(proto))))
  1049			return;
  1050		if (WARN_ON_ONCE(lynx_ls_pccr_params(mode, &off, &shift, &mask)))
  1051			return;
  1052	
  1053		dev_dbg(serdes->dev, "applying %s to PCCR%X.%s%c_CFG\n",
  1054			lynx_proto_str[proto], mode->pccr,
  1055			lynx_proto_str[__ffs(mode->protos)], 'A' + mode->idx);
  1056	
  1057		base = 0;
  1058		if (mode->protos & PROTO_MASK(SGMII))
  1059			base = LS_SGMII_BASE;
  1060		else if (mode->protos & PROTO_MASK(QSGMII))
  1061			base = LS_QSGMII_BASE;
  1062		else if (mode->protos & PROTO_MASK(XFI))
  1063			base = LS_XFI_BASE;
  1064	
  1065		pccr = lynx_read(serdes, off);
  1066		pccr &= ~(mask << shift);
  1067		if (proto != LYNX_PROTO_NONE)
  1068			pccr |= mode->cfg << shift;
  1069	
  1070		if (proto == LYNX_PROTO_1000BASEKX)
  1071			pccr |= PCCR8_SGMIIa_KX << shift;
  1072		lynx_write(serdes, pccr, off);
  1073	
  1074		if (mode->protos & PROTO_MASK(SGMII)) {
  1075			u32 cr1 = lynx_read(serdes, LS_SGMIIaCR1(mode->idx));
  1076	
  1077			cr1 &= ~SGMIIaCR1_SGPCS_EN;
  1078			cr1 |= proto == LYNX_PROTO_NONE ? 0 : SGMIIaCR1_SGPCS_EN;
  1079			lynx_write(serdes, cr1, LS_SGMIIaCR1(mode->idx));
  1080		}
  1081	}
  1082	
