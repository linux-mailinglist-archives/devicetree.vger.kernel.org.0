...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E58D5398A7C
	for <lists+devicetree@lfdr.de>; Wed,  2 Jun 2021 15:29:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229934AbhFBNbk (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 2 Jun 2021 09:31:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53618 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229927AbhFBNbh (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 2 Jun 2021 09:31:37 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0F4C3C061760
        for <devicetree@vger.kernel.org>; Wed,  2 Jun 2021 06:29:54 -0700 (PDT)
Received: from drehscheibe.grey.stw.pengutronix.de ([2a0a:edc0:0:c01:1d::a2])
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mtr@pengutronix.de>)
        id 1loQwS-0006lJ-89; Wed, 02 Jun 2021 15:29:52 +0200
Received: from [2a0a:edc0:0:1101:1d::39] (helo=dude03.red.stw.pengutronix.de)
        by drehscheibe.grey.stw.pengutronix.de with esmtp (Exim 4.92)
        (envelope-from <mtr@pengutronix.de>)
        id 1loQwR-0001rU-4O; Wed, 02 Jun 2021 15:29:51 +0200
Received: from mtr by dude03.red.stw.pengutronix.de with local (Exim 4.92)
        (envelope-from <mtr@pengutronix.de>)
        id 1loQwR-00HUC9-00; Wed, 02 Jun 2021 15:29:51 +0200
...
Subject: [PATCH v2 2/2] media: i2c: isl7998x: Add driver for Intersil ISL7998x
Date:   Wed,  2 Jun 2021 15:29:50 +0200
Message-Id: <20210602132950.4167596-3-m.tretter@pengutronix.de>
...
index 2d06dc43fe70..e6d4321825ee 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -9494,6 +9494,14 @@ L:	linux-iio@vger.kernel.org
...
index 462c0e059754..3b5c7bbad5a2 100644
--- a/drivers/media/i2c/Kconfig
+++ b/drivers/media/i2c/Kconfig
@@ -324,6 +324,15 @@ config VIDEO_BT866
...
index 0c067beca066..d832e6c3ffe6 100644
--- a/drivers/media/i2c/Makefile
+++ b/drivers/media/i2c/Makefile
@@ -124,6 +124,7 @@ obj-$(CONFIG_VIDEO_IMX290)	+= imx290.o
...
index 000000000000..c35e471ba81e
--- /dev/null
