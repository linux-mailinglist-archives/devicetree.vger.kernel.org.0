...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 26C8F4465CA
	for <lists+devicetree@lfdr.de>; Fri,  5 Nov 2021 16:30:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233604AbhKEPdW (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 5 Nov 2021 11:33:22 -0400
Received: from mx1.tq-group.com ([93.104.207.81]:26763 "EHLO mx1.tq-group.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S233582AbhKEPdU (ORCPT <rfc822;devicetree@vger.kernel.org>);
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  ...
  bh=PF5g0Hz3Y3uIGyouI716HEDKhKF5owjq6zvLUfPEe50=;
  b=qWwptLCqIUOYXFctJ6gD7umqkyq/gfQk+OG7KIVDkMBTj8ReGeYwFbew
   xnykLlp76ja2pnSs5cPX8CrdUAhWE2U4z8Ljzf9NraGIhCTQSQhbpmHI3
   mBM43+nr0nq8YDL6b9vdyI0EhPxwP0vwEG0Pwek+mU0r08ClGgNJKfoTE
   9uOmCMItpxWkUY+wwOlnY7g5cSKL4UGt6mLk6Jx4YqOGQpwt68175PFsx
   xDlhfq5xG2yQo/gh1N3lzAmNJ5cfpp5JCzrYJf1yvASrp89aOwt24/9Ip
   VMN1Ax2wHxh/fzttNUmhbYJnzfpVt4kFK3sI53wIvzyEsbYp6xQbPkC3O
   g==;
X-IronPort-AV: E=Sophos;i="5.87,212,1631570400"; 
   d="scan'208";a="20358806"
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  ...
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=PF5g0Hz3Y3uIGyouI716HEDKhKF5owjq6zvLUfPEe50=;
  b=GdJdHUdeLnazQdFlq9GZaNLQWXyaZzrjRBbj8gIoWXuV6Ejy6YPBRotk
   kp+63r0pQqPa+0SRDhetQCfjHXuM3xR1R556eZkDdhiVvhGP/7LTuWXQg
   td/5jFhUOHxw2lwqITBXwA+E+ObAoyF2pE8Mqdb2Kf/iv815LMlX06C81
   NexwCV++Qxu4wvkEp718qebUyJwOIWb6z2HuABORfJRZ+DAL5zSiLEWbp
   M/u3Gcp4l2bDg9XbcjiffEB1wmeK+epZpwt1Nnuq6KDJTycVM2aGdbCFv
   oVT94ui8eA0UinaBn2NUTebVHffhLQD7GvfPnG3kmRB1rappwwm2snah0
   w==;
X-IronPort-AV: E=Sophos;i="5.87,212,1631570400"; 
   d="scan'208";a="20358805"
Received: from vtuxmail01.tq-net.de ([10.115.0.20])
  by mx1.tq-group.com with ESMTP; 05 Nov 2021 16:30:35 +0100
Received: from steina-w.tq-net.de (unknown [10.123.49.12])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits))
        (No client certificate requested)
        by vtuxmail01.tq-net.de (Postfix) with ESMTPSA id D8995280075;
...
Subject: [PATCH v2 5/7] arm64: dts: freescale: add initial tree for TQMa8MQNL with i.MX8MN
Date:   Fri,  5 Nov 2021 16:30:23 +0100
Message-Id: <20211105153025.187106-6-alexander.stein@ew.tq-group.com>
...
index 000000000000..7a7e0c8f9260
--- /dev/null
...
+	};
+
+	pinctrl_usb0hub_sel: usb0hub_selgrp {
+		fsl,pins = <
+			/* SEL_USB_HUB_B */
...
new file mode 100644
index 000000000000..718eb359dcd0
--- /dev/null
