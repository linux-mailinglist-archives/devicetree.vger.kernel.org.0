...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A579B6AD759
	for <lists+devicetree@lfdr.de>; Tue,  7 Mar 2023 07:24:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229792AbjCGGYm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 7 Mar 2023 01:24:42 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56412 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230473AbjCGGYf (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 7 Mar 2023 01:24:35 -0500
Received: from mx0a-0031df01.pphosted.com (mx0a-0031df01.pphosted.com [205.220.168.131])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6D9807C9DE;
        Mon,  6 Mar 2023 22:24:00 -0800 (PST)
Received: from pps.filterd (m0279865.ppops.net [127.0.0.1])
        by mx0a-0031df01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 3276Dd1w006553;
        Tue, 7 Mar 2023 06:23:25 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=quicinc.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=qcppdkim1;
 bh=ovkrWL+gtGsLSxR+WyrxXK8O2tMARSwIcus2+tlIKvU=;
 b= og== 
Received: from nalasppmta03.qualcomm.com (Global_NAT1.qualcomm.com [129.46.96.20])
        by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 3p419d7247-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Tue, 07 Mar 2023 06:23:24 +0000
Received: from nalasex01a.na.qualcomm.com (nalasex01a.na.qualcomm.com [10.47.209.196])
        by NALASPPMTA03.qualcomm.com (8.17.1.5/8.17.1.5) with ESMTPS id 3276NOVd023166
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Tue, 7 Mar 2023 06:23:24 GMT
Received: from kathirav-linux.qualcomm.com (10.80.80.8) by
 nalasex01a.na.qualcomm.com (10.47.209.196) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.41; Mon, 6 Mar 2023 22:23:16 -0800
...
Subject: [PATCH V6 4/9] clk: qcom: add Global Clock controller (GCC) driver for IPQ5332 SoC
Date:   Tue, 7 Mar 2023 11:52:27 +0530
Message-ID: <20230307062232.4889-5-quic_kathirav@quicinc.com>
...
X-Proofpoint-ORIG-GUID: srFceVVM0U4Mh2Kj4qywaVGSBuunnAPf
X-Proofpoint-GUID: srFceVVM0U4Mh2Kj4qywaVGSBuunnAPf
...
---
Changes in V6:
	- Updated the commit message that we are re-using the Stromer
	  PLL ops for Stromer Plus PLL as well

Changes in V5:
	- There was one instance where the parent_names is used, replaced
	  that parent_hws

Changes in V4:
	- Used clk_regmap_phy_mux and its corresponding ops
	  clk_regmap_phy_mux_ops for USB and PCIE pipe clocks
	- Due to the above change, removed the unused the parent_data
	  and
