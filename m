...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 42B23746FA8
	for <lists+devicetree@lfdr.de>; Tue,  4 Jul 2023 13:14:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231634AbjGDLOw (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 4 Jul 2023 07:14:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35522 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231503AbjGDLN7 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 4 Jul 2023 07:13:59 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CCBA410D2;
        Tue,  4 Jul 2023 04:13:47 -0700 (PDT)
X-UUID: d3cf29281a5b11eeb20a276fd37b9834-20230704
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=y5dVlxcxfena/4JZ0NBg3G5pO5bgrTZC1vosztSuh9g=;
        b=YP84i+TiZqZIxJJr1rt5zIHw09Rx7fH/jlaAMlR44KJ+1pv3VgJvdgjcOsvo8C/NhKa0NYQtyNFF2I9QvJxB/Cx1GjQvHkH1nOU9E20MvOWqcIuWzF4CEcp5aAGhjXp3V1REGPwA4Jl+LRtXu9ITB+5FfOuFxMcvXMuZpPvw/O8=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.27,REQID:c2d5316a-52e6-490d-b2e1-a189683fd562,IP:0,U
        RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Release_Ham,ACTI
        ON:release,TS:70
X-CID-INFO: VERSION:1.1.27,REQID:c2d5316a-52e6-490d-b2e1-a189683fd562,IP:0,URL
        :0,TC:0,Content:-25,EDM:0,RT:0,SF:95,FILE:0,BULK:0,RULE:Spam_GS981B3D,ACTI
        ON:quarantine,TS:70
X-CID-META: VersionHash:01c9525,CLOUDID:7f979cda-b4fa-43c8-9c3e-0d3fabd03ec0,B
        ulkID:2307041913420BYZHJKW,BulkQuantity:0,Recheck:0,SF:48|38|29|28|17|19,T
...
Received: from mtkmbs14n1.mediatek.inc [(172.21.101.75)] by mailgw02.mediatek.com
        ...
        with ESMTP id 1744582051; Tue, 04 Jul 2023 19:13:39 +0800
Received: from mtkmbs13n2.mediatek.inc (172.21.101.108) by
 MTKMBS14N2.mediatek.inc (172.21.101.76) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26; Tue, 4 Jul 2023 19:13:37 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkmbs13n2.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.2.1118.26 via Frontend Transport; Tue, 4 Jul 2023 19:13:37 +0800
...
Subject: [PATCH v5,08/11] media: mediatek: vcodec: separate struct mtk_vcodec_dev
Date:   Tue, 4 Jul 2023 19:13:24 +0800
Message-ID: <20230704111327.7140-9-yunfei.dong@mediatek.com>
...
index dd835baea099..983a83f7b640 100644
...
+	struct mtk_vcodec_dec_dev *dev;
 	...
 	struct v4l2_fh fh;
@@ -134,6 +204,84 @@ struct mtk_vcodec_dec_ctx {
...
index 34f25a6c8339..4662b7871f74 100644
...
index 1a77b9b39894..1c63fbbec653 100644
...
index 92a4c2fca780..f6eba7163fdf 100644
...
index d70ad171fa16..27fe2363373a 100644
...
@@ -86,10 +86,10 @@ extern int mtk_vcodec_dbg;
