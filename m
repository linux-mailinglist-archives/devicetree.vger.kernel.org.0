...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C99F26F1A4C
	for <lists+devicetree@lfdr.de>; Fri, 28 Apr 2023 16:16:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229470AbjD1OQQ (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 28 Apr 2023 10:16:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33350 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230070AbjD1OQP (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 28 Apr 2023 10:16:15 -0400
Received: from madras.collabora.co.uk (madras.collabora.co.uk [46.235.227.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EF840269F;
        Fri, 28 Apr 2023 07:16:10 -0700 (PDT)
Received: from nicolas-tpx395.localdomain (mtl.collabora.ca [66.171.169.34])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        (Authenticated sender: nicolas)
        by madras.collabora.co.uk (Postfix) with ESMTPSA id A487766032CE;
        Fri, 28 Apr 2023 15:16:07 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1682691369;
        bh=Cbc4ZNlBxx+LjPIl0mC4EvJNU2+c8Mkn/YOXgEHADjM=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Message-ID: <66a762390a84ed06fbbf8bd62578d8713deae601.camel@collabora.com>
...
Date:   Fri, 28 Apr 2023 10:15:59 -0400
...
Le vendredi 28 avril 2023 =C3=A0 16:23 +0800, Yunfei Dong a =C3=A9crit=C2=
=A0:
...
I have reproduced these results on Debian with a GStreamer main. Though, yo=
u
forgot to mention your dependency. Would it be possible to make a v3 and si=
mply
includes Benjamin's patch in your series, it will make this much simpler fo=
r
everyone, and will fix the build issues of course. Don't forget to apply my=
 R-b
for that patch.=20
...
Dep:
media: uapi: HEVC: Add num_delta_pocs_of_ref_rps_idx field=20
https://patchwork.linuxtv.org/project/linux-media/list/?series=3D10330
