...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DC3ED607734
	for <lists+devicetree@lfdr.de>; Fri, 21 Oct 2022 14:46:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230035AbiJUMqP (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 21 Oct 2022 08:46:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41240 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229862AbiJUMqJ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 21 Oct 2022 08:46:09 -0400
Received: from relay3-d.mail.gandi.net (relay3-d.mail.gandi.net [IPv6:2001:4b98:dc4:8::223])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 952DF2623EB;
        Fri, 21 Oct 2022 05:46:05 -0700 (PDT)
Received: (Authenticated sender: maxime.chevallier@bootlin.com)
        by mail.gandi.net (Postfix) with ESMTPSA id 6EFFA60013;
        Fri, 21 Oct 2022 12:46:02 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=bootlin.com; s=gm1;
        ...
        bh=4W1I7xZ+sHLUyW4VYua4YIhtPpvwR7zlbE2GJhU9RsI=;
        b=
...
Subject: [PATCH net-next v5 2/5] net: ipqess: introduce the Qualcomm IPQESS driver
Date:   Fri, 21 Oct 2022 14:45:53 +0200
Message-Id: <20221021124556.100445-3-maxime.chevallier@bootlin.com>
...
V1->V2 :
 ...
 drivers/net/ethernet/qualcomm/ipqess/ipqess.c | 1263 +++++++++++++++++
...
new file mode 100644
index 000000000000..b23e7d776cd0
--- /dev/null
...
+}
+
+static int ipqess_request_and_map(struct platform_device *pdev, int num,
+			   void __iomem **ptr)
+{
+	struct resource *res;
+
...
+
+	err = ipqess_request_and_map(pdev, 0, &ess->hw_addr);
+	if (err)
+		return err;
+
