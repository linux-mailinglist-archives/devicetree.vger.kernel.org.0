...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BB29E51D659
	for <lists+devicetree@lfdr.de>; Fri,  6 May 2022 13:13:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1391227AbiEFLQv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 6 May 2022 07:16:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48816 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1391228AbiEFLQm (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 6 May 2022 07:16:42 -0400
Received: from NAM10-DM6-obe.outbound.protection.outlook.com (mail-dm6nam10on2080.outbound.protection.outlook.com [40.107.93.80])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DE994689AB;
        Fri,  6 May 2022 04:12:55 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=7s2TaTSLfMBzqyK/pcrXlDmgoFd69/BBXAifG5bVnvs=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=Nvidia.com;
 ...
 bh=7s2TaTSLfMBzqyK/pcrXlDmgoFd69/BBXAifG5bVnvs=;
 b=
...
Received: from DM6NAM11FT014.eop-nam11.prod.protection.outlook.com
 (2603:10b6:5:1f4:cafe::d3) by DM6PR02CA0093.outlook.office365.com
 (2603:10b6:5:1f4::34) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.5206.24 via Frontend
 Transport; Fri, 6 May 2022 11:12:51 +0000
...
Received: from mail.nvidia.com (12.22.5.235) by
 ...
 15.20.5227.15 via Frontend Transport; Fri, 6 May 2022 11:12:50 +0000
Received: from drhqmail202.nvidia.com (10.126.190.181) by
 DRHQMAIL107.nvidia.com (10.27.9.16) with Microsoft SMTP Server (TLS) id
 15.0.1497.32; Fri, 6 May 2022 11:12:50 +0000
Received: from drhqmail201.nvidia.com (10.126.190.180) by
 drhqmail202.nvidia.com (10.126.190.181) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.22; Fri, 6 May 2022 04:12:48 -0700
Received: from sumitg-l4t.nvidia.com (10.127.8.10) by mail.nvidia.com
 (10.126.190.180) with Microsoft SMTP Server id 15.2.986.22 via Frontend
 Transport; Fri, 6 May 2022 04:12:45 -0700
...
Subject: [Patch v5 5/9] soc: tegra: cbb: Add CBB1.0 driver for Tegra194
Date:   Fri, 6 May 2022 16:42:13 +0530
Message-ID: <20220506111217.8833-6-sumitg@nvidia.com>
...
X-MS-Office365-Filtering-Correlation-Id: e8a834a8-26f0-4b3b-5e87-08da2f515c2b
X-MS-TrafficTypeDiagnostic: CY4PR12MB1367:EE_
X-Microsoft-Antispam-PRVS: <CY4PR12MB13679A1431DE9B456BFB70BCB9C59@CY4PR12MB1367.namprd12.prod.outlook.com>
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-Forefront-Antispam-Report: CIP:12.22.5.235;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:mail.nvidia.com;PTR:InfoNoRecords;CAT:NONE;SFS:(13230001)(4636009)(36840700001)(40470700004)(46966006)(107886003)(5660300002)(30864003)(7696005)(26005)(6666004)(1076003)(2616005)(8936002)(36756003)(426003)(186003)(336012)(47076005)(2906002)(83380400001)(82310400005)(81166007)(54906003)(36860700001)(508600001)(70586007)(86362001)(110136005)(356005)(40460700003)(70206006)(8676002)(316002)(4326008)(36900700001)(559001)(579004);DIR:OUT;SFP:1101;
X-OriginatorOrg: Nvidia.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 06 May 2022 11:12:50.9830
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: e8a834a8-26f0-4b3b-5e87-08da2f515c2b
...
index 5725c8ef0406..65283a93e78f 100644
--- a/drivers/soc/tegra/Kconfig
+++ b/drivers/soc/tegra/Kconfig
@@ -162,3 +162,12 @@ config SOC_TEGRA30_VOLTAGE_COUPLER
...
new file mode 100644
index 000000000000..f1c8b2dcb0a8
--- /dev/null
...
new file mode 100644
index 000000000000..540bc12c9810
--- /dev/null
...
new file mode 100644
index 000000000000..112c1c1bbf5c
--- /dev/null
...
new file mode 100644
index 000000000000..c22fcd4626de
--- /dev/null
