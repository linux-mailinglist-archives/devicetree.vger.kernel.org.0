...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C87BE631A4
	for <lists+devicetree@lfdr.de>; Tue,  9 Jul 2019 09:11:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725947AbfGIHLh (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 9 Jul 2019 03:11:37 -0400
Received: from metis.ext.pengutronix.de ([85.220.165.71]:56599 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725886AbfGIHLg (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 9 Jul 2019 03:11:36 -0400
Received: from pty.hi.pengutronix.de ([2001:67c:670:100:1d::c5])
        by metis.ext.pengutronix.de with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mfe@pengutronix.de>)
        id 1hkkHf-000471-Iw; Tue, 09 Jul 2019 09:11:27 +0200
Received: from mfe by pty.hi.pengutronix.de with local (Exim 4.89)
        (envelope-from <mfe@pengutronix.de>)
        id 1hkkHd-0005KD-8O; Tue, 09 Jul 2019 09:11:25 +0200
Date:   Tue, 9 Jul 2019 09:11:25 +0200
...
Subject: Re: [PATCH v2 1/1] ARM: dts: colibri: introduce dts with UHS-I
 support enabled
Message-ID: <20190709071125.kdbgir2oz2mv35g6@pengutronix.de>
References: <20190514143826.7331-1-igor.opaniuk@toradex.com>
 ...
 <90825d175c78f932c3b406c2f376f1b17d583c40.camel@toradex.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <90825d175c78f932c3b406c2f376f1b17d583c40.camel@toradex.com>
X-Sent-From: Pengutronix Hildesheim
X-URL:  http://www.pengutronix.de/
X-IRC:  #ptxdist @freenode
X-Accept-Language: de,en
X-Accept-Content-Type: text/plain
X-Uptime: 08:56:52 up 52 days, 13:15, 50 users,  load average: 0.00, 0.05,
 0.03
...
It was just a nitpick. It seems that there isn't a common way.
...
I mean the links mentioned by [1] and [2].
...
Then the 'no-1-8-v' should be moved to the v1.0 dts.
...
I understand that but going your way isn't the best to share future
fixes. Imagine a customer fixes the v1.1 and only the v1.1 but this fix
also applies to the v1.0. So the next customer have to debug the bug a
second time for the v1.0. Now it's get even worse if there is a possible
v1.3. IMHO we should share the common code since the only difference is
the 1.8V eMMC rail but that's up to Shawn.
