...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8FE8A53CCB2
	for <lists+devicetree@lfdr.de>; Fri,  3 Jun 2022 17:54:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1343495AbiFCPyN (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Jun 2022 11:54:13 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56118 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238696AbiFCPyL (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 3 Jun 2022 11:54:11 -0400
Received: from smtpout1.mo528.mail-out.ovh.net (smtpout1.mo528.mail-out.ovh.net [46.105.34.251])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 823FCBE04;
        Fri,  3 Jun 2022 08:54:07 -0700 (PDT)
Received: from pro2.mail.ovh.net (unknown [10.108.20.220])
        by mo528.mail-out.ovh.net (Postfix) with ESMTPS id DDC5610791217;
...
Subject: [PATCH v2 1/3] dt-bindings: leds: Add bindings for the TLC5925 controller
Date:   Fri, 3 Jun 2022 17:53:30 +0200
Message-ID: <20220603155332.112272-2-jjhiblot@traphandler.com>
...
X-ClientProxiedBy: DAG8EX1.emp2.local (172.16.2.81) To DAG1EX2.emp2.local
 (172.16.2.2)
X-Ovh-Tracer-Id: 3358840898065283547
X-VR-SPAMSTATE: OK
X-VR-SPAMSCORE: 0
X-VR-SPAMCAUSE: 
