...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C9CC942129
	for <lists+devicetree@lfdr.de>; Wed, 12 Jun 2019 11:39:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2437531AbfFLJjc (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 12 Jun 2019 05:39:32 -0400
Received: from metis.ext.pengutronix.de ([85.220.165.71]:49423 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2437593AbfFLJjc (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 12 Jun 2019 05:39:32 -0400
Received: from dude02.hi.pengutronix.de ([2001:67c:670:100:1d::28] helo=dude02.pengutronix.de.)
        by metis.ext.pengutronix.de with esmtp (Exim 4.92)
        (envelope-from <p.zabel@pengutronix.de>)
        id 1haziy-00053v-VG; Wed, 12 Jun 2019 11:39:21 +0200
...
Subject: [PATCH v5 01/10] rockchip/vpu: rename from rockchip to hantro
Date:   Wed, 12 Jun 2019 11:39:06 +0200
Message-Id: <20190612093915.18973-2-p.zabel@pengutronix.de>
...
[1] https://patchwork.linuxtv.org/patch/56807/
---
 MAINTAINERS                                   |   4 +-
 ...
 31 files changed, 1572 insertions(+), 1561 deletions(-)
...
index 6a3bac28ebb4..29cca8aabf19 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
@@ -551,7 +549,7 @@ static int rockchip_attach_func(struct rockchip_vpu_dev *vpu,
 	return ret;
 }
...
@@ -619,26 +616,26 @@ static int rockchip_vpu_add_func(struct rockchip_vpu_dev *vpu,
 	return ret;
 }
...
@@ -816,15 +813,15 @@ static int rockchip_vpu_probe(struct platform_device *pdev)
 	return ret;
 }
...
index 8bc709ab13be..b4af8c659a98 100644
