...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F1CC45EF57E
	for <lists+devicetree@lfdr.de>; Thu, 29 Sep 2022 14:33:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235111AbiI2Mdm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 29 Sep 2022 08:33:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54406 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234939AbiI2Mdl (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 29 Sep 2022 08:33:41 -0400
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B9899156256;
        Thu, 29 Sep 2022 05:33:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1664454816; x=1695990816;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=Iex+c85p6tYX6xhLCTAZXey2e5OSS3rYlgS16v15zLY=;
  b=h5BR9d+dEaQnNs5ACyJJ91ajCGSP4/sWk6j+gjUO0Wz+OMYNV2e4/nWS
   k86yq584DsYyPmerggJd3qILa+26Necr5LXGB6C15vo49tb3qbliSPtHL
   ybHdMpjwWqQUTP+2LpIa0c/OoC11dcRgtdZXmxiuaoupN3SroQEFplPUQ
   Tkov0HXiBtd6IjUR8gE7af7oYq4Ncr+T5qlgWCbT7N9+RNex8Vt5rKiEV
   olEAs52toQcjUoWw6Pwb+ZnHdG8c4gmN3DyVRol1KSkuYJNsX6kzG/ItV
   QyVPFlKG2BWL6v3EWGwZl6qquTw4v3PXPfu9fByIKsUpfOnhhGfZkobDP
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10485"; a="363722238"
X-IronPort-AV: E=Sophos;i="5.93,355,1654585200"; 
   d="scan'208";a="363722238"
Received: from orsmga006.jf.intel.com ([10.7.209.51])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 29 Sep 2022 05:33:36 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10485"; a="599981581"
X-IronPort-AV: E=Sophos;i="5.93,355,1654585200"; 
   d="scan'208";a="599981581"
Received: from lkp-server01.sh.intel.com (HELO 6126f2790925) ([10.239.97.150])
  by orsmga006.jf.intel.com with ESMTP; 29 Sep 2022 05:33:32 -0700
Received: from kbuild by 6126f2790925 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1odsjL-00017h-35;
        Thu, 29 Sep 2022 12:33:31 +0000
Date:   Thu, 29 Sep 2022 20:33:01 +0800
From:   kernel test robot <lkp@intel.com>
To:     ChiaEn Wu <peterwu.pub@gmail.com>, sre@kernel.org,
        robh+dt@kernel.org, krzysztof.kozlowski+dt@linaro.org
Cc:     kbuild-all@lists.01.org, chiaen_wu@richtek.com,
        cy_huang@richtek.com, devicetree@vger.kernel.org,
        linux-kernel@vger.kernel.org, linux-pm@vger.kernel.org
Subject: Re: [PATCH 2/2] power: supply: rt9467: Add Richtek RT9467 charger
 driver
Message-ID: <202209292005.F0cdvllR-lkp@intel.com>
References: <7b33a6ad1f2d41bf75726f202158d334127afed6.1664475743.git.chiaen_wu@richtek.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="KqIGMcP8Ce2GVAoD"
Content-Disposition: inline
In-Reply-To: <7b33a6ad1f2d41bf75726f202158d334127afed6.1664475743.git.chiaen_wu@richtek.com>
...
[also build test ERROR on robh/for-next linus/master v6.0-rc7 next-20220928]
...
reproduce (this is a W=1 build):
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=sh SHELL=/bin/bash drivers/power/
...
>> drivers/power/supply/rt9467-charger.c:436:43: error: implicit declaration of function 'FIELD_PREP' [-Werror=implicit-function-declaration]
     436 |         reg_val = RT9467_MASK_ADC_START | FIELD_PREP(RT9467_MASK_ADC_IN_SEL, adc_sel);
         |                                           ^~~~~~~~~~
   drivers/power/supply/rt9467-charger.c: At top level:
...
vim +/FIELD_PREP +436 drivers/power/supply/rt9467-charger.c

   416	
   417	static int rt9467_get_adc_raw_data(struct rt9467_chg_data *data,
   418					   enum rt9467_adc_chan chan, int *val)
   419	{
   420		unsigned int adc_stat, reg_val, adc_sel;
   421		__be16 chan_raw_data;
   422		int ret;
   423	
   424		mutex_lock(&data->adc_lock);
   425	
   426		ret = rt9467_get_adc_sel(chan, &adc_sel);
   427		if (ret)
   428			goto adc_unlock;
   429	
   430		ret = regmap_write(data->regmap, RT9467_REG_CHG_ADC, 0);
   431		if (ret) {
   432			dev_err(data->dev, "Failed to clear ADC enable\n");
   433			goto adc_unlock;
   434		}
   435	
 > 436		reg_val = RT9467_MASK_ADC_START | FIELD_PREP(RT9467_MASK_ADC_IN_SEL, adc_sel);
   437		ret = regmap_write(data->regmap, RT9467_REG_CHG_ADC, reg_val);
   438		if (ret)
   439			goto adc_unlock;
   440	
   441		/* Minimum wait time for one channel processing */
   442		msleep(RT9467_ADCCONV_TIME_MS);
   443	
   444		ret = regmap_read_poll_timeout(data->regmap, RT9467_REG_CHG_ADC,
   445					       adc_stat,
   446					       !(adc_stat & RT9467_MASK_ADC_START),
   447					       MILLI, RT9467_ADCCONV_TIME_MS * MILLI);
   448		if (ret) {
   449			dev_err(data->dev, "Failed to wait ADC conversion, chan = %d\n", chan);
   450			goto adc_unlock;
   451		}
   452	
   453		ret = regmap_raw_read(data->regmap, RT9467_REG_ADC_DATA_H,
   454				      &chan_raw_data, sizeof(chan_raw_data));
   455		if (ret)
   456			goto adc_unlock;
   457	
   458		*val = be16_to_cpu(chan_raw_data);
   459	
   460	adc_unlock:
   461		mutex_unlock(&data->adc_lock);
   462		return ret;
   463	}
   464	
