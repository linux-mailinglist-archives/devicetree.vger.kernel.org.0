...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0AAEB2D80F3
	for <lists+devicetree@lfdr.de>; Fri, 11 Dec 2020 22:20:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2395459AbgLKVRg (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 11 Dec 2020 16:17:36 -0500
Received: from hqnvemgate25.nvidia.com ([216.228.121.64]:7575 "EHLO
        hqnvemgate25.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2393412AbgLKVRd (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 11 Dec 2020 16:17:33 -0500
Received: from hqmail.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate25.nvidia.com (using TLS: TLSv1.2, AES256-SHA)
        id <B5fd3e19c0002>; Fri, 11 Dec 2020 13:16:12 -0800
Received: from HQMAIL107.nvidia.com (172.20.187.13) by HQMAIL111.nvidia.com
 (172.20.187.18) with Microsoft SMTP Server (TLS) id 15.0.1473.3; Fri, 11 Dec
 2020 21:16:09 +0000
Received: from skomatineni-linux.nvidia.com (172.20.145.6) by mail.nvidia.com
 (172.20.187.13) with Microsoft SMTP Server id 15.0.1473.3 via Frontend
 Transport; Fri, 11 Dec 2020 21:16:09 +0000
...
Subject: [PATCH v3 4/9] spi: tegra210-quad: Add support for Tegra210 QSPI controller
Date:   Fri, 11 Dec 2020 13:15:58 -0800
Message-ID: <1607721363-8879-5-git-send-email-skomatineni@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1607721372; bh=77jdLySd5GdHuB4uFXFwPc/3uSoL8j6RP6uzpk/2U08=;
        h=From:To:CC:Subject:Date:Message-ID:X-Mailer:In-Reply-To:
         References:X-NVConfidentiality:MIME-Version:Content-Type;
        b=
Precedence: bulk
