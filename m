...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A2D472D6183
	for <lists+devicetree@lfdr.de>; Thu, 10 Dec 2020 17:19:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388940AbgLJQSC (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 10 Dec 2020 11:18:02 -0500
Received: from gproxy6-pub.mail.unifiedlayer.com ([67.222.39.168]:44116 "EHLO
        gproxy6-pub.mail.unifiedlayer.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S2388671AbgLJQRz (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Thu, 10 Dec 2020 11:17:55 -0500
Received: from cmgw12.unifiedlayer.com (unknown [10.9.0.12])
        by gproxy6.mail.unifiedlayer.com (Postfix) with ESMTP id E34971E064E
        for <devicetree@vger.kernel.org>; Thu, 10 Dec 2020 09:16:55 -0700 (MST)
Received: from bh-25.webhostbox.net ([208.91.199.152])
        by cmsmtp with ESMTP
        id nOchkmR0ueMJHnOchkrqO6; Thu, 10 Dec 2020 09:16:55 -0700
X-Authority-Reason: nr=8
X-Authority-Analysis: v=2.3 cv=f4tm+t6M c=1 sm=1 tr=0
 a=QNED+QcLUkoL9qulTODnwA==:117 a=2cfIYNtKkjgZNaOwnGXpGw==:17
 a=dLZJa+xiwSxG16/P+YVxDGlgEgI=:19 a=kj9zAlcOel0A:10:nop_charset_1
 a=zTNgK-yGK50A:10:nop_rcvd_month_year
 a=evQFzbml-YQA:10:endurance_base64_authed_username_1 a=V2NxCb60AAAA:8
 a=lJyPgkyEAnqkhevhilYA:9 a=7Zwj6sZBwVKJAoWSPKxL6X1jA+E=:19
 a=CjuIK1q_8ugA:10:nop_charset_2 a=OJAZQCPpPQ8A:10:nop_election2020_name_body
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=Oktn7yjZxdHiyg5IJcVi0ib2L/AUwp3DueaU/Yqi01k=; b=RfYX4uwcKi+yX+FzrM/TJ44heg
        ;
Received: from 108-223-40-66.lightspeed.sntcca.sbcglobal.net ([108.223.40.66]:59936 helo=localhost)
        by bh-25.webhostbox.net with esmtpsa  (TLS1.2) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
        (Exim 4.93)
        (envelope-from <linux@roeck-us.net>)
        id 1knOcg-000qjR-HI; Thu, 10 Dec 2020 16:16:54 +0000
Date:   Thu, 10 Dec 2020 08:16:53 -0800
...
X-Source-L: No
X-Exim-ID: 1knOcg-000qjR-HI
X-Source: 
X-Source-Args: 
X-Source-Dir: 
X-Source-Sender: 108-223-40-66.lightspeed.sntcca.sbcglobal.net (localhost) [108.223.40.66]:59936
