...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 58070229040
	for <lists+devicetree@lfdr.de>; Wed, 22 Jul 2020 07:58:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728539AbgGVF6g (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 22 Jul 2020 01:58:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57326 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726147AbgGVF6f (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 22 Jul 2020 01:58:35 -0400
Received: from mail-pf1-x441.google.com (mail-pf1-x441.google.com [IPv6:2607:f8b0:4864:20::441])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A4715C061794
        for <devicetree@vger.kernel.org>; Tue, 21 Jul 2020 22:58:35 -0700 (PDT)
Received: by mail-pf1-x441.google.com with SMTP id j20so608436pfe.5
        for <devicetree@vger.kernel.org>; Tue, 21 Jul 2020 22:58:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=aFWJMahmFGP6ghcHwePgHtxNBd4G899f/GVNoXHgHzU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=aFWJMahmFGP6ghcHwePgHtxNBd4G899f/GVNoXHgHzU=;
        b=
X-Gm-Message-State: AOAM532+JNFUA6DIGsQpKqRyT7fc5e/DynX/RHvIAg9ZnX7WyKwYvws7
        4HyiF078UsqPavScyqCCba0i0A==
X-Google-Smtp-Source: ABdhPJwSZIQn3/XXuSYj1YQlsewOBd8w3N0b4SCFGuSJFF1Tt0+oaY+pP5B6rfS9tzTTPG27i5PL2g==
X-Received: by 2002:a62:79cd:: with SMTP id u196mr26442904pfc.152.1595397514829;
        Tue, 21 Jul 2020 22:58:34 -0700 (PDT)
Received: from nagraj.local ([49.206.21.239])
        by smtp.gmail.com with ESMTPSA id e191sm22144010pfh.42.2020.07.21.22.58.30
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 21 Jul 2020 22:58:33 -0700 (PDT)
...
Subject: [PATCH v2 2/2] drm: panel: Add tianma nt36672a panel driver
Date:   Wed, 22 Jul 2020 11:28:16 +0530
Message-Id: <20200722055816.20768-3-sumit.semwal@linaro.org>
...
index 000000000000..0af3a6ff5d55
--- /dev/null
...
+
+	/*
+	 * As per downstream kernel, Reset sequence of Tianma nt36672a panel requires the panel to be
+	 * out of reset for 10ms, followed by being held in reset for 10ms. But for Android / AOSP,
+	 * we needed to bump it upto 200ms otherwise we get white screen sometimes.
