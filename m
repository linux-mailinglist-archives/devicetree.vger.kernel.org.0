...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 751B3270E6D
	for <lists+devicetree@lfdr.de>; Sat, 19 Sep 2020 16:13:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726411AbgISONy (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 19 Sep 2020 10:13:54 -0400
Received: from mail.kernel.org ([198.145.29.99]:46928 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726159AbgISONy (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Sat, 19 Sep 2020 10:13:54 -0400
Received: from localhost.localdomain (unknown [194.230.155.191])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 0129221481;
        Sat, 19 Sep 2020 14:13:47 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1600524832;
        bh=zWfXu843Q3z+K7zRtLFY99YGmjbqcA8YA1GBJ+A01so=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=1JoIMMqckQ0eP08ttXka7G+jCZg8I0Xpy1zDcdC0n7HwDaEaIgg4yfAjVT1mHfx73
         3IGZWOEwqLh/2KjENus0p6hQuzSUgPccKOomRHniVDQlFvQmIbBpaLOqDDsK9PxDec
         bc/Vbo86722bhkSuDGVA/7t1KejnUYqaXAnSPmF4=
...
Subject: [PATCH v2 2/3] arm64: dts: imx8mn-var-som: Add Variscite VAR-SOM-MX8MN System on Module
Date:   Sat, 19 Sep 2020 16:13:31 +0200
Message-Id: <20200919141332.5095-2-krzk@kernel.org>
...
2. Set PMIC interrupt as edge rising which is not strictly correct, but
   it seems to not cause IRQ storm and matches previous GPIO_ACTIVE_LOW
   incorrect flag. I reached to Variscite but did not get proper answer
   except "there should be a pull up", which does not work in reality.
