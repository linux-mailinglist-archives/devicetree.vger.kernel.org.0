...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 103E61AFEF7
	for <lists+devicetree@lfdr.de>; Mon, 20 Apr 2020 01:48:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725953AbgDSXsU (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 19 Apr 2020 19:48:20 -0400
Received: from mail-bn8nam11on2047.outbound.protection.outlook.com ([40.107.236.47]:38800
        "EHLO NAM11-BN8-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1725834AbgDSXsU (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Sun, 19 Apr 2020 19:48:20 -0400
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=Kf3/fRiIm/SxE7tdhTxjGWhcK6U4IMJcLjNQDu69Faw=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=Kf3/fRiIm/SxE7tdhTxjGWhcK6U4IMJcLjNQDu69Faw=;
 b=l24SVE8q1U7UCM0J4d2xdVxYrv01qSZjttLdFcpy3Y1HBVd5YTbjUReNSPRRv9IGDPjcrx/kF8wjSVOFXW/5AElg4w4QcSec7WqR7stoPleYIr0hK854af8teglJ2FhaQs7w3ccVTDRQgmopaKh7Bug/wHV25yBaUPCrqOVVKOg=
...
Subject: [PATCH 2/2] input: misc: Add support for Azoteq IQS269A
Date:   Sun, 19 Apr 2020 18:47:48 -0500
Message-Id: <1587340068-2818-2-git-send-email-jeff@labundy.com>
...
Received: from localhost.localdomain (136.49.227.119) by DM5PR12CA0059.namprd12.prod.outlook.com (2603:10b6:3:103::21) with Microsoft SMTP Server (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256) id 15.20.2921.27 via Frontend Transport; Sun, 19 Apr 2020 23:48:07 +0000
X-Mailer: git-send-email 2.7.4
X-Originating-IP: [136.49.227.119]
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 7d3098e3-ce28-4924-d057-08d7e4bc1c5c
X-MS-TrafficTypeDiagnostic: SN6PR08MB4672:
X-MS-Exchange-Transport-Forked: True
X-Microsoft-Antispam-PRVS: <SN6PR08MB46724BC2574725F088ADC138D3D70@SN6PR08MB4672.namprd08.prod.outlook.com>
X-MS-Oob-TLC-OOBClassifiers: OLM:486;
X-Forefront-PRVS: 0378F1E47A
X-Forefront-Antispam-Report: CIP:255.255.255.255;CTRY:;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:SN6PR08MB5517.namprd08.prod.outlook.com;PTR:;CAT:NONE;SFTY:;SFS:(10009020)(136003)(39830400003)(396003)(366004)(346002)(376002)(8676002)(107886003)(66946007)(26005)(8936002)(316002)(66476007)(66556008)(6666004)(5660300002)(30864003)(81156014)(6512007)(69590400007)(86362001)(4326008)(36756003)(16526019)(956004)(52116002)(186003)(508600001)(6506007)(2906002)(2616005)(6486002)(559001)(579004);DIR:OUT;SFP:1101;
Received-SPF: None (protection.outlook.com: labundy.com does not designate
 permitted sender hosts)
X-MS-Exchange-SenderADCheck: 1
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-MS-Exchange-AntiSpam-MessageData: UXVOFkweGzc5W8hx8oEEFCjrlZWXYjqDH2xfJX7JPMRA9e5N0wI/AsA3i1L5ow0UvQixTktPLIQ7r2Uwj1IDzlQHJ+WdGVipfBpOlWUKq99WzI23rWIC8lxuCo1G7k9ng+Rgn9Dg0987Q9z/4IwNhw==
X-OriginatorOrg: labundy.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 7d3098e3-ce28-4924-d057-08d7e4bc1c5c
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 19 Apr 2020 23:48:08.0501
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 00b69d09-acab-4585-aca7-8fb7c6323e6f
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: pvoLMbaKG+oQQeIRYePDFPFNnQJKnOPNZa2aEVM5Os1anqxBCNW0OCKHMBYTX1mzKme1PRfN9lPr3EFW5UwUlQ==
...
index 7e2e658..0d56308 100644
--- a/drivers/input/misc/Kconfig
+++ b/drivers/input/misc/Kconfig
@@ -739,6 +739,16 @@ config INPUT_IMS_PCU
...
index 8fd187f..2e679a9 100644
--- a/drivers/input/misc/Makefile
+++ b/drivers/input/misc/Makefile
@@ -40,6 +40,7 @@ obj-$(CONFIG_INPUT_GPIO_VIBRA)		+= gpio-vibra.o
