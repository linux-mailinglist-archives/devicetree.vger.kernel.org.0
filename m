...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A546036D97C
	for <lists+devicetree@lfdr.de>; Wed, 28 Apr 2021 16:21:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232316AbhD1OVr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 28 Apr 2021 10:21:47 -0400
Received: from frasgout.his.huawei.com ([185.176.79.56]:2942 "EHLO
        frasgout.his.huawei.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229520AbhD1OVq (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 28 Apr 2021 10:21:46 -0400
Received: from fraeml743-chm.china.huawei.com (unknown [172.18.147.201])
        by frasgout.his.huawei.com (SkyGuard) with ESMTP id 4FVgdP6Rgqz72fCZ;
        Wed, 28 Apr 2021 22:15:21 +0800 (CST)
Received: from lhreml710-chm.china.huawei.com (10.201.108.61) by
 fraeml743-chm.china.huawei.com (10.206.15.224) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.2; Wed, 28 Apr 2021 16:20:59 +0200
Received: from localhost (10.52.123.69) by lhreml710-chm.china.huawei.com
 ...
 2021 15:20:59 +0100
Date:   Wed, 28 Apr 2021 15:19:25 +0100
...
Message-ID: <20210428151925.000015e3@Huawei.com>
...
On Wed, 28 Apr 2021 10:01:06 +0200
...
I took a closer look at read_raw flow as a result of your follow up
point about whether they needed to claim direct mode or not.
...
So this is ensuring a 'fresh' reading?  Given I think it is cleared on any
read at all from the device, it prevents us from doing more than one channel
reading per sample which seems unlikely to be the intent.

Normally, for polled reading via sysfs we don't really mind if the data is
potentially a little stale, though in this case we may be coming out of standby
so you might need do something to ensure reasonably up to date date.
One option would be to stash a timestamp and if it's too long ago then
do a wait for fresh data.  It seems overkill to wait for data in the runtime
resume itself, but that might not be too bad as will only occur at all if readings
are infrequent enough for autosuspend to kick in.
...
There is a new helper called pm_runtime_resume_and_get()
It will ensure that it doesn't hold a reference if the call fails,
simplifying the flow beyond here.
