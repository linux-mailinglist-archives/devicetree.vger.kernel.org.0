...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9979E6DD4EE
	for <lists+devicetree@lfdr.de>; Tue, 11 Apr 2023 10:15:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230306AbjDKIPb convert rfc822-to-8bit (ORCPT
        <rfc822;lists+devicetree@lfdr.de>); Tue, 11 Apr 2023 04:15:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51114 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230220AbjDKIPA (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 11 Apr 2023 04:15:00 -0400
Received: from ex01.ufhost.com (ex01.ufhost.com [61.152.239.75])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D234B40E7;
        Tue, 11 Apr 2023 01:14:45 -0700 (PDT)
Received: from EXMBX165.cuchost.com (unknown [175.102.18.54])
        (using TLSv1 with cipher DHE-RSA-AES256-SHA (256/256 bits))
        (Client CN "EXMBX165", Issuer "EXMBX165" (not verified))
        by ex01.ufhost.com (Postfix) with ESMTP id 75DF124E2AA;
        Tue, 11 Apr 2023 16:14:44 +0800 (CST)
...
Subject: [PATCH v5 4/4] crypto: starfive - Add hash and HMAC support
Date:   Tue, 11 Apr 2023 16:14:24 +0800
Message-ID: <20230411081424.131912-5-jiajie.ho@starfivetech.com>
...
---
 ...
 5 files changed, 1084 insertions(+), 4 deletions(-)
...
index 393efd38b098..1a02458f2005 100644
...
+
 ...
 union starfive_alg_cr {
 	u32 v;
@@ -34,12 +72,17 @@ union starfive_alg_cr {
...
@@ -52,12 +95,32 @@ struct starfive_cryp_dev {
 	struct dma_chan				*rx;
...
index 000000000000..c7f2620642f2
--- /dev/null
