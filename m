...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A9D052D40D9
	for <lists+devicetree@lfdr.de>; Wed,  9 Dec 2020 12:20:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729926AbgLILRo (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 9 Dec 2020 06:17:44 -0500
Received: from bmail1.ministro.hu ([5.249.150.236]:39422 "EHLO
        bmail1.ministro.hu" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730503AbgLILRo (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 9 Dec 2020 06:17:44 -0500
X-Greylist: delayed 385 seconds by postgrey-1.27 at vger.kernel.org; Wed, 09 Dec 2020 06:17:39 EST
Received: from localhost (localhost [127.0.0.1])
        by bmail1.ministro.hu (Postfix) with ESMTP id 55A54123AE5;
        Wed,  9 Dec 2020 12:10:33 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ministro.hu;
        s=201804; t=1607512233;
        bh=m1aHzwh/rME8eIXvuC/RTinZlEZptTp8+3/y/tb+Ivk=;
        h=From:To:Subject:Date:From;
        b=
X-Virus-Scanned: Debian amavisd-new at ministro.hu
Received: from bmail1.ministro.hu ([127.0.0.1])
        by localhost (bmail1.ministro.hu [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 0kyrdyQvjrDi; Wed,  9 Dec 2020 12:10:01 +0100 (CET)
Received: from localhost (localhost [127.0.0.1])
        by bmail1.ministro.hu (Postfix) with ESMTP id 12991123AE3;
        Wed,  9 Dec 2020 12:10:01 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ministro.hu;
        s=201804; t=1607512201;
        bh=m1aHzwh/rME8eIXvuC/RTinZlEZptTp8+3/y/tb+Ivk=;
        h=From:To:Subject:Date:From;
        b=
From:   "Info" <info@ministro.hu>
To:     "'Rob Herring'" <robh+dt@kernel.org>,
        "'Greg Kroah-Hartman'" <gregkh@linuxfoundation.org>,
        =?iso-8859-2?Q?'J=F3zsef_Horv=E1th'?= <info@ministro.hu>,
        <devicetree@vger.kernel.org>, <linux-kernel@vger.kernel.org>,
        <devel@driverdev.osuosl.org>
Subject: [PATCH] Staging: silabs si4455 serial driver
Date:   Wed, 9 Dec 2020 12:09:58 +0100
Message-ID: <!&!AAAAAAAAAAAuAAAAAAAAAM7AkQxKEJRHh2BgMNSTrQkBAExvbAW64DNBoXXP8CRioZMAAAAzfOEAABAAAAAJUqiRO33GQqGIHffCVyG/AQAAAAA=@ministro.hu>
MIME-Version: 1.0
Content-Type: text/plain;
        charset="iso-8859-2"
Content-Transfer-Encoding: quoted-printable
X-Mailer: Microsoft Outlook 15.0
Thread-Index: AdbOFLdvgXjNT03eT5qFJlWJj2LUpA==
Content-Language: hu
Precedence: bulk
...
diff --git a/drivers/staging/si4455/Kconfig =
...
diff --git a/drivers/staging/si4455/si4455_api.h
...
+#define SI4455_IOC_GTXC		_IOR('T', BASE_TTYIOC_PRIVATE +
0x11, uint32_t)
+/* Set transmit channel. */
+#define SI4455_IOC_STXC		_IOW('T', BASE_TTYIOC_PRIVATE +
0x12, uint32_t)
+/* Get receive channel. */
+#define SI4455_IOC_GRXC		_IOR('T', BASE_TTYIOC_PRIVATE +
0x13, uint32_t)
+/* Set receive channel. */
+#define SI4455_IOC_SRXC		_IOW('T', BASE_TTYIOC_PRIVATE +
0x14, uint32_t)
+/* Get fixed length package size. */
+#define SI4455_IOC_GSIZ		_IOR('T', BASE_TTYIOC_PRIVATE +
0x15, uint32_t)
+/* Set fixed length package size. */
+#define SI4455_IOC_SSIZ		_IOW('T', BASE_TTYIOC_PRIVATE +
0x16, uint32_t)
+/* Get last rssi value. */
+#define SI4455_IOC_GRSSI	_IOR('T', BASE_TTYIOC_PRIVATE + 0x20,
uint32_t)
+
+#endif
--=20
