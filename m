...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3ECBF641B49
	for <lists+devicetree@lfdr.de>; Sun,  4 Dec 2022 08:20:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229800AbiLDHUT (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 4 Dec 2022 02:20:19 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34138 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229636AbiLDHUR (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 4 Dec 2022 02:20:17 -0500
Received: from mga03.intel.com (mga03.intel.com [134.134.136.65])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A7B4E17A82;
        Sat,  3 Dec 2022 23:20:13 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1670138413; x=1701674413;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=+HJtm9hbYGQvFXuXwUgdV1EboDgT3QGEBTr6alBL8XE=;
  b=lyudAEEDkhaTKXLiIpnl/LV27GQBHPXdyr9eI2+0JhWyRNNL/loSzJFx
   0MXdFPL61Py3qoo/ZcV3QYVj3x4crwqXrsp48saF4ZhjYR6uPdjlZdikU
   +CS/Ff4xuwhPm6LqfSa19c1thyHjDxolmGyCs7Qsnd227yIzu7CkgDj8Z
   9BomvR1ofXSt0P2tASRf4VtHpdfxDr8C1Y+/Kin2a8xYBVWGJlQlqExXx
   27vfmHvgR9UpiopTCHMjHfo6Z0rEL7f2F0NfiwAA+742nz13rVJPs0Zae
   3giNhg2YpsfEfU3gJ569Gv1iFaZVxeLbadr1ULgo4/bXlAkNc4NBsAnUi
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10550"; a="318031068"
X-IronPort-AV: E=Sophos;i="5.96,216,1665471600"; 
   d="scan'208";a="318031068"
Received: from fmsmga007.fm.intel.com ([10.253.24.52])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Dec 2022 23:20:11 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10550"; a="647600255"
X-IronPort-AV: E=Sophos;i="5.96,216,1665471600"; 
   d="scan'208";a="647600255"
Received: from lkp-server01.sh.intel.com (HELO 4d912534d779) ([10.239.97.150])
  by fmsmga007.fm.intel.com with ESMTP; 03 Dec 2022 23:20:06 -0800
Received: from kbuild by 4d912534d779 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p1jID-0000ej-2T;
        Sun, 04 Dec 2022 07:20:05 +0000
Date:   Sun, 4 Dec 2022 15:19:30 +0800
...
Subject: Re: [PATCH v2 06/15] thermal/drivers/tsens: Sort out msm8976 vs
 msm8956 data
Message-ID: <202212041513.TXoF8Kfi-lkp@intel.com>
References: <20221204055909.1351895-7-dmitry.baryshkov@linaro.org>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="YS/rsie/DJ/FE/6l"
...
[auto build test WARNING on next-20221202]
[also build test WARNING on v6.1-rc7]
[cannot apply to rafael-pm/thermal robh/for-next linus/master v6.1-rc7 v6.1-rc6 v6.1-rc5]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Dmitry-Baryshkov/thermal-drivers-tsens-specify-nvmem-cells-in-DT-rather-than-parsing-them-manually/20221204-140113
patch link:    https://lore.kernel.org/r/20221204055909.1351895-7-dmitry.baryshkov%40linaro.org
patch subject: [PATCH v2 06/15] thermal/drivers/tsens: Sort out msm8976 vs msm8956 data
config: alpha-allyesconfig
compiler: alpha-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/f0c792e32de095a0a3e89a4191ff0f1b215df852
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Dmitry-Baryshkov/thermal-drivers-tsens-specify-nvmem-cells-in-DT-rather-than-parsing-them-manually/20221204-140113
        git checkout f0c792e32de095a0a3e89a4191ff0f1b215df852
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=alpha SHELL=/bin/bash drivers/thermal/qcom/
...
>> drivers/thermal/qcom/tsens-v1.c:336:12: warning: no previous prototype for 'init_8956' [-Wmissing-prototypes]
     336 | int __init init_8956(struct tsens_priv *priv) {
         |            ^~~~~~~~~


vim +/init_8956 +336 drivers/thermal/qcom/tsens-v1.c
...
# Linux/alpha 6.1.0-rc7 Kernel Configuration
#
