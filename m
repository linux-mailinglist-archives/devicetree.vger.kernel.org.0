...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 228511A78F2
	for <lists+devicetree@lfdr.de>; Tue, 14 Apr 2020 12:58:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2438780AbgDNK5k (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 14 Apr 2020 06:57:40 -0400
Received: from metis.ext.pengutronix.de ([85.220.165.71]:47325 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2438357AbgDNKcK (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 14 Apr 2020 06:32:10 -0400
Received: from dude02.hi.pengutronix.de ([2001:67c:670:100:1d::28] helo=dude02.lab.pengutronix.de)
        by metis.ext.pengutronix.de with esmtps (TLS1.3:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <mtr@pengutronix.de>)
        id 1jOIrN-0007BZ-F6; Tue, 14 Apr 2020 12:32:05 +0200
Received: from mtr by dude02.lab.pengutronix.de with local (Exim 4.92)
        (envelope-from <mtr@pengutronix.de>)
        id 1jOIrM-00018F-UR; Tue, 14 Apr 2020 12:32:04 +0200
...
Subject: [PATCH v2 5/6] soc: xilinx: vcu: use vcu-settings syscon registers
Date:   Tue, 14 Apr 2020 12:32:01 +0200
Message-Id: <20200414103202.4288-6-m.tretter@pengutronix.de>
...
index f07a1361a2a8..ac12c33a6746 100644
...
+	mcuclk *= MHZ;
 	if (!mcuclk || !coreclk) {
 		...
 		return -EINVAL;
@@ -560,6 +544,7 @@ static int xvcu_probe(struct platform_device *pdev)
 {
 	struct resource *res;
...
@@ -580,17 +565,32 @@ static int xvcu_probe(struct platform_device *pdev)
 		return -ENOMEM;
 	}
...
@@ -622,7 +622,7 @@ static int xvcu_probe(struct platform_device *pdev)
...
@@ -669,7 +669,7 @@ static int xvcu_remove(struct platform_device *pdev)
