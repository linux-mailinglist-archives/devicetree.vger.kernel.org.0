...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id ECC3B59C55F
	for <lists+devicetree@lfdr.de>; Mon, 22 Aug 2022 19:51:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236798AbiHVRug (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 22 Aug 2022 13:50:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40770 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237006AbiHVRua (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 22 Aug 2022 13:50:30 -0400
Received: from mail.sberdevices.ru (mail.sberdevices.ru [45.89.227.171])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A0AAD3343D;
        Mon, 22 Aug 2022 10:50:24 -0700 (PDT)
Received: from s-lin-edge02.sberdevices.ru (localhost [127.0.0.1])
        by mail.sberdevices.ru (Postfix) with ESMTP id 0C2A35FD07;
        Mon, 22 Aug 2022 20:50:23 +0300 (MSK)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=sberdevices.ru;
        s=mail; t=1661190623;
        bh=1P9QV+mnvC4X6fj3+ZGc0y0DgJs+AtQWPiiIFNxshvc=;
        h=From:To:Subject:Date:Message-ID:Content-Type:MIME-Version;
        b=
...
Subject: [PATCH v7 3/4] iio: add MEMSensing MSA311 3-axis accelerometer driver
Thread-Topic: [PATCH v7 3/4] iio: add MEMSensing MSA311 3-axis accelerometer
 driver
Thread-Index: AQHYtk+EhpCYLvN3+k68bjQ2G3PiTA==
Date:   Mon, 22 Aug 2022 17:49:25 +0000
Message-ID: <20220822175011.2886-4-ddrokosov@sberdevices.ru>
...
Datasheet: https://cdn-shop.adafruit.com/product-files/5309/MSA311-V1.1-ENG=
.pdf
...
+
+	msa311->chip_name =3D devm_kasprintf(dev, GFP_KERNEL,
+					   "msa311-%hhx", partid);
+	if (!msa311->chip_name)
