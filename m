...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5251A640172
	for <lists+devicetree@lfdr.de>; Fri,  2 Dec 2022 09:01:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231468AbiLBIBR (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 2 Dec 2022 03:01:17 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44526 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231661AbiLBIBQ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 2 Dec 2022 03:01:16 -0500
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F25D96B3A1;
        Fri,  2 Dec 2022 00:01:11 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1669968072; x=1701504072;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=P79JCiBjJ2xK3budogt7815WP2Zoo2j5fFxPwBi8+1E=;
  b=HOSiCP3P+4vPc8Ub2+eBjPVIaCFerSCWCoOXqOy5ONkCRU5VkkaEzMAQ
   KtyvBrEznCeqveHEvdDEf4X5YzE/bylBUQR0IQpCN/ObwVNYXGNPwOW4/
   meTivhlUKortIkLsK90lJfcAGQ6OtFQdzBHbKCuV8VEF2Zsp27LlY7K/f
   vAIIjSLbxyaeNo9NBb6jhuSQquUhuOxDmaZOxmLn9m+o+ZRaBQwbQa5cr
   2oZjHDSjVMMrzWIKCGmotXYyC1aj1wblFbc2yYN2HK9zYXyCY5QKgTmTq
   v1Yv1mNIhRorA6TxlDgXI+7m39vuoCJlT6R9aBGrf4hOZ8DzZ9QrI0njp
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10548"; a="299263182"
X-IronPort-AV: E=Sophos;i="5.96,210,1665471600"; 
   d="scan'208";a="299263182"
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 02 Dec 2022 00:01:09 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10548"; a="677515166"
X-IronPort-AV: E=Sophos;i="5.96,210,1665471600"; 
   d="scan'208";a="677515166"
Received: from lkp-server01.sh.intel.com (HELO 64a2d449c951) ([10.239.97.150])
  by orsmga001.jf.intel.com with ESMTP; 02 Dec 2022 00:01:02 -0800
Received: from kbuild by 64a2d449c951 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1p10yk-000DPP-0L;
        Fri, 02 Dec 2022 08:01:02 +0000
Date:   Fri, 2 Dec 2022 16:00:26 +0800
...
Subject: Re: [PATCH v2 5/5] thermal/drivers/imx: Add support for loading
 calibration data from OCOTP
Message-ID: <202212021543.pyaWbRPm-lkp@intel.com>
References: <20221201215651.152497-5-marex@denx.de>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="WtEU54ltRLtxxxN4"
Content-Disposition: inline
In-Reply-To: <20221201215651.152497-5-marex@denx.de>
...
[also build test WARNING on soc/for-next linus/master v6.1-rc7 next-20221202]
...
url:    https://github.com/intel-lab-lkp/linux/commits/Marek-Vasut/dt-bindings-thermal-imx8mm-thermal-Document-optional-nvmem-cells/20221202-055808
base:   https://git.kernel.org/pub/scm/linux/kernel/git/shawnguo/linux.git for-next
patch link:    https://lore.kernel.org/r/20221201215651.152497-5-marex%40denx.de
patch subject: [PATCH v2 5/5] thermal/drivers/imx: Add support for loading calibration data from OCOTP
config: arm-randconfig-r046-20221201
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/ed7785684744abc68df44436b936aebd306ac575
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Marek-Vasut/dt-bindings-thermal-imx8mm-thermal-Document-optional-nvmem-cells/20221202-055808
        git checkout ed7785684744abc68df44436b936aebd306ac575
...
>> drivers/thermal/imx8mm_thermal.c:219:53: warning: format specifies type 'long' but the argument has type 'size_t' (aka 'unsigned int') [-Wformat]
...
vim +219 drivers/thermal/imx8mm_thermal.c

   194	
   195	static int imx8mm_tmu_probe_set_calib_v2(struct platform_device *pdev,
   196						 struct imx8mm_tmu *tmu)
   197	{
   198		struct device *dev = &pdev->dev;
   199		struct nvmem_cell *cell;
   200		u32 trim[4] = { 0 };
   201		size_t len;
   202		void *buf;
   203	
   204		cell = nvmem_cell_get(dev, "calib");
   205		if (IS_ERR(cell))
   206			return PTR_ERR(cell);
   207	
   208		buf = nvmem_cell_read(cell, &len);
   209		nvmem_cell_put(cell);
   210	
   211		if (IS_ERR(buf))
   212			return PTR_ERR(buf);
   213	
   214		memcpy(trim, buf, min(len, sizeof(trim)));
   215		kfree(buf);
   216	
   217		if (len != 16) {
   218			dev_err(dev,
 > 219				"OCOTP nvmem cell length is %ld, must be 16.\n", len);
   220			return -EINVAL;
   221		}
   222	
   223		/* Blank sample hardware */
   224		if (!trim[0] && !trim[1] && !trim[2] && !trim[3]) {
   225			/* Use a default 25C binary codes */
   226			writel(FIELD_PREP(TCALIV_SNSR25C_MASK, 0x63c),
   227			       tmu->base + TCALIV(0));
   228			writel(FIELD_PREP(TCALIV_SNSR25C_MASK, 0x63c),
   229			       tmu->base + TCALIV(1));
   230			return 0;
   231		}
   232	
   233		writel(FIELD_PREP(TASR_BUF_VERF_SEL_MASK,
   234				  FIELD_GET(TRIM2_BUF_VERF_SEL_MASK, trim[0])) |
   235		       FIELD_PREP(TASR_BUF_SLOPE_MASK,
   236				  FIELD_GET(TRIM2_BUF_SLOP_SEL_MASK, trim[0])),
   237		       tmu->base + TASR);
   238	
   239		writel(FIELD_PREP(TRIM_BJT_CUR_MASK,
   240				  FIELD_GET(TRIM2_BJT_CUR_MASK, trim[0])) |
   241		       FIELD_PREP(TRIM_BGR_MASK, FIELD_GET(TRIM2_BGR_MASK, trim[0])) |
   242		       FIELD_PREP(TRIM_VLSB_MASK, FIELD_GET(TRIM2_VLSB_MASK, trim[0])) |
   243		       TRIM_EN_CH,
   244		       tmu->base + TRIM);
   245	
   246		writel(FIELD_PREP(TCALIV_SNSR25C_MASK,
   247				  FIELD_GET(TRIM3_TCA25_0_LSB_MASK, trim[1]) |
   248				  (FIELD_GET(TRIM4_TCA25_0_MSB_MASK, trim[2]) << 4)) |
   249		       FIELD_PREP(TCALIV_SNSR105C_MASK,
   250				  FIELD_GET(TRIM4_TCA105_0_MASK, trim[2])),
   251		       tmu->base + TCALIV(0));
   252	
   253		writel(FIELD_PREP(TCALIV_SNSR25C_MASK,
   254				  FIELD_GET(TRIM5_TCA25_1_MASK, trim[3])) |
   255		       FIELD_PREP(TCALIV_SNSR105C_MASK,
   256				  FIELD_GET(TRIM5_TCA105_1_MASK, trim[3])),
   257		       tmu->base + TCALIV(1));
   258	
   259		writel(FIELD_PREP(TCALIV_SNSR25C_MASK,
   260				  FIELD_GET(TRIM3_TCA40_0_MASK, trim[1])) |
   261		       FIELD_PREP(TCALIV_SNSR105C_MASK,
   262				  FIELD_GET(TRIM4_TCA40_1_MASK, trim[2])),
   263		       tmu->base + TCALIV(2));
   264	
   265		return 0;
   266	}
   267	
