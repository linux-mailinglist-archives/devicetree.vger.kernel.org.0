...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5D5BA29143
	for <lists+devicetree@lfdr.de>; Fri, 24 May 2019 08:49:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388928AbfEXGtW (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 24 May 2019 02:49:22 -0400
Received: from hqemgate15.nvidia.com ([216.228.121.64]:14511 "EHLO
        hqemgate15.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388359AbfEXGtV (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 24 May 2019 02:49:21 -0400
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqemgate15.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5ce793df0000>; Thu, 23 May 2019 23:49:03 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Thu, 23 May 2019 23:49:08 -0700
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Thu, 23 May 2019 23:49:08 -0700
...
Message-ID: <1836c342-3fc8-7988-c7d4-943619e22df9@nvidia.com>
Date:   Fri, 24 May 2019 12:20:20 +0530
User-Agent: Mozilla/5.0 (Windows NT 10.0; WOW64; rv:60.0) Gecko/20100101
 Thunderbird/60.6.1
MIME-Version: 1.0
In-Reply-To: <1557997694.10179.343.camel@mhfsdcap03>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1558680543; bh=dsxOq9TFrvft0Qjt5EkiYVYGL2ewu9MLkuUaVTE4oXM=;
        h=X-PGP-Universal:Subject:To:CC:References:X-Nvconfidentiality:From:
         Message-ID:Date:User-Agent:MIME-Version:In-Reply-To:
         X-Originating-IP:X-ClientProxiedBy:Content-Type:Content-Language:
         Content-Transfer-Encoding;
        b=
...
>> +	u32 pls;
>> +	int ret;
>> +	int extcon_state = extcon_get_state(xudc->data_role_extcon, EXTCON_USB);
>> +
>> +	spin_lock_irqsave(&xudc->lock, flags);
>> +
>> +	if (xudc->data_role_extcon && extcon_state && xudc->wait_for_sec_prc) {
>> +		pls = (xudc_readl(xudc, PORTSC) >> PORTSC_PLS_SHIFT) &
>> +			PORTSC_PLS_MASK;
...
> use usb_ep_type_string()?
> see https://patchwork.kernel.org/patch/10862829/
> It's already picked up.
> 
Thanks for info, will use string print for easier reading of logs
...
> set it SS's default maxp 512 like others?
