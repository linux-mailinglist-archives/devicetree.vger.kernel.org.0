...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DC1BD45B6B3
	for <lists+devicetree@lfdr.de>; Wed, 24 Nov 2021 09:41:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241517AbhKXIoo (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 24 Nov 2021 03:44:44 -0500
Received: from esa.microchip.iphmx.com ([68.232.154.123]:24463 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241437AbhKXIoH (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 24 Nov 2021 03:44:07 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1637743258; x=1669279258;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=ibkGp0s9mc83Ll7w5y39aUT+E46ShBMw9vpBdx7Tlbo=;
  b=sGiDruP2hjECNjSiD3Xd7vHnns/PAXQb5nt/lsrB1LWKSTNwsVaswKqN
   TVICovSANlk7EZqBBY9qvRuRLvHp4tf9SveRXHcW9cTnijqS5Vdqbv99Y
   avHkDBzixtofN4xywZNBea9xxLhTkT6PWfRLpOI29DPHY33IRs0H3J4JF
   ymxTQRuHnrvOcYh05tl8t0x98169wYEcFWpEzphnbDmdsZGmQqHJyAMsK
   YpDGF2iNT3BBnMru1hvU4isBaKzDZ2JaKl7hvCKFC8LZg3JNIO/L67L1D
   MEsr4G9GPNirFYq94tiYyICW/ZST+HmRvZ1GbxmCnMCHuqBA4eDiEVgb2
   g==;
IronPort-SDR: 
 5S+NhywSHePZLk3hyiKfU8qp
X-IronPort-AV: E=Sophos;i="5.87,260,1631602800"; 
   d="scan'208";a="140157811"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa2.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 24 Nov 2021 01:40:57 -0700
Received: from chn-vm-ex01.mchp-main.com (10.10.85.143) by
 chn-vm-ex03.mchp-main.com (10.10.85.151) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.14; Wed, 24 Nov 2021 01:40:56 -0700
Received: from soft-dev3-1.microsemi.net (10.10.115.15) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server id
 15.1.2176.14 via Frontend Transport; Wed, 24 Nov 2021 01:40:54 -0700
...
Subject: [PATCH net-next v3 5/6] net: lan966x: add ethtool configuration and statistics
Date:   Wed, 24 Nov 2021 09:39:14 +0100
Message-ID: <20211124083915.2223065-6-horatiu.vultur@microchip.com>
...
index ade4a35924c6..d489ed389265 100644
--- a/drivers/net/ethernet/microchip/lan966x/lan966x_main.c
+++ b/drivers/net/ethernet/microchip/lan966x/lan966x_main.c
@@ -371,6 +371,7 @@ static const struct net_device_ops lan966x_port_netdev_ops = {
...
@@ -580,6 +581,7 @@ static int lan966x_probe_port(struct lan966x *lan966x, u32 p,
...
@@ -867,6 +869,7 @@ static int lan966x_probe(struct platform_device *pdev)
...
@@ -899,6 +902,10 @@ static int lan966x_probe(struct platform_device *pdev)
 cleanup_ports:
...
@@ -910,6 +917,10 @@ static int lan966x_remove(struct platform_device *pdev)
 {
...
index 332bcda0ded1..3af4adf7b801 100644
--- a/drivers/net/ethernet/microchip/lan966x/lan966x_main.h
+++ b/drivers/net/ethernet/microchip/lan966x/lan966x_main.h
@@ -66,6 +66,11 @@ struct lan966x_frame_info {
 	u8 ipv;
 };
...
@@ -110,6 +125,11 @@ struct lan966x_port {
