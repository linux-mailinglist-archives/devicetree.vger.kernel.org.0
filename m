...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 99FAD1166B5
	for <lists+devicetree@lfdr.de>; Mon,  9 Dec 2019 07:05:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727091AbfLIGFR (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 9 Dec 2019 01:05:17 -0500
Received: from mail-eopbgr770081.outbound.protection.outlook.com ([40.107.77.81]:61509
        "EHLO NAM02-SN1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1726132AbfLIGFQ (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Mon, 9 Dec 2019 01:05:16 -0500
Received: from DM6PR02CA0049.namprd02.prod.outlook.com (2603:10b6:5:177::26)
 by DM6PR02MB6544.namprd02.prod.outlook.com (2603:10b6:5:1b5::13) with
...
Received: from BL2NAM02FT045.eop-nam02.prod.protection.outlook.com
 (2a01:111:f400:7e46::204) by DM6PR02CA0049.outlook.office365.com
 (2603:10b6:5:177::26) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id 15.20.2516.13 via Frontend
 Transport; Mon, 9 Dec 2019 06:05:08 +0000
...
Received: from xsj-pvapsmtpgw01 (149.199.60.83) by
 ...
 via Frontend Transport; Mon, 9 Dec 2019 06:05:08 +0000
Received: from unknown-38-66.xilinx.com ([149.199.38.66] helo=xsj-pvapsmtp01)
        by xsj-pvapsmtpgw01 with esmtp (Exim 4.63)
        (envelope-from <shubhrajyoti.datta@gmail.com>)
        id 1ieC1o-0004Ng-FF; Sun, 08 Dec 2019 21:56:16 -0800
Received: from [127.0.0.1] (helo=xsj-smtp-dlp2.xlnx.xilinx.com)
        by xsj-pvapsmtp01 with esmtp (Exim 4.63)
        (envelope-from <shubhrajyoti.datta@gmail.com>)
        id 1ieC1i-0002CB-Jq; Sun, 08 Dec 2019 21:56:10 -0800
Received: from xsj-pvapsmtp01 (mail.xilinx.com [149.199.38.66] (may be forged))
        by xsj-smtp-dlp2.xlnx.xilinx.com (8.13.8/8.13.1) with ESMTP id xB95u9Wu024398;
        Sun, 8 Dec 2019 21:56:09 -0800
Received: from [10.140.6.59] (helo=xhdshubhraj40.xilinx.com)
        by xsj-pvapsmtp01 with esmtp (Exim 4.63)
        (envelope-from <shubhrajyoti.datta@gmail.com>)
        id 1ieC1g-00027p-UM; Sun, 08 Dec 2019 21:56:09 -0800
...
Date:   Mon,  9 Dec 2019 11:25:58 +0530
Message-Id: <1575870959-11703-2-git-send-email-shubhrajyoti.datta@gmail.com>
...
X-Matching-Connectors: 132203451087959923;(f9e945fa-a09a-4caa-7158-08d2eb1d8c44);()
X-Forefront-Antispam-Report: CIP:149.199.60.83;IPV:NLI;CTRY:US;EFV:NLI;SFV:NSPM;SFS:(10009020)(39850400004)(396003)(136003)(376002)(346002)(199004)(189003)(76176011)(498600001)(8936002)(26005)(9786002)(82202003)(50466002)(51416003)(54906003)(356004)(50226002)(426003)(55446002)(316002)(48376002)(2906002)(6666004)(5660300002)(9686003)(2616005)(73392003)(107886003)(86362001)(8676002)(81156014)(81166006)(30864003)(4326008)(76482006)(450100002)(336012)(305945005)(36756003)(70206006)(70586007)(42866002)(559001)(579004);DIR:OUT;SFP:1101;SCL:1;SRVR:DM6PR02MB6544;H:xsj-pvapsmtpgw01;FPR:;SPF:SoftFail;LANG:en;PTR:unknown-60-83.xilinx.com;A:1;MX:1;
MIME-Version: 1.0
Content-Type: text/plain
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 004413f0-7b64-4170-200c-08d77c6dbe97
X-MS-TrafficTypeDiagnostic: DM6PR02MB6544:
X-Microsoft-Antispam-PRVS: <DM6PR02MB6544F9A1B1FE9641C771314487580@DM6PR02MB6544.namprd02.prod.outlook.com>
X-MS-Oob-TLC-OOBClassifiers: OLM:7219;
X-Forefront-PRVS: 02462830BE
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Dec 2019 06:05:08.3326
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 004413f0-7b64-4170-200c-08d77c6dbe97
X-MS-Exchange-CrossTenant-Id: 5afe0b00-7697-4969-b663-5eab37d5f47e
X-MS-Exchange-CrossTenant-OriginalAttributedTenantConnectingIp: TenantId=5afe0b00-7697-4969-b663-5eab37d5f47e;Ip=[149.199.60.83];Helo=[xsj-pvapsmtpgw01]
X-MS-Exchange-CrossTenant-FromEntityHeader: HybridOnPrem
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DM6PR02MB6544
