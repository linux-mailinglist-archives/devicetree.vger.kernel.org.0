...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D354F45A439
	for <lists+devicetree@lfdr.de>; Tue, 23 Nov 2021 14:56:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237365AbhKWN7S (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 23 Nov 2021 08:59:18 -0500
Received: from esa.microchip.iphmx.com ([68.232.154.123]:52992 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237389AbhKWN7K (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 23 Nov 2021 08:59:10 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1637675762; x=1669211762;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=GAh7OrvoVJF2qI3xvO4/Q/9ALaiq5TsRku/c0IHzhfY=;
  b=KnfmfxmOuKE+84nMc4zNsfJBRLYhJVMa4YDsnSZKeSKEMTagfzal/qRo
   6YX8Z2/bXJytbnlz9ElvTImO3nF2JiHGEca1CoYlRVtaQcpmXi72fKfpO
   9BqYIcaF7cEx0i73ju1A5kulW+eB9b3qxc2VjU2OHlqgAtY6h7WFhLSIW
   j+jWpXx4oFCnytlP0uWRLq+8xRei9qv2hXs4ZNBZgBf5fN7fyV4cO+uQL
   T1ECpQtaGAJQ+UI14K+Ivt+SEF42FQDxrJ/41hiOR7bKrLb/2AwK0iG88
   4R4soWjVusC7ROVAcG7xe0rFkqHi9eME1oOIQLbdKAzXifgTpGaIMfl1A
   g==;
IronPort-SDR: 
 mwzrtIq84WIjmFhf/phnwhvF
X-IronPort-AV: E=Sophos;i="5.87,257,1631602800"; 
   d="scan'208";a="77316488"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa6.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 23 Nov 2021 06:56:01 -0700
Received: from chn-vm-ex01.mchp-main.com (10.10.85.143) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.14; Tue, 23 Nov 2021 06:56:01 -0700
Received: from soft-dev3-1.microsemi.net (10.10.115.15) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server id
 15.1.2176.14 via Frontend Transport; Tue, 23 Nov 2021 06:55:57 -0700
...
Subject: [PATCH net-next v2 5/6] net: lan966x: add ethtool configuration and statistics
Date:   Tue, 23 Nov 2021 14:55:16 +0100
Message-ID: <20211123135517.4037557-6-horatiu.vultur@microchip.com>
...
index c1abe16ad579..1181eb861c03 100644
--- a/drivers/net/ethernet/microchip/lan966x/lan966x_main.c
+++ b/drivers/net/ethernet/microchip/lan966x/lan966x_main.c
@@ -372,6 +372,7 @@ static const struct net_device_ops lan966x_port_netdev_ops = {
...
@@ -581,6 +582,7 @@ static int lan966x_probe_port(struct lan966x *lan966x, u32 p,
...
@@ -868,6 +870,7 @@ static int lan966x_probe(struct platform_device *pdev)
...
@@ -900,6 +903,10 @@ static int lan966x_probe(struct platform_device *pdev)
 cleanup_ports:
...
@@ -911,6 +918,10 @@ static int lan966x_remove(struct platform_device *pdev)
 {
