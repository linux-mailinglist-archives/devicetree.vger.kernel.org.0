...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B537D258EB4
	for <lists+devicetree@lfdr.de>; Tue,  1 Sep 2020 14:55:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728027AbgIAMzK (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 1 Sep 2020 08:55:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57712 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728149AbgIAMui (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 1 Sep 2020 08:50:38 -0400
Received: from galois.linutronix.de (Galois.linutronix.de [IPv6:2a0a:51c0:0:12e:550::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4DB35C061245;
        Tue,  1 Sep 2020 05:50:32 -0700 (PDT)
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linutronix.de;
        ...
        bh=obOE6kJm/4klN8KER432MeUTMSW0aErRqB5IoGOnH+8=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=linutronix.de;
        s=2020e; t=1598964630;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=obOE6kJm/4klN8KER432MeUTMSW0aErRqB5IoGOnH+8=;
        b=EMi5qigJTK56lFJ7ryEVcdYMegp/Qj7Q/cHQw6nShZ2PtbwLQaqJXV1XcflhZsuVnPITMs
        rNVXZtz5HUEykPAg==
...
Subject: [PATCH v4 2/7] net: dsa: Add DSA driver for Hirschmann Hellcreek switches
Date:   Tue,  1 Sep 2020 14:50:09 +0200
Message-Id: <20200901125014.17801-3-kurt@linutronix.de>
...
index 468b3c4273c5..07e17088b2b7 100644
...
new file mode 100644
index 000000000000..242d6a843143
--- /dev/null
...
+}
+
+const static struct hellcreek_platform_data de1soc_r1_pdata = {
+	.num_ports	= 4,
+	.is_100_mbits	= 1,
+	.qbv_support	= 1,
+	.qbv_on_cpu	= 1,
...
new file mode 100644
index 000000000000..fa2b1adb877f
--- /dev/null
