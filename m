...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A10E56A391A
	for <lists+devicetree@lfdr.de>; Mon, 27 Feb 2023 03:55:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230039AbjB0Czd (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 26 Feb 2023 21:55:33 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33404 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229975AbjB0Czb (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 26 Feb 2023 21:55:31 -0500
Received: from mail-lf1-x12e.google.com (mail-lf1-x12e.google.com [IPv6:2a00:1450:4864:20::12e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 35EA2113DE
        for <devicetree@vger.kernel.org>; Sun, 26 Feb 2023 18:55:25 -0800 (PST)
Received: by mail-lf1-x12e.google.com with SMTP id f41so6635371lfv.13
        for <devicetree@vger.kernel.org>; Sun, 26 Feb 2023 18:55:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=mMyHa1MAL1azwf7C8sqenQm6ErlRnORnlZEWQ/dHnn4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=mMyHa1MAL1azwf7C8sqenQm6ErlRnORnlZEWQ/dHnn4=;
        b=
X-Gm-Message-State: AO0yUKWjf5Pk53Md41ugKZKChOdadO+njt/E6XfKKOVqgEu235TIQnJi
        WFEu1UsiXL9Ah2up2A7CwslXmA==
X-Google-Smtp-Source: AK7set8RDp9FGRL0ZZrQA2gLY/9IlrlPjAL1LbkEEAiGdiXlQGB4rQNRARyH8n8T3GdNgsyKXtcSbw==
X-Received: by 2002:a19:7516:0:b0:4df:b98:520e with SMTP id y22-20020a197516000000b004df0b98520emr1351933lfe.21.1677466522845;
        Sun, 26 Feb 2023 18:55:22 -0800 (PST)
Received: from ?IPV6:2001:14ba:a085:4d00::8a5? (dzccz6yyyyyyyyyyybcwt-3.rev.dnainternet.fi. [2001:14ba:a085:4d00::8a5])
        by smtp.gmail.com with ESMTPSA id g4-20020a19ac04000000b004cb3fbc7925sm747790lfc.77.2023.02.26.18.55.21
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 26 Feb 2023 18:55:22 -0800 (PST)
Message-ID: <153ef3e0-9978-d201-44ad-3a5e55eeef4f@linaro.org>
Date:   Mon, 27 Feb 2023 04:55:21 +0200
MIME-Version: 1.0
...
In-Reply-To: <20230217-topic-cpr3h-v10-5-67aed8fdfa61@linaro.org>
...
These need to be stored per tid and per fusing_rev. I'd suggest to split 
use something like qcom,opp-TID-oloop-vadj = <array or a single-value>;
So, a single property per thread ID, allowing either a single value or 
an array of values, one per fusing revision.
...
This makes me wonder if it would be worth switching to regmap.
...
Shouldn't this be min/max instead of a single new_uV?
...
This should be called for non-CPRh targets too. For example, we can use 
this data to populate scaling tables for GPMU.
...
This will work if there are no other power domains set for the CPU/GPU 
devices. If e.g. the device has cpr and mx power domains, then 
pd_attach_dev callback will be called with the virtual genpd device.

I fixed this for me by adding base_dev pointer to pd.attach_dev() 
callback (and then using base_dev for the OPP calls).
...
CPR for GFX uses several RO for each corner. Can you possibly split this 
into separate pieces: one for scaling coefficinent calculation and 
another one for calculating quot adjustment?
...
Rather than having corner->quot_adjust which is used to adjust 
fuse->quot, it might be better to add an array quot[CPR3_RO_COUNT] to 
corner and then set relevant quot directly (this will make it easier to 
use it for GFX CPR).
...
I'd again ask to split generic code and CPRh code. CPRh code differs 
quite significantly. It would be easier to comprehend CPR driver if CPRh 
and CPR[34] code is split apart (yes, I had to do this while 
fighting/finding my way through the driver).
