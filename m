...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D9B8F1A6D69
	for <lists+devicetree@lfdr.de>; Mon, 13 Apr 2020 22:40:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388471AbgDMUkw (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 13 Apr 2020 16:40:52 -0400
Received: from bhuna.collabora.co.uk ([46.235.227.227]:34076 "EHLO
        bhuna.collabora.co.uk" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388457AbgDMUkt (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 13 Apr 2020 16:40:49 -0400
...
On 4/9/20 9:51 AM, Louis Kuo (郭德寧) wrote:
> Hi Helen,
> 
...
> 
> According to your comments, I would like to upstream new patch of sensor interface driver recently.

Next time, if you could reply these comments inline in the email (i.e. just after my comments, as I'm doing now), it would be easier to read and to know the context it applies.

> 
> A. About staging as you mentioned, for upstream patch files
> 1. Should I put the driver code under "/driver/staging/media" folder rather than "/drivers/media/platform" ?
> 2. Besides, about dt-binding yaml file and devicetree dts file, should I put it into "/Documentation/devicetree/bindings/media" and "arch/arm64/boot/dts/mediatek" as usual ?

Sorry, I thought this driver was being added to staging for some reason.

/drivers/media/platform is fine (if you consider the driver in a good state), but I was wondering why you need 3 directories mtk-isp/isp_50/seninf ?

> 
> 
> B. I have fixed code following most of your comments, but still remain some and reply as below,
> 
>> +#define NUM_SENSORS4
> I was wondering if you could have several sensors per port.
> =>one sensor one port, seninf have 4 source pads to connect up to 4 sensors

Right, so maybe rename it to reflect the number of sink pads (since you don't know how much sensors will be really connected right?).

> 
>> +#define MIPI_RX_ANA00_CSI0A_RG_CSI0A_CPHY_EN_MASK (0x1 << 0)
> I would also add a prefix to all these macros MTK_SENINF_
> =>add a prefix to all these macros will make a lot of register names too long to over 80 characters easily
> It would be nice to align the values in the same tabulation.
> =>the same as above, over 80 characters and cause checkpatch fail

I know that, at least the media community is ok going over 80 characters if the code is easier to read and more organized.
...
> Sent: Thursday, February 20, 2020 5:17 AM
> To: Louis Kuo (郭德寧) <louis.kuo@mediatek.com>; hans.verkuil@cisco.com; laurent.pinchart+renesas@ideasonboard.com; tfiga@chromium.org; keiichiw@chromium.org; matthias.bgg@gmail.com; mchehab@kernel.org
> Cc: devicetree@vger.kernel.org; Sean Cheng (鄭昇弘) <Sean.Cheng@mediatek.com>; Rynn.Wu@mediatek.com; srv_heupstream <srv_heupstream@mediatek.com>; Jerry-ch Chen (陳敬憲) <Jerry-ch.Chen@mediatek.com>; Jungo Lin (林明俊) <jungo.lin@mediatek.com>; Sj Huang (黃信璋) <sj.huang@mediatek.com>; yuzhao@chromium.org; linux-mediatek@lists.infradead.org; zwisler@chromium.org; Christie Yu (游雅惠) <christie.yu@mediatek.com>; Frederic Chen (陳俊元) <Frederic.Chen@mediatek.com>; linux-arm-kernel@lists.infradead.org; linux-media@vger.kernel.org; kernel@collabora.com
> Subject: Re: [RFC PATCH V5 1/3] media: platform: mtk-isp: Add Mediatek sensor interface driver
> 
> Hi Louis,
> 
...
>> +
>> +#define SENINF_TIMESTAMP_STEP0x67
>> +#define SENINF_SETTLE_DELAY0x15
>> +#define SENINF_HS_TRAIL_PARAMETER0x8
>> +
>> +#define NUM_PADS12
>> +#define NUM_SENSORS4
> 
> I was wondering if you could have several sensors per port.
> 
>> +#define CAM_MUX_IDX_MINNUM_SENSORS
...
>> +
>> +#define CSI_PORT_0A_ADDR_OFST0
>> +#define CSI_PORT_0B_ADDR_OFST0x1000
>> +#define CSI_PORT_1_ADDR_OFST0x2000
>> +#define CSI_PORT_2_ADDR_OFST0x4000
>> +
>> +#define SENINF_ALL_ERR_IRQ_EN0x7F
>> +#define SENINF_IRQ_CLR_SEL0x80000000
>> +
>> +#define MIPI_SENSOR0x8
>> +
>> +enum {
