...
Received: from mail.cognitivepilot.com ([127.0.0.1])
        ...
        with ESMTP id 3p-R1PkwIHsh for <devicetree@vger.kernel.org>;
        Mon, 22 Mar 2021 13:56:31 +0300 (MSK)
Received: from localhost.localdomain (unknown [185.68.147.27])
        by mail.cognitivepilot.com (Postfix) with ESMTP id 4F3rz24CDwzpQPcM;
...
Subject: [PATCH v2 2/4] ARM: dts: sun8i: r40: add pinmux settings for MMC3 and UARTs 2,4,5&7
Date:   Mon, 22 Mar 2021 13:55:36 +0300
Message-Id: <20210322105538.3475183-3-i.uvarov@cognitivepilot.com>
