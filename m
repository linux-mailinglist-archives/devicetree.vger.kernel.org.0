...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1F131202C8C
	for <lists+devicetree@lfdr.de>; Sun, 21 Jun 2020 22:00:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730631AbgFUUA2 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 21 Jun 2020 16:00:28 -0400
Received: from smtpout1.mo803.mail-out.ovh.net ([79.137.123.219]:43325 "EHLO
        smtpout1.mo803.mail-out.ovh.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1730577AbgFUUA1 (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Sun, 21 Jun 2020 16:00:27 -0400
Received: from pro2.mail.ovh.net (unknown [10.108.4.219])
        by mo803.mail-out.ovh.net (Postfix) with ESMTPS id 2638E5852A84;
...
Subject: [PATCH v6 3/4] iio: chemical: scd30: add serial interface driver
Date:   Sun, 21 Jun 2020 21:57:00 +0200
Message-ID: <20200621195701.97227-4-tomasz.duszynski@octakon.com>
...
X-ClientProxiedBy: CAS1.emp2.local (172.16.1.1) To DAG2EX1.emp2.local
 (172.16.2.11)
X-Ovh-Tracer-Id: 13571316004322106391
X-VR-SPAMSTATE: OK
X-VR-SPAMSCORE: -100
X-VR-SPAMCAUSE: 
