...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 14955125F8C
	for <lists+devicetree@lfdr.de>; Thu, 19 Dec 2019 11:43:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726698AbfLSKns (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 19 Dec 2019 05:43:48 -0500
Received: from mail25.static.mailgun.info ([104.130.122.25]:14644 "EHLO
        mail25.static.mailgun.info" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1727141AbfLSKnq (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Thu, 19 Dec 2019 05:43:46 -0500
DKIM-Signature: a=rsa-sha256; v=1; c=relaxed/relaxed; d=mg.codeaurora.org; q=dns/txt;
 s=smtp; t=1576752220; h=References: In-Reply-To: Message-Id: Date:
 Subject: To: From: Sender;
 bh=DbEX1opJKztQZsln4kHchAf32pLUwGSg2gqI+R4Psu8=; b=xhuJgENdvAZLDl+5EUS0K61Zz9ytaaPCjRwMw7lxjvQrRd23sVMFIgf2i18M7pJ52jfzJhxf
 yck077TETE4e8STs0fbE97NuAsz+ZvCF9L/oB1aAFuU2OrwzA8EwKymUgyD5Iv/GUXmcw8Z1
 u3WG/iki68lPMRWGwfdGRiR9D6Q=
X-Mailgun-Sending-Ip: 104.130.122.25
X-Mailgun-Sid: WyI1YmJiNiIsICJkZXZpY2V0cmVlQHZnZXIua2VybmVsLm9yZyIsICJiZTllNGEiXQ==
Received: from smtp.codeaurora.org (ec2-35-166-182-171.us-west-2.compute.amazonaws.com [35.166.182.171])
 by mxa.mailgun.org with ESMTP id 5dfb5456.7f951728fa40-smtp-out-n01;
 Thu, 19 Dec 2019 10:43:34 -0000 (UTC)
Received: by smtp.codeaurora.org (Postfix, from userid 1001)
        id 8D6CFC53808; Thu, 19 Dec 2019 10:43:34 +0000 (UTC)
...
Received: from srichara-linux.qualcomm.com (blr-c-bdr-fw-01_globalnat_allzones-outside.qualcomm.com [103.229.19.19])
        ...
        by smtp.codeaurora.org (Postfix) with ESMTPSA id A29F0C5380C;
        Thu, 19 Dec 2019 10:43:05 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 smtp.codeaurora.org A29F0C5380C
...
Subject: [PATCH V2 5/7] clk: qcom: Add ipq6018 Global Clock Controller support
Date:   Thu, 19 Dec 2019 16:11:47 +0530
Message-Id: <1576752109-24497-6-git-send-email-sricharan@codeaurora.org>
...
---
 ...
 [V2] Removed all crtitical flags, removed 1/1 clocks, moved to new way
      of specifyig clk parents, and addressed other review comments.

 drivers/clk/qcom/Kconfig       |    8 +
 drivers/clk/qcom/Makefile      |    1 +
 drivers/clk/qcom/gcc-ipq6018.c | 4674 ++++++++++++++++++++++++++++++++++++++++
 3 files changed, 4683 insertions(+)
...
+	{ .fw_name = "nss_crypto_pll", .name = "nss_crypto_pll"},
