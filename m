...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 31C644CEBA
	for <lists+devicetree@lfdr.de>; Thu, 20 Jun 2019 15:32:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731837AbfFTNck (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 20 Jun 2019 09:32:40 -0400
Received: from heliosphere.sirena.org.uk ([172.104.155.198]:59042 "EHLO
        heliosphere.sirena.org.uk" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726777AbfFTNci (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 20 Jun 2019 09:32:38 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        List-Archive; bh=OjDPb042AXvYor/k88YShjth7Ub1qDC7At0STRxpMXk=; b=n7l7jspnYuZV
        IPJt1eo+tpSeBYufUagRWhYA1zOMzfzKUSvuFb/P7CnwCHV/TIggQtprRFNwvhgZR9xDiPcBn/jk4
        wR/jroV9xpF8MsLCzU7S4A08B4MAwRTnNO6DLPlw5bh0IGcQQDn5iRhXmpczkHVI4LC2IC+uwdoCt
        kipuY=;
Received: from cpc102320-sgyl38-2-0-cust46.18-2.cable.virginm.net ([82.37.168.47] helo=finisterre.sirena.org.uk)
        by heliosphere.sirena.org.uk with esmtpsa (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.89)
        (envelope-from <broonie@sirena.org.uk>)
        id 1hdxAv-0000io-UG; Thu, 20 Jun 2019 13:32:26 +0000
Received: by finisterre.sirena.org.uk (Postfix, from userid 1000)
        id 5BE4B440046; Thu, 20 Jun 2019 14:32:25 +0100 (BST)
...
Subject: Applied "ASoC: cs47l85: Add codec driver for Cirrus Logic CS47L85" to the asoc tree
In-Reply-To: <20190619134159.23580-4-ckeepax@opensource.cirrus.com>
X-Patchwork-Hint: ignore
Message-Id: <20190620133225.5BE4B440046@finisterre.sirena.org.uk>
...
From 95a9049b5854d21420a782a41e3f79619655c2bc Mon Sep 17 00:00:00 2001
From: Richard Fitzgerald <rf@opensource.cirrus.com>
Date: Wed, 19 Jun 2019 14:41:58 +0100
Subject: [PATCH] ASoC: cs47l85: Add codec driver for Cirrus Logic CS47L85
...
index 5b3f7775510c..a8aa801b9342 100644
...
@@ -583,6 +584,9 @@ config SND_SOC_CS47L24
...
@@ -713,7 +717,9 @@ config SND_SOC_LOCHNAGAR_SC
...
index 55239f0bfad0..ce02d1fb250b 100644
...
index 000000000000..4c4bae6e2c57
--- /dev/null
