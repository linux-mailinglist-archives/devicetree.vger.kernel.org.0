...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B8CEC33B47E
	for <lists+devicetree@lfdr.de>; Mon, 15 Mar 2021 14:31:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230097AbhCONa5 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 15 Mar 2021 09:30:57 -0400
Received: from mailgw01.mediatek.com ([210.61.82.183]:41753 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S229951AbhCONat (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 15 Mar 2021 09:30:49 -0400
X-UUID: 5627d98414254a63b8448fcc89965c47-20210315
X-UUID: 5627d98414254a63b8448fcc89965c47-20210315
Received: from mtkmbs10n2.mediatek.inc [(172.21.101.183)] by mailgw01.mediatek.com
        (envelope-from <roger.lu@mediatek.com>)
        (Cellopoint E-mail Firewall v4.1.14 Build 0819 with TLSv1.2 ECDHE-RSA-AES256-GCM-SHA384 256/256)
        with ESMTP id 1909441530; Mon, 15 Mar 2021 21:30:45 +0800
...
Subject: [PATCH v12 4/7] soc: mediatek: SVS: add debug commands
Date:   Mon, 15 Mar 2021 21:30:15 +0800
Message-ID: <20210315133018.4976-5-roger.lu@mediatek.com>
...
index c6a45d5c8b3f..5c315467747d 100644
...
+
 ...
 /*
@@ -138,6 +173,7 @@ enum svs_reg_index {
 	SPARE2,
 	SPARE3,
 	THSLPEVEB,
+	SVS_REG_NUM,
...
@@ -241,6 +277,7 @@ struct thermal_parameter {
...
@@ -259,6 +296,7 @@ struct thermal_parameter {
...
@@ -636,11 +676,15 @@ static void svs_set_bank_phase(struct svs_platform *svsp,
...
@@ -660,11 +704,15 @@ static inline void svs_init01_isr_handler(struct svs_platform *svsp)
...
@@ -675,6 +723,10 @@ static inline void svs_init02_isr_handler(struct svs_platform *svsp)
...
@@ -686,6 +738,7 @@ static inline void svs_mon_mode_isr_handler(struct svs_platform *svsp)
...
@@ -695,6 +748,9 @@ static inline void svs_error_isr_handler(struct svs_platform *svsp)
...
@@ -1401,9 +1457,269 @@ static int svs_resume(struct device *dev)
 	return 0;
 }
...
+		.hw_id			= 0,
 		...
 		.tzone_name		= "tzts4",
 		.buck_name		= "proc",
@@ -1439,6 +1755,7 @@ static struct svs_bank svs_mt8183_banks[4] = {
 	},
 	{
 		.sw_id			= SVSB_CPU_BIG,
+		.hw_id			= 1,
 		...
 		.tzone_name		= "tzts5",
 		.buck_name		= "proc",
@@ -1474,6 +1791,7 @@ static struct svs_bank svs_mt8183_banks[4] = {
 	},
 	{
 		.sw_id			= SVSB_CCI,
+		.hw_id			= 2,
 		...
 		.buck_name		= "proc",
 		.pd_req			= false,
@@ -1508,6 +1826,7 @@ static struct svs_bank svs_mt8183_banks[4] = {
 	},
 	{
 		.sw_id			= SVSB_GPU,
+		.hw_id			= 3,
 		...
 		.buck_name		= "mali",
 		.pd_req			= true,
@@ -1673,6 +1992,12 @@ static int svs_probe(struct platform_device *pdev)
