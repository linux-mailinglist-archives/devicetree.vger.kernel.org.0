...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 103D962DE9E
	for <lists+devicetree@lfdr.de>; Thu, 17 Nov 2022 15:47:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240172AbiKQOrP (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 17 Nov 2022 09:47:15 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42870 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240100AbiKQOrN (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 17 Nov 2022 09:47:13 -0500
Received: from mga07.intel.com (mga07.intel.com [134.134.136.100])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6CA5111155;
        Thu, 17 Nov 2022 06:47:06 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1668696426; x=1700232426;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=idwUrSaWNDU1dUeLZ1ckbbGWt6djtjY1VYophdYzFbs=;
  b=eE+4CIKejBp+VZG/DYDx0ZgyFk3SWODTCrPSIit907N51AJlZBLv/7Ly
   j002/S0I2FPYggqUtwxan1IzjPR7tcaRBK04tOErIZGKm3+zb1jLU1U5H
   8Whv2VFN1Kbd5AsCGe6kY2MT9SdtmILuB5JrB19vgG6s+OwsTP17dXmMK
   Roh+rkNe8C8ycx5SREPyOKP3gTgc3ssR+Nq1yP0VFcUcZxtq9KYNgEzOQ
   gvFj8SF7ikAdtlpZ/5JXZCiH9cG88kofqmCEClOzqcI/oy79A3LI6XDIh
   Tl4fUUZUw4bUyDaVbBmEGJCgErKgX+JsM9r8wAgTzAeiyuPIyH2YV+6FC
   w==;
X-IronPort-AV: E=McAfee;i="6500,9779,10534"; a="377132630"
X-IronPort-AV: E=Sophos;i="5.96,171,1665471600"; 
   d="scan'208";a="377132630"
Received: from orsmga008.jf.intel.com ([10.7.209.65])
  by orsmga105.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 17 Nov 2022 06:47:05 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10534"; a="670944482"
X-IronPort-AV: E=Sophos;i="5.96,171,1665471600"; 
   d="scan'208";a="670944482"
Received: from lkp-server01.sh.intel.com (HELO 55744f5052f8) ([10.239.97.150])
  by orsmga008.jf.intel.com with ESMTP; 17 Nov 2022 06:46:59 -0800
Received: from kbuild by 55744f5052f8 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ovgAM-0000O3-1x;
        Thu, 17 Nov 2022 14:46:58 +0000
Date:   Thu, 17 Nov 2022 22:46:00 +0800
...
Message-ID: <202211172205.JDQrzLqZ-lkp@intel.com>
References: <20221117035902.13995-1-zhuyinbo@loongson.cn>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="biHbqjSv0FvkXN4E"
...
[cannot apply to brgl/gpio/for-next robh/for-next linus/master v6.1-rc5 v6.1-rc4 v6.1-rc3 v6.1-rc5]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Yinbo-Zhu/gpio-loongson-add-dts-and-acpi-support/20221117-115929
patch link:    https://lore.kernel.org/r/20221117035902.13995-1-zhuyinbo%40loongson.cn
patch subject: [PATCH v4 1/2] gpio: loongson: add dts and acpi support
config: s390-allyesconfig
compiler: s390-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/16c008401566b54a060d8fd08473e0d147d206eb
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Yinbo-Zhu/gpio-loongson-add-dts-and-acpi-support/20221117-115929
        git checkout 16c008401566b54a060d8fd08473e0d147d206eb
...
>> drivers/gpio/gpio-loongson.c:18:10: fatal error: asm/loongson.h: No such file or directory
      18 | #include <asm/loongson.h>
         |          ^~~~~~~~~~~~~~~~
   compilation terminated.


vim +18 drivers/gpio/gpio-loongson.c
...
# Linux/s390 6.1.0-rc5 Kernel Configuration
#
