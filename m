...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B9A4962627F
	for <lists+devicetree@lfdr.de>; Fri, 11 Nov 2022 21:05:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234252AbiKKUFs (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 11 Nov 2022 15:05:48 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50066 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230043AbiKKUFr (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 11 Nov 2022 15:05:47 -0500
Received: from mga14.intel.com (mga14.intel.com [192.55.52.115])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 983C6725F7;
        Fri, 11 Nov 2022 12:05:39 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1668197139; x=1699733139;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=oVSK9QTmuraEW2pL/vUrCibUfCT5ZrlS10AdBQoTvWk=;
  b=hHEhVABLIjfd3F47fp0V3ShOmkMxws2SmG4fSBTKhDfHX87sCXy8Kw7S
   C7hy4fpE4PuvhnIaZpRuzexq/TMk/6OrtTX5KFH7oLJDnmbXVSwqUl179
   837sTTx5nvLsDkb0+NVI74eovOW6DnLrxqhfxuWKKMAIE1eOj7yN8w54N
   nmFQUnWreZhIYKTPf/8DQTzt/hoYUYCBgkSHLI/cgZftJX6EUeQlIu1pA
   whxoT81p7EOPUCWDuF3Hr2EH/pohhV6ZGo/vZRU1YeC4EYonjArPaJxJn
   yZndxnFVZGSWowoXIL5FlwbkQ1Hm6N77tgYjyPK9M3szQDBc5nXKTiwRu
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="311664132"
X-IronPort-AV: E=Sophos;i="5.96,157,1665471600"; 
   d="scan'208";a="311664132"
Received: from orsmga005.jf.intel.com ([10.7.209.41])
  by fmsmga103.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 11 Nov 2022 12:05:24 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10528"; a="812533752"
X-IronPort-AV: E=Sophos;i="5.96,157,1665471600"; 
   d="scan'208";a="812533752"
Received: from lkp-server01.sh.intel.com (HELO e783503266e8) ([10.239.97.150])
  by orsmga005.jf.intel.com with ESMTP; 11 Nov 2022 12:05:20 -0800
Received: from kbuild by e783503266e8 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1otaH9-0004Ft-2c;
        Fri, 11 Nov 2022 20:05:19 +0000
Date:   Sat, 12 Nov 2022 04:05:08 +0800
...
Subject: Re: [PATCH v2 2/2] soc: qcom: Add Qualcomm Ramp Controller driver
Message-ID: <202211120356.5XpbSIkD-lkp@intel.com>
References: <20221104142204.156333-3-angelogioacchino.delregno@collabora.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="N+j4zWwm2piQk832"
Content-Disposition: inline
In-Reply-To: <20221104142204.156333-3-angelogioacchino.delregno@collabora.com>
...
url:    https://github.com/intel-lab-lkp/linux/commits/AngeloGioacchino-Del-Regno/Qualcomm-Ramp-Controller-and-MSM8976-config/20221104-222824
base:   https://git.kernel.org/pub/scm/linux/kernel/git/robh/linux.git for-next
patch link:    https://lore.kernel.org/r/20221104142204.156333-3-angelogioacchino.delregno%40collabora.com
patch subject: [PATCH v2 2/2] soc: qcom: Add Qualcomm Ramp Controller driver
config: ia64-allmodconfig
compiler: ia64-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/d5f50aa422755baabb49b6982283a5ea51d8f2e1
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review AngeloGioacchino-Del-Regno/Qualcomm-Ramp-Controller-and-MSM8976-config/20221104-222824
        git checkout d5f50aa422755baabb49b6982283a5ea51d8f2e1
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=ia64 SHELL=/bin/bash drivers/media/platform/ drivers/soc/qcom/
...
All errors (new ones prefixed by >>):
   ...
   drivers/soc/qcom/ramp_controller.c: In function 'rc_set_cfg_update':
>> drivers/soc/qcom/ramp_controller.c:104:15: error: implicit declaration of function 'FIELD_PREP' [-Werror=implicit-function-declaration]
