...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8655B39ADB7
	for <lists+devicetree@lfdr.de>; Fri,  4 Jun 2021 00:18:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231270AbhFCWU3 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 3 Jun 2021 18:20:29 -0400
Received: from relmlor2.renesas.com ([210.160.252.172]:9907 "EHLO
        relmlie6.idc.renesas.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S230265AbhFCWU3 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 3 Jun 2021 18:20:29 -0400
X-IronPort-AV: E=Sophos;i="5.83,246,1616425200"; 
   d="scan'208";a="83182167"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie6.idc.renesas.com with ESMTP; 04 Jun 2021 07:18:42 +0900
Received: from localhost.localdomain (unknown [10.226.36.204])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id CA0B4410B534;
        Fri,  4 Jun 2021 07:18:38 +0900 (JST)
...
Subject: [PATCH v2 08/12] clk: renesas: Add CPG core wrapper for RZ/G2L SoC
Date:   Thu,  3 Jun 2021 23:17:54 +0100
Message-Id: <20210603221758.10305-9-prabhakar.mahadev-lad.rj@bp.renesas.com>
...
---
 ...
 drivers/clk/renesas/renesas-rzg2l-cpg.c | 973 ++++++++++++++++++++++++
 drivers/clk/renesas/renesas-rzg2l-cpg.h | 215 ++++++
...
index 607e64a17d72..5a0d934f43a4 100644
...
index 000000000000..f096b9d0548c
--- /dev/null
...
+}
+
+static int rzg2l_cpg_div2_clk_determine_rate(struct clk_hw *hw,
+					     struct clk_rate_request *req)
+{
+	unsigned long best_diff = (unsigned long)-1;
+	unsigned int best_div, best_divs, div, divs;
+	struct div2_clk *d2clk = to_d2clk(hw);
+	unsigned int i, j, n, ns;
+	unsigned long diff;
+
...
+			diff = abs(req->best_parent_rate - (req->rate * div * divs));
+			if (best_diff > diff) {
+				best_diff = diff;
+				best_div = div;
+				best_divs = divs;
...
+	}
+
+	req->rate = DIV_ROUND_CLOSEST_ULL((u64)req->best_parent_rate, best_div * best_divs);
+	return 0;
+}
+
...
+	.determine_rate = rzg2l_cpg_div2_clk_determine_rate,
...
new file mode 100644
index 000000000000..8e7117e7f79b
--- /dev/null
