...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5E38C3B43B5
	for <lists+devicetree@lfdr.de>; Fri, 25 Jun 2021 14:59:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231654AbhFYNBk (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 25 Jun 2021 09:01:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37120 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231501AbhFYNBj (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 25 Jun 2021 09:01:39 -0400
Received: from andre.telenet-ops.be (andre.telenet-ops.be [IPv6:2a02:1800:120:4::f00:15])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4F5C6C0617AE
...
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed20:1476:ce84:e216:add8])
        ...
        id MQzC2500K2B1U9901QzCg6; Fri, 25 Jun 2021 14:59:13 +0200
Received: from rox.of.borg ([192.168.97.57])
        by ramsan.of.borg with esmtps  (TLS1.3) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
        (Exim 4.93)
        (envelope-from <geert@linux-m68k.org>)
        id 1lwlQO-003TMI-2x; Fri, 25 Jun 2021 14:59:12 +0200
Received: from geert by rox.of.borg with local (Exim 4.93)
        (envelope-from <geert@linux-m68k.org>)
        id 1lwlQN-004sQb-J4; Fri, 25 Jun 2021 14:59:11 +0200
...
Subject: [PATCH v2 06/18] auxdisplay: Extract character line display core support
Date:   Fri, 25 Jun 2021 14:58:50 +0200
Message-Id: <20210625125902.1162428-7-geert@linux-m68k.org>
...
+	for (i = 0; i < linedisp->num_chars; i++) {
 		...
 		if (err)
 			break;
@@ -218,140 +214,22 @@ static const struct of_device_id img_ascii_lcd_matches[] = {
 };
...
@@ -391,29 +269,22 @@ static int img_ascii_lcd_probe(struct platform_device *pdev)
...
@@ -430,8 +301,8 @@ static int img_ascii_lcd_remove(struct platform_device *pdev)
 {
