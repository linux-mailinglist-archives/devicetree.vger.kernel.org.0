...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 820B7379926
	for <lists+devicetree@lfdr.de>; Mon, 10 May 2021 23:28:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232082AbhEJV3O (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 10 May 2021 17:29:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45346 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231434AbhEJV3O (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 10 May 2021 17:29:14 -0400
Received: from relay01.th.seeweb.it (relay01.th.seeweb.it [IPv6:2001:4b7a:2000:18::162])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 81277C061760;
        Mon, 10 May 2021 14:28:08 -0700 (PDT)
Received: from IcarusMOD.eternityproject.eu (unknown [2.237.20.237])
        (using TLSv1.3 with cipher TLS_AES_128_GCM_SHA256 (128/128 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by m-r1.th.seeweb.it (Postfix) with ESMTPSA id E52671F50A;
        Mon, 10 May 2021 23:28:02 +0200 (CEST)
...
References: <HlKgfVyFuKjJEozBiamG7OpJNtXapuXyTiBzrned5KC3onTAJ4hO9l0LzpfDL9WQ4PKv5gNXSDAHPh6-nqSwjsOjrh-wS8_OIl-ChUSvbiE=@protonmail.com>
From:   AngeloGioacchino Del Regno 
        <angelogioacchino.delregno@somainline.org>
Message-ID: <ea8c9317-a4b8-3b5b-d0b9-fb703258775b@somainline.org>
Date:   Mon, 10 May 2021 23:28:01 +0200
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.9.0
MIME-Version: 1.0
In-Reply-To: <HlKgfVyFuKjJEozBiamG7OpJNtXapuXyTiBzrned5KC3onTAJ4hO9l0LzpfDL9WQ4PKv5gNXSDAHPh6-nqSwjsOjrh-wS8_OIl-ChUSvbiE=@protonmail.com>
...
Il 10/05/21 20:40, Yassine Oudjana ha scritto:
...
Hi Yassine,
happy to receive reviews on this series.
...
This is a way to poke the CPR hardware. I don't clearly remember
specifically what was it (sorry, too much time has passed and my
brain starts forgetting...), but failing to do this would lead to
unstabilities.

There was something happening to that CPR3_REG_IRQ_EN value when the
target frequency changed, but ... I am really sad I don't remember.
...
I again don't clearly remember, but that should be from one of the
hardcoded structs in the downstream CPR driver.
...
That's right, this should get moved away from here.
