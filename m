...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 283D34D4133
	for <lists+devicetree@lfdr.de>; Thu, 10 Mar 2022 07:36:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237911AbiCJGhE (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 10 Mar 2022 01:37:04 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55056 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238025AbiCJGhD (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 10 Mar 2022 01:37:03 -0500
Received: from mx1.cqplus1.com (unknown [113.204.237.245])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id D284C12E765
        for <devicetree@vger.kernel.org>; Wed,  9 Mar 2022 22:35:47 -0800 (PST)
...
Subject: [PATCH v10 06/10] clk: Add Sunplus SP7021 clock driver
Date:   Thu, 10 Mar 2022 14:28:45 +0800
Message-Id: <d8b68c5f77cea516504984470c5b93f8df42bbec.1646892811.git.qinjian@cqplus1.com>
...
+#define DBG_CLK(clk)					\
+{							\
+	struct clk_hw *_hw = clk;			\
+	const char *name = clk_hw_get_name(_hw);	\
+	unsigned long rate = clk_hw_get_rate(_hw);	\
+	pr_debug("%-20s%lu\n", name, rate);		\
+}
+#else
+#define DBG_CLK(...)
