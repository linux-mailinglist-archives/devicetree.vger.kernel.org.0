...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id AFE37DD0C6
	for <lists+devicetree@lfdr.de>; Fri, 18 Oct 2019 23:01:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2393193AbfJRVBU (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 18 Oct 2019 17:01:20 -0400
Received: from mail-pl1-f195.google.com ([209.85.214.195]:37326 "EHLO
        mail-pl1-f195.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731817AbfJRVBU (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 18 Oct 2019 17:01:20 -0400
Received: by mail-pl1-f195.google.com with SMTP id u20so3424307plq.4;
        Fri, 18 Oct 2019 14:01:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=sender:date:from:to:cc:subject:message-id:mime-version
         :content-disposition:user-agent;
        bh=QZxhasOMzpXhe7CEvibEFesyD2KeK+aFLiVgl9PMtuI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=QZxhasOMzpXhe7CEvibEFesyD2KeK+aFLiVgl9PMtuI=;
        b=
X-Gm-Message-State: APjAAAV8Pjs61oPiSGEz3FLFPoZahZ0IWgjRnhrIurwRYTvVSuyEEDw/
        ZNRShT3Ga5R8ESql/x4fdEM=
X-Google-Smtp-Source: APXvYqzVr7gk5IVbKxnvGv+X53RALckp/5RmRA38len2QiPYLze/R+ofjkQpAHEzXnpeuJ7jAWLIUw==
X-Received: by 2002:a17:902:7891:: with SMTP id q17mr12143528pll.241.1571432478526;
        Fri, 18 Oct 2019 14:01:18 -0700 (PDT)
Received: from localhost ([2600:1700:e321:62f0:329c:23ff:fee3:9d7c])
        by smtp.gmail.com with ESMTPSA id t21sm7862892pgi.87.2019.10.18.14.01.16
        (version=TLS1_2 cipher=ECDHE-RSA-CHACHA20-POLY1305 bits=256/256);
        Fri, 18 Oct 2019 14:01:17 -0700 (PDT)
Date:   Fri, 18 Oct 2019 14:01:15 -0700
...
Subject: Re: [PATCH][RESEND] New driver for TLV493D-A1B6 I2C chip, input and
 hwmon class device.
Message-ID: <20191018210115.GA3902@roeck-us.net>
MIME-Version: 1.0
...
total: 1 errors, 401 warnings, 53 checks, 774 lines checked

You might want to consider using the kernel coding style if you expect
anyone to actually review your code. At least for me it is all but
unreadable (did you replace all tabs with spaces ? why ?)

Also, from the chip description, it seems to me that this should be
implemented as iio driver. It is not a hardware monitoring driver and
should not register with the hardware monitoring subsystem, or at least
not directly.
...
> 
> diff --git a/Documentation/devicetree/bindings/input/tlv493d-a1b6_rotenc.txt
...
> +};
> +
> +reg is the only mandatory parameter, for the others defaults will be used if
> not specified.
> +
> +reg = <0x1f> - set to alternate address
> +Can be switched to <0x5f>, the primary address, but this is unavailable at
> for some +i2c controllers.
> +For example 0x1f must be used for NXP IMx6 SOC.
> +This may change in future with its i2c-controller driver updates.
> +
> +0x5f is the device's default address, but we need to preserve the address
> after device
> +periodical reset and it's impossible to reset it to primary address on some
> i2c controllers.
...
> +
> +temp_base:
> + raw binary value for 25 deg C, typical value is 340, but it differs device
> to device. See datasheet.
> +
> +refresh_rate:
...
> +}
> +
> +static void tlv493da1b6_rotenc_power(struct tlv493da1b6_rotenc_data *rotenc,
> + bool poweron)
> +{
> +}
> +
