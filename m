...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1B9E16750C8
	for <lists+devicetree@lfdr.de>; Fri, 20 Jan 2023 10:22:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230292AbjATJWR (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 20 Jan 2023 04:22:17 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37642 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230296AbjATJVn (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 20 Jan 2023 04:21:43 -0500
Received: from madras.collabora.co.uk (madras.collabora.co.uk [46.235.227.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4A89D4218;
        Fri, 20 Jan 2023 01:21:16 -0800 (PST)
Received: from IcarusMOD.eternityproject.eu (2-237-20-237.ip236.fastwebnet.it [2.237.20.237])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        (Authenticated sender: kholk11)
        by madras.collabora.co.uk (Postfix) with ESMTPSA id 665476602DFA;
        Fri, 20 Jan 2023 09:21:11 +0000 (GMT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1674206472;
        bh=4BapiV5xXShFZxXXapl0X0bp3Wetd7QF5F4ErU2/WXc=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v4 08/23] clk: mediatek: mt8173: Migrate to platform driver and common probe
Date:   Fri, 20 Jan 2023 10:20:38 +0100
Message-Id: <20230120092053.182923-9-angelogioacchino.delregno@collabora.com>
...
---
 drivers/clk/mediatek/clk-mt8173.c | 483 +++++++++++++++++-------------
 1 file changed, 276 insertions(+), 207 deletions(-)

diff --git a/drivers/clk/mediatek/clk-mt8173.c b/drivers/clk/mediatek/clk-mt8173.c
index e3786fd64726..0163d27e8795 100644
...
+static void mtk_clk_enable_critical(void)
 {
 	if (!mt8173_top_clk_data || !mt8173_pll_clk_data)
 		return;
@@ -853,104 +863,152 @@ static void __init mtk_clk_enable_critical(void)
...
@@ -1009,119 +1067,130 @@ static const struct mtk_pll_data plls[] = {
