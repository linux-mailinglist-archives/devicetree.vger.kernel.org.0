...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0BDCA5018FB
	for <lists+devicetree@lfdr.de>; Thu, 14 Apr 2022 18:46:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236312AbiDNQtA (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 14 Apr 2022 12:49:00 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38850 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242815AbiDNQsZ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 14 Apr 2022 12:48:25 -0400
Received: from finn.localdomain (finn.gateworks.com [108.161.129.64])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7926D129EAB;
        Thu, 14 Apr 2022 09:15:13 -0700 (PDT)
Received: from 068-189-091-139.biz.spectrum.com ([68.189.91.139] helo=tharvey.pdc.gateworks.com)
        by finn.localdomain with esmtp (Exim 4.93)
        (envelope-from <tharvey@gateworks.com>)
        id 1nf27g-00CSRb-MD; Thu, 14 Apr 2022 16:15:08 +0000
...
Subject: [PATCH v2 2/2] arm64: dts: imx: Add i.MX8M Plus Gateworks gw7400 dts support
Date:   Thu, 14 Apr 2022 09:15:05 -0700
Message-Id: <20220414161505.15524-2-tharvey@gateworks.com>
...
v2
 - impelement feedback from Krzysztof
  ...
  - use generic node names for gpio-keys subnode
  - use proper LED_FUNCTION_HEARTBEAT for led function
  - drop unnecesary status from pps-gpio subnode
---
 arch/arm64/boot/dts/freescale/Makefile        |   1 +
 .../dts/freescale/imx8mp-venice-gw74xx.dts    | 896 ++++++++++++++++++
...
index 85c2c9ba5110..2e1ad67f486a 100644
--- a/arch/arm64/boot/dts/freescale/Makefile
+++ b/arch/arm64/boot/dts/freescale/Makefile
@@ -79,6 +79,7 @@ dtb-$(CONFIG_ARCH_MXC) += imx8mn-var-som-symphony.dtb
