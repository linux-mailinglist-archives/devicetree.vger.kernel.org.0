...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B753E199F4
	for <lists+devicetree@lfdr.de>; Fri, 10 May 2019 10:47:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727177AbfEJIru (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 10 May 2019 04:47:50 -0400
Received: from hqemgate15.nvidia.com ([216.228.121.64]:13179 "EHLO
        hqemgate15.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727119AbfEJIrt (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 10 May 2019 04:47:49 -0400
Received: from hqpgpgate101.nvidia.com (Not Verified[216.228.121.13]) by hqemgate15.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5cd53a8a0000>; Fri, 10 May 2019 01:47:06 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate101.nvidia.com (PGP Universal service);
  Fri, 10 May 2019 01:47:42 -0700
X-PGP-Universal: processed;
        by hqpgpgate101.nvidia.com on Fri, 10 May 2019 01:47:42 -0700
...
Received: from hqnvemgw02.nvidia.com (172.16.227.111) by HQMAIL107.nvidia.com
 ...
 Transport; Fri, 10 May 2019 08:47:41 +0000
...
Subject: [PATCH V3 6/8] memory: tegra: Add EMC scaling sequence code for Tegra210
Date:   Fri, 10 May 2019 16:47:17 +0800
Message-ID: <20190510084719.18902-7-josephl@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1557478026; bh=801J8SBD+r6ArGthEys8ZuD03+9KC4DoaNU78baVynY=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:MIME-Version:X-NVConfidentiality:
         Content-Transfer-Encoding:Content-Type;
        b=
...
index 000000000000..971efea3d29e
--- /dev/null
...
+
+	fake_timing =3D get_timing_from_freq(emc, last_timing->rate);
+
...
+		u32 var;
+		u32 wval;
+		const u32 *burst_regs_off =3D &reg_off.burst_regs_off[0];
+
+		if (!burst_regs_off[i])
+			continue;
+
...
+		u64 trim_reg;
+		const u32 *trim_regs_off =3D &reg_off.trim_regs_off[0];
+
+		if (!trim_regs_off[i])
+			continue;
+
...
ra210-emc.c
index 285dfc1ed7c2..83b3f57bf1aa 100644
--- a/drivers/memory/tegra/tegra210-emc.c
+++ b/drivers/memory/tegra/tegra210-emc.c
@@ -134,6 +134,11 @@ static const char *emc_src_names[TEGRA_EMC_SRC_COUNT] =
=3D {
 };
=20
...
ra210-emc.h
index c07e4209cb57..ef70b00160d0 100644
...
+
 enum {
 	REG_EMC,
 	REG_EMC0,
@@ -849,7 +1004,9 @@ void emc_writel_per_ch(struct tegra_emc *emc, u32 val,=
 int type,
