...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1F4901166DB
	for <lists+devicetree@lfdr.de>; Mon,  9 Dec 2019 07:21:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727069AbfLIGVG (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 9 Dec 2019 01:21:06 -0500
Received: from mail-eopbgr770074.outbound.protection.outlook.com ([40.107.77.74]:8162
        "EHLO NAM02-SN1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1727120AbfLIGVG (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Mon, 9 Dec 2019 01:21:06 -0500
Received: from BYAPR02CA0047.namprd02.prod.outlook.com (2603:10b6:a03:54::24)
 by DM5PR02MB2187.namprd02.prod.outlook.com (2603:10b6:3:4f::14) with
...
Received: from SN1NAM02FT014.eop-nam02.prod.protection.outlook.com
 (2a01:111:f400:7e44::206) by BYAPR02CA0047.outlook.office365.com
 ...
 Transport; Mon, 9 Dec 2019 06:20:05 +0000
...
Received: from xsj-pvapsmtpgw01 (149.199.60.83) by
 ...
 via Frontend Transport; Mon, 9 Dec 2019 06:20:05 +0000
Received: from unknown-38-66.xilinx.com ([149.199.38.66] helo=xsj-pvapsmtp01)
        by xsj-pvapsmtpgw01 with esmtp (Exim 4.63)
        (envelope-from <shubhrajyoti.datta@gmail.com>)
        id 1ieCGm-0004SK-0H; Sun, 08 Dec 2019 22:11:44 -0800
Received: from [127.0.0.1] (helo=xsj-smtp-dlp1.xlnx.xilinx.com)
        by xsj-pvapsmtp01 with esmtp (Exim 4.63)
        (envelope-from <shubhrajyoti.datta@gmail.com>)
        id 1ieCGg-0002dx-QI; Sun, 08 Dec 2019 22:11:38 -0800
Received: from xsj-pvapsmtp01 (mail.xilinx.com [149.199.38.66] (may be forged))
        by xsj-smtp-dlp1.xlnx.xilinx.com (8.13.8/8.13.1) with ESMTP id xB96BbDW029745;
        Sun, 8 Dec 2019 22:11:38 -0800
Received: from [10.140.6.59] (helo=xhdshubhraj40.xilinx.com)
        by xsj-pvapsmtp01 with esmtp (Exim 4.63)
        (envelope-from <shubhrajyoti.datta@gmail.com>)
        id 1ieCGe-0002co-Hc; Sun, 08 Dec 2019 22:11:37 -0800
...
Subject: [PATCH v2 2/3] trafgen: xilinx: add axi traffic generator driver
Date:   Mon,  9 Dec 2019 11:41:27 +0530
Message-Id: <d66da6c524d01414562d3c15853174eeafa0c9fa.1575871828.git.shubhrajyoti.datta@xilinx.com>
...
X-Matching-Connectors: 132203460053203864;(f9e945fa-a09a-4caa-7158-08d2eb1d8c44);()
X-Forefront-Antispam-Report: CIP:149.199.60.83;IPV:NLI;CTRY:US;EFV:NLI;SFV:NSPM;SFS:(10009020)(396003)(39860400002)(136003)(376002)(346002)(199004)(189003)(48376002)(336012)(54906003)(316002)(73392003)(9786002)(50466002)(5660300002)(118296001)(70586007)(426003)(70206006)(26005)(51416003)(7696005)(76176011)(76482006)(6666004)(356004)(9686003)(2906002)(86362001)(30864003)(82202003)(498600001)(305945005)(450100002)(107886003)(36756003)(50226002)(8676002)(8936002)(4326008)(81156014)(81166006)(42866002)(579004)(559001);DIR:OUT;SFP:1101;SCL:1;SRVR:DM5PR02MB2187;H:xsj-pvapsmtpgw01;FPR:;SPF:SoftFail;LANG:en;PTR:unknown-60-83.xilinx.com;A:1;MX:1;
MIME-Version: 1.0
Content-Type: text/plain
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: 1f56d1f0-fc48-498a-e5b1-08d77c6fd4fb
X-MS-TrafficTypeDiagnostic: DM5PR02MB2187:
X-Microsoft-Antispam-PRVS: <DM5PR02MB2187F9C21E42E52EEA5F11D587580@DM5PR02MB2187.namprd02.prod.outlook.com>
X-MS-Oob-TLC-OOBClassifiers: OLM:7219;
X-Forefront-PRVS: 02462830BE
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 09 Dec 2019 06:20:05.0514
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: 1f56d1f0-fc48-498a-e5b1-08d77c6fd4fb
X-MS-Exchange-CrossTenant-Id: 5afe0b00-7697-4969-b663-5eab37d5f47e
X-MS-Exchange-CrossTenant-OriginalAttributedTenantConnectingIp: TenantId=5afe0b00-7697-4969-b663-5eab37d5f47e;Ip=[149.199.60.83];Helo=[xsj-pvapsmtpgw01]
X-MS-Exchange-CrossTenant-FromEntityHeader: HybridOnPrem
X-MS-Exchange-Transport-CrossTenantHeadersStamped: DM5PR02MB2187
