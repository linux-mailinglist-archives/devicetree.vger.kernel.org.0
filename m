...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9E3B27190DC
	for <lists+devicetree@lfdr.de>; Thu,  1 Jun 2023 05:04:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231405AbjFADEY (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 31 May 2023 23:04:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38996 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230450AbjFADDg (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 31 May 2023 23:03:36 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 83B23E5D;
        Wed, 31 May 2023 20:03:11 -0700 (PDT)
X-UUID: d4b9cd2c002811eeb20a276fd37b9834-20230601
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=vXB5AaM1ACGzTxJWMPDq37j23JY7ou+wGH+LjKPKRvw=;
        b=IXeOKb06EyWfE/hyEMI83VtxwB8asIXv7p+f8DSW0f9fFVFjUxGvukHzD5zR04oXtL4tmwukg7+9pBKKlzBa3Y15P/jRK/5Ds8ZqDzNw3uUDjmhv2fDwWFUWV95QZig4HgQhUaoXUmKXNBq+P6OVA8PrQ4BE+7u0hoBNbTjQRLU=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.25,REQID:e8746908-0528-4d8b-9874-feb58af29060,IP:0,U
        RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTIO
        N:release,TS:-25
X-CID-META: VersionHash:d5b0ae3,CLOUDID:dbad023d-de1e-4348-bc35-c96f92f1dcbb,B
...
Received: from mtkmbs11n2.mediatek.inc [(172.21.101.187)] by mailgw02.mediatek.com
        ...
        with ESMTP id 1367174717; Thu, 01 Jun 2023 11:03:06 +0800
Received: from mtkmbs13n1.mediatek.inc (172.21.101.193) by
 mtkmbs13n2.mediatek.inc (172.21.101.108) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26; Thu, 1 Jun 2023 11:03:04 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkmbs13n1.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.2.1118.26 via Frontend Transport; Thu, 1 Jun 2023 11:03:04 +0800
...
Subject: [PATCH 6/8] mediatek: vcodec: separate struct mtk_vcodec_dev
Date:   Thu, 1 Jun 2023 11:02:54 +0800
Message-ID: <20230601030256.29875-7-yunfei.dong@mediatek.com>
...
index d4672d627e43..dde428ba3a9a 100644
...
index b1e56564cf2c..e55d67783d39 100644
...
+#include "mtk_vcodec_dec_drv.h"
 ...
 #include "mtk_vcodec_util.h"
@@ -896,7 +896,7 @@ void vb2ops_vdec_stop_streaming(struct vb2_queue *q)
...
index 0451e75b921f..123c1430ce67 100644
...
@@ -40,7 +39,7 @@ static int mtk_vcodec_get_hw_count(struct mtk_vcodec_dev *dev)
...
@@ -238,7 +237,7 @@ static int fops_vcodec_open(struct file *file)
...
@@ -275,7 +274,7 @@ static const struct v4l2_file_operations mtk_vcodec_fops = {
...
index 9b59aaee19ec..f33bb0c99911 100644
...
index 113ca5f60f2b..dd961a1ae2e8 100644
--- a/drivers/media/platform/mediatek/vcodec/mtk_vcodec_dec_pm.c
+++ b/drivers/media/platform/mediatek/vcodec/mtk_vcodec_dec_pm.c
@@ -108,7 +108,7 @@ static void mtk_vcodec_dec_clock_off(struct mtk_vcodec_pm *pm)
...
@@ -126,7 +126,7 @@ static void mtk_vcodec_dec_enable_irq(struct mtk_vcodec_dev *vdec_dev, int hw_id
 	}
 }
...
@@ -172,7 +172,7 @@ static void mtk_vcodec_record_racing_info(struct mtk_vcodec_dec_ctx *ctx)
...
+static struct mtk_vcodec_pm *mtk_vcodec_dec_get_pm(struct mtk_vcodec_dec_dev *vdec_dev,
 ...
 {
 	struct mtk_vdec_hw_dev *subdev_dev;
@@ -192,7 +192,7 @@ static struct mtk_vcodec_pm *mtk_vcodec_dec_get_pm(struct mtk_vcodec_dev *vdec_d
 	return &vdec_dev->pm;
 }
...
+static void mtk_vcodec_dec_child_dev_on(struct mtk_vcodec_dec_dev *vdec_dev,
 ...
 {
 	struct mtk_vcodec_pm *pm;
@@ -212,7 +212,7 @@ static void mtk_vcodec_dec_child_dev_on(struct mtk_vcodec_dev *vdec_dev,
 	}
 }
...
index 9811118192ac..b0e1e18b2d9b 100644
...
-#include "mtk_vcodec_drv.h"
 ...
 #include "mtk_vcodec_intr.h"
 #include "mtk_vcodec_util.h"
@@ -277,7 +276,7 @@ static void mtk_vdec_worker(struct work_struct *work)
 {
 	struct mtk_vcodec_dec_ctx *ctx =
...
index 998e962e5e85..875cbade949b 100644
...
-#include "mtk_vcodec_drv.h"
 ...
 #include "mtk_vcodec_intr.h"
 #include "mtk_vcodec_util.h"
@@ -287,7 +286,7 @@ static void mtk_vdec_worker(struct work_struct *work)
 {
 	struct mtk_vcodec_dec_ctx *ctx =
 		container_of(work, struct mtk_vcodec_dec_ctx, decode_work);
-	struct mtk_vcodec_dev *dev = ctx->dev;
...
@@ -440,7 +439,7 @@ const struct media_device_ops mtk_vcodec_media_ops = {
...
index 0da61adfd5ee..452bcbf82d23 100644
...
-#include "mtk_vcodec_drv.h"
 ...
 #include "mtk_vcodec_intr.h"
 #include "mtk_vcodec_util.h"
@@ -1463,7 +1462,7 @@ int mtk_vcodec_enc_queue_init(void *priv, struct vb2_queue *src_vq,
...
+	struct mtk_vcodec_enc_dev *dev = ctx->dev;
 	...
 	return 0;
@@ -1471,7 +1470,7 @@ int mtk_venc_unlock(struct mtk_vcodec_enc_ctx *ctx)
...
index a5b4b654cc5b..b9653330e7af 100644
...
@@ -117,7 +116,7 @@ static irqreturn_t mtk_vcodec_enc_irq_handler(int irq, void *priv)
...
+	struct mtk_vcodec_enc_dev *dev = video_drvdata(file);
 	...
 	int ret = 0;
 	struct vb2_queue *src_vq;
@@ -206,7 +205,7 @@ static int fops_vcodec_open(struct file *file)
...
@@ -235,7 +234,7 @@ static const struct v4l2_file_operations mtk_vcodec_fops = {
...
+	struct mtk_vcodec_enc_dev *dev;
 	...
 	phandle rproc_phandle;
 	enum mtk_vcodec_fw_type fw_type;
@@ -457,7 +456,7 @@ MODULE_DEVICE_TABLE(of, mtk_vcodec_enc_match);
...
@@ -467,7 +466,7 @@ static void mtk_vcodec_enc_remove(struct platform_device *pdev)
 	if (dev->vfd_enc)
...
index 7055954eb2af..896c6f971b79 100644
...
index be9159acacf8..ba619beeac59 100644
...
@@ -119,9 +119,9 @@ struct mtk_vcodec_fw *mtk_vcodec_fw_vpu_init(void *priv, enum mtk_vcodec_fw_use
 	}
...
index e28df989fd82..9d54100a4bc8 100644
...
index 3a3cf5034028..c2d6ac7abc40 100644
...
-#include "mtk_vcodec_util.h"
 ...
 #if defined(CONFIG_DEBUG_FS)
 int mtk_vcodec_dbg;
@@ -103,7 +103,7 @@ void mtk_vcodec_mem_free(void *priv, struct mtk_vcodec_mem *mem)
 }
...
@@ -114,7 +114,7 @@ void *mtk_vcodec_get_hw_dev(struct mtk_vcodec_dev *dev, int hw_idx)
 }
...
+void mtk_vcodec_set_curr_ctx(struct mtk_vcodec_dec_dev *vdec_dev,
 ...
 {
 	unsigned long flags;
@@ -136,7 +136,7 @@ void mtk_vcodec_set_curr_ctx(struct mtk_vcodec_dev *vdec_dev,
 }
...
index 9c31e70272bd..229735440575 100644
...
@@ -67,10 +67,10 @@ extern int mtk_vcodec_dbg;
...
index 42355008d580..171d05b9a870 100644
--- a/drivers/media/platform/mediatek/vcodec/vdec/vdec_h264_req_multi_if.c
+++ b/drivers/media/platform/mediatek/vcodec/vdec/vdec_h264_req_multi_if.c
@@ -544,7 +544,7 @@ static int vdec_h264_slice_core_decode(struct vdec_lat_buf *lat_buf)
 	return 0;
 }
...
index a2b5f3dce466..ccab7a23de25 100644
...
@@ -242,7 +242,7 @@ static void vdec_msg_queue_core_work(struct work_struct *work)
...
index 2120243c208d..01b66dec1403 100644
...
index 8916a7c047a1..50cad924d616 100644
...
index d35b8027e574..7d5077c5a2ae 100644
...
index 06b4e835eab6..9ce6a8ee80d6 100644
