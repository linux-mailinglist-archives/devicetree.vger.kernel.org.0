...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 29AA51CF8EE
	for <lists+devicetree@lfdr.de>; Tue, 12 May 2020 17:20:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730621AbgELPUd (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 12 May 2020 11:20:33 -0400
Received: from mail-bn8nam11on2065.outbound.protection.outlook.com ([40.107.236.65]:6270
        "EHLO NAM11-BN8-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1730546AbgELPUb (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Tue, 12 May 2020 11:20:31 -0400
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=Buu6ob93zUb9YBgXgLUshnGuhMP383v5yJLlWhycv8E=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=Buu6ob93zUb9YBgXgLUshnGuhMP383v5yJLlWhycv8E=;
 b=UImGJpLjGTeTDBhbu8h/IJS+guc0oUPGxeAV2wGslpokWfSM2SjHT6BX2NJKiOPM7NTFISTI7TK7XcDqE8c/LzuutD9iLjCt+pAoqWNZXllnOHAFXmzy9FFRDR8TsseNpMSkiGD8NHspUn5KmkbXt2Gk8WMJv0gBrVAY6Cp5ZVs=
Received: from CY4PR1101CA0003.namprd11.prod.outlook.com
 (2603:10b6:910:15::13) by BL0PR02MB4468.namprd02.prod.outlook.com
 (2603:10b6:208:4a::13) with Microsoft SMTP Server (version=TLS1_2,
...
Received: from CY1NAM02FT020.eop-nam02.prod.protection.outlook.com
 (2603:10b6:910:15:cafe::50) by CY4PR1101CA0003.outlook.office365.com
...
Received: from xsj-pvapsmtpgw01 (149.199.60.83) by
 ...
 +0000
Received: from [149.199.38.66] (port=47685 helo=xsj-pvapsmtp01)
        by xsj-pvapsmtpgw01 with esmtp (Exim 4.90)
        (envelope-from <vishal.sagar@xilinx.com>)
        id 1jYWhP-0004LB-Lu; Tue, 12 May 2020 08:20:03 -0700
Received: from [127.0.0.1] (helo=localhost)
        by xsj-pvapsmtp01 with smtp (Exim 4.63)
        (envelope-from <vishal.sagar@xilinx.com>)
        id 1jYWhg-0000YH-2J; Tue, 12 May 2020 08:20:20 -0700
Received: from xsj-pvapsmtp01 (smtp2.xilinx.com [149.199.38.66])
        by xsj-smtp-dlp1.xlnx.xilinx.com (8.13.8/8.13.1) with ESMTP id 04CFKA39021567;
        Tue, 12 May 2020 08:20:10 -0700
Received: from [172.23.82.133] (helo=xhdvsagar40x.xilinx.com)
        by xsj-pvapsmtp01 with esmtp (Exim 4.63)
        (envelope-from <vishal.sagar@xilinx.com>)
        id 1jYWhV-0008NS-8q; Tue, 12 May 2020 08:20:10 -0700
...
Subject: [PATCH v13 2/2] media: v4l: xilinx: Add Xilinx MIPI CSI-2 Rx Subsystem driver
Date:   Tue, 12 May 2020 20:49:47 +0530
Message-Id: <20200512151947.120348-3-vishal.sagar@xilinx.com>
...
X-Forefront-Antispam-Report: CIP:149.199.60.83;CTRY:US;LANG:en;SCL:1;SRV:;IPV:NLI;SFV:NSPM;H:xsj-pvapsmtpgw01;PTR:unknown-60-83.xilinx.com;CAT:NONE;SFTY:;SFS:(136003)(396003)(39860400002)(346002)(376002)(46966005)(33430700001)(316002)(2616005)(6666004)(36756003)(336012)(9786002)(426003)(110136005)(82310400002)(47076004)(8676002)(81166007)(5660300002)(4326008)(26005)(478600001)(356005)(54906003)(7416002)(186003)(33440700001)(7696005)(70206006)(70586007)(2906002)(30864003)(8936002)(107886003)(82740400003)(44832011)(1076003)(921003)(579004);DIR:OUT;SFP:1101;
Content-Type: text/plain
X-MS-PublicTrafficType: Email
X-MS-Office365-Filtering-Correlation-Id: c87e1db8-3c46-43ac-e465-08d7f687fbe4
X-MS-TrafficTypeDiagnostic: BL0PR02MB4468:
X-Microsoft-Antispam-PRVS: <BL0PR02MB44687344E28C3CB26FFCD09EA7BE0@BL0PR02MB4468.namprd02.prod.outlook.com>
X-Auto-Response-Suppress: DR, RN, NRN, OOF, AutoReply
X-MS-Oob-TLC-OOBClassifiers: OLM:163;
X-Forefront-PRVS: 0401647B7F
X-MS-Exchange-SenderADCheck: 1
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info: 
X-OriginatorOrg: xilinx.com
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 12 May 2020 15:20:20.3154
 (UTC)
X-MS-Exchange-CrossTenant-Network-Message-Id: c87e1db8-3c46-43ac-e465-08d7f687fbe4
X-MS-Exchange-CrossTenant-Id: 657af505-d5df-48d0-8300-c31994686c5c
X-MS-Exchange-CrossTenant-OriginalAttributedTenantConnectingIp: TenantId=657af505-d5df-48d0-8300-c31994686c5c;Ip=[149.199.60.83];Helo=[xsj-pvapsmtpgw01]
X-MS-Exchange-CrossTenant-FromEntityHeader: HybridOnPrem
X-MS-Exchange-Transport-CrossTenantHeadersStamped: BL0PR02MB4468
