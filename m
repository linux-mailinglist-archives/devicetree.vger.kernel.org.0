...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8D06B798B19
	for <lists+devicetree@lfdr.de>; Fri,  8 Sep 2023 18:57:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240285AbjIHQ52 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 8 Sep 2023 12:57:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47292 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235969AbjIHQ51 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 8 Sep 2023 12:57:27 -0400
Received: from mail-vk1-xa31.google.com (mail-vk1-xa31.google.com [IPv6:2607:f8b0:4864:20::a31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B2ED119B6
        for <devicetree@vger.kernel.org>; Fri,  8 Sep 2023 09:57:19 -0700 (PDT)
Received: by mail-vk1-xa31.google.com with SMTP id 71dfb90a1353d-495c2b28211so266479e0c.3
        for <devicetree@vger.kernel.org>; Fri, 08 Sep 2023 09:57:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=raspberrypi.com; s=google; t=1694192239; x=1694797039; darn=vger.kernel.org;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc:subject:date:message-id:reply-to;
        bh=E7DnTng0888Vtq3Mjqb+20KJnmdYSuzOqxIGoas9zJo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1694192239; x=1694797039;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=E7DnTng0888Vtq3Mjqb+20KJnmdYSuzOqxIGoas9zJo=;
        b=
X-Gm-Message-State: AOJu0Yytwyf0V7g9KA+/s3JarUaD4XDc+/sXS0VNTX0rBugR6yYnGaCZ
        n9d8wfizOQRX01q0LIzD2xmooMsmDZCC1RMcxPKJww==
X-Google-Smtp-Source: AGHT+IFjVglXGNSrkIcJ6dsilZo+hJsuDkDSI5phr7QQSlpzmxY3U2iMNC83+S1++VkCrhaZyIEHiwabACQLsfqXqvc=
X-Received: by 2002:a1f:ec43:0:b0:48d:2779:a4f with SMTP id
 k64-20020a1fec43000000b0048d27790a4fmr3303043vkh.0.1694192238274; Fri, 08 Sep
...
In-Reply-To: <vp3bbkaibfzdxzgv5xedpneqtyxqxlvioou5whb567s5txtgve@a4xr3wtmjqzu>
From:   Dave Stevenson <dave.stevenson@raspberrypi.com>
Date:   Fri, 8 Sep 2023 17:57:01 +0100
Message-ID: <CAPY8ntCYz3D77R7G+JTKvOWW4uNTj-wKrsjJ7ASw_RoN4FU-ow@mail.gmail.com>
...
Cc:     Umang Jain <umang.jain@ideasonboard.com>,
        ...
        Shawn Tu <shawnx.tu@intel.com>, kieran.bingham@ideasonboard.com
...
It calls imx519_set_framing_limits, which calls
__v4l2_ctrl_s_ctrl(vblank). imx519_set_ctrl then calls
pm_runtime_get_if_in_use to see if the sensor is powered up.

pm_runtime_get_if_active then checks dev->power.runtime_status !=
RPM_ACTIVE [1], but RPM_ACTIVE = 0, so the default answer is that
we're powered up and hence try writing the relevant I2C registers.

Memory says it was Laurent's imx290 patches that first tripped over
that one when he'd tried moving the ctrl_handler_init.

  Dave

[1] https://elixir.bootlin.com/linux/latest/source/drivers/base/power/runtime.c#L1199
