...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 20C6539CC80
	for <lists+devicetree@lfdr.de>; Sun,  6 Jun 2021 05:32:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230145AbhFFDdv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 5 Jun 2021 23:33:51 -0400
Received: from mail-oi1-f172.google.com ([209.85.167.172]:46800 "EHLO
        mail-oi1-f172.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230075AbhFFDdv (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 5 Jun 2021 23:33:51 -0400
Received: by mail-oi1-f172.google.com with SMTP id c13so8789481oib.13
        for <devicetree@vger.kernel.org>; Sat, 05 Jun 2021 20:31:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:in-reply-to;
        bh=3PHnksa2OI+bd4BtqVaZ5P+wOFtqCrAlbh4o15zFl/I=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=3PHnksa2OI+bd4BtqVaZ5P+wOFtqCrAlbh4o15zFl/I=;
        b=
X-Gm-Message-State: AOAM530vLRQ+z/ZRGfJeoAoNUTjJnSGb5CFdaKD1rujctWrAzvgZMOFE
        ymac0T8dsZvc+6aiaKrf92h73Q==
X-Google-Smtp-Source: ABdhPJw2I5JmGZR/nINDL91js4T0dJpNP2Typ54HuMmANSN1Smo8ta7ttXh7anAHAoXcxGu0YRy5SA==
X-Received: by 2002:aca:380a:: with SMTP id f10mr15933205oia.157.1622950243020;
        Sat, 05 Jun 2021 20:30:43 -0700 (PDT)
Received: from builder.lan (104-57-184-186.lightspeed.austtx.sbcglobal.net. [104.57.184.186])
        by smtp.gmail.com with ESMTPSA id s6sm1479535otk.71.2021.06.05.20.30.41
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sat, 05 Jun 2021 20:30:42 -0700 (PDT)
Date:   Sat, 5 Jun 2021 22:30:40 -0500
...
Message-ID: <YLxBYICA/ievMTmu@builder.lan>
References: <20210605121040.282053-1-martin.botka@somainline.org>
 <20210605121040.282053-2-martin.botka@somainline.org>
MIME-Version: 1.0
...
> remove a stray "//"
> Changes in V4:
> Move qcom,gcc-sm6125.h to binding patch
>  drivers/clk/qcom/Kconfig      |    7 +
>  drivers/clk/qcom/Makefile     |    1 +
>  drivers/clk/qcom/gcc-sm6125.c | 4190 +++++++++++++++++++++++++++++++++
>  3 files changed, 4198 insertions(+)
>  create mode 100644 drivers/clk/qcom/gcc-sm6125.c
> 
> diff --git a/drivers/clk/qcom/Kconfig b/drivers/clk/qcom/Kconfig
> index 45646b867cdb..6e3e697b947d 100644
> --- a/drivers/clk/qcom/Kconfig
> +++ b/drivers/clk/qcom/Kconfig
> @@ -492,6 +492,13 @@ config SM_DISPCC_8250
...
> index c8291312e723..8d4484f84647 100644
...
> index 000000000000..9680a9abf476
> --- /dev/null
