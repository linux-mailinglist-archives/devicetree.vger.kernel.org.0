...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 34C1850D9FB
	for <lists+devicetree@lfdr.de>; Mon, 25 Apr 2022 09:21:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232769AbiDYHYo (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 25 Apr 2022 03:24:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33110 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229561AbiDYHYo (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 25 Apr 2022 03:24:44 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6DE2B644E;
        Mon, 25 Apr 2022 00:21:37 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id E0974612C6;
        Mon, 25 Apr 2022 07:21:36 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 2BA5DC385A7;
        Mon, 25 Apr 2022 07:21:33 +0000 (UTC)
Message-ID: <be3bc81f-ffe6-c083-d79d-62d491d9f817@xs4all.nl>
Date:   Mon, 25 Apr 2022 09:21:32 +0200
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:91.0) Gecko/20100101
 Thunderbird/91.7.0
Subject: Re: [PATCH v4 8/9] media: dw100: Add i.MX8MP dw100 dewarper driver
...
References: <20220328141309.177611-1-xavier.roumegue@oss.nxp.com>
 <20220328141309.177611-9-xavier.roumegue@oss.nxp.com>
From:   Hans Verkuil <hverkuil-cisco@xs4all.nl>
In-Reply-To: <20220328141309.177611-9-xavier.roumegue@oss.nxp.com>
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: 7bit
X-Spam-Status: No, score=-6.5 required=5.0 tests=BAYES_00,
...
(Perhaps check that this typo doesn't appear elsewhere in these patches?)
...
General note: I get a lot of messages when I run this patch through
'scripts/checkpatch.pl --strict'. Please fix the issues that make
sense.
...
It's preferred to have the '&&' on the previous line.
...
It's a bit silly to reserve 16 controls when there is only one.

Just change this to:

	struct v4l2_ctrl 	*dewarping_map_ctrl;
...
Hmm, if length == 16, then n == 2. That doesn't look right.

You can just use the round_up helper here (include/linux/math.h).
...
Weird TAB after static. Replace with space.
...
Don't reinvent these macros. See include/linux/minmax.h.
...
Hex values are recommended to be lower case a-f in kernel code. Please change
this throughout this patch series.
