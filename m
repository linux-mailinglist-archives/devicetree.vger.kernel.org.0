...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E53F85BAD23
	for <lists+devicetree@lfdr.de>; Fri, 16 Sep 2022 14:12:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231386AbiIPMMs (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 16 Sep 2022 08:12:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38440 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231407AbiIPMMj (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 16 Sep 2022 08:12:39 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [IPv6:2604:1380:4641:c500::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 71474B0B10;
        Fri, 16 Sep 2022 05:12:32 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 88ED962B41;
        Fri, 16 Sep 2022 12:12:31 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id CA3BCC433B5;
        Fri, 16 Sep 2022 12:12:27 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1663330351;
        bh=+DLTT9UAH1NVWmODamw9HpEGaclxsPw5IVouUKLk+PQ=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH 4/6] arm64: dts: qcom: Introduce the SC8180x platform
Date:   Fri, 16 Sep 2022 17:42:02 +0530
Message-Id: <20220916121204.3880182-5-vkoul@kernel.org>
...
+		};
+
+		xbl_mem: xbl-region@85d00000 {
+			reg = <0x0 0x85d00000 0x0 0x140000>;
+			no-map;
+		};
+
+		aop_mem: aop-region@85f00000 {
+			reg = <0x0 0x85f00000 0x0 0x20000>;
+			no-map;
+		};
+
+		aop_cmd_db: cmd-db-region@85f20000 {
+			compatible = "qcom,cmd-db";
+			reg = <0x0 0x85f20000 0x0 0x20000>;
+			no-map;
+		};
+
+		reserved-region@85f40000 {
+			reg = <0x0 0x85f40000 0x0 0x10000>;
+			no-map;
+		};
+
+		smem_mem: smem-region@86000000 {
...
+		};
+
+		modem_smp2p_ipa_out: ipa-out {
+			qcom,entry-name = "ipa";
+			#qcom,smem-state-cells = <1>;
+		};
+
+		modem_smp2p_ipa_in: ipa-in {
+			qcom,entry-name = "ipa";
+			interrupt-controller;
+			#interrupt-cells = <2>;
+		};
+
+		modem_smp2p_wlan_in: wlan {
...
+
+		pcie0: pci@1c00000 {
+			compatible = "qcom,pcie-sc8180x", "snps,dw-pcie";
...
+			compatible = "qcom,sc8180x-smmu-500", "qcom,adreno-smmu", "arm,mmu-500";
...
+				#clock-cells = <1>;
+				#phy-cells = <0>;
+				clock-output-names = "qmp_dptx1_phy_pll_link_clk", "qmp_dptx1_phy_pll_vco_div_clk";
+			};
+		};
+
