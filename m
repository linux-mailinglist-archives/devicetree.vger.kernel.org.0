...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 73EC53C5CC6
	for <lists+devicetree@lfdr.de>; Mon, 12 Jul 2021 15:02:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234325AbhGLNBL (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 12 Jul 2021 09:01:11 -0400
Received: from mx0a-00128a01.pphosted.com ([148.163.135.77]:58312 "EHLO
        mx0a-00128a01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S233807AbhGLNBK (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Mon, 12 Jul 2021 09:01:10 -0400
Received: from pps.filterd (m0167088.ppops.net [127.0.0.1])
        by mx0a-00128a01.pphosted.com (8.16.0.43/8.16.0.43) with SMTP id 16CCoOts014799;
        Mon, 12 Jul 2021 08:58:15 -0400
Received: from nwd2mta4.analog.com ([137.71.173.58])
        by mx0a-00128a01.pphosted.com with ESMTP id 39rj8dgs3d-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Mon, 12 Jul 2021 08:58:15 -0400
Received: from ASHBMBX8.ad.analog.com (ASHBMBX8.ad.analog.com [10.64.17.5])
        by nwd2mta4.analog.com (8.14.7/8.14.7) with ESMTP id 16CCwDl7024687
...
Received: from zeus.spd.analog.com (10.66.68.11) by ashbmbx9.ad.analog.com
 ...
 Transport; Mon, 12 Jul 2021 08:58:12 -0400
Received: from localhost.localdomain ([10.48.65.12])
        by zeus.spd.analog.com (8.15.1/8.15.1) with ESMTP id 16CCvx0E018858;
        Mon, 12 Jul 2021 08:58:10 -0400
...
Subject: [PATCH v2 5/7] net: phy: adin1100: Add ethtool master-slave support
Date:   Mon, 12 Jul 2021 16:06:29 +0300
Message-ID: <20210712130631.38153-6-alexandru.tachici@analog.com>
...
X-Proofpoint-GUID: w3T1DuXk6yiVsVUrndxrd8LsPHh0MKdm
X-Proofpoint-ORIG-GUID: w3T1DuXk6yiVsVUrndxrd8LsPHh0MKdm
...
index 94deaf52bbcd..ae216a80608b 100644
--- a/drivers/net/phy/adin1100.c
+++ b/drivers/net/phy/adin1100.c
@@ -37,7 +37,11 @@ static const int phy_10_features_array[] = {
...
@@ -164,6 +172,7 @@ static int adin_read_lpa(struct phy_device *phydev)
...
+	int cfg;
 	...
 	if (ret)
@@ -173,6 +182,8 @@ static int adin_read_status(struct phy_device *phydev)
...
@@ -187,7 +198,37 @@ static int adin_read_status(struct phy_device *phydev)
...
@@ -201,6 +242,41 @@ static int adin_config_aneg(struct phy_device *phydev)
