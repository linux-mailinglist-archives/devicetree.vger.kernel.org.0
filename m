...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CCCC4680E2F
	for <lists+devicetree@lfdr.de>; Mon, 30 Jan 2023 13:57:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236980AbjA3M5B (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 30 Jan 2023 07:57:01 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48252 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236284AbjA3M46 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 30 Jan 2023 07:56:58 -0500
Received: from mx0b-0031df01.pphosted.com (mx0b-0031df01.pphosted.com [205.220.180.131])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A1A6937F15;
        Mon, 30 Jan 2023 04:56:51 -0800 (PST)
Received: from pps.filterd (m0279872.ppops.net [127.0.0.1])
        by mx0a-0031df01.pphosted.com (8.17.1.19/8.17.1.19) with ESMTP id 30UBrIjr028466;
        Mon, 30 Jan 2023 12:56:21 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=quicinc.com; h=from : to : cc :
 subject : date : message-id : in-reply-to : references : mime-version :
 content-type; s=qcppdkim1;
 bh=OvAKPtytF9rnnK4mtRXPKV3F365O2KnjKRW+WKtklcg=;
 b= Zw== 
Received: from nalasppmta02.qualcomm.com (Global_NAT1.qualcomm.com [129.46.96.20])
        by mx0a-0031df01.pphosted.com (PPS) with ESMTPS id 3ncv3fbvha-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Mon, 30 Jan 2023 12:56:20 +0000
Received: from nalasex01a.na.qualcomm.com (nalasex01a.na.qualcomm.com [10.47.209.196])
        by NALASPPMTA02.qualcomm.com (8.17.1.5/8.17.1.5) with ESMTPS id 30UCuJYJ009639
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Mon, 30 Jan 2023 12:56:19 GMT
Received: from devipriy-linux.qualcomm.com (10.80.80.8) by
 nalasex01a.na.qualcomm.com (10.47.209.196) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.36; Mon, 30 Jan 2023 04:56:10 -0800
...
Subject: [PATCH V3 2/7] clk: qcom: Add Global Clock Controller driver for IPQ9574
Date:   Mon, 30 Jan 2023 18:25:23 +0530
Message-ID: <20230130125528.11509-3-quic_devipriy@quicinc.com>
...
X-Proofpoint-GUID: A3FB7jhwowZHxLPpAlSgvyDJP1HPhqUB
X-Proofpoint-ORIG-GUID: A3FB7jhwowZHxLPpAlSgvyDJP1HPhqUB
...
---
 Changes in V3:
        - Corrected the indentation for structure member 'parent_hws'
 
 Changes in V2:
        - Dropped unnecessary header files
        - Removed critical flags for clocks that are managed by
          the firmware and for certain debug clocks
        - Removed ignore_unused flags
        - Dropped all the dummy entries and the remove function

 drivers/clk/qcom/Kconfig       |    8 +
 drivers/clk/qcom/Makefile      |    1 +
 drivers/clk/qcom/gcc-ipq9574.c | 4302 ++++++++++++++++++++++++++++++++
 3 files changed, 4311 insertions(+)
...
index 000000000000..40db1f5f3045
--- /dev/null
