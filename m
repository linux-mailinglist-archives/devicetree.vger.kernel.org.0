...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id BE9931504A9
	for <lists+devicetree@lfdr.de>; Mon,  3 Feb 2020 11:55:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727797AbgBCKyv (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 3 Feb 2020 05:54:51 -0500
Received: from mail-pg1-f181.google.com ([209.85.215.181]:40257 "EHLO
        mail-pg1-f181.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727787AbgBCKyu (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 3 Feb 2020 05:54:50 -0500
Received: by mail-pg1-f181.google.com with SMTP id k25so7609649pgt.7
        for <devicetree@vger.kernel.org>; Mon, 03 Feb 2020 02:54:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=p/prQUXRGYQXuK16nS1VV9kX5OLQuB+rR6zoBYXXQ74=;
        b=m/+kXI9vbR+7cN61EiK6ltjIaOJJxLJP3Gx8Mw77XYywcqvEtkDTm9gPWBaR8JIWHJ
         AqyPcR3pEmxds/HEtli1X8PfdnzdlQlbMpFEClRSdIGfBpwikxqJlTc1o2Skg/gn2gnw
         UIPLG8+34XGOuiHC5D7MTZ1Hhps6NTQ0DrzC8=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references:mime-version:content-transfer-encoding;
        bh=p/prQUXRGYQXuK16nS1VV9kX5OLQuB+rR6zoBYXXQ74=;
        b=
X-Gm-Message-State: APjAAAXu0Co80tVMFg38beiFCBd+ogfQJZGNUmm+DdgXrnolN+tW9L5g
        EfhJNqYXfaoW7M1pllmpav+ASw==
X-Google-Smtp-Source: APXvYqxtKsUO2aqz3fIP/Wr5Bmf0QGuCwwbk4zKz99AzO0zpi+/ZQDjn36W4u4CkQXKkojmue2yx+w==
X-Received: by 2002:a63:2bd6:: with SMTP id r205mr18675913pgr.69.1580727288372;
        Mon, 03 Feb 2020 02:54:48 -0800 (PST)
Received: from hsinyi-z840.tpe.corp.google.com ([2401:fa00:1:10:b852:bd51:9305:4261])
        by smtp.gmail.com with ESMTPSA id 11sm20923835pfz.25.2020.02.03.02.54.46
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 03 Feb 2020 02:54:47 -0800 (PST)
...
Subject: [PATCH v5 3/3] arm64: dts: mediatek: add mt8173 elm and hana board
Date:   Mon,  3 Feb 2020 18:53:49 +0800
Message-Id: <20200203105345.118294-4-hsinyi@chromium.org>
...
---
Changes in v5:
- add gpio-line-names for gpio controller. gpio-line-names is required for
  crossystem to get the wpsw_cur status.
---
...
new file mode 100644
index 000000000000..1b359b5ff260
--- /dev/null
