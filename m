...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0BE0111A324
	for <lists+devicetree@lfdr.de>; Wed, 11 Dec 2019 04:46:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726642AbfLKDqP (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 10 Dec 2019 22:46:15 -0500
Received: from out1-smtp.messagingengine.com ([66.111.4.25]:41361 "EHLO
        out1-smtp.messagingengine.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726717AbfLKDqO (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Tue, 10 Dec 2019 22:46:14 -0500
Received: from compute4.internal (compute4.nyi.internal [10.202.2.44])
        by mailout.nyi.internal (Postfix) with ESMTP id C169B22430;
        Tue, 10 Dec 2019 22:46:12 -0500 (EST)
Received: from imap2 ([10.202.2.52])
  by compute4.internal (MEProxy); Tue, 10 Dec 2019 22:46:12 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=aj.id.au; h=
        mime-version:message-id:in-reply-to:references:date:from:to:cc
        :subject:content-type; s=fm1; bh=KPsNLXbqwsv7BMpLL6iTVbEnLgqrPz1
        CobutiAd/YoI=; b=lEdM24xod6qhqmUOFElKe32FjrDT3MPicMPDnBSlPseuqzx
        
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=
        messagingengine.com; h=cc:content-type:date:from:in-reply-to
        :message-id:mime-version:references:subject:to:x-me-proxy
        :x-me-proxy:x-me-sender:x-me-sender:x-sasl-enc; s=fm1; bh=KPsNLX
        bqwsv7BMpLL6iTVbEnLgqrPz1CobutiAd/YoI=; b=g+ypssHF3gsc29FTYJoeh8
        
        ==
X-ME-Sender: <xms:g2bwXaecdZB6n5KhLKTl2v1z91OEKg9db6F196zPjOqSbYFibMlw_Q>
X-ME-Proxy-Cause: gggruggvucftvghtrhhoucdtuddrgedufedrudelgedgheehucetufdoteggodetrfdotf
    ...
    rhfuihiivgeptd
X-ME-Proxy: <xmx:g2bwXfLb9feHIVwM0Z2nq6XUq5G8_BYsCTrilBwDPhzI8pK5Pzl0ig>
    <xmx:g2bwXaiIaiSoKBRDn4T-qf6A4KyjSNAD7pCBfOsJGOmPnl8SrlmRaw>
    <xmx:g2bwXdQj0eHRUtrii0sVIWa3t5kWf9I4weOM8x8l2Fc6QK3bqOdzIQ>
    <xmx:hGbwXQZhMeF-ic1w6hLkUPLmi87JzH2_AsPNny1_U_wUkBEid1sFeA>
Received: by mailuser.nyi.internal (Postfix, from userid 501)
        id 45E3DE00A2; Tue, 10 Dec 2019 22:46:11 -0500 (EST)
X-Mailer: MessagingEngine.com Webmail Interface
User-Agent: Cyrus-JMAP/3.1.7-679-g1f7ccac-fmstable-20191210v1
Mime-Version: 1.0
Message-Id: <de395d95-15f4-4df3-873d-ce89ae008ed3@www.fastmail.com>
In-Reply-To: <1575566112-11658-7-git-send-email-eajames@linux.ibm.com>
...
Date:   Wed, 11 Dec 2019 14:17:51 +1030
