...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8F03D6F6C92
	for <lists+devicetree@lfdr.de>; Thu,  4 May 2023 15:07:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230345AbjEDNHd (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 4 May 2023 09:07:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47426 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231133AbjEDNHa (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 4 May 2023 09:07:30 -0400
Received: from madras.collabora.co.uk (madras.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e5ab])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 376CC6EA1;
        Thu,  4 May 2023 06:07:26 -0700 (PDT)
Received: from nicolas-tpx395.localdomain (unknown [IPv6:2606:6d00:15:199e::580])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        (Authenticated sender: nicolas)
        by madras.collabora.co.uk (Postfix) with ESMTPSA id 904E266056D6;
        Thu,  4 May 2023 14:07:22 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1683205644;
        bh=EvEJNZhOepHq7DyGkOLiqGKBZeQCoCVFoN0vmNiuEO4=;
        h=Subject:From:To:Cc:Date:In-Reply-To:References:From;
        b=
Message-ID: <dfdbefb284c469b28692fb64cfef24bbf1109440.camel@collabora.com>
...
Date:   Thu, 04 May 2023 09:07:13 -0400
In-Reply-To: <2628ff2c9cd09b00fbc76610120c29aeec4f45f4.camel@mediatek.com>
References: <20230428082329.28606-1-yunfei.dong@mediatek.com>
         <66a762390a84ed06fbbf8bd62578d8713deae601.camel@collabora.com>
         <2628ff2c9cd09b00fbc76610120c29aeec4f45f4.camel@mediatek.com>
...
Le jeudi 04 mai 2023 =C3=A0 07:42 +0000, Yunfei Dong (=E8=91=A3=E4=BA=91=E9=
=A3=9E) a =C3=A9crit=C2=A0:
> Hi Nicolas,
>=20
> Thanks for your suggestion.
> On Fri, 2023-04-28 at 10:15 -0400, Nicolas Dufresne wrote:
...
> > Hi Yunfei,
> >=20
> > Le vendredi 28 avril 2023 =C3=A0 16:23 +0800, Yunfei Dong a =C3=A9crit =
:
...
> >=20
> > I have reproduced these results on Debian with a GStreamer main.
> > Though, you
> > forgot to mention your dependency. Would it be possible to make a v3
> > and simply
> > includes Benjamin's patch in your series, it will make this much
> > simpler for
> > everyone, and will fix the build issues of course. Don't forget to
> > apply my R-b
> > for that patch.
> >=20
...
> >=20
> https://urldefense.com/v3/__https://patchwork.linuxtv.org/project/linux-m=
edia/list/?series=3D10330__;!!CTRNKA9wMg0ARbw!kHcaxDBW0LK9u0d6zlYnW8FuQyhji=
puwJYJBZ_9Pk-PwFUpgzr_vlEXEIYOLbmcxZOsp119WUcnFqeGvBlzIZu0ScsaT0O80Sg$
> >=20
>=20
> Whether you mean that the patch message as below?
>=20
...
> - hevc fluster test result: 132/147 (not support: 10bit =3D> 11 and
> resolution =3D> 4).
> ---
> Depends on patch:
> [1]: media: uapi: HEVC: Add num_delta_pocs_of_ref_rps_idx field.

You won't need that line, as the patch will be part of a 2 patch single ser=
ie
now.
...
> > > ---
> > > Reference series:
> > > [1]: this patch is send by Benjamin Gaignard.
> > >      message-id:=20
> > > 20230418160717.743517-1-benjamin.gaignard@collabora.com
> > >=20
...
> > > index 3000db975e5f..995997f702a0 100644
> > > ---
> > > a/drivers/media/platform/mediatek/vcodec/mtk_vcodec_dec_stateless.c
> > > +++
> > > b/drivers/media/platform/mediatek/vcodec/mtk_vcodec_dec_stateless.c
> > > @@ -107,11 +107,63 @@ static const struct mtk_stateless_control
> > > mtk_stateless_controls[] =3D {
> > >               },
...
> > >=20
> > >       if (cap_format_count)
> > >               default_cap_format =3D
> > > mtk_video_formats[cap_format_count - 1];
> > > diff --git
> > > a/drivers/media/platform/mediatek/vcodec/mtk_vcodec_drv.h
> > > b/drivers/media/platform/mediatek/vcodec/mtk_vcodec_drv.h
> > > index 9acab54fd650..144252fa8bea 100644
> > > --- a/drivers/media/platform/mediatek/vcodec/mtk_vcodec_drv.h
> > > +++ b/drivers/media/platform/mediatek/vcodec/mtk_vcodec_drv.h
...
> > > index 000000000000..831942c2e565
> > > --- /dev/null
> > > +++
> > > b/drivers/media/platform/mediatek/vcodec/vdec/vdec_hevc_req_multi_i
> > > f.c
...
> > > +     int index;
> > > +
> > > +     vq =3D v4l2_m2m_get_vq(ctx->m2m_ctx,
> > > V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE);
> > > +     for (index =3D 0; index < V4L2_HEVC_DPB_ENTRIES_NUM_MAX;
> > > index++) {
...
> > > +
> > > +             hevc_dpb_info[index].y_dma_addr =3D
...
> > > );
> > > +     GET_HEVC_VDEC_PARAM(log2_diff_max_min_luma_transform_block_si
> > > ze);
...
> > > +     GET_HEVC_VDEC_PARAM(log2_min_pcm_luma_coding_block_size_minus
> > > 3);
> > > +     GET_HEVC_VDEC_PARAM(log2_diff_max_min_pcm_luma_coding_block_s
> > > ize);
...
> > > +
> > > +     for (i =3D 0; i < 20; i++)
> > > +             dst_param->column_width_minus1[i] =3D src_param-
> > > > column_width_minus1[i];
> > > +     for (i =3D 0; i < 22; i++)
> > > +             dst_param->row_height_minus1[i] =3D src_param-
> > > > row_height_minus1[i];
> > > +
...
> > > +                        V4L2_HEVC_PPS_FLAG_SIGN_DATA_HIDING_ENABLE
> > > D);
...
> > > +                        V4L2_HEVC_PPS_FLAG_PPS_SLICE_CHROMA_QP_OFF
> > > SETS_PRESENT);
...
> > > +             dst_entry->pic_order_cnt_val =3D src_entry-
> > > > pic_order_cnt_val;
> > > +
> > > +             dst_params->poc_st_curr_before[i] =3D src_params-
> > > > poc_st_curr_before[i];
> > > +             dst_params->poc_st_curr_after[i] =3D src_params-
> > > > poc_st_curr_after[i];
> > > +             dst_params->poc_lt_curr[i] =3D src_params-
> > > > poc_lt_curr[i];
> > > +     }
> > > +
> > > +     dst_params->pic_order_cnt_val =3D src_params-
> > > > pic_order_cnt_val;
> > > +     dst_params->short_term_ref_pic_set_size =3D src_params-
> > > > short_term_ref_pic_set_size;
> > > +     dst_params->long_term_ref_pic_set_size =3D src_params-
> > > > long_term_ref_pic_set_size;
> > > +     dst_params->num_active_dpb_entries =3D src_params-
> > > > num_active_dpb_entries;
> > > +     dst_params->num_poc_st_curr_before =3D src_params-
> > > > num_poc_st_curr_before
> > > +     dst_params->num_poc_st_curr_after =3D src_params-
> > > > num_poc_st_curr_after;
> > > +     dst_params->num_delta_pocs_of_ref_rps_idx =3D src_params-
...
> > > +{
> > > +     struct vdec_hevc_slice_lat_dec_param *slice_param =3D &inst-
...
> > > +
> > > +     sps =3D vdec_hevc_get_ctrl_ptr(inst->ctx,
> > > V4L2_CID_STATELESS_HEVC_SPS);
> > > +     if (IS_ERR(sps))
> > > +             return PTR_ERR(sps);
> > > +
> > > +     pps =3D vdec_hevc_get_ctrl_ptr(inst->ctx,
...
> > > sizeof(*dec_params));
> > > +
> > > +     slice_param->decode_params.num_poc_st_curr_before =3D
> > > dec_params->num_poc_st_curr_before;
> > > +     slice_param->decode_params.num_poc_st_curr_after =3D
> > > dec_params->num_poc_st_curr_after;
> > > +     slice_param->decode_params.num_poc_lt_curr =3D dec_params-
> > > > num_poc_lt_curr;
...
> > > vdec_hevc_slice_share_info *share_info)
> > > +{
> > > +     struct v4l2_ctrl_hevc_decode_params *dec_params =3D
...
> > > +{
> > > +     unsigned int buf_sz =3D vdec_hevc_get_mv_buf_size(pic->buf_w,
> > > pic->buf_h);
...
> > > bs_buffer);
> > > +     lat_buf->src_buf_req =3D src_buf_info-
...
> > > +                     err =3D vdec_hevc_slice_alloc_mv_buf(inst,
> > > &inst->ctx->picinfo);
...
> > > +
> > > +     mtk_vcodec_debug(inst, "slice addr/size(0x%llx 0x%llx) trans
> > > start/end((0x%llx 0x%llx))",
...
> > > +
> > > +     mtk_vcodec_debug(inst, "[hevc-core] y/c addr =3D 0x%llx
> > > 0x%llx", y_fb_dma,
> > > +                      c_fb_dma);
> > > +
...
> > > +
> > > +     inst->vsi_core->ube.dma_addr =3D lat_buf->ctx-
> > > > msg_queue.wdma_addr.dma_addr;
> > > +     inst->vsi_core->ube.size =3D lat_buf->ctx-
> > > > msg_queue.wdma_addr.size;
> > > +
> > > +     inst->vsi_core->err_map.dma_addr =3D lat_buf-
> > > > wdma_err_addr.dma_addr;
> > > +     inst->vsi_core->err_map.size =3D lat_buf->wdma_err_addr.size;
> > > +
> > > +     inst->vsi_core->slice_bc.dma_addr =3D lat_buf-
> > > > slice_bc_addr.dma_addr;
> > > +     inst->vsi_core->slice_bc.size =3D lat_buf->slice_bc_addr.size;
> > > +
> > > +     inst->vsi_core->trans.dma_addr =3D share_info->trans.dma_addr;
> > > +     inst->vsi_core->trans.dma_addr_end =3D share_info-
> > > > trans.dma_addr_end;
> > > +
...
> > > +     for (i =3D 0; i < HEVC_MAX_MV_NUM; i++) {
> > > +             mem =3D &inst->mv_buf[i];
> > > +             inst->vsi_core->mv_buf_dma[i].dma_addr =3D mem-
> > > > dma_addr;
...
> > > +     }
> > > +
> > > +     vsi_size =3D round_up(sizeof(struct vdec_hevc_slice_vsi),
> > > VCODEC_DEC_ALIGNED_64);
...
> > > +             goto error_free_inst;
> > > +
> > > +     mtk_vcodec_debug(inst, "lat struct size =3D %d,%d,%d,%d vsi:
> > > %d\n",
...
> > > +                      vsi_size);
> > > +     mtk_vcodec_debug(inst, "lat hevc instance >> %p, codec_type =3D
> > > 0x%x",
...
> > > +     struct vdec_hevc_slice_share_info *share_info =3D lat_buf-
> > > > private_data;
...
> > > +
> > > +     err =3D vdec_hevc_slice_setup_core_buffer(inst, share_info,
> > > lat_buf);
> > > +     if (err)
> > > +             goto vdec_dec_end;
> > > +
...
> > > +     timeout =3D mtk_vcodec_wait_for_done_ctx(inst->ctx,
...
> > > > dec.crc[1],
> > > +                      inst->vsi_core->dec.crc[2], inst->vsi_core-
> > > > dec.crc[3],
> > > +                      inst->vsi_core->dec.crc[4], inst->vsi_core-
> > > > dec.crc[5],
...
> > > +     }
> > > +
> > > +     lat_buf =3D vdec_msg_queue_dqbuf(&inst->ctx-
> > > > msg_queue.lat_ctx);
> > > +     if (!lat_buf) {
...
> > > +
> > > +     share_info =3D lat_buf->private_data;
> > > +     err =3D vdec_hevc_slice_fill_decode_parameters(inst,
> > > share_info);
> > > +     if (err)
> > > +             goto err_free_fb_out;
> > > +
> > > +     err =3D vdec_hevc_slice_setup_lat_buffer(inst, bs, lat_buf,
> > > res_chg);
> > > +     if (err)
> > > +             goto err_free_fb_out;
> > > +
...
> > > +     if (err =3D=3D SLICE_HEADER_FULL || err =3D=3D TRANS_BUFFER_FUL=
L) {
...
> > > +     }
> > > +
> > > +     share_info->trans.dma_addr_end =3D inst->ctx-
> > > > msg_queue.wdma_addr.dma_addr +
...
> > > +     struct vdec_hevc_slice_inst *inst =3D h_vdec;
> > > +
> > > +     if (!h_vdec || inst->ctx->dev->vdec_pdata->hw_arch =3D=3D
...
> > > +             break;
> > > +     default:
> > > +             mtk_vcodec_err(inst, "invalid get parameter type=3D%d",
> > > type);
> > > +             return -EINVAL;
> > > +     }
> > > +     return 0;
...
> > >               ctx->hw_id =3D IS_VDEC_LAT_ARCH(hw_arch) ?
