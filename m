...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1453AE240C
	for <lists+devicetree@lfdr.de>; Wed, 23 Oct 2019 22:10:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2391554AbfJWUKb (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 23 Oct 2019 16:10:31 -0400
Received: from mail-wr1-f65.google.com ([209.85.221.65]:34778 "EHLO
        mail-wr1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2389786AbfJWUK2 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 23 Oct 2019 16:10:28 -0400
Received: by mail-wr1-f65.google.com with SMTP id t16so18324355wrr.1;
        Wed, 23 Oct 2019 13:10:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=o3krcJHLr2CZdmX4GtXF8w23+MIvOtXBiDjJAHB1mnM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=o3krcJHLr2CZdmX4GtXF8w23+MIvOtXBiDjJAHB1mnM=;
        b=
X-Gm-Message-State: APjAAAVVNkQZ5QNJ/0lxVcL+NydO0MSD4ikmqVI6ONFJsNIvXULUWJOd
        7u5KCJjB2TeP63lhyGYh35U=
X-Google-Smtp-Source: APXvYqwLoR/EQr3OPyMkK6K4oysLDG3ohcy3VhKIR+9YBhuvts2qCwFnkOF0Y7US9oc8fn8Yx3iT7Q==
X-Received: by 2002:a5d:4341:: with SMTP id u1mr460211wrr.306.1571861421704;
        Wed, 23 Oct 2019 13:10:21 -0700 (PDT)
Received: from Red.localdomain (lfbn-1-7036-79.w90-116.abo.wanadoo.fr. [90.116.209.79])
        by smtp.googlemail.com with ESMTPSA id h17sm277261wmb.33.2019.10.23.13.10.19
...
Subject: [PATCH v2 1/4] crypto: Add Allwinner sun8i-ss cryptographic offloader
Date:   Wed, 23 Oct 2019 22:10:13 +0200
Message-Id: <20191023201016.26195-2-clabbe.montjoie@gmail.com>
...
new file mode 100644
index 000000000000..3e560eb4a457
--- /dev/null
...
+	}
+
+	ss->reset = devm_reset_control_get_optional(&pdev->dev, "bus");
+	if (IS_ERR(ss->reset)) {
