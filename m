...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A2320730DE4
	for <lists+devicetree@lfdr.de>; Thu, 15 Jun 2023 06:05:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242750AbjFOEFO (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 15 Jun 2023 00:05:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57742 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238152AbjFOEFJ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 15 Jun 2023 00:05:09 -0400
Received: from gate2.alliedtelesis.co.nz (gate2.alliedtelesis.co.nz [IPv6:2001:df5:b000:5::4])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 675DE212B
        for <devicetree@vger.kernel.org>; Wed, 14 Jun 2023 21:05:03 -0700 (PDT)
Received: from svr-chch-seg1.atlnz.lc (mmarshal3.atlnz.lc [10.32.18.43])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by gate2.alliedtelesis.co.nz (Postfix) with ESMTPS id 055682C0594;
        Thu, 15 Jun 2023 16:04:55 +1200 (NZST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=alliedtelesis.co.nz;
        s=mail181024; t=1686801895;
        bh=rLZ1zREIa+tXkZewaMWxEkrQPDep6XErf3mfjKbraZ4=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: from pat.atlnz.lc (Not Verified[10.32.16.33]) by svr-chch-seg1.atlnz.lc with Trustwave SEG (v8,2,6,11305)
        id <B648a8de60003>; Thu, 15 Jun 2023 16:04:54 +1200
Received: from chrisp-dl.ws.atlnz.lc (chrisp-dl.ws.atlnz.lc [10.33.22.30])
        by pat.atlnz.lc (Postfix) with ESMTP id 90D6B13ED5B;
        Thu, 15 Jun 2023 16:04:54 +1200 (NZST)
Received: by chrisp-dl.ws.atlnz.lc (Postfix, from userid 1030)
        id 8FC6A2815D4; Thu, 15 Jun 2023 16:04:54 +1200 (NZST)
...
Subject: [PATCH v9 3/3] dt-bindings: mtd: marvell-nand: Convert to YAML DT scheme
Date:   Thu, 15 Jun 2023 16:04:47 +1200
Message-Id: <20230615040447.3484564-4-chris.packham@alliedtelesis.co.nz>
