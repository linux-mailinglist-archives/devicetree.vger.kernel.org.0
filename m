...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 577F87240BF
	for <lists+devicetree@lfdr.de>; Tue,  6 Jun 2023 13:21:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233221AbjFFLV1 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 6 Jun 2023 07:21:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50562 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234770AbjFFLVY (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 6 Jun 2023 07:21:24 -0400
Received: from mx1.tq-group.com (mx1.tq-group.com [93.104.207.81])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0FEA09E
        for <devicetree@vger.kernel.org>; Tue,  6 Jun 2023 04:21:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=tq-group.com; i=@tq-group.com; q=dns/txt; s=key1;
  t=1686050480; x=1717586480;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=QjNxr7ht+Ny920Y1nK7ZJQQnzRbEvL8Lea7ji+CfHQo=;
  b=XgOZ+pmxlSRGKIq/TPeKyj70niYBVP3vs+Mq4UolISzToBf2VpMhZ6hV
   W8+8evRKBq1zYR3rOTCoie1UIaolq+od5kvSPRwr5ecngBqAHqcGDsxq/
   6j82dogZLaxJwikE0NWGQFEyrqFNf20bAnlp53SDfZPLc48GaBX/DmVJq
   GAacxzA9FUpg0TDcxkYvp/7/3pdL6u0gUqVywgh35xyRW3sl7vHm7HALb
   Z1gQfPTovFT27EAcDi1B0SGfWex2zhBAfEZzN7yplmOZH346TfYk4qF9+
   yQzQ3BuUvClD/moF0slut4FevNej6kdcqPXgHINkCrMTiJaGOrrLbhfAh
   A==;
X-IronPort-AV: E=Sophos;i="6.00,221,1681164000"; 
   d="scan'208";a="31301046"
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  ...
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=QjNxr7ht+Ny920Y1nK7ZJQQnzRbEvL8Lea7ji+CfHQo=;
  b=oZaMtRcOnzysAvEV047spdo192/9/c+Nl0YdQ/ihsNgdp0BwIMYq6dsu
   lrVSoOnQRvflJ3mSXvrt07W9b0TvxyZ2EtopPMPP7wHoqffrDlWW7hef0
   HD1IdkYpMzjdbEuaymNF5T6sq7kPq0OkLCEiLJdbNoSVXZr9Gha9HxGIM
   Zo0lJD9pMJzOM4iT8rvVGkDBFbY8VhNBQGTkgmFzDOR7mauKs1rNN9n7R
   0NEQ4vHRTp0FBCarPTmN8MVSqeKEIIvOHGCuQ0sfm6Szt1GdnmWuONQ9T
   KulVBPTdMwxFAI9ZwSVjtG0ZVK64Smzdc/QH3GdbP6nJgqEe0GWhOYRzf
   g==;
X-IronPort-AV: E=Sophos;i="6.00,221,1681164000"; 
   d="scan'208";a="31301045"
...
Received: from steina-w.tq-net.de (unknown [10.123.53.21])
        ...
        by vtuxmail01.tq-net.de (Postfix) with ESMTPSA id 28561280090;
...
Subject: [PATCH 2/3] arm64: dts: freescale: add initial device tree for TQMa8XQP with i.MX8QXP
Date:   Tue,  6 Jun 2023 13:21:07 +0200
Message-Id: <20230606112108.685885-3-alexander.stein@ew.tq-group.com>
...
This adds support for TQMa8XQP module on MBa8Xx board. The module and
mainboard can also be used using i.MX8DXP, hence the DT file split.
...
index a750be13ace89..862c4bfc989a0 100644
--- a/arch/arm64/boot/dts/freescale/Makefile
+++ b/arch/arm64/boot/dts/freescale/Makefile
@@ -139,6 +139,7 @@ dtb-$(CONFIG_ARCH_MXC) += imx8qxp-colibri-eval-v3.dtb
...
new file mode 100644
index 0000000000000..8c0843fc026df
--- /dev/null
...
+&lpspi2 {
+	pinctrl-names = "default";
+	pinctrl-0 = <&pinctrl_spi2 &pinctrl_spi2_cs>;
+	num-cs = <1>;
...
+&lpspi3 {
+	pinctrl-names = "default";
+	pinctrl-0 = <&pinctrl_spi3 &pinctrl_spi3_cs>;
+	num-cs = <2>;
+	// There is no GPIO muxable to pad used for 2nd chip select
...
+		fsl,pins = <IMX8QXP_SAI0_RXD_LSIO_GPIO0_IO27	0x00000021>,
...
+	};
+
+	pinctrl_spi3_cs: spi3csgrp {
+		fsl,pins = <IMX8QXP_SPI3_CS0_LSIO_GPIO0_IO16	0x00000021>,
...
new file mode 100644
index 0000000000000..15736db85bb6f
--- /dev/null
