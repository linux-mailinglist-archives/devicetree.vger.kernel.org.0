...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E21F7418974
	for <lists+devicetree@lfdr.de>; Sun, 26 Sep 2021 16:32:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231842AbhIZOdp (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 26 Sep 2021 10:33:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49456 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231743AbhIZOdo (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 26 Sep 2021 10:33:44 -0400
Received: from mail-lf1-x134.google.com (mail-lf1-x134.google.com [IPv6:2a00:1450:4864:20::134])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A2F13C061570;
        Sun, 26 Sep 2021 07:32:07 -0700 (PDT)
Received: by mail-lf1-x134.google.com with SMTP id i25so64890356lfg.6;
        Sun, 26 Sep 2021 07:32:07 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=ZateHcMKRw5vqXICpo3Ff3SedPwpZGpT3o51Meadjgs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=ZateHcMKRw5vqXICpo3Ff3SedPwpZGpT3o51Meadjgs=;
        b=
X-Gm-Message-State: AOAM532c6gYujmoK5XyttF98UL3bnJFDyM7tZ6ReVAmmjt7Zyr1vuijG
        KAEpyDChZKz9fVTKb07UCJrYZlNT8PWp1g2BUpw=
X-Google-Smtp-Source: ABdhPJwGCBhyj2do4oYAF2eVLSK/VZNOQX4T9UPwYTXBMfzF9X8T1t8KWGLTTTYBkSYb/w8Jmv6Rb1V1VsRh+Y/9Wn4=
X-Received: by 2002:a2e:8616:: with SMTP id a22mr22724128lji.365.1632666725650;
 Sun, 26 Sep 2021 07:32:05 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <20210917154047.leojvqjqjj2sg34l@gilmour>
From:   Kevin Tang <kevin3.tang@gmail.com>
Date:   Sun, 26 Sep 2021 22:31:53 +0800
Message-ID: <CAFPSGXZbqh0f6kEoQaq_Nt677ksVS6QPdAa5==KVVAszSAuasw@mail.gmail.com>
...
=A5=E5=91=A8=E4=BA=94 =E4=B8=8B=E5=8D=8811:40=E5=86=99=E9=81=93=EF=BC=9A
>
...
> > @@ -686,9 +687,25 @@ static void sprd_crtc_mode_set_nofb(struct drm_crt=
c *crtc)
> >  {
...
> > +             dsi_reg_up(ctx, CMD_MODE_CFG, GEN_SW_0P_TX | GEN_SW_1P_TX=
 |
> > +                     GEN_SW_2P_TX | GEN_SR_0P_TX | GEN_SR_1P_TX | GEN_=
SR_2P_TX |
> > +                     GEN_LW_TX | DCS_SW_0P_TX | DCS_SW_1P_TX | DCS_SR_=
0P_TX |
> > +                     DCS_LW_TX | MAX_RD_PKT_SIZE, GEN_SW_0P_TX | GEN_S=
W_1P_TX |
> > +                     GEN_SW_2P_TX | GEN_SR_0P_TX | GEN_SR_1P_TX | GEN_=
SR_2P_TX |
> > +                     GEN_LW_TX | DCS_SW_0P_TX | DCS_SW_1P_TX | DCS_SR_=
...
> > +}
> > +
> > +static struct drm_connector_helper_funcs sprd_dsi_connector_helper_fun=
cs =3D {
...
> > +};
> > +
> > +static int sprd_dsi_connector_init(struct drm_device *drm, struct sprd=
_dsi *dsi)
> > +{
...
> here, see:
> https://lore.kernel.org/dri-devel/20210910101218.1632297-3-maxime@cerno.t=
ech/
