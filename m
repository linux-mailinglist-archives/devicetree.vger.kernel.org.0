...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9C9E543F68A
	for <lists+devicetree@lfdr.de>; Fri, 29 Oct 2021 07:23:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231878AbhJ2F0I (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 29 Oct 2021 01:26:08 -0400
Received: from esa.microchip.iphmx.com ([68.232.154.123]:29230 "EHLO
        esa.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231855AbhJ2F0E (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 29 Oct 2021 01:26:04 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1635485016; x=1667021016;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=L+5FAPInmTzRUdWlHxtqaxwg3vkR+fbGaQIHvKVZQCQ=;
  b=Tw41DrveWbY4yS6sNR8lN/maf6D6f+4myCjgxPAH3HgLJ+VpZw0RHCMc
   VppMvas4vquvBzcqBCSMv6eDT69YYrJ4+ElYHT4MY89I8UhHcszBsaiqp
   E66dXlKje+fGv8u/KrKyW/hT5DO4duES+lyKJYmj7uBAcuEiOXEuPZIas
   7lNCTp6/lW7Qa0N+BZK/469VIHxx1NQr/1Swq8rNdSlyju3xg1OlRj8Tp
   AgU4Pj4gRYE5/1fLJjnoEsXep8DU3J5cZ2LBqp0O4R2iM5pkMIPBV1YFL
   mq2J8HSpLy4KV5DG6lc/E8/hOqi2dwbsxhlmSmS8QViAI1GfxrL9QvI9L
   w==;
IronPort-SDR: 
 JG3KQ8OeCAOg1cygPYFU6ltO
X-IronPort-AV: E=Sophos;i="5.87,191,1631602800"; 
   d="scan'208";a="137295233"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa2.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 28 Oct 2021 22:23:36 -0700
Received: from chn-vm-ex04.mchp-main.com (10.10.85.152) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.2176.14; Thu, 28 Oct 2021 22:23:35 -0700
Received: from CHE-LT-I21427LX.microchip.com (10.10.115.15) by
 chn-vm-ex04.mchp-main.com (10.10.85.152) with Microsoft SMTP Server id
 15.1.2176.14 via Frontend Transport; Thu, 28 Oct 2021 22:23:28 -0700
...
Subject: [PATCH v6 net-next 03/10] net: phy: Add support for LAN937x T1 phy driver
Date:   Fri, 29 Oct 2021 10:52:49 +0530
Message-ID: <20211029052256.144739-4-prasanna.vengateshan@microchip.com>
...
---
 ...
 1 file changed, 276 insertions(+), 69 deletions(-)

diff --git a/drivers/net/phy/microchip_t1.c b/drivers/net/phy/microchip_t1.c
index a4de3d2081c5..c933a9d3233d 100644
...
+#define DRIVER_DESC	"Microchip LAN87XX/LAN937X T1 PHY driver"
 ...
 struct access_ereg_val {
 	u8  mode;
@@ -59,12 +102,16 @@ struct access_ereg_val {
...
@@ -74,16 +121,43 @@ static int access_ereg(struct phy_device *phydev, u8 mode, u8 bank,
 	}
...
+
 	...
 	if (rc < 0)
 		return rc;
@@ -112,71 +186,166 @@ static int access_ereg_modify_changed(struct phy_device *phydev,
 	return rc;
 }
...
@@ -231,6 +400,9 @@ static int lan87xx_config_init(struct phy_device *phydev)
 {
...
@@ -462,32 +634,67 @@ static int lan87xx_cable_test_get_status(struct phy_device *phydev,
 	return 0;
 }
