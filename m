...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BBFC33728A6
	for <lists+devicetree@lfdr.de>; Tue,  4 May 2021 12:19:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230198AbhEDKUm (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 4 May 2021 06:20:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59236 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230220AbhEDKUl (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 4 May 2021 06:20:41 -0400
Received: from mail-wr1-x42c.google.com (mail-wr1-x42c.google.com [IPv6:2a00:1450:4864:20::42c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2304AC061574
        for <devicetree@vger.kernel.org>; Tue,  4 May 2021 03:19:46 -0700 (PDT)
Received: by mail-wr1-x42c.google.com with SMTP id n2so8800133wrm.0
        for <devicetree@vger.kernel.org>; Tue, 04 May 2021 03:19:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=j3SluUyIrndZKDI2j7DGLo4HW8QGh2W3smLT5Nr0vq4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=j3SluUyIrndZKDI2j7DGLo4HW8QGh2W3smLT5Nr0vq4=;
        b=
X-Gm-Message-State: AOAM532jI9cBxjzUyBOj+HEhCPztwusb5FubvZJi/tA+qZk1k5z8jN3D
        6aXBXdfXNiINB2tCw5M1ugcUDw==
X-Google-Smtp-Source: ABdhPJzl7oNWz9KJXHwR9229CnA8fbIimtu+cFt/YDoZh0Fl85l9esl2d0jIqnFFuz2oYD+qaCjCEA==
X-Received: by 2002:a05:6000:1290:: with SMTP id f16mr30708958wrx.52.1620123583806;
        Tue, 04 May 2021 03:19:43 -0700 (PDT)
Received: from arch-thunder.local (a109-49-46-234.cpe.netcabo.pt. [109.49.46.234])
        by smtp.gmail.com with ESMTPSA id d5sm16293789wrv.43.2021.05.04.03.19.42
...
Subject: [PATCH 1/7] usb: isp1760: move to regmap for register access
Date:   Tue,  4 May 2021 11:19:04 +0100
Message-Id: <20210504101910.18619-2-rui.silva@linaro.org>
...
@@ -65,18 +63,10 @@ static void isp1760_init_core(struct isp1760_device *isp)
...
+	return !!isp1760_hcd_read(hcd, field);
 ...
 /*
@@ -231,12 +278,15 @@ static void bank_reads8(void __iomem *src_base, u32 src_offset, u32 bank_addr,
 	}
 }
...
@@ -278,14 +328,15 @@ static void mem_writes8(void __iomem *dst_base, u32 dst_offset,
...
@@ -377,34 +428,15 @@ static void free_mem(struct usb_hcd *hcd, struct isp1760_qtd *qtd)
 	qtd->payload_addr = 0;
 }
...
@@ -730,12 +767,12 @@ static void start_bus_transfer(struct usb_hcd *hcd, u32 ptd_offset, int slot,
...
@@ -744,16 +781,20 @@ static void start_bus_transfer(struct usb_hcd *hcd, u32 ptd_offset, int slot,
...
@@ -783,9 +825,10 @@ static void collect_qtds(struct usb_hcd *hcd, struct isp1760_qh *qh,
...
@@ -873,8 +916,8 @@ static void enqueue_qtds(struct usb_hcd *hcd, struct isp1760_qh *qh)
 			if ((qtd->length) &&
...
@@ -1210,13 +1253,15 @@ static irqreturn_t isp1760_irq(struct usb_hcd *hcd)
...
@@ -1271,7 +1316,7 @@ static void errata2_function(struct timer_list *unused)
...
+			ptd_read(hcd, priv->base, ATL_PTD_OFFSET, slot, &ptd);
 			if (!FROM_DW0_VALID(ptd.dw0) &&
 				...
 				priv->atl_done_map |= 1 << slot;
@@ -1288,9 +1333,8 @@ static void errata2_function(struct timer_list *unused)
...
@@ -1584,15 +1625,19 @@ static void kill_transfer(struct usb_hcd *hcd, struct urb *urb,
...
@@ -1705,8 +1750,7 @@ static void isp1760_endpoint_disable(struct usb_hcd *hcd,
...
@@ -1716,17 +1760,13 @@ static int isp1760_hub_status_data(struct usb_hcd *hcd, char *buf)
...
+		goto done;
 	...
 	/*
@@ -1735,11 +1775,9 @@ static int isp1760_hub_status_data(struct usb_hcd *hcd, char *buf)
...
@@ -1752,9 +1790,11 @@ static int isp1760_hub_status_data(struct usb_hcd *hcd, char *buf)
...
@@ -1770,7 +1810,7 @@ static void isp1760_hub_descriptor(struct isp1760_hcd *priv,
...
@@ -1781,38 +1821,37 @@ static void isp1760_hub_descriptor(struct isp1760_hcd *priv,
...
@@ -1837,7 +1876,6 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
...
@@ -1848,22 +1886,22 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
...
@@ -1872,12 +1910,11 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
...
+			isp1760_hcd_set(hcd, PORT_CSC);
 		...
 		case USB_PORT_FEAT_C_OVER_CURRENT:
 			/* XXX error ?*/
@@ -1888,7 +1925,7 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
 		default:
 			goto error;
 		}
...
@@ -1903,15 +1940,14 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
 			goto error;
 		wIndex--;
 		status = 0;
-		temp = reg_read32(hcd->regs, HC_PORTSC1);
...
@@ -1930,35 +1966,31 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
 				priv->reset_done = 0;
...
+								750);
 			if (retval != 0) {
 				dev_err(hcd->self.controller, "port %d reset error %d\n",
 						wIndex + 1, retval);
@@ -1966,8 +1998,7 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
 			}
...
@@ -1975,21 +2006,22 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
...
@@ -2009,41 +2041,39 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
 		if (!wIndex || wIndex > ports)
 			goto error;
 		wIndex--;
-		temp = reg_read32(hcd->regs, HC_PORTSC1);
...
@@ -2052,12 +2082,11 @@ static int isp1760_hub_control(struct usb_hcd *hcd, u16 typeReq,
 				priv->reset_done = jiffies +
 					msecs_to_jiffies(50);
 			}
-			reg_write32(hcd->regs, HC_PORTSC1, temp);
...
+		isp1760_reg_read(priv->regs, ISP176x_HC_USBCMD);
 	...
 	default:
@@ -2074,14 +2103,13 @@ static int isp1760_get_frame(struct usb_hcd *hcd)
 	struct isp1760_hcd *priv = hcd_to_priv(hcd);
 	u32 fr;
...
+			 int irq, unsigned long irqflags,
 ...
 {
 	struct usb_hcd *hcd;
@@ -2200,7 +2223,6 @@ int isp1760_hcd_register(struct isp1760_hcd *priv, void __iomem *regs,
 	init_memory(priv);
