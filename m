...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A6ABF17127D
	for <lists+devicetree@lfdr.de>; Thu, 27 Feb 2020 09:25:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728688AbgB0IY4 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 27 Feb 2020 03:24:56 -0500
Received: from mx0a-00128a01.pphosted.com ([148.163.135.77]:7096 "EHLO
        mx0a-00128a01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728542AbgB0IY4 (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Thu, 27 Feb 2020 03:24:56 -0500
Received: from pps.filterd (m0167089.ppops.net [127.0.0.1])
        by mx0a-00128a01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 01R8NDhs009147;
        Thu, 27 Feb 2020 03:24:38 -0500
Received: from nwd2mta3.analog.com ([137.71.173.56])
        by mx0a-00128a01.pphosted.com with ESMTP id 2ydtrwje2f-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 27 Feb 2020 03:24:38 -0500
Received: from SCSQMBX10.ad.analog.com (scsqmbx10.ad.analog.com [10.77.17.5])
        by nwd2mta3.analog.com (8.14.7/8.14.7) with ESMTP id 01R8OaXQ034756
...
Received: from zeus.spd.analog.com (10.64.82.11) by SCSQMBX10.ad.analog.com
 ...
 Transport; Thu, 27 Feb 2020 00:24:34 -0800
Received: from saturn.ad.analog.com ([10.48.65.109])
        by zeus.spd.analog.com (8.15.1/8.15.1) with ESMTP id 01R8OPts013107;
...
Subject: [PATCH v3 5/8] iio: adc: adi-axi-adc: add support for AXI ADC IP core
Date:   Thu, 27 Feb 2020 10:27:16 +0200
Message-ID: <20200227082719.6343-6-alexandru.ardelean@analog.com>
...
index 000000000000..a9fb8efc166d
--- /dev/null
...
+		return ERR_PTR(-ENODEV);
+
+	cln = of_parse_phandle(dev->of_node, "adi-axi-adc-client", 0);
+	if (!cln) {
+		dev_err(dev, "No 'adi-axi-adc-client' node defined\n");
+		return ERR_PTR(-ENODEV);
+	}
+
+	mutex_lock(&registered_clients_lock);
