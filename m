...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2B2616128A9
	for <lists+devicetree@lfdr.de>; Sun, 30 Oct 2022 08:26:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229536AbiJ3H01 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 30 Oct 2022 03:26:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57206 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229476AbiJ3H0Z (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 30 Oct 2022 03:26:25 -0400
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CADAC282;
        Sun, 30 Oct 2022 00:26:20 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1667114780; x=1698650780;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=KgaG5xh9ZLhkPrjpNcTmct4mtDzfPsqImzo6TvKjGKA=;
  b=hGnXPN3CL0iE1DiGR0QlVBiXUzWB1bw9CcxCG0/p1E8x9SNLnBaeJPg5
   mVXpAXe1/0Kioqbtbj8l9fLmnxieaGkW/+aZ9oetY5QQpJjWPOUxBynwz
   ++eMDXia0Nm5RGxK2X0ekksMnGjkwLvh7W3v5xU9nAR5ht8ZbpJPLvYvJ
   xY2xnHBkpgEiWgJ0OjNLA46qXuNBL1fr+nMfjHRlfGqpuUyGo9g16rkh7
   xvYnIuECGwFoDZXBoo0/5ac9SecKo9dpB8vuwoya4wR7hSSqzJ8xQzPk8
   TKS4/Mlg7i5tZjYqP76CoY8PgiJLFGVoYPhFGOJJhH1qnZPmsdvqp8esG
   g==;
X-IronPort-AV: E=McAfee;i="6500,9779,10515"; a="292012648"
X-IronPort-AV: E=Sophos;i="5.95,225,1661842800"; 
   d="scan'208";a="292012648"
Received: from fmsmga001.fm.intel.com ([10.253.24.23])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 30 Oct 2022 00:26:19 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10515"; a="775804753"
X-IronPort-AV: E=Sophos;i="5.95,225,1661842800"; 
   d="scan'208";a="775804753"
Received: from lkp-server02.sh.intel.com (HELO b6d29c1a0365) ([10.239.97.151])
  by fmsmga001.fm.intel.com with ESMTP; 30 Oct 2022 00:26:14 -0700
Received: from kbuild by b6d29c1a0365 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1op2hy-000BnG-0S;
        Sun, 30 Oct 2022 07:26:14 +0000
Date:   Sun, 30 Oct 2022 15:25:44 +0800
...
Subject: Re: [RESEND PATCH v5 4/4] drivers: misc: Add Support for TMR Inject
 IP
Message-ID: <202210301513.rnkRcCIU-lkp@intel.com>
References: <20221028090106.1456940-5-appana.durga.kedareswara.rao@amd.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="GKOuxI/pwhU9cBQe"
Content-Disposition: inline
In-Reply-To: <20221028090106.1456940-5-appana.durga.kedareswara.rao@amd.com>
...
[also build test WARNING on robh/for-next soc/for-next linus/master v6.1-rc2 next-20221028]
[cannot apply to xilinx-xlnx/master]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Appana-Durga-Kedareswara-rao/drivers-misc-Add-support-for-TMR-Manager-and-Inject-IPs/20221028-170329
patch link:    https://lore.kernel.org/r/20221028090106.1456940-5-appana.durga.kedareswara.rao%40amd.com
patch subject: [RESEND PATCH v5 4/4] drivers: misc: Add Support for TMR Inject IP
config: microblaze-allmodconfig
compiler: microblaze-linux-gcc (GCC) 12.1.0
reproduce (this is a W=1 build):
        wget https://raw.githubusercontent.com/intel/lkp-tests/master/sbin/make.cross -O ~/bin/make.cross
        chmod +x ~/bin/make.cross
        # https://github.com/intel-lab-lkp/linux/commit/7dd0b83d500b83048e87c2c13d875c656a70386f
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Appana-Durga-Kedareswara-rao/drivers-misc-Add-support-for-TMR-Manager-and-Inject-IPs/20221028-170329
        git checkout 7dd0b83d500b83048e87c2c13d875c656a70386f
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=microblaze SHELL=/bin/bash drivers/misc/
...
>> drivers/misc/xilinx_tmr_inject.c:70:6: warning: no previous prototype for 'xtmr_init_debugfs' [-Wmissing-prototypes]
      70 | void xtmr_init_debugfs(struct xtmr_inject_dev *xtmr_inject)
         |      ^~~~~~~~~~~~~~~~~


vim +/xtmr_init_debugfs +70 drivers/misc/xilinx_tmr_inject.c
