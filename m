...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6734744FC08
	for <lists+devicetree@lfdr.de>; Sun, 14 Nov 2021 23:03:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236324AbhKNWFy (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 14 Nov 2021 17:05:54 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33172 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236227AbhKNWFW (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 14 Nov 2021 17:05:22 -0500
Received: from mail-lj1-x22c.google.com (mail-lj1-x22c.google.com [IPv6:2a00:1450:4864:20::22c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 15165C06120E;
        Sun, 14 Nov 2021 14:02:05 -0800 (PST)
Received: by mail-lj1-x22c.google.com with SMTP id z8so31182247ljz.9;
        Sun, 14 Nov 2021 14:02:05 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=1wwZEaEz/sSmYpUyIKldNYYc5PGjKAOeWUTY3aVSp9s=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1wwZEaEz/sSmYpUyIKldNYYc5PGjKAOeWUTY3aVSp9s=;
        b=
X-Gm-Message-State: AOAM530YGTatbwKZtbBTS9JDMhkpxgxCuoQ7UMKXPY8AFZtXgpuK+NNi
        pPONy5A0hMTm165dH6klT2A=
X-Google-Smtp-Source: ABdhPJz0Fbj9Kz8PxIiosgAs4Mq+UJXwWQ9PthsJh0GOgWlxOcGanTh8fymL8vfI2F4QfUXbMF+bsg==
X-Received: by 2002:a2e:97cb:: with SMTP id m11mr33794061ljj.324.1636927323538;
        Sun, 14 Nov 2021 14:02:03 -0800 (PST)
Received: from localhost.localdomain (46-138-46-211.dynamic.spd-mgts.ru. [46.138.46.211])
        by smtp.gmail.com with ESMTPSA id t5sm1353842lfd.80.2021.11.14.14.02.02
...
Subject: [PATCH v1 09/14] ARM: tegra: Add device-tree for Pegatron Chagall tablet
Date:   Mon, 15 Nov 2021 01:01:14 +0300
Message-Id: <20211114220119.18909-10-digetx@gmail.com>
...
---
 ...
 2 files changed, 2808 insertions(+), 1 deletion(-)
 create mode 100644 arch/arm/boot/dts/tegra30-pegatron-chagall.dts

diff --git a/arch/arm/boot/dts/Makefile b/arch/arm/boot/dts/Makefile
index 47cd157496f9..bc8e21956649 100644
...
index 000000000000..168cb929e6ca
--- /dev/null
...
+
+/ {
+	model = "Pegatron Chagall based tablet";
