 =?us-ascii?Q?nnFa9bvqKFuJwKzXSxLOsoNmyvu7FRIh16HalAmo3o204sCcaH+Ps27L31P9?=
 =?us-ascii?Q?5KwU1kj82eu5bZmwoo4V4HEjmnfLeZOm7SvgeGQOI7rlvzbekwx6TZ91V2Ns?=
 =?us-ascii?Q?/EzX/4TnMj8/KEi+ssvFVAdey2pIph0zrdSdvxJTeQBkj46RwFzYTomu/b9m?=
 =?us-ascii?Q?QsZqc29wxeAVf8u6fE/R+GpDZ6zV3Ma8sWpsEMgackACkXCGKCcFkDgSzLIx?=
 =?us-ascii?Q?RAFXmP3S/iTQ02kQ5EGrmddPbYRazXty3uTFcKGT9aP+lXWuMHG4SZIysmaV?=
 =?us-ascii?Q?kJLE?=
X-OriginatorOrg: nxp.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 3c2dbf1f-641b-41a3-8ba5-08d8bdddbdaf
X-MS-Exchange-CrossTenant-AuthSource: VI1PR04MB3983.eurprd04.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 21 Jan 2021 07:25:35.6206
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 686ea1d3-bc2b-4c6f-a92c-d99c5c301635
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: GHxttSPt5b4ob15/ekIB4UZ7829nw4Lief6lRgrCf6wsyU0TBl/ogZp2sufY2DUZFxKon6G5g1QDKsGfpXHyqQ==
...
+}
+
+static void dpu_disengcfg_framecomplete0_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_DISENGCFG_FRAMECOMPLETE0);
+}
+
+static void dpu_disengcfg_framecomplete1_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_DISENGCFG_FRAMECOMPLETE1);
+}
+
+static void dpu_disengcfg_seqcomplete0_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_DISENGCFG_SEQCOMPLETE0);
+}
+
+static void dpu_disengcfg_seqcomplete1_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_DISENGCFG_SEQCOMPLETE1);
+}
+
+static void dpu_disengcfg_shdload0_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_DISENGCFG_SHDLOAD0);
+}
+
+static void dpu_disengcfg_shdload1_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_DISENGCFG_SHDLOAD1);
+}
+
+static void dpu_extdst0_shdload_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_EXTDST0_SHDLOAD);
+}
+
+static void dpu_extdst1_shdload_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_EXTDST1_SHDLOAD);
+}
+
+static void dpu_extdst4_shdload_irq_handler(struct irq_desc *desc)
+{
+	dpu_irq_handle(desc, DPU_IRQ_EXTDST4_SHDLOAD);
+}
+
+static void dpu_extdst5_shdload_irq_handler(struct irq_desc *desc)
+{
...
+		if (!dpu_irq_handler_maps[i].handler)
+			continue;
+
+		irq_set_chained_handler_and_data(dpu->irq[i],
+						 dpu_irq_handler_maps[i].handler,
+						 dpu);
+	}
+
+	return ret;
...
+	}
+
+	ret = dpu_plane_check_no_off_screen(state, crtc_state);
+	if (ret)
+		return ret;
+
+	ret = dpu_plane_check_max_source_resolution(state);
+	if (ret)
+		return ret;
+
+	ret = dpu_plane_check_source_alignment(state);
+	if (ret)
+		return ret;
+
+	ret = dpu_plane_check_fb_modifier(state);
+	if (ret)
+		return ret;
+
+	ret = dpu_plane_check_tiled_fb_alignment(state);
+	if (ret)
+		return ret;
+
+	ret = dpu_plane_check_no_bt709_full_range(state);
+	if (ret)
+		return ret;
+
+	ret = dpu_plane_check_fb_plane_1(state);
+	if (ret)
+		return ret;
+
+	if (fb->format->num_planes > 1) {
+		ret = dpu_plane_check_fb_plane_2(state);
+		if (ret)
+			return ret;
+	}
+
+	return dpu_plane_check_dprc(state);
+}
+
