...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D027F13664E
	for <lists+devicetree@lfdr.de>; Fri, 10 Jan 2020 05:47:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731334AbgAJErQ (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 9 Jan 2020 23:47:16 -0500
Received: from mail-io1-f68.google.com ([209.85.166.68]:34151 "EHLO
        mail-io1-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731311AbgAJErQ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 9 Jan 2020 23:47:16 -0500
Received: by mail-io1-f68.google.com with SMTP id z193so688940iof.1
        for <devicetree@vger.kernel.org>; Thu, 09 Jan 2020 20:47:15 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=juipWghhZWbOej2tFm4x/URTAk9uOvEv4SqCsturnT8=;
        b=f9/ppNGdbyyElGeebjLUQZkig5iEqnTw/UkTCsz69ugvMp/JhUOSULxTbTFWGW5ql2
         ZFCTZBr8q4sVAecV5VVWHMt7JkShsqnx+2wChPjJUYdLp5vdKerUvH1gu0Oh0cWBvQpT
         Yb3xLWPcuc9Yf7SRLYBuSBHWvaG3upSwColWY=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:references:in-reply-to:from:date
         :message-id:subject:to:cc;
        bh=juipWghhZWbOej2tFm4x/URTAk9uOvEv4SqCsturnT8=;
        b=
X-Gm-Message-State: APjAAAVNkJUJWc5i6+mkD2QPZ1xpl8liZWyVke2FwNv4f/FC2JQZubUc
        n1PaVKXcb5GNVqoUBrKbvthXgpOfGQVrYA6eoHgrNg==
X-Google-Smtp-Source: APXvYqz783Lx/zFNA6TOPFW5FUeaef0dBt2I9PMnsJzXSZfQ7xt1Za6edH9aOVY+3Ci26CzR2puTPqKhs7LEZm8kIkY=
X-Received: by 2002:a5e:8703:: with SMTP id y3mr832669ioj.308.1578631634645;
 Thu, 09 Jan 2020 20:47:14 -0800 (PST)
MIME-Version: 1.0
References: <20200109101042.201500-1-hsinyi@chromium.org> <20200109101042.201500-3-hsinyi@chromium.org>
 <5a2ebfb5-f0bd-bb42-0463-d2db74f7048d@collabora.com>
In-Reply-To: <5a2ebfb5-f0bd-bb42-0463-d2db74f7048d@collabora.com>
From:   Hsin-Yi Wang <hsinyi@chromium.org>
Date:   Fri, 10 Jan 2020 12:46:48 +0800
Message-ID: <CAJMQK-gPL++YeBz+3BSrUTJvsi_zyFAjOB4jpfZ-=SrAroFSdA@mail.gmail.com>
...
On Thu, Jan 9, 2020 at 11:11 PM Enric Balletbo i Serra
...
>
Thanks for the comments. I will fix up in next version.
...
>
Partners wants to increase touchpad and touchscreen source (they
choose synaptics) for hana 300e, and synaptics uses hid-over-i2c
driver.
...
>
If we remove brightness-levels, minimum brightness that can be set
from UI would make the screen too dark to see anything.
>
...
>
This is for hana 300e only, I'll move it to mt8173-elm-hana.dts
> > +};
> > +
> > +&mipi_tx0 {
> > +     status = "okay";
...
>
It's originally for anx7688. I'll remove it here.
> > +             };
> > +     };
> > +};
> > +
