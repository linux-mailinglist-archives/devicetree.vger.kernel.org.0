...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 929D74EE4DF
	for <lists+devicetree@lfdr.de>; Fri,  1 Apr 2022 01:44:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243149AbiCaXqS (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 31 Mar 2022 19:46:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55754 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S243148AbiCaXqQ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 31 Mar 2022 19:46:16 -0400
Received: from mail-oi1-f181.google.com (mail-oi1-f181.google.com [209.85.167.181])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 55E20644C8;
        Thu, 31 Mar 2022 16:44:27 -0700 (PDT)
Received: by mail-oi1-f181.google.com with SMTP id t21so1145187oie.11;
        Thu, 31 Mar 2022 16:44:27 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         :mime-version:content-disposition:in-reply-to;
        bh=IgEdeowLrsPxqjAkbODwlhPMI4J1CaYF1vjQc+w1mMM=;
        b=
X-Gm-Message-State: AOAM531ZGuqcVa4IfLLqYV1EfM4y6Xvcj3TEYT9hFevw5iKwgA9dLPQG
        DyNj+cXJ2Y5cL1kfvJPhm9lwwg6DCw==
X-Google-Smtp-Source: ABdhPJypQgQamc6XHsV4OmlpyAL4pmmIxXf++ZvlclvGeKmqI/x3RtMuWlicpPdWo6v3Yfej38fvTA==
X-Received: by 2002:a05:6808:113:b0:2ec:b7db:df66 with SMTP id b19-20020a056808011300b002ecb7dbdf66mr3813697oie.108.1648770266472;
        Thu, 31 Mar 2022 16:44:26 -0700 (PDT)
Received: from robh.at.kernel.org (66-90-144-107.dyn.grandenetworks.net. [66.90.144.107])
        by smtp.gmail.com with ESMTPSA id r6-20020a0568301ac600b005cdbc6e62a9sm469129otc.39.2022.03.31.16.44.25
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 31 Mar 2022 16:44:26 -0700 (PDT)
Received: (nullmailer pid 1718214 invoked by uid 1000);
        Thu, 31 Mar 2022 23:44:25 -0000
Date:   Thu, 31 Mar 2022 18:44:25 -0500
From:   Rob Herring <robh@kernel.org>
To:     Kris Bahnsen <kris@embeddedts.com>
Cc:     linux-kernel@vger.kernel.org, devicetree@vger.kernel.org,
        Mark Featherston <mark@embeddedts.com>
Subject: Re: [PATCH] ARM: dts: Add TS-7553-V2 support
Message-ID: <YkY82fUTiHvev25o@robh.at.kernel.org>
References: <20220323003105.21572-1-kris@embeddedTS.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20220323003105.21572-1-kris@embeddedTS.com>
...
On Tue, Mar 22, 2022 at 05:31:05PM -0700, Kris Bahnsen wrote:
...
This is not a bus. Move the child nodes to the top level.
...
That's the default for a new node, not needed.
...
Should have 'hog' in the name. More specifically run 'make dtbs_check' 
on this which should have a warning for the the exact regex required. 
And don't add any other warnings (from this file, the SoC dtsi will have 
a bunch already).
