...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B0AA2285CB4
	for <lists+devicetree@lfdr.de>; Wed,  7 Oct 2020 12:18:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727518AbgJGKSn (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 7 Oct 2020 06:18:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49356 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727297AbgJGKSm (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 7 Oct 2020 06:18:42 -0400
Received: from metis.ext.pengutronix.de (metis.ext.pengutronix.de [IPv6:2001:67c:670:201:290:27ff:fe1d:cc33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BC41EC061755
        for <devicetree@vger.kernel.org>; Wed,  7 Oct 2020 03:18:41 -0700 (PDT)
Received: from pty.hi.pengutronix.de ([2001:67c:670:100:1d::c5])
        by metis.ext.pengutronix.de with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.92)
        (envelope-from <ukl@pengutronix.de>)
        id 1kQ6Wq-0005iM-D3; Wed, 07 Oct 2020 12:18:36 +0200
Received: from ukl by pty.hi.pengutronix.de with local (Exim 4.89)
        (envelope-from <ukl@pengutronix.de>)
        id 1kQ6Wp-0004Bd-OB; Wed, 07 Oct 2020 12:18:35 +0200
Date:   Wed, 7 Oct 2020 12:18:35 +0200
...
Subject: dt-binding to define default watchdog and machine reset (Was: Re:
 [RFC] Using a watchdog as system reset)
Message-ID: <20201007101835.yhlbjfpklepfodgw@pengutronix.de>
...
Content-Type: multipart/signed; micalg=pgp-sha512;
        protocol="application/pgp-signature"; boundary="o3sv6ctzhngohkd7"
...
> On 10/7/20 9:12 AM, Uwe Kleine-K=F6nig wrote:
...
> multiple watchdogs (default value in driver overridable in DT and at runt=
ime).
...

=E3Yy
-----END PGP SIGNATURE-----
