...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 4465929CEA
	for <lists+devicetree@lfdr.de>; Fri, 24 May 2019 19:25:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731937AbfEXRYV (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 24 May 2019 13:24:21 -0400
Received: from mail-lj1-f195.google.com ([209.85.208.195]:43872 "EHLO
        mail-lj1-f195.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726530AbfEXRYU (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 24 May 2019 13:24:20 -0400
Received: by mail-lj1-f195.google.com with SMTP id z5so9320027lji.10;
        Fri, 24 May 2019 10:24:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=66tsSpexaZXFFGSP1aq7PFx4+TyaWNqIBMJd/+1mPGA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=66tsSpexaZXFFGSP1aq7PFx4+TyaWNqIBMJd/+1mPGA=;
        b=
X-Gm-Message-State: APjAAAUouzyx5TJ80w6ndMXuEJvOOQt3KYqWH8N+cK71V+aYfkPjm6GY
        R53HmTipAjh44AP/IjxQQIE=
X-Google-Smtp-Source: APXvYqybdjZ7ggrzuASWOWnDGPJTIdM2qzSgl9aHs49P75JjHqqRnDtUhO09IR8LJP9as6/OvkXd3g==
X-Received: by 2002:a2e:9bc5:: with SMTP id w5mr15346657ljj.87.1558718656821;
        Fri, 24 May 2019 10:24:16 -0700 (PDT)
Received: from localhost.localdomain ([94.29.35.141])
        by smtp.gmail.com with ESMTPSA id d13sm196957lfm.27.2019.05.24.10.24.15
...
Subject: [PATCH v3 1/8] clk: tegra20/30: Add custom EMC clock implementation
Date:   Fri, 24 May 2019 20:23:46 +0300
Message-Id: <20190524172353.29087-2-digetx@gmail.com>
...
index c71b61162a32..1c5b8923f2be 100644
...
@@ -1126,6 +1094,8 @@ static struct clk *tegra20_clk_src_onecell_get(struct of_phandle_args *clkspec,
 	if (IS_ERR(clk))
 		return clk;
...
@@ -1135,13 +1105,16 @@ static struct clk *tegra20_clk_src_onecell_get(struct of_phandle_args *clkspec,
 	 */
...
index fa8d573ac626..2b69ad4aa259 100644
...
+				    NULL);
 	...
 	/* cml0 */
@@ -1313,6 +1309,26 @@ static struct tegra_audio_clk_info tegra30_audio_plls[] = {
...
@@ -1356,7 +1372,7 @@ static void __init tegra30_clock_init(struct device_node *np)
...
index 09bccbb9640c..8c94d71f48f7 100644
...
index afb9edfa5d58..ec65046504f7 100644
--- a/include/linux/clk/tegra.h
+++ b/include/linux/clk/tegra.h
@@ -130,4 +130,18 @@ extern void tegra210_put_utmipll_in_iddq(void);
