...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E988C53CDE8
	for <lists+devicetree@lfdr.de>; Fri,  3 Jun 2022 19:13:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344286AbiFCRNj (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Jun 2022 13:13:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58826 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239784AbiFCRNf (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 3 Jun 2022 13:13:35 -0400
Received: from alexa-out.qualcomm.com (alexa-out.qualcomm.com [129.46.98.28])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 76B8137A2E;
        Fri,  3 Jun 2022 10:13:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
  d=quicinc.com; i=@quicinc.com; q=dns/txt; s=qcdkim;
  t=1654276413; x=1685812413;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=ClOlMlpLwnj6/oPaqEzuv8Xn5ClgfTQOyfGlLRapeac=;
  b=HQONiYDGv+2pcT9dLs66Z++NJZVIsLDeo9TSHyGOUJsuOrmjTQCUpObF
   gv8eQqU9Jbl5puCsNmA61Zbb/MknJCOYXIRbNVQfKjAAbaNDP6gNSTAlQ
   fqefybdaTnta4y2w1yEwBc2EFBBKSChsdlucgFuZfEtmLwzbLA6H4UlQ6
   U=;
Received: from ironmsg07-lv.qualcomm.com ([10.47.202.151])
  by alexa-out.qualcomm.com with ESMTP; 03 Jun 2022 10:13:33 -0700
X-QCInternal: smtphost
Received: from nasanex01c.na.qualcomm.com ([10.47.97.222])
  by ironmsg07-lv.qualcomm.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Jun 2022 10:13:32 -0700
Received: from nalasex01a.na.qualcomm.com (10.47.209.196) by
 nasanex01c.na.qualcomm.com (10.47.97.222) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.22; Fri, 3 Jun 2022 10:13:12 -0700
Received: from hu-harshq-hyd.qualcomm.com (10.80.80.8) by
 nalasex01a.na.qualcomm.com (10.47.209.196) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.986.22; Fri, 3 Jun 2022 10:13:07 -0700
...
Subject: [PATCH v2 3/3] usb: dwc3: Refactor PHY logic to support Multiport Controller
Date:   Fri, 3 Jun 2022 22:42:42 +0530
Message-ID: <1654276362-28930-4-git-send-email-quic_harshq@quicinc.com>
...
---
 ...
 4 files changed, 305 insertions(+), 130 deletions(-)

diff --git a/drivers/usb/dwc3/core.c b/drivers/usb/dwc3/core.c
index 5734219..be43719 100644
...
+	}
 ...
 err0a:
 	dwc3_ulpi_exit(dwc);
@@ -1251,53 +1289,169 @@ static int dwc3_core_init(struct dwc3 *dwc)
 	return ret;
 }
...
@@ -1305,16 +1459,16 @@ static int dwc3_core_get_phy(struct dwc3 *dwc)
...
+		phy_set_mode(dwc->usb3_generic_phy[0], PHY_MODE_USB_DEVICE);
 		...
 		ret = dwc3_gadget_init(dwc);
 		if (ret)
@@ -1323,10 +1477,15 @@ static int dwc3_core_init_mode(struct dwc3 *dwc)
...
+			phy_set_mode(dwc->usb3_generic_phy[i], PHY_MODE_USB_HOST);
 		...
 		if (ret)
@@ -1674,7 +1833,7 @@ static int dwc3_probe(struct platform_device *pdev)
...
@@ -1839,15 +1998,18 @@ static int dwc3_probe(struct platform_device *pdev)
...
@@ -1929,6 +2091,7 @@ static int dwc3_core_init_for_resume(struct dwc3 *dwc)
...
@@ -1951,17 +2114,21 @@ static int dwc3_suspend_common(struct dwc3 *dwc, pm_message_t msg)
...
@@ -1989,7 +2156,7 @@ static int dwc3_suspend_common(struct dwc3 *dwc, pm_message_t msg)
...
@@ -2012,17 +2179,21 @@ static int dwc3_resume_common(struct dwc3 *dwc, pm_message_t msg)
 			break;
 		}
