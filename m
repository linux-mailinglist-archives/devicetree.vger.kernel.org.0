...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C088B14D101
	for <lists+devicetree@lfdr.de>; Wed, 29 Jan 2020 20:08:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727146AbgA2TIf (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 29 Jan 2020 14:08:35 -0500
Received: from asavdk3.altibox.net ([109.247.116.14]:38062 "EHLO
        asavdk3.altibox.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726332AbgA2TIf (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 29 Jan 2020 14:08:35 -0500
Received: from ravnborg.org (unknown [158.248.194.18])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by asavdk3.altibox.net (Postfix) with ESMTPS id 7B2662007C;
        Wed, 29 Jan 2020 20:08:30 +0100 (CET)
Date:   Wed, 29 Jan 2020 20:08:29 +0100
...
Subject: Re: [PATCH 2/2] drm/panel: Add a driver for Samsung
 s6e88a0-ams452ef01 panel
Message-ID: <20200129190829.GE25273@ravnborg.org>
References: <20200126183911.17090-1-michael.srba@seznam.cz>
 <20200126183911.17090-2-michael.srba@seznam.cz>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20200126183911.17090-2-michael.srba@seznam.cz>
User-Agent: Mutt/1.10.1 (2018-07-13)
X-CMAE-Score: 0
X-CMAE-Analysis: v=2.3 cv=eMA9ckh1 c=1 sm=1 tr=0
        a=UWs3HLbX/2nnQ3s7vZ42gw==:117 a=UWs3HLbX/2nnQ3s7vZ42gw==:17
        a=jpOVt7BSZ2e4Z31A5e1TngXxSK0=:19 a=kj9zAlcOel0A:10 a=e5mUnYsNAAAA:8
        a=HVXABAyAZpLQjwrh20IA:9 a=CjuIK1q_8ugA:10 a=Vxmtnl_E_bksehYqCbjh:22
...
On Sun, Jan 26, 2020 at 07:39:11PM +0100, michael.srba@seznam.cz wrote:
...
> complex and hard to make look nice, mainly courtesy of magic look up tables. If
> it is to be added, it should be with a separate patch.
> 
> Signed-off-by: Michael Srba <Michael.Srba@seznam.cz>
> ---
>  drivers/gpu/drm/panel/Kconfig                 |   6 +
>  drivers/gpu/drm/panel/Makefile                |   1 +
>  .../panel/panel-samsung-s6e88a0-ams452ef01.c  | 299 ++++++++++++++++++
...
> index 000000000000..10eb1ffc1bba
> --- /dev/null
...
Separate each block with a whitespace, and sort the lines alphabetically in ecah block.
...
> +	return 0;
> +}
No need to add empty functions - drop it.
...
> +{
This will fail to build with drm-misc-next.
This functions now takes connector as argument.

> +	struct drm_display_mode *mode;
> +
> +	mode = drm_mode_duplicate(panel->drm, &s6e88a0_ams452ef01_mode);
panel->drm is gone. Use connector->dev
