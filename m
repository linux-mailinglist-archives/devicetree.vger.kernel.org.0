...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E65B75F804D
	for <lists+devicetree@lfdr.de>; Fri,  7 Oct 2022 23:53:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229675AbiJGVxS (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 7 Oct 2022 17:53:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35626 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229540AbiJGVxP (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 7 Oct 2022 17:53:15 -0400
Received: from mga12.intel.com (mga12.intel.com [192.55.52.136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 673BCA486A;
        Fri,  7 Oct 2022 14:53:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1665179591; x=1696715591;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=Q4YCiAGHLRII2dokbr+YqAR/oDe5PsEoaahLcf7C9d4=;
  b=mWjYYhUZiKJ4kSOMO7fvZxZvNzImKq/iBdeEtgW8c8gu90JEFDPyJ/3v
   kkvd3PYpEIRG6rHZ3GHoAhuQXSCfKfa57nPVmuSprbPBVimUxFlAhwOeG
   QSD2nuLkTTPR4vamDxsSrOvv2jmmC/zaVTi2ODEmx66lu/CaG73iWGkHw
   NwZAfmPLvzKke61XJn29PftA+EJC9ySyjgqiBh5F5m9EiXr4OHdXmV/LY
   BRhqzHVDmCFIDAvjOnbB2icv5M4wp4uOBuK+qauWamwqHuc0FaJlNBBcJ
   EmR5UFBKM6HAaf5uXzf6ClI76N1GTmv2Zr5ct+Ek/AKzgvOVer7RqWtXT
   A==;
X-IronPort-AV: E=McAfee;i="6500,9779,10493"; a="283567101"
X-IronPort-AV: E=Sophos;i="5.95,167,1661842800"; 
   d="scan'208";a="283567101"
Received: from orsmga004.jf.intel.com ([10.7.209.38])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 07 Oct 2022 14:53:10 -0700
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10493"; a="750695561"
X-IronPort-AV: E=Sophos;i="5.95,167,1661842800"; 
   d="scan'208";a="750695561"
Received: from lkp-server01.sh.intel.com (HELO 3c15167049b7) ([10.239.97.150])
  by orsmga004.jf.intel.com with ESMTP; 07 Oct 2022 14:53:05 -0700
Received: from kbuild by 3c15167049b7 with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1ogvHE-0001YZ-27;
        Fri, 07 Oct 2022 21:53:04 +0000
Date:   Sat, 8 Oct 2022 05:52:57 +0800
...
Subject: Re: [PATCH v2 3/3] input/touchscreen: Add Hynitron cstxxx touchscreen
Message-ID: <202210080524.5BhI2EqM-lkp@intel.com>
References: <20221007184710.6395-4-macroalpha82@gmail.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="ilsTldJmhgE1fV65"
Content-Disposition: inline
In-Reply-To: <20221007184710.6395-4-macroalpha82@gmail.com>
...
[also build test WARNING on hid/for-next robh/for-next linus/master v6.0 next-20221007]
[If your patch is applied to the wrong git tree, kindly drop us a note.
And when submitting patch, we suggest to use '--base' as documented in
https://git-scm.com/docs/git-format-patch#_base_tree_information]

url:    https://github.com/intel-lab-lkp/linux/commits/Chris-Morgan/Add-Hynitron-cstxxx-Touchscreen/20221008-024919
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/dcbd6c389894fbad535263c97fb38d58dcb14437
        git remote add linux-review https://github.com/intel-lab-lkp/linux
        git fetch --no-tags linux-review Chris-Morgan/Add-Hynitron-cstxxx-Touchscreen/20221008-024919
        git checkout dcbd6c389894fbad535263c97fb38d58dcb14437
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-12.1.0 make.cross W=1 O=build_dir ARCH=sh SHELL=/bin/bash drivers/input/touchscreen/
...
>> drivers/input/touchscreen/hynitron_cstxxx.c:72:6: warning: no previous prototype for 'hyn_reset_proc' [-Wmissing-prototypes]
      72 | void hyn_reset_proc(struct i2c_client *client, int delay)
         |      ^~~~~~~~~~~~~~
>> drivers/input/touchscreen/hynitron_cstxxx.c:98:5: warning: no previous prototype for 'cst3xx_i2c_write' [-Wmissing-prototypes]
      98 | int cst3xx_i2c_write(struct i2c_client *client,
         |     ^~~~~~~~~~~~~~~~
>> drivers/input/touchscreen/hynitron_cstxxx.c:117:5: warning: no previous prototype for 'cst3xx_i2c_read_register' [-Wmissing-prototypes]
     117 | int cst3xx_i2c_read_register(struct i2c_client *client, u16 reg,
         |     ^~~~~~~~~~~~~~~~~~~~~~~~
>> drivers/input/touchscreen/hynitron_cstxxx.c:149:5: warning: no previous prototype for 'cst3xx_firmware_info' [-Wmissing-prototypes]
     149 | int cst3xx_firmware_info(struct i2c_client *client)
         |     ^~~~~~~~~~~~~~~~~~~~
>> drivers/input/touchscreen/hynitron_cstxxx.c:208:5: warning: no previous prototype for 'cst3xx_bootloader_enter' [-Wmissing-prototypes]
     208 | int cst3xx_bootloader_enter(struct i2c_client *client)
         |     ^~~~~~~~~~~~~~~~~~~~~~~
>> drivers/input/touchscreen/hynitron_cstxxx.c:257:5: warning: no previous prototype for 'cst3xx_finish_touch_read' [-Wmissing-prototypes]
     257 | int cst3xx_finish_touch_read(struct i2c_client *client)
         |     ^~~~~~~~~~~~~~~~~~~~~~~~
>> drivers/input/touchscreen/hynitron_cstxxx.c:367:5: warning: no previous prototype for 'cst3xx_input_dev_int' [-Wmissing-prototypes]
     367 | int cst3xx_input_dev_int(struct i2c_client *client)
         |     ^~~~~~~~~~~~~~~~~~~~


vim +/hyn_reset_proc +72 drivers/input/touchscreen/hynitron_cstxxx.c
  ...
  > 72	void hyn_reset_proc(struct i2c_client *client, int delay)
    ...
    87	
    88		ts_data->pdata->report_touch(client);
    89	
 ...
 > 117	int cst3xx_i2c_read_register(struct i2c_client *client, u16 reg,
   ...
   135		int ret;
   136	
   137		ret = i2c_transfer(client->adapter, msgs, 2);
   138		if (ret >= 0)
   139			ret = (ret == ARRAY_SIZE(msgs) ? 0 : -EIO);
   140	
   141		if (ret)
   142			dev_err(&client->dev,
   143				"Error reading %d bytes from 0x%04x: %d\n",
   144				len, reg, ret);
   145	
   146		return ret;
   147	}
 ...
 > 149	int cst3xx_firmware_info(struct i2c_client *client)
   ...
   160		ret = cst3xx_i2c_write(client, buf, 2);
   161		if (ret < 0)
   162			return -EIO;
   163	
   164		mdelay(10);
   ...
   168		 * correctly.
   169		 */
   170		ret = cst3xx_i2c_read_register(client, CST3XX_FIRMWARE_CHK_CODE_REG,
   171					       buf, 4);
   172		if (ret < 0)
   173			return -EIO;
   174	
   175		tmp = get_unaligned_le32(buf);
   176		if ((tmp & 0xffff0000) != ts_data->pdata->ic_chkcode) {
   177			dev_err(&client->dev, "%s ic mismatch\n", __func__);
   178			return -ENODEV;
   179		}
   180	
   181		mdelay(10);
   ...
   184		ret = cst3xx_i2c_read_register(client, CST3XX_FIRMWARE_VERSION_REG,
   185					       buf, 4);
   186		if (ret < 0)
   187			return -EIO;
   188	
   ...
   199		ret = cst3xx_i2c_write(client, buf, 2);
   200		if (ret < 0)
   201			return -EIO;
   202	
   203		mdelay(5);
 ...
 > 208	int cst3xx_bootloader_enter(struct i2c_client *client)
   ...
   219			ret = cst3xx_i2c_write(client, buf, 3);
   220			if (ret < 0)
   221				continue;
   222			mdelay(2);
   223	
   224			/* check whether in program mode */
   225			ret = cst3xx_i2c_read_register(client,
   226						       CST3XX_BOOTLDR_PROG_CHK_REG,
   227						       buf, 1);
   228			tmp = get_unaligned(buf);
   229	
   230			if (ret < 0)
   231				continue;
   232	
   ...
   246	}
   247	
   248	static void cst3xx_touch_update(struct hynitron_ts_data *ts_data, s32 id,
   249					s32 x, s32 y, s32 w)
   250	{
 ...
 > 257	int cst3xx_finish_touch_read(struct i2c_client *client)
   ...
   264		if (err < 0) {
   265			dev_err(&client->dev, "send read touch info ending failed.\n");
   266			return err;
   267		}
   268	
   269		return 0;
