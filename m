...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BD40D76559E
	for <lists+devicetree@lfdr.de>; Thu, 27 Jul 2023 16:10:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232877AbjG0OKw (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 27 Jul 2023 10:10:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48532 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232774AbjG0OKv (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 27 Jul 2023 10:10:51 -0400
Received: from mail-qt1-x831.google.com (mail-qt1-x831.google.com [IPv6:2607:f8b0:4864:20::831])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 34E4830D4
        for <devicetree@vger.kernel.org>; Thu, 27 Jul 2023 07:10:45 -0700 (PDT)
Received: by mail-qt1-x831.google.com with SMTP id d75a77b69052e-403a840dc64so6628401cf.1
        for <devicetree@vger.kernel.org>; Thu, 27 Jul 2023 07:10:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ndufresne-ca.20221208.gappssmtp.com; s=20221208; t=1690467044; x=1691071844;
        h=mime-version:user-agent:content-transfer-encoding:references
         :in-reply-to:date:cc:to:from:subject:message-id:from:to:cc:subject
         :date:message-id:reply-to;
        bh=vlFX29u3awFoxJrZhf+KkaVeUkBSphonS6eonCZz/IQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1690467044; x=1691071844;
        h=mime-version:user-agent:content-transfer-encoding:references
         :in-reply-to:date:cc:to:from:subject:message-id:x-gm-message-state
         :from:to:cc:subject:date:message-id:reply-to;
        bh=vlFX29u3awFoxJrZhf+KkaVeUkBSphonS6eonCZz/IQ=;
        b=
X-Gm-Message-State: ABy/qLaKyAEADlpWMGoFwJPR0msiNu5O/CXRulL/UnJYHN9U//exvkSZ
        pf5Wp6uvn2qsomLTmgmReIWn/Q==
X-Google-Smtp-Source: APBJJlHbiLihGWa+z22KVHElXnyBFdd0zwW4Qu5J5VO9lGbXDzOxGqMoc/YHrBnfAwQEyiqrGS/Xog==
X-Received: by 2002:a05:622a:20c:b0:402:d15e:2982 with SMTP id b12-20020a05622a020c00b00402d15e2982mr96979qtx.25.1690467043191;
        Thu, 27 Jul 2023 07:10:43 -0700 (PDT)
Received: from nicolas-tpx395.localdomain ([2606:6d00:10:580::7a9])
        by smtp.gmail.com with ESMTPSA id x1-20020ac87001000000b00402ed9adfa1sm443612qtm.87.2023.07.27.07.10.42
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 27 Jul 2023 07:10:42 -0700 (PDT)
Message-ID: <b83249c002c6986f471913cf96fa631c46ec69be.camel@ndufresne.ca>
...
Date:   Thu, 27 Jul 2023 10:10:41 -0400
...
Le jeudi 27 juillet 2023 =C3=A0 16:55 +0530, Devarsh Thakkar a =C3=A9crit=
=C2=A0:
...
>  create mode 100644 drivers/media/platform/imagination/e5010-jpeg-enc-hw.=
c
>  create mode 100644 drivers/media/platform/imagination/e5010-jpeg-enc-hw.=
h
...
> +obj-y +=3D imagination/
>  obj-y +=3D intel/
>  obj-y +=3D marvell/
>  obj-y +=3D mediatek/
> diff --git a/drivers/media/platform/imagination/Kconfig b/drivers/media/p=
latform/imagination/Kconfig
...
> +	  semiplanar video formats, with resolution ranging from 64x64 to 8K x =
8K
> +	  pixels. The module will be named as e5010_jpeg_enc.
                             is
 =20
> diff --git a/drivers/media/platform/imagination/Makefile b/drivers/media/=
platform/imagination/Makefile
> new file mode 100644
...
> @@ -0,0 +1,3 @@
> +# SPDX-License-Identifier: GPL-2.0
> +e5010_jpeg_enc-objs :=3D e5010-jpeg-enc-hw.o e5010-jpeg-enc.o
> +obj-$(CONFIG_VIDEO_E5010_JPEG_ENC) +=3D e5010_jpeg_enc.o
> diff --git a/drivers/media/platform/imagination/e5010-core-regs.h b/drive=
rs/media/platform/imagination/e5010-core-regs.h
> new file mode 100644
...
nit: Could be modernized to "#pragma once" (though only used in selftest so=
 far)
...
> +#define JASPER_INTERRUPT_MASK_CR_OUTPUT_ADDRESS_ERROR_ENABLE_MASK	(0x000=
00002)
...
> +#define JASPER_INTERRUPT_STATUS_CR_OUTPUT_ADDRESS_ERROR_IRQ_MASK	(0x0000=
0002)
...
> +#define JASPER_LUMA_QUANTIZATION_TABLE0_CR_LUMA_QUANTIZATION_TABLE_03_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE0_CR_LUMA_QUANTIZATION_TABLE_03_SH=
IFT	(24)
> +#define JASPER_LUMA_QUANTIZATION_TABLE0_CR_LUMA_QUANTIZATION_TABLE_02_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE0_CR_LUMA_QUANTIZATION_TABLE_02_SH=
IFT	(16)
> +#define JASPER_LUMA_QUANTIZATION_TABLE0_CR_LUMA_QUANTIZATION_TABLE_01_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE0_CR_LUMA_QUANTIZATION_TABLE_01_SH=
IFT	(8)
> +#define JASPER_LUMA_QUANTIZATION_TABLE0_CR_LUMA_QUANTIZATION_TABLE_00_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE0_CR_LUMA_QUANTIZATION_TABLE_00_SH=
IFT	(0)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_OFFSET					(0x0054)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_CR_LUMA_QUANTIZATION_TABLE_07_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_CR_LUMA_QUANTIZATION_TABLE_07_SH=
IFT	(24)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_CR_LUMA_QUANTIZATION_TABLE_06_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_CR_LUMA_QUANTIZATION_TABLE_06_SH=
IFT	(16)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_CR_LUMA_QUANTIZATION_TABLE_05_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_CR_LUMA_QUANTIZATION_TABLE_05_SH=
IFT	(8)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_CR_LUMA_QUANTIZATION_TABLE_04_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE1_CR_LUMA_QUANTIZATION_TABLE_04_SH=
IFT	(0)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_OFFSET					(0x0058)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_CR_LUMA_QUANTIZATION_TABLE_13_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_CR_LUMA_QUANTIZATION_TABLE_13_SH=
IFT	(24)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_CR_LUMA_QUANTIZATION_TABLE_12_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_CR_LUMA_QUANTIZATION_TABLE_12_SH=
IFT	(16)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_CR_LUMA_QUANTIZATION_TABLE_11_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_CR_LUMA_QUANTIZATION_TABLE_11_SH=
IFT	(8)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_CR_LUMA_QUANTIZATION_TABLE_10_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE2_CR_LUMA_QUANTIZATION_TABLE_10_SH=
IFT	(0)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_OFFSET					(0x005C)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_CR_LUMA_QUANTIZATION_TABLE_17_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_CR_LUMA_QUANTIZATION_TABLE_17_SH=
IFT	(24)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_CR_LUMA_QUANTIZATION_TABLE_16_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_CR_LUMA_QUANTIZATION_TABLE_16_SH=
IFT	(16)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_CR_LUMA_QUANTIZATION_TABLE_15_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_CR_LUMA_QUANTIZATION_TABLE_15_SH=
IFT	(8)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_CR_LUMA_QUANTIZATION_TABLE_14_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE3_CR_LUMA_QUANTIZATION_TABLE_14_SH=
IFT	(0)
> +#define JASPER_LUMA_QUANTIZATION_TABLE4_OFFSET					(0x0060)
> +#define JASPER_LUMA_QUANTIZATION_TABLE4_CR_LUMA_QUANTIZATION_TABLE_21_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE4_CR_LUMA_QUANTIZATION_TABLE_21_SH=
IFT	(8)
> +#define JASPER_LUMA_QUANTIZATION_TABLE4_CR_LUMA_QUANTIZATION_TABLE_20_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE4_CR_LUMA_QUANTIZATION_TABLE_20_SH=
IFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_OFFSET					(0x0064)
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_CR_LUMA_QUANTIZATION_TABLE_27_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_CR_LUMA_QUANTIZATION_TABLE_27_SH=
IFT	(24)
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_CR_LUMA_QUANTIZATION_TABLE_26_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_CR_LUMA_QUANTIZATION_TABLE_26_SH=
IFT	(16)
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_CR_LUMA_QUANTIZATION_TABLE_25_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_CR_LUMA_QUANTIZATION_TABLE_25_SH=
IFT	(8)
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_CR_LUMA_QUANTIZATION_TABLE_24_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE5_CR_LUMA_QUANTIZATION_TABLE_24_SH=
IFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_OFFSET					(0x0068)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_CR_LUMA_QUANTIZATION_TABLE_33_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_CR_LUMA_QUANTIZATION_TABLE_33_SH=
IFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_CR_LUMA_QUANTIZATION_TABLE_32_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_CR_LUMA_QUANTIZATION_TABLE_32_SH=
IFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_CR_LUMA_QUANTIZATION_TABLE_31_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_CR_LUMA_QUANTIZATION_TABLE_31_SH=
IFT	(8)
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_CR_LUMA_QUANTIZATION_TABLE_30_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE6_CR_LUMA_QUANTIZATION_TABLE_30_SH=
IFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_OFFSET					(0x006C)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_CR_LUMA_QUANTIZATION_TABLE_37_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_CR_LUMA_QUANTIZATION_TABLE_37_SH=
IFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_CR_LUMA_QUANTIZATION_TABLE_36_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_CR_LUMA_QUANTIZATION_TABLE_36_SH=
IFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_CR_LUMA_QUANTIZATION_TABLE_35_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_CR_LUMA_QUANTIZATION_TABLE_35_SH=
IFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_CR_LUMA_QUANTIZATION_TABLE_34_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE7_CR_LUMA_QUANTIZATION_TABLE_34_SH=
IFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_OFFSET					(0x0070)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_CR_LUMA_QUANTIZATION_TABLE_43_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_CR_LUMA_QUANTIZATION_TABLE_43_SH=
IFT	(24)
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_CR_LUMA_QUANTIZATION_TABLE_42_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_CR_LUMA_QUANTIZATION_TABLE_42_SH=
IFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_CR_LUMA_QUANTIZATION_TABLE_41_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_CR_LUMA_QUANTIZATION_TABLE_41_SH=
IFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_CR_LUMA_QUANTIZATION_TABLE_40_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE8_CR_LUMA_QUANTIZATION_TABLE_40_SH=
IFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_OFFSET					(0x0074)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_CR_LUMA_QUANTIZATION_TABLE_47_MA=
SK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_CR_LUMA_QUANTIZATION_TABLE_47_SH=
IFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_CR_LUMA_QUANTIZATION_TABLE_46_MA=
SK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_CR_LUMA_QUANTIZATION_TABLE_46_SH=
IFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_CR_LUMA_QUANTIZATION_TABLE_45_MA=
SK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_CR_LUMA_QUANTIZATION_TABLE_45_SH=
IFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_CR_LUMA_QUANTIZATION_TABLE_44_MA=
SK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE9_CR_LUMA_QUANTIZATION_TABLE_44_SH=
IFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_OFFSET					(0x0078)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_CR_LUMA_QUANTIZATION_TABLE_53_M=
ASK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_CR_LUMA_QUANTIZATION_TABLE_53_S=
HIFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_CR_LUMA_QUANTIZATION_TABLE_52_M=
ASK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_CR_LUMA_QUANTIZATION_TABLE_52_S=
HIFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_CR_LUMA_QUANTIZATION_TABLE_51_M=
ASK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_CR_LUMA_QUANTIZATION_TABLE_51_S=
HIFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_CR_LUMA_QUANTIZATION_TABLE_50_M=
ASK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE10_CR_LUMA_QUANTIZATION_TABLE_50_S=
HIFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_OFFSET					(0x007C)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_CR_LUMA_QUANTIZATION_TABLE_57_M=
ASK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_CR_LUMA_QUANTIZATION_TABLE_57_S=
HIFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_CR_LUMA_QUANTIZATION_TABLE_56_M=
ASK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_CR_LUMA_QUANTIZATION_TABLE_56_S=
HIFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_CR_LUMA_QUANTIZATION_TABLE_55_M=
ASK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_CR_LUMA_QUANTIZATION_TABLE_55_S=
HIFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_CR_LUMA_QUANTIZATION_TABLE_54_M=
ASK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE11_CR_LUMA_QUANTIZATION_TABLE_54_S=
HIFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_OFFSET					(0x0080)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_CR_LUMA_QUANTIZATION_TABLE_63_M=
ASK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_CR_LUMA_QUANTIZATION_TABLE_63_S=
HIFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_CR_LUMA_QUANTIZATION_TABLE_62_M=
ASK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_CR_LUMA_QUANTIZATION_TABLE_62_S=
HIFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_CR_LUMA_QUANTIZATION_TABLE_61_M=
ASK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_CR_LUMA_QUANTIZATION_TABLE_61_S=
HIFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_CR_LUMA_QUANTIZATION_TABLE_60_M=
ASK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE12_CR_LUMA_QUANTIZATION_TABLE_60_S=
HIFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_OFFSET					(0x0084)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_CR_LUMA_QUANTIZATION_TABLE_67_M=
ASK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_CR_LUMA_QUANTIZATION_TABLE_67_S=
HIFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_CR_LUMA_QUANTIZATION_TABLE_66_M=
ASK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_CR_LUMA_QUANTIZATION_TABLE_66_S=
HIFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_CR_LUMA_QUANTIZATION_TABLE_65_M=
ASK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_CR_LUMA_QUANTIZATION_TABLE_65_S=
HIFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_CR_LUMA_QUANTIZATION_TABLE_64_M=
ASK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE13_CR_LUMA_QUANTIZATION_TABLE_64_S=
HIFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_OFFSET					(0x0088)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_CR_LUMA_QUANTIZATION_TABLE_73_M=
ASK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_CR_LUMA_QUANTIZATION_TABLE_73_S=
HIFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_CR_LUMA_QUANTIZATION_TABLE_72_M=
ASK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_CR_LUMA_QUANTIZATION_TABLE_72_S=
HIFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_CR_LUMA_QUANTIZATION_TABLE_71_M=
ASK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_CR_LUMA_QUANTIZATION_TABLE_71_S=
HIFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_CR_LUMA_QUANTIZATION_TABLE_70_M=
ASK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE14_CR_LUMA_QUANTIZATION_TABLE_70_S=
HIFT	(0)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_OFFSET					(0x008C)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_CR_LUMA_QUANTIZATION_TABLE_77_M=
ASK	(0xFF000000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_CR_LUMA_QUANTIZATION_TABLE_77_S=
HIFT	(24)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_CR_LUMA_QUANTIZATION_TABLE_76_M=
ASK	(0x00FF0000)
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_CR_LUMA_QUANTIZATION_TABLE_76_S=
HIFT	(16)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_CR_LUMA_QUANTIZATION_TABLE_75_M=
ASK	(0x0000FF00)
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_CR_LUMA_QUANTIZATION_TABLE_75_S=
HIFT	(8)
> +
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_CR_LUMA_QUANTIZATION_TABLE_74_M=
ASK	(0x000000FF)
> +#define JASPER_LUMA_QUANTIZATION_TABLE15_CR_LUMA_QUANTIZATION_TABLE_74_S=
HIFT	(0)
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE0_OFFSET				(0x0090)
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE0_CR_CHROMA_QUANTIZATION_TABLE_0=
3_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE0_CR_CHROMA_QUANTIZATION_TABLE_0=
3_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE1_CR_CHROMA_QUANTIZATION_TABLE_0=
7_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE1_CR_CHROMA_QUANTIZATION_TABLE_0=
7_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE2_CR_CHROMA_QUANTIZATION_TABLE_1=
3_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE2_CR_CHROMA_QUANTIZATION_TABLE_1=
3_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE3_CR_CHROMA_QUANTIZATION_TABLE_1=
7_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE3_CR_CHROMA_QUANTIZATION_TABLE_1=
7_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE4_CR_CHROMA_QUANTIZATION_TABLE_2=
3_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE4_CR_CHROMA_QUANTIZATION_TABLE_2=
3_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE5_CR_CHROMA_QUANTIZATION_TABLE_2=
7_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE5_CR_CHROMA_QUANTIZATION_TABLE_2=
7_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE6_CR_CHROMA_QUANTIZATION_TABLE_3=
3_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE6_CR_CHROMA_QUANTIZATION_TABLE_3=
3_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE7_CR_CHROMA_QUANTIZATION_TABLE_3=
7_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE7_CR_CHROMA_QUANTIZATION_TABLE_3=
7_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE8_CR_CHROMA_QUANTIZATION_TABLE_4=
3_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE8_CR_CHROMA_QUANTIZATION_TABLE_4=
3_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE9_CR_CHROMA_QUANTIZATION_TABLE_4=
7_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE9_CR_CHROMA_QUANTIZATION_TABLE_4=
7_SHIFT		(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE10_CR_CHROMA_QUANTIZATION_TABLE_=
53_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE10_CR_CHROMA_QUANTIZATION_TABLE_=
53_SHIFT	(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE11_CR_CHROMA_QUANTIZATION_TABLE_=
57_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE11_CR_CHROMA_QUANTIZATION_TABLE_=
57_SHIFT	(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE12_CR_CHROMA_QUANTIZATION_TABLE_=
63_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE12_CR_CHROMA_QUANTIZATION_TABLE_=
63_SHIFT	(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE13_CR_CHROMA_QUANTIZATION_TABLE_=
67_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE13_CR_CHROMA_QUANTIZATION_TABLE_=
67_SHIFT	(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE14_CR_CHROMA_QUANTIZATION_TABLE_=
73_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE14_CR_CHROMA_QUANTIZATION_TABLE_=
73_SHIFT	(24)
> +
...
> +
> +#define JASPER_CHROMA_QUANTIZATION_TABLE15_CR_CHROMA_QUANTIZATION_TABLE_=
77_MASK		(0xFF000000)
> +#define JASPER_CHROMA_QUANTIZATION_TABLE15_CR_CHROMA_QUANTIZATION_TABLE_=
77_SHIFT	(24)
> +
...
> +#define JASPER_FRONT_END_CRC_CR_JASPER_FRONT_END_CRC_OUT_MASK	(0xFFFFFFF=
F)
...
> +#define JASPER_ENTROPY_ENCODER_CRC_CR_JASPER_ENTROPY_CRC_OUT_MASK	(0xFFF=
FFFFF)
> +#define JASPER_ENTROPY_ENCODER_CRC_CR_JASPER_ENTROPY_CRC_OUT_SHIFT	(0)
> +
> +#define JASPER_PACKING_BUFFER_DATA_CRC_OFFSET		(0x00E8)
> +#define JASPER_PACKING_BUFFER_DATA_CRC_CR_JASPER_PACKING_DATA_CRC_OUT_MA=
SK		(0xFFFFFFFF)
> +#define JASPER_PACKING_BUFFER_DATA_CRC_CR_JASPER_PACKING_DATA_CRC_OUT_SH=
IFT		(0)
> +
> +#define JASPER_PACKING_BUFFER_ADDR_CRC_OFFSET		(0x00EC)
> +#define JASPER_PACKING_BUFFER_ADDR_CRC_CR_JASPER_PACKING_ADDR_OUT_CRC_MA=
SK		(0xFFFFFFFF)
> +#define JASPER_PACKING_BUFFER_ADDR_CRC_CR_JASPER_PACKING_ADDR_OUT_CRC_SH=
IFT		(0)
> +
> +#define JASPER_CORE_BYTE_SIZE		(0x00F0)
> +
> +#endif
> diff --git a/drivers/media/platform/imagination/e5010-jpeg-enc-hw.c b/dri=
vers/media/platform/imagination/e5010-jpeg-enc-hw.c
> new file mode 100644
...
> +
> +static void write_reg_field(void __iomem *base, unsigned int offset, u32=
 mask,
...
> +		value =3D (value & mask) | (reg & ~mask);
> +	}
> +	writel(value, (base + offset));
> +}
> +
> +static int write_reg_field_not_busy(void __iomem *jasper_base, void __io=
mem *wr_base,
...
> +	u32 val;
> +
> +	ret =3D readl_poll_timeout_atomic(jasper_base + JASPER_STATUS_OFFSET, v=
al,
> +					(val & JASPER_STATUS_CR_JASPER_BUSY_MASK) =3D=3D 0,
> +					2000, 50000);
> +	if (ret)
> +		return ret;
> +
...
> +}
> +
> +void e5010_reset(struct device *dev, void __iomem *core_base, void __iom=
em *mmu_base)
> +{
> +	int ret =3D 0;
> +	u32 val;
...
> +
> +	ret =3D readl_poll_timeout_atomic(mmu_base + MMU_MMU_CONTROL1_OFFSET, v=
al,
> +					(val & MMU_MMU_CONTROL1_MMU_SOFT_RESET_MASK) =3D=3D 0,
> +					2000, 50000);
> +	if (ret)
...
> +}
> +
> +int e5010_hw_enable_output_address_error_irq(void __iomem *core_base, u3=
2 enable)
> +{
> +	int ret;
> +
> +	ret =3D write_reg_field_not_busy(core_base, core_base,
...
> +	bool pic_done;
> +
> +	reg =3D readl(core_base + JASPER_INTERRUPT_STATUS_OFFSET);
...
> +
> +	reg =3D readl(core_base + JASPER_INTERRUPT_STATUS_OFFSET);
> +	output_address_error =3D (reg & JASPER_INTERRUPT_STATUS_CR_OUTPUT_ADDRE=
SS_ERROR_IRQ_MASK) ?
> +				true : false;
> +
...
> +}
> +
> +int e5010_hw_enable_auto_clock_gating(void __iomem *core_base, u32 enabl=
e)
> +{
> +	int ret;
> +
...
> +}
> +
> +int e5010_hw_enable_manual_clock_gating(void __iomem *core_base, u32 ena=
ble)
> +{
> +	int ret;
> +
...
> +	int ret;
> +
> +	ret =3D write_reg_field_not_busy(core_base, core_base, offset, 0xffffff=
ff, 0, val);
> +	return ret;
> +}
> +
...
> +}
> diff --git a/drivers/media/platform/imagination/e5010-jpeg-enc-hw.h b/dri=
vers/media/platform/imagination/e5010-jpeg-enc-hw.h
> new file mode 100644
...
> +
> +int e5010_hw_enable_output_address_error_irq(void __iomem *core_offset, =
u32 enable);
> +int e5010_hw_enable_picture_done_irq(void __iomem *core_offset, u32 enab=
le);
> +int e5010_hw_enable_auto_clock_gating(void __iomem *core_offset, u32 ena=
ble);
> +int e5010_hw_enable_manual_clock_gating(void __iomem *core_offset, u32 e=
nable);
> +int e5010_hw_enable_crc_check(void __iomem *core_offset, u32 enable);
> +int e5010_hw_set_input_source_to_memory(void __iomem *core_offset, u32 s=
et);
...
> +int e5010_hw_set_chroma_stride(void __iomem *core_offset, u32 bytesperli=
ne);
...
> +int e5010_hw_set_qpvalue(void __iomem *core_offset, u32 offset, u32 valu=
e);
> +void e5010_reset(struct device *dev, void __iomem *core_offset, void __i=
omem *mmu_offset);
...
nit: While reviewing top down, I was wondering why you use uninitialized gl=
obal.
Might be worth commenting that these are forward declaration.

> +
> +static struct e5010_fmt e5010_formats[] =3D {
> +	{
> +		.fourcc =3D V4L2_PIX_FMT_NV12,
> +		.num_planes =3D 1,
> +		.type =3D V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
> +		.subsampling =3D V4L2_JPEG_CHROMA_SUBSAMPLING_420,
> +		.chroma_order =3D CHROMA_ORDER_CB_CR,
> +		.h_align =3D 6,
> +		.v_align =3D 3,
> +	},
> +	{
...
> +		.type =3D V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
> +		.subsampling =3D V4L2_JPEG_CHROMA_SUBSAMPLING_420,
> +		.chroma_order =3D CHROMA_ORDER_CR_CB,
> +		.h_align =3D 6,
> +		.v_align =3D 3,
> +	},
> +	{
...
> +		.num_planes =3D 1,
> +		.type =3D V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE,
> +		.subsampling =3D V4L2_JPEG_CHROMA_SUBSAMPLING_422,
> +		.chroma_order =3D CHROMA_ORDER_CB_CR,
> +		.h_align =3D 6,
> +		.v_align =3D 3,
> +	},
...
> +
> +/*
> + * Contains the data that needs to be sent in the marker segment of an i=
nterchange format JPEG
> + * stream or an abbreviated format table specification data stream.
> + * Specifies the huffman table used for encoding the luminance DC coeffi=
cient differences.
> + * The table represents Table K.3 of IS0/IEC 10918-1:1994(E)
> + */
> +static const u8 marker_luma_dc[] =3D {
...
nterchange format JPEG
> + * stream or an abbreviated format table specification data stream.
> + * Specifies the huffman table used for encoding the luminance AC coeffi=
cients.
> + * The table represents Table K.5 of IS0/IEC 10918-1:1994(E)
> + */
> +static const u8 marker_luma_ac[] =3D {
...
nterchange format JPEG
> + * stream or an abbreviated format table specification data stream.
> + * Specifies the huffman table used for encoding the chrominance DC coef=
ficient differences.
> + * The table represents Table K.4 of IS0/IEC 10918-1:1994(E)
> + */
> +static const u8 marker_chroma_dc[] =3D {
...
nterchange format JPEG
> + * stream or an abbreviated format table specification data stream.
> + * Specifies the huffman table used for encoding the chrominance AC coef=
ficients.
> + * The table represents Table K.6 of IS0/IEC 10918-1:1994(E)
> + */
> +static const u8 marker_chroma_ac[] =3D {
...
> +
> +static const struct v4l2_event e5010_eos_event =3D {
...
> +}
> +
> +static struct e5010_q_data *get_queue(struct e5010_context *ctx, enum v4=
l2_buf_type type)
> +{
> +	switch (type) {
> +	case V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE:
...
> +	int quality, i;
> +
> +	quality =3D 100 - ctx->quality;
> +	quality -=3D 50;

Why not just (a number between -50 and 50)?

	quality =3D 50 - ctx->quality;

> +
> +	luminosity =3D LUMINOSITY * quality / 50;
> +	contrast =3D CONTRAST * quality / 50;
> +
> +	if (quality > 0) {
> +		luminosity *=3D INCREASE;
> +		contrast *=3D INCREASE;
> +	}
> +
> +	for (i =3D 0; i < 64; i++) {
> +		long long delta =3D chroma[i] * contrast + luminosity;
> +		int val =3D (int)(chroma[i] + delta);
> +
> +		if (val < 1)
> +			val =3D 1;
> +		if (val > 255)
...
> +		ctx->chroma_qp[i] =3D quality =3D=3D -50 ? 1 : val;
> +
> +		delta =3D luma[i] * contrast + luminosity;
> +		val =3D (int)(luma[i] + delta);
> +		if (val < 1)
> +			val =3D 1;
> +		if (val > 255)
> +			val =3D 255;
...
> +		ctx->luma_qp[i] =3D quality =3D=3D -50 ? 1 : val;
> +	}
> +
> +	ctx->update_qp =3D true;
> +}
> +
> +static int update_qp_tables(struct e5010_context *ctx)
> +{
> +	struct e5010_dev *dev =3D ctx->dev;
> +	int i, ret =3D 0;
> +	u32 lvalue, cvalue;
> +
> +	lvalue =3D 0;
> +	cvalue =3D 0;
> +
> +	for (i =3D 0; i < (QP_TABLE_SIZE); i++) {

No need for this parenthesis.

> +		lvalue |=3D ctx->luma_qp[i] << (8 * (i % 4));
> +		cvalue |=3D ctx->chroma_qp[i] << (8 * (i % 4));
> +		if (i % 4 =3D=3D 3) {
> +			ret |=3D e5010_hw_set_qpvalue(dev->jasper_base,
...
> +}
> +
> +static int e5010_set_input_subsampling(void __iomem *core_base, int subs=
ampling)
> +{
> +	switch (subsampling) {
...
> +}
> +
> +static int e5010_querycap(struct file *file, void *priv, struct v4l2_cap=
ability *cap)
> +{
> +	strscpy(cap->driver, E5010_MODULE_NAME, sizeof(cap->driver));
> +	strscpy(cap->card, E5010_MODULE_NAME, sizeof(cap->card));
> +	snprintf(cap->bus_info, sizeof(cap->bus_info), "platform:%s", E5010_MOD=
ULE_NAME);
...
> +	int i;
> +
> +	for (i =3D 0; i < ARRAY_SIZE(e5010_formats); ++i) {
> +		if (e5010_formats[i].fourcc =3D=3D f->fmt.pix_mp.pixelformat &&
> +		    e5010_formats[i].type =3D=3D f->type)
...
> +}
> +
> +static int e5010_enum_fmt(struct file *file, void *priv, struct v4l2_fmt=
desc *f)
> +{
> +	int i, index =3D 0;
> +	struct e5010_fmt *fmt =3D NULL;
...
> +
> +	for (i =3D 0; i < ARRAY_SIZE(e5010_formats); ++i) {
> +		if (e5010_formats[i].type =3D=3D f->type) {
> +			if (index =3D=3D f->index) {
> +				fmt =3D &e5010_formats[i];
> +				break;
> +			}
> +			index++;
> +		}
...
> +}
> +
> +static int e5010_g_fmt(struct file *file, void *priv, struct v4l2_format=
 *f)
> +{
> +	struct e5010_context *ctx =3D file->private_data;
...
> +	struct v4l2_plane_pix_format *plane_fmt =3D pix_mp->plane_fmt;
> +
> +	if (!V4L2_TYPE_IS_MULTIPLANAR(f->type)) {
...
> +	}
> +
> +	queue =3D get_queue(ctx, f->type);
> +	if (IS_ERR(queue))
> +		return PTR_ERR(queue);
> +
> +	pix_mp->flags =3D 0;
> +	pix_mp->field =3D V4L2_FIELD_NONE;
> +	pix_mp->pixelformat =3D queue->fmt->fourcc;
> +	pix_mp->width =3D queue->width_adjusted;
> +	pix_mp->height =3D queue->height_adjusted;
> +	pix_mp->num_planes =3D queue->fmt->num_planes;
> +
> +	if (V4L2_TYPE_IS_OUTPUT(f->type)) {
> +		if (!pix_mp->colorspace)
> +			pix_mp->colorspace =3D V4L2_COLORSPACE_SRGB;
> +
> +		for (i =3D 0; i < queue->fmt->num_planes; i++) {
> +			plane_fmt[i].sizeimage =3D queue->sizeimage[i];
> +			plane_fmt[i].bytesperline =3D queue->bytesperline[i];
> +		}
> +
> +	} else {
> +		pix_mp->colorspace =3D V4L2_COLORSPACE_JPEG;
> +		plane_fmt[0].bytesperline =3D 0;
> +		plane_fmt[0].sizeimage =3D queue->sizeimage[0];
> +	}
...
> +{
> +	if (q->fmt->fourcc =3D=3D V4L2_PIX_FMT_JPEG) {
> +		/* bytesperline unused for compressed formats */
> +		q->bytesperline[0] =3D 0;
> +		q->bytesperline[1] =3D 0;
> +	} else if (q->fmt->num_planes =3D=3D 1) {
> +		q->bytesperline[0] =3D q->width_adjusted;
> +		q->bytesperline[1] =3D 0;
> +	} else {
> +		q->bytesperline[0] =3D q->width_adjusted;
> +		q->bytesperline[1] =3D q->bytesperline[0];
> +	}
> +}
> +
> +static void e5010_queue_update_sizeimage(struct e5010_q_data *q, struct =
e5010_context *ctx)
> +{
> +	if (q->fmt->fourcc =3D=3D V4L2_PIX_FMT_JPEG) {
> +		if (ctx->out_queue.fmt->subsampling =3D=3D V4L2_JPEG_CHROMA_SUBSAMPLIN=
G_420)
> +			q->sizeimage[0] =3D q->width_adjusted * q->height_adjusted * 3 / 2;
> +		else
> +			q->sizeimage[0] =3D q->width_adjusted * q->height_adjusted * 2;
> +		q->sizeimage[0] +=3D HEADER_SIZE;
> +		q->sizeimage[1] =3D 0;
> +	} else if (q->fmt->subsampling =3D=3D V4L2_JPEG_CHROMA_SUBSAMPLING_420)=
 {
> +		if (q->fmt->num_planes =3D=3D 1)	{
> +			q->sizeimage[0] =3D q->width_adjusted * q->height_adjusted * 3 / 2;
> +			q->sizeimage[1] =3D 0;
> +		} else {
> +			q->sizeimage[0] =3D q->width_adjusted * q->height_adjusted;
> +			q->sizeimage[1] =3D q->sizeimage[0] / 2;
> +		}
> +	} else {
> +		if (q->fmt->num_planes =3D=3D 1)	{
> +			q->sizeimage[0] =3D q->width_adjusted * q->height_adjusted * 2;
...
> +		} else {
> +			q->sizeimage[0] =3D q->width_adjusted * q->height_adjusted;
> +			q->sizeimage[1] =3D q->sizeimage[0];
> +		}
> +	}
...
> +}
> +
> +static int e5010_jpeg_try_fmt(struct v4l2_format *f, struct e5010_contex=
t *ctx)
> +{
...
> +	if (!fmt) {
> +		if (V4L2_TYPE_IS_OUTPUT(f->type))
> +			pix_mp->pixelformat =3D V4L2_PIX_FMT_NV12;
> +		else
> +			pix_mp->pixelformat =3D V4L2_PIX_FMT_JPEG;
> +		fmt =3D find_format(f);
> +		if (!fmt)
> +			return -EINVAL;
> +	}
...
> +
> +	queue->fmt =3D fmt;
> +	queue->width =3D pix_mp->width;
> +	queue->height =3D pix_mp->height;
> +
> +	queue->width_adjusted =3D queue->width;
> +	queue->height_adjusted =3D queue->height;
> +
> +	if (V4L2_TYPE_IS_OUTPUT(f->type)) {
> +		if (!pix_mp->colorspace)
> +			pix_mp->colorspace =3D V4L2_COLORSPACE_JPEG;
...
We hav v4l2_apply_frmsize_constraints() and struct v4l2_frmsize_stepwise no=
w
that can be set directly in your program table. It is much cleaner then thi=
s old
method.
...
The queue already trace all this, not sure what is the value of that trace.=
 Its
...
> +}
> +
> +static int e5010_try_fmt(struct file *file, void *priv, struct v4l2_form=
at *f)
> +{
> +	struct e5010_context *ctx =3D file->private_data;
> +
...
> +}
> +
> +static int e5010_s_fmt(struct file *file, void *priv, struct v4l2_format=
 *f)
> +{
> +	struct e5010_context *ctx =3D file->private_data;
> +	struct vb2_queue *vq;
...
> +}
> +
> +static int e5010_enum_framesizes(struct file *file, void *priv, struct v=
...
> +		return -EINVAL;
> +
> +	f.fmt.pix_mp.pixelformat =3D fsize->pixel_format;
> +	if (f.fmt.pix_mp.pixelformat =3D=3D  V4L2_PIX_FMT_JPEG)
...
> +	fsize->stepwise.min_width =3D MIN_DIMENSION;
> +	fsize->stepwise.max_width =3D MAX_DIMENSION;
> +	fsize->stepwise.step_width =3D 1;
> +	fsize->stepwise.min_height =3D MIN_DIMENSION;
> +	fsize->stepwise.max_height =3D MAX_DIMENSION;
> +	fsize->stepwise.step_height =3D 1;

With struct v4l2_frmsize_stepwise, all this code would be reduced.

> +
> +	fsize->reserved[0] =3D 0;
> +	fsize->reserved[1] =3D 0;
> +
> +	return 0;
> +}
> +
> +static int e5010_g_selection(struct file *file, void *fh, struct v4l2_se=
lection *s)
> +{
> +	struct e5010_context *ctx =3D file->private_data;
> +	struct e5010_q_data *queue;
> +
> +	if (s->type !=3D V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE)
> +		return -EINVAL;
> +
> +	queue =3D get_queue(ctx, s->type);
> +	if (IS_ERR(queue))
> +		return PTR_ERR(queue);
> +
> +	switch (s->target) {
...
> +		s->r.left =3D 0;
> +		s->r.top =3D 0;
> +		s->r.width =3D queue->width;
> +		s->r.height =3D queue->height;
> +		break;
...
> +}
> +
> +static int e5010_s_selection(struct file *file, void *fh, struct v4l2_se=
lection *s)
> +{
> +	struct e5010_context *ctx =3D file->private_data;
> +	struct e5010_q_data *queue;
...
> +		return PTR_ERR(queue);
> +
> +	queue->crop.left =3D 0;
> +	queue->crop.top =3D 0;
> +	queue->crop.width =3D s->r.width;
> +	queue->crop.height =3D s->r.height;
> +
> +	return 0;
> +}
> +
> +static int e5010_subscribe_event(struct v4l2_fh *fh, const struct v4l2_e=
vent_subscription *sub)
> +{
> +	switch (sub->type) {
> +	case V4L2_EVENT_EOS:
...
ueue *dst_vq)
> +{
> +	struct e5010_context *ctx =3D priv;
> +	struct e5010_dev *dev =3D ctx->dev;
> +	int ret =3D 0;
> +
> +	/* src_vq */
...
> +	src_vq->buf_struct_size =3D sizeof(struct e5010_buffer);
> +	src_vq->ops =3D &e5010_video_ops;
> +	src_vq->mem_ops =3D &vb2_dma_contig_memops;
> +	src_vq->timestamp_flags =3D V4L2_BUF_FLAG_TIMESTAMP_COPY;
> +	src_vq->lock =3D &dev->mutex;
> +	src_vq->dev =3D dev->v4l2_dev.dev;
> +
...
> +	dst_vq->buf_struct_size =3D sizeof(struct e5010_buffer);
> +	dst_vq->ops =3D &e5010_video_ops;
> +	dst_vq->mem_ops =3D &vb2_dma_contig_memops;
> +	dst_vq->timestamp_flags =3D V4L2_BUF_FLAG_TIMESTAMP_COPY;
> +	dst_vq->lock =3D &dev->mutex;
> +	dst_vq->dev =3D dev->v4l2_dev.dev;
> +
...
> +{
> +	struct e5010_context *ctx =3D
> +		container_of(ctrl->handler, struct e5010_context, ctrl_handler);
> +
> +	switch (ctrl->id) {
> +	case V4L2_CID_JPEG_COMPRESSION_QUALITY:
> +		ctx->quality =3D ctrl->val;
> +		calculate_qp_tables(ctx);
> +		break;
> +	default:
> +		dev_err(ctx->dev->dev, "Invalid control, id =3D %d, val =3D %d\n",
> +			ctrl->id, ctrl->val);
> +		return -EINVAL;
> +	}
> +
...
> +}
> +
> +static const struct v4l2_ctrl_ops e5010_ctrl_ops =3D {
> +	.s_ctrl =3D e5010_s_ctrl,
> +};
> +
...
> +		err =3D ctx->ctrl_handler.error;
> +		v4l2_ctrl_handler_free(&ctx->ctrl_handler);
> +		return err;
> +	}
> +
> +	err =3D v4l2_ctrl_handler_setup(&ctx->ctrl_handler);
> +	if (err)
> +		v4l2_ctrl_handler_free(&ctx->ctrl_handler);
> +
> +	return err;
...
> +	fmt =3D find_format(&f);
> +	queue =3D &ctx->out_queue;
> +	queue->fmt =3D fmt;
> +	queue->width =3D DEFAULT_WIDTH;
> +	queue->height =3D DEFAULT_HEIGHT;
> +	queue->width_adjusted =3D queue->width;
> +	queue->height_adjusted =3D queue->height;
> +
> +	v4l_bound_align_image(&queue->width_adjusted,
...
> +
> +	f.type =3D V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE;
> +	f.fmt.pix_mp.pixelformat =3D V4L2_PIX_FMT_JPEG;
> +	fmt =3D find_format(&f);
> +	queue =3D &ctx->cap_queue;
> +	queue->fmt =3D fmt;
> +	queue->width =3D DEFAULT_WIDTH;
> +	queue->height =3D DEFAULT_HEIGHT;
> +	queue->width_adjusted =3D queue->width;
...
> +
> +	ctx->dev =3D dev;
> +	ctx->fh.m2m_ctx =3D v4l2_m2m_ctx_init(dev->m2m_dev, ctx, queue_init);
...
> +}
> +
> +static struct video_device e5010_videodev =3D {
> +	.name =3D E5010_MODULE_NAME,
> +	.fops =3D &e5010_fops,
> +	.ioctl_ops =3D &e5010_ioctl_ops,
> +	.minor =3D -1,
...
> +};
> +
> +static void header_write(struct e5010_context *ctx, u8 *addr, unsigned i=
nt *offset,
> +			 unsigned int no_bytes, unsigned long bits)
> +{
> +	u8 *w_addr =3D addr + *offset;
> +	int i;
> +
> +	if ((*offset + no_bytes) > HEADER_SIZE) {
> +		dev_warn(ctx->dev->dev, "%s: %s: %d: Problem writing header. %d > HEAD=
ER_SIZE %d\n",
> +			 __FILE__, __func__, __LINE__, *offset + no_bytes, HEADER_SIZE);
> +		return;
> +	}
> +
> +	for (i =3D no_bytes - 1; i >=3D 0; i--)
> +		*(w_addr++) =3D ((u8 *)&bits)[i];
> +
> +	*offset +=3D no_bytes;
> +}
...
> +}
> +
> +static void encode_frame_header(struct e5010_context *ctx, void *addr, u=
nsigned int *offset)
> +{
> +	u8 *buffer =3D (u8 *)addr;
> +
...
> +	if (ctx->out_queue.fmt->subsampling =3D=3D V4L2_JPEG_CHROMA_SUBSAMPLING=
_422)
...
> +
> +	for (i =3D 0; i < COMPONENTS_IN_SCAN; i++) {
...
> +	pic_done =3D e5010_hw_pic_done_irq(dev->jasper_base);
> +	out_addr_err =3D e5010_hw_output_address_irq(dev->jasper_base);
> +
...
> +		output_size =3D e5010_hw_get_output_size(dev->jasper_base);
...
> +	int ret =3D 0;
> +
> +	/*TODO: Set MMU in bypass mode until support for the same is added in d=
river*/

Normally we place TODO at the top too, could also be nice to mention this i=
n the
commit message.
...
> +
> +	ret =3D e5010_hw_set_input_source_to_memory(dev->jasper_base, 1);
> +	if (ret) {
> +		dev_err(dev->dev, "Failed to set input source to memory\n");
> +		goto fail;
> +	}
> +
> +	ret =3D e5010_hw_enable_picture_done_irq(dev->jasper_base, 1);
> +	if (ret)
...
> +	int irq, ret =3D 0;
> +
> +	of_dev_id =3D of_match_device(e5010_of_match, &pdev->dev);
> +	if (!of_dev_id) {
...
> +
> +	dev->vdev =3D &e5010_videodev;
> +	dev->vdev->v4l2_dev =3D &dev->v4l2_dev;
> +	dev->vdev->lock =3D &dev->mutex;
> +	dev->vdev->queue =3D NULL;
> +	dev->vdev->prio =3D NULL;
> +	dev->vdev->dev_parent =3D NULL;
> +	dev->vdev->minor =3D -1;
> +
...
> +	}
> +
> +	dev->m2m_dev =3D v4l2_m2m_init(&e5010_m2m_ops);
> +	if (!dev->m2m_dev) {
...
> +
> +	ret =3D video_register_device(dev->vdev, VFL_TYPE_VIDEO, 0);
> +	if (ret) {
...
> +		 dev->vdev->num);
> +
> +	res =3D platform_get_resource_byname(pdev, IORESOURCE_MEM, "regjasper")=
;
> +	if (!res) {
...
> +	}
> +	dev->jasper_base =3D devm_ioremap_resource(&pdev->dev, res);
> +	if (!dev->jasper_base) {
> +		ret =3D -ENOMEM;
> +		goto fail_after_video_register_device;
> +	}
> +
> +	res =3D platform_get_resource_byname(pdev, IORESOURCE_MEM, "regmmu");
> +	if (!res) {
> +		dev_err(dev->dev, "Missing 'regmmu' resources area\n");
> +		ret =3D -ENOMEM;
> +		goto fail_after_video_register_device;
> +	}
> +	dev->mmu_base =3D devm_ioremap_resource(&pdev->dev, res);
> +	if (!dev->mmu_base) {
> +		ret =3D -ENOMEM;
> +		goto fail_after_video_register_device;
> +	}
> +
> +	dev->last_context_run =3D NULL;
> +
> +	irq =3D platform_get_irq(pdev, 0);
> +	ret =3D devm_request_irq(dev->dev, irq, e5010_irq, 0,
...
> +	}
> +
> +	dev->clk =3D devm_clk_get(&pdev->dev, "core_clk");
> +	if (IS_ERR(dev->clk)) {
> +		dev_err(dev->dev, "failed to get clock\n");
> +		ret =3D PTR_ERR(dev->clk);
> +		goto fail_after_video_register_device;
> +	}
> +
...
> +{
> +	struct e5010_dev *dev =3D platform_get_drvdata(pdev);
> +
...
> +}
> +
> +static int e5010_queue_setup(struct vb2_queue *vq, unsigned int *nbuffer=
s, unsigned int *nplanes,
> +			     unsigned int sizes[], struct device *alloc_devs[])
> +{
> +	struct e5010_context *ctx =3D vb2_get_drv_priv(vq);
> +	struct e5010_q_data *queue;
> +	int i;
> +
...
> +	}
> +
> +	queue =3D get_queue(ctx, vq->type);
> +	if (IS_ERR(queue))
> +		return PTR_ERR(queue);
> +
> +	if (*nplanes) {
> +		if (*nplanes !=3D queue->fmt->num_planes)
> +			return -EINVAL;
...
> +	}
> +
> +	*nbuffers =3D max_t(unsigned int, *nbuffers, 1);
> +	*nplanes =3D queue->fmt->num_planes;
> +	for (i =3D 0; i < *nplanes; i++)
> +		sizes[i] =3D queue->sizeimage[i];
> +
> +	dprintk(ctx->dev, 2,
> +		"ctx: 0x%p, type %s, buffer(s): %d, planes %d, plane1: bytes %d plane2=
: %d bytes\n",
...
> +{
> +	struct e5010_context *ctx =3D vb2_get_drv_priv(vb->vb2_queue);
> +	void *d_addr;
> +
> +	if (vb->state !=3D VB2_BUF_STATE_DONE || V4L2_TYPE_IS_OUTPUT(vb->vb2_qu=
eue->type))
> +		return;
> +
> +	d_addr =3D vb2_plane_vaddr(vb, 0);
...
> +	vbuf->field =3D V4L2_FIELD_NONE;
> +
> +	queue =3D get_queue(ctx, vb->vb2_queue->type);
> +	if (IS_ERR(queue))
> +		return PTR_ERR(queue);
> +
> +	for (i =3D 0; i < queue->fmt->num_planes; i++) {
...
> +		struct e5010_q_data *queue =3D get_queue(ctx, V4L2_BUF_TYPE_VIDEO_CAPT=
URE_MPLANE);
> +
> +		if (IS_ERR(queue))
> +			return;
> +		vbuf->sequence =3D queue->sequence++;
...
> +
> +	cap_vq =3D v4l2_m2m_get_vq(ctx->fh.m2m_ctx, V4L2_BUF_TYPE_VIDEO_CAPTURE=
_MPLANE);
> +
> +	ret =3D v4l2_m2m_ioctl_try_encoder_cmd(file, &ctx->fh, cmd);
> +	if (ret < 0)
> +		return ret;
> +
...
> +		return 0;
> +
> +	ret =3D v4l2_m2m_ioctl_encoder_cmd(file, &ctx->fh, cmd);
> +	if (ret < 0)
> +		return ret;
> +
...
> +		v4l2_event_queue_fh(&ctx->fh, &e5010_eos_event);
> +
> +	if (cmd->cmd =3D=3D V4L2_ENC_CMD_START &&
> +	    v4l2_m2m_has_stopped(ctx->fh.m2m_ctx))
...
> +{
> +	struct e5010_context *ctx =3D vb2_get_drv_priv(q);
> +	int ret;
> +
> +	struct e5010_q_data *queue =3D get_queue(ctx, q->type);
> +
> +	if (IS_ERR(queue))
> +		return PTR_ERR(queue);
> +	queue->streaming =3D true;
...
> +	}
> +
> +	ret =3D e5010_init_device(ctx->dev);
> +	if (ret)
...
> +	int ret =3D 0;
> +	unsigned long flags;
> +	int num_planes =3D ctx->out_queue.fmt->num_planes;
> +
> +	spin_lock_irqsave(&dev->hw_lock, flags);
> +	s_vb =3D v4l2_m2m_next_src_buf(ctx->fh.m2m_ctx);
> +	WARN_ON(!s_vb);
> +	d_vb =3D v4l2_m2m_next_dst_buf(ctx->fh.m2m_ctx);
> +	WARN_ON(!d_vb);
> +	if (!s_vb || !d_vb)
> +		goto no_ready_buf_err;
> +
> +	s_vb->sequence =3D ctx->out_queue.sequence++;
> +	d_vb->sequence =3D ctx->cap_queue.sequence++;
> +
> +	v4l2_m2m_buf_copy_metadata(s_vb, d_vb, false);
> +
> +	if (ctx !=3D dev->last_context_run || ctx->update_qp) {
> +		dprintk(dev, 1, "ctx updated: 0x%p -> 0x%p, updating qp tables\n",
> +			dev->last_context_run, ctx);
> +		ret =3D update_qp_tables(ctx);
> +	}
> +
> +	if (ret) {
> +		ctx->update_qp =3D true;
...
> +	} else {
> +		dev->last_context_run =3D ctx;
> +		ctx->update_qp =3D false;
> +	}
> +
> +	/* Set I/O Buffer addresses */
> +	reg =3D (u32)vb2_dma_contig_plane_dma_addr(&s_vb->vb2_buf, 0);
> +	ret =3D e5010_hw_set_input_luma_addr(dev->jasper_base, reg);
> +	if (ret || !reg) {
...
> +		reg +=3D (ctx->out_queue.bytesperline[0]) * (ctx->out_queue.height);
> +	else
> +		reg =3D (u32)vb2_dma_contig_plane_dma_addr(&s_vb->vb2_buf, 1);
> +
> +	dprintk(dev, 3,
...
> +
> +	ret =3D e5010_hw_set_input_chroma_addr(dev->jasper_base, reg);
> +	if (ret || !reg) {
> +		dev_err(dev->dev, "Failed to set input chroma address\n");
> +		goto device_busy_err;
> +	}
> +
> +	reg =3D (u32)vb2_dma_contig_plane_dma_addr(&d_vb->vb2_buf, 0);
> +	reg +=3D HEADER_SIZE;
> +	ret =3D e5010_hw_set_output_base_addr(dev->jasper_base, reg);
> +	if (ret || !reg) {
...
> +
> +	/* Set input settings */
> +	ret =3D e5010_hw_set_horizontal_size(dev->jasper_base, ctx->out_queue.w=
idth - 1);
> +	if (ret) {
...
> +	}
> +
> +	ret =3D e5010_hw_set_vertical_size(dev->jasper_base, ctx->out_queue.hei=
ght - 1);
> +	if (ret) {
> +		dev_err(dev->dev, "Failed to set input width\n");
> +		goto device_busy_err;
> +	}
> +
> +	ret =3D e5010_hw_set_luma_stride(dev->jasper_base, ctx->out_queue.bytes=
perline[0]);
> +	if (ret) {
...
> +	}
> +
> +	ret =3D e5010_hw_set_chroma_stride(dev->jasper_base, ctx->out_queue.byt=
esperline[0]);
> +	if (ret) {
...
> +	}
> +
> +	ret =3D e5010_set_input_subsampling(dev->jasper_base, ctx->out_queue.fm=
t->subsampling);
> +	if (ret) {
...
> +	}
> +
> +	ret =3D e5010_hw_set_chroma_order(dev->jasper_base, ctx->out_queue.fmt-=
>chroma_order);
> +	if (ret) {
...
> +{
> +	struct e5010_dev *e5010_dev =3D dev_get_drvdata(dev);
> +	int ret;
> +
> +	ret =3D clk_prepare_enable(e5010_dev->clk);
> +	if (ret < 0) {
...
> +#endif
> +
> +static const struct dev_pm_ops	e5010_pm_ops =3D {
> +	SET_RUNTIME_PM_OPS(e5010_runtime_suspend,
> +			   e5010_runtime_resume, NULL)
> +	SET_SYSTEM_SLEEP_PM_OPS(e5010_suspend, e5010_resume)
> +};
> +
> +static const struct v4l2_ioctl_ops e5010_ioctl_ops =3D {
> +	.vidioc_querycap =3D e5010_querycap,
> +
> +	.vidioc_enum_fmt_vid_cap =3D e5010_enum_fmt,
> +	.vidioc_g_fmt_vid_cap_mplane =3D e5010_g_fmt,
> +	.vidioc_try_fmt_vid_cap_mplane =3D e5010_try_fmt,
> +	.vidioc_s_fmt_vid_cap_mplane =3D e5010_s_fmt,
> +
> +	.vidioc_enum_fmt_vid_out =3D e5010_enum_fmt,
> +	.vidioc_g_fmt_vid_out_mplane =3D e5010_g_fmt,
> +	.vidioc_try_fmt_vid_out_mplane =3D e5010_try_fmt,
> +	.vidioc_s_fmt_vid_out_mplane =3D e5010_s_fmt,
> +
> +	.vidioc_g_selection =3D e5010_g_selection,
> +	.vidioc_s_selection =3D e5010_s_selection,
> +
...
> +
> +	.vidioc_subscribe_event =3D e5010_subscribe_event,
> +	.vidioc_unsubscribe_event =3D v4l2_event_unsubscribe,
> +	.vidioc_try_encoder_cmd =3D v4l2_m2m_ioctl_try_encoder_cmd,
> +	.vidioc_encoder_cmd =3D e5010_encoder_cmd,
> +
> +	.vidioc_enum_framesizes =3D e5010_enum_framesizes,
> +};
> +
> +static const struct vb2_ops e5010_video_ops =3D {
> +	.queue_setup =3D e5010_queue_setup,
> +	.buf_queue =3D e5010_buf_queue,
> +	.buf_finish =3D e5010_buf_finish,
> +	.buf_prepare =3D e5010_buf_prepare,
> +	.buf_out_validate =3D e5010_buf_out_validate,
> +	.wait_prepare =3D vb2_ops_wait_prepare,
> +	.wait_finish =3D vb2_ops_wait_finish,
> +	.start_streaming =3D e5010_start_streaming,
> +	.stop_streaming =3D e5010_stop_streaming,
> +};
> +
> +static const struct v4l2_file_operations e5010_fops =3D {
> +	.owner =3D THIS_MODULE,
> +	.open =3D e5010_open,
> +	.release =3D e5010_release,
> +	.poll =3D v4l2_m2m_fop_poll,
> +	.unlocked_ioctl =3D video_ioctl2,
> +	.mmap =3D v4l2_m2m_fop_mmap,
> +};
> +
> +static const struct v4l2_m2m_ops e5010_m2m_ops =3D {
> +	.device_run =3D e5010_device_run,
> +};
> +
> +static const struct of_device_id e5010_of_match[] =3D {
> +	{.compatible =3D "img,e5010-jpeg-enc"},   { /* end */},
> +};
> +MODULE_DEVICE_TABLE(of, e5010_of_match);
> +
> +static struct platform_driver e5010_driver =3D {
> +	.probe =3D e5010_probe,
> +	.remove =3D e5010_remove,
> +	.driver =3D {
> +		.name =3D E5010_MODULE_NAME,
> +		.of_match_table =3D e5010_of_match,
> +		.pm =3D &e5010_pm_ops,
> +	},
> +};
...
> diff --git a/drivers/media/platform/imagination/e5010-jpeg-enc.h b/driver=
s/media/platform/imagination/e5010-jpeg-enc.h
> new file mode 100644
...
> +#define LH_AC				0x00B5
> +
> +/* Definitions for the quantization table specification in the Marker se=
gment */
...
> +
> +enum {
> +	CHROMA_ORDER_CB_CR =3D 0, //UV ordering
> +	CHROMA_ORDER_CR_CB =3D 1, //VU ordering
> +};
> +
> +enum {
> +	SUBSAMPLING_420 =3D 1,
> +	SUBSAMPLING_422 =3D 2,
> +};
> +
> +/*
...
> +
> +#endif
> diff --git a/drivers/media/platform/imagination/e5010-mmu-regs.h b/driver=
s/media/platform/imagination/e5010-mmu-regs.h
> new file mode 100644
...
> +
> +#define MMU_REQUEST_PRIORITY_ENABLE_CMD_PRIORITY_ENABLE_MASK		(0x0000800=
0)
...
> +
> +#define MMU_REQUEST_PRIORITY_ENABLE_CMD_MMU_PRIORITY_ENABLE_MASK	(0x0001=
0000)
...
> +
> +#define MMU_MMU_ADDRESS_CONTROL_MMU_ENABLE_EXT_ADDRESSING_MASK		(0x00000=
010)
...
Looks good in general, I think its worth small modernization toward using m=
ore
