...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 24DAB4BD63C
	for <lists+devicetree@lfdr.de>; Mon, 21 Feb 2022 07:56:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345338AbiBUGl1 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 21 Feb 2022 01:41:27 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:42048 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345420AbiBUGko (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 21 Feb 2022 01:40:44 -0500
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5B426443D6;
        Sun, 20 Feb 2022 22:39:47 -0800 (PST)
X-UUID: 04656edc4b304553a8a958fe1feddd32-20220221
X-UUID: 04656edc4b304553a8a958fe1feddd32-20220221
Received: from mtkexhb01.mediatek.inc [(172.21.101.102)] by mailgw02.mediatek.com
        (envelope-from <roger.lu@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 587174897; Mon, 21 Feb 2022 14:39:41 +0800
...
Subject: [PATCH v23 4/7] soc: mediatek: SVS: add monitor mode
Date:   Mon, 21 Feb 2022 14:39:36 +0800
Message-ID: <20220221063939.14969-5-roger.lu@mediatek.com>
...
---
 drivers/soc/mediatek/mtk-svs.c | 252 ++++++++++++++++++++++++++++++++-
 1 file changed, 246 insertions(+), 6 deletions(-)

diff --git a/drivers/soc/mediatek/mtk-svs.c b/drivers/soc/mediatek/mtk-svs.c
index 2d7ea3d607c4..c4bcb3fc3182 100644
...
@@ -843,6 +916,25 @@ static int svs_init02(struct svs_platform *svsp)
 	return 0;
 }
...
+
 ...
 {
 	int ret;
@@ -855,6 +947,8 @@ static int svs_start(struct svs_platform *svsp)
 	if (ret)
 		return ret;
...
@@ -900,6 +994,8 @@ static int svs_resume(struct device *dev)
 	if (ret)
 		return ret;
...
@@ -964,6 +1060,15 @@ static int svs_bank_resource_setup(struct svs_platform *svsp)
 			}
 		}
...
+
 		...
 		if (svsb->opp_count != count) {
 			dev_err(svsb->dev,
@@ -994,7 +1099,11 @@ static int svs_bank_resource_setup(struct svs_platform *svsp)
...
+	u32 idx, i, ft_pgm, mts, temp0, temp1, temp2;
 	...
 	for (i = 0; i < svsp->efuse_max; i++)
 		if (svsp->efuse[i])
@@ -1070,6 +1179,126 @@ static bool svs_mt8183_efuse_parsing(struct svs_platform *svsp)
 		}
 	}
...
@@ -1152,9 +1381,14 @@ static struct device *svs_add_device_link(struct svs_platform *svsp,
...
@@ -1261,9 +1495,11 @@ static struct svs_bank svs_mt8183_banks[] = {
...
+					  SVSB_MODE_MON,
 		...
 		.freq_base		= 900000000,
 		.vboot			= 0x30,
@@ -1279,6 +1515,10 @@ static struct svs_bank svs_mt8183_banks[] = {
 		.core_sel		= 0x8fff0003,
 		.int_st			= BIT(3),
 		.ctl0			= 0x00050001,
+		.tzone_htemp		= 85000,
