...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6C50613FC08
	for <lists+devicetree@lfdr.de>; Thu, 16 Jan 2020 23:11:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729503AbgAPWLU (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 16 Jan 2020 17:11:20 -0500
Received: from mail.kapsi.fi ([91.232.154.25]:38825 "EHLO mail.kapsi.fi"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730161AbgAPWLU (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Thu, 16 Jan 2020 17:11:20 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=kapsi.fi;
         s=20161220; h=References:In-Reply-To:Message-Id:Date:Subject:Cc:To:From:
        Sender:Reply-To:MIME-Version:Content-Type:Content-Transfer-Encoding:
        Content-ID:Content-Description:Resent-Date:Resent-From:Resent-Sender:
        Resent-To:Resent-Cc:Resent-Message-ID:List-Id:List-Help:List-Unsubscribe:
        List-Subscribe:List-Post:List-Owner:List-Archive;
        bh=I0F+pe7PaYycudmhIu9hof/3xe+f2iZaWpYlfh/lqYM=; b=gf2M3Vhma/mDQaNTowp579dRN/
        ;
Received: from 88-115-239-103.elisa-laajakaista.fi ([88.115.239.103] helo=jadmar.ti.com)
        by mail.kapsi.fi with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.89)
        (envelope-from <jsarha@ti.com>)
        id 1isDLy-0008B8-Im; Fri, 17 Jan 2020 00:11:02 +0200
...
Cc:     tomi.valkeinen@ti.com, laurent.pinchart@ideasonboard.com,
        ...
        sam@ravnborg.org, robh+dt@kernel.org, jsarha@ti.com
Subject: [PATCH v7 4/5] drm/tidss: New driver for TI Keystone platform Display SubSystem
Date:   Fri, 17 Jan 2020 00:09:29 +0200
Message-Id: <357b1aa13f28dba5fcb9f769bdac6d0d5ff966b3.1579202260.git.jsarha@ti.com>
X-Mailer: git-send-email 2.17.1
In-Reply-To: <cover.1579202260.git.jsarha@ti.com>
References: <cover.1579202260.git.jsarha@ti.com>
X-SA-Exim-Connect-IP: 88.115.239.103
X-SA-Exim-Mail-From: jsarha@ti.com
...
new file mode 100644
index 000000000000..4fb2910ece19
--- /dev/null
