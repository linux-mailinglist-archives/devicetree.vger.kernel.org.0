...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D98BE4A2E89
	for <lists+devicetree@lfdr.de>; Sat, 29 Jan 2022 12:57:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242505AbiA2L5y (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 29 Jan 2022 06:57:54 -0500
Received: from mout.gmx.net ([212.227.15.15]:60025 "EHLO mout.gmx.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S243561AbiA2L5s (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Sat, 29 Jan 2022 06:57:48 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=gmx.net;
        s=badeba3b8450; t=1643457458;
        bh=ccDPROmFjf9Eg0ChBX9YtEIF6/g61HJ5XVJaoz0ObZk=;
        h=X-UI-Sender-Class:From:To:Cc:Subject:Date:In-Reply-To:References;
        b=iDtrNPCmLBEyxq3jDA2JuRNqpTmph0mMg+S28VtQTQwZOkB4GtHFXoCqU+YPU5irp
         lN06xGDrKmZgYcPIJLCZbe3AXDoMybIlfruSWB+UfYrWlr59LilyZCbP6y1RGsAIXP
         JmijRs8j0lFONmoEGDnylTkh/XFOLwDJHBpw90GY=
X-UI-Sender-Class: 01bb95c1-4bf8-414a-932a-4f6e2808ef9c
Received: from longitude ([5.146.194.160]) by mail.gmx.net (mrgmx005
 [212.227.17.190]) with ESMTPSA (Nemesis) id 1Mjj8D-1mYLb02VkR-00lDMW; Sat, 29
 Jan 2022 12:57:37 +0100
...
Subject: [PATCH v5 5/9] pinctrl: nuvoton: Add driver for WPCM450
Date:   Sat, 29 Jan 2022 12:52:24 +0100
Message-Id: <20220129115228.2257310-6-j.neuschaefer@gmx.net>
...
X-Provags-ID: V03:K1:h4FGRhfnQf6l9/FjbCHONSHWC2KmhBp+dsaV0zyqeKBjq0El3OY
 jgsi9cgnmy8dWIpsSF041owmQ6AyjPeUROY7iIohhjdhINemVf9n4q/uNscagXfO6RTpnek
 oZALvXwzbaHdTBdBznqsrBvoAG22R7Udg+XzXssE5yTp5enTgs18AqNhZw6FwVV0sNHoHoV
 CVFJ1K5cPG0BcujJP8WDQ==
X-Spam-Flag: NO
X-UI-Out-Filterresults: notjunk:1;V03:K0:eH1I41JW17g=:XmcBND0Mb85YjhSksYl4Bt
 
Precedence: bulk
...
v4:
- https://lore.kernel.org/lkml/20220109173000.1242703-6-j.neuschaefer@gmx.=
net/
...
+ * implementation there, because it would require taking gpio_chip->bgpio=
_lock,
+ * which is a spin lock, but wpcm450_gpio_fix_evpol must work in contexts=
 where
+ * a raw spin lock is held.
+ */
+static int wpcm450_gpio_get(struct wpcm450_gpio *gpio, int offset)
+{
+	void __iomem *reg =3D gpio->pctrl->gpio_base + gpio->bank->datain;
+	unsigned long flags;
+	u32 level;
+
+	raw_spin_lock_irqsave(&gpio->pctrl->lock, flags);
+	level =3D !!(ioread32(reg) & BIT(offset));
...
+
+		do {
+			level =3D wpcm450_gpio_get(gpio, offset);
+
...
+			raw_spin_unlock_irqrestore(&pctrl->lock, flags);
+
+		} while (wpcm450_gpio_get(gpio, offset) !=3D level);
+	}
+}
+
