...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1FAAB19D011
	for <lists+devicetree@lfdr.de>; Fri,  3 Apr 2020 08:12:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387849AbgDCGMa (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 3 Apr 2020 02:12:30 -0400
Received: from esa5.microchip.iphmx.com ([216.71.150.166]:35385 "EHLO
        esa5.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2387784AbgDCGMa (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  ...
  b=Ubs+AWObggELaqNzNE4NMkIKdoY4JyRW4quWPuxOY8lAsEgzDVUKNfb3
   ...
   KSXdIWSsecWDqu2kDQ88UBGg67i0fpz/4if92DXBBEfqLYxxJN/5CvInj
   g==;
...
X-IronPort-AV: E=Sophos;i="5.72,338,1580799600"; 
   d="scan'208";a="71316157"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa5.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 02 Apr 2020 23:12:29 -0700
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 03 Apr 2020 06:12:26.8700
 (UTC)
...
+			atmel,pins =3D
+				<AT91_PIOA 13 AT91_PERIPH_B (AT91_PINCTRL_DRIVE_STRENGTH_HI)				/* PA1=
3 CK periph B */
+				 AT91_PIOA 12 AT91_PERIPH_B (AT91_PINCTRL_PULL_UP | AT91_PINCTRL_DRIVE=
_STRENGTH_HI)	/* PA12 CMD periph B with pullup */
+				 AT91_PIOA 11 AT91_PERIPH_B (AT91_PINCTRL_PULL_UP | AT91_PINCTRL_DRIVE=
_STRENGTH_HI)	/* PA11 DAT0 periph B with pullup */
+				 AT91_PIOA  2 AT91_PERIPH_B (AT91_PINCTRL_PULL_UP | AT91_PINCTRL_DRIVE=
_STRENGTH_HI)	/* PA2 DAT1 periph B with pullup */
+				 AT91_PIOA  3 AT91_PERIPH_B (AT91_PINCTRL_PULL_UP | AT91_PINCTRL_DRIVE=
_STRENGTH_HI)	/* PA3 DAT2 periph B with pullup */
+				 AT91_PIOA  4 AT91_PERIPH_B (AT91_PINCTRL_PULL_UP | AT91_PINCTRL_DRIVE=
_STRENGTH_HI)>;	/* PA4 DAT3 periph B with pullup */
+		};
+	};
+
 	gpio_keys {
 		pinctrl_key_gpio_default: pinctrl_key_gpio {
 			atmel,pins =3D <AT91_PIOD 18 AT91_PERIPH_GPIO AT91_PINCTRL_NONE>;
@@ -568,6 +580,15 @@
 	disable-wp;
 };
=20
...
+	pinctrl-0 =3D <&pinctrl_sdmmc1_default>;
+	no-1-8-v;
+	non-removable;
+	status =3D "disabled"; /* Conflict with flx4. */
+};
+
 &qspi {
 	pinctrl-names =3D "default";
