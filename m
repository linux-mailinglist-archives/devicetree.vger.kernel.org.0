...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5C39F178C2C
	for <lists+devicetree@lfdr.de>; Wed,  4 Mar 2020 09:04:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729093AbgCDIEO (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 4 Mar 2020 03:04:14 -0500
Received: from mx0a-00128a01.pphosted.com ([148.163.135.77]:61434 "EHLO
        mx0a-00128a01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1729091AbgCDIEN (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 4 Mar 2020 03:04:13 -0500
Received: from pps.filterd (m0167089.ppops.net [127.0.0.1])
        by mx0a-00128a01.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 02482Nco027606;
        Wed, 4 Mar 2020 03:03:59 -0500
Received: from nwd2mta4.analog.com ([137.71.173.58])
        by mx0a-00128a01.pphosted.com with ESMTP id 2yfnranjgr-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 04 Mar 2020 03:03:59 -0500
Received: from ASHBMBX9.ad.analog.com (ashbmbx9.ad.analog.com [10.64.17.10])
        by nwd2mta4.analog.com (8.14.7/8.14.7) with ESMTP id 02483wpX035050
        (version=TLSv1/SSLv3 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128 verify=FAIL);
        Wed, 4 Mar 2020 03:03:58 -0500
Received: from ASHBCASHYB4.ad.analog.com (10.64.17.132) by
 ASHBMBX9.ad.analog.com (10.64.17.10) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1779.2; Wed, 4 Mar 2020 03:03:57 -0500
...
Received: from zeus.spd.analog.com (10.64.82.11) by ASHBMBX8.ad.analog.com
 ...
 Transport; Wed, 4 Mar 2020 03:03:57 -0500
Received: from saturn.ad.analog.com ([10.48.65.112])
        by zeus.spd.analog.com (8.15.1/8.15.1) with ESMTP id 02483jog021268;
        Wed, 4 Mar 2020 03:03:54 -0500
...
Subject: [PATCH v4 5/8] iio: adc: adi-axi-adc: add support for AXI ADC IP core
Date:   Wed, 4 Mar 2020 10:06:44 +0200
Message-ID: <20200304080647.16501-6-alexandru.ardelean@analog.com>
...
index f4da821c4022..11bfc079c543 100644
...
index 000000000000..0e9f2e8acaf1
--- /dev/null
...
+ * Link: https://wiki.analog.com/resources/fpga/docs/adi_axi_adc_ip
+ *
...
+ *   https://wiki.analog.com/resources/fpga/docs/adi_axi_adc_ip#register_map
+ */
+
