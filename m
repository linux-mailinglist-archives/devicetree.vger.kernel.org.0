...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9A8C3552B1D
	for <lists+devicetree@lfdr.de>; Tue, 21 Jun 2022 08:41:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345973AbiFUGlI (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 21 Jun 2022 02:41:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53460 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345944AbiFUGks (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 21 Jun 2022 02:40:48 -0400
Received: from twspam01.aspeedtech.com (twspam01.aspeedtech.com [211.20.114.71])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B17A518E10;
        Mon, 20 Jun 2022 23:40:44 -0700 (PDT)
Received: from mail.aspeedtech.com ([192.168.0.24])
        by twspam01.aspeedtech.com with ESMTP id 25L6MMpm031704;
...
Subject: [PATCH v3 1/5] crypto: aspeed: Add HACE hash driver
Date:   Tue, 21 Jun 2022 14:37:48 +0800
Message-ID: <20220621063752.1005781-2-neal_liu@aspeedtech.com>
...
X-ClientProxiedBy: TWMBX02.aspeed.com (192.168.0.24) To TWMBX02.aspeed.com
 (192.168.0.24)
X-DNSRBL: 
X-MAIL: twspam01.aspeedtech.com 25L6MMpm031704
...
---
 ...
 8 files changed, 1854 insertions(+)
...
index 1fc9ead83d2a..ed1fef2d8066 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
...
index 000000000000..05cba5171c51
--- /dev/null
...
new file mode 100644
index 000000000000..c34d162aa7b7
--- /dev/null
...
+};
+
+#define hilo(x)	(cpu_to_be32(upper_32_bits(x)), cpu_to_be32(lower_32_bits(x)))
+
+static const u32 sha384_iv[16] = {
+	hilo(SHA384_H0), hilo(SHA384_H1), hilo(SHA384_H2), hilo(SHA384_H3),
+	hilo(SHA384_H4), hilo(SHA384_H5), hilo(SHA384_H6), hilo(SHA384_H7)
+};
+
+static const u32 sha512_iv[16] = {
+	hilo(SHA512_H0), hilo(SHA512_H1), hilo(SHA512_H2), hilo(SHA512_H3),
+	hilo(SHA512_H4), hilo(SHA512_H5), hilo(SHA512_H6), hilo(SHA512_H7)
+};
+
...
new file mode 100644
index 000000000000..35b6017b3032
--- /dev/null
