...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 237B83D35CB
	for <lists+devicetree@lfdr.de>; Fri, 23 Jul 2021 09:59:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233871AbhGWHSh (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 23 Jul 2021 03:18:37 -0400
Received: from mail.kernel.org ([198.145.29.99]:46896 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S233291AbhGWHSh (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Fri, 23 Jul 2021 03:18:37 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 05F4A60EBD;
        Fri, 23 Jul 2021 07:59:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1627027151;
        bh=xNBxMLvbOUTj+aYORMsHAOQzZ2c3P+fMPLzcEt8Wk8c=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Fri, 23 Jul 2021 15:59:04 +0800
...
Subject: Re: [PATCH 2/2] arm64: dts: imx: Add i.mx8mm/imx8mn Gateworks gw7902
 dts support
Message-ID: <20210723075900.GF30773@dragon>
References: <20210715141750.11612-1-tharvey@gateworks.com>
 <20210715141750.11612-2-tharvey@gateworks.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20210715141750.11612-2-tharvey@gateworks.com>
User-Agent: Mutt/1.9.4 (2018-02-28)
Precedence: bulk
List-ID: <devicetree.vger.kernel.org>
X-Mailing-List: devicetree@vger.kernel.org

On Thu, Jul 15, 2021 at 07:17:50AM -0700, Tim Harvey wrote:
...
>  .../dts/freescale/imx8mm-venice-gw7902.dts    | 922 ++++++++++++++++++
>  .../dts/freescale/imx8mn-venice-gw7902.dts    | 895 +++++++++++++++++
...
> index 4b4785d86324..9020350ac3e7 100644
> --- a/arch/arm64/boot/dts/freescale/Makefile
> +++ b/arch/arm64/boot/dts/freescale/Makefile
> @@ -42,10 +42,12 @@ dtb-$(CONFIG_ARCH_MXC) += imx8mm-venice-gw71xx-0x.dtb
...
> index 000000000000..4bf9ec5be2cf
> --- /dev/null
...
These two are out of alphabetical order.

Shawn

> diff --git a/arch/arm64/boot/dts/freescale/imx8mn-venice-gw7902.dts b/arch/arm64/boot/dts/freescale/imx8mn-venice-gw7902.dts
> new file mode 100644
> index 000000000000..b3b8d21118d3
> --- /dev/null
