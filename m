...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7BCA34E6B71
	for <lists+devicetree@lfdr.de>; Fri, 25 Mar 2022 01:08:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1356970AbiCYAJd (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 24 Mar 2022 20:09:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54460 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1356867AbiCYAJc (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 24 Mar 2022 20:09:32 -0400
Received: from gate2.alliedtelesis.co.nz (gate2.alliedtelesis.co.nz [202.36.163.20])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BC56FBBE01
        for <devicetree@vger.kernel.org>; Thu, 24 Mar 2022 17:07:57 -0700 (PDT)
Received: from svr-chch-seg1.atlnz.lc (mmarshal3.atlnz.lc [10.32.18.43])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (Client did not present a certificate)
        by gate2.alliedtelesis.co.nz (Postfix) with ESMTPS id 9A5AF2C0AE0;
        Fri, 25 Mar 2022 00:07:54 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=alliedtelesis.co.nz;
        s=mail181024; t=1648166874;
        bh=Iqbm214fOkGDaZnhWvlfPmGTJCSY0wJ2nLMteQsdeao=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: from pat.atlnz.lc (Not Verified[10.32.16.33]) by svr-chch-seg1.atlnz.lc with Trustwave SEG (v8,2,6,11305)
        id <B623d07d90001>; Fri, 25 Mar 2022 13:07:53 +1300
Received: from chrisp-dl.ws.atlnz.lc (chrisp-dl.ws.atlnz.lc [10.33.22.30])
        by pat.atlnz.lc (Postfix) with ESMTP id 9C9A413EE56;
        Fri, 25 Mar 2022 13:07:53 +1300 (NZDT)
Received: by chrisp-dl.ws.atlnz.lc (Postfix, from userid 1030)
        id 93A352A003C; Fri, 25 Mar 2022 13:07:49 +1300 (NZDT)
...
Subject: [PATCH v3 2/3] dt-bindings: mmc: xenon: Convert to JSON schema
Date:   Fri, 25 Mar 2022 13:07:44 +1300
Message-Id: <20220325000745.1708610-3-chris.packham@alliedtelesis.co.nz>
...
index 000000000000..326ac3fa36b5
--- /dev/null
