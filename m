...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AF17D6DA5ED
	for <lists+devicetree@lfdr.de>; Fri,  7 Apr 2023 00:40:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230098AbjDFWk2 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 6 Apr 2023 18:40:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52702 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231144AbjDFWk1 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 6 Apr 2023 18:40:27 -0400
Received: from mx3.securetransport.de (mx3.securetransport.de [116.203.31.6])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 55DBF5FC7;
        Thu,  6 Apr 2023 15:40:24 -0700 (PDT)
Received: from mail.dh-electronics.com (unknown [77.24.89.57])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mx3.securetransport.de (Postfix) with ESMTPSA id 1E09A5DC67;
        Fri,  7 Apr 2023 00:39:47 +0200 (CEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=dh-electronics.com;
        s=dhelectronicscom; t=1680820788;
        bh=wbQFGW/uOW6LPTIhHMd0jndp8ch4Ac6NRP22d2WvbcI=;
        h=From:To:CC:Subject:Date:In-Reply-To:References:From;
        b=
Received: from DHPWEX01.DH-ELECTRONICS.ORG (10.64.2.30) by
 DHPWEX01.DH-ELECTRONICS.ORG (10.64.2.30) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26; Thu, 6 Apr 2023 23:54:27 +0200
Received: from localhost.localdomain (172.16.51.16) by
 DHPWEX01.DH-ELECTRONICS.ORG (10.64.2.30) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26 via Frontend Transport; Thu, 6 Apr 2023 23:54:26 +0200
...
Subject: [PATCH V3 4/4] ARM: dts: imx6ull-dhcor: Add Marantec maveo box
Date:   Thu, 6 Apr 2023 23:53:15 +0200
Message-ID: <20230406215315.13280-4-cniedermaier@dh-electronics.com>
...
V3: - Remove /delete-property/ entries from aliases node
---
 arch/arm/boot/dts/Makefile                    |   1 +
 arch/arm/boot/dts/imx6ull-dhcor-maveo-box.dts | 359 ++++++++++++++++++++++++++
