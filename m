...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D378B6069B4
	for <lists+devicetree@lfdr.de>; Thu, 20 Oct 2022 22:43:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229615AbiJTUnY (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 20 Oct 2022 16:43:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34022 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229763AbiJTUnP (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 20 Oct 2022 16:43:15 -0400
Received: from madras.collabora.co.uk (madras.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e5ab])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3C50420C981;
...
Received: from jupiter.universe (dyndsl-091-096-059-009.ewe-ip-backbone.de [91.96.59.9])
        ...
        by madras.collabora.co.uk (Postfix) with ESMTPSA id 60253660253D;
        Thu, 20 Oct 2022 21:42:57 +0100 (BST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1666298577;
        bh=I364BL+0kFsTQWKVC1pDk2qh9sXPTTZDqXKirDcuA/M=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
Received: by jupiter.universe (Postfix, from userid 1000)
        id 6224648089E; Thu, 20 Oct 2022 22:42:52 +0200 (CEST)
...
Subject: [PATCHv4 09/13] mfd: rk8xx: add rk806 support
Date:   Thu, 20 Oct 2022 22:42:47 +0200
Message-Id: <20221020204251.108565-10-sebastian.reichel@collabora.com>
...
index 8e3de443cc3d..85cd5b476fb1 100644
--- a/drivers/mfd/Kconfig
+++ b/drivers/mfd/Kconfig
@@ -1219,6 +1219,20 @@ config MFD_RK8XX_I2C
...
index edf84e870f98..e4b01ece4eaa 100644
...
index 098506972710..cdebf8e3d93c 100644
...
@@ -58,6 +63,16 @@ static const struct mfd_cell rk805s[] = {
 	},
 };
...
+
 static const struct mfd_cell rk808s[] = {
 	{ .name = "rk808-clkout", },
 	{ .name = "rk808-regulator", },
@@ -112,6 +127,12 @@ static const struct rk808_reg_data rk805_pre_init_reg[] = {
...
+	bool dual_support = false;
 	...
 	int nr_cells;
 	int ret;
@@ -559,6 +614,14 @@ int rk8xx_probe(struct device *dev, int variant, unsigned int irq, struct regmap
 		cells = rk805s;
...
index 000000000000..79c05327eeaf
--- /dev/null
