...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 819FA2A6C17
	for <lists+devicetree@lfdr.de>; Wed,  4 Nov 2020 18:46:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732054AbgKDRq0 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 4 Nov 2020 12:46:26 -0500
Received: from esa6.microchip.iphmx.com ([216.71.154.253]:61541 "EHLO
        esa6.microchip.iphmx.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1732048AbgKDRqZ (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 4 Nov 2020 12:46:25 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple;
  d=microchip.com; i=@microchip.com; q=dns/txt; s=mchp;
  t=1604511984; x=1636047984;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version;
  bh=vyMpERyXDylpmoCrnv7RbsJPaGE8nv7JXgDMAE9j6JQ=;
  b=DEX+4XH5aAULNNrk9Rw8zP3YtFS3Tjj8bBEUIhVp6kIax6DFt5Cqf+dR
   tI3akQXK1NNQDj46DZq1ZPUCCePyA9+rqcCXkpq1/K955nHSAoW2FdUnT
   eHSDDsGGaxEWaCQ+T+InjBsiIxp8qunLtCYcCzUS58UtJz5TXSxSRNORY
   F4DZrnl60Hb7yaYa48MSNq4VsFU8l+tO3c0NkqQeqTEl3NILT1aAmWckK
   tkqGbYUXXj6i7d+IX6HW97T40uZcisCAgzukaWtSK0dUqZkg3MYU2XBvj
   r0FKdp0Jn50O2z66COOfiM5wnlN+Q1c3ZG+n2Zz+9QdjsDulwLm1G++lU
   Q==;
IronPort-SDR: 
X-IronPort-AV: E=Sophos;i="5.77,451,1596524400"; 
   d="scan'208";a="32430000"
Received: from smtpout.microchip.com (HELO email.microchip.com) ([198.175.253.82])
  by esa6.microchip.iphmx.com with ESMTP/TLS/AES256-SHA256; 04 Nov 2020 10:46:17 -0700
Received: from chn-vm-ex01.mchp-main.com (10.10.85.143) by
 chn-vm-ex02.mchp-main.com (10.10.85.144) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256) id
 15.1.1979.3; Wed, 4 Nov 2020 10:46:16 -0700
Received: from m18063-ThinkPad-T460p.microchip.com (10.10.115.15) by
 chn-vm-ex01.mchp-main.com (10.10.85.143) with Microsoft SMTP Server id
 15.1.1979.3 via Frontend Transport; Wed, 4 Nov 2020 10:46:11 -0700
...
Subject: [PATCH v2 7/8] clk: at91: clk-master: re-factor master clock
Date:   Wed, 4 Nov 2020 19:45:25 +0200
Message-ID: <1604511926-29516-8-git-send-email-claudiu.beznea@microchip.com>
...
index bb81ff731ad8..f61d7dbe0e07 100644
...
+					   &at91rm9200_master_layout,
+					   data->mck_characteristics,
+					   &at91sam9260_mck_lock, 0, INT_MIN);
+	if (IS_ERR(hw))
+		goto err_free;
+
+	hw = at91_clk_register_master_div(regmap, "masterck_div",
