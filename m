...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 373BE38C223
	for <lists+devicetree@lfdr.de>; Fri, 21 May 2021 10:40:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232070AbhEUImS (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 21 May 2021 04:42:18 -0400
Received: from mx0b-00268f01.pphosted.com ([148.163.159.192]:17474 "EHLO
        mx0b-00268f01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S230445AbhEUImR (ORCPT
        <rfc822;devicetree@vger.kernel.org>);
        Fri, 21 May 2021 04:42:17 -0400
X-Greylist: delayed 4888 seconds by postgrey-1.27 at vger.kernel.org; Fri, 21 May 2021 04:42:17 EDT
Received: from pps.filterd (m0105197.ppops.net [127.0.0.1])
        by mx0a-00268f01.pphosted.com (8.16.0.43/8.16.0.43) with SMTP id 14L7ItFo007001;
        Fri, 21 May 2021 07:19:07 GMT
...
Subject: Re: [PATCH v3 08/16] ipmi: kcs_bmc: Decouple the IPMI chardev from
 the core
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 21 May 2021 07:19:05.5763
 (UTC)
...
>@@ -98,24 +105,77 @@ void kcs_bmc_disable_device(struct kcs_bmc_device *kc=
s_bmc, struct kcs_bmc_clien
> }
...
>+		rc =3D drv->ops->add_device(kcs_bmc);
>+		if (rc)
...
>+	list_for_each_entry(drv, &kcs_bmc_drivers, entry) {
>+		rc =3D drv->ops->remove_device(kcs_bmc);
>+		if (rc)
...
> 	int rc;
>@@ -512,10 +511,8 @@ int kcs_bmc_ipmi_add_device(struct kcs_bmc_device *kc=
s_bmc)
>
> 	return 0;
> }
...
>
>@@ -541,7 +538,29 @@ int kcs_bmc_ipmi_remove_device(struct kcs_bmc_device =
*kcs_bmc)
>
> 	return 0;
> }
...
>+
>+static const struct kcs_bmc_driver_ops kcs_bmc_ipmi_driver_ops =3D {
>+	.add_device =3D kcs_bmc_ipmi_add_device,
>+	.remove_device =3D kcs_bmc_ipmi_remove_device,
>+};
>+
>+static struct kcs_bmc_driver kcs_bmc_ipmi_driver =3D {
>+	.ops =3D &kcs_bmc_ipmi_driver_ops,
>+};
>+
