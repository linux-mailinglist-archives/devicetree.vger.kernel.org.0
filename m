...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8EE6645D8E4
	for <lists+devicetree@lfdr.de>; Thu, 25 Nov 2021 12:13:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235981AbhKYLQd (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 25 Nov 2021 06:16:33 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42508 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233097AbhKYLOc (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 25 Nov 2021 06:14:32 -0500
Received: from nbd.name (nbd.name [IPv6:2a01:4f8:221:3d45::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C0A4BC0617A5;
        Thu, 25 Nov 2021 03:07:54 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=nbd.name;
        ...
        bh=fV9iNGrMKw4+jR0efvQ4f0w3ULPHBq9JYbARuskRhGk=; b=do0yQBKN5ZwBqCMOTCZvbICvIJ
        Ykq2LMZ/rjWHWkQLSNPicfbhXb8r/+FdLfGJpUD0iW33wW6n/AVmLop9rCY2kEdrNpUFQPHihovSN
        EufA/JFJNhM5wuMt2c2qc8UK63oUQ7vZch+qhZ7lVaVpWgZB7IxzVnjh5MiC6QFs8w9c=;
Received: from p54ae9f3f.dip0.t-ipconnect.de ([84.174.159.63] helo=localhost.localdomain)
        by ds12 with esmtpsa (TLS1.2:ECDHE_RSA_AES_128_GCM_SHA256:128)
        (Exim 4.89)
        (envelope-from <nbd@nbd.name>)
        id 1mqCbP-0002ws-RF; Thu, 25 Nov 2021 12:07:43 +0100
...
Subject: [PATCH v4 03/12] ARM: dts: Add basic support for Airoha EN7523
Date:   Thu, 25 Nov 2021 12:07:29 +0100
Message-Id: <20211125110738.41028-4-nbd@nbd.name>
...
index 000000000000..e8e5c034cee7
--- /dev/null
...
new file mode 100644
index 000000000000..de9e5f3ff155
--- /dev/null
