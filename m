...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B329C6F29CB
	for <lists+devicetree@lfdr.de>; Sun, 30 Apr 2023 19:07:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229784AbjD3RHS (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sun, 30 Apr 2023 13:07:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39314 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230134AbjD3RHP (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sun, 30 Apr 2023 13:07:15 -0400
Received: from synguard (unknown [212.29.212.82])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 195D62D52;
        Sun, 30 Apr 2023 10:07:10 -0700 (PDT)
Received: from T14.siklu.local (T14.siklu.local [192.168.42.187])
        by synguard (Postfix) with ESMTP id DA9CD4E4CF;
...
Subject: [PATCH v4 2/3] net: mvpp2: tai: add extts support
Date:   Sun, 30 Apr 2023 20:06:55 +0300
Message-Id: <20230430170656.137549-3-shmuel.h@siklu.com>
...
to distinguish between an external trigger (e.g. from the PTP_PULSE_IN
pin) or an internal one, triggered by the registers.

The polling rate is once in 95ms, the value was borrowed from
ptp_clockmatrix which performs a similar task.
...
---
v1 -> v2: minor commit message and code comment changes. 
v2 -> v3: same as above. 
v3 -> v4: replace mvpp22_tai_{start,stop}_unlocked with
          mvpp22_tai_{start,stop}.
---
...
index d8ce8bdae046..97b34c876653 100644
