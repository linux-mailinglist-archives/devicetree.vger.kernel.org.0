...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7F57E34607F
	for <lists+devicetree@lfdr.de>; Tue, 23 Mar 2021 14:57:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231882AbhCWN5S (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 23 Mar 2021 09:57:18 -0400
Received: from mailgw01.mediatek.com ([210.61.82.183]:34764 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S231856AbhCWN5F (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 23 Mar 2021 09:57:05 -0400
X-UUID: 2efaf6389a3d46dcaf4a50387eb71283-20210323
X-UUID: 2efaf6389a3d46dcaf4a50387eb71283-20210323
Received: from mtkcas10.mediatek.inc [(172.21.101.39)] by mailgw01.mediatek.com
        (envelope-from <roger.lu@mediatek.com>)
        (Cellopoint E-mail Firewall v4.1.14 Build 0819 with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 617793861; Tue, 23 Mar 2021 21:57:01 +0800
...
Subject: [PATCH v13 7/7] soc: mediatek: SVS: add mt8192 SVS GPU driver
Date:   Tue, 23 Mar 2021 21:56:57 +0800
Message-ID: <20210323135657.2701-8-roger.lu@mediatek.com>
...
@@ -545,6 +607,181 @@ static u32 interpolate(u32 f0, u32 f1, u32 v0, u32 v1, u32 fx)
...
@@ -1583,10 +1926,11 @@ static int svs_status_debug_show(struct seq_file *m, void *v)
...
+			   svsb->name, tzone_temp, svsb->turn_pt);
 	...
 	for (i = 0; i < svsb->opp_count; i++) {
 		opp = dev_pm_opp_find_freq_exact(svsb->opp_dev,
@@ -1719,6 +2063,81 @@ static int svs_create_svs_debug_cmds(struct svs_platform *svsp)
 	return 0;
 }
