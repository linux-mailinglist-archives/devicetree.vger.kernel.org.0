...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1C17E5EDEE0
	for <lists+devicetree@lfdr.de>; Wed, 28 Sep 2022 16:36:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233534AbiI1OgH (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 28 Sep 2022 10:36:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39410 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234407AbiI1OgH (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 28 Sep 2022 10:36:07 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 45DD37E020;
        Wed, 28 Sep 2022 07:36:05 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id C8A0461EC2;
        Wed, 28 Sep 2022 14:36:04 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id C860BC433D6;
        Wed, 28 Sep 2022 14:36:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1664375764;
        bh=cPKn8iqW1k+02SjE9ZiSAwsNMIiqT7rIEV62O8/QxV4=;
        h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
        b=
Date:   Wed, 28 Sep 2022 15:35:57 +0100
...
Subject: Re: [PATCHv3 09/14] mfd: rk8xx: add rk806 support
Message-ID: <YzRbzUPgRkY2UvcD@google.com>
References: <20220909175522.179175-1-sebastian.reichel@collabora.com>
 <20220909175522.179175-10-sebastian.reichel@collabora.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20220909175522.179175-10-sebastian.reichel@collabora.com>
...
Only RK806?  The config symbol nomenclature begs to differ.
...
This short form doesn't even match on the one in the code.

However this is documentation, so please use its proper name.
...
Please group the one-liners together at the top.
...
Spaces after the {'s and before the }'s please.
...
Is there harm in using PLATFORM_DEVID_AUTO all the time?
...
data and val are not good variable names.
...
If you don't do it now, what are the chances of this ever happening?

> +	if (count != 2) {
> +		dev_err(&spi->dev, "regmap write err!\n");

What does this have to do with Regmap?
...
That's not what this line of code does.
...
This is an odd way to format function params.
...
Instead of hard-coding the value, please use ARRAY_SIZE()
...
I used to think this was cool.  Who doesn't love the word "sentinel".

However, really is surplus to requirement.
