...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 466574722EB
	for <lists+devicetree@lfdr.de>; Mon, 13 Dec 2021 09:42:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233291AbhLMIl6 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 13 Dec 2021 03:41:58 -0500
Received: from mailgw02.mediatek.com ([210.61.82.184]:47692 "EHLO
        mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S233254AbhLMIl4 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 13 Dec 2021 03:41:56 -0500
X-UUID: 4c4fd8f507e24913baa49cb7ac5e471f-20211213
X-UUID: 4c4fd8f507e24913baa49cb7ac5e471f-20211213
Received: from mtkexhb01.mediatek.inc [(172.21.101.102)] by mailgw02.mediatek.com
        (envelope-from <yunfei.dong@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 2013560278; Mon, 13 Dec 2021 16:41:52 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by
 mtkmbs10n2.mediatek.inc (172.21.101.183) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384) id 15.2.792.3;
 Mon, 13 Dec 2021 16:41:50 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkcas11.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.0.1497.2 via Frontend Transport; Mon, 13 Dec 2021 16:41:49 +0800
...
Subject: [PATCH v13, 06/19] media: mtk-vcodec: Add to support multi hardware decode
Date:   Mon, 13 Dec 2021 16:41:28 +0800
Message-ID: <20211213084141.13363-7-yunfei.dong@mediatek.com>
...
---
Fix several comments from steve.
---
 drivers/media/platform/mtk-vcodec/Makefile    |   5 +-
 .../platform/mtk-vcodec/mtk_vcodec_dec_drv.c  | 109 +++++++----
 ...
 7 files changed, 328 insertions(+), 32 deletions(-)
...
index b7a51e96d4ba..ba4055cef441 100644
...
@@ -116,6 +173,10 @@ static int fops_vcodec_open(struct file *file)
...
+
 	...
 	if (ret) {
@@ -220,7 +281,6 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
 {
...
-	struct resource *res;
 	...
 	int ret;
@@ -249,32 +309,10 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
@@ -329,6 +367,15 @@ static int mtk_vcodec_probe(struct platform_device *pdev)
...
index 26e4d6f4ec04..f76cfd07c78d 100644
--- a/drivers/media/platform/mtk-vcodec/mtk_vcodec_dec_stateless.c
+++ b/drivers/media/platform/mtk-vcodec/mtk_vcodec_dec_stateless.c
@@ -357,8 +357,10 @@ const struct mtk_vcodec_dec_pdata mtk_vdec_8183_pdata = {
...
@@ -373,4 +375,5 @@ const struct mtk_vcodec_dec_pdata mtk_lat_sig_core_pdata = {
 	.uses_stateless_api = true,
 	.worker = mtk_vdec_worker,
 	.flush_decoder = mtk_vdec_flush_decoder,
