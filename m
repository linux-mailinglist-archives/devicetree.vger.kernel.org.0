...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 88C56392907
	for <lists+devicetree@lfdr.de>; Thu, 27 May 2021 09:55:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235181AbhE0H5S (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 27 May 2021 03:57:18 -0400
Received: from comms.puri.sm ([159.203.221.185]:53632 "EHLO comms.puri.sm"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235229AbhE0H4y (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Thu, 27 May 2021 03:56:54 -0400
Received: from localhost (localhost [127.0.0.1])
        by comms.puri.sm (Postfix) with ESMTP id CCF0DE2060;
        Thu, 27 May 2021 00:54:51 -0700 (PDT)
Received: from comms.puri.sm ([127.0.0.1])
        by localhost (comms.puri.sm [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id 74fKleT2MbEx; Thu, 27 May 2021 00:54:49 -0700 (PDT)
...
Subject: [PATCH v1 2/3] media: imx: add a driver for i.MX8MQ mipi csi rx phy and controller
Date:   Thu, 27 May 2021 09:54:06 +0200
Message-Id: <20210527075407.3180744-3-martin.kepplinger@puri.sm>
...
index 000000000000..67b99be3e804
--- /dev/null
...
+};
+
+static const char * const mipi_csi2_clk_id[] = {
+	"core",
+	"esc",
+	"pxl",
+	"clko2",
...
+};
+
+static const struct csi2_pix_format mipi_csi2_formats[] = {
...
+	unsigned int i;
+
+	for (i = 0; i < ARRAY_SIZE(mipi_csi2_formats); i++)
+		if (code == mipi_csi2_formats[i].code)
+			return &mipi_csi2_formats[i];
+	return NULL;
+}
+
+/* -----------------------------------------------------------------------------
...
+ */
+
+static inline u32 mipi_csi2_read(struct csi_state *state, u32 reg)
+{
+	return readl(state->regs + reg);
+}
+
+static inline void mipi_csi2_write(struct csi_state *state, u32 reg, u32 val)
+{
