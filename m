...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DB07C759366
	for <lists+devicetree@lfdr.de>; Wed, 19 Jul 2023 12:46:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230008AbjGSKq6 (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 19 Jul 2023 06:46:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33812 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229975AbjGSKq5 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 19 Jul 2023 06:46:57 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3895DE0;
        Wed, 19 Jul 2023 03:46:54 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id A670B613F1;
        Wed, 19 Jul 2023 10:46:53 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 60BE7C433C7;
        Wed, 19 Jul 2023 10:46:48 +0000 (UTC)
Message-ID: <a0180488-f7f5-8538-a8bb-52ae52912835@xs4all.nl>
Date:   Wed, 19 Jul 2023 12:46:46 +0200
MIME-Version: 1.0
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:102.0) Gecko/20100101
 Thunderbird/102.12.0
Subject: Re: [PATCH v15 7/8] media: i2c: add DS90UB913 driver
...
References: <20230619122212.304962-1-tomi.valkeinen@ideasonboard.com>
 <20230619122212.304962-8-tomi.valkeinen@ideasonboard.com>
From:   Hans Verkuil <hverkuil@xs4all.nl>
In-Reply-To: <20230619122212.304962-8-tomi.valkeinen@ideasonboard.com>
...
media-git/drivers/media/i2c/ds90ub913.c: In function 'ub913_log_status':
media-git/drivers/media/i2c/ds90ub913.c:483:9: warning: 'v' may be used uninitialized [-Wmaybe-uninitialized]
  483 |         ub913_write(priv, UB913_REG_GENERAL_CFG,
      |         ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  484 |                     v | UB913_REG_GENERAL_CFG_CRC_ERR_RESET);
      |                     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
media-git/drivers/media/i2c/ds90ub913.c:472:12: note: 'v' was declared here
  472 |         u8 v, v1, v2;
      |            ^
...
On 19/06/2023 14:22, Tomi Valkeinen wrote:
...
> index 60eafa1f5681..31d46e0bfbcf 100644
> --- a/drivers/media/i2c/Kconfig
> +++ b/drivers/media/i2c/Kconfig
> @@ -1630,6 +1630,19 @@ endmenu
>  
...
> index 0da487e35022..c2507520e01c 100644
