...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D2DC842C7D1
	for <lists+devicetree@lfdr.de>; Wed, 13 Oct 2021 19:40:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238083AbhJMRmg (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 13 Oct 2021 13:42:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38546 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237676AbhJMRma (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 13 Oct 2021 13:42:30 -0400
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e3e3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EFC75C061570;
        Wed, 13 Oct 2021 10:40:26 -0700 (PDT)
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (Authenticated sender: sre)
        with ESMTPSA id 82BB01F440FE
Received: by earth.universe (Postfix, from userid 1000)
        id E0CF43C0CA8; Wed, 13 Oct 2021 19:40:21 +0200 (CEST)
Date:   Wed, 13 Oct 2021 19:40:21 +0200
From:   Sebastian Reichel <sebastian.reichel@collabora.com>
To:     Chris Morgan <macroalpha82@gmail.com>
Cc:     linux-rockchip@lists.infradead.org, lee.jones@linaro.org,
        robh+dt@kernel.org, heiko@sntech.de, maccraft123mc@gmail.com,
        devicetree@vger.kernel.org, linux-pm@vger.kernel.org,
        Chris Morgan <macromorgan@hotmail.com>
Subject: Re: [PATCH v4 RESEND 3/4] power: supply: Add charger driver for
 Rockchip RK817
Message-ID: <20211013174021.z3d7vuupi76rizr4@earth.universe>
References: <20210916194208.10387-1-macroalpha82@gmail.com>
 <20210916194208.10387-4-macroalpha82@gmail.com>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha512;
        protocol="application/pgp-signature"; boundary="m2o4k2tenqqxhpg4"
Content-Disposition: inline
In-Reply-To: <20210916194208.10387-4-macroalpha82@gmail.com>
Precedence: bulk
...
> +			 */
> +			charge_now =3D charger->dsoc *
> +				     (charger->bat_charge_full_design_uah
> +				     / 1000) / 100;
> +			charge_now_adc =3D CHARGE_TO_ADC((charge_now / 1000),
> +					 charger->res_div);
> +
...
> +		val->intval =3D (charger->voltage_k * tmp) +
...
> +				 bulk_reg, 2);
> +		cur =3D get_unaligned_be16(bulk_reg);
...
> +	struct rk808 *rk808 =3D charger->rk808;
> +	u8 bulk_reg[4];
> +	u32 design_charge_mah =3D (charger->bat_charge_full_design_uah / 1000);
...
> +	 */
> +	ret =3D regmap_bulk_read(rk808->regmap, RK817_GAS_GAUGE_BAT_R1, bulk_re=
g, 3);
> +	if (ret < 0)
> +		return ret;
> +	charger->dsoc =3D get_unaligned_le24(bulk_reg);
...
> +	 */
> +
> +	ret =3D regmap_bulk_read(rk808->regmap, RK817_GAS_GAUGE_DATA3, bulk_reg=
, 3);
> +	if (ret < 0)
> +		return ret;
> +
> +	full_charge_cap =3D get_unaligned_le24(bulk_reg);
> +
...
> +		ret =3D regmap_bulk_write(rk808->regmap, RK817_GAS_GAUGE_DATA3, bulk_r=
eg, 3);
> +		if (ret < 0)
> +			return ret;
...
> +	 */
> +	boot_capacity =3D power_supply_batinfo_ocv2cap(bat_info, boot_voltage, =
20);
> +	if (boot_capacity < 0) {
...
> +	 */
> +	boot_charge =3D (boot_capacity * charger->bat_charge_full_design_uah) /=
 100;
...
> +	}
> +
> +	charger->bat_charge_full_design_uah =3D bat_info.charge_full_design_uah;
...

=7D4L
-----END PGP SIGNATURE-----
