...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2EC1145CEA1
	for <lists+devicetree@lfdr.de>; Wed, 24 Nov 2021 22:01:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1344506AbhKXVEa (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 24 Nov 2021 16:04:30 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54184 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1344412AbhKXVEX (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 24 Nov 2021 16:04:23 -0500
Received: from mail-lj1-x234.google.com (mail-lj1-x234.google.com [IPv6:2a00:1450:4864:20::234])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A58F2C06175D;
        Wed, 24 Nov 2021 13:01:07 -0800 (PST)
Received: by mail-lj1-x234.google.com with SMTP id i63so8135090lji.3;
        Wed, 24 Nov 2021 13:01:07 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=XpK/FHirOXPtNpr93nq6POkHvFcqgDl0YuV6WVUZHsk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=XpK/FHirOXPtNpr93nq6POkHvFcqgDl0YuV6WVUZHsk=;
        b=
X-Gm-Message-State: AOAM531JyqYJy723Go1s54fm5QH21RqhSbwdrbWM5eVaKv+PJEF14Q8R
        jVMKUSOr01vPW5pT1ubpgO9vJNitxdE=
X-Google-Smtp-Source: ABdhPJwTPSACdb7vK/cAy65KqbHzhWeC2mxzeNdIxrOK7NnweMVdS5nO9fX1oLd1sxnzeCvlasdOvQ==
X-Received: by 2002:a2e:a588:: with SMTP id m8mr20000351ljp.23.1637787665317;
        Wed, 24 Nov 2021 13:01:05 -0800 (PST)
Received: from localhost.localdomain (94-29-48-99.dynamic.spd-mgts.ru. [94.29.48.99])
        by smtp.gmail.com with ESMTPSA id 18sm79939ljr.17.2021.11.24.13.01.04
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 24 Nov 2021 13:01:04 -0800 (PST)
...
Subject: [PATCH v2 10/14] ARM: tegra: Add device-tree for Pegatron Chagall tablet
Date:   Wed, 24 Nov 2021 23:59:18 +0300
Message-Id: <20211124205922.11930-11-digetx@gmail.com>
...
index bf5a22351b3d..4dc0722c28f5 100644
--- a/arch/arm/boot/dts/tegra20-asus-tf101.dts
+++ b/arch/arm/boot/dts/tegra20-asus-tf101.dts
@@ -397,7 +397,7 @@ uartc: serial@70006200 {
...
@@ -783,6 +783,7 @@ sdmmc1: mmc@c8000000 {
...
index a2e1a9e89ea2..0ea14728f90e 100644
--- a/arch/arm/boot/dts/tegra30-asus-transformer-common.dtsi
+++ b/arch/arm/boot/dts/tegra30-asus-transformer-common.dtsi
@@ -1172,9 +1172,9 @@ pmic: pmic@2d {
...
@@ -1473,7 +1473,7 @@ sdmmc3: mmc@78000400 {
...
index 000000000000..979dd2401275
--- /dev/null
