...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 13DE865C7E0
	for <lists+devicetree@lfdr.de>; Tue,  3 Jan 2023 21:11:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233096AbjACULr (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 3 Jan 2023 15:11:47 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46996 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230488AbjACULq (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 3 Jan 2023 15:11:46 -0500
Received: from mga18.intel.com (mga18.intel.com [134.134.136.126])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 09DE1FED;
        Tue,  3 Jan 2023 12:11:41 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1672776702; x=1704312702;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=LSiRuu5ndRs39BVv/swP0l5SobPYJkyz3GkfQ3/V2Ps=;
  b=DVvMXc6BmfJJ/qIRvjqB4GsBijRoHiSrx8toKIB1W6Wzb7+0dXXUO4an
   BJWhCwekKqXeWJRQfM7Y2sSQmHCglBQdZmxhmP+UlPDKM3ecDofGvetmr
   JjufcgWBTFvvGmYfr3XDlwXDOIO3TECTAIhvc2xr4qW2SKbnOTEn17vw6
   O6ukwwvmlIemSncqr1JVuJ7R7LCDh1KubgnHf0tUYkf+DJylUSuUzhkld
   EQ5tI19ILSvSlva8Gb+SWbsAZrXabU6ROaCDSVIgEsF59EgvvbUyrD+1p
   /nkfQcOpgtTapTjfjKCsOiiR/HQDTMUOvEzO1LY2QYCxdTEB0x7mw75A/
   Q==;
X-IronPort-AV: E=McAfee;i="6500,9779,10579"; a="305251315"
X-IronPort-AV: E=Sophos;i="5.96,297,1665471600"; 
   d="scan'208";a="305251315"
Received: from orsmga002.jf.intel.com ([10.7.209.21])
  by orsmga106.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 03 Jan 2023 12:11:38 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=McAfee;i="6500,9779,10579"; a="654915049"
X-IronPort-AV: E=Sophos;i="5.96,297,1665471600"; 
   d="scan'208";a="654915049"
Received: from lkp-server01.sh.intel.com (HELO b5d47979f3ad) ([10.239.97.150])
  by orsmga002.jf.intel.com with ESMTP; 03 Jan 2023 12:11:32 -0800
Received: from kbuild by b5d47979f3ad with local (Exim 4.96)
        (envelope-from <lkp@intel.com>)
        id 1pCndD-000Sgv-2e;
        Tue, 03 Jan 2023 20:11:31 +0000
Date:   Wed, 4 Jan 2023 04:11:26 +0800
...
Message-ID: <202301040430.JnMdUz9S-lkp@intel.com>
References: <20230103170058.810597-11-benjamin.gaignard@collabora.com>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="8ulq2l68vZG000SL"
...
[also build test WARNING on rockchip/for-next linus/master v6.2-rc2 next-20221226]
...
reproduce (this is a W=1 build):
        ...
        # https://github.com/intel-lab-lkp/linux/commit/9223ba771533395ef28d21c8b4c944dde145d820
        ...
        git checkout 9223ba771533395ef28d21c8b4c944dde145d820
...
All warnings (new ones prefixed by >>):
   ...
   drivers/media/platform/verisilicon/rockchip_vpu981_hw_av1_dec.c:229:6: warning: no previous prototype for 'rockchip_vpu981_av1_dec_tiles_free' [-Wmissing-prototypes]
     229 | void rockchip_vpu981_av1_dec_tiles_free(struct hantro_ctx *ctx)
         |      ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   drivers/media/platform/verisilicon/rockchip_vpu981_hw_av1_dec.c:1141:6: warning: no previous prototype for 'rockchip_vpu981_av1_dec_done' [-Wmissing-prototypes]
    1141 | void rockchip_vpu981_av1_dec_done(struct hantro_ctx *ctx)
         |      ^~~~~~~~~~~~~~~~~~~~~~~~~~~~
   drivers/media/platform/verisilicon/rockchip_vpu981_hw_av1_dec.c:1933:5: warning: no previous prototype for 'rockchip_vpu981_av1_dec_run' [-Wmissing-prototypes]
    1933 | int rockchip_vpu981_av1_dec_run(struct hantro_ctx *ctx)
         |     ^~~~~~~~~~~~~~~~~~~~~~~~~~~
   drivers/media/platform/verisilicon/rockchip_vpu981_hw_av1_dec.c: In function 'rockchip_vpu981_av1_dec_set_tile_info':
>> drivers/media/platform/verisilicon/rockchip_vpu981_hw_av1_dec.c:616:1: warning: the frame size of 1076 bytes is larger than 1024 bytes [-Wframe-larger-than=]
     616 | }
         | ^


vim +616 drivers/media/platform/verisilicon/rockchip_vpu981_hw_av1_dec.c

   546	
   547	static void rockchip_vpu981_av1_dec_set_tile_info(struct hantro_ctx *ctx)
   548	{
   549		struct hantro_av1_dec_hw_ctx *av1_dec = &ctx->av1_dec;
   550		struct hantro_av1_dec_ctrls *ctrls = &av1_dec->ctrls;
   551		struct v4l2_av1_tile_info tile_info = ctrls->frame->tile_info;
   552		const struct v4l2_ctrl_av1_tile_group_entry *group_entry =
   553		    ctrls->tile_group_entry;
   554		int context_update_y =
   555		    tile_info.context_update_tile_id / tile_info.tile_cols;
   556		int context_update_x =
   557		    tile_info.context_update_tile_id % tile_info.tile_cols;
   558		int context_update_tile_id =
   559		    context_update_x * tile_info.tile_rows + context_update_y;
   560		uint8_t *dst = av1_dec->tile_info.cpu;
   561		struct hantro_dev *vpu = ctx->dev;
   562		int tile0, tile1;
   563	
   564		memset(dst, 0, av1_dec->tile_info.size);
   565	
   566		for (tile0 = 0; tile0 < tile_info.tile_cols; tile0++) {
   567			for (tile1 = 0; tile1 < tile_info.tile_rows; tile1++) {
   568				int tile_id = tile1 * tile_info.tile_cols + tile0;
   569				uint32_t start, end;
   570				uint32_t y0 =
   571				    tile_info.height_in_sbs_minus_1[tile1] + 1;
   572				uint32_t x0 = tile_info.width_in_sbs_minus_1[tile0] + 1;
   573	
   574				// tile size in SB units (width,height)
   575				*dst++ = x0;
   576				*dst++ = 0;
   577				*dst++ = 0;
   578				*dst++ = 0;
   ...
   582				*dst++ = 0;
   583	
   584				// tile start position
   585				start = group_entry[tile_id].tile_offset - group_entry[0].tile_offset;
   586				*dst++ = start & 255;
   587				*dst++ = (start >> 8) & 255;
   588				*dst++ = (start >> 16) & 255;
   589				*dst++ = (start >> 24) & 255;
   590	
   591				// # of bytes in tile data
   ...
   598		}
   599	
   600		hantro_reg_write(vpu, &av1_multicore_expect_context_update,
   601				 !!(context_update_x == 0));
   602		hantro_reg_write(vpu, &av1_tile_enable, !!((tile_info.tile_cols > 1)
   603							   || (tile_info.tile_rows > 1)));
   604		hantro_reg_write(vpu, &av1_num_tile_cols_8k, tile_info.tile_cols);
   605		hantro_reg_write(vpu, &av1_num_tile_rows_8k, tile_info.tile_rows);
   606		hantro_reg_write(vpu, &av1_context_update_tile_id,
   607				 context_update_tile_id);
   608		hantro_reg_write(vpu, &av1_tile_transpose, 1);
   609		if (context_update_tile_id) {
   610			hantro_reg_write(vpu, &av1_dec_tile_size_mag,
   611					 tile_info.tile_size_bytes);
   612		} else
   613			hantro_reg_write(vpu, &av1_dec_tile_size_mag, 3);
   614	
   615		hantro_write_addr(vpu, AV1_TILE_BASE, av1_dec->tile_info.dma);
 > 616	}
   617	
