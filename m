...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 12D901B1A7E
	for <lists+devicetree@lfdr.de>; Tue, 21 Apr 2020 02:12:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727070AbgDUALa (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 20 Apr 2020 20:11:30 -0400
Received: from hqnvemgate25.nvidia.com ([216.228.121.64]:3533 "EHLO
        hqnvemgate25.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726817AbgDUAL1 (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 20 Apr 2020 20:11:27 -0400
Received: from hqpgpgate102.nvidia.com (Not Verified[216.228.121.13]) by hqnvemgate25.nvidia.com (using TLS: TLSv1.2, DES-CBC3-SHA)
        id <B5e9e39ef0001>; Mon, 20 Apr 2020 17:10:23 -0700
Received: from hqmail.nvidia.com ([172.20.161.6])
  by hqpgpgate102.nvidia.com (PGP Universal service);
  Mon, 20 Apr 2020 17:11:25 -0700
X-PGP-Universal: processed;
        by hqpgpgate102.nvidia.com on Mon, 20 Apr 2020 17:11:25 -0700
Received: from HQMAIL111.nvidia.com (172.20.187.18) by HQMAIL101.nvidia.com
 (172.20.187.10) with Microsoft SMTP Server (TLS) id 15.0.1473.3; Tue, 21 Apr
 2020 00:11:24 +0000
Received: from rnnvemgw01.nvidia.com (10.128.109.123) by HQMAIL111.nvidia.com
 (172.20.187.18) with Microsoft SMTP Server (TLS) id 15.0.1473.3 via Frontend
 Transport; Tue, 21 Apr 2020 00:11:24 +0000
Received: from skomatineni-linux.nvidia.com (Not Verified[10.2.165.49]) by rnnvemgw01.nvidia.com with Trustwave SEG (v7,5,8,10121)
        id <B5e9e3a2a0002>; Mon, 20 Apr 2020 17:11:23 -0700
...
Subject: [RFC PATCH v8 6/9] media: tegra: Add Tegra210 Video input driver
Date:   Mon, 20 Apr 2020 17:11:11 -0700
Message-ID: <1587427874-3291-7-git-send-email-skomatineni@nvidia.com>
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nvidia.com; s=n1;
        t=1587427823; bh=GjYVjTfAAU3n+2sYDuGy/SseMjhpmM9jCYXtbaIgkf4=;
        h=X-PGP-Universal:From:To:CC:Subject:Date:Message-ID:X-Mailer:
         In-Reply-To:References:X-NVConfidentiality:MIME-Version:
         Content-Type;
        b=
...
+}
+
+void tegra_v4l2_nodes_cleanup_tpg(struct tegra_vi *vi)
+{
+	struct tegra_video_device *vid = dev_get_drvdata(vi->client.host);
...
+}
+
+int tegra_v4l2_nodes_setup_tpg(struct tegra_vi *vi)
+{
+	struct tegra_video_device *vid = dev_get_drvdata(vi->client.host);
+	struct tegra_csi *csi = vid->csi;
...
+
+cleanup:
+	tegra_v4l2_nodes_cleanup_tpg(vi);
+	tegra_channels_cleanup(vi);
+	return ret;
+}
+
...
+	 */
+	ret = tegra_v4l2_nodes_setup_tpg(vid->vi);
+	if (ret < 0) {
+		dev_err(&dev->dev,
...
+
+	tegra_v4l2_nodes_cleanup_tpg(vid->vi);
+
+	host1x_device_exit(dev);
+
