...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D13BDB82BD
	for <lists+devicetree@lfdr.de>; Thu, 19 Sep 2019 22:41:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2404648AbfISUje (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 19 Sep 2019 16:39:34 -0400
Received: from lelv0143.ext.ti.com ([198.47.23.248]:47468 "EHLO
        lelv0143.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2392743AbfISUjd (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Thu, 19 Sep 2019 16:39:33 -0400
Received: from fllv0035.itg.ti.com ([10.64.41.0])
        by lelv0143.ext.ti.com (8.15.2/8.15.2) with ESMTP id x8JKdVUl117335;
        Thu, 19 Sep 2019 15:39:31 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1568925571;
        bh=qPjKjfJSqcwuRSyS4pZlEcnR3nwDf14lR4R6XEpMG4I=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=gH72dBx4s2UCOIWrBJlAEY3SoPRo5gYguWeDHxzFRpHWsnfc/uv+k7g/KgoQwYI6r
         UN+4+JiNmSThJMXsM+mI+9xVJdPgLpViP0Xne+U4UiRhSBLIEbIp/P+0Zh1JAwJsIk
         kJlAWetzOyz9jDtsH2e4rl7fa1+syZ1xoGb68dtQ=
Received: from DFLE108.ent.ti.com (dfle108.ent.ti.com [10.64.6.29])
        by fllv0035.itg.ti.com (8.15.2/8.15.2) with ESMTP id x8JKdVur122908;
        Thu, 19 Sep 2019 15:39:31 -0500
Received: from DFLE113.ent.ti.com (10.64.6.34) by DFLE108.ent.ti.com
 (10.64.6.29) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1713.5; Thu, 19
 Sep 2019 15:39:27 -0500
Received: from lelv0326.itg.ti.com (10.180.67.84) by DFLE113.ent.ti.com
 (10.64.6.34) with Microsoft SMTP Server (version=TLS1_2,
 cipher=TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256_P256) id 15.1.1713.5 via
 Frontend Transport; Thu, 19 Sep 2019 15:39:27 -0500
Received: from uda0869644b.dal.design.ti.com (ileax41-snat.itg.ti.com [10.172.224.153])
        by lelv0326.itg.ti.com (8.15.2/8.15.2) with ESMTP id x8JKdKIe014276;
        Thu, 19 Sep 2019 15:39:31 -0500
...
Subject: [Patch v2 11/13] media: am437x-vpfe: TRY_FMT ioctl is not really trying anything
Date:   Thu, 19 Sep 2019 15:41:23 -0500
Message-ID: <20190919204125.15254-12-bparrot@ti.com>
...
index ad46e037fe89..47404d799029 100644
--- a/drivers/media/platform/am437x/am437x-vpfe.c
+++ b/drivers/media/platform/am437x/am437x-vpfe.c
@@ -143,9 +143,11 @@ static struct vpfe_fmt formats[VPFE_MAX_ACTIVE_FMT] = {
 	},
 };
...
+				 struct v4l2_format *f);
 ...
 static struct vpfe_fmt *find_format_by_code(struct vpfe_device *vpfe,
 					    unsigned int code)
@@ -177,62 +179,16 @@ static struct vpfe_fmt *find_format_by_pix(struct vpfe_device *vpfe,
 	return NULL;
 }
...
@@ -967,6 +923,7 @@ static int vpfe_get_ccdc_image_format(struct vpfe_device *vpfe,
...
@@ -979,7 +936,8 @@ static int vpfe_config_ccdc_image_format(struct vpfe_device *vpfe)
 	}
...
@@ -1023,7 +981,8 @@ static int vpfe_config_ccdc_image_format(struct vpfe_device *vpfe)
...
@@ -1045,26 +1004,29 @@ static int vpfe_config_image_format(struct vpfe_device *vpfe,
 		return -EINVAL;
 	}
...
@@ -1342,81 +1304,74 @@ static int vpfe_querycap(struct file *file, void  *priv,
 }
...
+			       f->fmt.pix.height;
+
+	vpfe_dbg(3, vpfe, "%s: fourcc: %4pE size: %dx%d bpl:%d img_size:%d\n",
...
@@ -1456,20 +1411,70 @@ static int vpfe_enum_fmt(struct file *file, void  *priv,
 }
...
@@ -1478,25 +1483,32 @@ static int vpfe_s_fmt(struct file *file, void *priv,
 		return -EBUSY;
 	}
...
@@ -1511,43 +1523,28 @@ static int vpfe_enum_size(struct file *file, void  *priv,
 {
 	struct vpfe_device *vpfe = video_drvdata(file);
 	struct v4l2_subdev_frame_size_enum fse;
-	struct vpfe_subdev_info *sdinfo;
...
@@ -2036,6 +2033,7 @@ vpfe_s_selection(struct file *file, void *fh, struct v4l2_selection *s)
 	struct vpfe_device *vpfe = video_drvdata(file);
...
@@ -2061,10 +2059,12 @@ vpfe_s_selection(struct file *file, void *fh, struct v4l2_selection *s)
...
index 79a6505c083d..aa5ddaec774c 100644
--- a/drivers/media/platform/am437x/am437x-vpfe.h
+++ b/drivers/media/platform/am437x/am437x-vpfe.h
@@ -283,8 +283,8 @@ struct vpfe_device {
