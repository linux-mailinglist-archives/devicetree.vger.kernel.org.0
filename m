...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E2F5D4A74DB
	for <lists+devicetree@lfdr.de>; Wed,  2 Feb 2022 16:44:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238528AbiBBPoN (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 2 Feb 2022 10:44:13 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59292 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235186AbiBBPoM (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 2 Feb 2022 10:44:12 -0500
Received: from mail-yb1-xb2a.google.com (mail-yb1-xb2a.google.com [IPv6:2607:f8b0:4864:20::b2a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B42A9C06173B
        for <devicetree@vger.kernel.org>; Wed,  2 Feb 2022 07:44:12 -0800 (PST)
Received: by mail-yb1-xb2a.google.com with SMTP id m6so62232404ybc.9
        for <devicetree@vger.kernel.org>; Wed, 02 Feb 2022 07:44:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=mT+LEjkuf37tYKLGK7ZG+F7jNEzW0AdN2LBLGp/1ZZw=;
        b=JG3v+GIuY7LxTX5J4blUsu4rLkXyE60SKGKWN+I+x/KXPGVht/jQLdQUPrJVUmxm+L
         gV9MGPzgfryXdEzVgTgOuIzBQrdUWM1l6uz41ScrH4cIXJN76Bx8w2qzdzraxNpTJMan
         hlnL3JxTf4FkgvQT4pl9tT6AiZno/2BfpIhmk=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112;
        h=x-gm-message-state:mime-version:references:in-reply-to:from:date
         :message-id:subject:to:cc;
        bh=mT+LEjkuf37tYKLGK7ZG+F7jNEzW0AdN2LBLGp/1ZZw=;
        b=
X-Gm-Message-State: AOAM533jviDJCs379M7oDzBP8ocrScf7d1nYugjHUiOtQA//O40pjYpl
        3w+tjV2rlGNCoixqXzqa30fwa8/l1mBWynPKhmRG3w==
X-Google-Smtp-Source: ABdhPJyZJ0iAUUyOuAiDB9cytUKhd0pvypw7HaBqUa5xrO89JshifuOC5GiiMy4etSTJLZWRE2N8ZdwpYVMFdvTby/w=
X-Received: by 2002:a25:6b4e:: with SMTP id o14mr30872113ybm.485.1643816651439;
 Wed, 02 Feb 2022 07:44:11 -0800 (PST)
MIME-Version: 1.0
References: <20220121060120.10683-1-guodong.liu@mediatek.com> <20220121060120.10683-2-guodong.liu@mediatek.com>
In-Reply-To: <20220121060120.10683-2-guodong.liu@mediatek.com>
From:   Chen-Yu Tsai <wenst@chromium.org>
Date:   Wed, 2 Feb 2022 23:44:00 +0800
Message-ID: <CAGXv+5EDcRwgg5swe+D40+K608_1PyfprwXdPmSyd0VrTCVpXw@mail.gmail.com>
Subject: Re: [PATCH v2 1/2] dt-bindings: pinctrl: mt8186: add pinctrl file and
 binding document
...
On Fri, Jan 21, 2022 at 2:09 PM Guodong Liu <guodong.liu@mediatek.com> wrote:
>
...
I have some thoughts about moving this to the "drive-strength-microamps"
pin config property, but I've not yet fully thought out how it's supposed
to be combined with "drive-strength".

My original design was to have the presence of "drive-strength-microamps"
...
As far as I can tell, this is based on the MT8195 binding, which unfortunately
