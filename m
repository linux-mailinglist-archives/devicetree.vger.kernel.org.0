...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 29D8F65606B
	for <lists+devicetree@lfdr.de>; Mon, 26 Dec 2022 07:31:26 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231704AbiLZGbY (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 26 Dec 2022 01:31:24 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42580 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231668AbiLZGaf (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 26 Dec 2022 01:30:35 -0500
Received: from mout.perfora.net (mout.perfora.net [74.208.4.194])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7C0E5271C;
        Sun, 25 Dec 2022 22:29:42 -0800 (PST)
Received: from toolbox.int.toradex.com ([213.55.224.88]) by mrelay.perfora.net
 (mreueus003 [74.208.5.2]) with ESMTPSA (Nemesis) id 0MhBR9-1pVSzk3mJF-00MHpP;
 Mon, 26 Dec 2022 07:29:03 +0100
...
Subject: [PATCH v1 5/5] arm64: dts: freescale: add initial support for apalis imx8 aka quadmax
Date:   Mon, 26 Dec 2022 07:28:23 +0100
Message-Id: <20221226062824.53113-6-marcel@ziswiler.com>
X-Mailer: git-send-email 2.35.1
In-Reply-To: <20221226062824.53113-1-marcel@ziswiler.com>
References: <20221226062824.53113-1-marcel@ziswiler.com>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Provags-ID: V03:K1:yo8SNV/mBv3FVTkS1WltJnfeaTGg/mKCAXYEfpd+U072HoiVFOB
 +Du0YVzgC3XPb5HMY5wilvdYDgkNsKY4TU/3YWpLCw5GTZXWoc+bktEe6QoRwwurdaXyo5u
 Qb9mj3llgyCOT2GQUYqsTle+NvhnrEnvkrUtezp0OgHBcfbAwBDTnSduLjfPBUZRVtPipuf
 CCAlUnTE3ZaWPjhoy6vtQ==
UI-OutboundReport: notjunk:1;M01:P0:d7ja++dN6sM=;nrsQUtFsL2yWE0wXHO4Yi0Q6xxL
 
...
The carrier board device trees include the module's device tree and
enable the supported peripherals of the carrier board.
...
index 000000000000..010d17fc7309
--- /dev/null
...
new file mode 100644
index 000000000000..13e745ce4ce0
--- /dev/null
...
new file mode 100644
index 000000000000..61d83f826c3f
--- /dev/null
...
new file mode 100644
index 000000000000..0b6ff8c893e1
--- /dev/null
...
new file mode 100644
index 000000000000..d6a9701efa23
--- /dev/null
...
new file mode 100644
index 000000000000..c2ba5e89bced
--- /dev/null
...
+};
+
+/* TODO: Delete PCIe Wi-Fi Reference Clock */
+
+&ethphy0 {
