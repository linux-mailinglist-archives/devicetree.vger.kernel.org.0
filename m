...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 493B541A1A4
	for <lists+devicetree@lfdr.de>; Mon, 27 Sep 2021 23:58:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237595AbhI0WAT (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Mon, 27 Sep 2021 18:00:19 -0400
Received: from m-r1.th.seeweb.it ([5.144.164.170]:39547 "EHLO
        m-r1.th.seeweb.it" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237546AbhI0WAP (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Mon, 27 Sep 2021 18:00:15 -0400
Received: from Marijn-Arch-PC.localdomain (94-209-165-62.cable.dynamic.v4.ziggo.nl [94.209.165.62])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
        (No client certificate requested)
        by m-r1.th.seeweb.it (Postfix) with ESMTPSA id 7D3FE1F96E;
        Mon, 27 Sep 2021 23:58:33 +0200 (CEST)
...
Subject: [PATCH v4 2/2] clk: qcom: Add MSM8976/56 Global Clock Controller (GCC) driver
Date:   Mon, 27 Sep 2021 23:58:28 +0200
Message-Id: <20210927215828.52357-3-marijn.suijten@somainline.org>
...
---
 ...
 3 files changed, 4163 insertions(+)
 create mode 100644 drivers/clk/qcom/gcc-msm8976.c

diff --git a/drivers/clk/qcom/Kconfig b/drivers/clk/qcom/Kconfig
index 62e00e15495c..afc282e17ff1 100644
--- a/drivers/clk/qcom/Kconfig
+++ b/drivers/clk/qcom/Kconfig
@@ -257,6 +257,14 @@ config MSM_MMCC_8974
...
index c2a1cafb31bc..61ed7090f0c7 100644
--- a/drivers/clk/qcom/Makefile
+++ b/drivers/clk/qcom/Makefile
@@ -35,6 +35,7 @@ obj-$(CONFIG_MSM_GCC_8916) += gcc-msm8916.o
...
index 000000000000..d7ea9b20a859
--- /dev/null
