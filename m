...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 36A47734030
	for <lists+devicetree@lfdr.de>; Sat, 17 Jun 2023 12:35:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1346272AbjFQKdX (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Sat, 17 Jun 2023 06:33:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55524 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1346218AbjFQKdS (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Sat, 17 Jun 2023 06:33:18 -0400
Received: from mailgw01.mediatek.com (unknown [60.244.123.138])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F3E612139;
        Sat, 17 Jun 2023 03:33:12 -0700 (PDT)
X-UUID: 59121a7e0cfa11ee9cb5633481061a41-20230617
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=mediatek.com; s=dk;
        h=Content-Type:Content-Transfer-Encoding:MIME-Version:References:In-Reply-To:Message-ID:Date:Subject:CC:To:From; bh=3dpiUfjFvLMuT4R1et+ZyZBfPF//cY96oyNDhjb663U=;
        b=ULJ4Mq4WmBd+jLubw9oEYtcL7M3SHO0wFxoHsBFAk3MuHHt98brfPJvn89z9mNL1ajBmba8O00Y0yCMV69jJTDr7ankX7MU1yMa0szvwneyb+6VPsMN+QaytxRNmNTfaSf2F8TCIUi+SRzp5GdoThy4hAS4KG63SSu+lZwURON8=;
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.26,REQID:e7d88048-9cdc-4c84-a5b7-6b5c6c18002f,IP:0,U
        RL:0,TC:0,Content:-25,EDM:0,RT:0,SF:0,FILE:0,BULK:0,RULE:Release_Ham,ACTIO
        N:release,TS:-25
X-CID-META: VersionHash:cb9a4e1,CLOUDID:4d95bc3e-de1e-4348-bc35-c96f92f1dcbb,B
...
Received: from mtkmbs11n1.mediatek.inc [(172.21.101.185)] by mailgw01.mediatek.com
        ...
        with ESMTP id 1198860342; Sat, 17 Jun 2023 18:33:07 +0800
Received: from mtkmbs13n2.mediatek.inc (172.21.101.108) by
 mtkmbs13n1.mediatek.inc (172.21.101.193) with Microsoft SMTP Server
 (version=TLS1_2, cipher=TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384) id
 15.2.1118.26; Sat, 17 Jun 2023 18:33:05 +0800
Received: from mhfsdcap04.gcn.mediatek.inc (10.17.3.154) by
 mtkmbs13n2.mediatek.inc (172.21.101.73) with Microsoft SMTP Server id
 15.2.1118.26 via Frontend Transport; Sat, 17 Jun 2023 18:33:04 +0800
...
Subject: [PATCH v3,08/11] mediatek: vcodec: separate struct mtk_vcodec_dev
Date:   Sat, 17 Jun 2023 18:32:52 +0800
Message-ID: <20230617103255.20239-9-yunfei.dong@mediatek.com>
...
index 3445fe1c738c..0b51560b6630 100644
...
index b6a15f7fbee3..1452491e3b74 100644
...
@@ -77,7 +76,7 @@ static irqreturn_t mtk_vcodec_dec_irq_handler(int irq, void *priv)
 	return IRQ_HANDLED;
 }
...
+static int mtk_vcodec_get_reg_bases(struct mtk_vcodec_dec_dev *dev)
 {
 	...
 	int reg_num, i;
@@ -101,7 +100,7 @@ static int mtk_vcodec_get_reg_bases(struct mtk_vcodec_dev *dev)
 	return 0;
 }
...
+static int mtk_vcodec_init_dec_resources(struct mtk_vcodec_dec_dev *dev)
 {
 	struct platform_device *pdev = dev->plat_dev;
 	int ret;
@@ -138,7 +137,7 @@ static int mtk_vcodec_init_dec_resources(struct mtk_vcodec_dev *dev)
...
@@ -236,7 +235,7 @@ static int fops_vcodec_open(struct file *file)
...
@@ -273,7 +272,7 @@ static const struct v4l2_file_operations mtk_vcodec_fops = {
...
@@ -480,7 +479,7 @@ MODULE_DEVICE_TABLE(of, mtk_vcodec_match);
...
@@ -496,7 +495,7 @@ static void mtk_vcodec_dec_remove(struct platform_device *pdev)
 	if (dev->vfd_dec)
...
index 189bb36571ec..5165bf8f8892 100644
...
index e92bae40c767..4e27f8657bd6 100644
...
index 08cefd87c889..20b0b854c9fc 100644
...
index e543690b06d1..36b5bf49198d 100644
...
index b86d939ee26f..37601826b05d 100644
...
@@ -240,7 +240,7 @@ static void vdec_msg_queue_core_work(struct work_struct *work)
