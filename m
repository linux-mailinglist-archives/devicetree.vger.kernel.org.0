...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 427AA3B1705
	for <lists+devicetree@lfdr.de>; Wed, 23 Jun 2021 11:37:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230152AbhFWJji (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 23 Jun 2021 05:39:38 -0400
Received: from mailgw01.mediatek.com ([60.244.123.138]:56949 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S229833AbhFWJji (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 23 Jun 2021 05:39:38 -0400
X-UUID: 1e649ba65bcc4d5999da194ca92d7421-20210623
X-UUID: 1e649ba65bcc4d5999da194ca92d7421-20210623
Received: from mtkcas07.mediatek.inc [(172.21.101.84)] by mailgw01.mediatek.com
        (envelope-from <zhiyong.tao@mediatek.com>)
        (Generic MTA with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 1181853392; Wed, 23 Jun 2021 17:37:18 +0800
Received: from mtkcas11.mediatek.inc (172.21.101.40) by
 mtkmbs05n1.mediatek.inc (172.21.101.15) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Wed, 23 Jun 2021 17:37:16 +0800
Received: from localhost.localdomain (10.17.3.153) by mtkcas11.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Wed, 23 Jun 2021 17:37:15 +0800
...
Subject: [PATCH v8 2/2] pinctrl: mediatek: add rsel setting on MT8195
Date:   Wed, 23 Jun 2021 17:37:10 +0800
Message-ID: <20210623093710.5340-3-zhiyong.tao@mediatek.com>
...
index 5b3b048725cc..855051495735 100644
...
+		r1 = 0;
 		...
 		err = -EINVAL;
 		goto out;
@@ -661,6 +664,29 @@ static int mtk_pinconf_bias_set_pupd_r1_r0(struct mtk_pinctrl *hw,
 	return err;
 }
...
+	return err;
+}
+EXPORT_SYMBOL_GPL(mtk_pinconf_bias_set_rsel);
+
 static int mtk_pinconf_bias_get_pu_pd(struct mtk_pinctrl *hw,
 				const struct mtk_pin_desc *desc,
 				u32 *pullup, u32 *enable)
@@ -742,44 +768,117 @@ static int mtk_pinconf_bias_get_pupd_r1_r0(struct mtk_pinctrl *hw,
 	return err;
 }
...
index 85db2e4377f0..7f467c46a8c9 100644
...
+	/* Case for: R1R0 */
 	if (pullen == MTK_PUPD_SET_R1R0_00) {
 		pullen = 0;
 		r1 = 0;
@@ -607,10 +609,15 @@ ssize_t mtk_pctrl_show_one_pin(struct mtk_pinctrl *hw,
 		pullen = 1;
 		r1 = 1;
 		r0 = 1;
...
+
+	/* Case for: RSEL */
+	if (pullen >= MTK_PULL_SET_RSEL_000 && pullen <= MTK_PULL_SET_RSEL_111) {
...
+	len += scnprintf(buf + len, buf_len - len,
 			...
 			gpio,
 			pinmux,
@@ -624,10 +631,12 @@ ssize_t mtk_pctrl_show_one_pin(struct mtk_pinctrl *hw,
 			pullup);
