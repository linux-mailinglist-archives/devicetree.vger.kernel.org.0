...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 60C8F27F1D7
	for <lists+devicetree@lfdr.de>; Wed, 30 Sep 2020 20:58:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730056AbgI3S4X (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Wed, 30 Sep 2020 14:56:23 -0400
Received: from mail.baikalelectronics.com ([87.245.175.226]:41904 "EHLO
        mail.baikalelectronics.ru" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730349AbgI3S4M (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Wed, 30 Sep 2020 14:56:12 -0400
Received: from localhost (unknown [127.0.0.1])
        by mail.baikalelectronics.ru (Postfix) with ESMTP id 5648B8000853;
        Wed, 30 Sep 2020 18:56:03 +0000 (UTC)
X-Virus-Scanned: amavisd-new at baikalelectronics.ru
Received: from mail.baikalelectronics.ru ([127.0.0.1])
        by localhost (mail.baikalelectronics.ru [127.0.0.1]) (amavisd-new, port 10024)
        with ESMTP id cSJFFE6kiVyj; Wed, 30 Sep 2020 21:56:02 +0300 (MSK)
...
Subject: [PATCH v2 17/21] spi: dw: Add memory operations support
Date:   Wed, 30 Sep 2020 21:55:41 +0300
Message-ID: <20200930185545.29959-18-Sergey.Semin@baikalelectronics.ru>
...
+#include <linux/string.h>
 ...
 #include "spi-dw.h"
@@ -422,6 +425,300 @@ static void dw_spi_handle_err(struct spi_controller *master,
 	spi_reset_chip(dws);
 }
...
+
 ...
 {
@@ -522,6 +819,8 @@ int dw_spi_add_host(struct device *dev, struct dw_spi *dws)
...
@@ -535,6 +834,7 @@ int dw_spi_add_host(struct device *dev, struct dw_spi *dws)
