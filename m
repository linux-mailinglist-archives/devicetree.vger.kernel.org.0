...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9182334942B
	for <lists+devicetree@lfdr.de>; Thu, 25 Mar 2021 15:34:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231499AbhCYOdf (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Thu, 25 Mar 2021 10:33:35 -0400
Received: from foss.arm.com ([217.140.110.172]:51044 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231504AbhCYOdM (ORCPT <rfc822;devicetree@vger.kernel.org>);
        Thu, 25 Mar 2021 10:33:12 -0400
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 680F1143D;
        Thu, 25 Mar 2021 07:33:12 -0700 (PDT)
Received: from usa.arm.com (e103737-lin.cambridge.arm.com [10.1.197.49])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPA id EE7EC3F792;
        Thu, 25 Mar 2021 07:33:10 -0700 (PDT)
...
Subject: [PATCH v5 4/7] firmware: arm_ffa: Add initial Arm FFA driver support
Date:   Thu, 25 Mar 2021 14:32:52 +0000
Message-Id: <20210325143255.1532452-5-sudeep.holla@arm.com>
...
---
 ...
 drivers/firmware/arm_ffa/driver.c | 300 ++++++++++++++++++++++++++++++
...
new file mode 100644
index 000000000000..6d5094ecc0f6
--- /dev/null
...
+	ffa_res_t ret;
+
+	ret = invoke_ffa_fn(FFA_RXTX_UNMAP, PACK_TARGET_INFO(vm_id, 0),
+			    0, 0, 0, 0, 0, 0);
+
+	if (ret.a0 == FFA_ERROR)
+		return ffa_to_linux_errno((int)ret.a2);
