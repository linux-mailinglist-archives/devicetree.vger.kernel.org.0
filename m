...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 643C45464DD
	for <lists+devicetree@lfdr.de>; Fri, 10 Jun 2022 12:58:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1346475AbiFJK6O (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Fri, 10 Jun 2022 06:58:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35528 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345260AbiFJK5s (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Fri, 10 Jun 2022 06:57:48 -0400
Received: from mailgw02.mediatek.com (unknown [210.61.82.184])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 79D9221F9D7;
        Fri, 10 Jun 2022 03:55:32 -0700 (PDT)
X-UUID: 79c82bdc629440a48a58b9f580227079-20220610
X-CID-P-RULE: Release_Ham
X-CID-O-INFO: VERSION:1.1.5,REQID:db9cd72d-3021-4233-83f6-77e1ac703b6c,OB:0,LO
        B:0,IP:0,URL:5,TC:0,Content:-5,EDM:0,RT:0,SF:0,FILE:0,RULE:Release_Ham,ACT
        ION:release,TS:0
X-CID-META: VersionHash:2a19b09,CLOUDID:712ff27e-c8dc-403a-96e8-6237210dceee,C
...
Received: from mtkexhb02.mediatek.inc [(172.21.101.103)] by mailgw02.mediatek.com
        ...
        with ESMTP id 2067258328; Fri, 10 Jun 2022 18:55:25 +0800
...
Subject: [PATCH v11 05/10] drm/mediatek: Add MT8195 Embedded DisplayPort driver
Date:   Fri, 10 Jun 2022 18:55:17 +0800
Message-ID: <20220610105522.13449-6-rex-bc.chen@mediatek.com>
...
X-Spam-Status: No, score=-0.1 required=5.0 tests=BAYES_00,RDNS_NONE,
        ...
        VFY_ACCT_NORDNS autolearn=no autolearn_force=no version=3.4.6
...
---
 ...
 drivers/gpu/drm/mediatek/mtk_dp.c      | 2241 ++++++++++++++++++++++++
 drivers/gpu/drm/mediatek/mtk_dp_reg.h  |  545 ++++++
 drivers/gpu/drm/mediatek/mtk_drm_drv.c |    3 +
 drivers/gpu/drm/mediatek/mtk_drm_drv.h |    3 +
 6 files changed, 2802 insertions(+)
 create mode 100644 drivers/gpu/drm/mediatek/mtk_dp.c
 create mode 100644 drivers/gpu/drm/mediatek/mtk_dp_reg.h

diff --git a/drivers/gpu/drm/mediatek/Kconfig b/drivers/gpu/drm/mediatek/Kconfig
index 2976d21e9a34..af4e085d0077 100644
...
index 000000000000..e33b513469e8
--- /dev/null
...
+{
+	u16 val = BIT(HTOTAL_SEL_DP_ENC0_P0_SHIFT) |
...
+
+	mtk_dp_update_bits(mtk_dp, MTK_DP_ENC0_P0_3030, val, val);
+}
+
...
+			   0, VIDEO_SOURCE_SEL_DP_ENC0_P0_MASK);
...
+	mtk_dp_set_color_depth(mtk_dp, DP_MSA_MISC_8_BPC);
+
...
+				      mtk_dp->rx_cap[mtk_dp->max_linkrate]);
...
+		return ret;
+
+	ret = device_property_read_u16(dev, "max-linkrate", &linkrate);
+	if (ret)
+		return ret;
+
+	switch (linkrate) {
+	case 8100: /* 8.1G */
+		mtk_dp->max_linkrate = MTK_DP_LINKRATE_HBR3;
+		break;
+	case 5400: /* 5.4G */
+		mtk_dp->max_linkrate = MTK_DP_LINKRATE_HBR2;
+		break;
+	case 2700: /* 2.7G */
+		mtk_dp->max_linkrate = MTK_DP_LINKRATE_HBR;
+		break;
+	case 1620: /* 1.62G */
+		mtk_dp->max_linkrate = MTK_DP_LINKRATE_RBR;
+		break;
+	default:
+		ret = -EINVAL;
+		break;
...
new file mode 100644
index 000000000000..5377ccea8178
--- /dev/null
...
@@ -1033,6 +1033,9 @@ static struct platform_driver * const mtk_drm_drivers[] = {
 	&mtk_disp_ovl_driver,
...
index acbf14b597db..0f96f76f6a51 100644
--- a/drivers/gpu/drm/mediatek/mtk_drm_drv.h
+++ b/drivers/gpu/drm/mediatek/mtk_drm_drv.h
@@ -67,6 +67,9 @@ extern struct platform_driver mtk_disp_ovl_adaptor_driver;
