...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A0BFC4E3E3B
	for <lists+devicetree@lfdr.de>; Tue, 22 Mar 2022 13:15:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230488AbiCVMQk (ORCPT <rfc822;lists+devicetree@lfdr.de>);
        Tue, 22 Mar 2022 08:16:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32932 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233482AbiCVMQi (ORCPT
        <rfc822;devicetree@vger.kernel.org>); Tue, 22 Mar 2022 08:16:38 -0400
Received: from bhuna.collabora.co.uk (bhuna.collabora.co.uk [IPv6:2a00:1098:0:82:1000:25:2eeb:e3e3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 734E46AA5D;
        Tue, 22 Mar 2022 05:15:07 -0700 (PDT)
Received: from [IPV6:2a01:e0a:120:3210:291a:14b5:29b5:1fc7] (unknown [IPv6:2a01:e0a:120:3210:291a:14b5:29b5:1fc7])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        (Authenticated sender: benjamin.gaignard)
        by bhuna.collabora.co.uk (Postfix) with ESMTPSA id C72101F40FA7;
        Tue, 22 Mar 2022 12:15:04 +0000 (GMT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=collabora.com;
        s=mail; t=1647951305;
        bh=byvauf5l7gsAK2Y7KIZduXJ22pX3MecBqZBDGUkzXFw=;
        h=Date:Subject:To:Cc:References:From:In-Reply-To:From;
        b=
Message-ID: <4ece9feb-1154-8795-98c4-3d6c09f9c27e@collabora.com>
Date:   Tue, 22 Mar 2022 13:15:01 +0100
MIME-Version: 1.0
...
Le 17/03/2022 à 15:56, Moudy Ho a écrit :
...
You may need to add the result of v4l2-compliance here.
...
Since these defines and structures are strongly link
to the SCP firmware it may be good to add a comment about
which version(s) of the firmware they are targeting.
...
I haven't found any other MDP_DEBUG compilation anywhere else
and no mdp_debug_init() so I guess these lines could be removed.
...
You may also need to clean SCP, cmdq_mbox etc..
...
You don't need define this function, v4l2mem2mem check if .job_abort
operation is set before call it.
...
Why adding a work queue here ?
You can move mdp_m2m_worker() content inside instead.
...
Since this state is only init or error, you could replace by an
atomic and remove the mutex
